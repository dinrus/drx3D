...
class DRX3D_EXPORT ChangePerSecond {
public:
...
/**
 * @brief Main class for drx3D, manages modules and updates. After creating your Engine object call {@link Engine#Run} to start.
 */
class DRX3D_EXPORT Engine : NonCopyable {
public:
	/**
	 ...
	 */
	explicit Engine(STxt argv0, ModuleFilter &&moduleFilter = {});
	~Engine();
	 ...
	 */
	const STxt &GetArgv0() const { return argv0; };
