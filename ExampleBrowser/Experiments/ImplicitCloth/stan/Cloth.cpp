...
Cloth::Cloth(tukk _name, i32 _n) : SpringNetwork(_n),
										  color(0, 0.5f, 1.0f)
{
	cloths.Add(this);
}
...
i32 cloth_showbbox = 0;         // for debug visualization  shows bounding box.
...
static void ClothDrawSprings(Cloth *cloth)
{
       ...
       float3N &X = cloth->X;
       for(i32 i=0;i<cloth->springs.count;i++)
       {
