...
public:
	...
	void Run(MyCommandProcessor* comProc, const STxt& hostNamePort)
	{
		...
		std::cout << "Standalone drx3D Physics GRPC server listening on " << hostNamePort << std::endl;
...
i32 main(i32 argc, tuk* argv)
{
	...
	STxt hostName = "localhost";
	STxt hostNamePort = hostName;
	if (port >= 0)
	{
