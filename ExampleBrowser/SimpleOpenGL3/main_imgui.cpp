...
i32 g_MousePressed[3] = {0};
i32 g_MousePressed2[3] = {0};
...
void ImGui_ImplBullet_CreateDeviceObjects()
{
	...
	io.Fonts->TexID = (uk )(intptr_t)g_FontTexture;
...
#define OFFSETOF(TYPE, ELEMENT) ((size_t) & (((TYPE*)0)->ELEMENT))
	for (i32 n = 0; n < draw_data->CmdListsCount; n++)
	{
		...
		glVertexPointer(2, GL_FLOAT, sizeof(ImDrawVert), (const GLvoid*)((tukk)vtx_buffer + OFFSETOF(ImDrawVert, pos)));
		glTexCoordPointer(2, GL_FLOAT, sizeof(ImDrawVert), (const GLvoid*)((tukk)vtx_buffer + OFFSETOF(ImDrawVert, uv)));
		glColorPointer(4, GL_UNSIGNED_BYTE, sizeof(ImDrawVert), (const GLvoid*)((tukk)vtx_buffer + OFFSETOF(ImDrawVert, col)));
...
{
	{
		...
		b3Quat orn(0, 0, 0, 1);
		b3Vec3 color = b3MakeVector3(1, 0, 0);
