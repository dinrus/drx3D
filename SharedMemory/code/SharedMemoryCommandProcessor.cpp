...
bool SharedMemoryCommandProcessor::processCommand(const struct SharedMemoryCommand& clientCmd, struct SharedMemoryStatus& serverStatusOut, tuk bufferServerToClient, i32 bufferSizeInBytes)
{
...
bool SharedMemoryCommandProcessor::receiveStatus(struct SharedMemoryStatus& serverStatusOut, tuk bufferServerToClient, i32 bufferSizeInBytes)
{
	...
	{
		drx3DAssert(m_data->m_testBlock1->m_numServerCommands ==
		...
		for (i32 i = 0; i < m_data->m_lastServerStatus.m_numDataStreamBytes; i++)
		{
		...
		drx3DAssert(m_data->m_testBlock1->m_numProcessedServerCommands ==
...
void SharedMemoryCommandProcessor::renderScene(i32 renderFlags)
{
}

void SharedMemoryCommandProcessor::physicsDebugDraw(i32 debugDrawFlags)
{
}
...
void SharedMemoryCommandProcessor::setSharedMemoryKey(i32 key)
{
