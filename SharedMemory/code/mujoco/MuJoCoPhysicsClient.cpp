...
struct BodyJointInfoCache2
{
	...
	HashMap<HashInt, MuJoCoUserDataCache> m_jointToUserDataMap;
...
void MuJoCoPhysicsClient::debugDraw(i32 debugDrawMode)
{
...
void MuJoCoPhysicsClient::processBodyJointInfo(i32 bodyUniqueId, const SharedMemoryStatus& serverCmd)
{
...
i32 MuJoCoPhysicsClient::getNumBodies() const
{
	return m_data->m_bodyJointMap.size();
}

void MuJoCoPhysicsClient::removeCachedBody(i32 bodyUniqueId)
{
...
i32 MuJoCoPhysicsClient::getNumUserConstraints() const
{
	return m_data->m_userConstraintInfoMap.size();
}

i32 MuJoCoPhysicsClient::getUserConstraintInfo(i32 constraintUniqueId, struct b3UserConstraint& info) const
{
...
i32 MuJoCoPhysicsClient::getUserConstraintId(i32 serialIndex) const
{
...
i32 MuJoCoPhysicsClient::getBodyUniqueId(i32 serialIndex) const
{
...
bool MuJoCoPhysicsClient::getBodyInfo(i32 bodyUniqueId, struct b3BodyInfo& info) const
{
	BodyJointInfoCache2** bodyJointsPtr = m_data->m_bodyJointMap[bodyUniqueId];
	if (bodyJointsPtr && *bodyJointsPtr)
	{
...
i32 MuJoCoPhysicsClient::getNumJoints(i32 bodyIndex) const
{
...
bool MuJoCoPhysicsClient::getJointInfo(i32 bodyIndex, i32 jointIndex, struct b3JointInfo& info) const
{
	BodyJointInfoCache2** bodyJointsPtr = m_data->m_bodyJointMap[bodyIndex];
	if (bodyJointsPtr && *bodyJointsPtr)
	{
...
void MuJoCoPhysicsClient::setSharedMemoryKey(i32 key)
{
}

void MuJoCoPhysicsClient::uploadBulletFileToSharedMemory(tukk data, i32 len)
{
...
void MuJoCoPhysicsClient::uploadRaysToSharedMemory(struct SharedMemoryCommand& command, const double* rayFromWorldArray, const double* rayToWorldArray, i32 numRays)
{
...
i32 MuJoCoPhysicsClient::getNumDebugLines() const
{
...
void MuJoCoPhysicsClient::getCachedMassMatrix(i32 dofCountCheck, double* massMatrix)
{
...
bool MuJoCoPhysicsClient::getCachedUserData(i32 bodyUniqueId, i32 linkIndex, i32 userDataId, struct b3UserDataValue& valueOut) const
{
	BodyJointInfoCache2** bodyJointsPtr = m_data->m_bodyJointMap[bodyUniqueId];
	if (!bodyJointsPtr || !(*bodyJointsPtr))
	{
...
i32 MuJoCoPhysicsClient::getCachedUserDataId(i32 bodyUniqueId, i32 linkIndex, tukk key) const
{
	BodyJointInfoCache2** bodyJointsPtr = m_data->m_bodyJointMap[bodyUniqueId];
	if (!bodyJointsPtr || !(*bodyJointsPtr))
	{
...
i32 MuJoCoPhysicsClient::getNumUserData(i32 bodyUniqueId, i32 linkIndex) const
{
	BodyJointInfoCache2** bodyJointsPtr = m_data->m_bodyJointMap[bodyUniqueId];
	if (!bodyJointsPtr || !(*bodyJointsPtr))
	{
...
void MuJoCoPhysicsClient::getUserDataInfo(i32 bodyUniqueId, i32 linkIndex, i32 userDataIndex, tukk* keyOut, i32* userDataIdOut) const
{
	BodyJointInfoCache2** bodyJointsPtr = m_data->m_bodyJointMap[bodyUniqueId];
	if (!bodyJointsPtr || !(*bodyJointsPtr))
	{
...
void MuJoCoPhysicsClient::pushProfileTiming(tukk timingName)
{
