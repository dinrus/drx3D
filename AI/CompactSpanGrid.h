...
public:
	struct Cell
	{
		...
		inline Cell(u32 _index, u32 _count)
			: index(_index)
			, count(_count)
		{
		}
	...
	struct Span
	{
		...
		inline Span(u16 _bottom, u16 _height, u16 _depth, bool _backface)
...
#endif  // #ifndef __MNM_COMPACT_SPAN_GRID_H
