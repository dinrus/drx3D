...
#define VISION_MAP_ALL_TYPES    u32(-1)
#define VISION_MAP_ALL_FACTIONS u32(-1)
...
struct ObserverParams
{
	...
	u32 factionsToObserveMask;
	u32 typesToObserveMask;
...
public:
	...
	virtual VisionID                CreateVisionID(tukk name) = 0;
	...
	virtual void                    ObserverChanged(const ObserverID& observerID, const ObserverParams& params, u32 hint) = 0;
	virtual void                    ObservableChanged(const ObservableID& observableID, const ObservableParams& params, u32 hint) = 0;
