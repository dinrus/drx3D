...
public:
	...
	virtual tukk  GetName() { return "instant"; }
	...
	virtual i32          GetShotCount() const                                        { return m_ShotsCount; }
...
protected:
	...
	i32         m_weaponBurstBulletCount;
	i32         m_curBurstBulletCount;
	...
	private:
		struct State
		{
			State()
				: time(0.0f)
				, idleTime(0.0f)
				, startSeed(drx_random(0.0f, 1337.0f))
				, state(Running)
			{
			}
...
public:
	...
	virtual i32  SelectBurstLength() { return 0; }
...
public:
	...
	virtual i32          GetShotCount() const                                        { return 0; }
...
public:
	...
	virtual tukk GetName() { return "projectile_slow"; }
...
public:
	...
	virtual tukk  GetName() { return "projectile_fast"; }
	virtual void         Reset();
	virtual EAIFireState Update(IAIObject* pTarget, bool canFire, EFireMode fireMode, const AIWeaponDescriptor& descriptor, Vec3& outShootTargetPos);
	virtual bool         ValidateFireDirection(const Vec3& fireVector, bool mustHit) { return true; }
	virtual void         Release()                                                   { delete this; }
...
public:
	...
	virtual tukk GetName() { return "grenade"; }
