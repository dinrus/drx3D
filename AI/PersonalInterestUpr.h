...
/********************************************************************
   ---------------------------------------------------------------------
   Имя файла:   PersonalInterestUpr.h
   $Id$
   $DateTime$
   Описание: Interest Upr (tracker) for interested individuals

   Note:        PIMs are owned by the CentralInterestUpr - delete there
   ---------------------------------------------------------------------
   История:
...
#ifndef __PersonalInterestUpr_H__
#define __PersonalInterestUpr_H__
...
class CPersonalInterestUpr : public IAIAction::IAIActionListener
{
public:
	CPersonalInterestUpr(CAIActor* pAIActor = NULL);
