...
/********************************************************************
   -------------------------------------------------------------------------
   Имя файла:   PatHolder.h
   $Id$
   Описание: Interface to hold an manipulate a path
...
public:
	...
	void                                      PullPathOnNavigationMesh(const MNM::CNavMesh& navMesh, u16 iteration, const IMNMCustomPathCostComputer* pOptionalCustomPathCostComputer)
	{
...
private:
	...
	void StringPullLoop(const MNM::CNavMesh& navMesh, u16 iteration, const TStringPullChecker& stringPullChecker)
	{
