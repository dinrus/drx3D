...
{
	SPathControlPoint2()
		: navType(IAISystem::NAV_UNSET), pos(ZERO), distance(0.0f), customId(0) {}
	SPathControlPoint2(IAISystem::ENavigationType navType, const Vec3& pos, u16 customId = 0)
		: navType(navType), pos(pos), distance(0.0f), customId(customId) {}
...
public:
	...
	virtual void Advance(float distance) override {}    // TODO: Remove, but needed by old implementation for now...
	...
	virtual float GetDistToCustomNav(const InterpolatedPath& controlPoints, u32 curLASegmentIndex, const Vec3& curLAPos) const;
