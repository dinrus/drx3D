...
#include <drx3D/AI/MNM_Type_info.h>
...
struct WayTriangleData
{
	WayTriangleData()
		...
		, offMeshLinkID(0)
		, costMultiplier(1.0f)
		, incidentEdge((u32)MNM::Constants::InvalidEdgeIndex)
	{
...
protected:
	...
	u32     m_totalSearchCount;

	u32     m_currentSearchSteps;
	u32     m_totalSearchSteps;
	u32     m_peakSearchSteps;
	...
	: public AStarContention
{
	...
	void SetUpForPathSolving(u32k triangleCount, const TriangleID fromTriangleID, const vector3_t& startLocation, const real_t dist_start_to_end)
	{
...
namespace MNMUtils
{
inline const MNM::real_t CalculateMinHorizontalRange(u16k radiusVoxelUnits, const float voxelHSize)
{
...
inline const MNM::real_t CalculateMinVerticalRange(u16k agentHeightVoxelUnits, const float voxelVSize)
{
