...
public:
	...
	i32 LogProgress(IFunctionHandler* pH);
	...
	//!	</description>
	//!		<param name="szMessage">message line to be displayed in log</param>
	i32 LogEvent(IFunctionHandler* pH);
	...
	//!		<param name="szMessage">message line to be displayed in log</param>
	i32 LogComment(IFunctionHandler* pH);
	...
	i32 RecComment(IFunctionHandler* pH);
	...
	i32 ResetParameters(IFunctionHandler* pH);
	...
	i32 GetTypeOf(IFunctionHandler* pH);
	...
	// AIOBJECT_BOAT
	// AIOBJECT_HELICOPTER
	i32 GetSubTypeOf(IFunctionHandler* pH);
	...
	i32 GetParameter(IFunctionHandler* pH);
	...
	//!		<param name="paramValue">new parameter value, see above for type and meaning.</param>
	i32 ChangeMovementAbility(IFunctionHandler* pH);
	...
	/*
	   ...
	   i32 AddSmartObjectCondition(IFunctionHandler *pH);
	 */
	...
	i32 ExecuteAction(IFunctionHandler* pH);
	...
	i32 AbortAction(IFunctionHandler* pH);
	...
	i32 SetSmartObjectState(IFunctionHandler* pH);
	...
	i32 ModifySmartObjectStates(IFunctionHandler* pH);
	...
	i32 SmartObjectEvent(IFunctionHandler* pH);
	...
	//! </returns>
	i32 GetLastUsedSmartObject(IFunctionHandler* pH);
	...
	i32 PushGoal(IFunctionHandler* pH);
	...
	i32 PushLabel(IFunctionHandler* pH);
	...
	i32 Signal(IFunctionHandler* pH);

	i32 NotifyGroup(IFunctionHandler* pH, i32 groupID, ScriptHandle sender, tukk notification);
	...
	i32 FreeSignal(IFunctionHandler* pH);
	...
	i32 SetIgnorant(IFunctionHandler* pH);

	i32 BreakEvent(IFunctionHandler* pH, ScriptHandle entityID, Vec3 pos, float radius);
	i32 AddCoverEntity(IFunctionHandler* pH, ScriptHandle entityID);
	i32 RemoveCoverEntity(IFunctionHandler* pH, ScriptHandle entityID);
	...
	i32 GetGroupCount(IFunctionHandler* pH);
	...
	i32 GetGroupMember(IFunctionHandler* pH);
	...
	i32 GetGroupOf(IFunctionHandler* pH);

	//! <code>AI.GetFactionOf( entityID )</code>
	//! <returns>The faction of the specified entity.</returns>
	i32 GetFactionOf(IFunctionHandler* pH, ScriptHandle entityID);
	...
	i32 SetFactionOf(IFunctionHandler* pH, ScriptHandle entityID, tukk factionName);

	i32 GetReactionOf(IFunctionHandler* pH);
	i32 SetReactionOf(IFunctionHandler* pH, tukk factionOne, tukk factionTwo, i32 reaction);
	...
	i32 GetUnitInRank(IFunctionHandler* pH);
	...
	i32 SetUnitProperties(IFunctionHandler* pH);
	...
	//!			(in the form of UPR_* + UPR* i.e. UPR_COMBAT_GROUND + UPR_COMBAT_FLIGHT)
	//!			see IAgent.h for definition of unit properties UPR_*</param>
	i32 GetUnitCount(IFunctionHandler* pH);
	...
	i32 Hostile(IFunctionHandler* pH);
	...
	i32 GetLeader(IFunctionHandler* pH);
	...
	i32 SetLeader(IFunctionHandler* pH);
	...
	i32 GetBeaconPosition(IFunctionHandler* pH);
	...
	i32 SetBeaconPosition(IFunctionHandler* pH);
	...
	i32 RequestAttack(IFunctionHandler* pH);
	...
	i32 GetGroupTarget(IFunctionHandler* pH);

	//! <code>AI.GetGroupTargetType( groupID )</code>
	i32 GetGroupTargetType(IFunctionHandler* pH, i32 groupID);

	//! <code>AI.GetGroupTargetThreat( groupID )</code>
	i32 GetGroupTargetThreat(IFunctionHandler* pH, i32 groupID);

	//! <code>AI.GetGroupTargetEntity( groupID )</code>
	i32 GetGroupTargetEntity(IFunctionHandler* pH, i32 groupID);

	//! <code>AI.GetGroupScriptTable( groupID )</code>
	i32 GetGroupScriptTable(IFunctionHandler* pH, i32 groupID);
	...
	//!		<param name="bHostileOnly (optional)">filter only hostile targets in group</param>
	//!		<param name="bLiveOnly (optional)">filter only live targets in group (entities)</param>
	i32 GetGroupTargetCount(IFunctionHandler* pH);
	...
	i32 GetGroupAveragePosition(IFunctionHandler* pH);
	...
	i32 FindObjectOfType(IFunctionHandler* pH);
	...
	i32 GetAnchor(IFunctionHandler* pH);
	...
	i32 GetNearestEntitiesOfType(IFunctionHandler* pH);
	...
	i32 GetAIObjectPosition(IFunctionHandler* pH);
	...
	//!		<param name="entityId">AI's entity id</param>
	i32 IgnoreCurrentHideObject(IFunctionHandler* pH);
	...
	//!		<param name="entityId">AI's entity id</param>
	i32 GetCurrentHideAnchor(IFunctionHandler* pH);

	//////////////////////////////////////////////////////////////////////////////////////////////////////////
	/// Attention Target / perception related functions
	//////////////////////////////////////////////////////////////////////////////////////////////////////////

	i32 GetForwardDir(IFunctionHandler* pH);
	...
	i32 GetAttentionTargetOf(IFunctionHandler* pH);
	...
	i32 GetAttentionTargetAIType(IFunctionHandler* pH);
	...
	i32 GetAttentionTargetType(IFunctionHandler* pH);
	...
	i32 GetAttentionTargetEntity(IFunctionHandler* pH, ScriptHandle entityID);
	...
	i32 GetAttentionTargetPosition(IFunctionHandler* pH);
	...
	i32 GetAttentionTargetDirection(IFunctionHandler* pH);
	...
	//!		<param name="entityId">AI's entity id</param>
	//! <returns>Dir - vector {x,y,z} passed as a return value (attention target 's direction)</returns>
	i32 GetAttentionTargetViewDirection(IFunctionHandler* pH);
	...
	i32 GetAttentionTargetDistance(IFunctionHandler* pH);

	//! <code>AI.GetAttentionTargetThreat( entityID )</code>
	i32 GetAttentionTargetThreat(IFunctionHandler* pH, ScriptHandle entityID);
	...
	//!		<param name="entityId">AI's entity id</param>
	i32 ClearPotentialTargets(IFunctionHandler* pH);
	...
	i32 SetTempTargetPriority(IFunctionHandler* pH);
	...
	//! <returns>true if updated</returns>
	i32 AddAggressiveTarget(IFunctionHandler* pH);
	...
	//! <returns>true if updated</returns>
	i32 UpdateTempTarget(IFunctionHandler* pH);
	...
	i32 ClearTempTarget(IFunctionHandler* pH);
	...
	i32 SetExtraPriority(IFunctionHandler* pH);
	...
	//!		<param name="enemyEntityId">AI's entity id</param>
	i32 GetExtraPriority(IFunctionHandler* pH);
	...
	//! </returns>
	i32 GetTargetType(IFunctionHandler* pH);
	...
	i32 GetTargetSubType(IFunctionHandler* pH);
	...
	i32 RegisterTargetTrack(IFunctionHandler* pH);
	...
	i32 UnregisterTargetTrack(IFunctionHandler* pH);
	...
	i32 SetTargetTrackClassThreat(IFunctionHandler* pH);

	i32 TriggerCurrentTargetTrackPulse(IFunctionHandler* pH, ScriptHandle entityID, tukk stimulusName,
	                                   tukk pulseName);
	...
	i32 CreateStimulusEvent(IFunctionHandler* pH, ScriptHandle ownerId, ScriptHandle targetId, tukk stimulusName, SmartScriptTable pData);
	i32 CreateStimulusEventInRange(IFunctionHandler* pH, ScriptHandle targetId, tukk stimulusName, SmartScriptTable dataScriptTable);
	...
	i32 SoundEvent(IFunctionHandler* pH);
	...
	i32 VisualEvent(IFunctionHandler* pH);
	...
	i32 GetSoundPerceptionDescriptor(IFunctionHandler* pH);
	...
	i32 SetSoundPerceptionDescriptor(IFunctionHandler* pH);
	...
	i32 SetAssesmentMultiplier(IFunctionHandler* pH);
	...
	i32 SetFactionThreatMultiplier(IFunctionHandler* pH);
	...
	i32 GetRefPointPosition(IFunctionHandler* pH);
	...
	i32 GetRefPointDirection(IFunctionHandler* pH);
	...
	i32 SetRefPointRadius(IFunctionHandler* pH);
	...
	i32 SetRefShapeName(IFunctionHandler* pH);

	//! <code>AI.GetRefShapeName(entityId)</code>
	//! <returns>reference shape name.</returns>
	//!		<param name="entityId">AI's entity id</param>
	i32 GetRefShapeName(IFunctionHandler* pH);

	i32 SetVehicleStickTarget(IFunctionHandler* pH);
	...
	i32 SetTerritoryShapeName(IFunctionHandler* pH);
	...
	i32 SetCharacter(IFunctionHandler* pH);
#endif
	...
	i32 SetRefPointAtDefensePos(IFunctionHandler* pH);
	...
	i32 SetPathToFollow(IFunctionHandler* pH);
	...
	i32 SetPathAttributeToFollow(IFunctionHandler* pH);
	...
	i32 GetNearestPathOfTypeInRange(IFunctionHandler* pH);
	...
	i32 GetTotalLengthOfPath(IFunctionHandler* pH);
	...
	i32 GetNearestPointOnPath(IFunctionHandler* pH);
	...
	//!		<param name="vPos">.</param>
	i32 GetPathSegNoOnPath(IFunctionHandler* pH);
	...
	i32 GetPredictedPosAlongPath(IFunctionHandler* pH);
	...
	i32 SetPointListToFollow(IFunctionHandler* pH);
	...
	i32 GetEnclosingGenericShapeOfType(IFunctionHandler* pH);
	...
	//!		<param name="checkHeight">(optional) Default=false, if the flag is set the height of the shape is tested too.
	//!			The test will check space between the shape.aabb.min.z and shape.aabb.min.z+shape.height.</param>
	i32 IsPointInsideGenericShape(IFunctionHandler* pH);
	...
	i32 ConstrainPointInsideGenericShape(IFunctionHandler* pH);
	...
	//!			The test will check space between the shape.aabb.min.z and shape.aabb.min.z+shape.height.</param>
	i32 DistanceToGenericShape(IFunctionHandler* pH);
	...
	i32 CreateTempGenericShapeBox(IFunctionHandler* pH);

	//! <code>AI.GetObjectRadius(entityId)</code>
	//! <returns>the radius of specified AI object.</returns>
	//!		<param name="entityId">AI's entity id</param>
	i32 GetObjectRadius(IFunctionHandler* pH);

	//! <code>AI.GetProbableTargetPosition(entityId)</code>
	//! <returns>the probable target position of the AI.</returns>
	//!		<param name="entityId">AI's entity id</param>
	i32 GetProbableTargetPosition(IFunctionHandler* pH);

	i32 NotifyReinfDone(IFunctionHandler* pH);

	i32 BehaviorEvent(IFunctionHandler* pH);

	i32 NotifySurpriseEntityAction(IFunctionHandler* pH);

	i32 InvalidateHidespot(IFunctionHandler* pH);
	i32 EvalHidespot(IFunctionHandler* pH);
	...
	//! </returns>
	i32 EvalPeek(IFunctionHandler* pH);

	//! <code>AI.AddPersonallyHostile(entityID, hostileID)</code>
	i32 AddPersonallyHostile(IFunctionHandler* pH, ScriptHandle entityID, ScriptHandle hostileID);

	//! <code>AI.RemovePersonallyHostile(entityID, hostileID)</code>
	i32 RemovePersonallyHostile(IFunctionHandler* pH, ScriptHandle entityID, ScriptHandle hostileID);

	//! <code>AI.ResetPersonallyHostiles(entityID, hostileID)</code>
	i32 ResetPersonallyHostiles(IFunctionHandler* pH, ScriptHandle entityID, ScriptHandle hostileID);

	//! <code>AI.IsPersonallyHostile(entityID, hostileID)</code>
	i32 IsPersonallyHostile(IFunctionHandler* pH, ScriptHandle entityID, ScriptHandle hostileID);
	...
	i32 GetDirectAnchorPos(IFunctionHandler* pH);

	i32 GetGroupAlertness(IFunctionHandler* pH);

	i32 GetAlertness(IFunctionHandler* pH);

	//! <returns>the estimated surrounding navigable space in meters.</returns>
	i32 GetEnclosingSpace(IFunctionHandler* pH);

	i32 Event(IFunctionHandler* pH);
	...
	i32 GetPotentialTargetCountFromFaction(IFunctionHandler* pH, ScriptHandle entityID, tukk factionName);

	//! <code>AI.GetPotentialTargetCount( entityID )</code>
	//! <description>Retrieves the number of potential targets for an entity from a specified factions.</description>
	//!		<param name="entityId">id handle of entity to match against.</param>
	i32 GetPotentialTargetCount(IFunctionHandler* pH, ScriptHandle entityID);
	...
	i32 CreateFormation(IFunctionHandler* pH);
	...
	i32 AddFormationPointFixed(IFunctionHandler* pH);
	...
	i32 AddFormationPoint(IFunctionHandler* pH);
	...
	i32 GetFormationPointClass(IFunctionHandler* pH);
	...
	i32 GetFormationPointPosition(IFunctionHandler* pH);
	...
	i32 BeginTrackPattern(IFunctionHandler* pH);
	...
	i32 AddPatternNode(IFunctionHandler* pH);
	...
	i32 AddPatternBranch(IFunctionHandler* pH);
	...
	//! </description>
	i32 EndTrackPattern(IFunctionHandler* pH);
	...
	i32 ChangeFormation(IFunctionHandler* pH);
	...
	i32 ScaleFormation(IFunctionHandler* pH);
	...
	i32 SetFormationUpdate(IFunctionHandler* pH);
	...
	i32 SetFormationUpdateSight(IFunctionHandler* pH);
	...
	//! </returns>
	i32 GetNavigationType(IFunctionHandler* pH);
	...
	i32 GetDistanceAlongPath(IFunctionHandler* pH);
	...
	i32 IntersectsForbidden(IFunctionHandler* pH);
	...
	i32 GetHeliAdvancePoint(IFunctionHandler* pH);

	i32 GetFlyingVehicleFlockingPos(IFunctionHandler* pH);

	i32 CheckVehicleColision(IFunctionHandler* pH);

	i32 SetForcedNavigation(IFunctionHandler* pH);

	i32 SetAdjustPath(IFunctionHandler* pH);
	...
	i32 IsPointInFlightRegion(IFunctionHandler* pH);
	...
	i32 IsPointInWaterRegion(IFunctionHandler* pH);
	...
	i32 SetFireMode(IFunctionHandler* pH);
	...
	i32 SetMemoryFireType(IFunctionHandler* pH);
	...
	i32 GetMemoryFireType(IFunctionHandler* pH);
	...
	i32 ThrowGrenade(IFunctionHandler* pH);
	...
	i32 IsFireEnabled(IFunctionHandler* pH);
	...
	i32 CanFireInStance(IFunctionHandler* pH);
	...
	i32 SetUseSecondaryVehicleWeapon(IFunctionHandler* pH);

	//! <description>Assign AgentPathfindingProperties to the given path type.</description>
	i32 AssignPFPropertiesToPathType(IFunctionHandler* pH);

	i32 AssignPathTypeToSOUser(IFunctionHandler* pH);

	//! <description>Set agent's pathfinder properties, (normal, road, cover, ....).</description>
	i32 SetPFProperties(IFunctionHandler* pH);

	i32 SetRefPointToGrenadeAvoidTarget(IFunctionHandler* pH);
	...
	i32 IsAgentInTargetFOV(IFunctionHandler* pH);
	...
	i32 AgentLookAtPos(IFunctionHandler* pH);
	...
	//!		<param name="entityId">AI's entity id.</param>
	i32 ResetAgentLookAtPos(IFunctionHandler* pH);
	...
	//! </returns>
	i32 IsAgentInAgentFOV(IFunctionHandler* pH);
	...
	i32 CreateGroupFormation(IFunctionHandler* pH);
	...
	i32 SetFormationPosition(IFunctionHandler* pH);
	...
	i32 SetFormationLookingPoint(IFunctionHandler* pH);
	...
	i32 SetFormationAngleThreshold(IFunctionHandler* pH);
	...
	i32 GetFormationPosition(IFunctionHandler* pH);
	...
	i32 GetFormationLookingPoint(IFunctionHandler* pH);

	i32 AutoDisable(IFunctionHandler* pH);

	//! <description>Creates new combat class.</description>
	i32 AddCombatClass(IFunctionHandler* pH);

	i32 Animation(IFunctionHandler* pH);

	//! <code>AI.SetAnimationTag(entityId, tagName)</code>
	//!		<param name="entityId">AI's entity</param>
	//!		<param name="tagName">.</param>
	i32 SetAnimationTag(IFunctionHandler* pH, ScriptHandle entityID, tukk tagName);

	//! <code>AI.ClearAnimationTag(entityId, tagName)</code>
	//!		<param name="entityId">AI's entity</param>
	//!		<param name="tagName">.</param>
	i32 ClearAnimationTag(IFunctionHandler* pH, ScriptHandle entityID, tukk tagName);

	//i32 GetClosestPointToOBB(IFunctionHandler *pH);
	...
	i32 GetStance(IFunctionHandler* pH);
	...
	i32 SetStance(IFunctionHandler* pH);
	...
	i32 SetMovementContext(IFunctionHandler* pH, ScriptHandle entityId, i32 context);

	//! <code>AI.ResetMovementContext(entityId)</code>
	//! <description>Reset the given entity's movement context.</description>
	//!		<param name="entityId">AI's entity id</param>
	//!		<param name="context">context value</param>
	i32 ClearMovementContext(IFunctionHandler* pH, ScriptHandle entityId, i32 context);
	...
	i32 SetPostures(IFunctionHandler* pH, ScriptHandle entityId, SmartScriptTable postures);
	...
	i32 SetPosturePriority(IFunctionHandler* pH, ScriptHandle entityId, tukk postureName, float priority);

	//! <code>AI.GetPosturePriority(entityId, postureName)</code>
	//! <description>Set the given entity's posture priority.</description>
	i32 GetPosturePriority(IFunctionHandler* pH, ScriptHandle entityId, tukk postureName);

	//! <code>AI.IsMoving(entityId)</code>
	//! <description>Returns true if the agent desires to move.</description>
	//!		<param name="entityId">AI's entity id</param>
	i32 IsMoving(IFunctionHandler* pH);
	...
	i32 RegisterDamageRegion(IFunctionHandler* pH);
	...
	i32 GetBiasedDirection(IFunctionHandler* pH);
	...
	i32 CheckMeleeDamage(IFunctionHandler* pH);
	...
	i32 GetDirLabelToPoint(IFunctionHandler* pH);
	...
	i32 DebugReportHitDamage(IFunctionHandler* pH);
	...
	i32 ProcessBalancedDamage(IFunctionHandler* pH);
	...
	i32 SetRefpointToAnchor(IFunctionHandler* pH);
	...
	i32 SetRefpointToPunchableObject(IFunctionHandler* pH);
	...
	i32 MeleePunchableObject(IFunctionHandler* pH);
	...
	i32 IsPunchableObjectValid(IFunctionHandler* pH);
	...
	i32 PlayReadabilitySound(IFunctionHandler* pH);
	...
	i32 PlayCommunication(IFunctionHandler* pH, ScriptHandle entityId, tukk commName, tukk channelName,
	                      float contextExpiry);
	...
	i32 StopCommunication(IFunctionHandler* pH, ScriptHandle playID);
	...
	i32 EnableWeaponAccessory(IFunctionHandler* pH);

	// AIHandler calls this function to replace the OnPlayerSeen signal
	/*	static tukk GetCustomOnSeenSignal( i32 iCombatClass )
	   {
	    if ( iCombatClass < 0 || iCombatClass >= m_CustomOnSeenSignals.size() )
	      return "OnPlayerSeen";
	    tukk result = m_CustomOnSeenSignals[ iCombatClass ];
	...
	//! </returns>
	i32 RegisterInterestingEntity(IFunctionHandler* pH, ScriptHandle entityId, float radius, float baseInterest, tukk actionName, Vec3 offset, float pause, i32 shared);
	...
	//!		<param name="entityId">AI's entity</param>
	i32 UnregisterInterestingEntity(IFunctionHandler* pH, ScriptHandle entityId);
	...
	//!		nil - if not (Interest system is disabled, parameters not valid, etc)
	//! </returns>
	i32 RegisterInterestedActor(IFunctionHandler* pH, ScriptHandle entityId, float fInterestFilter, float fAngleInDegrees);

	//! <code>AI.UnregisterInterestedActor(entityId)</code>
	//! <description>Unregisters the entity with the interest system. Any errors go to the error log.</description>
	//!		<param name="entityId">AI's entity id</param>
	i32 UnregisterInterestedActor(IFunctionHandler* pH, ScriptHandle entityId);
	...
	//!		nil - if not
	//! </returns>
	i32 IsCoverCompromised(IFunctionHandler* pH);

	//! <code>AI.SetCoverCompromised(entityId)</code>
	//!		<param name="entityId">AI's entity</param>
	i32 SetCoverCompromised(IFunctionHandler* pH);
	...
	//!		nil - if not
	//! </returns>
	i32 IsTakingCover(IFunctionHandler* pH);
	...
	//!		nil - if not
	//! </returns>
	i32 IsMovingInCover(IFunctionHandler* pH);
	...
	//!		nil - if not
	//! </returns>
	i32 IsMovingToCover(IFunctionHandler* pH);
	...
	//! <returns>nil</returns>
	i32 ResetAgentState(IFunctionHandler* pH, ScriptHandle entityId, tukk stateLabel);
	...
	//!		0 - Otherwise
	//! </returns>
	i32 RegisterTacticalPointQuery(IFunctionHandler* pH);
	...
	//!		nil - Otherwise
	//! </returns>
	i32 GetObjectBlackBoard(IFunctionHandler* pH);
	...
	//!		nil - Otherwise
	//! </returns>
	i32 GetBehaviorBlackBoard(IFunctionHandler* pH);
	...
	i32 SetBehaviorVariable(IFunctionHandler* pH, ScriptHandle entityId, tukk variableName, bool value);
	...
	i32 GetBehaviorVariable(IFunctionHandler* pH, ScriptHandle entityId, tukk variableName);
	...
	bool ParseTables(i32 firstTable, bool parseMovementAbility, IFunctionHandler* pH, AIObjectParams& aiParams, bool& updateAlways);
	...
	i32 SetSpeed(IFunctionHandler* pH);
	...
	i32 SetEntitySpeedRange(IFunctionHandler* pH);

	//! <code>AI.SetAlarmed( entityId )</code>
	//! <description>This function sets the entity to be "perception alarmed".</description>
	i32 SetAlarmed(IFunctionHandler* pH);

	//! <code>AI.LoadBehaviors( folderName, extension, globalEnv)</code>
	i32 LoadBehaviors(IFunctionHandler* pH, tukk folderName, tukk extension);

#ifdef USE_DEPRECATED_AI_CHARACTER_SYSTEM
	//! <code>AI.LoadCharacters(folderName, tbl)</code>
	i32 LoadCharacters(IFunctionHandler* pH, tukk folderName, SmartScriptTable tbl);
#endif

	//! <code>AI.IsLowHealthPauseActive( entityID )</code>
	i32 IsLowHealthPauseActive(IFunctionHandler* pH, ScriptHandle entityID);

	//! <code>AI.GetPreviousBehaviorName( entityID )</code>
	i32 GetPreviousBehaviorName(IFunctionHandler* pH, ScriptHandle entityID);

	//! <code>AI.SetContinuousMotion( entityID, continuousMotion )</code>
	i32 SetContinuousMotion(IFunctionHandler* pH, ScriptHandle entityID, bool continuousMotion);

	//! <code>AI.GetPeakThreatLevel( entityID )</code>
	i32 GetPeakThreatLevel(IFunctionHandler* pH, ScriptHandle entityID);

	//! <code>AI.GetPeakThreatType( entityID )</code>
	i32 GetPeakThreatType(IFunctionHandler* pH, ScriptHandle entityID);

	//! <code>AI.GetPreviousPeakThreatLevel( entityID )</code>
	i32 GetPreviousPeakThreatLevel(IFunctionHandler* pH, ScriptHandle entityID);

	//! <code>AI.GetPreviousPeakThreatType( entityID )</code>
	i32 GetPreviousPeakThreatType(IFunctionHandler* pH, ScriptHandle entityID);

	//! <code>AI.CheckForFriendlyAgentsAroundPoint( entityID, point, radius)</code>
	i32 CheckForFriendlyAgentsAroundPoint(IFunctionHandler* pH, ScriptHandle entityID, Vec3 point, float radius);

	//! <code>AI.EnableUpdateLookTarget(entityID, bEnable)</code>
	i32 EnableUpdateLookTarget(IFunctionHandler* pH, ScriptHandle entityID, bool bEnable);

	//! <code>AI.UpdateGlobalPerceptionScale(visualScale, audioScale, [filterType], [faction])</code>
	i32 UpdateGlobalPerceptionScale(IFunctionHandler* pH, float visualScale, float audioScale);

	//! <code>AI.QueueBubbleMessage(entityID, message, flags)</code>
	i32 QueueBubbleMessage(IFunctionHandler* pH, ScriptHandle entityID, tukk message);

	//! <code>AI.SequenceBehaviorReady(entityId)</code>
	i32 SequenceBehaviorReady(IFunctionHandler* pH, ScriptHandle entityId);

	//! <code>AI.SequenceInterruptibleBehaviorLeft(entityId)</code>
	i32 SequenceInterruptibleBehaviorLeft(IFunctionHandler* pH, ScriptHandle entityId);

	//! <code>AI.SequenceNonInterruptibleBehaviorLeft(entityId)</code>
	i32 SequenceNonInterruptibleBehaviorLeft(IFunctionHandler* pH, ScriptHandle entityId);

	//! <code>AI.SetCollisionAvoidanceRadiusIncrement(entityId, radius)</code>
	i32 SetCollisionAvoidanceRadiusIncrement(IFunctionHandler* pH, ScriptHandle entityId, float radius);

	//! <code>AI.RequestToStopMovement(entityId)</code>
	i32 RequestToStopMovement(IFunctionHandler* pH, ScriptHandle entityId);

	//! <code>AI.GetDistanceToClosestGroupMember(entityId)</code>
	i32 GetDistanceToClosestGroupMember(IFunctionHandler* pH, ScriptHandle entityId);

	//! <code>AI.IsAimReady(entityIdHandle)</code>
	i32 IsAimReady(IFunctionHandler* pH, ScriptHandle entityIdHandle);
	...
	i32 AllowLowerBodyToTurn(IFunctionHandler* pH, ScriptHandle entityID, bool bAllowLowerBodyToTurn);
	...
	i32 GetGroupScopeUserCount(IFunctionHandler* pH, ScriptHandle entityIdHandle, tukk groupScopeName);

	i32 StartModularBehaviorTree(IFunctionHandler* pH, ScriptHandle entityIdHandle, tukk treeName);
	i32 StopModularBehaviorTree(IFunctionHandler* pH, ScriptHandle entityIdHandle);

	//////////////////////////////////////////////////////////////////////////////////////////////////////////
	// XML support for goal pipes
	//////////////////////////////////////////////////////////////////////////////////////////////////////////
	i32 LoadGoalPipes(IFunctionHandler* pH);

private:

	static tukk GetPathTypeName(EAIPathType pathType);
...
protected:
	...
	//====================================================================
	EntityId GetEntityIdFromParam(IFunctionHandler* pH, i32 i);

	//====================================================================
	// Fetch entity pointer from script parameter
	//====================================================================
	IEntity* GetEntityFromParam(IFunctionHandler* pH, i32 i);
	...
	bool     GetSignalExtraData(IFunctionHandler* pH, i32 iParam, IAISignalExtraData*& pEData);

	i32      RayWorldIntersectionWrapper(Vec3 org, Vec3 dir, i32 objtypes, u32 flags, ray_hit* hits, i32 nMaxHits,
	                                     IPhysicalEntity** pSkipEnts = 0, i32 nSkipEnts = 0, uk pForeignData = 0, i32 iForeignData = 0);

	i32 CreateQueryFromTacticalSpec(SmartScriptTable specTable);

	typedef std::map<i32, i32>                              VTypeChart_t;
	typedef std::multimap<i32, i32, std::greater<i32> /**/> VTypeChartSorted_t;
	...
	i32  SetLastOpResult(IFunctionHandler* pH, ScriptHandle entityIdHandle, ScriptHandle targetEntityIdHandle);
