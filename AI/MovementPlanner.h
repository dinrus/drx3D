...
private:
	...
	void OnNavigationMeshChanged(NavigationAgentTypeID navigationAgentTypeID, NavigationMeshID meshID, u32 tileID);
	void OnNavigationAnnotationChanged(NavigationAgentTypeID navigationAgentTypeID, NavigationMeshID meshID, u32 tileID);
...
private:
	...
	void QueueNavigationChange(NavigationAgentTypeID navigationAgentTypeID, NavigationMeshID meshID, u32 tileID, const SMeshTileChange::ChangeFlags& changeFlag);
	...
	u8                        m_replanningAfterFailCount;
	bool                         m_pathfinderRequestQueued;
	const static u8           s_maxAllowedReplanning = 3;
};
}
