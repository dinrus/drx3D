...
//! Example: 
//! SAreaTypeAndFlags<u32, 6> uses u32 as base type. From that area type uses 6 bits (= 64 values from 0 to 63) and there can be 26 different flags
...
typedef SAreaTypeAndFlags<u32, 6> AreaAnnotation;
...
typedef u32 TileID;
typedef u32 TriangleID; // #MNM_TODO pavloi 2016.07.19: actually, it means TileTriangleID
typedef u32 OffMeshLinkID;
...
struct GlobalIslandID
{
	...
	GlobalIslandID(u32k navigationMeshID, const MNM::StaticIslandID islandID)
	{
	...
	u32 GetNavigationMeshIDAsUint32() const
	{
...
inline TriangleID ComputeTriangleID(TileID tileID, u16 triangleIdx)
{
...
inline u16 ComputeTriangleIndex(TriangleID triangleID)
{
