...
public:
	...
	i32 GetVersion() const override { return m_version.v; }

	/// Set the path version, should not normally be used.
	virtual void SetVersion(i32 v) override { m_version.v = v; }
	...
	void                          Dump(tukk name) const override;
	...
	void Clear(tukk dbgString) override;
...
private:
	...
	CPathObstacles m_obstacles; // Marcio: Drxsis2
