...
public:
	...
	virtual u32          GetObservableTypeMask() const;
	...
	virtual const Vec3  GetPosInNavigationMesh(u32k agentTypeID) const override;
	...
	virtual i32          GetGroupId() const override;
	...
	////////////////////////////////////////////////////////////////////////////////////////
	//Formations////////////////////////////////////////////////////////////////////////////
	virtual bool        CreateFormation(u32k nCrc32ForFormationName, Vec3 vTargetPos = ZERO) override;
	virtual bool        CreateFormation(tukk szName, Vec3 vTargetPos = ZERO) override;
	...
	tukk           GetEventName(unsigned short eType) const;
...
protected:
	...
	bool     m_bEnabled;
	u16   m_nObjectType;   //	type would be Dummy
...
private:
	...
	i32      m_expectedPhysicsPosFrameId; // Timestamp of m_vExpectedPhysicsPos
