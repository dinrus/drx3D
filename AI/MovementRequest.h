...
#include <drx3D/AI/IPathfinder.h> // MNMDangersFlags, MNMCustomPathCostComputerSharedPtr
...
struct MovementRequest
{
	...
	static tukk GetTypeAsDebugName(Type type)
	{
...
struct MovementRequestStatus
{
	...
	struct PlanStatus
	{
		...
		struct BlockInfo
		{
			...
			BlockInfo(tukk _name) : name(_name) {}
