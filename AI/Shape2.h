...
/********************************************************************
   ...
   Имя файла:   Shape2.h
   $Id$
   Описание: Temp file holding code extracted from CAISystem.h/cpp
...
struct SShape
{
	...
	ListPositions::const_iterator NearestPointOnPath(const Vec3& pos, bool forceLoop, float& dist, Vec3& nearestPt, float* distAlongPath = 0,
	                                                 Vec3* segmentDir = 0, u32* segmentStartIndex = 0, float* pathLength = 0, float* segmentFraction = 0) const;
