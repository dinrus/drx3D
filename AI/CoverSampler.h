...
public:
	...
	virtual u32      GetSurfaceFlags() const;
...
private:
	...
	bool        OverlapCylinder(const Vec3& bottomCenter, const Vec3& dir, float length, float radius, u32 collisionFlags) const;
	...
	bool        IntersectRay(const Vec3& center, const Vec3& dir, u32 collisionFlags, IntersectionResult* result) const;

	SurfaceType GetSurfaceType(IPhysicalEntity* physicalEntity, i32 ipart) const;
	...
	struct SamplingState
	{
		...
		u32         originalSurfaceSamples;
		u32         updateCount;
		mutable u32 pwiCount;
		mutable u32 rwiCount;
	};
