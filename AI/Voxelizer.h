...
#include <drx3D/AI/DynamicSpanGrid.h>
...
{
public:
	size_t ProcessGeometry(u32 hashValueSeed = 0, u32 hashTest = 0, u32* hashValue = 0,
...
private:
	...
	void   VoxelizeGeometry(const Vec3* vertices, u32k* indices, size_t triCount, const Matrix34& worldTM);
	u32 ComputeTerrainHashAndAABB(IGeometry* geometry, AABB& aabb);
