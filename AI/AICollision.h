...
// Simple unique_ptr to allow thread-safe and efficient use of GetEntitiesInBox while not encouraging memory leaks
...
bool IntersectSweptSphere(Vec3* hitPos, float& hitDist, const Lineseg& lineseg,
                          float radius, EAICollisionEntities aiCollisionEntities, IPhysicalEntity** pSkipEnts = 0, i32 nSkipEnts = 0, i32 geomFlagsAny = geom_colltype0);
...
ILINE size_t GetPhysicalEntitiesInBox(Vec3 boxMin, Vec3 boxMax, IPhysicalEntity**& entityList, i32 entityTypes)
{
...
ILINE size_t GetPhysicalEntitiesInBox(Vec3 boxMin, Vec3 boxMax, StaticPhysEntityArray& entityList, i32 entityTypes)
{
...
// OverlapCylinder
//====================================================================
inline bool OverlapCylinder(const Lineseg& lineseg, float radius, EAICollisionEntities aiCollisionEntities, IPhysicalEntity* pSkipEntity = NULL, i32 customFilter = 0, i32* pEntityID = 0, i32 maxIDs = 0)
{
	...
	{
		maxIDs = min(maxIDs, static_cast<i32>(d));
		for (i32 loop = 0; loop < maxIDs; ++loop)
		{
...
// IntersectSegment
//====================================================================
inline bool IntersectSegment(Vec3& hitPos, const Lineseg& lineseg, EAICollisionEntities aiCollisionEntities, i32 filter = rwi_ignore_noncolliding | rwi_stop_at_pierceable)
{
	ray_hit hit;
