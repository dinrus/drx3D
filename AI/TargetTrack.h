...
public:
	...
	void                         Init(tAIObjectID aiGroupOwnerId, tAIObjectID aiObjectId, u32 uConfigHash);
	void                         ResetForPool();
	...
	bool InvokeStimulus(const TargetTrackHelpers::STargetTrackStimulusEvent& stimulusEvent, u32 uStimulusNameHash);
	...
	void   SetDebugGraphIndex(u32 uDebugGraphIndex) { m_uDebugGraphIndex = uDebugGraphIndex; }
	u32 GetDebugGraphIndex() const                  { return m_uDebugGraphIndex; }
	void   DebugDraw(CDebugDrawContext& dc, i32 iIndex, float& fColumnX, float& fColumnY, TargetTrackHelpers::ITargetTrackConfigProxy* pConfigProxy) const;
	...
	typedef VectorMap<u32, SStimulusInvocation> TStimuliInvocationContainer;
...
private:
	...
	void UpdateStimulusPulse(SStimulusInvocation& invoke, u32 uPulseNameHash) const;
