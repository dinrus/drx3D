...
// -------------------------------------------------------------------------
//  Имя файла:   ObjectContainer.h
//  Created:     11/02/2008 by Matthew
//  Описание: Manages the stubs and pointers to all AI objects
// -------------------------------------------------------------------------
//  История:
//
////////////////////////////////////////////////////////////////////////////
...
public:
	...
	i32                           ReleaseDeregisteredObjects(bool checkForLeaks);
	...
	i32                 GetNumRegistered() { return m_snObjectsRegistered - m_snObjectsDeregistered; }
...
protected:
	...
	static i32    m_snObjectsRegistered, m_snObjectsDeregistered;
...
#include <drx3D/AI/Reference.inl>
