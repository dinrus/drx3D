...
// CPathObstacles
//===================================================================
class CPathObstacles : public IPathObstacles
{
public:
	CPathObstacles();
	~CPathObstacles();
...
private:
	...
	i32        m_lastCalculatePathVersion;

	/// size of the cache of obstacle shapes
	static i32 s_obstacleCacheSize;
	...
	static i32k                   s_maxDynamicObstacleFlags = 256;
