...
template<
  ...
  , typename YourIndexType//	<=HIGHLY recommend this be i32
  >
class GraphTraits
{
public:
	...
	i32                GetNumLinks(IndexType nodeIndex) const;
	IndexType          GetNextNodeIndex(IndexType graphNodeIndex, i32 linkIndex) const;
};
...
/////////////////////////////////////////////////////////////////////////////
//AStar OpenList Node////////////////////////////////////////////////////////
template<typename IndexType = i32>
struct AStarNode
{
	float                       G, F;
...
#define BYTES_PER_INT sizeof(i32)
...
template<>
class DefaultClosedList<i32>
{
	std::vector<i32> BitArray;
	i32              ArraySize;
public:
...
public:
	...
	i32 Update(i32 theMaxNumNodesToProcess)
	{
		for (; 0 < theMaxNumNodesToProcess; --theMaxNumNodesToProcess)
		{
			...
			{
				i32 numLinks = graph->GetNumLinks(currentAStarNode->graphNodeIndex);
				for (i32 linkIndex = 0; linkIndex < numLinks; ++linkIndex)
				{
