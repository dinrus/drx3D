...
//////////////////////////////////////////////////////////////////////////
void CAINavigationMarkupShapeComponent::SMarkupShapeProperties::ReflectType(sxema::CTypeDesc<CAINavigationMarkupShapeComponent::SMarkupShapeProperties>& desc)
{
	desc.SetGUID("7070E098-2FB0-4C7B-8DFF-B9ED76B93D6D"_drx_guid);
}
...
void CAINavigationMarkupShapeComponent::ReflectType(sxema::CTypeDesc<CAINavigationMarkupShapeComponent>& desc)
{
...
void CAINavigationMarkupShapeComponent::Register(sxema::IEnvRegistrar& registrar)
{
	sxema::CEnvRegistrationScope entityScope = registrar.Scope(IEntity::GetEntityScopeGUID());
	{
		sxema::CEnvRegistrationScope componentScope = entityScope.Register(SXEMA_MAKE_ENV_COMPONENT(CAINavigationMarkupShapeComponent));
		{
			// Functions
			{
				auto pFunction = SXEMA_MAKE_ENV_FUNCTION(&CAINavigationMarkupShapeComponent::SetAnnotationFlag, "299851E7-89E1-431B-A9E0-E085361F674D"_drx_guid, "SetAnnotationFlag");
			...
			{
				auto pFunction = SXEMA_MAKE_ENV_FUNCTION(&CAINavigationMarkupShapeComponent::ToggleAnnotationFlags, "9E1F9DCE-58D4-4A11-B5B3-3D9D2578DDDE"_drx_guid, "ToggleAnnotationFlags");
			...
			{
				auto pFunction = SXEMA_MAKE_ENV_FUNCTION(&CAINavigationMarkupShapeComponent::ResetAnotations, "2BDD2A21-25EE-4C07-A851-7CCA758EAE0C"_drx_guid, "ResetAnotation");
...
void CAINavigationMarkupShapeComponent::ToggleAnnotationFlags(const sxema::CSharedString& shapeName, const NavigationComponentHelpers::SAnnotationFlagsMask& flags)
{
	size_t index = 0;
	...
	{
		DrxWarning(VALIDATOR_MODULE_AI, VALIDATOR_WARNING, "NavigationMarkupShapes::SwitchAnnotationFlag, invalid shape name '%s'!", shapeName.c_str());
		return;
	}
...
void CAINavigationMarkupShapeComponent::SetAnnotationFlag(const sxema::CSharedString& shapeName, const NavigationAreaFlagID& flagId, bool bEnable)
{
	size_t index = 0;
	for (size_t count = m_shapesProperties.shapes.size(); index < count; ++index)
	{
	...
	if (index >= m_runtimeData.size())
	{
		DrxWarning(VALIDATOR_MODULE_AI, VALIDATOR_WARNING, "NavigationMarkupShapes::SetAnnotationFlag, invalid shape name '%s'!", shapeName.c_str());
		return;
	}
