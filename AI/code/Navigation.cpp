...
//
//-----------------------------------------------------------------------------------------------------------
void CNavigation::LoadNavigationData(tukk szLevel, tukk szMission)
{
...
//
//-----------------------------------------------------------------------------------------------------------
bool CNavigation::GetDesignerPath(tukk szName, SShape& path) const
{
...
void CNavigation::ReadAreasFromFile(CDrxBufferedFileReader& file, i32 fileVersion)
{
	FlushAllAreas();
...
//====================================================================
float CNavigation::GetNearestPointOnPath(tukk szPathName, const Vec3& vPos, Vec3& vResult, bool& bLoopPath, float& totalLength) const
{
...
//====================================================================
void CNavigation::GetPointOnPathBySegNo(tukk szPathName, Vec3& vResult, float segNo) const
{
	vResult = ZERO;
...
//
//-----------------------------------------------------------------------------------------------------------
bool CNavigation::DoesNavigationShapeExists(tukk szName, EnumAreaType areaType, bool road)
{
...
//-----------------------------------------------------------------------------------------------------------
void CNavigation::DeleteNavigationShape(tukk szName)
{
...
tukk CNavigation::GetNearestPathOfTypeInRange(IAIObject* requester, const Vec3& reqPos, float range, i32 type, float devalue, bool useStartNode)
{
	AIAssert(requester);
...
//====================================================================
IAISystem::ENavigationType CNavigation::CheckNavigationType(const Vec3& pos, i32& nBuildingID, IAISystem::tNavCapMask navCapMask) const
{
...
void CNavigation::GetMemoryStatistics(IDrxSizer* pSizer)
{
	{
