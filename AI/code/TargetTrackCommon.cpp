...
/*************************************************************************
   ...
   $Id$
   $DateTime$
   Описание: Defines common helpers for the Target Track system
...
//////////////////////////////////////////////////////////////////////////
STargetTrackStimulusEvent::STargetTrackStimulusEvent(tAIObjectID ownerId, tAIObjectID targetId, tukk szStimulusName, const SStimulusEvent& eventInfo)
...
//////////////////////////////////////////////////////////////////////////
STargetTrackPulseConfig::STargetTrackPulseConfig(tukk szPulse, float fValue, float fDuration)
	: m_sPulse(szPulse)
	, m_fValue(fValue)
...
//////////////////////////////////////////////////////////////////////////
STargetTrackModifierConfig::STargetTrackModifierConfig(u32 uId, float fValue, float fLimit)
	: m_uId(uId)
	, m_fValue(fValue)
	, m_fLimit(0.0f)
	, m_bInherited(false)
...
//////////////////////////////////////////////////////////////////////////
STargetTrackStimulusConfig::STargetTrackStimulusConfig(tukk szStimulus, bool bHostileOnly, float fPeak, float fSustainRatio, float fAttack, float fDecay, float fRelease, float fIgnore)
	...
	, m_ucInheritanceMask(other.m_ucInheritanceMask)
{
	...
	{
		u32k uOtherPulseHash = itOtherPulse->first;
...
//////////////////////////////////////////////////////////////////////////
STargetTrackConfig::STargetTrackConfig(tukk szName)
	: m_sName(szName)
	, m_bTemplateApplied(false)
{
