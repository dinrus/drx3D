...
//////////////////////////////////////////////////////////////////////////
bool CTargetTrackDistanceModifier::IsMatchingTag(tukk szTag) const
{
...
//////////////////////////////////////////////////////////////////////////
bool CTargetTrackHostileModifier::IsMatchingTag(tukk szTag) const
{
	return stricmp(szTag, GetTag()) == 0;
}
...
//////////////////////////////////////////////////////////////////////////
bool CTargetTrackClassThreatModifier::IsMatchingTag(tukk szTag) const
{
	return stricmp(szTag, GetTag()) == 0;
}
                                                   ...
                                                   const TargetTrackHelpers::STargetTrackModifierConfig& modConfig) const
{
	...
	const float fClassThreat = gAIEnv.pTargetTrackUpr->GetTargetClassThreat(aiObjectId);
...
//////////////////////////////////////////////////////////////////////////
bool CTargetTrackDistanceIgnoreModifier::IsMatchingTag(tukk szTag) const
{
	return stricmp(szTag, GetTag()) == 0;
}
...
bool CTargetTrackPlayerModifier::IsMatchingTag(tukk tag) const
{
