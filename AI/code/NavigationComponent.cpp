...
void CEntityAINavigationComponent::SStateUpdatedSignal::ReflectType(sxema::CTypeDesc<SStateUpdatedSignal>& desc)
{
	desc.SetGUID("cb398038-bf76-4c32-935a-0956dda8fc69"_drx_guid);
...
void CEntityAINavigationComponent::SNavigationCompletedSignal::ReflectType(sxema::CTypeDesc<SNavigationCompletedSignal>& desc)
{
	desc.SetGUID("a6a897d3-2a30-4bc2-b14c-823baf2a2dc6"_drx_guid);
	desc.SetLabel("NavigationCompleted");
	desc.SetDescription("Sent when a navigation request is completed.");
}

void CEntityAINavigationComponent::SNavigationFailedSignal::ReflectType(sxema::CTypeDesc<SNavigationFailedSignal>& desc)
{
	desc.SetGUID("52d3b5de-7096-4de7-9ec7-a769e092d2d2"_drx_guid);
...
void CEntityAINavigationComponent::ReflectType(sxema::CTypeDesc<CEntityAINavigationComponent>& desc)
{
	desc.AddBase<IEntityNavigationComponent>();
	desc.SetGUID("1b988fa3-2cc8-4dfa-9107-a63aded77e91"_drx_guid);
...
void CEntityAINavigationComponent::Register(sxema::IEnvRegistrar& registrar)
{
	sxema::CEnvRegistrationScope scope = registrar.Scope(IEntity::GetEntityScopeGUID());
	{
		sxema::CEnvRegistrationScope componentScope = scope.Register(SXEMA_MAKE_ENV_COMPONENT(CEntityAINavigationComponent));

		// Functions
		{
			auto pFunction = SXEMA_MAKE_ENV_FUNCTION(&CEntityAINavigationComponent::SetRequestedVelocity, "e99ce354-1c57-404f-926e-b56b0254a12d"_drx_guid, "SetRequestedVelocity");
		...
		{
			auto pFunction = SXEMA_MAKE_ENV_FUNCTION(&CEntityAINavigationComponent::GetRequestedVelocity, "d6e2454f-fb39-4c7e-bec4-615e33c23322"_drx_guid, "GetRequestedVelocity");
		...
		{
			auto pFunction = SXEMA_MAKE_ENV_FUNCTION(&CEntityAINavigationComponent::NavigateTo, "d7ef4d30-dc99-41df-a0b5-eb21760b84a3"_drx_guid, "NavigateTo");
		...
		{
			auto pFunction = SXEMA_MAKE_ENV_FUNCTION(&CEntityAINavigationComponent::IsDestinationReachable, "86b5dd4d-518d-4baa-b3e6-c3bae725bb88"_drx_guid, "IsDestinationReachable");
		...
		{
			auto pFunction = SXEMA_MAKE_ENV_FUNCTION(&CEntityAINavigationComponent::StopMovement, "c4c3fc49-5884-48c6-9d71-bbd30ad7dced"_drx_guid, "Stop");
			pFunction->SetDescription("Stops current navigation");
			componentScope.Register(pFunction);
		}
		{
			auto pFunction = SXEMA_MAKE_ENV_FUNCTION(&CEntityAINavigationComponent::TestRaycastHit, "3b354256-7197-4fce-9d37-4ff37bc07c76"_drx_guid, "TestRaycastHit");
		...
		{
			auto pFunction = SXEMA_MAKE_ENV_FUNCTION(&CEntityAINavigationComponent::IsRayObstructed, "3813108c-e614-46ec-a029-f5ab0b85500c"_drx_guid, "IsRayObstructed");
		...
		// Signals
		{
			componentScope.Register(SXEMA_MAKE_ENV_SIGNAL(SStateUpdatedSignal));
			componentScope.Register(SXEMA_MAKE_ENV_SIGNAL(SNavigationCompletedSignal));
			componentScope.Register(SXEMA_MAKE_ENV_SIGNAL(SNavigationFailedSignal));
		}
	}
}
...
{
	DRX_ASSERT(gEnv && gEnv->pAISystem && gEnv->pAISystem->GetMovementSystem());
...
void CEntityAINavigationComponent::SetNavigationAgentType(tukk szTypeName)
{
...
void CEntityAINavigationComponent::NewStateComputed(const PathFollowResult& result, uk pSender)
{
...
void CEntityAINavigationComponent::FillPathFollowerParams(PathFollowerParams& params) const
{
	...
	params.normalSpeed = drxmath::clamp(m_movementProperties.normalSpeed, m_movementProperties.minSpeed, m_movementProperties.maxSpeed);
