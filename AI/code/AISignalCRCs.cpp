...
//		AI actions order.
static tukk const AIORD_ATTACK = "ORD_ATTACK";
static tukk const AIORD_SEARCH = "ORD_SEARCH";
static tukk const AIORD_REPORTDONE = "ORD_DONE";
static tukk const AIORD_REPORTFAIL = "ORD_FAIL";
