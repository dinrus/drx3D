...
/*************************************************************************
   ...
   $Id$
   $DateTime$
   Описание: Rate of Death handling for the Puppet
...
#include <drx3D/AI/IAIRateOfDeathHandler.h>
...
void CPuppet::HandleBurstFireInit()
{
	...
	if (m_targetZone == AIZONE_WARN)
		m_targetSeenTime = std::max(0.0f, m_targetSeenTime - (drx_random(1, 3)) / 10.0f);
