...
tukk MovementActor::GetName() const
{
...
void MovementActor::Log(tukk message)
{
...
bool MovementActor::AddActionAbilityCallbacks(const SMovementActionAbilityCallbacks& ability)
{
	...
	DRX_ASSERT_MESSAGE(bNoCallbackAlreadyPresent, "MovementActor::AddActionAbilityCallbacks - Trying to add the same movement action ability twice");
	return true;
}
