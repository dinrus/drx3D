...
//
//----------------------------------------------------------------------------------------------------
void CUnitImg::ClearPlanning(i32 priority)
{
	if (priority)
	{
...
void CUnitImg::Serialize(TSerialize ser)
{
	...
	DRX_ASSERT_MESSAGE(m_Plan.empty(), "Todo: implement serialization of m_Plan");
...
void CUnitAction::Serialize(TSerialize ser)
{
	...
	DRX_ASSERT_MESSAGE(false, "Todo: implement serialization of blocked actions");
