...
bool AIQueueBubbleMessage(tukk messageName, const EntityId entityID,
                          tukk message, u32 flags, float duration /*= 0*/, SAIBubbleRequest::ERequestType requestType /* = eRT_ErrorMessage */)
{
...
static u32 ComputeMessageNameId(tukk szMessageName)
{
	return CCrc32::ComputeLowercase(szMessageName);
}

SBubbleRequestId CAIBubblesSystem::QueueMessage(tukk messageName, const SAIBubbleRequest& request)
{
	...
	u32k messageNameId = ComputeMessageNameId(messageName);
...
public:
	...
	void DrawBubble(tukk const message, const size_t numberOfLines, const EBubbleRequestOption flags)
	{
...
private:
	...
	void DrawBubbleMessage(tukk const szMessage, const Vec3& drawingPosition, const bool bFramed, const bool bDepthTest)
	{
		SDrawTextInfo ti;
...
void CAIBubblesSystem::LogMessage(tukk const message, const TBubbleRequestOptionFlags flags) const
{
...
void CAIBubblesSystem::PopupBlockingAlert(tukk const message, const TBubbleRequestOptionFlags flags) const
{
	...
	{
		DrxMessageBox(message, "AIBubbleSystemMessageBox");
	}
}
...
bool CAIBubblesSystem::ShouldFilterOutMessage(u32k messsageNameUniqueId) const
{
...
void CAIBubblesSystem::SetNameFilter(tukk szMessageNameFilter)
{
