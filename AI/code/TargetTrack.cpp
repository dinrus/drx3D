...
/*************************************************************************
   ...
   $Id$
   $DateTime$
   Описание: Maintains an interest level of an agent's perception on a
...
void CTargetTrack::SStimulusInvocation::Serialize(TSerialize ser)
{
	...
	u8 stimulusType = (int8)m_eStimulusType;
...
//////////////////////////////////////////////////////////////////////////
void CTargetTrack::Init(tAIObjectID aiGroupOwnerId, tAIObjectID aiObjectId, u32 uConfigHash)
{
...
bool CTargetTrack::Update(float fCurrTime, TargetTrackHelpers::ITargetTrackConfigProxy* pConfigProxy)
{
	...
	i32k iFrameId = pAISystem->GetAITickCount();
	if (iFrameId != m_iLastUpdateFrame)
	{
		...
		for (; itStimulusInvoke != itStimulusInvokeEnd; ++itStimulusInvoke)
		{
			u32k uStimulusHash = itStimulusInvoke->first;
...
//////////////////////////////////////////////////////////////////////////
bool CTargetTrack::InvokeStimulus(const TargetTrackHelpers::STargetTrackStimulusEvent& stimulusEvent, u32 uStimulusNameHash)
{
	DRX_PROFILE_FUNCTION(PROFILE_AI);
...
//////////////////////////////////////////////////////////////////////////
bool CTargetTrack::TriggerPulse(u32 uStimulusNameHash, u32 uPulseNameHash)
{
	DRX_PROFILE_FUNCTION(PROFILE_AI);
...
void CTargetTrack::UpdateStimulusInvoke(SStimulusInvocation& invoke, const TargetTrackHelpers::STargetTrackStimulusEvent& stimulusEvent) const
{
	...
	else
	{
		if (pTarget)
			...
			DRX_ASSERT_MESSAGE(0, "No position could be set from invoked stimulus event!");
	}
...
//////////////////////////////////////////////////////////////////////////
void CTargetTrack::UpdateStimulusPulse(SStimulusInvocation& invoke, u32 uPulseNameHash) const
{
...
#ifdef TARGET_TRACK_DEBUG
//////////////////////////////////////////////////////////////////////////
void CTargetTrack::DebugDraw(CDebugDrawContext& dc, i32 iIndex, float& fColumnX, float& fColumnY, TargetTrackHelpers::ITargetTrackConfigProxy* pConfigProxy) const
{
