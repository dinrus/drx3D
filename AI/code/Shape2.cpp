...
// CShapeMask
//===================================================================
CShapeMask::CShapeMask() : m_nx(0), m_ny(0), m_dx(0), m_dy(0), m_bytesPerRow(0)
{
}
...
// GetBox
//===================================================================
void CShapeMask::GetBox(Vec3& min, Vec3& max, i32 i, i32 j)
{
...
// SShape
//===================================================================
SShape::SShape(const ListPositions& shape_, bool allowMask, IAISystem::ENavigationType navType_, i32 type_,
...
SShape::SShape(const ListPositions& shape_, const AABB& aabb_, IAISystem::ENavigationType navType /*= IAISystem::NAV_UNSET */,
               i32 type /*= 0 */, bool closed_ /*= false */, float height_ /*= 0.0f */, EAILightLevel lightLevel_ /*= AILL_NONE */,
               bool temp /*= false */)
	: shape(shape_)
	, aabb(aabb_)
...
ListPositions::const_iterator SShape::NearestPointOnPath(const Vec3& pos, bool forceLoop, float& dist, Vec3& nearestPt,
                                                         ...
                                                         u32* segmentStartIndex, float* pathLength, float* segmentFraction) const
{
	if (shape.empty())
		return shape.end();
...
i32 SShape::GetIntersectionDistances(const Vec3& start, const Vec3& end, float intersectDistArray[], i32 maxIntersections, bool testHeight /*=false*/, bool testTopBottom /*=false*/) const
{
...
SPerceptionModifierShape::SPerceptionModifierShape(const ListPositions& shape, float reductionPerMetre, float reductionMax, float fHeight, bool isClosed) : SShape(shape)
{
	height = fHeight;
	closed = isClosed;
