...
/********************************************************************
   -------------------------------------------------------------------------
   Имя файла:   AIDynHideObjectUpr.cpp
   $Id$
...
static i32k MAX_NEW_ITEMS_PER_QUERY = 10;
// The cache size.
static u32k HIDEOBJECT_CACHE_SIZE = 250;

//===================================================================
// CAIDynHideObjectUpr
//===================================================================
CAIDynHideObjectUpr::CAIDynHideObjectUpr()
{
...
// Reset
//===================================================================
void CAIDynHideObjectUpr::Reset()
{
	m_cacheFreeList.resize(HIDEOBJECT_CACHE_SIZE);
	for (i32 i = 0; i < HIDEOBJECT_CACHE_SIZE; ++i)
		m_cacheFreeList[i] = i;
...
//===================================================================
void CAIDynHideObjectUpr::FreeCacheItem(i32 i)
{
...
//===================================================================
i32 CAIDynHideObjectUpr::GetNewCacheItem()
{
	if (m_cacheFreeList.empty())
	{
		...
		float maxTime = 0;
		i32 maxIdx = 0; // If all the times are the same (or even 0!), delete the first item.
		for (i32 i = 0; i < HIDEOBJECT_CACHE_SIZE; ++i)
		{
...
//===================================================================
void CAIDynHideObjectUpr::GetHidePositionsWithinRange(std::vector<SDynamicObjectHideSpot>& hideSpots,
                                                          const Vec3& pos, float radius,
                                                          IAISystem::tNavCapMask navCapMask, float passRadius,
                                                          u32 lastNavNodeIndex)
{
...
//===================================================================
void CAIDynHideObjectUpr::InvalidateHideSpotLocation(const Vec3& pos, EntityId objectEntId)
{
...
// ValidateHideSpotLocation
//===================================================================
bool CAIDynHideObjectUpr::ValidateHideSpotLocation(const Vec3& pos, const SAIBodyInfo& bi, EntityId objectEntId)
{
...
//===================================================================
u32 CAIDynHideObjectUpr::GetPositionHashFromEntity(IEntity* pEntity)
{
...
// DebugDraw
//===================================================================
void CAIDynHideObjectUpr::DebugDraw()
{
