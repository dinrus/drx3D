...
private:
	...
	struct TileLinks
	{
		...
		void CopyLinks(TriangleLink* links, u16 linkCount);

		TriangleLink* triangleLinks;
		u16        triangleLinkCount;
	};
...
public:
	...
	{
		QueryLinksResult(const TriangleLink* _firstLink, u16 _linkCount)
	...
	QueryLinksResult GetLinksForTriangle(const TriangleID triangleID, u16k index) const;
