...
{
public:
	COPSeekCover(bool uncover, float radius, float minRadius, i32 iterations, bool useLastOpAsBackup, bool towardsLastOpResult);
...
private:
	...
	void CalcStrafeCoverTree(SAIStrafeCoverPos& pos, i32 i, i32 j, const Vec3& center, const Vec3& forw, const Vec3& right,
