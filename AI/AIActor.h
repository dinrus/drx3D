...
/********************************************************************
   ...
   Имя файла:   AIActor.h
   $Id$
   Описание: Header for the CAIActor class
...
#include <drx3D/AI/ValueHistory.h>
...
struct SAIDamagePart
{
	...
	i32   surfaceIdx; // The index of the surface material.
};
...
public:
	...
	void                      SetBehaviorVariable(tukk variableName, bool value) override;
	bool                      GetBehaviorVariable(tukk variableName) const;

	void                      ResetModularBehaviorTree(EObjectResetType type) override;
	virtual void              SetModularBehaviorTree(tukk szTreeName) override { m_modularBehaviorTreeName = szTreeName; ResetModularBehaviorTree(AIOBJRESET_INIT); }
	...
	virtual tukk                 GetPathAgentName() const override;
	...
	virtual bool IsPointValidForAgent(const Vec3& pos, u32 flags) const override { return true; }
	//IAIPathAgent//////////////////////////////////////////////////////////////////////////
	////////////////////////////////////////////////////////////////////////////////////////
	...
	virtual void                SetSignal(i32 nSignalID, tukk szText, IEntity* pSender = 0, IAISignalExtraData* pData = NULL, u32 crcCode = 0) override;
	...
	virtual void                SetGroupId(i32 id) override;
	virtual void                SetFactionID(u8 factionID) override;

	virtual void                SetObserver(bool observer);
	virtual u32              GetObserverTypeMask() const;
	virtual u32              GetObservableTypeMask() const override;

	virtual void                ReactionChanged(u8 factionID, IFactionMap::ReactionType reaction);
	...
	virtual void                BehaviorChanged(tukk current, tukk previous) override;
	...
	void CoordinationEntered(tukk signalName);
	void CoordinationExited(tukk signalName);
	...
	virtual void               SetTerritoryShapeName(tukk szName) override;
	virtual tukk        GetTerritoryShapeName() const override;
	virtual tukk        GetWaveName() const override { return m_Parameters.m_sWaveName.c_str(); }
...
protected:
	...
	u32 GetFactionVisionMask(u8 factionID) const;
...
private:
	void StartBehaviorTree(tukk behaviorName);
