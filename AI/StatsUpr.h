...
public:
	...
	void SetStat(EStatistics eStat, i32 iValue)
...
private:
	...
	struct SStatMetadata
	{
		...
		i32         flags;            // EStatFlags	specifying how to treat the value
		tukk format;           // Optional printf format specifier
	};
