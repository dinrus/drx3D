...
{
public:
	COPStick(float fStickDistance, float fAccuracy, float fDuration, i32 fFlags, i32 nFlagsAux, ETraceEndMode eTraceEndMode = eTEM_FixedDistance);
...
private:
	...
	inline EGoalOpResult HandlePathDecision(CPipeUser* pPipeUser, i32 nPathDecision, bool b2D);
