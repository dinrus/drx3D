...
struct IEntityNavigationComponent : public IEntityComponent
{
	...
	virtual void SetNavigationAgentType(tukk szTypeName) = 0;
	...
	static void ReflectType(sxema::CTypeDesc<IEntityNavigationComponent>& desc)
	{
		desc.SetGUID("F2D45F94-8558-4C4F-8FFF-697783BEEB7C"_drx_guid);
	}
};