...
/********************************************************************
   -------------------------------------------------------------------------
   Имя файла:   ShapeContainer.h
   $Id$
   Описание: Shape containers.
...
struct SQuadTreeAIShapeElement
{
	...
	SQuadTreeAIShapeElement(ShapeClass* pShape = 0) : m_pShape(pShape), m_counter(-1) {}
...
/*
   ...
   inline CAISpecialArea* CAISpecialAreaContainer::GetShapeById(i32 id)
   {
