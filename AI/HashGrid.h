...
template<i32 NumberOfCells, typename ValueType, typename KeyHash,
...
public:
	...
	u32 query_sphere(const key_type& center, const key_value& radius, Container& container) const
	{
		u32 count = 0;
	...
	template<typename Container>
	u32 query_sphere_distance(const key_type& center, const key_value& radius, Container& container) const
	{
		u32 count = 0;
	...
	template<typename Container>
	u32 query_box(const key_type& minc, const key_type& maxc, Container& container) const
	{
		u32 count = 0;
