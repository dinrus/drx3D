...
public:
	...
	u32 GetID() const { return m_nControllerId; }
	...
	virtual i32      GetO_numKey() const { return -1; } //only implemented for the PQ controller
	virtual i32      GetP_numKey() const { return -1; } //only implemented for the PQ controller
...
{
public:
	bool operator()(const IController* a, u32 nID) { assert(a != (IController*)NULL); return a->GetID() < nID; }
	bool operator()(u32 nID, const IController* b) { assert(b != (IController*)NULL); return nID < b->GetID(); }
};
