...
public://private:
	void UnloadAnimationAssets(i32 index);
...
public:
	...
	bool          Push(const IAnimationPoseModifierPtr pPoseModifier, tukk name, const bool bQueued);
	...
	u32        GetSize();
	void          AddToSizer(IDrxSizer* pSizer) const;
