...
struct DRX_ALIGN(128) Console
{
	...
	void Init();
	tukk ca_CharEditModel;
	tukk ca_FilterJoints;
	tukk ca_DebugCommandBufferFilter;
	string ca_DebugTextTarget;
	u32 ca_DebugTextLayer;

#ifndef _RELEASE
	i32 ca_DebugAnimUsageOnFileAccess;
	i32 ca_AttachmentTextureMemoryBudget;
#endif
	...
	i32 ca_physicsProcessImpact;
	i32 ca_MemoryUsageLog;
	i32 ca_MemoryDefragPoolSize;
	i32 ca_MemoryDefragEnabled;
	i32 ca_ParametricPoolSize;

	i32 ca_StreamCHR;
	i32 ca_StreamDBAInPlace;
	...
	i32 ca_ResetCulledJointsToBindPose;

	f32 ca_MotionBlurMovementThreshold;

	i32 ca_vaEnable;
	i32 ca_vaProfile;
	i32 ca_vaBlendEnable;
	i32 ca_vaBlendPostSkinning;
	i32 ca_vaBlendCullingDebug;
	f32 ca_vaScaleFactor;
	f32 ca_vaBlendCullingThreshold;

	i32 ca_vaUpdateTangents;
	i32 ca_vaSkipVertexAnimationLOD;
	i32 ca_AttachmentMergingMemoryBudget;
