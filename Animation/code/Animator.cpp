...
std::map<STxt, Matrix4> Animator::CalculateCurrentAnimationPose() const {
...
std::map<STxt, Matrix4> Animator::InterpolatePoses(const Keyframe &previousFrame, const Keyframe &nextFrame, float progression) const {
	std::map<STxt, Matrix4> currentPose;
...
void Animator::CalculateJointPose(const std::map<STxt, Matrix4> &currentPose, const Joint &joint, const Matrix4 &parentTransform, std::vector<Matrix4> &jointMatrices) {
