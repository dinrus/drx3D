...
i32 SNode::ResolveJointIndex(const CDefaultSkeleton& skeleton) const
{
	i32 index = skeleton.GetJointIDByCRC32(crc32);
	if (index > -1)
		return index;
	return -1;
}
...
bool Serialize(Serialization::IArchive& ar, PoseModifier::SNode& value, tukk name, tukk label)
{
