...
void CFacialEffCtrl::Serialize(CFacialEffectorsLibrary* pLibrary, XmlNodeRef& node, bool bLoading)
{
	...
	if (bLoading)
	{
		...
		tukk sEffectorName = node->getAttr("Effector");
...
//////////////////////////////////////////////////////////////////////////
IFacialEffector* CFacialEffector::GetSubEffector(i32 nIndex)
{
	assert(nIndex >= 0 && nIndex < (i32)m_subEffectors.size());
...
//////////////////////////////////////////////////////////////////////////
IFacialEffCtrl* CFacialEffector::GetSubEffCtrl(i32 nIndex)
{
	assert(nIndex >= 0 && nIndex < (i32)m_subEffectors.size());
...
//////////////////////////////////////////////////////////////////////////
IFacialEffCtrl* CFacialEffector::GetSubEffCtrlByName(tukk effectorName)
{
	i32 subEffectorCount = (i32)m_subEffectors.size();
	for (i32 i = 0; i < subEffectorCount; ++i)
	{
#ifdef FACE_STORE_ASSET_VALUES
...
void CFacialEffector::GetMemoryUsage(IDrxSizer* pSizer) const
{
...
//////////////////////////////////////////////////////////////////////////
void CFacialEffectorAttachment::SetParamString(EFacialEffectorParam param, tukk str)
{
	switch (param)
	{
...
//////////////////////////////////////////////////////////////////////////
tukk CFacialEffectorAttachment::GetParamString(EFacialEffectorParam param)
{
	switch (param)
	{
	case EFE_PARAM_BONE_NAME:
...
#else
	DrxFatalError("Vec3 Params are not stored on consoles!");
#endif
	return Vec3(0, 0, 0);
