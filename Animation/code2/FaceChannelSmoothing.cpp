...
{
void ApplyKernel(CFacialAnimChannelInterpolator* pSpline, CFacialAnimChannelInterpolator* pReference, i32 kernelSize, const float* kernel);
void ApplyKernelNoiseFilter(CFacialAnimChannelInterpolator* pSpline, CFacialAnimChannelInterpolator* pReference, i32 kernelSize, const float* kernel, float threshold);
...
void FaceChannel::ApplyKernel(CFacialAnimChannelInterpolator* pSpline, CFacialAnimChannelInterpolator* pReference, i32 kernelSize, const float* kernel)
{
...
void FaceChannel::ApplyKernelNoiseFilter(CFacialAnimChannelInterpolator* pSpline, CFacialAnimChannelInterpolator* pReference, i32 kernelSize, const float* kernel, float threshold)
{
	float length = pReference->GetKeyTime(pReference->GetKeyCount() - 1);
...
// Suppress uninitMemberVar for kernel as the analyzer is unable to detect initialization through reference
...
i32 FaceChannel::GaussianKernel::GetKernelSize() const
{
	return KERNEL_SIZE;
}
