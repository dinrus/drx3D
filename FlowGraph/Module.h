 ...
 * Modules are managed by an editor manager Editor:FlowGraphModuleUpr.h and a runtime manager - DinrusAction:ModuleUpr.h
 */
...
{
	friend class CFlowGraphModuleUpr;
...
public:
	...
	virtual tukk                                GetPath() const                       { return m_fileName.c_str(); }
...
private:
	...
	bool PreLoadModule(tukk fileName);                           //! load initial data, create nodes
	bool LoadModuleGraph(tukk moduleName, tukk fileName); //! load actual flowgraph
