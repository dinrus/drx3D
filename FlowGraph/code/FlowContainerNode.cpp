...
public:
	...
	virtual void GetConfiguration(SFlowNodeConfig& config)
	{
		static const SInputPortConfig inputs[] = {
			InputPortConfig<i32>("Id",     0,                            _HELP("Id for the container")),
			InputPortConfig_Void("Create", _HELP("Create a container")),
			{ 0 }
		};

		static const SOutputPortConfig outputs[] = {
			OutputPortConfig<i32>("Error",      _HELP("the number specifies the error - 1: Container already exists")),
			OutputPortConfig_AnyType("Success", _HELP("Operation successfully completed")),
			OutputPortConfig<i32>("Id",         _HELP("Id of the container if successfully created")),
			{ 0 }
		};
		...
		case eFE_Activate:
			{
				...
				{
					i32 id = GetPortInt(pActInfo, EIP_Id);
...
public:
	...
	{
		static const SInputPortConfig inputs[] = {
			InputPortConfig<i32>("Id",           _HELP("Which container to manipulate")),
		...
		static const SOutputPortConfig outputs[] = {
			OutputPortConfig<i32>("Error",      _HELP("the number specifies the error - 1: Container ID is invalid")),
			OutputPortConfig_AnyType("Success", _HELP("Operation successfully completed")),
			{ 0 }
		};
...
public:
	...
	virtual void GetConfiguration(SFlowNodeConfig& config)
	{
		...
		static const SOutputPortConfig outputs[] = {
			OutputPortConfig<i32>("Error",  _HELP("the number specifies the error - 1: containerId is invalid")),
