...
/*************************************************************************
   ...
   $Id$
   $DateTime$
   Описание:	Kinect (Xbox One) Flowgraph nodes. These nodes can be used
...
public:
	...
	virtual void OnVoiceCommand(tukk voiceCommand)
	{
		if (m_active)
		{
	...
	virtual void OnGrammarChange(tukk grammarName, eGrammaChange change) {};
