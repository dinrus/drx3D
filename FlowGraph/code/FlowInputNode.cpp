...
//               * Deprecated Input:ActionMapUpr, Input:ActionListener, Input:ActionFilter
...
public:
	...
	void GetConfiguration(SFlowNodeConfig& config)
	{
		...
		static const SInputPortConfig inputs[] =
		{
			InputPortConfig<i32>("Controller", _HELP("Number of the controller that should rumble" ), _HELP("Controller Number"), _UICONFIG("enum_int:1=0,2=1,3=2,4=3")),
