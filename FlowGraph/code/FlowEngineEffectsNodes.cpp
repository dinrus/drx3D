...
static float GetCustomValue(const SFlowNodeConfig& config, TBaseNodeClass* pFlowBaseNode, bool bIsEnabled, IFlowNode::SActivationInfo* pActInfo, i32 portIndex, bool& isOk)
{
...
static void GetCustomValueVec3(Vec3& customValue, const SFlowNodeConfig& config, TBaseNodeClass* pFlowBaseNode, bool bIsEnabled, IFlowNode::SActivationInfo* pActInfo, i32 portIndex, bool& isOk)
{
	if (pFlowBaseNode && pActInfo && isOk)
	{
		if (bIsEnabled)
...
struct SColorCorrection
{
	...
	static void Disable()
	{
		...
		for (i32 i = 2; config.pInputPorts[i].name; ++i)
		{
...
struct SFilterBlur
{
	static void GetConfiguration(SFlowNodeConfig& config)
	{
		static const SInputPortConfig inputs[] =
		{
			InputPortConfig<bool>("Enabled",                false, "Enables node",                 "Enabled"),
			InputPortConfig<bool>("Disabled",               true,  "Disables node",                "Disabled"),
			InputPortConfig<i32>("FilterBlurring_Type",     0,     "Set blur type, 0 is Gaussian", "Type"),
...
struct SFilterSharpen
{
	static void GetConfiguration(SFlowNodeConfig& config)
	{
		static const SInputPortConfig inputs[] =
		{
			InputPortConfig<bool>("Enabled",                  false, "Enables node",                              "Enabled"),
			InputPortConfig<bool>("Disabled",                 true,  "Disables node",                             "Disabled"),
			InputPortConfig<i32>("FilterSharpening_Type",     0,     "Sets sharpening filter, 0 is Unsharp Mask", "Type"),
...
struct SEffectBloodSplats
{
	static void GetConfiguration(SFlowNodeConfig& config)
	{
		static const SInputPortConfig inputs[] =
		{
			InputPortConfig<bool>("Enabled",             false, "Enables node",               "Enabled"),
			InputPortConfig<bool>("Disabled",            true,  "Disables node",              "Disabled"),
			InputPortConfig<i32>("BloodSplats_Type",     0,     "Blood type: human or alien", "Type"),
...
struct SEffectVolumetricScattering
{
	static void GetConfiguration(SFlowNodeConfig& config)
	{
		static const SInputPortConfig inputs[] =
		{
			...
			InputPortConfig<i32>("VolumetricScattering_Type",       0,         "Set volumetric scattering type",             "Type"),
			{ 0 }
		};
...
struct SEffect3DHudInterference
{
	...
	static void Serialize(IFlowNode::SActivationInfo* pActInfo, TSerialize ser)
	{
		//DRX_TODO(11, 1, 2010, "make a propper serialization here");
		if (ser.IsReading())
		{
...
public:
	...
	void GetConfiguration(SFlowNodeConfig& config)
	{
		static const SInputPortConfig in_config[] =
		{
			...
			InputPortConfig<i32>("ShadowMode", 0,                                       _HELP("Shadow mode"),_HELP("ShadowMode"), _UICONFIG("enum_int:Normal=0,HighQuality=1")), // the values needs to coincide with EShadowMode
			{ 0 }
		};
