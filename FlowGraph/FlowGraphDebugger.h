...
{
	DRXINTERFACE_SIMPLE(IFlowGraphDebugger)
	DRXGENERATE_SINGLETONCLASS_GUID(CFlowGraphDebugger, "FlowgraphDebugger", "2d6810e1-0cbd-467a-b564-6539c3778285"_drx_guid)
...
public:
	...
	virtual bool               RegisterListener(IFlowGraphDebugListener* pListener, tukk name) override;
	...
	virtual bool               PerformActivation(IFlowGraphPtr pFlowgraph, i32 edgeIndex, const SFlowAddress& fromAddr, const SFlowAddress& toAddr, const TFlowInputData& value) override;
...
private:
	...
	bool                       TryActivatePort(SBreakPoint& breakpoint, IFlowEdgeIterator::Edge& edge, bool& bPerform, i32 edgeIndex);
