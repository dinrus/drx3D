...
{
public:
	CAutoRegFlowNodeBase(tukk szClassName)
	{
...
{
public:
	CAutoRegFlowNode(tukk szClassName)
	...
	IFlowNodePtr Create(IFlowNode::SActivationInfo* pActInfo)
	{
		...
		{
			DRX_ASSERT_MESSAGE(false, "Unsupported CloneType!");
		}
	}
...
#define REGISTER_FLOW_NODE(FlowNodeClassName, FlowNodeClass)                     \
  ...
  DRX_EXPORT_STATIC_LINK_VARIABLE(g_AutoReg ## FlowNodeClass);
...
#define REGISTER_FLOW_NODE_EX(FlowNodeClassName, FlowNodeClass, RegName)   \
  ...
  DRX_EXPORT_STATIC_LINK_VARIABLE(g_AutoReg ## RegName);
...
public:
	...
	static i32k myCloneType = CLONE_TYPE;
};
...
public:
	...
	static i32k myCloneType = eNCT_Instanced;
};
...
public:
	...
	static i32k myCloneType = eNCT_Singleton;
};

inline void DrxRegisterFlowNodes()
{
...
inline void DrxUnregisterFlowNodes()
{
