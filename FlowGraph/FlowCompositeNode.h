...
public:
	...
	virtual bool                        CreatedNode(TFlowNodeId id, tukk name, TFlowNodeTypeId typeId, IFlowNodePtr pNode);
	virtual void                        CancelCreatedNode(TFlowNodeId id, tukk name, TFlowNodeTypeId typeId, IFlowNodePtr pNode);
