...
class CCharacterRenderNode final : public ICharacterRenderNode, private DinrusX3dEngBase
{
...
public:
	...
	virtual tukk GetEntityClassName() const final          { return "CharacterRenderNode"; };
	...
	static void PrecacheCharacter(const float fImportance, ICharacterInstance* pCharacter, IMaterial* pSlotMat,
	                              const Matrix34& matParent, const float fEntDistance, const float fScale, i32 nMaxDepth, bool bFullUpdate, bool bDrawNear, i32 nLod);
