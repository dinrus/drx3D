...
{
#if (DRX_PLATFORM_LINUX || DRX_PLATFORM_ANDROID) && !defined(__clang__)
	_mm_prefetch(reinterpret_cast<tukk >(pData), (_mm_hint)L);
#else
	_mm_prefetch(reinterpret_cast<tukk >(pData), (i32)L);
#endif
}
