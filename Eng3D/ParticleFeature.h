...
#include <drx3D/Eng3D/ParamTraits.h>
#include <drx3D/CoreX/Renderer/IGpuParticles.h>
#include <drx3D/CoreX/Dispatcher.h>
...
public:
	...
	tukk                 GetConnectorName(uint connectorId) const override { return nullptr; }
	void                        ConnectTo(tukk pOtherName) override        {}
	void                        DisconnectFrom(tukk pOtherName) override   {}
	uint                        GetNumResources() const override                  { return 0; }
	tukk                 GetResourceName(uint resourceId) const override   { return nullptr; }
	// ~IParticleFeature
...
#define DRX_PFX2_DECLARE_FEATURE \
...
#define DRX_PFX2_IMPLEMENT_COMPONENT_FEATURE(BaseType, Type, GroupName, FeatureName, Color)                              \
...
#define DRX_PFX2_IMPLEMENT_FEATURE(BaseType, Type, GroupName, FeatureName, Color)                                        \
  DRX_PFX2_IMPLEMENT_COMPONENT_FEATURE(BaseType, Type, GroupName, FeatureName, Color)                                    \
...
#define DRX_PFX2_LEGACY_FEATURE(Type, GroupName, FeatureName) \
