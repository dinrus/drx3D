...
SERIALIZATION_ENUM_DEFINE(ESizeMode, : u8,
                          Size,
                          Scale
                          )

SERIALIZATION_ENUM_DEFINE(EOriginMode, : u8,
                          Origin,
                          Center
                          )

SERIALIZATION_ENUM_DEFINE(EPiecesMode, : u8,
                          Whole,
                          RandomPiece,
                          AllPieces
                          )

SERIALIZATION_ENUM_DEFINE(EPiecePlacement, : u8,
                          Standard,
                          SubPlacement,
                          CenteredSubPlacement
                          )

class CFeatureRenderMeshes : public CParticleFeature, public DinrusX3dEngBase
{
public:
	...
	virtual void AddToComponent(CParticleComponent* pComponent, SComponentParams* pParams) override
	{
		...
		if (m_pStaticObject)
		{
			...
			{
				i32 subObjectCount = m_pStaticObject->GetSubObjectCount();
...
DRX_PFX2_IMPLEMENT_FEATURE(CParticleFeature, CFeatureRenderMeshes, "Render", "Meshes", colorRender);
