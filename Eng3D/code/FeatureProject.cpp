...
DRX_PFX2_IMPLEMENT_FEATURE(CParticleFeature, CFeatureProjectTerrain, "Project", "Terrain", colorProject);
...
DRX_PFX2_IMPLEMENT_FEATURE(CParticleFeature, CFeatureProjectWater, "Project", "Water", colorProject);
