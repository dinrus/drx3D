...
class CFeatureRenderDecals : public CParticleFeature, public DinrusX3dEngBase
{
private:
...
DRX_PFX2_IMPLEMENT_FEATURE(CParticleFeature, CFeatureRenderDecals, "Render", "Decals", colorRender);
...
void CFeatureRenderDecals::RenderDeferred(const CParticleComponentRuntime& runtime, const SRenderContext& renderContext)
{
	...
	decal.nSortOrder = clamp_tpl(i32(m_sortBias * 100.f), 0, 255);
	decal.nFlags = 0;
