...
public:
	...
	virtual void AddToComponent(CParticleComponent* pComponent, SComponentParams* pParams) override
	{
		...
		{
			i32k numSamples = gpu_pfx2::kNumModifierSamples;
...
DRX_PFX2_IMPLEMENT_FEATURE(CParticleFeature, CFeatureFieldOpacity, "Field", "Opacity", colorField);
...
DRX_PFX2_IMPLEMENT_FEATURE(CParticleFeature, CFeatureFieldSize, "Field", "Size", colorField);
...
DRX_PFX2_IMPLEMENT_FEATURE(CParticleFeature, CFeatureFieldPixelSize, "Field", "PixelSize", colorField);
