...
DRX_PFX2_IMPLEMENT_FEATURE(CParticleFeature, CFeatureLifeTime, "Life", "Time", colorLife);
...
DRX_PFX2_LEGACY_FEATURE(CFeatureLifeImmortal, "Life", "Immortal")
...
DRX_PFX2_LEGACY_FEATURE(CFeatureKillOnParentDeath, "Kill", "OnParentDeath");
