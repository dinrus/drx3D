...
#include <drx3D/Eng3D/FeatureMotion.h>
...
DRX_UNIT_TEST(DragFast)
{
	float x1 = 1.0e-12f;
	for (i32 i = 0; i < 24; ++i, x1 *= 10.f)
	{
		float coeffs[3];
...
DRX_PFX2_IMPLEMENT_FEATURE(CParticleFeature, CFeatureMotionPhysics, "Motion", "Physics", colorMotion);

//////////////////////////////////////////////////////////////////////////
// CFeatureMotionDinrusXPhys
...
CFeatureMotionDinrusXPhys::CFeatureMotionDinrusXPhys()
...
void CFeatureMotionDinrusXPhys::AddToComponent(CParticleComponent* pComponent, SComponentParams* pParams)
{
...
void CFeatureMotionDinrusXPhys::Serialize(Serialization::IArchive& ar)
{
...
void CFeatureMotionDinrusXPhys::PostInitParticles(CParticleComponentRuntime& runtime)
{
	DRX_PFX2_PROFILE_DETAIL;
	...
	i32k surfaceTypeId = m_surfaceType;
...
void CFeatureMotionDinrusXPhys::UpdateParticles(CParticleComponentRuntime& runtime)
{
	DRX_PFX2_PROFILE_DETAIL;
...
void CFeatureMotionDinrusXPhys::DestroyParticles(CParticleComponentRuntime& runtime)
{
...
DRX_PFX2_IMPLEMENT_FEATURE(CParticleFeature, CFeatureMotionDinrusXPhys, "Motion", "DinrusXPhys", colorMotion);
...
DRX_PFX2_LEGACY_FEATURE(CFeatureMoveRelativeToEmitter, "Velocity", "MoveRelativeToEmitter");
DRX_PFX2_IMPLEMENT_FEATURE(CParticleFeature, CFeatureMoveRelativeToEmitter, "Motion", "MoveRelativeToEmitter", colorMotion);
