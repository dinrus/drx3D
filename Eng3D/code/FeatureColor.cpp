...
void CFeatureFieldColor::Sample(Vec3* samples, i32k numSamples)
{
...
DRX_PFX2_IMPLEMENT_FEATURE(CParticleFeature, CFeatureFieldColor, "Field", "Color", colorField);
