...
//  Описание:    Отрисовка статических объектов (растительности).
// -------------------------------------------------------------------------
//  История:
//
////////////////////////////////////////////////////////////////////////////
...
)
{
	...
	i32 nMaxTestsToScip = (GetVisAreaUpr()->m_pCurPortal) ? 3 : 10000;
...
bool CHeightMap::Intersect(Vec3 vStartPoint, Vec3 vStopPoint, float _fDist, i32 nMaxTestsToScip, Vec3& vLastVisPoint)
{
	//  FUNCTION_PROFILER_3DENGINE;
