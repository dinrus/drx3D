...
CWaterWaveRenderNode::~CWaterWaveRenderNode()
{
	...
	GetWaterWaveUpr()->Unregister(this);

	Get3DEngine()->FreeRenderNodeState(this);
}

//////////////////////////////////////////////////////////////////////////
void CWaterWaveRenderNode::ComputeMinMax(const Vec3* pVertices, u32 nVertexCount)
{
	...
	for (u32 i(0); i < nVertexCount; i += 4)
	{
...
//////////////////////////////////////////////////////////////////////////
void CWaterWaveRenderNode::Create(uint64 nID, const Vec3* pVertices, u32 nVertexCount, const Vec2& pUVScale, const Matrix34& pWorldTM)
{
	...
	// Add to 3d engine
	GetWaterWaveUpr()->Register(this);
	Get3DEngine()->RegisterEntity(this);

}

//////////////////////////////////////////////////////////////////////////
void CWaterWaveRenderNode::CopySerializationParams(uint64 nID, const Vec3* pVertices, u32 nVertexCount, const Vec2& pUVScale, const Matrix34& pWorldTM)
{
...
//////////////////////////////////////////////////////////////////////////
tukk CWaterWaveRenderNode::GetEntityClassName() const
{
	return "CWaterWaveRenderNode";
}

//////////////////////////////////////////////////////////////////////////
tukk CWaterWaveRenderNode::GetName() const
{
	return "WaterWave";
}
...
//////////////////////////////////////////////////////////////////////////
void CWaterWaveRenderNode::SetMaterial(IMaterial* pMat)
{
	m_pMaterial = pMat;
}

//////////////////////////////////////////////////////////////////////////
void CWaterWaveRenderNode::GetMemoryUsage(IDrxSizer* pSizer) const
{
...
//////////////////////////////////////////////////////////////////////////
IRenderMesh* CWaterWaveUpr::CreateRenderMeshInstance(CWaterWaveRenderNode* pWave)
{
	...
	if (pItor == m_pInstancedWaves.end())
	{
		...
		i32 nVertexCount(pSerParam->m_nVertexCount);
		...
		i32k nGridRes = GetCVars()->e_WaterWavesTessellationAmount;
		...
		i32k nSectors = nVertexCount / 4;
		i32k nGridResTotal = nGridRes * nSectors - nSectors;
		...
		for (i = 0; i < nVertexCount; i += 4)
		{
			...
			for (i32 x(0); x < nGridRes; ++x)
			{
				...
				for (i32 y(0); y < nGridRes; ++y)
				{
					...
					u8 nEdge = (u8)(fEdge * 255);

					pCurr.color.bcolor[0] = (u8) (fXStep * 255.0f);
					pCurr.color.bcolor[1] = (u8) (fCurrStep * 255.0f);
		...
		for (i = 0; i < nVertexCount; i += 4)
		{
			...
			for (i32 y(0); y < nGridRes - 1; ++y)
			{
				for (i32 x(0); x < nGridRes; ++x, ++nIndex)
				{
		...
		pRenderMesh->SetChunk(pWave->GetMaterial(0), 0, pWaveVertices.size(), 0, pWaveIndices.size(), texelAreaDensity);
...
//////////////////////////////////////////////////////////////////////////
void CWaterWaveUpr::Register(CWaterWaveRenderNode* pWave)
{
...
//////////////////////////////////////////////////////////////////////////
void CWaterWaveUpr::Unregister(CWaterWaveRenderNode* pWave)
{
...
//////////////////////////////////////////////////////////////////////////
void CWaterWaveUpr::Update(const SRenderingPassInfo& passInfo)
{
	FUNCTION_PROFILER_3DENGINE;
