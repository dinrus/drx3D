...
#include <drx3D/Eng3D/FeatureAngles.h>
...
DRX_PFX2_IMPLEMENT_FEATURE(CParticleFeature, CFeatureAnglesRotate2D, "Angles", "Rotate2D", colorAngles);
...
DRX_PFX2_IMPLEMENT_FEATURE(CParticleFeature, CFeatureAnglesRotate3D, "Angles", "Rotate3D", colorAngles);
...
DRX_PFX2_IMPLEMENT_FEATURE(CParticleFeature, CFeatureAnglesAlign, "Angles", "Align", colorAngles);
