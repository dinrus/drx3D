...
DRX_PFX2_LEGACY_FEATURE(CFeatureMotionFluidDynamics, "Motion", "GPU Fluid Dynamics");
DRX_PFX2_IMPLEMENT_FEATURE(CParticleFeature, CFeatureMotionFluidDynamics, "GPU Particles", "Fluid Dynamics", colorGPU);
