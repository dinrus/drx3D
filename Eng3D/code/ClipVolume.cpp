...
void CClipVolume::SetName(tukk szName)
{
	drx_strcpy(m_sName, szName);
}
...
void CClipVolume::Update(_smart_ptr<IRenderMesh> pRenderMesh, IBSPTree3D* pBspTree, const Matrix34& worldTM, u8 viewDistRatio, u32 flags)
{
...
void CClipVolume::GetMemoryUsage(class IDrxSizer* pSizer) const
{
