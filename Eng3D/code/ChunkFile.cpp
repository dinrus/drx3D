...
//////////////////////////////////////////////////////////////////////////
CChunkFile::ChunkDesc* CChunkFile::GetChunk(i32 nChunkIdx)
{
	assert(nChunkIdx >= 0 && nChunkIdx < (i32)m_chunks.size());
	return m_chunks[nChunkIdx];
}

const CChunkFile::ChunkDesc* CChunkFile::GetChunk(i32 nChunkIdx) const
{
	assert(nChunkIdx >= 0 && nChunkIdx < (i32)m_chunks.size());
	return m_chunks[nChunkIdx];
}
...
// number of chunks
i32 CChunkFile::NumChunks() const
{
	return (i32)m_chunks.size();
}

//////////////////////////////////////////////////////////////////////////
i32 CChunkFile::AddChunk(ChunkTypes chunkType, i32 chunkVersion, EEndianness eEndianness, ukk chunkData, i32 chunkSize)
{
...
//////////////////////////////////////////////////////////////////////////
void CChunkFile::DeleteChunkById(i32 nChunkId)
{
	for (size_t i = 0, n = m_chunks.size(); i < n; ++i)
	{
...
//////////////////////////////////////////////////////////////////////////
CChunkFile::ChunkDesc* CChunkFile::FindChunkById(i32 nChunkId)
{
...
//////////////////////////////////////////////////////////////////////////
bool CChunkFile::Write(tukk filename)
{
	if (m_chunks.empty())
	{
...
//////////////////////////////////////////////////////////////////////////
bool CChunkFile::WriteToMemoryBuffer(uk * pData, i32* nSize)
{
	ReleaseMemoryBuffer();
	*pData = 0;
	...
	for (i32 stage = 0; stage < 2; ++stage)
	{
		...
		else
		{
			...
			*nSize = sizeWriter.GetPos();
			...
			m_pInternalData = (tuk)malloc(*nSize);
...
//////////////////////////////////////////////////////////////////////////
bool CChunkFile::Read(tukk filename)
{
	...
	{
		i32k duplicateCount = (i32)(m_chunks.size() - m_chunkIdMap.size());
		m_LastError.Format(
