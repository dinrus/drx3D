...
namespace pfx2
{
	...
	bool CParticleSpline::Serialize(Serialization::IArchive& ar, tukk name, tukk label)
	{
	...
	void CParticleSpline::GetKey(i32 i, KeyType& key) const
	{
