...
private:
	...
	byte              m_srcBuffer[bufferSize + DRX_PFX2_PARTICLES_ALIGNMENT]; // Raw buffer for writing.
};

class CParticleRenderBase : public CParticleFeature, public DinrusX3dEngBase
{
public:
...
protected:
	...
	private:
		bool ClipSegment(Vec3& pos0, float size0, Vec3& pos1) const
		{
			...
			for (i32 p = FR_PLANE_RIGHT; p <= FR_PLANE_BOTTOM; ++p)
			{
