...
// -------------------------------------------------------------------------
//  Имя файла:   WaterWavesRenderNode.h
//  Version:     v1.00
...
class CWaterWaveRenderNode : public IWaterWaveRenderNode, public DinrusX3dEngBase
{

public:
	CWaterWaveRenderNode();
	virtual void                    Create(uint64 nID, const Vec3* pVertices, u32 nVertexCount, const Vec2& pUVScale, const Matrix34& pWorldTM);
...
private:
	...
	// Get wave boundings
	void ComputeMinMax(const Vec3* pVertices, u32 nVertexCount);

	// Update bounding box
	void UpdateBoundingBox();

	// Copy serialization parameters
	void CopySerializationParams(uint64 nID, const Vec3* pVertices, u32 nVertexCount, const Vec2& pUVScale, const Matrix34& pWorldTM);
...
class CWaterWaveUpr : public DinrusX3dEngBase
{
public:
	CWaterWaveUpr();
	~CWaterWaveUpr();
