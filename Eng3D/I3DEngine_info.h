...
#include <drx3D/Eng3D/I3DEngine.h> // <> required for Interfuscator

STRUCT_INFO_BEGIN(STerrainInfo)
STRUCT_VAR_INFO(heightMapSize_InUnits, TYPE_INFO(i32))
STRUCT_VAR_INFO(unitSize_InMeters, TYPE_INFO(float))
STRUCT_VAR_INFO(sectorSize_InMeters, TYPE_INFO(i32))
STRUCT_VAR_INFO(sectorsTableSize_InSectors, TYPE_INFO(i32))
...
STRUCT_VAR_INFO(nChunkSize, TYPE_INFO(i32))
...
STRUCT_VAR_INFO(nFlags2, TYPE_INFO(int8))
STRUCT_VAR_INFO(nChunkSize, TYPE_INFO(i32))
STRUCT_VAR_INFO(nVisAreasNum, TYPE_INFO(i32))
STRUCT_VAR_INFO(nPortalsNum, TYPE_INFO(i32))
STRUCT_VAR_INFO(nOcclAreasNum, TYPE_INFO(i32))
STRUCT_INFO_END(SVisAreaManChunkHeader)

STRUCT_INFO_BEGIN(SOcTreeNodeChunk)
STRUCT_VAR_INFO(nChunkVersion, TYPE_INFO(i16))
STRUCT_VAR_INFO(ucChildsMask, TYPE_INFO(i16))
...
STRUCT_VAR_INFO(file_type, TYPE_INFO(u8))
STRUCT_VAR_INFO(flags, TYPE_INFO(u8))
STRUCT_VAR_INFO(version, TYPE_INFO(u16))
STRUCT_INFO_END(SCommonFileHeader)

STRUCT_INFO_BEGIN(SHotUpdateInfo)
STRUCT_VAR_INFO(nHeigtmap, TYPE_INFO(u32))
STRUCT_VAR_INFO(nObjTypeMask, TYPE_INFO(u32))
STRUCT_VAR_INFO(areaBox, TYPE_INFO(AABB))
STRUCT_INFO_END(SHotUpdateInfo)

STRUCT_INFO_BEGIN(STerrainTextureFileHeader_old)
STRUCT_VAR_INFO(nSectorSizeMeters, TYPE_INFO(u16))
STRUCT_VAR_INFO(nLodsNum, TYPE_INFO(u16))
STRUCT_VAR_INFO(nLayerCount, TYPE_INFO(u16))
STRUCT_VAR_INFO(nReserved, TYPE_INFO(u16))
STRUCT_INFO_END(STerrainTextureFileHeader_old)

STRUCT_INFO_BEGIN(STerrainTextureFileHeader)
STRUCT_VAR_INFO(nLayerCount, TYPE_INFO(u16))
STRUCT_VAR_INFO(dwFlags, TYPE_INFO(u16))
...
STRUCT_VAR_INFO(nSectorSizePixels, TYPE_INFO(u16))
STRUCT_VAR_INFO(nReserved, TYPE_INFO(u16))
STRUCT_VAR_INFO(eTexFormat, TYPE_INFO(ETEX_Format))
STRUCT_VAR_INFO(nSectorSizeBytes, TYPE_INFO(u32))
