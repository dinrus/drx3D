...
class CCloudBlockerRenderNode : public ICloudBlockerRenderNode, public DinrusX3dEngBase
{
public:
	CCloudBlockerRenderNode();

	// implements IRenderNode
	virtual tukk             GetName() const override                      { return "CloudBlocker"; }
	virtual tukk             GetEntityClassName() const override           { return "CloudBlocker"; }
