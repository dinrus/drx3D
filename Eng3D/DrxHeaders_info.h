...
STRUCT_INFO_BEGIN(DrxVertex)
VAR_INFO(p)
VAR_INFO(n)
STRUCT_INFO_END(DrxVertex)

STRUCT_INFO_BEGIN(DrxFace)
VAR_INFO(v0)
VAR_INFO(v1)
VAR_INFO(v2)
VAR_INFO(MatID)
STRUCT_INFO_END(DrxFace)

STRUCT_INFO_BEGIN(DrxUV)
VAR_INFO(u)
VAR_INFO(v)
STRUCT_INFO_END(DrxUV)

STRUCT_INFO_BEGIN(DrxSkinVtx)
VAR_INFO(bVolumetric)
VAR_INFO(idx)
VAR_INFO(w)
VAR_INFO(M)
STRUCT_INFO_END(DrxSkinVtx)

STRUCT_INFO_BEGIN(DrxLink)
VAR_INFO(BoneID)
VAR_INFO(offset)
VAR_INFO(Blending)
STRUCT_INFO_END(DrxLink)

STRUCT_INFO_BEGIN(DrxIRGB)
VAR_INFO(r)
VAR_INFO(g)
VAR_INFO(b)
STRUCT_INFO_END(DrxIRGB)

STRUCT_INFO_BEGIN(DrxBonePhysics_Comp)
VAR_INFO(nPhysGeom)
VAR_INFO(flags)
VAR_INFO(min)
VAR_INFO(max)
...
VAR_INFO(damping)
VAR_INFO(framemtx)
STRUCT_INFO_END(DrxBonePhysics_Comp)

STRUCT_INFO_BEGIN(DrxBoneDescData_Comp)
...
STRUCT_INFO_END(DrxBoneDescData_Comp)
...
STRUCT_INFO_BEGIN(DrxTCB3Key)
STRUCT_BASE_INFO(BaseKey3)
STRUCT_BASE_INFO(BaseTCB)
STRUCT_INFO_END(DrxTCB3Key)

STRUCT_INFO_BEGIN(DrxTCBQKey)
STRUCT_BASE_INFO(BaseKeyQ)
STRUCT_BASE_INFO(BaseTCB)
STRUCT_INFO_END(DrxTCBQKey)

STRUCT_INFO_BEGIN(DrxKeyPQLog)
VAR_INFO(nTime)
VAR_INFO(vPos)
VAR_INFO(vRotLog)
STRUCT_INFO_END(DrxKeyPQLog)

STRUCT_INFO_BEGIN(DrxKeyPQS)
VAR_INFO(position)
VAR_INFO(rotation)
VAR_INFO(scale)
STRUCT_INFO_END(DrxKeyPQS)

ENUM_INFO_BEGIN(CtrlTypes)
ENUM_ELEM_INFO(, CTRL_NONE)
ENUM_ELEM_INFO(, CTRL_DRXBONE)
