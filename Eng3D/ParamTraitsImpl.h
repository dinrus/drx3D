...
ILINE bool Serialize(Serialization::IArchive& ar, SEnable& val, tukk name, tukk label)
{
...
bool TValue<T, TTraits>::Serialize(Serialization::IArchive& ar, tukk name, tukk label)
{
