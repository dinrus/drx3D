...
{
public:
	CVariableCollectionUpr() = default;
	~CVariableCollectionUpr();
...
public:
	...
	virtual CVariable*           CreateVariable(const CHashedString& name, i32 initialValue) override;
	...
	virtual bool                 SetVariableValue(const CHashedString& name, i32 newValue, bool createIfNotExisting = true, float resetTime = -1.0f) override;
	...
	virtual void                 SetUserString(tukk szUserString) override { m_userString = szUserString; }
	virtual tukk          GetUserString() const override { return m_userString.c_str(); }
	//////////////////////////////////////////////////////////
