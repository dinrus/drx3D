...
public:
	...
	virtual tukk GetType() const override { return "LessCheck"; }
	//////////////////////////////////////////////////////////
...
public:
	...
	virtual bool        IsMet(DRS::IResponseInstance* pResponseInstance) override;
	virtual string      GetVerboseInfo() const override;
	virtual tukk GetType() const override { return "GreaterCheck"; }
	//////////////////////////////////////////////////////////
	CVariableValue m_value;
};
...
public:
	...
	virtual bool        IsMet(DRS::IResponseInstance* pResponseInstance) override;
	virtual string      GetVerboseInfo() const override;
	virtual tukk GetType() const override { return "EqualCheck"; }
	//////////////////////////////////////////////////////////
	CVariableValue m_value;
};
...
public:
	...
	virtual bool        IsMet(DRS::IResponseInstance* pResponseInstance) override;
	virtual string      GetVerboseInfo() const override;
	virtual tukk GetType() const override { return "InRangeCheck"; }
	//////////////////////////////////////////////////////////
...
public:
	...
	virtual string      GetVerboseInfo() const override;
	virtual tukk GetType() const override { return "VariableToVariableCheck"; }
	//////////////////////////////////////////////////////////
private:
