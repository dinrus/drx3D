...
public:
	...
	virtual void                 SetValue(i32 newValue) override                  { m_value = CVariableValue(newValue); }
	...
	virtual i32                  GetValueAsInt() const override                   { return m_value.GetValueAsInt(); };
...
struct IVariableUsingBase
{
	...
	void                  _Serialize(Serialization::IArchive& ar, tukk szVariableDisplayName = "^Variable", tukk szCollectionDisplayName = "^Collection");
