...
//--------------------------------------------------------------------------------------------------
void IVariableUsingBase::_Serialize(Serialization::IArchive& ar, tukk szVariableName /* = "^Variable" */, tukk szCollectionName /* = "^Collection" */)
{
...
DrxDRS::CVariable* DrxDRS::IVariableUsingBase::GetOrCreateCurrentVariable(CResponseInstance* pResponseInstance)
{
	CVariableCollection* pCollection = GetCurrentCollection(pResponseInstance);
	if (!pCollection && !m_collectionName.IsValid())
	{
		pCollection = CResponseSystem::GetInstance()->GetVariableCollectionUpr()->CreateVariableCollection(m_collectionName);
	}
	if (pCollection)
	{
...
//--------------------------------------------------------------------------------------------------
void DrxDRS::CVariable::SetValueFromString(const string& valueAsString)
{
