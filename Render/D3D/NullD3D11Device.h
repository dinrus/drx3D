...
public:
	// IUnknown
	virtual HRESULT STDMETHODCALLTYPE QueryInterface(REFIID riid, uk * ppvObj)
	{
		if (ppvObj)
			*ppvObj = 0;
	...
	virtual HRESULT STDMETHODCALLTYPE CreateInputLayout(const D3D11_INPUT_ELEMENT_DESC* pInputElementDescs, UINT NumElements, ukk pShaderBytecodeWithInputSignature, SIZE_T BytecodeLength, ID3D11InputLayout** ppInputLayout)
	{
		if (ppInputLayout)
			*ppInputLayout = 0;
		return S_FALSE;
	...
	virtual HRESULT STDMETHODCALLTYPE CreateVertexShader(ukk pShaderBytecode, SIZE_T BytecodeLength, ID3D11ClassLinkage* pClassLinkage, ID3D11VertexShader** ppVertexShader)
	{
		if (ppVertexShader)
			*ppVertexShader = 0;
		return S_FALSE;
	...
	virtual HRESULT STDMETHODCALLTYPE CreateGeometryShader(ukk pShaderBytecode, SIZE_T BytecodeLength, ID3D11ClassLinkage* pClassLinkage, ID3D11GeometryShader** ppGeometryShader)
	{
		if (ppGeometryShader)
			*ppGeometryShader = 0;
		return S_FALSE;
	...
	virtual HRESULT STDMETHODCALLTYPE CreateGeometryShaderWithStreamOutput(ukk pShaderBytecode, SIZE_T BytecodeLength, const D3D11_SO_DECLARATION_ENTRY* pSODeclaration, UINT NumEntries, const UINT* pBufferStrides, UINT NumStrides, UINT RasterizedStream, ID3D11ClassLinkage* pClassLinkage, ID3D11GeometryShader** ppGeometryShader)
	{
		if (ppGeometryShader)
			*ppGeometryShader = 0;
		return S_FALSE;
	...
	virtual HRESULT STDMETHODCALLTYPE CreatePixelShader(ukk pShaderBytecode, SIZE_T BytecodeLength, ID3D11ClassLinkage* pClassLinkage, ID3D11PixelShader** ppPixelShader)
	{
		if (ppPixelShader)
			*ppPixelShader = 0;
		return S_FALSE;
	...
	virtual HRESULT STDMETHODCALLTYPE CreateHullShader(ukk pShaderBytecode, SIZE_T BytecodeLength, ID3D11ClassLinkage* pClassLinkage, ID3D11HullShader** ppHullShader)
	{
		if (ppHullShader)
			*ppHullShader = 0;
		return S_FALSE;
	...
	virtual HRESULT STDMETHODCALLTYPE CreateDomainShader(ukk pShaderBytecode, SIZE_T BytecodeLength, ID3D11ClassLinkage* pClassLinkage, ID3D11DomainShader** ppDomainShader)
	{
		if (ppDomainShader)
			*ppDomainShader = 0;
		return S_FALSE;
	...
	virtual HRESULT STDMETHODCALLTYPE CreateComputeShader(ukk pShaderBytecode, SIZE_T BytecodeLength, ID3D11ClassLinkage* pClassLinkage, ID3D11ComputeShader** ppComputeShader)
	{
		if (ppComputeShader)
			*ppComputeShader = 0;
		return S_FALSE;
	...
	virtual HRESULT STDMETHODCALLTYPE OpenSharedResource(HANDLE hResource, REFIID ReturnedInterface, uk * ppResource)
	{
		if (ppResource)
			*ppResource = 0;
		return S_FALSE;
	...
	virtual HRESULT STDMETHODCALLTYPE CheckFeatureSupport(D3D11_FEATURE Feature, uk pFeatureSupportData, UINT FeatureSupportDataSize)
	{
		return S_FALSE;
	}

	virtual HRESULT STDMETHODCALLTYPE GetPrivateData(REFGUID guid, UINT* pDataSize, uk pData)
	{
		if (pDataSize)
			*pDataSize = 0;
		return S_FALSE;
	...
	virtual HRESULT STDMETHODCALLTYPE SetPrivateData(REFGUID guid, UINT DataSize, ukk pData)
	{
		return S_FALSE;
	}
	...
	virtual HRESULT STDMETHODCALLTYPE OpenSharedResource1(HANDLE hResource, REFIID returnedInterface, uk * ppResource)
	{
		return S_FALSE;
	}

	virtual HRESULT STDMETHODCALLTYPE OpenSharedResourceByName(LPCWSTR lpName, DWORD dwDesiredAccess, REFIID returnedInterface, uk * ppResource)
	{
		return S_FALSE;
	}
	#endif
...
public:
	NullD3D11Device() : m_refCount(1), m_pImmediateCtx(0) {}
...
public:
	...
	virtual HRESULT STDMETHODCALLTYPE GetData(ID3D11Asynchronous* pAsync, uk pData, UINT DataSize, UINT GetDataFlags)
	{
		return S_FALSE;
	}
	...
	virtual void STDMETHODCALLTYPE  UpdateSubresource(ID3D11Resource* pDstResource, UINT DstSubresource, const D3D11_BOX* pDstBox, ukk pSrcData, UINT SrcRowPitch, UINT SrcDepthPitch)                                                                                                                       {}
	...
	void STDMETHODCALLTYPE UpdateSubresource1(ID3D11Resource* pDstResource, UINT DstSubresource, const D3D11_BOX* pDstBox, ukk pSrcData, UINT SrcRowPitch, UINT SrcDepthPitch, UINT CopyFlags)                             {}
...
protected:
	...
	#else
public:
	DeviceContext(ID3D11Device* pDevice) : m_refCount(1), m_pDevice(pDevice) {}
