...
typedef RECT   D3D11_RECT;
	...
	#define STDMETHOD(method)         virtual i32 STDMETHODCALLTYPE method
	#define STDMETHOD_(type, method)  virtual type STDMETHODCALLTYPE method
	#define STDMETHODV(method)        virtual i32 STDMETHODVCALLTYPE method
...
#define D3DCOLOR_COLORVALUE(r, g, b, a) D3DCOLOR_RGBA((u32)((r) * 255.f), (u32)((g) * 255.f), (u32)((b) * 255.f), (u32)((a) * 255.f))
...
struct SDrxPresentParams
{
	u32 BackBufferWidth;
	u32 BackBufferHeight;
	struct
	{
		u32 ScaledOutputWidth;
		u32 ScaledOutputHeight;
	} VideoScalerParameters;
};

struct SDrxVideoMode
{
	u32 dwDisplayWidth;
	u32 dwDisplayHeight;
	u32 ResolutionID;
...
{
public:
	HRESULT ValidateContext(uk pContext) { return S_OK; }
	void    Release()                       {}
};
...
{
	u32              BackBufferWidth, BackBufferHeight;
