...
#define VK_DEFINE_GUID(_NAME, _D0, _W0, _W1, _B0, _B1, _B2, _B3, _B4, _B5, _B6, _B7) \
  ...
  {                                                                                  \
...
#if DRX_PLATFORM_WINAPI || _MSC_EXTENSIONS
	#if _MSC_VER
	...
	class CDrxVKGIOutput;
	class CDrxVKGIAdapter;
	class CDrxVKGIFactory;
	class CDrxVKSwapChain;

	#if DRX_PLATFORM_WINAPI || _MSC_EXTENSIONS
		// *INDENT-OFF*
		VK_DEFINE_TYPE_GUID(class, CDrxVKGIOutput,            DC7DCA35, 2196, 414D, 9F, 53, 61, 78, 84, 03, 2A, 60)
		VK_DEFINE_TYPE_GUID(class, CDrxVKGIAdapter,           645967A4, 1392, 4310, A7, 98, 80, 53, CE, 3E, 93, FD)
		VK_DEFINE_TYPE_GUID(class, CDrxVKGIFactory,           1BC6EA02, EF36, 464F, BF, 0C, 21, CA, 39, E5, 16, 8A)
		VK_DEFINE_TYPE_GUID(class, CDrxVKSwapChain,           94D99BDB, F1F8, 4AB0, B2, 36, 7D, A0, 17, 0E, DA, B1)
		// *INDENT-ON*
	#endif
