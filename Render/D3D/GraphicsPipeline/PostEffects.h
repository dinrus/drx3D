...
public:
	...
	const CEffectParam* GetEffectParamByName(tukk pszParam) const;
...
private:
	...
	void SetShaderParams(const CPostEffectContext &context, EShaderStage shaderStages, CRenderPrimitive::ConstantUpr& constantUpr, const struct SHudData& data, const class CHud3D& hud3d) const;
