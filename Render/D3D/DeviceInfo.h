...
struct DeviceInfo
{
	...
	bool CreateDevice(i32 zbpp, OnCreateDeviceCallback pCreateDeviceCallback, CreateWindowCallback pCreateWindowCallback);
	...
	u32                        CreationFlags() const             { return m_creationFlags; }
...
protected:
	...
	#if defined(SUPPORT_DEVICE_INFO_MSG_PROCESSING)
	DrxCriticalSection           m_msgQueueLock;
