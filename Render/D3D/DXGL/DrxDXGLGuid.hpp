...
// -------------------------------------------------------------------------
//  Имя файла:   DrxDXGLGuid.hpp
//  Version:     v1.00
//  Created:     20/02/2013 by Valerio Guagliumi.
//  Описание: Contains the definition of a cross platform unique
...
#ifndef __DRXDXGLGUID__
	#define __DRXDXGLGUID__

#if DRX_PLATFORM_WINDOWS
//Универсализация __declspec(uuid (...)) для разных компиляторов:
#include <guiddef.h>
#endif
////////////////////////////////////////////////////////////////
...
// *INDENT-OFF* - GUIDs should not be indented
...
#elif defined (__GNUC__)
#define DXGL_DEFINE_TYPE_GUID(_CLASS, _TYPE, _D0, _W0, _W1, _B0, _B1, _B2, _B3, _B4, _B5, _B6, _B7) \
     _CLASS CPPX_UUID_FOR (_TYPE, DXGL_GUID_STRING(_D0,_W0,_W1,_B0,_B1,_B2,_B3,_B4,_B5,_B6,_B7)) _TYPE;
    //spec ## _uuid
#endif
...
#define DXGL_DEFINE_TYPE_GUID(_CLASS, _TYPE, _D0, _W0, _W1, _B0, _B1, _B2, _B3, _B4, _B5, _B6, _B7) \
	...
	template <> struct SDrxDXGLTypeGuid<_CLASS _TYPE>{ static const GUID& Get() { return DXGL_TYPE_GUID_NAME(_TYPE); } };

#define __uuidof(_TYPE) SDrxDXGLTypeGuid<_TYPE>::Get()
...
#else
DXGL_DEFINE_TYPE_GUID(class, CDrxDXGLTexture1D,         637BD3A1, 3507, 4ECA, B0, 24, F4, 5E, 72, 1A, 93, CA)
DXGL_DEFINE_TYPE_GUID(class, CDrxDXGLTexture2D,         810C3ECB, 11EA, 48C6, 92, EE, FE, 1F, 56, CC, A1, FB)
DXGL_DEFINE_TYPE_GUID(class, CDrxDXGLTexture3D,         AD18E34A, 1879, 4329, 8A, 38, 47, 3E, 98, 92, 11, F6)
DXGL_DEFINE_TYPE_GUID(class, CDrxDXGLBuffer,            2FC0ECFE, C29D, 468C, 96, B1, B4, 7E, A0, 02, 6B, AC)
DXGL_DEFINE_TYPE_GUID(class, CDrxDXGLResource,          2B819A4A, B3DE, 4999, 93, DA, 03, 31, D7, 94, AE, 2E)
DXGL_DEFINE_TYPE_GUID(class, CDrxDXGLView,              D2D7D83A, 77D1, 4112, A7, 80, 67, 98, 30, 70, 2F, 59)
DXGL_DEFINE_TYPE_GUID(class, CDrxDXGLQuery,             EF4578BD, D215, 4EF8, 9B, C3, D5, AD, 83, DA, 77, EC)
DXGL_DEFINE_TYPE_GUID(class, CDrxDXGLDebug,             AAEE26AF, 2E73, 478F, B6, 0C, 8B, 1D, 90, 4D, 5F, 4D)
DXGL_DEFINE_TYPE_GUID(class, CDrxDXGLShaderReflection,  4B1CFC1E, 4E1E, 4954, A3, BB, E5, 17, 90, E3, 5F, A6)
DXGL_DEFINE_TYPE_GUID(class, CDrxDXGLDevice,            36525D64, 2382, 4130, 81, 00, 78, DE, 5D, 43, 9F, 33)
DXGL_DEFINE_TYPE_GUID(class, CDrxDXGLDeviceChild,       E61E0A3E, F6BD, 4998, B0, 1B, 9A, D8, F9, CA, 67, 30)
DXGL_DEFINE_TYPE_GUID(class, CDrxDXGLSwitchToRef,       AD18E34A, 1879, 4329, 8A, 38, 47, 3E, 98, 92, 11, F6)
DXGL_DEFINE_TYPE_GUID(class, CDrxDXGLGIFactory,         408D1CF0, 64A9, 4B2D, 99, 53, B0, D8, CD, CE, BA, AF)
DXGL_DEFINE_TYPE_GUID(class, CDrxDXGLGIAdapter,         BA6BC4F4, 7419, 4CDA, A4, 76, 0C, 89, 35, 6B, 48, 6F)
DXGL_DEFINE_TYPE_GUID(class, CDrxDXGLGIDevice,          ED665E26, B530, 432F, 83, 19, BB, 2D, 87, FA, 71, C2)
DXGL_DEFINE_TYPE_GUID(class, CDrxDXGLGIObject,          CB223673, 742A, 458F, 90, ED, AC, 1E, 25, 94, 83, 46)
DXGL_DEFINE_TYPE_GUID(class, CDrxDXGLSwapChain,         06cef291, a887, 4f9f, 95, 9c, 0a, ed, 53, 2c, 4c, 7b)
