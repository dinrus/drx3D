...
#include <X11/Xlib.h>
#include <X11/Xutil.h>
#include <drx3D/Render/glad_gl.h>
...
GLAPI i32 gladLoadGLX(Display* dpy, i32 screen);

GLAPI i32 gladLoadGLXLoader(GLADloadproc, Display * dpy, i32 screen);
...
typedef struct
{
	i32           event_type;  /* GLX_DAMAGED or GLX_SAVED */
	i32           draw_type;   /* GLX_WINDOW or GLX_PBUFFER */
	u64 serial;      /* # of last request processed by server */
	Bool          send_event;  /* true if this came for SendEvent request */
	Display*      display;     /* display the event was read from */
	GLXDrawable   drawable;    /* XID of Drawable */
	u32  buffer_mask; /* mask indicating which buffers are affected */
	u32  aux_buffer;  /* which aux buffer was affected */
	i32           x, y;
	i32           width, height;
	i32           count; /* if nonzero, at least this many more */
...
typedef struct
{
	...
	i32           event_type; /* GLX_DAMAGED_SGIX or GLX_SAVED_SGIX */
	i32           draw_type;  /* GLX_WINDOW_SGIX or GLX_PBUFFER_SGIX */
	u32  mask;       /* mask indicating which buffers are affected*/
	i32           x, y;
	i32           width, height;
	i32           count; /* if nonzero, at least this many more */
...
typedef struct
{
	char         pipeName[80]; /* Should be [GLX_HYPERPIPE_PIPE_NAME_LENGTH_SGIX] */
	i32          channel;
	u32 participationType;
	i32          timeSlice;
} GLXHyperpipeConfigSGIX;
typedef struct
{
	char pipeName[80];   /* Should be [GLX_HYPERPIPE_PIPE_NAME_LENGTH_SGIX] */
	i32  srcXOrigin, srcYOrigin, srcWidth, srcHeight;
	i32  destXOrigin, destYOrigin, destWidth, destHeight;
} GLXPipeRect;
typedef struct
{
	char pipeName[80];   /* Should be [GLX_HYPERPIPE_PIPE_NAME_LENGTH_SGIX] */
	i32  XOrigin, YOrigin, maxHeight, maxWidth;
} GLXPipeRectLimits;
...
GLAPI i32 GLAD_GLX_VERSION_1_0;
typedef XVisualInfo* (APIENTRYP PFNGLXCHOOSEVISUALPROC)(Display*, i32, i32*);
...
typedef void (APIENTRYP         PFNGLXCOPYCONTEXTPROC)(Display*, GLXContext, GLXContext, u64);
...
typedef Bool (APIENTRYP         PFNGLXQUERYEXTENSIONPROC)(Display*, i32*, i32*);
GLAPI PFNGLXQUERYEXTENSIONPROC glad_glXQueryExtension;
typedef Bool (APIENTRYP         PFNGLXQUERYVERSIONPROC)(Display*, i32*, i32*);
...
typedef i32 (APIENTRYP          PFNGLXGETCONFIGPROC)(Display*, XVisualInfo*, i32, i32*);
...
typedef void (APIENTRYP         PFNGLXUSEXFONTPROC)(Font, i32, i32, i32);
GLAPI PFNGLXUSEXFONTPROC glad_glXUseXFont;
	#endif
	#ifndef GLX_VERSION_1_1
		#define GLX_VERSION_1_1 1
GLAPI i32 GLAD_GLX_VERSION_1_1;
typedef tukk (APIENTRYP PFNGLXQUERYEXTENSIONSSTRINGPROC)(Display*, i32);
GLAPI PFNGLXQUERYEXTENSIONSSTRINGPROC glad_glXQueryExtensionsString;
typedef tukk (APIENTRYP PFNGLXQUERYSERVERSTRINGPROC)(Display*, i32, i32);
GLAPI PFNGLXQUERYSERVERSTRINGPROC glad_glXQueryServerString;
typedef tukk (APIENTRYP PFNGLXGETCLIENTSTRINGPROC)(Display*, i32);
GLAPI PFNGLXGETCLIENTSTRINGPROC glad_glXGetClientString;
	#endif
	#ifndef GLX_VERSION_1_2
		#define GLX_VERSION_1_2 1
GLAPI i32 GLAD_GLX_VERSION_1_2;
typedef Display* (APIENTRYP PFNGLXGETCURRENTDISPLAYPROC)();
GLAPI PFNGLXGETCURRENTDISPLAYPROC glad_glXGetCurrentDisplay;
	#endif
	#ifndef GLX_VERSION_1_3
		#define GLX_VERSION_1_3 1
GLAPI i32 GLAD_GLX_VERSION_1_3;
typedef GLXFBConfig* (APIENTRYP PFNGLXGETFBCONFIGSPROC)(Display*, i32, i32*);
GLAPI PFNGLXGETFBCONFIGSPROC glad_glXGetFBConfigs;
typedef GLXFBConfig* (APIENTRYP PFNGLXCHOOSEFBCONFIGPROC)(Display*, i32, i32k*, i32*);
GLAPI PFNGLXCHOOSEFBCONFIGPROC glad_glXChooseFBConfig;
typedef i32 (APIENTRYP          PFNGLXGETFBCONFIGATTRIBPROC)(Display*, GLXFBConfig, i32, i32*);
...
typedef GLXWindow (APIENTRYP    PFNGLXCREATEWINDOWPROC)(Display*, GLXFBConfig, Window, i32k*);
...
typedef GLXPixmap (APIENTRYP    PFNGLXCREATEPIXMAPPROC)(Display*, GLXFBConfig, Pixmap, i32k*);
...
typedef GLXPbuffer (APIENTRYP   PFNGLXCREATEPBUFFERPROC)(Display*, GLXFBConfig, i32k*);
...
typedef void (APIENTRYP         PFNGLXQUERYDRAWABLEPROC)(Display*, GLXDrawable, i32, u32*);
GLAPI PFNGLXQUERYDRAWABLEPROC glad_glXQueryDrawable;
typedef GLXContext (APIENTRYP   PFNGLXCREATENEWCONTEXTPROC)(Display*, GLXFBConfig, i32, GLXContext, Bool);
...
typedef i32 (APIENTRYP          PFNGLXQUERYCONTEXTPROC)(Display*, GLXContext, i32, i32*);
GLAPI PFNGLXQUERYCONTEXTPROC glad_glXQueryContext;
typedef void (APIENTRYP         PFNGLXSELECTEVENTPROC)(Display*, GLXDrawable, u64);
GLAPI PFNGLXSELECTEVENTPROC glad_glXSelectEvent;
typedef void (APIENTRYP         PFNGLXGETSELECTEDEVENTPROC)(Display*, GLXDrawable, u64*);
GLAPI PFNGLXGETSELECTEDEVENTPROC glad_glXGetSelectedEvent;
	#endif
	#ifndef GLX_VERSION_1_4
		#define GLX_VERSION_1_4 1
GLAPI i32 GLAD_GLX_VERSION_1_4;
...
inline void glad_wrapped_glXGetSelectedEvent(Display* _dpy, GLXDrawable _draw, u64* _event_mask) { GLAD_INSTRUMENT_CALL(glXGetSelectedEvent, _dpy, _draw, _event_mask); }
		#define glXGetSelectedEvent glad_wrapped_glXGetSelectedEvent
struct glad_tag_glXQueryExtension {};
inline Bool glad_wrapped_glXQueryExtension(Display* _dpy, i32* _errorb, i32* _event) { return GLAD_INSTRUMENT_CALL(glXQueryExtension, _dpy, _errorb, _event); }
...
inline void glad_wrapped_glXSelectEvent(Display* _dpy, GLXDrawable _draw, u64 _event_mask) { GLAD_INSTRUMENT_CALL(glXSelectEvent, _dpy, _draw, _event_mask); }
...
inline Bool glad_wrapped_glXQueryVersion(Display* _dpy, i32* _maj, i32* _min) { return GLAD_INSTRUMENT_CALL(glXQueryVersion, _dpy, _maj, _min); }
...
inline GLXWindow glad_wrapped_glXCreateWindow(Display* _dpy, GLXFBConfig _config, Window _win, i32k* _attrib_list) { return GLAD_INSTRUMENT_CALL(glXCreateWindow, _dpy, _config, _win, _attrib_list); }
		#define glXCreateWindow glad_wrapped_glXCreateWindow
struct glad_tag_glXCopyContext {};
inline void glad_wrapped_glXCopyContext(Display* _dpy, GLXContext _src, GLXContext _dst, u64 _mask) { GLAD_INSTRUMENT_CALL(glXCopyContext, _dpy, _src, _dst, _mask); }
		#define glXCopyContext glad_wrapped_glXCopyContext
struct glad_tag_glXCreatePbuffer {};
inline GLXPbuffer glad_wrapped_glXCreatePbuffer(Display* _dpy, GLXFBConfig _config, i32k* _attrib_list) { return GLAD_INSTRUMENT_CALL(glXCreatePbuffer, _dpy, _config, _attrib_list); }
...
inline i32 glad_wrapped_glXQueryContext(Display* _dpy, GLXContext _ctx, i32 _attribute, i32* _value) { return GLAD_INSTRUMENT_CALL(glXQueryContext, _dpy, _ctx, _attribute, _value); }
		#define glXQueryContext glad_wrapped_glXQueryContext
struct glad_tag_glXChooseVisual {};
inline XVisualInfo* glad_wrapped_glXChooseVisual(Display* _dpy, i32 _screen, i32* _attribList) { return GLAD_INSTRUMENT_CALL(glXChooseVisual, _dpy, _screen, _attribList); }
		#define glXChooseVisual glad_wrapped_glXChooseVisual
struct glad_tag_glXQueryServerString {};
inline tukk glad_wrapped_glXQueryServerString(Display* _dpy, i32 _screen, i32 _name) { return GLAD_INSTRUMENT_CALL(glXQueryServerString, _dpy, _screen, _name); }
...
inline i32 glad_wrapped_glXGetFBConfigAttrib(Display* _dpy, GLXFBConfig _config, i32 _attribute, i32* _value) { return GLAD_INSTRUMENT_CALL(glXGetFBConfigAttrib, _dpy, _config, _attribute, _value); }
		#define glXGetFBConfigAttrib glad_wrapped_glXGetFBConfigAttrib
struct glad_tag_glXUseXFont {};
inline void glad_wrapped_glXUseXFont(Font _font, i32 _first, i32 _count, i32 _list) { GLAD_INSTRUMENT_CALL(glXUseXFont, _font, _first, _count, _list); }
...
inline GLXFBConfig* glad_wrapped_glXChooseFBConfig(Display* _dpy, i32 _screen, i32k* _attrib_list, i32* _nelements) { return GLAD_INSTRUMENT_CALL(glXChooseFBConfig, _dpy, _screen, _attrib_list, _nelements); }
		#define glXChooseFBConfig glad_wrapped_glXChooseFBConfig
struct glad_tag_glXCreateNewContext {};
inline GLXContext glad_wrapped_glXCreateNewContext(Display* _dpy, GLXFBConfig _config, i32 _render_type, GLXContext _share_list, Bool _direct) { return GLAD_INSTRUMENT_CALL(glXCreateNewContext, _dpy, _config, _render_type, _share_list, _direct); }
...
inline i32 glad_wrapped_glXGetConfig(Display* _dpy, XVisualInfo* _visual, i32 _attrib, i32* _value) { return GLAD_INSTRUMENT_CALL(glXGetConfig, _dpy, _visual, _attrib, _value); }
		#define glXGetConfig glad_wrapped_glXGetConfig
struct glad_tag_glXGetFBConfigs {};
inline GLXFBConfig* glad_wrapped_glXGetFBConfigs(Display* _dpy, i32 _screen, i32* _nelements) { return GLAD_INSTRUMENT_CALL(glXGetFBConfigs, _dpy, _screen, _nelements); }
		#define glXGetFBConfigs glad_wrapped_glXGetFBConfigs
struct glad_tag_glXCreatePixmap {};
inline GLXPixmap glad_wrapped_glXCreatePixmap(Display* _dpy, GLXFBConfig _config, Pixmap _pixmap, i32k* _attrib_list) { return GLAD_INSTRUMENT_CALL(glXCreatePixmap, _dpy, _config, _pixmap, _attrib_list); }
...
inline void glad_wrapped_glXQueryDrawable(Display* _dpy, GLXDrawable _draw, i32 _attribute, u32* _value) { GLAD_INSTRUMENT_CALL(glXQueryDrawable, _dpy, _draw, _attribute, _value); }
		#define glXQueryDrawable glad_wrapped_glXQueryDrawable
struct glad_tag_glXQueryExtensionsString {};
inline tukk glad_wrapped_glXQueryExtensionsString(Display* _dpy, i32 _screen) { return GLAD_INSTRUMENT_CALL(glXQueryExtensionsString, _dpy, _screen); }
		#define glXQueryExtensionsString glad_wrapped_glXQueryExtensionsString
struct glad_tag_glXGetClientString {};
inline tukk glad_wrapped_glXGetClientString(Display* _dpy, i32 _name) { return GLAD_INSTRUMENT_CALL(glXGetClientString, _dpy, _name); }
