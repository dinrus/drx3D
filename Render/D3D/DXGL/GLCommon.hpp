...
// -------------------------------------------------------------------------
//  Имя файла:   GLCommon.hpp
//  Version:     v1.00
//  Created:     05/03/2013 by Valerio Guagliumi.
//  Описание: Declares the types and functions that implement the
//               OpenGL rendering functionality of DXGL
// -------------------------------------------------------------------------
//  История:
//   - 27/03/2014: Renamed from DrxOpenGLImpl.hpp,
//                 moved drx3D dependencies to GLDrxPlatform.hpp
//
////////////////////////////////////////////////////////////////////////////
...
#include <drx3D/Render/GLPlatform.hpp>
...
// Android with OpenGL 4
	...
	#endif
#elif DRX_PLATFORM_LINUX || DRX_PLATFORM_ANDROID || DRX_PLATFORM_WINDOWS
...
#if DRX_PLATFORM_MOBILE && defined(USE_SDL2_VIDEO)
...
#include <drx3D/Render/GLFeatures.hpp>
