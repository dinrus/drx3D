...
GLAPI i32 gladLoadGL(void);

GLAPI i32 gladLoadGLLoader(GLADloadproc);
...
typedef uk            GLeglImageOES;
typedef char             GLchar;
typedef char             GLcharARB;
#ifdef __APPLE__
typedef uk            GLhandleARB;
#else
typedef u32     GLhandleARB;
#endif
...
struct _cl_context;
struct _cl_event;
typedef void (APIENTRY * GLDEBUGPROC)(GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const GLchar* message, ukk userParam);
typedef void (APIENTRY * GLDEBUGPROCARB)(GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const GLchar* message, ukk userParam);
typedef void (APIENTRY * GLDEBUGPROCKHR)(GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const GLchar* message, ukk userParam);
typedef void (APIENTRY * GLDEBUGPROCAMD)(GLuint id, GLenum category, GLenum severity, GLsizei length, const GLchar* message, uk userParam);
...
typedef void (APIENTRYP           PFNGLTEXIMAGE1DPROC)(GLenum, GLint, GLint, GLsizei, GLint, GLenum, GLenum, ukk );
GLAPI PFNGLTEXIMAGE1DPROC glad_glTexImage1D;
typedef void (APIENTRYP           PFNGLTEXIMAGE2DPROC)(GLenum, GLint, GLint, GLsizei, GLsizei, GLint, GLenum, GLenum, ukk );
...
typedef void (APIENTRYP           PFNGLREADPIXELSPROC)(GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, uk );
...
typedef void (APIENTRYP           PFNGLGETTEXIMAGEPROC)(GLenum, GLint, GLenum, GLenum, uk );
...
GLAPI i32 GLAD_GL_VERSION_1_1;
typedef void (APIENTRYP      PFNGLDRAWARRAYSPROC)(GLenum, GLint, GLsizei);
GLAPI PFNGLDRAWARRAYSPROC glad_glDrawArrays;
typedef void (APIENTRYP      PFNGLDRAWELEMENTSPROC)(GLenum, GLsizei, GLenum, ukk );
...
typedef void (APIENTRYP      PFNGLTEXSUBIMAGE1DPROC)(GLenum, GLint, GLint, GLsizei, GLenum, GLenum, ukk );
GLAPI PFNGLTEXSUBIMAGE1DPROC glad_glTexSubImage1D;
typedef void (APIENTRYP      PFNGLTEXSUBIMAGE2DPROC)(GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, ukk );
...
GLAPI i32 GLAD_GL_VERSION_1_2;
typedef void (APIENTRYP PFNGLDRAWRANGEELEMENTSPROC)(GLenum, GLuint, GLuint, GLsizei, GLenum, ukk );
GLAPI PFNGLDRAWRANGEELEMENTSPROC glad_glDrawRangeElements;
typedef void (APIENTRYP PFNGLTEXIMAGE3DPROC)(GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, ukk );
GLAPI PFNGLTEXIMAGE3DPROC glad_glTexImage3D;
typedef void (APIENTRYP PFNGLTEXSUBIMAGE3DPROC)(GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, ukk );
...
typedef void (APIENTRYP PFNGLCOMPRESSEDTEXIMAGE3DPROC)(GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLint, GLsizei, ukk );
GLAPI PFNGLCOMPRESSEDTEXIMAGE3DPROC glad_glCompressedTexImage3D;
typedef void (APIENTRYP PFNGLCOMPRESSEDTEXIMAGE2DPROC)(GLenum, GLint, GLenum, GLsizei, GLsizei, GLint, GLsizei, ukk );
GLAPI PFNGLCOMPRESSEDTEXIMAGE2DPROC glad_glCompressedTexImage2D;
typedef void (APIENTRYP PFNGLCOMPRESSEDTEXIMAGE1DPROC)(GLenum, GLint, GLenum, GLsizei, GLint, GLsizei, ukk );
GLAPI PFNGLCOMPRESSEDTEXIMAGE1DPROC glad_glCompressedTexImage1D;
typedef void (APIENTRYP PFNGLCOMPRESSEDTEXSUBIMAGE3DPROC)(GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLsizei, ukk );
GLAPI PFNGLCOMPRESSEDTEXSUBIMAGE3DPROC glad_glCompressedTexSubImage3D;
typedef void (APIENTRYP PFNGLCOMPRESSEDTEXSUBIMAGE2DPROC)(GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLsizei, ukk );
GLAPI PFNGLCOMPRESSEDTEXSUBIMAGE2DPROC glad_glCompressedTexSubImage2D;
typedef void (APIENTRYP PFNGLCOMPRESSEDTEXSUBIMAGE1DPROC)(GLenum, GLint, GLint, GLsizei, GLenum, GLsizei, ukk );
GLAPI PFNGLCOMPRESSEDTEXSUBIMAGE1DPROC glad_glCompressedTexSubImage1D;
typedef void (APIENTRYP PFNGLGETCOMPRESSEDTEXIMAGEPROC)(GLenum, GLint, uk );
GLAPI PFNGLGETCOMPRESSEDTEXIMAGEPROC glad_glGetCompressedTexImage;
#endif
#ifndef GL_VERSION_1_4
	#define GL_VERSION_1_4 1
GLAPI i32 GLAD_GL_VERSION_1_4;
...
typedef void (APIENTRYP PFNGLMULTIDRAWELEMENTSPROC)(GLenum, const GLsizei*, GLenum, ukk *, GLsizei);
...
typedef void (APIENTRYP      PFNGLBUFFERDATAPROC)(GLenum, GLsizeiptr, ukk , GLenum);
GLAPI PFNGLBUFFERDATAPROC glad_glBufferData;
typedef void (APIENTRYP      PFNGLBUFFERSUBDATAPROC)(GLenum, GLintptr, GLsizeiptr, ukk );
GLAPI PFNGLBUFFERSUBDATAPROC glad_glBufferSubData;
typedef void (APIENTRYP      PFNGLGETBUFFERSUBDATAPROC)(GLenum, GLintptr, GLsizeiptr, uk );
GLAPI PFNGLGETBUFFERSUBDATAPROC glad_glGetBufferSubData;
typedef uk (APIENTRYP     PFNGLMAPBUFFERPROC)(GLenum, GLenum);
...
typedef void (APIENTRYP      PFNGLGETBUFFERPOINTERVPROC)(GLenum, GLenum, uk *);
GLAPI PFNGLGETBUFFERPOINTERVPROC glad_glGetBufferPointerv;
#endif
#ifndef GL_VERSION_2_0
	#define GL_VERSION_2_0 1
GLAPI i32 GLAD_GL_VERSION_2_0;
...
typedef void (APIENTRYP      PFNGLGETVERTEXATTRIBPOINTERVPROC)(GLuint, GLenum, uk *);
...
typedef void (APIENTRYP      PFNGLVERTEXATTRIBPOINTERPROC)(GLuint, GLint, GLenum, GLboolean, GLsizei, ukk );
GLAPI PFNGLVERTEXATTRIBPOINTERPROC glad_glVertexAttribPointer;
#endif
#ifndef GL_VERSION_2_1
	#define GL_VERSION_2_1 1
GLAPI i32 GLAD_GL_VERSION_2_1;
...
typedef void (APIENTRYP           PFNGLVERTEXATTRIBIPOINTERPROC)(GLuint, GLint, GLenum, GLsizei, ukk );
...
typedef uk (APIENTRYP          PFNGLMAPBUFFERRANGEPROC)(GLenum, GLintptr, GLsizeiptr, GLbitfield);
...
GLAPI i32 GLAD_GL_VERSION_3_1;
typedef void (APIENTRYP   PFNGLDRAWARRAYSINSTANCEDPROC)(GLenum, GLint, GLsizei, GLsizei);
GLAPI PFNGLDRAWARRAYSINSTANCEDPROC glad_glDrawArraysInstanced;
typedef void (APIENTRYP   PFNGLDRAWELEMENTSINSTANCEDPROC)(GLenum, GLsizei, GLenum, ukk , GLsizei);
...
GLAPI i32 GLAD_GL_VERSION_3_2;
typedef void (APIENTRYP      PFNGLDRAWELEMENTSBASEVERTEXPROC)(GLenum, GLsizei, GLenum, ukk , GLint);
GLAPI PFNGLDRAWELEMENTSBASEVERTEXPROC glad_glDrawElementsBaseVertex;
typedef void (APIENTRYP      PFNGLDRAWRANGEELEMENTSBASEVERTEXPROC)(GLenum, GLuint, GLuint, GLsizei, GLenum, ukk , GLint);
GLAPI PFNGLDRAWRANGEELEMENTSBASEVERTEXPROC glad_glDrawRangeElementsBaseVertex;
typedef void (APIENTRYP      PFNGLDRAWELEMENTSINSTANCEDBASEVERTEXPROC)(GLenum, GLsizei, GLenum, ukk , GLsizei, GLint);
GLAPI PFNGLDRAWELEMENTSINSTANCEDBASEVERTEXPROC glad_glDrawElementsInstancedBaseVertex;
typedef void (APIENTRYP      PFNGLMULTIDRAWELEMENTSBASEVERTEXPROC)(GLenum, const GLsizei*, GLenum, ukk *, GLsizei, const GLint*);
...
typedef void (APIENTRYP      PFNGLDRAWARRAYSINDIRECTPROC)(GLenum, ukk );
GLAPI PFNGLDRAWARRAYSINDIRECTPROC glad_glDrawArraysIndirect;
typedef void (APIENTRYP      PFNGLDRAWELEMENTSINDIRECTPROC)(GLenum, GLenum, ukk );
...
GLAPI i32 GLAD_GL_VERSION_4_1;
typedef void (APIENTRYP      PFNGLRELEASESHADERCOMPILERPROC)();
GLAPI PFNGLRELEASESHADERCOMPILERPROC glad_glReleaseShaderCompiler;
typedef void (APIENTRYP      PFNGLSHADERBINARYPROC)(GLsizei, const GLuint*, GLenum, ukk , GLsizei);
...
typedef void (APIENTRYP      PFNGLGETPROGRAMBINARYPROC)(GLuint, GLsizei, GLsizei*, GLenum*, uk );
GLAPI PFNGLGETPROGRAMBINARYPROC glad_glGetProgramBinary;
typedef void (APIENTRYP      PFNGLPROGRAMBINARYPROC)(GLuint, GLenum, ukk , GLsizei);
...
typedef void (APIENTRYP      PFNGLVERTEXATTRIBLPOINTERPROC)(GLuint, GLint, GLenum, GLsizei, ukk );
...
typedef void (APIENTRYP PFNGLDRAWELEMENTSINSTANCEDBASEINSTANCEPROC)(GLenum, GLsizei, GLenum, ukk , GLsizei, GLuint);
GLAPI PFNGLDRAWELEMENTSINSTANCEDBASEINSTANCEPROC glad_glDrawElementsInstancedBaseInstance;
typedef void (APIENTRYP PFNGLDRAWELEMENTSINSTANCEDBASEVERTEXBASEINSTANCEPROC)(GLenum, GLsizei, GLenum, ukk , GLsizei, GLint, GLuint);
...
GLAPI i32 GLAD_GL_VERSION_4_3;
typedef void (APIENTRYP   PFNGLCLEARBUFFERDATAPROC)(GLenum, GLenum, GLenum, GLenum, ukk );
GLAPI PFNGLCLEARBUFFERDATAPROC glad_glClearBufferData;
typedef void (APIENTRYP   PFNGLCLEARBUFFERSUBDATAPROC)(GLenum, GLenum, GLintptr, GLsizeiptr, GLenum, GLenum, ukk );
...
typedef void (APIENTRYP   PFNGLMULTIDRAWARRAYSINDIRECTPROC)(GLenum, ukk , GLsizei, GLsizei);
GLAPI PFNGLMULTIDRAWARRAYSINDIRECTPROC glad_glMultiDrawArraysIndirect;
typedef void (APIENTRYP   PFNGLMULTIDRAWELEMENTSINDIRECTPROC)(GLenum, GLenum, ukk , GLsizei, GLsizei);
...
typedef void (APIENTRYP   PFNGLDEBUGMESSAGECALLBACKPROC)(GLDEBUGPROC, ukk );
...
typedef void (APIENTRYP   PFNGLOBJECTPTRLABELPROC)(ukk , GLsizei, const GLchar*);
GLAPI PFNGLOBJECTPTRLABELPROC glad_glObjectPtrLabel;
typedef void (APIENTRYP   PFNGLGETOBJECTPTRLABELPROC)(ukk , GLsizei, GLsizei*, GLchar*);
GLAPI PFNGLGETOBJECTPTRLABELPROC glad_glGetObjectPtrLabel;
#endif
#ifndef GL_VERSION_4_4
	#define GL_VERSION_4_4 1
GLAPI i32 GLAD_GL_VERSION_4_4;
typedef void (APIENTRYP PFNGLBUFFERSTORAGEPROC)(GLenum, GLsizeiptr, ukk , GLbitfield);
GLAPI PFNGLBUFFERSTORAGEPROC glad_glBufferStorage;
typedef void (APIENTRYP PFNGLCLEARTEXIMAGEPROC)(GLuint, GLint, GLenum, GLenum, ukk );
GLAPI PFNGLCLEARTEXIMAGEPROC glad_glClearTexImage;
typedef void (APIENTRYP PFNGLCLEARTEXSUBIMAGEPROC)(GLuint, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, ukk );
...
typedef void (APIENTRYP      PFNGLNAMEDBUFFERSTORAGEPROC)(GLuint, GLsizeiptr, ukk , GLbitfield);
GLAPI PFNGLNAMEDBUFFERSTORAGEPROC glad_glNamedBufferStorage;
typedef void (APIENTRYP      PFNGLNAMEDBUFFERDATAPROC)(GLuint, GLsizeiptr, ukk , GLenum);
GLAPI PFNGLNAMEDBUFFERDATAPROC glad_glNamedBufferData;
typedef void (APIENTRYP      PFNGLNAMEDBUFFERSUBDATAPROC)(GLuint, GLintptr, GLsizeiptr, ukk );
...
typedef void (APIENTRYP      PFNGLCLEARNAMEDBUFFERDATAPROC)(GLuint, GLenum, GLenum, GLenum, ukk );
GLAPI PFNGLCLEARNAMEDBUFFERDATAPROC glad_glClearNamedBufferData;
typedef void (APIENTRYP      PFNGLCLEARNAMEDBUFFERSUBDATAPROC)(GLuint, GLenum, GLintptr, GLsizeiptr, GLenum, GLenum, ukk );
GLAPI PFNGLCLEARNAMEDBUFFERSUBDATAPROC glad_glClearNamedBufferSubData;
typedef uk (APIENTRYP     PFNGLMAPNAMEDBUFFERPROC)(GLuint, GLenum);
GLAPI PFNGLMAPNAMEDBUFFERPROC glad_glMapNamedBuffer;
typedef uk (APIENTRYP     PFNGLMAPNAMEDBUFFERRANGEPROC)(GLuint, GLintptr, GLsizeiptr, GLbitfield);
...
typedef void (APIENTRYP      PFNGLGETNAMEDBUFFERPOINTERVPROC)(GLuint, GLenum, uk *);
GLAPI PFNGLGETNAMEDBUFFERPOINTERVPROC glad_glGetNamedBufferPointerv;
typedef void (APIENTRYP      PFNGLGETNAMEDBUFFERSUBDATAPROC)(GLuint, GLintptr, GLsizeiptr, uk );
...
typedef void (APIENTRYP      PFNGLTEXTURESUBIMAGE1DPROC)(GLuint, GLint, GLint, GLsizei, GLenum, GLenum, ukk );
GLAPI PFNGLTEXTURESUBIMAGE1DPROC glad_glTextureSubImage1D;
typedef void (APIENTRYP      PFNGLTEXTURESUBIMAGE2DPROC)(GLuint, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, ukk );
GLAPI PFNGLTEXTURESUBIMAGE2DPROC glad_glTextureSubImage2D;
typedef void (APIENTRYP      PFNGLTEXTURESUBIMAGE3DPROC)(GLuint, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, ukk );
GLAPI PFNGLTEXTURESUBIMAGE3DPROC glad_glTextureSubImage3D;
typedef void (APIENTRYP      PFNGLCOMPRESSEDTEXTURESUBIMAGE1DPROC)(GLuint, GLint, GLint, GLsizei, GLenum, GLsizei, ukk );
GLAPI PFNGLCOMPRESSEDTEXTURESUBIMAGE1DPROC glad_glCompressedTextureSubImage1D;
typedef void (APIENTRYP      PFNGLCOMPRESSEDTEXTURESUBIMAGE2DPROC)(GLuint, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLsizei, ukk );
GLAPI PFNGLCOMPRESSEDTEXTURESUBIMAGE2DPROC glad_glCompressedTextureSubImage2D;
typedef void (APIENTRYP      PFNGLCOMPRESSEDTEXTURESUBIMAGE3DPROC)(GLuint, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLsizei, ukk );
...
typedef void (APIENTRYP      PFNGLGETTEXTUREIMAGEPROC)(GLuint, GLint, GLenum, GLenum, GLsizei, uk );
GLAPI PFNGLGETTEXTUREIMAGEPROC glad_glGetTextureImage;
typedef void (APIENTRYP      PFNGLGETCOMPRESSEDTEXTUREIMAGEPROC)(GLuint, GLint, GLsizei, uk );
...
typedef void (APIENTRYP      PFNGLGETTEXTURESUBIMAGEPROC)(GLuint, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, GLsizei, uk );
GLAPI PFNGLGETTEXTURESUBIMAGEPROC glad_glGetTextureSubImage;
typedef void (APIENTRYP      PFNGLGETCOMPRESSEDTEXTURESUBIMAGEPROC)(GLuint, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLsizei, uk );
...
typedef void (APIENTRYP      PFNGLGETNCOMPRESSEDTEXIMAGEPROC)(GLenum, GLint, GLsizei, uk );
GLAPI PFNGLGETNCOMPRESSEDTEXIMAGEPROC glad_glGetnCompressedTexImage;
typedef void (APIENTRYP      PFNGLGETNTEXIMAGEPROC)(GLenum, GLint, GLenum, GLenum, GLsizei, uk );
...
typedef void (APIENTRYP      PFNGLREADNPIXELSPROC)(GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, GLsizei, uk );
...
typedef void (APIENTRYP      PFNGLGETNCOLORTABLEPROC)(GLenum, GLenum, GLenum, GLsizei, uk );
GLAPI PFNGLGETNCOLORTABLEPROC glad_glGetnColorTable;
typedef void (APIENTRYP      PFNGLGETNCONVOLUTIONFILTERPROC)(GLenum, GLenum, GLenum, GLsizei, uk );
GLAPI PFNGLGETNCONVOLUTIONFILTERPROC glad_glGetnConvolutionFilter;
typedef void (APIENTRYP      PFNGLGETNSEPARABLEFILTERPROC)(GLenum, GLenum, GLenum, GLsizei, uk , GLsizei, uk , uk );
GLAPI PFNGLGETNSEPARABLEFILTERPROC glad_glGetnSeparableFilter;
typedef void (APIENTRYP      PFNGLGETNHISTOGRAMPROC)(GLenum, GLboolean, GLenum, GLenum, GLsizei, uk );
GLAPI PFNGLGETNHISTOGRAMPROC glad_glGetnHistogram;
typedef void (APIENTRYP      PFNGLGETNMINMAXPROC)(GLenum, GLboolean, GLenum, GLenum, GLsizei, uk );
...
inline void glad_wrapped_glCompressedTexSubImage3D(GLenum _target, GLint _level, GLint _xoffset, GLint _yoffset, GLint _zoffset, GLsizei _width, GLsizei _height, GLsizei _depth, GLenum _format, GLsizei _imageSize, ukk _data) { GLAD_INSTRUMENT_CALL(glCompressedTexSubImage3D, _target, _level, _xoffset, _yoffset, _zoffset, _width, _height, _depth, _format, _imageSize, _data); }
...
inline void glad_wrapped_glCompressedTextureSubImage3D(GLuint _texture, GLint _level, GLint _xoffset, GLint _yoffset, GLint _zoffset, GLsizei _width, GLsizei _height, GLsizei _depth, GLenum _format, GLsizei _imageSize, ukk _data) { GLAD_INSTRUMENT_CALL(glCompressedTextureSubImage3D, _texture, _level, _xoffset, _yoffset, _zoffset, _width, _height, _depth, _format, _imageSize, _data); }
...
inline void glad_wrapped_glGetCompressedTextureImage(GLuint _texture, GLint _level, GLsizei _bufSize, uk _pixels) { GLAD_INSTRUMENT_CALL(glGetCompressedTextureImage, _texture, _level, _bufSize, _pixels); }
...
inline void glad_wrapped_glGetTextureImage(GLuint _texture, GLint _level, GLenum _format, GLenum _type, GLsizei _bufSize, uk _pixels) { GLAD_INSTRUMENT_CALL(glGetTextureImage, _texture, _level, _format, _type, _bufSize, _pixels); }
...
inline void glad_wrapped_glVertexAttribIPointer(GLuint _index, GLint _size, GLenum _type, GLsizei _stride, ukk _pointer) { GLAD_INSTRUMENT_CALL(glVertexAttribIPointer, _index, _size, _type, _stride, _pointer); }
...
inline void glad_wrapped_glDrawElementsInstancedBaseInstance(GLenum _mode, GLsizei _count, GLenum _type, ukk _indices, GLsizei _instancecount, GLuint _baseinstance) { GLAD_INSTRUMENT_CALL(glDrawElementsInstancedBaseInstance, _mode, _count, _type, _indices, _instancecount, _baseinstance); }
...
inline void glad_wrapped_glCompressedTexImage2D(GLenum _target, GLint _level, GLenum _internalformat, GLsizei _width, GLsizei _height, GLint _border, GLsizei _imageSize, ukk _data) { GLAD_INSTRUMENT_CALL(glCompressedTexImage2D, _target, _level, _internalformat, _width, _height, _border, _imageSize, _data); }
...
inline void glad_wrapped_glDrawArraysIndirect(GLenum _mode, ukk _indirect) { GLAD_INSTRUMENT_CALL(glDrawArraysIndirect, _mode, _indirect); }
...
inline uk glad_wrapped_glMapNamedBufferRange(GLuint _buffer, GLintptr _offset, GLsizeiptr _length, GLbitfield _access) { return GLAD_INSTRUMENT_CALL(glMapNamedBufferRange, _buffer, _offset, _length, _access); }
...
inline void glad_wrapped_glTexImage1D(GLenum _target, GLint _level, GLint _internalformat, GLsizei _width, GLint _border, GLenum _format, GLenum _type, ukk _pixels) { GLAD_INSTRUMENT_CALL(glTexImage1D, _target, _level, _internalformat, _width, _border, _format, _type, _pixels); }
...
inline void glad_wrapped_glGetTexImage(GLenum _target, GLint _level, GLenum _format, GLenum _type, uk _pixels) { GLAD_INSTRUMENT_CALL(glGetTexImage, _target, _level, _format, _type, _pixels); }
...
inline void glad_wrapped_glClearTexSubImage(GLuint _texture, GLint _level, GLint _xoffset, GLint _yoffset, GLint _zoffset, GLsizei _width, GLsizei _height, GLsizei _depth, GLenum _format, GLenum _type, ukk _data) { GLAD_INSTRUMENT_CALL(glClearTexSubImage, _texture, _level, _xoffset, _yoffset, _zoffset, _width, _height, _depth, _format, _type, _data); }
...
inline uk glad_wrapped_glMapNamedBuffer(GLuint _buffer, GLenum _access) { return GLAD_INSTRUMENT_CALL(glMapNamedBuffer, _buffer, _access); }
...
inline void glad_wrapped_glDrawElementsInstanced(GLenum _mode, GLsizei _count, GLenum _type, ukk _indices, GLsizei _instancecount) { GLAD_INSTRUMENT_CALL(glDrawElementsInstanced, _mode, _count, _type, _indices, _instancecount); }
...
inline void glad_wrapped_glGetVertexAttribPointerv(GLuint _index, GLenum _pname, uk * _pointer) { GLAD_INSTRUMENT_CALL(glGetVertexAttribPointerv, _index, _pname, _pointer); }
...
inline void glad_wrapped_glGetnMinmax(GLenum _target, GLboolean _reset, GLenum _format, GLenum _type, GLsizei _bufSize, uk _values) { GLAD_INSTRUMENT_CALL(glGetnMinmax, _target, _reset, _format, _type, _bufSize, _values); }
...
inline void glad_wrapped_glVertexAttribPointer(GLuint _index, GLint _size, GLenum _type, GLboolean _normalized, GLsizei _stride, ukk _pointer) { GLAD_INSTRUMENT_CALL(glVertexAttribPointer, _index, _size, _type, _normalized, _stride, _pointer); }
...
inline void glad_wrapped_glGetObjectPtrLabel(ukk _ptr, GLsizei _bufSize, GLsizei* _length, GLchar* _label) { GLAD_INSTRUMENT_CALL(glGetObjectPtrLabel, _ptr, _bufSize, _length, _label); }
...
inline void glad_wrapped_glTexSubImage3D(GLenum _target, GLint _level, GLint _xoffset, GLint _yoffset, GLint _zoffset, GLsizei _width, GLsizei _height, GLsizei _depth, GLenum _format, GLenum _type, ukk _pixels) { GLAD_INSTRUMENT_CALL(glTexSubImage3D, _target, _level, _xoffset, _yoffset, _zoffset, _width, _height, _depth, _format, _type, _pixels); }
...
inline void glad_wrapped_glTextureSubImage3D(GLuint _texture, GLint _level, GLint _xoffset, GLint _yoffset, GLint _zoffset, GLsizei _width, GLsizei _height, GLsizei _depth, GLenum _format, GLenum _type, ukk _pixels) { GLAD_INSTRUMENT_CALL(glTextureSubImage3D, _texture, _level, _xoffset, _yoffset, _zoffset, _width, _height, _depth, _format, _type, _pixels); }
...
inline void glad_wrapped_glObjectPtrLabel(ukk _ptr, GLsizei _length, const GLchar* _label) { GLAD_INSTRUMENT_CALL(glObjectPtrLabel, _ptr, _length, _label); }
...
inline void glad_wrapped_glNamedBufferStorage(GLuint _buffer, GLsizeiptr _size, ukk _data, GLbitfield _flags) { GLAD_INSTRUMENT_CALL(glNamedBufferStorage, _buffer, _size, _data, _flags); }
...
inline void glad_wrapped_glGetnColorTable(GLenum _target, GLenum _format, GLenum _type, GLsizei _bufSize, uk _table) { GLAD_INSTRUMENT_CALL(glGetnColorTable, _target, _format, _type, _bufSize, _table); }
	#define glGetnColorTable glad_wrapped_glGetnColorTable
struct glad_tag_glCompressedTextureSubImage1D {};
inline void glad_wrapped_glCompressedTextureSubImage1D(GLuint _texture, GLint _level, GLint _xoffset, GLsizei _width, GLenum _format, GLsizei _imageSize, ukk _data) { GLAD_INSTRUMENT_CALL(glCompressedTextureSubImage1D, _texture, _level, _xoffset, _width, _format, _imageSize, _data); }
...
inline void glad_wrapped_glMultiDrawElementsIndirect(GLenum _mode, GLenum _type, ukk _indirect, GLsizei _drawcount, GLsizei _stride) { GLAD_INSTRUMENT_CALL(glMultiDrawElementsIndirect, _mode, _type, _indirect, _drawcount, _stride); }
...
inline uk glad_wrapped_glMapBuffer(GLenum _target, GLenum _access) { return GLAD_INSTRUMENT_CALL(glMapBuffer, _target, _access); }
	#define glMapBuffer glad_wrapped_glMapBuffer
struct glad_tag_glClearTexImage {};
inline void glad_wrapped_glClearTexImage(GLuint _texture, GLint _level, GLenum _format, GLenum _type, ukk _data) { GLAD_INSTRUMENT_CALL(glClearTexImage, _texture, _level, _format, _type, _data); }
...
inline void glad_wrapped_glCompressedTexImage3D(GLenum _target, GLint _level, GLenum _internalformat, GLsizei _width, GLsizei _height, GLsizei _depth, GLint _border, GLsizei _imageSize, ukk _data) { GLAD_INSTRUMENT_CALL(glCompressedTexImage3D, _target, _level, _internalformat, _width, _height, _depth, _border, _imageSize, _data); }
...
inline void glad_wrapped_glMultiDrawElements(GLenum _mode, const GLsizei* _count, GLenum _type, ukk* _indices, GLsizei _drawcount) { GLAD_INSTRUMENT_CALL(glMultiDrawElements, _mode, _count, _type, _indices, _drawcount); }
...
inline void glad_wrapped_glGetnHistogram(GLenum _target, GLboolean _reset, GLenum _format, GLenum _type, GLsizei _bufSize, uk _values) { GLAD_INSTRUMENT_CALL(glGetnHistogram, _target, _reset, _format, _type, _bufSize, _values); }
...
inline void glad_wrapped_glGetProgramBinary(GLuint _program, GLsizei _bufSize, GLsizei* _length, GLenum* _binaryFormat, uk _binary) { GLAD_INSTRUMENT_CALL(glGetProgramBinary, _program, _bufSize, _length, _binaryFormat, _binary); }
...
inline void glad_wrapped_glMultiDrawElementsBaseVertex(GLenum _mode, const GLsizei* _count, GLenum _type, ukk* _indices, GLsizei _drawcount, const GLint* _basevertex) { GLAD_INSTRUMENT_CALL(glMultiDrawElementsBaseVertex, _mode, _count, _type, _indices, _drawcount, _basevertex); }
	#define glMultiDrawElementsBaseVertex glad_wrapped_glMultiDrawElementsBaseVertex
struct glad_tag_glNamedBufferSubData {};
inline void glad_wrapped_glNamedBufferSubData(GLuint _buffer, GLintptr _offset, GLsizeiptr _size, ukk _data) { GLAD_INSTRUMENT_CALL(glNamedBufferSubData, _buffer, _offset, _size, _data); }
...
inline void glad_wrapped_glGetnConvolutionFilter(GLenum _target, GLenum _format, GLenum _type, GLsizei _bufSize, uk _image) { GLAD_INSTRUMENT_CALL(glGetnConvolutionFilter, _target, _format, _type, _bufSize, _image); }
...
inline void glad_wrapped_glCompressedTexSubImage1D(GLenum _target, GLint _level, GLint _xoffset, GLsizei _width, GLenum _format, GLsizei _imageSize, ukk _data) { GLAD_INSTRUMENT_CALL(glCompressedTexSubImage1D, _target, _level, _xoffset, _width, _format, _imageSize, _data); }
...
inline void glad_wrapped_glDebugMessageCallback(GLDEBUGPROC _callback, ukk _userParam) { GLAD_INSTRUMENT_CALL(glDebugMessageCallback, _callback, _userParam); }
...
inline void glad_wrapped_glGetnTexImage(GLenum _target, GLint _level, GLenum _format, GLenum _type, GLsizei _bufSize, uk _pixels) { GLAD_INSTRUMENT_CALL(glGetnTexImage, _target, _level, _format, _type, _bufSize, _pixels); }
...
inline void glad_wrapped_glMultiDrawArraysIndirect(GLenum _mode, ukk _indirect, GLsizei _drawcount, GLsizei _stride) { GLAD_INSTRUMENT_CALL(glMultiDrawArraysIndirect, _mode, _indirect, _drawcount, _stride); }
...
inline void glad_wrapped_glDrawElementsBaseVertex(GLenum _mode, GLsizei _count, GLenum _type, ukk _indices, GLint _basevertex) { GLAD_INSTRUMENT_CALL(glDrawElementsBaseVertex, _mode, _count, _type, _indices, _basevertex); }
...
inline void glad_wrapped_glClearBufferSubData(GLenum _target, GLenum _internalformat, GLintptr _offset, GLsizeiptr _size, GLenum _format, GLenum _type, ukk _data) { GLAD_INSTRUMENT_CALL(glClearBufferSubData, _target, _internalformat, _offset, _size, _format, _type, _data); }
...
inline void glad_wrapped_glGetCompressedTexImage(GLenum _target, GLint _level, uk _img) { GLAD_INSTRUMENT_CALL(glGetCompressedTexImage, _target, _level, _img); }
	#define glGetCompressedTexImage glad_wrapped_glGetCompressedTexImage
struct glad_tag_glGetnCompressedTexImage {};
inline void glad_wrapped_glGetnCompressedTexImage(GLenum _target, GLint _lod, GLsizei _bufSize, uk _pixels) { GLAD_INSTRUMENT_CALL(glGetnCompressedTexImage, _target, _lod, _bufSize, _pixels); }
...
inline void glad_wrapped_glTexSubImage2D(GLenum _target, GLint _level, GLint _xoffset, GLint _yoffset, GLsizei _width, GLsizei _height, GLenum _format, GLenum _type, ukk _pixels) { GLAD_INSTRUMENT_CALL(glTexSubImage2D, _target, _level, _xoffset, _yoffset, _width, _height, _format, _type, _pixels); }
...
inline void glad_wrapped_glTextureSubImage2D(GLuint _texture, GLint _level, GLint _xoffset, GLint _yoffset, GLsizei _width, GLsizei _height, GLenum _format, GLenum _type, ukk _pixels) { GLAD_INSTRUMENT_CALL(glTextureSubImage2D, _texture, _level, _xoffset, _yoffset, _width, _height, _format, _type, _pixels); }
...
inline void glad_wrapped_glShaderBinary(GLsizei _count, const GLuint* _shaders, GLenum _binaryformat, ukk _binary, GLsizei _length) { GLAD_INSTRUMENT_CALL(glShaderBinary, _count, _shaders, _binaryformat, _binary, _length); }
...
inline void glad_wrapped_glDrawElements(GLenum _mode, GLsizei _count, GLenum _type, ukk _indices) { GLAD_INSTRUMENT_CALL(glDrawElements, _mode, _count, _type, _indices); }
...
inline void glad_wrapped_glClearNamedBufferData(GLuint _buffer, GLenum _internalformat, GLenum _format, GLenum _type, ukk _data) { GLAD_INSTRUMENT_CALL(glClearNamedBufferData, _buffer, _internalformat, _format, _type, _data); }
...
inline void glad_wrapped_glCompressedTextureSubImage2D(GLuint _texture, GLint _level, GLint _xoffset, GLint _yoffset, GLsizei _width, GLsizei _height, GLenum _format, GLsizei _imageSize, ukk _data) { GLAD_INSTRUMENT_CALL(glCompressedTextureSubImage2D, _texture, _level, _xoffset, _yoffset, _width, _height, _format, _imageSize, _data); }
...
inline void glad_wrapped_glReadPixels(GLint _x, GLint _y, GLsizei _width, GLsizei _height, GLenum _format, GLenum _type, uk _pixels) { GLAD_INSTRUMENT_CALL(glReadPixels, _x, _y, _width, _height, _format, _type, _pixels); }
...
inline void glad_wrapped_glVertexAttribLPointer(GLuint _index, GLint _size, GLenum _type, GLsizei _stride, ukk _pointer) { GLAD_INSTRUMENT_CALL(glVertexAttribLPointer, _index, _size, _type, _stride, _pointer); }
...
inline void glad_wrapped_glDrawElementsInstancedBaseVertex(GLenum _mode, GLsizei _count, GLenum _type, ukk _indices, GLsizei _instancecount, GLint _basevertex) { GLAD_INSTRUMENT_CALL(glDrawElementsInstancedBaseVertex, _mode, _count, _type, _indices, _instancecount, _basevertex); }
...
inline void glad_wrapped_glGetBufferSubData(GLenum _target, GLintptr _offset, GLsizeiptr _size, uk _data) { GLAD_INSTRUMENT_CALL(glGetBufferSubData, _target, _offset, _size, _data); }
...
inline void glad_wrapped_glTexImage3D(GLenum _target, GLint _level, GLint _internalformat, GLsizei _width, GLsizei _height, GLsizei _depth, GLint _border, GLenum _format, GLenum _type, ukk _pixels) { GLAD_INSTRUMENT_CALL(glTexImage3D, _target, _level, _internalformat, _width, _height, _depth, _border, _format, _type, _pixels); }
...
inline void glad_wrapped_glGetNamedBufferSubData(GLuint _buffer, GLintptr _offset, GLsizeiptr _size, uk _data) { GLAD_INSTRUMENT_CALL(glGetNamedBufferSubData, _buffer, _offset, _size, _data); }
...
inline void glad_wrapped_glDrawElementsIndirect(GLenum _mode, GLenum _type, ukk _indirect) { GLAD_INSTRUMENT_CALL(glDrawElementsIndirect, _mode, _type, _indirect); }
...
inline void glad_wrapped_glGetNamedBufferPointerv(GLuint _buffer, GLenum _pname, uk * _params) { GLAD_INSTRUMENT_CALL(glGetNamedBufferPointerv, _buffer, _pname, _params); }
...
inline void glad_wrapped_glTextureSubImage1D(GLuint _texture, GLint _level, GLint _xoffset, GLsizei _width, GLenum _format, GLenum _type, ukk _pixels) { GLAD_INSTRUMENT_CALL(glTextureSubImage1D, _texture, _level, _xoffset, _width, _format, _type, _pixels); }
...
inline void glad_wrapped_glCompressedTexSubImage2D(GLenum _target, GLint _level, GLint _xoffset, GLint _yoffset, GLsizei _width, GLsizei _height, GLenum _format, GLsizei _imageSize, ukk _data) { GLAD_INSTRUMENT_CALL(glCompressedTexSubImage2D, _target, _level, _xoffset, _yoffset, _width, _height, _format, _imageSize, _data); }
	#define glCompressedTexSubImage2D glad_wrapped_glCompressedTexSubImage2D
struct glad_tag_glProgramBinary {};
inline void glad_wrapped_glProgramBinary(GLuint _program, GLenum _binaryFormat, ukk _binary, GLsizei _length) { GLAD_INSTRUMENT_CALL(glProgramBinary, _program, _binaryFormat, _binary, _length); }
...
inline void glad_wrapped_glBufferStorage(GLenum _target, GLsizeiptr _size, ukk _data, GLbitfield _flags) { GLAD_INSTRUMENT_CALL(glBufferStorage, _target, _size, _data, _flags); }
...
inline void glad_wrapped_glReadnPixels(GLint _x, GLint _y, GLsizei _width, GLsizei _height, GLenum _format, GLenum _type, GLsizei _bufSize, uk _data) { GLAD_INSTRUMENT_CALL(glReadnPixels, _x, _y, _width, _height, _format, _type, _bufSize, _data); }
...
inline void glad_wrapped_glClearBufferData(GLenum _target, GLenum _internalformat, GLenum _format, GLenum _type, ukk _data) { GLAD_INSTRUMENT_CALL(glClearBufferData, _target, _internalformat, _format, _type, _data); }
...
inline void glad_wrapped_glCompressedTexImage1D(GLenum _target, GLint _level, GLenum _internalformat, GLsizei _width, GLint _border, GLsizei _imageSize, ukk _data) { GLAD_INSTRUMENT_CALL(glCompressedTexImage1D, _target, _level, _internalformat, _width, _border, _imageSize, _data); }
...
inline void glad_wrapped_glDrawRangeElementsBaseVertex(GLenum _mode, GLuint _start, GLuint _end, GLsizei _count, GLenum _type, ukk _indices, GLint _basevertex) { GLAD_INSTRUMENT_CALL(glDrawRangeElementsBaseVertex, _mode, _start, _end, _count, _type, _indices, _basevertex); }
...
inline void glad_wrapped_glDrawRangeElements(GLenum _mode, GLuint _start, GLuint _end, GLsizei _count, GLenum _type, ukk _indices) { GLAD_INSTRUMENT_CALL(glDrawRangeElements, _mode, _start, _end, _count, _type, _indices); }
...
inline void glad_wrapped_glBufferSubData(GLenum _target, GLintptr _offset, GLsizeiptr _size, ukk _data) { GLAD_INSTRUMENT_CALL(glBufferSubData, _target, _offset, _size, _data); }
...
inline uk glad_wrapped_glMapBufferRange(GLenum _target, GLintptr _offset, GLsizeiptr _length, GLbitfield _access) { return GLAD_INSTRUMENT_CALL(glMapBufferRange, _target, _offset, _length, _access); }
...
inline void glad_wrapped_glGetnSeparableFilter(GLenum _target, GLenum _format, GLenum _type, GLsizei _rowBufSize, uk _row, GLsizei _columnBufSize, uk _column, uk _span) { GLAD_INSTRUMENT_CALL(glGetnSeparableFilter, _target, _format, _type, _rowBufSize, _row, _columnBufSize, _column, _span); }
...
inline void glad_wrapped_glBufferData(GLenum _target, GLsizeiptr _size, ukk _data, GLenum _usage) { GLAD_INSTRUMENT_CALL(glBufferData, _target, _size, _data, _usage); }
...
inline void glad_wrapped_glTexSubImage1D(GLenum _target, GLint _level, GLint _xoffset, GLsizei _width, GLenum _format, GLenum _type, ukk _pixels) { GLAD_INSTRUMENT_CALL(glTexSubImage1D, _target, _level, _xoffset, _width, _format, _type, _pixels); }
...
inline void glad_wrapped_glGetBufferPointerv(GLenum _target, GLenum _pname, uk * _params) { GLAD_INSTRUMENT_CALL(glGetBufferPointerv, _target, _pname, _params); }
...
inline void glad_wrapped_glTexImage2D(GLenum _target, GLint _level, GLint _internalformat, GLsizei _width, GLsizei _height, GLint _border, GLenum _format, GLenum _type, ukk _pixels) { GLAD_INSTRUMENT_CALL(glTexImage2D, _target, _level, _internalformat, _width, _height, _border, _format, _type, _pixels); }
...
inline void glad_wrapped_glNamedBufferData(GLuint _buffer, GLsizeiptr _size, ukk _data, GLenum _usage) { GLAD_INSTRUMENT_CALL(glNamedBufferData, _buffer, _size, _data, _usage); }
...
inline void glad_wrapped_glClearNamedBufferSubData(GLuint _buffer, GLenum _internalformat, GLintptr _offset, GLsizeiptr _size, GLenum _format, GLenum _type, ukk _data) { GLAD_INSTRUMENT_CALL(glClearNamedBufferSubData, _buffer, _internalformat, _offset, _size, _format, _type, _data); }
...
inline void glad_wrapped_glGetCompressedTextureSubImage(GLuint _texture, GLint _level, GLint _xoffset, GLint _yoffset, GLint _zoffset, GLsizei _width, GLsizei _height, GLsizei _depth, GLsizei _bufSize, uk _pixels) { GLAD_INSTRUMENT_CALL(glGetCompressedTextureSubImage, _texture, _level, _xoffset, _yoffset, _zoffset, _width, _height, _depth, _bufSize, _pixels); }
...
GLAPI i32 GLAD_GL_ARB_imaging;
typedef void (APIENTRYP PFNGLCOLORTABLEPROC)(GLenum, GLenum, GLsizei, GLenum, GLenum, ukk );
...
typedef void (APIENTRYP PFNGLGETCOLORTABLEPROC)(GLenum, GLenum, GLenum, uk );
...
typedef void (APIENTRYP PFNGLCOLORSUBTABLEPROC)(GLenum, GLsizei, GLsizei, GLenum, GLenum, ukk );
...
typedef void (APIENTRYP PFNGLCONVOLUTIONFILTER1DPROC)(GLenum, GLenum, GLsizei, GLenum, GLenum, ukk );
GLAPI PFNGLCONVOLUTIONFILTER1DPROC glad_glConvolutionFilter1D;
typedef void (APIENTRYP PFNGLCONVOLUTIONFILTER2DPROC)(GLenum, GLenum, GLsizei, GLsizei, GLenum, GLenum, ukk );
...
typedef void (APIENTRYP PFNGLGETCONVOLUTIONFILTERPROC)(GLenum, GLenum, GLenum, uk );
...
typedef void (APIENTRYP PFNGLGETSEPARABLEFILTERPROC)(GLenum, GLenum, GLenum, uk , uk , uk );
GLAPI PFNGLGETSEPARABLEFILTERPROC glad_glGetSeparableFilter;
typedef void (APIENTRYP PFNGLSEPARABLEFILTER2DPROC)(GLenum, GLenum, GLsizei, GLsizei, GLenum, GLenum, ukk , ukk );
GLAPI PFNGLSEPARABLEFILTER2DPROC glad_glSeparableFilter2D;
typedef void (APIENTRYP PFNGLGETHISTOGRAMPROC)(GLenum, GLboolean, GLenum, GLenum, uk );
...
typedef void (APIENTRYP PFNGLGETMINMAXPROC)(GLenum, GLboolean, GLenum, GLenum, uk );
...
GLAPI i32 GLAD_GL_EXT_texture_compression_s3tc;
#endif
#ifndef GL_EXT_texture_sRGB
	#define GL_EXT_texture_sRGB 1
GLAPI i32 GLAD_GL_EXT_texture_sRGB;
#endif
#ifndef GL_EXT_texture_filter_anisotropic
	#define GL_EXT_texture_filter_anisotropic 1
GLAPI i32 GLAD_GL_EXT_texture_filter_anisotropic;
#endif
#ifndef GL_ARB_texture_compression_bptc
	#define GL_ARB_texture_compression_bptc 1
GLAPI i32 GLAD_GL_ARB_texture_compression_bptc;
#endif
#ifndef GL_ARB_compute_shader
	#define GL_ARB_compute_shader 1
GLAPI i32 GLAD_GL_ARB_compute_shader;
#endif
#ifndef GL_GREMEDY_string_marker
	#define GL_GREMEDY_string_marker 1
GLAPI i32 GLAD_GL_GREMEDY_string_marker;
typedef void (APIENTRYP PFNGLSTRINGMARKERGREMEDYPROC)(GLsizei, ukk );
GLAPI PFNGLSTRINGMARKERGREMEDYPROC glad_glStringMarkerGREMEDY;
#endif
#ifndef GL_KHR_debug
	#define GL_KHR_debug 1
GLAPI i32 GLAD_GL_KHR_debug;
typedef void (APIENTRYP   PFNGLGETPOINTERVPROC)(GLenum, uk *);
...
typedef void (APIENTRYP   PFNGLDEBUGMESSAGECALLBACKKHRPROC)(GLDEBUGPROCKHR, ukk );
...
typedef void (APIENTRYP   PFNGLOBJECTPTRLABELKHRPROC)(ukk , GLsizei, const GLchar*);
GLAPI PFNGLOBJECTPTRLABELKHRPROC glad_glObjectPtrLabelKHR;
typedef void (APIENTRYP   PFNGLGETOBJECTPTRLABELKHRPROC)(ukk , GLsizei, GLsizei*, GLchar*);
GLAPI PFNGLGETOBJECTPTRLABELKHRPROC glad_glGetObjectPtrLabelKHR;
typedef void (APIENTRYP   PFNGLGETPOINTERVKHRPROC)(GLenum, uk *);
GLAPI PFNGLGETPOINTERVKHRPROC glad_glGetPointervKHR;
#endif
#ifndef GL_NVX_gpu_memory_info
	#define GL_NVX_gpu_memory_info 1
GLAPI i32 GLAD_GL_NVX_gpu_memory_info;
#endif
#ifndef GL_ATI_meminfo
	#define GL_ATI_meminfo 1
GLAPI i32 GLAD_GL_ATI_meminfo;
#endif
#ifndef GL_ARB_internalformat_query
	#define GL_ARB_internalformat_query 1
GLAPI i32 GLAD_GL_ARB_internalformat_query;
#endif
#ifndef GL_ARB_internalformat_query2
	#define GL_ARB_internalformat_query2 1
GLAPI i32 GLAD_GL_ARB_internalformat_query2;
#endif
#ifndef GL_EXT_direct_state_access
	#define GL_EXT_direct_state_access 1
GLAPI i32 GLAD_GL_EXT_direct_state_access;
...
typedef void (APIENTRYP      PFNGLTEXTUREIMAGE1DEXTPROC)(GLuint, GLenum, GLint, GLint, GLsizei, GLint, GLenum, GLenum, ukk );
GLAPI PFNGLTEXTUREIMAGE1DEXTPROC glad_glTextureImage1DEXT;
typedef void (APIENTRYP      PFNGLTEXTUREIMAGE2DEXTPROC)(GLuint, GLenum, GLint, GLint, GLsizei, GLsizei, GLint, GLenum, GLenum, ukk );
GLAPI PFNGLTEXTUREIMAGE2DEXTPROC glad_glTextureImage2DEXT;
typedef void (APIENTRYP      PFNGLTEXTURESUBIMAGE1DEXTPROC)(GLuint, GLenum, GLint, GLint, GLsizei, GLenum, GLenum, ukk );
GLAPI PFNGLTEXTURESUBIMAGE1DEXTPROC glad_glTextureSubImage1DEXT;
typedef void (APIENTRYP      PFNGLTEXTURESUBIMAGE2DEXTPROC)(GLuint, GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, ukk );
...
typedef void (APIENTRYP      PFNGLGETTEXTUREIMAGEEXTPROC)(GLuint, GLenum, GLint, GLenum, GLenum, uk );
...
typedef void (APIENTRYP      PFNGLTEXTUREIMAGE3DEXTPROC)(GLuint, GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, ukk );
GLAPI PFNGLTEXTUREIMAGE3DEXTPROC glad_glTextureImage3DEXT;
typedef void (APIENTRYP      PFNGLTEXTURESUBIMAGE3DEXTPROC)(GLuint, GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, ukk );
...
typedef void (APIENTRYP      PFNGLMULTITEXCOORDPOINTEREXTPROC)(GLenum, GLint, GLenum, GLsizei, ukk );
...
typedef void (APIENTRYP      PFNGLMULTITEXIMAGE1DEXTPROC)(GLenum, GLenum, GLint, GLint, GLsizei, GLint, GLenum, GLenum, ukk );
GLAPI PFNGLMULTITEXIMAGE1DEXTPROC glad_glMultiTexImage1DEXT;
typedef void (APIENTRYP      PFNGLMULTITEXIMAGE2DEXTPROC)(GLenum, GLenum, GLint, GLint, GLsizei, GLsizei, GLint, GLenum, GLenum, ukk );
GLAPI PFNGLMULTITEXIMAGE2DEXTPROC glad_glMultiTexImage2DEXT;
typedef void (APIENTRYP      PFNGLMULTITEXSUBIMAGE1DEXTPROC)(GLenum, GLenum, GLint, GLint, GLsizei, GLenum, GLenum, ukk );
GLAPI PFNGLMULTITEXSUBIMAGE1DEXTPROC glad_glMultiTexSubImage1DEXT;
typedef void (APIENTRYP      PFNGLMULTITEXSUBIMAGE2DEXTPROC)(GLenum, GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, ukk );
...
typedef void (APIENTRYP      PFNGLGETMULTITEXIMAGEEXTPROC)(GLenum, GLenum, GLint, GLenum, GLenum, uk );
...
typedef void (APIENTRYP      PFNGLMULTITEXIMAGE3DEXTPROC)(GLenum, GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, ukk );
GLAPI PFNGLMULTITEXIMAGE3DEXTPROC glad_glMultiTexImage3DEXT;
typedef void (APIENTRYP      PFNGLMULTITEXSUBIMAGE3DEXTPROC)(GLenum, GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, ukk );
...
typedef void (APIENTRYP      PFNGLGETPOINTERINDEXEDVEXTPROC)(GLenum, GLuint, uk *);
...
typedef void (APIENTRYP      PFNGLCOMPRESSEDTEXTUREIMAGE3DEXTPROC)(GLuint, GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLint, GLsizei, ukk );
GLAPI PFNGLCOMPRESSEDTEXTUREIMAGE3DEXTPROC glad_glCompressedTextureImage3DEXT;
typedef void (APIENTRYP      PFNGLCOMPRESSEDTEXTUREIMAGE2DEXTPROC)(GLuint, GLenum, GLint, GLenum, GLsizei, GLsizei, GLint, GLsizei, ukk );
GLAPI PFNGLCOMPRESSEDTEXTUREIMAGE2DEXTPROC glad_glCompressedTextureImage2DEXT;
typedef void (APIENTRYP      PFNGLCOMPRESSEDTEXTUREIMAGE1DEXTPROC)(GLuint, GLenum, GLint, GLenum, GLsizei, GLint, GLsizei, ukk );
GLAPI PFNGLCOMPRESSEDTEXTUREIMAGE1DEXTPROC glad_glCompressedTextureImage1DEXT;
typedef void (APIENTRYP      PFNGLCOMPRESSEDTEXTURESUBIMAGE3DEXTPROC)(GLuint, GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLsizei, ukk );
GLAPI PFNGLCOMPRESSEDTEXTURESUBIMAGE3DEXTPROC glad_glCompressedTextureSubImage3DEXT;
typedef void (APIENTRYP      PFNGLCOMPRESSEDTEXTURESUBIMAGE2DEXTPROC)(GLuint, GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLsizei, ukk );
GLAPI PFNGLCOMPRESSEDTEXTURESUBIMAGE2DEXTPROC glad_glCompressedTextureSubImage2DEXT;
typedef void (APIENTRYP      PFNGLCOMPRESSEDTEXTURESUBIMAGE1DEXTPROC)(GLuint, GLenum, GLint, GLint, GLsizei, GLenum, GLsizei, ukk );
GLAPI PFNGLCOMPRESSEDTEXTURESUBIMAGE1DEXTPROC glad_glCompressedTextureSubImage1DEXT;
typedef void (APIENTRYP      PFNGLGETCOMPRESSEDTEXTUREIMAGEEXTPROC)(GLuint, GLenum, GLint, uk );
GLAPI PFNGLGETCOMPRESSEDTEXTUREIMAGEEXTPROC glad_glGetCompressedTextureImageEXT;
typedef void (APIENTRYP      PFNGLCOMPRESSEDMULTITEXIMAGE3DEXTPROC)(GLenum, GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLint, GLsizei, ukk );
GLAPI PFNGLCOMPRESSEDMULTITEXIMAGE3DEXTPROC glad_glCompressedMultiTexImage3DEXT;
typedef void (APIENTRYP      PFNGLCOMPRESSEDMULTITEXIMAGE2DEXTPROC)(GLenum, GLenum, GLint, GLenum, GLsizei, GLsizei, GLint, GLsizei, ukk );
GLAPI PFNGLCOMPRESSEDMULTITEXIMAGE2DEXTPROC glad_glCompressedMultiTexImage2DEXT;
typedef void (APIENTRYP      PFNGLCOMPRESSEDMULTITEXIMAGE1DEXTPROC)(GLenum, GLenum, GLint, GLenum, GLsizei, GLint, GLsizei, ukk );
GLAPI PFNGLCOMPRESSEDMULTITEXIMAGE1DEXTPROC glad_glCompressedMultiTexImage1DEXT;
typedef void (APIENTRYP      PFNGLCOMPRESSEDMULTITEXSUBIMAGE3DEXTPROC)(GLenum, GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLsizei, ukk );
GLAPI PFNGLCOMPRESSEDMULTITEXSUBIMAGE3DEXTPROC glad_glCompressedMultiTexSubImage3DEXT;
typedef void (APIENTRYP      PFNGLCOMPRESSEDMULTITEXSUBIMAGE2DEXTPROC)(GLenum, GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLsizei, ukk );
GLAPI PFNGLCOMPRESSEDMULTITEXSUBIMAGE2DEXTPROC glad_glCompressedMultiTexSubImage2DEXT;
typedef void (APIENTRYP      PFNGLCOMPRESSEDMULTITEXSUBIMAGE1DEXTPROC)(GLenum, GLenum, GLint, GLint, GLsizei, GLenum, GLsizei, ukk );
GLAPI PFNGLCOMPRESSEDMULTITEXSUBIMAGE1DEXTPROC glad_glCompressedMultiTexSubImage1DEXT;
typedef void (APIENTRYP      PFNGLGETCOMPRESSEDMULTITEXIMAGEEXTPROC)(GLenum, GLenum, GLint, uk );
...
typedef void (APIENTRYP      PFNGLNAMEDBUFFERDATAEXTPROC)(GLuint, GLsizeiptr, ukk , GLenum);
GLAPI PFNGLNAMEDBUFFERDATAEXTPROC glad_glNamedBufferDataEXT;
typedef void (APIENTRYP      PFNGLNAMEDBUFFERSUBDATAEXTPROC)(GLuint, GLintptr, GLsizeiptr, ukk );
GLAPI PFNGLNAMEDBUFFERSUBDATAEXTPROC glad_glNamedBufferSubDataEXT;
typedef uk (APIENTRYP     PFNGLMAPNAMEDBUFFEREXTPROC)(GLuint, GLenum);
...
typedef void (APIENTRYP      PFNGLGETNAMEDBUFFERPOINTERVEXTPROC)(GLuint, GLenum, uk *);
GLAPI PFNGLGETNAMEDBUFFERPOINTERVEXTPROC glad_glGetNamedBufferPointervEXT;
typedef void (APIENTRYP      PFNGLGETNAMEDBUFFERSUBDATAEXTPROC)(GLuint, GLintptr, GLsizeiptr, uk );
...
typedef void (APIENTRYP      PFNGLGETPOINTERI_VEXTPROC)(GLenum, GLuint, uk *);
GLAPI PFNGLGETPOINTERI_VEXTPROC glad_glGetPointeri_vEXT;
typedef void (APIENTRYP      PFNGLNAMEDPROGRAMSTRINGEXTPROC)(GLuint, GLenum, GLenum, GLsizei, ukk );
...
typedef void (APIENTRYP      PFNGLGETNAMEDPROGRAMSTRINGEXTPROC)(GLuint, GLenum, GLenum, uk );
...
typedef void (APIENTRYP      PFNGLGETVERTEXARRAYPOINTERVEXTPROC)(GLuint, GLenum, uk *);
...
typedef void (APIENTRYP      PFNGLGETVERTEXARRAYPOINTERI_VEXTPROC)(GLuint, GLuint, GLenum, uk *);
GLAPI PFNGLGETVERTEXARRAYPOINTERI_VEXTPROC glad_glGetVertexArrayPointeri_vEXT;
typedef uk (APIENTRYP     PFNGLMAPNAMEDBUFFERRANGEEXTPROC)(GLuint, GLintptr, GLsizeiptr, GLbitfield);
...
typedef void (APIENTRYP      PFNGLNAMEDBUFFERSTORAGEEXTPROC)(GLuint, GLsizeiptr, ukk , GLbitfield);
GLAPI PFNGLNAMEDBUFFERSTORAGEEXTPROC glad_glNamedBufferStorageEXT;
typedef void (APIENTRYP      PFNGLCLEARNAMEDBUFFERDATAEXTPROC)(GLuint, GLenum, GLenum, GLenum, ukk );
GLAPI PFNGLCLEARNAMEDBUFFERDATAEXTPROC glad_glClearNamedBufferDataEXT;
typedef void (APIENTRYP      PFNGLCLEARNAMEDBUFFERSUBDATAEXTPROC)(GLuint, GLenum, GLsizeiptr, GLsizeiptr, GLenum, GLenum, ukk );
...
GLAPI i32 GLAD_GL_NV_vertex_buffer_unified_memory;
...
GLAPI i32 GLAD_GL_NV_uniform_buffer_unified_memory;
#endif
#ifndef GL_NV_shader_buffer_load
	#define GL_NV_shader_buffer_load 1
GLAPI i32 GLAD_GL_NV_shader_buffer_load;
...
GLAPI i32 GLAD_GL_NV_bindless_multi_draw_indirect;
typedef void (APIENTRYP PFNGLMULTIDRAWARRAYSINDIRECTBINDLESSNVPROC)(GLenum, ukk , GLsizei, GLsizei, GLint);
GLAPI PFNGLMULTIDRAWARRAYSINDIRECTBINDLESSNVPROC glad_glMultiDrawArraysIndirectBindlessNV;
typedef void (APIENTRYP PFNGLMULTIDRAWELEMENTSINDIRECTBINDLESSNVPROC)(GLenum, GLenum, ukk , GLsizei, GLsizei, GLint);
GLAPI PFNGLMULTIDRAWELEMENTSINDIRECTBINDLESSNVPROC glad_glMultiDrawElementsIndirectBindlessNV;
#endif
#ifndef GL_NV_bindless_multi_draw_indirect_count
	#define GL_NV_bindless_multi_draw_indirect_count 1
GLAPI i32 GLAD_GL_NV_bindless_multi_draw_indirect_count;
typedef void (APIENTRYP PFNGLMULTIDRAWARRAYSINDIRECTBINDLESSCOUNTNVPROC)(GLenum, ukk , GLsizei, GLsizei, GLsizei, GLint);
GLAPI PFNGLMULTIDRAWARRAYSINDIRECTBINDLESSCOUNTNVPROC glad_glMultiDrawArraysIndirectBindlessCountNV;
typedef void (APIENTRYP PFNGLMULTIDRAWELEMENTSINDIRECTBINDLESSCOUNTNVPROC)(GLenum, GLenum, ukk , GLsizei, GLsizei, GLsizei, GLint);
GLAPI PFNGLMULTIDRAWELEMENTSINDIRECTBINDLESSCOUNTNVPROC glad_glMultiDrawElementsIndirectBindlessCountNV;
#endif
#ifndef GL_NV_bindless_texture
	#define GL_NV_bindless_texture 1
GLAPI i32 GLAD_GL_NV_bindless_texture;
...
GLAPI i32 GLAD_GL_EXT_shader_image_load_store;
...
GLAPI i32 GLAD_GL_NV_depth_buffer_float;
...
inline void glad_wrapped_glCompressedMultiTexSubImage1DEXT(GLenum _texunit, GLenum _target, GLint _level, GLint _xoffset, GLsizei _width, GLenum _format, GLsizei _imageSize, ukk _bits) { GLAD_INSTRUMENT_CALL(glCompressedMultiTexSubImage1DEXT, _texunit, _target, _level, _xoffset, _width, _format, _imageSize, _bits); }
...
inline void glad_wrapped_glDebugMessageCallbackKHR(GLDEBUGPROCKHR _callback, ukk _userParam) { GLAD_INSTRUMENT_CALL(glDebugMessageCallbackKHR, _callback, _userParam); }
...
inline void glad_wrapped_glCompressedMultiTexSubImage3DEXT(GLenum _texunit, GLenum _target, GLint _level, GLint _xoffset, GLint _yoffset, GLint _zoffset, GLsizei _width, GLsizei _height, GLsizei _depth, GLenum _format, GLsizei _imageSize, ukk _bits) { GLAD_INSTRUMENT_CALL(glCompressedMultiTexSubImage3DEXT, _texunit, _target, _level, _xoffset, _yoffset, _zoffset, _width, _height, _depth, _format, _imageSize, _bits); }
...
inline void glad_wrapped_glNamedBufferStorageEXT(GLuint _buffer, GLsizeiptr _size, ukk _data, GLbitfield _flags) { GLAD_INSTRUMENT_CALL(glNamedBufferStorageEXT, _buffer, _size, _data, _flags); }
...
inline void glad_wrapped_glGetSeparableFilter(GLenum _target, GLenum _format, GLenum _type, uk _row, uk _column, uk _span) { GLAD_INSTRUMENT_CALL(glGetSeparableFilter, _target, _format, _type, _row, _column, _span); }
...
inline void glad_wrapped_glMultiDrawElementsIndirectBindlessNV(GLenum _mode, GLenum _type, ukk _indirect, GLsizei _drawCount, GLsizei _stride, GLint _vertexBufferCount) { GLAD_INSTRUMENT_CALL(glMultiDrawElementsIndirectBindlessNV, _mode, _type, _indirect, _drawCount, _stride, _vertexBufferCount); }
...
inline void glad_wrapped_glObjectPtrLabelKHR(ukk _ptr, GLsizei _length, const GLchar* _label) { GLAD_INSTRUMENT_CALL(glObjectPtrLabelKHR, _ptr, _length, _label); }
...
inline void glad_wrapped_glNamedBufferDataEXT(GLuint _buffer, GLsizeiptr _size, ukk _data, GLenum _usage) { GLAD_INSTRUMENT_CALL(glNamedBufferDataEXT, _buffer, _size, _data, _usage); }
...
inline void glad_wrapped_glCompressedTextureSubImage3DEXT(GLuint _texture, GLenum _target, GLint _level, GLint _xoffset, GLint _yoffset, GLint _zoffset, GLsizei _width, GLsizei _height, GLsizei _depth, GLenum _format, GLsizei _imageSize, ukk _bits) { GLAD_INSTRUMENT_CALL(glCompressedTextureSubImage3DEXT, _texture, _target, _level, _xoffset, _yoffset, _zoffset, _width, _height, _depth, _format, _imageSize, _bits); }
...
inline void glad_wrapped_glCompressedTextureImage3DEXT(GLuint _texture, GLenum _target, GLint _level, GLenum _internalformat, GLsizei _width, GLsizei _height, GLsizei _depth, GLint _border, GLsizei _imageSize, ukk _bits) { GLAD_INSTRUMENT_CALL(glCompressedTextureImage3DEXT, _texture, _target, _level, _internalformat, _width, _height, _depth, _border, _imageSize, _bits); }
	#define glCompressedTextureImage3DEXT glad_wrapped_glCompressedTextureImage3DEXT
struct glad_tag_glColorSubTable {};
inline void glad_wrapped_glColorSubTable(GLenum _target, GLsizei _start, GLsizei _count, GLenum _format, GLenum _type, ukk _data) { GLAD_INSTRUMENT_CALL(glColorSubTable, _target, _start, _count, _format, _type, _data); }
...
inline void glad_wrapped_glGetNamedBufferSubDataEXT(GLuint _buffer, GLintptr _offset, GLsizeiptr _size, uk _data) { GLAD_INSTRUMENT_CALL(glGetNamedBufferSubDataEXT, _buffer, _offset, _size, _data); }
	#define glGetNamedBufferSubDataEXT glad_wrapped_glGetNamedBufferSubDataEXT
struct glad_tag_glConvolutionFilter2D {};
inline void glad_wrapped_glConvolutionFilter2D(GLenum _target, GLenum _internalformat, GLsizei _width, GLsizei _height, GLenum _format, GLenum _type, ukk _image) { GLAD_INSTRUMENT_CALL(glConvolutionFilter2D, _target, _internalformat, _width, _height, _format, _type, _image); }
...
inline void glad_wrapped_glNamedProgramStringEXT(GLuint _program, GLenum _target, GLenum _format, GLsizei _len, ukk _string) { GLAD_INSTRUMENT_CALL(glNamedProgramStringEXT, _program, _target, _format, _len, _string); }
...
inline void glad_wrapped_glGetPointerv(GLenum _pname, uk * _params) { GLAD_INSTRUMENT_CALL(glGetPointerv, _pname, _params); }
...
inline void glad_wrapped_glMultiDrawArraysIndirectBindlessNV(GLenum _mode, ukk _indirect, GLsizei _drawCount, GLsizei _stride, GLint _vertexBufferCount) { GLAD_INSTRUMENT_CALL(glMultiDrawArraysIndirectBindlessNV, _mode, _indirect, _drawCount, _stride, _vertexBufferCount); }
...
inline void glad_wrapped_glCompressedMultiTexImage2DEXT(GLenum _texunit, GLenum _target, GLint _level, GLenum _internalformat, GLsizei _width, GLsizei _height, GLint _border, GLsizei _imageSize, ukk _bits) { GLAD_INSTRUMENT_CALL(glCompressedMultiTexImage2DEXT, _texunit, _target, _level, _internalformat, _width, _height, _border, _imageSize, _bits); }
...
inline void glad_wrapped_glCompressedTextureImage2DEXT(GLuint _texture, GLenum _target, GLint _level, GLenum _internalformat, GLsizei _width, GLsizei _height, GLint _border, GLsizei _imageSize, ukk _bits) { GLAD_INSTRUMENT_CALL(glCompressedTextureImage2DEXT, _texture, _target, _level, _internalformat, _width, _height, _border, _imageSize, _bits); }
...
inline void glad_wrapped_glGetVertexArrayPointeri_vEXT(GLuint _vaobj, GLuint _index, GLenum _pname, uk * _param) { GLAD_INSTRUMENT_CALL(glGetVertexArrayPointeri_vEXT, _vaobj, _index, _pname, _param); }
...
inline void glad_wrapped_glGetMinmax(GLenum _target, GLboolean _reset, GLenum _format, GLenum _type, uk _values) { GLAD_INSTRUMENT_CALL(glGetMinmax, _target, _reset, _format, _type, _values); }
...
inline void glad_wrapped_glCompressedTextureSubImage1DEXT(GLuint _texture, GLenum _target, GLint _level, GLint _xoffset, GLsizei _width, GLenum _format, GLsizei _imageSize, ukk _bits) { GLAD_INSTRUMENT_CALL(glCompressedTextureSubImage1DEXT, _texture, _target, _level, _xoffset, _width, _format, _imageSize, _bits); }
...
inline void glad_wrapped_glGetHistogram(GLenum _target, GLboolean _reset, GLenum _format, GLenum _type, uk _values) { GLAD_INSTRUMENT_CALL(glGetHistogram, _target, _reset, _format, _type, _values); }
...
inline void glad_wrapped_glGetPointeri_vEXT(GLenum _pname, GLuint _index, uk * _params) { GLAD_INSTRUMENT_CALL(glGetPointeri_vEXT, _pname, _index, _params); }
...
inline void glad_wrapped_glMultiTexSubImage2DEXT(GLenum _texunit, GLenum _target, GLint _level, GLint _xoffset, GLint _yoffset, GLsizei _width, GLsizei _height, GLenum _format, GLenum _type, ukk _pixels) { GLAD_INSTRUMENT_CALL(glMultiTexSubImage2DEXT, _texunit, _target, _level, _xoffset, _yoffset, _width, _height, _format, _type, _pixels); }
...
inline void glad_wrapped_glGetPointervKHR(GLenum _pname, uk * _params) { GLAD_INSTRUMENT_CALL(glGetPointervKHR, _pname, _params); }
...
inline void glad_wrapped_glClearNamedBufferDataEXT(GLuint _buffer, GLenum _internalformat, GLenum _format, GLenum _type, ukk _data) { GLAD_INSTRUMENT_CALL(glClearNamedBufferDataEXT, _buffer, _internalformat, _format, _type, _data); }
...
inline void glad_wrapped_glGetNamedBufferPointervEXT(GLuint _buffer, GLenum _pname, uk * _params) { GLAD_INSTRUMENT_CALL(glGetNamedBufferPointervEXT, _buffer, _pname, _params); }
...
inline void glad_wrapped_glConvolutionFilter1D(GLenum _target, GLenum _internalformat, GLsizei _width, GLenum _format, GLenum _type, ukk _image) { GLAD_INSTRUMENT_CALL(glConvolutionFilter1D, _target, _internalformat, _width, _format, _type, _image); }
...
inline void glad_wrapped_glTextureSubImage2DEXT(GLuint _texture, GLenum _target, GLint _level, GLint _xoffset, GLint _yoffset, GLsizei _width, GLsizei _height, GLenum _format, GLenum _type, ukk _pixels) { GLAD_INSTRUMENT_CALL(glTextureSubImage2DEXT, _texture, _target, _level, _xoffset, _yoffset, _width, _height, _format, _type, _pixels); }
...
inline void glad_wrapped_glMultiTexImage1DEXT(GLenum _texunit, GLenum _target, GLint _level, GLint _internalformat, GLsizei _width, GLint _border, GLenum _format, GLenum _type, ukk _pixels) { GLAD_INSTRUMENT_CALL(glMultiTexImage1DEXT, _texunit, _target, _level, _internalformat, _width, _border, _format, _type, _pixels); }
...
inline void glad_wrapped_glCompressedMultiTexSubImage2DEXT(GLenum _texunit, GLenum _target, GLint _level, GLint _xoffset, GLint _yoffset, GLsizei _width, GLsizei _height, GLenum _format, GLsizei _imageSize, ukk _bits) { GLAD_INSTRUMENT_CALL(glCompressedMultiTexSubImage2DEXT, _texunit, _target, _level, _xoffset, _yoffset, _width, _height, _format, _imageSize, _bits); }
...
inline void glad_wrapped_glGetMultiTexImageEXT(GLenum _texunit, GLenum _target, GLint _level, GLenum _format, GLenum _type, uk _pixels) { GLAD_INSTRUMENT_CALL(glGetMultiTexImageEXT, _texunit, _target, _level, _format, _type, _pixels); }
	#define glGetMultiTexImageEXT glad_wrapped_glGetMultiTexImageEXT
struct glad_tag_glGetPointerIndexedvEXT {};
inline void glad_wrapped_glGetPointerIndexedvEXT(GLenum _target, GLuint _index, uk * _data) { GLAD_INSTRUMENT_CALL(glGetPointerIndexedvEXT, _target, _index, _data); }
...
inline void glad_wrapped_glClearNamedBufferSubDataEXT(GLuint _buffer, GLenum _internalformat, GLsizeiptr _offset, GLsizeiptr _size, GLenum _format, GLenum _type, ukk _data) { GLAD_INSTRUMENT_CALL(glClearNamedBufferSubDataEXT, _buffer, _internalformat, _offset, _size, _format, _type, _data); }
	#define glClearNamedBufferSubDataEXT glad_wrapped_glClearNamedBufferSubDataEXT
struct glad_tag_glGetTextureImageEXT {};
inline void glad_wrapped_glGetTextureImageEXT(GLuint _texture, GLenum _target, GLint _level, GLenum _format, GLenum _type, uk _pixels) { GLAD_INSTRUMENT_CALL(glGetTextureImageEXT, _texture, _target, _level, _format, _type, _pixels); }
...
inline uk glad_wrapped_glMapNamedBufferEXT(GLuint _buffer, GLenum _access) { return GLAD_INSTRUMENT_CALL(glMapNamedBufferEXT, _buffer, _access); }
...
inline void glad_wrapped_glGetColorTable(GLenum _target, GLenum _format, GLenum _type, uk _table) { GLAD_INSTRUMENT_CALL(glGetColorTable, _target, _format, _type, _table); }
...
inline uk glad_wrapped_glMapNamedBufferRangeEXT(GLuint _buffer, GLintptr _offset, GLsizeiptr _length, GLbitfield _access) { return GLAD_INSTRUMENT_CALL(glMapNamedBufferRangeEXT, _buffer, _offset, _length, _access); }
...
inline void glad_wrapped_glMultiTexSubImage3DEXT(GLenum _texunit, GLenum _target, GLint _level, GLint _xoffset, GLint _yoffset, GLint _zoffset, GLsizei _width, GLsizei _height, GLsizei _depth, GLenum _format, GLenum _type, ukk _pixels) { GLAD_INSTRUMENT_CALL(glMultiTexSubImage3DEXT, _texunit, _target, _level, _xoffset, _yoffset, _zoffset, _width, _height, _depth, _format, _type, _pixels); }
...
inline void glad_wrapped_glStringMarkerGREMEDY(GLsizei _len, ukk _string) { GLAD_INSTRUMENT_CALL(glStringMarkerGREMEDY, _len, _string); }
...
inline void glad_wrapped_glMultiTexImage3DEXT(GLenum _texunit, GLenum _target, GLint _level, GLint _internalformat, GLsizei _width, GLsizei _height, GLsizei _depth, GLint _border, GLenum _format, GLenum _type, ukk _pixels) { GLAD_INSTRUMENT_CALL(glMultiTexImage3DEXT, _texunit, _target, _level, _internalformat, _width, _height, _depth, _border, _format, _type, _pixels); }
...
inline void glad_wrapped_glGetCompressedTextureImageEXT(GLuint _texture, GLenum _target, GLint _lod, uk _img) { GLAD_INSTRUMENT_CALL(glGetCompressedTextureImageEXT, _texture, _target, _lod, _img); }
...
inline void glad_wrapped_glNamedBufferSubDataEXT(GLuint _buffer, GLintptr _offset, GLsizeiptr _size, ukk _data) { GLAD_INSTRUMENT_CALL(glNamedBufferSubDataEXT, _buffer, _offset, _size, _data); }
...
inline void glad_wrapped_glGetNamedProgramStringEXT(GLuint _program, GLenum _target, GLenum _pname, uk _string) { GLAD_INSTRUMENT_CALL(glGetNamedProgramStringEXT, _program, _target, _pname, _string); }
...
inline void glad_wrapped_glCompressedMultiTexImage3DEXT(GLenum _texunit, GLenum _target, GLint _level, GLenum _internalformat, GLsizei _width, GLsizei _height, GLsizei _depth, GLint _border, GLsizei _imageSize, ukk _bits) { GLAD_INSTRUMENT_CALL(glCompressedMultiTexImage3DEXT, _texunit, _target, _level, _internalformat, _width, _height, _depth, _border, _imageSize, _bits); }
...
inline void glad_wrapped_glTextureImage3DEXT(GLuint _texture, GLenum _target, GLint _level, GLint _internalformat, GLsizei _width, GLsizei _height, GLsizei _depth, GLint _border, GLenum _format, GLenum _type, ukk _pixels) { GLAD_INSTRUMENT_CALL(glTextureImage3DEXT, _texture, _target, _level, _internalformat, _width, _height, _depth, _border, _format, _type, _pixels); }
...
inline void glad_wrapped_glGetVertexArrayPointervEXT(GLuint _vaobj, GLenum _pname, uk * _param) { GLAD_INSTRUMENT_CALL(glGetVertexArrayPointervEXT, _vaobj, _pname, _param); }
...
inline void glad_wrapped_glGetObjectPtrLabelKHR(ukk _ptr, GLsizei _bufSize, GLsizei* _length, GLchar* _label) { GLAD_INSTRUMENT_CALL(glGetObjectPtrLabelKHR, _ptr, _bufSize, _length, _label); }
...
inline void glad_wrapped_glTextureImage2DEXT(GLuint _texture, GLenum _target, GLint _level, GLint _internalformat, GLsizei _width, GLsizei _height, GLint _border, GLenum _format, GLenum _type, ukk _pixels) { GLAD_INSTRUMENT_CALL(glTextureImage2DEXT, _texture, _target, _level, _internalformat, _width, _height, _border, _format, _type, _pixels); }
...
inline void glad_wrapped_glCompressedMultiTexImage1DEXT(GLenum _texunit, GLenum _target, GLint _level, GLenum _internalformat, GLsizei _width, GLint _border, GLsizei _imageSize, ukk _bits) { GLAD_INSTRUMENT_CALL(glCompressedMultiTexImage1DEXT, _texunit, _target, _level, _internalformat, _width, _border, _imageSize, _bits); }
...
inline void glad_wrapped_glMultiTexCoordPointerEXT(GLenum _texunit, GLint _size, GLenum _type, GLsizei _stride, ukk _pointer) { GLAD_INSTRUMENT_CALL(glMultiTexCoordPointerEXT, _texunit, _size, _type, _stride, _pointer); }
...
inline void glad_wrapped_glTextureSubImage1DEXT(GLuint _texture, GLenum _target, GLint _level, GLint _xoffset, GLsizei _width, GLenum _format, GLenum _type, ukk _pixels) { GLAD_INSTRUMENT_CALL(glTextureSubImage1DEXT, _texture, _target, _level, _xoffset, _width, _format, _type, _pixels); }
...
inline void glad_wrapped_glGetCompressedMultiTexImageEXT(GLenum _texunit, GLenum _target, GLint _lod, uk _img) { GLAD_INSTRUMENT_CALL(glGetCompressedMultiTexImageEXT, _texunit, _target, _lod, _img); }
	#define glGetCompressedMultiTexImageEXT glad_wrapped_glGetCompressedMultiTexImageEXT
struct glad_tag_glColorTable {};
inline void glad_wrapped_glColorTable(GLenum _target, GLenum _internalformat, GLsizei _width, GLenum _format, GLenum _type, ukk _table) { GLAD_INSTRUMENT_CALL(glColorTable, _target, _internalformat, _width, _format, _type, _table); }
	#define glColorTable glad_wrapped_glColorTable
struct glad_tag_glMultiTexSubImage1DEXT {};
inline void glad_wrapped_glMultiTexSubImage1DEXT(GLenum _texunit, GLenum _target, GLint _level, GLint _xoffset, GLsizei _width, GLenum _format, GLenum _type, ukk _pixels) { GLAD_INSTRUMENT_CALL(glMultiTexSubImage1DEXT, _texunit, _target, _level, _xoffset, _width, _format, _type, _pixels); }
...
inline void glad_wrapped_glTextureImage1DEXT(GLuint _texture, GLenum _target, GLint _level, GLint _internalformat, GLsizei _width, GLint _border, GLenum _format, GLenum _type, ukk _pixels) { GLAD_INSTRUMENT_CALL(glTextureImage1DEXT, _texture, _target, _level, _internalformat, _width, _border, _format, _type, _pixels); }
...
inline void glad_wrapped_glCompressedTextureSubImage2DEXT(GLuint _texture, GLenum _target, GLint _level, GLint _xoffset, GLint _yoffset, GLsizei _width, GLsizei _height, GLenum _format, GLsizei _imageSize, ukk _bits) { GLAD_INSTRUMENT_CALL(glCompressedTextureSubImage2DEXT, _texture, _target, _level, _xoffset, _yoffset, _width, _height, _format, _imageSize, _bits); }
...
inline void glad_wrapped_glMultiTexImage2DEXT(GLenum _texunit, GLenum _target, GLint _level, GLint _internalformat, GLsizei _width, GLsizei _height, GLint _border, GLenum _format, GLenum _type, ukk _pixels) { GLAD_INSTRUMENT_CALL(glMultiTexImage2DEXT, _texunit, _target, _level, _internalformat, _width, _height, _border, _format, _type, _pixels); }
...
inline void glad_wrapped_glGetConvolutionFilter(GLenum _target, GLenum _format, GLenum _type, uk _image) { GLAD_INSTRUMENT_CALL(glGetConvolutionFilter, _target, _format, _type, _image); }
...
inline void glad_wrapped_glSeparableFilter2D(GLenum _target, GLenum _internalformat, GLsizei _width, GLsizei _height, GLenum _format, GLenum _type, ukk _row, ukk _column) { GLAD_INSTRUMENT_CALL(glSeparableFilter2D, _target, _internalformat, _width, _height, _format, _type, _row, _column); }
...
inline void glad_wrapped_glTextureSubImage3DEXT(GLuint _texture, GLenum _target, GLint _level, GLint _xoffset, GLint _yoffset, GLint _zoffset, GLsizei _width, GLsizei _height, GLsizei _depth, GLenum _format, GLenum _type, ukk _pixels) { GLAD_INSTRUMENT_CALL(glTextureSubImage3DEXT, _texture, _target, _level, _xoffset, _yoffset, _zoffset, _width, _height, _depth, _format, _type, _pixels); }
