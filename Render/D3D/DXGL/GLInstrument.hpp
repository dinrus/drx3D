...
// -------------------------------------------------------------------------
//  Имя файла:   GLInstrument.hpp
//  Version:     v1.00
//  Created:     29/04/2015 by Valerio Guagliumi.
//  Описание: Wrappers for OpenGL function call data and error logging
// -------------------------------------------------------------------------
//  История:
//
////////////////////////////////////////////////////////////////////////////
...
#define __GLINSTRUMENT__
	...
	#define GLAD_INSTRUMENT_CALL(_Name, ...) NDrxOpenGL::Instrument<glad_tag_ ## _Name>::Call( # _Name, glad_ ## _Name, ## __VA_ARGS__)
...
void                             CallTracePrintf(tukk szFormat, ...) PRINTF_PARAMS(1, 2);
void                             CallTraceFlush();

template<typename T> inline void TraceValue(const T&)              { CallTracePrintf("[?]"); }
template<typename T> inline void TraceValue(const T*)              { CallTracePrintf("[ptr]"); }
inline void                      TraceValue(char cValue)           { CallTracePrintf("%c", cValue); }
inline void                      TraceValue(u32 uValue)   { CallTracePrintf("%u", uValue); }
inline void                      TraceValue(i32 iValue)            { CallTracePrintf("%i", iValue); }
...
inline void                      TraceValue(unsigned short uValue) { TraceValue((u32)uValue); }
inline void                      TraceValue(u8 uValue)  { TraceValue((u32)uValue); }
inline void                      TraceValue(short iValue)          { TraceValue((i32)iValue); }
inline void                      TraceValue(signed char iValue)    { TraceValue((i32)iValue); }
...
inline void TraceFunction(tukk szName)
{
	CallTracePrintf("%s(", szName);
}

template<typename T>
inline void TraceArgument(u32 uIndex, const T& kValue)
{
	if (uIndex > 0)
		CallTracePrintf(", ");
	TraceValue(kValue);
...
inline void TracePreArgument(u32 uIndex, tukk szName)
{
	if (uIndex > 0)
		CallTracePrintf(", ");
	CallTracePrintf("[%s]", szName);
...
template<typename T>
inline void TracePostArgument(tukk szName, const T& kValue)
{
	CallTracePrintf(", %s = ", szName);
	TraceValue(kValue);
}
...
struct Instrument
{
	inline static void Call(tukk szName, void(pfCall)())
	{
	...
	inline static void Call(tukk szName, void(pfCall)(Arg0), Arg0 kArg0)
	{
		TRACE_FUNCTION(szName);
	...
	inline static void Call(tukk szName, void(pfCall)(Arg0, Arg1), Arg0 kArg0, Arg1 kArg1)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
	...
	inline static void Call(tukk szName, void(pfCall)(Arg0, Arg1, Arg2), Arg0 kArg0, Arg1 kArg1, Arg2 kArg2)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_ARGUMENT(1, kArg1);
	...
	inline static void Call(tukk szName, void(pfCall)(Arg0, Arg1, Arg2, Arg3), Arg0 kArg0, Arg1 kArg1, Arg2 kArg2, Arg3 kArg3)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_ARGUMENT(1, kArg1);
	...
	inline static void Call(tukk szName, void(pfCall)(Arg0, Arg1, Arg2, Arg3, Arg4), Arg0 kArg0, Arg1 kArg1, Arg2 kArg2, Arg3 kArg3, Arg4 kArg4)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_ARGUMENT(1, kArg1);
	...
	inline static void Call(tukk szName, void(pfCall)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5), Arg0 kArg0, Arg1 kArg1, Arg2 kArg2, Arg3 kArg3, Arg4 kArg4, Arg5 kArg5)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_ARGUMENT(1, kArg1);
	...
	inline static void Call(tukk szName, void(pfCall)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6), Arg0 kArg0, Arg1 kArg1, Arg2 kArg2, Arg3 kArg3, Arg4 kArg4, Arg5 kArg5, Arg6 kArg6)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_ARGUMENT(1, kArg1);
	...
	inline static void Call(tukk szName, void(pfCall)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7), Arg0 kArg0, Arg1 kArg1, Arg2 kArg2, Arg3 kArg3, Arg4 kArg4, Arg5 kArg5, Arg6 kArg6, Arg7 kArg7)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_ARGUMENT(1, kArg1);
	...
	inline static void Call(tukk szName, void(pfCall)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8), Arg0 kArg0, Arg1 kArg1, Arg2 kArg2, Arg3 kArg3, Arg4 kArg4, Arg5 kArg5, Arg6 kArg6, Arg7 kArg7, Arg8 kArg8)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_ARGUMENT(1, kArg1);
	...
	inline static void Call(tukk szName, void(pfCall)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8, Arg9), Arg0 kArg0, Arg1 kArg1, Arg2 kArg2, Arg3 kArg3, Arg4 kArg4, Arg5 kArg5, Arg6 kArg6, Arg7 kArg7, Arg8 kArg8, Arg9 kArg9)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_ARGUMENT(1, kArg1);
	...
	inline static void Call(tukk szName, void(pfCall)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8, Arg9, Arg10), Arg0 kArg0, Arg1 kArg1, Arg2 kArg2, Arg3 kArg3, Arg4 kArg4, Arg5 kArg5, Arg6 kArg6, Arg7 kArg7, Arg8 kArg8, Arg9 kArg9, Arg10 kArg10)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_ARGUMENT(1, kArg1);
	...
	inline static void Call(tukk szName, void(pfCall)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8, Arg9, Arg10, Arg11), Arg0 kArg0, Arg1 kArg1, Arg2 kArg2, Arg3 kArg3, Arg4 kArg4, Arg5 kArg5, Arg6 kArg6, Arg7 kArg7, Arg8 kArg8, Arg9 kArg9, Arg10 kArg10, Arg11 kArg11)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_ARGUMENT(1, kArg1);
	...
	inline static void Call(tukk szName, void(pfCall)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8, Arg9, Arg10, Arg11, Arg12), Arg0 kArg0, Arg1 kArg1, Arg2 kArg2, Arg3 kArg3, Arg4 kArg4, Arg5 kArg5, Arg6 kArg6, Arg7 kArg7, Arg8 kArg8, Arg9 kArg9, Arg10 kArg10, Arg11 kArg11, Arg12 kArg12)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_ARGUMENT(1, kArg1);
	...
	inline static void Call(tukk szName, void(pfCall)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8, Arg9, Arg10, Arg11, Arg12, Arg13), Arg0 kArg0, Arg1 kArg1, Arg2 kArg2, Arg3 kArg3, Arg4 kArg4, Arg5 kArg5, Arg6 kArg6, Arg7 kArg7, Arg8 kArg8, Arg9 kArg9, Arg10 kArg10, Arg11 kArg11, Arg12 kArg12, Arg13 kArg13)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_ARGUMENT(1, kArg1);
	...
	inline static Ret Call(tukk szName, Ret(pfCall)())
	{
		TRACE_FUNCTION(szName);
		TRACE_CALL();
		Ret kResult = pfCall();
	...
	inline static Ret Call(tukk szName, Ret(pfCall)(Arg0), Arg0 kArg0)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_CALL();
	...
	inline static Ret Call(tukk szName, Ret(pfCall)(Arg0, Arg1), Arg0 kArg0, Arg1 kArg1)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_ARGUMENT(1, kArg1);
	...
	inline static Ret Call(tukk szName, Ret(pfCall)(Arg0, Arg1, Arg2), Arg0 kArg0, Arg1 kArg1, Arg2 kArg2)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_ARGUMENT(1, kArg1);
	...
	inline static Ret Call(tukk szName, Ret(pfCall)(Arg0, Arg1, Arg2, Arg3), Arg0 kArg0, Arg1 kArg1, Arg2 kArg2, Arg3 kArg3)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_ARGUMENT(1, kArg1);
	...
	inline static Ret Call(tukk szName, Ret(pfCall)(Arg0, Arg1, Arg2, Arg3, Arg4), Arg0 kArg0, Arg1 kArg1, Arg2 kArg2, Arg3 kArg3, Arg4 kArg4)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_ARGUMENT(1, kArg1);
	...
	inline static Ret Call(tukk szName, Ret(pfCall)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5), Arg0 kArg0, Arg1 kArg1, Arg2 kArg2, Arg3 kArg3, Arg4 kArg4, Arg5 kArg5)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_ARGUMENT(1, kArg1);
	...
	inline static Ret Call(tukk szName, Ret(pfCall)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6), Arg0 kArg0, Arg1 kArg1, Arg2 kArg2, Arg3 kArg3, Arg4 kArg4, Arg5 kArg5, Arg6 kArg6)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_ARGUMENT(1, kArg1);
	...
	inline static Ret Call(tukk szName, Ret(pfCall)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7), Arg0 kArg0, Arg1 kArg1, Arg2 kArg2, Arg3 kArg3, Arg4 kArg4, Arg5 kArg5, Arg6 kArg6, Arg7 kArg7)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_ARGUMENT(1, kArg1);
	...
	inline static Ret Call(tukk szName, Ret(pfCall)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8), Arg0 kArg0, Arg1 kArg1, Arg2 kArg2, Arg3 kArg3, Arg4 kArg4, Arg5 kArg5, Arg6 kArg6, Arg7 kArg7, Arg8 kArg8)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_ARGUMENT(1, kArg1);
	...
	inline static Ret Call(tukk szName, Ret(pfCall)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8, Arg9), Arg0 kArg0, Arg1 kArg1, Arg2 kArg2, Arg3 kArg3, Arg4 kArg4, Arg5 kArg5, Arg6 kArg6, Arg7 kArg7, Arg8 kArg8, Arg9 kArg9)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_ARGUMENT(1, kArg1);
	...
	inline static Ret Call(tukk szName, Ret(pfCall)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8, Arg9, Arg10), Arg0 kArg0, Arg1 kArg1, Arg2 kArg2, Arg3 kArg3, Arg4 kArg4, Arg5 kArg5, Arg6 kArg6, Arg7 kArg7, Arg8 kArg8, Arg9 kArg9, Arg10 kArg10)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_ARGUMENT(1, kArg1);
	...
	inline static Ret Call(tukk szName, Ret(pfCall)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8, Arg9, Arg10, Arg11), Arg0 kArg0, Arg1 kArg1, Arg2 kArg2, Arg3 kArg3, Arg4 kArg4, Arg5 kArg5, Arg6 kArg6, Arg7 kArg7, Arg8 kArg8, Arg9 kArg9, Arg10 kArg10, Arg11 kArg11)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_ARGUMENT(1, kArg1);
	...
	inline static Ret Call(tukk szName, Ret(pfCall)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8, Arg9, Arg10, Arg11, Arg12), Arg0 kArg0, Arg1 kArg1, Arg2 kArg2, Arg3 kArg3, Arg4 kArg4, Arg5 kArg5, Arg6 kArg6, Arg7 kArg7, Arg8 kArg8, Arg9 kArg9, Arg10 kArg10, Arg11 kArg11, Arg12 kArg12)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_ARGUMENT(1, kArg1);
	...
	inline static Ret Call(tukk szName, Ret(pfCall)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8, Arg9, Arg10, Arg11, Arg12, Arg13), Arg0 kArg0, Arg1 kArg1, Arg2 kArg2, Arg3 kArg3, Arg4 kArg4, Arg5 kArg5, Arg6 kArg6, Arg7 kArg7, Arg8 kArg8, Arg9 kArg9, Arg10 kArg10, Arg11 kArg11, Arg12 kArg12, Arg13 kArg13)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_ARGUMENT(1, kArg1);
	...
	inline static Ret Call(tukk szName, Ret(pfCall)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8, Arg9, Arg10, Arg11, Arg12, Arg13, Arg14), Arg0 kArg0, Arg1 kArg1, Arg2 kArg2, Arg3 kArg3, Arg4 kArg4, Arg5 kArg5, Arg6 kArg6, Arg7 kArg7, Arg8 kArg8, Arg9 kArg9, Arg10 kArg10, Arg11 kArg11, Arg12 kArg12, Arg13 kArg13, Arg14 kArg14)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_ARGUMENT(1, kArg1);
	...
	inline static Ret Call(tukk szName, Ret(pfCall)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8, Arg9, Arg10, Arg11, Arg12, Arg13, Arg14, Arg15), Arg0 kArg0, Arg1 kArg1, Arg2 kArg2, Arg3 kArg3, Arg4 kArg4, Arg5 kArg5, Arg6 kArg6, Arg7 kArg7, Arg8 kArg8, Arg9 kArg9, Arg10 kArg10, Arg11 kArg11, Arg12 kArg12, Arg13 kArg13, Arg14 kArg14, Arg15 kArg15)
	{
		TRACE_FUNCTION(szName);
		TRACE_ARGUMENT(0, kArg0);
		TRACE_ARGUMENT(1, kArg1);
...
struct InstrumentCategoryGen
{
	...
	inline static void Call(tukk szName, void(pfCall)(Count, Name*), Count iCount, Name* pNames)
	{
		TRACE_FUNCTION(szName);
...
#define CUSTOM_INSTRUMENT(_Category, _Name)                                              \
  ...
  namespace NDrxOpenGL                                                                   \
  {                                                                                      \
  template<> struct Instrument<glad_tag_ ## _Name> : InstrumentCategory ## _Category {}; \
  }
