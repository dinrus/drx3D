...
//  Version:     v1.00
//  Created:     17/07/2014 by Valerio Guagliumi.
//  Описание: Interface wrappers used for full DirectX emulation.
// -------------------------------------------------------------------------
//  История:
//
////////////////////////////////////////////////////////////////////////////
...
template<typename Interface> struct SingleInheritance
{
	typedef void                                                                                              TBase;
};
	#define SINGLE_INHERITANCE(_Derived, _Base) template<> struct SingleInheritance<_Derived> { typedef _Base TBase; };
...
struct SAggregateNode
{
	...
	virtual bool QueryInterfaceInternal(REFIID riid, uk * ppvObject)
	{
		return false;
	};
};
...
struct SUnknown : Base, SAggregateNode
{
	DXGL_WRAPPER_ROOT(Unknown)

	SUnknown() : m_pImpl(NULL) {}
	virtual ~SUnknown(){}
	...
	bool QueryInterfaceInternal(REFIID riid, uk * ppvObject)
	{
...
template<typename Impl, typename Base>
struct SD3D10Blob : SUnknown<Impl, Base>
{
...
template<typename Impl, typename Base>
struct SD3D11DeviceChild : SUnknown<Impl, Base>
{
	...
	HRESULT STDMETHODCALLTYPE GetPrivateData(REFGUID guid, UINT* pDataSize, uk pData)     { return this->m_pImpl->GetPrivateData(guid, pDataSize, pData); }
	HRESULT STDMETHODCALLTYPE SetPrivateData(REFGUID guid, UINT DataSize, ukk pData) { return this->m_pImpl->SetPrivateData(guid, DataSize, pData); }
...
template<typename Impl, typename Base>
struct SD3D11DepthStencilState : SD3D11DeviceChild<Impl, Base>
{
...
template<typename Impl, typename Base>
struct SD3D11BlendState : SD3D11DeviceChild<Impl, Base>
{
...
template<typename Impl, typename Base>
struct SD3D11RasterizerState : SD3D11DeviceChild<Impl, Base>
{
...
template<typename Impl, typename Base>
struct SD3D11Resource : SD3D11DeviceChild<Impl, Base>
{
...
template<typename Impl, typename Base>
struct SD3D11Buffer : SD3D11Resource<Impl, Base>
{
...
template<typename Impl, typename Base>
struct SD3D11Texture1D : SD3D11Resource<Impl, Base>
{
...
template<typename Impl, typename Base>
struct SD3D11Texture2D : SD3D11Resource<Impl, Base>
{
...
template<typename Impl, typename Base>
struct SD3D11Texture3D : SD3D11Resource<Impl, Base>
{
...
template<typename Impl, typename Base>
struct SD3D11View : SD3D11DeviceChild<Impl, Base>
{
...
template<typename Impl, typename Base>
struct SD3D11ShaderResourceView : SD3D11View<Impl, Base>
{
...
template<typename Impl, typename Base>
struct SD3D11RenderTargetView : SD3D11View<Impl, Base>
{
...
template<typename Impl, typename Base>
struct SD3D11DepthStencilView : SD3D11View<Impl, Base>
{
...
template<typename Impl, typename Base>
struct SD3D11UnorderedAccessView : SD3D11View<Impl, Base>
{
...
template<typename Impl, typename Base> struct SD3D11VertexShader : SD3D11DeviceChild<Impl, Base>
{
	DXGL_WRAPPER_DERIVED(D3D11VertexShader, SD3D11DeviceChild) SD3D11VertexShader()
	{
	}
};
template<typename Impl, typename Base> struct SD3D11HullShader : SD3D11DeviceChild<Impl, Base>
{
	DXGL_WRAPPER_DERIVED(D3D11HullShader, SD3D11DeviceChild) SD3D11HullShader()
	{
	}
};
template<typename Impl, typename Base> struct SD3D11DomainShader : SD3D11DeviceChild<Impl, Base>
{
	DXGL_WRAPPER_DERIVED(D3D11DomainShader, SD3D11DeviceChild) SD3D11DomainShader()
	{
	}
};
template<typename Impl, typename Base> struct SD3D11GeometryShader : SD3D11DeviceChild<Impl, Base>
{
	DXGL_WRAPPER_DERIVED(D3D11GeometryShader, SD3D11DeviceChild) SD3D11GeometryShader()
	{
	}
};
template<typename Impl, typename Base> struct SD3D11PixelShader : SD3D11DeviceChild<Impl, Base>
{
	DXGL_WRAPPER_DERIVED(D3D11PixelShader, SD3D11DeviceChild) SD3D11PixelShader()
	{
	}
};
template<typename Impl, typename Base> struct SD3D11ComputeShader : SD3D11DeviceChild<Impl, Base>
{
	DXGL_WRAPPER_DERIVED(D3D11ComputeShader, SD3D11DeviceChild) SD3D11ComputeShader()
	{
	}
};
template<typename Impl, typename Base> struct SD3D11InputLayout : SD3D11DeviceChild<Impl, Base>
{
...
template<typename Impl, typename Base>
struct SD3D11SamplerState : SD3D11DeviceChild<Impl, Base>
{
...
template<typename Impl, typename Base>
struct SD3D11Asynchronous : SD3D11DeviceChild<Impl, Base>
{
...
template<typename Impl, typename Base>
struct SD3D11Query : SD3D11Asynchronous<Impl, Base>
{
...
template<typename Impl, typename Base>
struct SD3D11ShaderReflectionType : Base
{
	DXGL_WRAPPER_ROOT_NO_COM(D3D11ShaderReflectionType)
	SD3D11ShaderReflectionType() : m_pImpl(NULL){}
...
template<typename Impl, typename Base>
struct SD3D11ShaderReflectionVariable : Base
{
	DXGL_WRAPPER_ROOT_NO_COM(D3D11ShaderReflectionVariable)
	SD3D11ShaderReflectionVariable() : m_pImpl(NULL){}
...
template<typename Impl, typename Base>
struct SD3D11ShaderReflectionConstantBuffer : Base
{
	DXGL_WRAPPER_ROOT_NO_COM(D3D11ShaderReflectionConstantBuffer)
	SD3D11ShaderReflectionConstantBuffer() : m_pImpl(NULL){}
...
template<typename Impl, typename Base>
struct SD3D11ShaderReflection : SUnknown<Impl, Base>
{
...
template<typename Impl, typename Base>
struct SDXGIObject : SUnknown<Impl, Base>
{
	DXGL_WRAPPER_DERIVED(DXGIObject, SUnknown)
	SDXGIObject(){}
	HRESULT STDMETHODCALLTYPE SetPrivateData(REFGUID Name, UINT DataSize, ukk pData)  { return this->m_pImpl->SetPrivateData(Name, DataSize, pData); }
	...
	HRESULT STDMETHODCALLTYPE GetPrivateData(REFGUID Name, UINT* pDataSize, uk pData)      { return this->m_pImpl->GetPrivateData(Name, pDataSize, pData); }
	HRESULT STDMETHODCALLTYPE GetParent(REFIID riid, uk * ppParent)                         { return this->m_pImpl->GetParent(riid, ppParent); }
};

template<typename Impl, typename Base>
struct SDXGIDeviceSubObject : SDXGIObject<Impl, Base>
{
	DXGL_WRAPPER_DERIVED(DXGIDeviceSubObject, SDXGIObject)
	SDXGIDeviceSubObject(){}
	HRESULT STDMETHODCALLTYPE GetDevice(REFIID riid, uk * ppDevice) { return this->m_pImpl->GetDevice(riid, ppDevice); }
};

template<typename Impl, typename Base>
struct SDXGIOutput : SDXGIObject<Impl, Base>
{
...
template<typename Impl, typename Base>
struct SDXGIAdapter : SDXGIObject<Impl, Base>
{
...
template<typename Impl, typename Base>
struct SDXGIAdapter1 : SDXGIAdapter<Impl, Base>
{
...
template<typename Impl, typename Base>
struct SDXGIFactory : SDXGIObject<Impl, Base>
{
...
template<typename Impl, typename Base>
struct SDXGIFactory1 : SDXGIFactory<Impl, Base>
{
...
template<typename Impl, typename Base>
struct SDXGIDevice : SDXGIObject<Impl, Base>
{
...
template<typename Impl, typename Base>
struct SDXGISwapChain : SDXGIDeviceSubObject<Impl, Base>
{
	...
	HRESULT STDMETHODCALLTYPE GetBuffer(UINT Buffer, REFIID riid, uk * ppSurface)                                                { return this->m_pImpl->GetBuffer(Buffer, riid, ppSurface); }
...
template<typename Impl, typename Base>
struct SD3D11SwitchToRef : public SUnknown<Impl, Base>
{
...
template<typename Impl, typename Base>
struct SD3D11Device : public SUnknown<Impl, Base>
{
	...
	HRESULT STDMETHODCALLTYPE           CreateInputLayout(const D3D11_INPUT_ELEMENT_DESC* pInputElementDescs, UINT NumElements, ukk pShaderBytecodeWithInputSignature, SIZE_T BytecodeLength, ID3D11InputLayout** ppInputLayout)                                                                                                            { return this->m_pImpl->CreateInputLayout(pInputElementDescs, NumElements, pShaderBytecodeWithInputSignature, BytecodeLength, ppInputLayout); }
	HRESULT STDMETHODCALLTYPE           CreateVertexShader(ukk pShaderBytecode, SIZE_T BytecodeLength, ID3D11ClassLinkage* pClassLinkage, ID3D11VertexShader** ppVertexShader)                                                                                                                                                              { return this->m_pImpl->CreateVertexShader(pShaderBytecode, BytecodeLength, pClassLinkage, ppVertexShader); }
	HRESULT STDMETHODCALLTYPE           CreateGeometryShader(ukk pShaderBytecode, SIZE_T BytecodeLength, ID3D11ClassLinkage* pClassLinkage, ID3D11GeometryShader** ppGeometryShader)                                                                                                                                                        { return this->m_pImpl->CreateGeometryShader(pShaderBytecode, BytecodeLength, pClassLinkage, ppGeometryShader); }
	...
	HRESULT STDMETHODCALLTYPE           CreatePixelShader(ukk pShaderBytecode, SIZE_T BytecodeLength, ID3D11ClassLinkage* pClassLinkage, ID3D11PixelShader** ppPixelShader)                                                                                                                                                                 { return this->m_pImpl->CreatePixelShader(pShaderBytecode, BytecodeLength, pClassLinkage, ppPixelShader); }
	HRESULT STDMETHODCALLTYPE           CreateHullShader(ukk pShaderBytecode, SIZE_T BytecodeLength, ID3D11ClassLinkage* pClassLinkage, ID3D11HullShader** ppHullShader)                                                                                                                                                                    { return this->m_pImpl->CreateHullShader(pShaderBytecode, BytecodeLength, pClassLinkage, ppHullShader); }
	HRESULT STDMETHODCALLTYPE           CreateDomainShader(ukk pShaderBytecode, SIZE_T BytecodeLength, ID3D11ClassLinkage* pClassLinkage, ID3D11DomainShader** ppDomainShader)                                                                                                                                                              { return this->m_pImpl->CreateDomainShader(pShaderBytecode, BytecodeLength, pClassLinkage, ppDomainShader); }
	HRESULT STDMETHODCALLTYPE           CreateComputeShader(ukk pShaderBytecode, SIZE_T BytecodeLength, ID3D11ClassLinkage* pClassLinkage, ID3D11ComputeShader** ppComputeShader)                                                                                                                                                           { return this->m_pImpl->CreateComputeShader(pShaderBytecode, BytecodeLength, pClassLinkage, ppComputeShader); }
	...
	HRESULT STDMETHODCALLTYPE           OpenSharedResource(HANDLE hResource, REFIID ReturnedInterface, uk * ppResource)                                                                                                                                                                                                                           { return this->m_pImpl->OpenSharedResource(hResource, ReturnedInterface, ppResource); }
	...
	HRESULT STDMETHODCALLTYPE           CheckFeatureSupport(D3D11_FEATURE Feature, uk pFeatureSupportData, UINT FeatureSupportDataSize)                                                                                                                                                                                                          { return this->m_pImpl->CheckFeatureSupport(Feature, pFeatureSupportData, FeatureSupportDataSize); }
	HRESULT STDMETHODCALLTYPE           GetPrivateData(REFGUID guid, UINT* pDataSize, uk pData)                                                                                                                                                                                                                                                  { return this->m_pImpl->GetPrivateData(guid, pDataSize, pData); }
	HRESULT STDMETHODCALLTYPE           SetPrivateData(REFGUID guid, UINT DataSize, ukk pData)                                                                                                                                                                                                                                              { return this->m_pImpl->SetPrivateData(guid, DataSize, pData); }
	HRESULT STDMETHODCALLTYPE           SetPrivateDataInterface(REFGUID guid, const IUnknown* pData)                                                                                                                                                                                                                                                { return this->m_pImpl->SetPrivateDataInterface(guid, pData); }
...
template<typename Impl, typename Base>
struct SD3D11DeviceContext : SD3D11DeviceChild<Impl, Base>
{
	...
	HRESULT STDMETHODCALLTYPE                   GetData(ID3D11Asynchronous* pAsync, uk pData, UINT DataSize, UINT GetDataFlags)                                                                                                                                                                                               { return this->m_pImpl->GetData(pAsync, pData, DataSize, GetDataFlags); }
	...
	void STDMETHODCALLTYPE                      UpdateSubresource(ID3D11Resource* pDstResource, UINT DstSubresource, const D3D11_BOX* pDstBox, ukk pSrcData, UINT SrcRowPitch, UINT SrcDepthPitch)                                                                                                                       { this->m_pImpl->UpdateSubresource(pDstResource, DstSubresource, pDstBox, pSrcData, SrcRowPitch, SrcDepthPitch); }
