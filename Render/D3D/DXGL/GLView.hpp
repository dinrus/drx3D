...
// -------------------------------------------------------------------------
//  Имя файла:   GLView.hpp
//  Version:     v1.00
//  Created:     26/03/2015 by Valerio Guagliumi.
//  Описание: Declares the resource view types and related functions
// -------------------------------------------------------------------------
//  История:
//
////////////////////////////////////////////////////////////////////////////
...
struct SShaderTextureViewConfiguration
{
	...
	SShaderTextureViewConfiguration(EGIFormat eFormat, GLenum eTarget, u32 uMinMipLevel, u32 uNumMipLevels, u32 uMinLayer, u32 uNumLayers)
		: m_eFormat(eFormat)
		, m_eTarget(eTarget)
...
struct SShaderTextureBufferViewConfiguration
{
	...
	SShaderTextureBufferViewConfiguration(EGIFormat eFormat, u32 uFirstElement, u32 uNumElements)
		: m_eFormat(eFormat)
...
struct SOutputMergerTextureViewConfiguration
{
	...
	SOutputMergerTextureViewConfiguration(EGIFormat eFormat, u32 uMipLevel, u32 uMinLayer, u32 uNumLayers)
		: m_eFormat(eFormat)
...
DXGL_DECLARE_REF_COUNTED(struct, SOutputMergerView)
{
	...
	struct SFrameBufferRef
	{
		...
		SFrameBufferRef(SFrameBuffer* pFrameBuffer, u32 uNumBindings)
