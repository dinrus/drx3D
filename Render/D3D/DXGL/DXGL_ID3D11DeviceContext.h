...
// -------------------------------------------------------------------------
//  Имя файла:   DXGL_ID3D11DeviceContext.h
//  Version:     v1.00
//  Created:     20/02/2013 by Valerio Guagliumi.
//  Описание: Contains a definition of the ID3D11DeviceContext interface
...
#endif
{
	...
	virtual HRESULT STDMETHODCALLTYPE                   GetData(ID3D11Asynchronous* pAsync, uk pData, UINT DataSize, UINT GetDataFlags) = 0;
	...
	virtual void STDMETHODCALLTYPE                      UpdateSubresource(ID3D11Resource* pDstResource, UINT DstSubresource, const D3D11_BOX* pDstBox, ukk pSrcData, UINT SrcRowPitch, UINT SrcDepthPitch) = 0;
