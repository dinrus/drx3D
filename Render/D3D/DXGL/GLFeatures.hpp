...
//  Описание: OpenGL feature detection and emulation
// -------------------------------------------------------------------------
//  История:
//
////////////////////////////////////////////////////////////////////////////
...
#define __GLFEATURES__
	...
	#include <drx3D/Render/GLInstrument.hpp>
#else
	...
	#define DXGL_EXTENSION_LOADER 1
		...
		#include <drx3D/Render/Specification/glad_gles2.h>
	#else
		#include <drx3D/Render/Specification/glad_gl.h>
	#endif
	#define DXGL_GL_EXTENSION_SUPPORTED(_Extension) (GLAD_GL_ ## _Extension == 1)
	#if DRX_PLATFORM_WINDOWS
		#include <drx3D/Render/Specification/glad_wgl.h>
		#define DXGL_WGL_EXTENSION_SUPPORTED(_Extension) (GLAD_WGL_ ## _Extension == 1)
	#elif DRX_PLATFORM_ANDROID
		#include <drx3D/Render/Specification/glad_egl.h>
	#elif DRX_PLATFORM_LINUX
		#include <drx3D/Render/Specification/glad_glx.h>
	#endif
#else
...
#define DXGL_SUPPORT_COMPUTE                       (!DRX_PLATFORM_MAC)
...
#define DXGL_SUPPORT_DEBUG_OUTPUT                  (DXGLES_REQUIRED_VERSION >= DXGL_VERSION_32) && (!DXGL_SUPPORT_NSIGHT_SINCE(4_1) && !DRX_PLATFORM_MAC)
...
#if DXGL_SUPPORT_NSIGHT_SINCE(3_0) || DXGL_SUPPORT_VOGL || DRX_PLATFORM_MAC
...
#endif //DXGL_SUPPORT_NSIGHT_SINCE(3_0) || DXGL_SUPPORT_VOGL || DRX_PLATFORM_MAC

#if DXGL_SUPPORT_NSIGHT_SINCE(3_0) || DRX_PLATFORM_MAC
...
#endif //DXGL_SUPPORT_NSIGHT_SINCE(3_0) || DRX_PLATFORM_MAC

#if DXGL_SUPPORT_NSIGHT_SINCE(4_1) || DRX_PLATFORM_MAC
...
#if DXGL_SUPPORT_NSIGHT_SINCE(4_1) || DXGL_SUPPORT_VOGL || DRX_PLATFORM_MAC
...
#endif // DXGL_SUPPORT_NSIGHT_SINCE(4_1) || DXGL_SUPPORT_VOGL || DRX_PLATFORM_MAC
...
inline void glGetTextureImageEXT(GLuint uTexture, GLenum eTarget, GLint iLevel, GLenum eFormat, GLenum eType, uk pPixels)
{
	SAutoTexBind kAutoBind(eTarget, uTexture);
	glGetTexImage(eTarget, iLevel, eFormat, eType, pPixels);
}

inline void glGetCompressedTextureImageEXT(GLuint uTexture, GLenum eTarget, GLint iLevel, uk pImg)
{
	SAutoTexBind kAutoBind(eTarget, uTexture);
...
inline void glNamedBufferDataEXT(GLuint uBuffer, GLsizeiptr iSize, ukk pData, GLenum eUsage)
{
...
inline void glNamedBufferSubDataEXT(GLuint uBuffer, GLintptr iOffset, GLsizeiptr iSize, ukk pData)
{
	SAutoBufferBind<> kAutoBind(uBuffer);
...
inline void glGetNamedBufferSubDataEXT(GLuint uBuffer, GLintptr iOffset, GLsizeiptr iSize, uk pData)
{
	SAutoBufferBind<> kAutoBind(uBuffer);
...
#if DRX_PLATFORM_ANDROID && !defined(EGL_OPENGL_API)
