...
class CDrxDX12GIFactory : public CDrxDX12GIObject<IDXGIFactory4ToImplement>
{
public:
	DX12_OBJECT(CDrxDX12GIFactory, CDrxDX12GIObject<IDXGIFactory4ToImplement> );

	static CDrxDX12GIFactory* Create();
	...
	VIRTUALGFX HRESULT STDMETHODCALLTYPE EnumAdapterByLuid(
	  ...
	  _In_ REFIID riid,
	  /* [annotation] */
	  _COM_Outptrvoid** ppvAdapter) FINALGFX { abort(); return S_OK; }
...
protected:
	CDrxDX12GIFactory(IDXGIFactory4ToCall* pDXGIFactory4);
