...
struct Handable
{
	...
	static UINT32 RequestHandle() threadsafe
	{
		...
		if (!m_FreeHandles.dequeue(handle))
			handle = DrxInterlockedIncrement((int*)&m_HighHandle);
...
#define Redirect(func) \
  m_Target->func;
	...
	virtual HRESULT STDMETHODCALLTYPE CreateCommandQueue(
	  ...
	  REFIID riid,
	  _COM_Outptrvoid** ppCommandQueue) final
	{
	...
	virtual HRESULT STDMETHODCALLTYPE CreateCommandAllocator(
	  ...
	  REFIID riid,
	  _COM_Outptrvoid** ppCommandAllocator) final
	{
	...
	virtual HRESULT STDMETHODCALLTYPE CreateGraphicsPipelineState(
	  ...
	  REFIID riid,
	  _COM_Outptrvoid** ppPipelineState) final
	{
	...
	virtual HRESULT STDMETHODCALLTYPE CreateCommandList(
	  ...
	  REFIID riid,
	  _COM_Outptrvoid** ppCommandList) final
	{
	...
	virtual HRESULT STDMETHODCALLTYPE CreateRootSignature(
	  ...
	  REFIID riid,
	  _COM_Outptrvoid** ppvRootSignature) final
	{
	...
	virtual HRESULT STDMETHODCALLTYPE CreateCommittedResource(
	  ...
	  REFIID riidResource,
	  _COM_Outptr_optvoid** ppvResource) final
	{
	...
	virtual HRESULT STDMETHODCALLTYPE CreateHeap(
	  ...
	  REFIID riid,
	  _COM_Outptr_optvoid** ppvHeap) final
	{
	...
	virtual HRESULT STDMETHODCALLTYPE OpenSharedHandle(
	  ...
	  REFIID riid,
	  _COM_Outptr_optvoid** ppvObj) final
	{
		__debugbreak();
		return E_FAIL;
	}
	...
	virtual HRESULT STDMETHODCALLTYPE CreateCommandSignature(
	  ...
	  REFIID riid,
	  _COM_Outptr_optvoid** ppvCommandSignature) final
	{
