...
{
public:
	static CDevice*                  Create(CDrxDX12GIAdapter* adapter, D3D_FEATURE_LEVEL* pFeatureLevel);
...
public:
	HRESULT                     CheckFeatureSupport(D3D12_FEATURE Feature, uk pFeatureSupportData, UINT FeatureSupportDataSize) { return m_pDevice->CheckFeatureSupport(Feature, pFeatureSupportData, FeatureSupportDataSize); }
...
private:
	...
	static DrxCriticalSectionNonRecursive                  m_SamplerThreadSafeScope;
	static DrxCriticalSectionNonRecursive                  m_ShaderResourceThreadSafeScope;
	static DrxCriticalSectionNonRecursive                  m_UnorderedAccessThreadSafeScope;
	static DrxCriticalSectionNonRecursive                  m_DepthStencilThreadSafeScope;
	static DrxCriticalSectionNonRecursive                  m_RenderTargetThreadSafeScope;
	static DrxCriticalSectionNonRecursive                  m_DescriptorAllocatorTheadSafeScope;
