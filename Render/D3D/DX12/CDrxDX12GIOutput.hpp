...
class CDrxDX12GIOutput : public CDrxDX12GIObject<IDXGIOutput4ToImplement>
{
public:
	DX12_OBJECT(CDrxDX12GIOutput, CDrxDX12GIObject<IDXGIOutput4ToImplement>);

	static CDrxDX12GIOutput* Create(CDrxDX12GIAdapter* Adapter, UINT Output);

	ILINE CDrxDX12GIAdapter*  GetAdapter   () const { return m_pAdapter; }
...
protected:
	CDrxDX12GIOutput(CDrxDX12GIAdapter* pAdapter, IDXGIOutput4ToCall* pOutput);

private:
	CDrxDX12GIAdapter*  m_pAdapter;
