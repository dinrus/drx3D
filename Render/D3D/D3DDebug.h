...
public:
	...
	void Release();
	void Update(ESeverityCombination muteSeverity, tukk strMuteMsgList, tukk strBreakOnMsgList);
...
private:
	...
	UINT ParseIDs(tukk strMsgIDList, D3D11_MESSAGE_ID arrMsgList[MAX_NUM_DEBUG_MSG_IDS]) const;
};
