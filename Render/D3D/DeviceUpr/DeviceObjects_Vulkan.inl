...
public:
	...
	std::array<NDrxVulkan::CImageResource*, CDeviceRenderPassDesc::MaxRendertargetCount> m_renderTargets;
	NDrxVulkan::CImageResource*                                                          m_pDepthStencilTarget;
...
{
	// Sanity check
	DRX_ASSERT(m_pCoreCommandList->m_sharedState.pCommandList == m_pVKScheduler->GetCommandList(CMDQUEUE_GRAPHICS));
