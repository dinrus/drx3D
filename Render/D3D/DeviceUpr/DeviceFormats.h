...
struct SPixFormat
{
	...
	tukk Desc;         // Stat: Human readable name for stats.
	...
	bool CheckSupport(D3DFormat Format, tukk szDescr);
};
...
namespace DeviceFormats
{
	...
	u32 GetWriteMask              (ETEX_Format eTF    );
	u32 GetWriteMask              (D3DFormat nFormat  );
