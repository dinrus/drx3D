...
protected:
	CRenderDisplayContext(IRenderer::SDisplayContextDescription desc, STxt name, u32 uniqueId) : m_name(name), m_uniqueId(uniqueId), m_desc(desc)
	{
...
public:
	...
	STxt          GetName() const { return m_name; }
	...
	{
		DRX_ASSERT(m_pDepthTarget || !NeedsDepthStencil());
...
public:
	CSwapChainBackedRenderDisplayContext(IRenderer::SDisplayContextDescription desc, STxt name, u32 uniqueId) : CRenderDisplayContext(desc, name, uniqueId) {}
	...
	u32               GetRefreshRateNumerator() const { return m_swapChain.GetRefreshRateNumerator(); }
	u32               GetRefreshRateDemoninator() const { return m_swapChain.GetRefreshRateDemoninator(); }
#endif
...
public:
	...
	CCustomRenderDisplayContext(IRenderer::SDisplayContextDescription desc, STxt name, u32 uniqueId, std::vector<TexSmartPtr> &&backBuffersArray, uint32_t initialSwapChainIndex = 0);
