...
public:
	...
	static CTexture* CreateDepthTarget(i32 nWidth, i32 nHeight, const ColorF& cClear, ETEX_Format eTF);
	static CTexture* CreateRenderTarget(i32 nWidth, i32 nHeight, const ColorF& cClear, ETEX_Format eTF);
...
public:
	...
	static void CreateDepthMaps(i32 resourceWidth, i32 resourceHeight);
	static void CreateSceneMaps(ETEX_Format eTF, i32 resourceWidth, i32 resourceHeight);
	static void CreateHDRMaps(i32 resourceWidth, i32 resourceHeight);
	static bool CreatePostFXMaps(i32 resourceWidth, i32 resourceHeight);
	static void CreateCachedShadowMaps();
	static void CreateNearestShadowMap();
	static void CreateDeferredMaps(i32 resourceWidth, i32 resourceHeight);
	static void CreateSystemTargets(i32 resourceWidth, i32 resourceHeight);

	static void ResizeSystemTargets(i32 renderWidth, i32 renderHeight);
	...
	static void OnRenderResolutionChanged(i32 renderWidth, i32 renderHeight);
	static void OnOutputResolutionChanged(i32 outputWidth, i32 outputHeight);
	static void OnDisplayResolutionChanged(i32 displayWidth, i32 displayHeight);
	
	static i32 s_resourceWidth, s_resourceHeight;
	static i32 s_renderWidth, s_renderHeight, s_renderMinDim, s_renderArea;
	static i32 s_outputWidth, s_outputHeight;
	static i32 s_displayWidth, s_displayHeight;
	...
	static SEnvTexture* FindSuitableEnvTex(Vec3& Pos, Ang3& Angs, bool bMustExist, i32 RendFlags, bool bUseExistingREs, CShader* pSH, CShaderResources* pRes, CRenderObject* pObj, bool bReflect, CRenderElement* pRE, bool* bMustUpdate, const SRenderingPassInfo* pPassInfo);
	...
	static i32       s_nCurLumTextureIndex;                                      // CAutoExposureStage
