...
public:
	...
	u8 m_nMtlLayerNoDrawFlags;

public:
	//////////////////////////////////////////////////////////////////////////
	void AddTextureMap(i32 Id)
	{
	...
	i32 Size() const
	{
		i32 nSize = sizeof(CShaderResources);
	...
	void GetMemoryUsage(IDrxSizer* pSizer) const final
	{
	...
	virtual i32                        GetResFlags() final                       { return m_ResFlags; }
	virtual void                       SetMaterialName(tukk szName) final { m_szMaterialName = szName; }
	...
	virtual SEfResTexture*             GetTexture(i32 nSlot) const final         { return m_Textures[nSlot]; }
	...
	virtual void  SetMtlLayerNoDrawFlags(u8 nFlags) final { m_nMtlLayerNoDrawFlags = nFlags; }
	virtual u8 GetMtlLayerNoDrawFlags() const final       { return m_nMtlLayerNoDrawFlags; }
	...
	inline u8 HeatAmount_unnormalized() const
	{
		return m_HeatAmount;
	}
	...
	virtual size_t            GetResourceMemoryUsage(IDrxSizer* pSizer) final;
