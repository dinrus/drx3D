...
public:
	...
	bool                ProcessAll(CPrimitiveRenderPass& targetPass, std::vector<CPrimitiveRenderPass*>& prePasses, const SFlareLight& light, const SRenderViewInfo* pViewInfo, i32 viewInfoCount, bool bForceRender = false, bool bUpdateOcclusion = true);
