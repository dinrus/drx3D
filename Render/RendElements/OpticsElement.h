...
public:
	...
	COpticsElement(tukk name, float size = 0.3f, const float brightness = 1.0f, const ColorF& color = LensOpConst::_LO_DEF_CLR);
...
public:
	...
	virtual void                InsertElement(i32 nPos, IOpticsElementBase* pElement) {}
	virtual void                Remove(i32 i)                                         {}
	virtual void                RemoveAll()                                           {}
	virtual i32                 GetElementCount() const                               { return 0; }
	virtual IOpticsElementBase* GetElementAt(i32 i) const
	{
#ifndef RELEASE
		iLog->Log("ERROR");
		__debugbreak();
