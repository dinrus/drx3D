...
#include <drx3D/Render/D3D/DeviceUpr/TempDynBuffer.h>
...
inline u32 SF_AdjustBlendStateForMeasureOverdraw(u32 blendModeStates)
{
...
CRenderPrimitive* SSF_ResourcesD3D::CRenderPrimitiveHeap::GetUsablePrimitive(i32 key)
{
...
void SSF_ResourcesD3D::CRenderPrimitiveHeap::FreeUsedPrimitives(i32 key)
{
	DrxAutoCriticalSectionNoRecursive threadSafe(m_lock);
...
CTexture* SSF_ResourcesD3D::GetColorSurface(CD3D9Renderer* pRenderer, i32 nWidth, i32 nHeight, ETEX_Format eFormat, i32 nMaxWidth, i32 nMaxHeight)
{
	DrxCriticalSectionNonRecursive threadSafePool;
...
CTexture* SSF_ResourcesD3D::GetStencilSurface(CD3D9Renderer* pRenderer, i32 nWidth, i32 nHeight, ETEX_Format eFormat)
{
	DrxCriticalSectionNonRecursive threadSafePool;
...
//////////////////////////////////////////////////////////////////////////
void CRenderer::SF_ConfigMask(i32 st, u32 ref)
{
	// Graphics pipeline == 0
...
//////////////////////////////////////////////////////////////////////////
void CRenderer::SF_GetMeshMaxSize(i32& numVertices, i32& numIndices) const
{
	numVertices = 16384;
	numIndices  = 16384*3;
}
...
//////////////////////////////////////////////////////////////////////////
void CD3D9Renderer::SF_DrawIndexedTriList(i32 baseVertexIndex, i32 minVertexIndex, i32 numVertices, i32 startIndex, i32 triangleCount, const SSF_GlobalDrawParams& __restrict params)
{
	...
	DRX_ASSERT(params.vtxData->VertexFormat != IScaleformPlayback::Vertex_Glyph && params.vtxData->VertexFormat != IScaleformPlayback::Vertex_None);
	...
	const CDrxNameTSCRC techName = *sfRes.m_FillTechnique[fillType][params.isMultiplyDarkBlendMode];
...

	{
		...
		primInit->SetStencilState(params.m_stencil.func, params.m_stencil.ref, u8(~0U), u8(~0U));
...
//////////////////////////////////////////////////////////////////////////
void CD3D9Renderer::SF_DrawLineStrip(i32 baseVertexIndex, i32 lineCount, const SSF_GlobalDrawParams& __restrict params)
{
	DRX_PROFILE_FUNCTION(PROFILE_SYSTEM);
	...
	DRX_ASSERT(params.vtxData->VertexFormat == IScaleformPlayback::Vertex_XY16i);
	...
	// Set appropriate shader
	const CDrxNameTSCRC techName = *sfRes.m_FillTechnique[params.fillType][false];
...
//////////////////////////////////////////////////////////////////////////
void CD3D9Renderer::SF_DrawGlyphClear(const IScaleformPlayback::DeviceData* vtxData, i32 baseVertexIndex, const SSF_GlobalDrawParams& __restrict params)
{
	...
	DRX_ASSERT(vtxData->VertexFormat == IScaleformPlayback::Vertex_Glyph || vtxData->VertexFormat == IScaleformPlayback::Vertex_XY16i);
	...
	// Set appropriate shader
	const CDrxNameTSCRC techName = *sfRes.m_FillTechnique[params.fillType][params.isMultiplyDarkBlendMode];
...
void CD3D9Renderer::SF_DrawBlurRect(const IScaleformPlayback::DeviceData* vtxData, const SSF_GlobalDrawParams& __restrict params)
{
	...
	DRX_ASSERT((params.blurType > SSF_GlobalDrawParams::BlurNone) && (params.blurType < SSF_GlobalDrawParams::BlurCount));
	...
	// Set appropriate shader
	const CDrxNameTSCRC techName = *sfRes.m_FilterTechnique[params.blurType];
...
//////////////////////////////////////////////////////////////////////////
i32 CRenderer::SF_CreateTexture(i32 width, i32 height, i32 numMips, u8k* pData, ETEX_Format eSrcFormat, i32 flags)
{
	char name[128];
	drx_sprintf(name, "$SF_%d", m_TexGenID++);
	...
	i32 texId = (pTexture != 0) ? pTexture->GetID() : -1;
	return texId;
}

//////////////////////////////////////////////////////////////////////////
bool CD3D9Renderer::SF_UpdateTexture(i32 texId, i32 mipLevel, i32 numRects, const SUpdateRect* pRects, u8k* pSrcData, size_t rowPitch, size_t size, ETEX_Format eSrcFormat)
{
	DRX_PROFILE_FUNCTION(PROFILE_SYSTEM);
	...
	{
		i32 sizePixel(CTexture::BytesPerPixel(eSrcFormat));
		u8k* pSrc(&pSrcData[pRects[i].srcY * rowPitch + sizePixel * pRects[i].srcX]);
...
bool CD3D9Renderer::SF_ClearTexture(i32 texId, i32 mipLevel, i32 numRects, const SUpdateRect* pRects, u8k* pData)
{
	DRX_PROFILE_FUNCTION(PROFILE_SYSTEM);
	__debugbreak();
