...
#include <drx3D/Render/DeviceFormats.h>

#include <drx3D/CoreX/Renderer/ITexture.h> // ETEX_Format

#include <drx3D/Render/DriverD3D.h>

bool SPixFormat::CheckSupport(D3DFormat Format, tukk szDescr)
{
	bool bRes = false;
...
#if DRX_RENDERER_VULKAN || DRX_RENDERER_OPENGL
...
#if DRX_RENDERER_VULKAN || (DRX_RENDERER_OPENGL >= 430)
...
u32 DeviceFormats::GetWriteMask(ETEX_Format eTF)
{
	switch (eTF)
	{
	case eTF_R8G8B8A8:
...
u32 DeviceFormats::GetWriteMask(D3DFormat nFormat)
{
