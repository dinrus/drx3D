...
#include <drx3D/Render/DeviceWrapper_D3D11_MemReplay.h>
...
void MemReplayD3DAnnotation::AddMap(UINT nSubRes, uk pData, size_t sz)
{
	MapDesc desc;
...
HRESULT MemReplayD3DAnnotation::QueryInterface(REFIID riid, uk * ppvObject)
{
...
///////////////////////////////////////////////////////////////////////////////
CDrxDeviceMemReplayHook::CDrxDeviceMemReplayHook()
{
}

///////////////////////////////////////////////////////////////////////////////
tukk CDrxDeviceMemReplayHook::Name() const
{
	return "CDrxDeviceMemReplayHook";
}

///////////////////////////////////////////////////////////////////////////////
void CDrxDeviceMemReplayHook::CreateBuffer_PostCallHook(HRESULT hr, const D3D11_BUFFER_DESC* pDesc, const D3D11_SUBRESOURCE_DATA* pInitialData, ID3D11Buffer** ppBuffer)
{
	if (FAILED(hr))
		return;
...
///////////////////////////////////////////////////////////////////////////////
void CDrxDeviceMemReplayHook::CreateTexture1D_PostCallHook(HRESULT hr, const D3D11_TEXTURE1D_DESC* pDesc, const D3D11_SUBRESOURCE_DATA* pInitialData, ID3D11Texture1D** ppTexture1D)
{
	if (FAILED(hr))
		return;
...
///////////////////////////////////////////////////////////////////////////////
void CDrxDeviceMemReplayHook::CreateTexture2D_PostCallHook(HRESULT hr, const D3D11_TEXTURE2D_DESC* pDesc, const D3D11_SUBRESOURCE_DATA* pInitialData, ID3D11Texture2D** ppTexture2D)
{
	if (FAILED(hr))
		return;
...
///////////////////////////////////////////////////////////////////////////////
void CDrxDeviceMemReplayHook::CreateTexture3D_PostCallHook(HRESULT hr, const D3D11_TEXTURE3D_DESC* pDesc, const D3D11_SUBRESOURCE_DATA* pInitialData, ID3D11Texture3D** ppTexture3D)
{
	if (FAILED(hr))
		return;
...
void CDrxDeviceMemReplayHook::CreatePlacementBuffer_PostCallHook(HRESULT hr, const D3D11_BUFFER_DESC* pDesc, uk pCpuVirtualAddress, ID3D11Buffer** ppBuffer)
{
	if (FAILED(hr))
		return;
...
///////////////////////////////////////////////////////////////////////////////
void CDrxDeviceMemReplayHook::CreatePlacementTexture1D_PostCallHook(HRESULT hr, const D3D11_TEXTURE1D_DESC* pDesc, UINT TileModeIndex, UINT Pitch, uk pCpuVirtualAddress, ID3D11Texture1D** ppTexture1D)
{
...
///////////////////////////////////////////////////////////////////////////////
void CDrxDeviceMemReplayHook::CreatePlacementTexture2D_PostCallHook(HRESULT hr, const D3D11_TEXTURE2D_DESC* pDesc, UINT TileModeIndex, UINT Pitch, uk pCpuVirtualAddress, ID3D11Texture2D** ppTexture2D)
{
		#if !defined(MEMREPLAY_INSTRUMENT_TEXTUREPOOL)
	if (FAILED(hr))
		return;
...
///////////////////////////////////////////////////////////////////////////////
void CDrxDeviceMemReplayHook::CreatePlacementTexture3D_PostCallHook(HRESULT hr, const D3D11_TEXTURE3D_DESC* pDesc, UINT TileModeIndex, UINT Pitch, uk pCpuVirtualAddress, ID3D11Texture3D** ppTexture3D)
{
		#if !defined(MEMREPLAY_INSTRUMENT_TEXTUREPOOL)
	if (FAILED(hr))
		return;
...
///////////////////////////////////////////////////////////////////////////////
void CDrxDeviceMemReplayHook::Map_PostCallHook(HRESULT hr, ID3D11Resource* pResource, UINT Subresource, D3D11_MAP MapType, UINT MapFlags, D3D11_MAPPED_SUBRESOURCE* pMappedResource)
{
	...
	if (pAnnotation)
	{
		...
		if (!FAILED(pResource->QueryInterface(__uuidof(ID3D11Buffer), (uk *)&pBuffer)))
		{
			D3D11_BUFFER_DESC desc;
			pBuffer->GetDesc(&desc);
			sz = desc.ByteWidth;
		...
		else if (!FAILED(pResource->QueryInterface(__uuidof(ID3D11Texture1D), (uk *)&pTex1D)))
		{
			D3D11_TEXTURE1D_DESC desc;
			pTex1D->GetDesc(&desc);
		...
		else if (!FAILED(pResource->QueryInterface(__uuidof(ID3D11Texture3D), (uk *)&pTex2D)))
		{
			D3D11_TEXTURE2D_DESC desc;
			pTex2D->GetDesc(&desc);
		...
		else if (!FAILED(pResource->QueryInterface(__uuidof(ID3D11Texture1D), (uk *)&pTex3D)))
		{
			D3D11_TEXTURE3D_DESC desc;
			pTex3D->GetDesc(&desc);
...
///////////////////////////////////////////////////////////////////////////////
void CDrxDeviceMemReplayHook::Unmap_PreCallHook(ID3D11Resource* pResource, UINT Subresource)
{
	MemReplayD3DAnnotation* pAnnotation = MemReplayGetD3DAnnotation(pResource);
	if (pAnnotation)
	{
...
void CD3D9Renderer::MemReplayWrapD3DDevice()
{
	...
	if (replayInfo.filename)
	{
		...
		RegisterDeviceWrapperHook(new CDrxDeviceMemReplayHook());
	#endif // MEMREPLAY_WRAP_D3D11
	}
#endif
}
