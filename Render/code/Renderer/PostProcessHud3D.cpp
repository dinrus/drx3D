...
i16 SHudData::s_nFlashWidthMax  = 16;
i16 SHudData::s_nFlashHeightMax = 16;
...
void SHudData::Init()
{
	...
	{
		i32 nResID = pShaderResources->m_Id;
...
/*
	...
	u32 nRECount = m_pRenderData[nThreadID].size();
...
/*
	...
	if (nRECount || bForceRefresh) //&& m_nFlashUpdateFrameID != rd->GetFrameID(false) )
	{
		...
		if ((gRenDev->GetFrameID(false) % max(1, (i32)CRenderer::CV_r_PostProcessHUD3DCache)) != 0)
		{
			if (!bForceRefresh)
			{
		...
		i32 nViewportWidth = min((i32)SHudData::s_nFlashWidthMax, m_pHUD_RT->GetWidth());
		i32 nViewportHeight = min((i32)SHudData::s_nFlashHeightMax, m_pHUD_RT->GetHeight());
...
////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////
void CHud3D::ReleaseFlashPlayerRef(u32k nThreadID)
{
	u32 nRECount = m_pRenderData[nThreadID].size();
	for (u32 r = 0; r < nRECount; ++r)
	{
...
/*
	...
	if (interferenceStrength > 0.0f)
	{
		...
		{
			m_interferenceRandNums.x = drx_random(-1.0f, 1.0f);
			m_interferenceRandNums.y = drx_random(-1.0f, 1.0f);
			m_interferenceRandNums.z = drx_random(0.0f, 1.0f);
			m_interferenceRandNums.w = drx_random(-1.0f, 1.0f);
			m_interferenceRandTimer = 0.0f;
		}
