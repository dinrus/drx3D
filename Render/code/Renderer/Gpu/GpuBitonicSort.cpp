...
#include <drx3D/Render/GpuBitonicSort.h>
...
CBitonicSort::CBitonicSort() : m_data(NUM_ELEMENTS), m_transposeData(NUM_ELEMENTS)
{
	...
	m_computePassBitonicSort.SetTechnique(pShader, CDrxNameTSCRC("BitonicSort"), 0);
	m_computePassBitonicTranspose.SetTechnique(pShader, CDrxNameTSCRC("BitonicTranspose"), 0);
}

void CBitonicSort::Sort(u32 numElements, CDeviceCommandListRef RESTRICT_REFERENCE commandList)
{
...
void CBitonicSort::SyncParams(u32 iLevel, u32 iLevelMask, u32 iWidth, u32 iHeight)
{
