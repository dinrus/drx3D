...
// -------------------------------------------------------------------------
//  Имя файла:   AppleGPUInfoUtils.mm
//  Version:     v1.00
//  Created:     06/02/2014 by Leander Beernaert.
//  Описание: Utitilities to access GPU info on Mac OS X
// -------------------------------------------------------------------------
//  История:
//
////////////////////////////////////////////////////////////////////////////
...
// this file needs to be sparate since drx3D headers conflict with the
// Cocoa definitions
...
long GetVRAMForDisplay(i32k dspNum)
{
    ...
    if (err == kCGErrorSuccess)
    {
        ...
        {
            // If so, convert the CFNumber into a plain u64
