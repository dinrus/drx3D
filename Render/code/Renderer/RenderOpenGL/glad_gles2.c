...
#include <stdio.h>
#include <string.h>
#include <drx3D/Render/glad_gles2.h>
...
i32 GLAD_GL_ES_VERSION_2_0;
i32 GLAD_GL_ES_VERSION_3_0;
i32 GLAD_GL_ES_VERSION_3_1;
i32 GLAD_GL_ES_VERSION_3_2;
...
i32 GLAD_GL_EXT_texture_cube_map_array;
i32 GLAD_GL_NV_sRGB_formats;
i32 GLAD_GL_EXT_texture_border_clamp;
i32 GLAD_GL_EXT_texture_filter_anisotropic;
i32 GLAD_GL_KHR_debug;
i32 GLAD_GL_EXT_separate_shader_objects;
i32 GLAD_GL_EXT_texture_compression_s3tc;
i32 GLAD_GL_EXT_texture_view;
...
i32 gladLoadGLES2Loader(GLADloadproc load) {
