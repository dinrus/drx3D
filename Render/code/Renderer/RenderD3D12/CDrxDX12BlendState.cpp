...
#include <drx3D/Render/CDrxDX12BlendState.hpp>

CDrxDX12BlendState* CDrxDX12BlendState::Create(const D3D11_BLEND_DESC* pBlendStateDesc)
{
	...
	return DX12_NEW_RAW(CDrxDX12BlendState(*pBlendStateDesc, desc12));
}

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

CDrxDX12BlendState::CDrxDX12BlendState(const D3D11_BLEND_DESC& desc11, const D3D12_BLEND_DESC& desc12)
...
void STDMETHODCALLTYPE CDrxDX12BlendState::GetDesc(
