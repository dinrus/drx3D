...
#include <drx3D/Render/CDrxDX12ShaderResourceView.hpp>
...
CDrxDX12ShaderResourceView* CDrxDX12ShaderResourceView::Create(CDrxDX12Device* pDevice, ID3D11Resource* pResource11, const D3D11_SHADER_RESOURCE_VIEW_DESC* pDesc)
{
	...
	u32 subresourcesInUse = D3D12CalcSubresourceCount(std::min(mips.Length(), descX.MipLevels), std::min(slices.Length(), descX.ArraySize()), planeCount);

	auto pSrv = DX12_NEW_RAW(CDrxDX12ShaderResourceView(pResource11, *pDesc, pResource12, desc12));
...
CDrxDX12ShaderResourceView::CDrxDX12ShaderResourceView(ID3D11Resource* pResource11, const D3D11_SHADER_RESOURCE_VIEW_DESC& desc11, ID3D12Resource* pResource12, const D3D12_SHADER_RESOURCE_VIEW_DESC& desc12)
	: Super(pResource11, NDrxDX12::EVT_ShaderResourceView)
	, m_Desc11(desc11)
{
...
void STDMETHODCALLTYPE CDrxDX12ShaderResourceView::GetDesc(
