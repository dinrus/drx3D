...
#include <drx3D/Render/CDrxDX12UnorderedAccessView.hpp>

CDrxDX12UnorderedAccessView* CDrxDX12UnorderedAccessView::Create(CDrxDX12Device* pDevice, ID3D11Resource* pResource11, const D3D11_UNORDERED_ACCESS_VIEW_DESC* pDesc11)
{
	...
	auto pUav = DX12_NEW_RAW(CDrxDX12UnorderedAccessView(pResource11, *pDesc11, pResource12, desc12));
	pUav->GetDX12View().SetMapsFullResource(subresourcesInUse == subresourceCount);
	pUav->GetDX12View().SetSlices(slices);
	pUav->GetDX12View().SetMips(TRange<u16>(mip, mip + 1));
	return pUav;
}

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

CDrxDX12UnorderedAccessView::CDrxDX12UnorderedAccessView(ID3D11Resource* pResource11, const D3D11_UNORDERED_ACCESS_VIEW_DESC& desc11, ID3D12Resource* pResource12, const D3D12_UNORDERED_ACCESS_VIEW_DESC& desc12)
	: Super(pResource11, NDrxDX12::EVT_UnorderedAccessView)
	, m_Desc11(desc11)
{
...
void STDMETHODCALLTYPE CDrxDX12UnorderedAccessView::GetDesc(
