...
#include <drx3D/Render/CDrxDX12DepthStencilState.hpp>

CDrxDX12DepthStencilState* CDrxDX12DepthStencilState::Create(const D3D11_DEPTH_STENCIL_DESC* pDepthStencilDesc)
{
	...
	return DX12_NEW_RAW(CDrxDX12DepthStencilState(*pDepthStencilDesc, desc12));
}

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

CDrxDX12DepthStencilState::CDrxDX12DepthStencilState(const D3D11_DEPTH_STENCIL_DESC& desc11, const D3D12_DEPTH_STENCIL_DESC& desc12)
...
void STDMETHODCALLTYPE CDrxDX12DepthStencilState::GetDesc(
