...
#include <drx3D/Render/CDrxDX12Buffer.hpp>
#include <drx3D/Render/GI/CDrxDX12SwapChain.hpp>

CDrxDX12Buffer* CDrxDX12Buffer::Create(CDrxDX12Device* pDevice)
{
	...
	CDrxDX12Buffer* result = DX12_NEW_RAW(CDrxDX12Buffer(pDevice, desc11, nullptr, D3D12_RESOURCE_STATE_COMMON, CD3DX12_RESOURCE_DESC(desc12), NULL));

	return result;
}

CDrxDX12Buffer* CDrxDX12Buffer::Create(CDrxDX12Device* pDevice, ID3D12Resource* pResource, D3D12_RESOURCE_STATES initialState)
{
	...
	CDrxDX12Buffer* result = DX12_NEW_RAW(CDrxDX12Buffer(pDevice, desc11, pResource, initialState, CD3DX12_RESOURCE_DESC(desc12), NULL));
...
CDrxDX12Buffer* CDrxDX12Buffer::Create(CDrxDX12Device* pDevice, CDrxDX12SwapChain* pSwapChain, ID3D12Resource* pResource)
{
	CDrxDX12Buffer* result = Create(pDevice, pResource, D3D12_RESOURCE_STATE_RENDER_TARGET);
...
CDrxDX12Buffer* CDrxDX12Buffer::Create(CDrxDX12Device* pDevice, const D3D11_BUFFER_DESC* pDesc, const D3D11_SUBRESOURCE_DATA* pInitialData)
{
	...
	auto result = DX12_NEW_RAW(CDrxDX12Buffer(pDevice, *pDesc, resource, resourceUsage, CD3DX12_RESOURCE_DESC(resource->GetDesc()), pInitialData, 1));
	resource->Release();
...
CDrxDX12Buffer::CDrxDX12Buffer(CDrxDX12Device* pDevice, const D3D11_BUFFER_DESC& desc11, ID3D12Resource* pResource, D3D12_RESOURCE_STATES eInitialState, const D3D12_RESOURCE_DESC& desc12, const D3D11_SUBRESOURCE_DATA* pInitialData, size_t numInitialData)
	...
	, m_Desc11(desc11)
{
	...
	m_DX12View.Init(m_DX12Resource, NDrxDX12::EVT_ConstantBufferView, m_Desc11.ByteWidth);
}

bool CDrxDX12Buffer::SubstituteUsed()
{
...
void STDMETHODCALLTYPE CDrxDX12Buffer::GetDesc(
