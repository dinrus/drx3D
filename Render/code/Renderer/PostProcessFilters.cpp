...
#include <drx3D/Render/D3D/GraphicsPipeline/PostEffects.h>
////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////
...
/*
	...
	static CDrxNameTSCRC pTechName("CA_Sharpening");
...
/*
	...
	static CDrxNameTSCRC pTechName("BlurInterpolation");
	GetUtils().ShBeginPass(CShaderMan::s_shPostEffects, pTechName, FEF_DONTSETTEXTURES | FEF_DONTSETSTATES);
...
bool CColorGrading::UpdateParams(SColorGradingMergeParams& pMergeParams, bool bUpdateChart)
{
	...
	Vec4 pParams1 = Vec4(fMaxOutput, fGrain, drx_random(0.f, 1023.f), drx_random(0.f, 1023.f));
...
/*
...

	{
		...
		static CDrxNameTSCRC TechNameMask("StereoNearMask");
	...
	static CDrxNameR pParamName1("NearZRange");
...
/*
	...
	// 0.25ms / 0.4ms
	static CDrxNameTSCRC TechName("ImageGhosting");
	GetUtils().ShBeginPass(CShaderMan::s_shPostEffects, TechName, FEF_DONTSETTEXTURES | FEF_DONTSETSTATES);

	// Update ghosting
	gcpRendD3D->FX_SetState(GS_NODEPTHTEST | GS_BLSRC_SRCALPHA | GS_BLDST_ONEMINUSSRCALPHA);

	static CDrxNameR pParamNamePS("ImageGhostingParamsPS");
...
/*
	...
	i32 nRenderState = GS_NODEPTHTEST;
