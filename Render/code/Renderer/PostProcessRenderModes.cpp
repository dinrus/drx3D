...
/*
	...
	Vec4 vParamsVS = Vec4(drx_random(0, 1023), drx_random(0, 1023), drx_random(0, 1023), drx_random(0, 1023));
	...
	static CDrxNameTSCRC pTechName("NightVision");
	...
	static CDrxNameR pParamNameVS("nightVisionParamsVS");
	static CDrxNameR pParamNamePS("nightVisionParamsPS");
...
//		{
//			static u32k nSonarSoundSemantincs = (eSoundSemantic_Explosion|eSoundSemantic_Physics_Collision|eSoundSemantic_Physics_Footstep|eSoundSemantic_Vehicle|eSoundSemantic_Weapon);
...
//					return;
//
//				i32k nFrameID = gRenDev->GetFrameID( false );
...
//				}
//
//				SSonarHint pSonarHint( pSound->GetPosition() , fCurrTime, 0.5f + drx_frand());
...
/*
	...
	PostProcessUtils().TexBlurDirectional(CRendererResources::s_ptexBackBufferScaled[0], Vec2(drx_random(0.0f, 0.125f), drx_random(2.0f, 3.0f)) * fCurrAnim * 4.0f, 1);
