...
#include <drx3D/Render/D3D/GraphicsPipeline/OmniCamera.h>
...
void CTiledShadingStage::Execute()
{
	...
	if (CSvoRenderer::GetInstance()->IsActive())
	{
		...
		i32 nModeGI = CSvoRenderer::GetInstance()->GetIntegratioMode(bSpecularTargetIsReady);
	...
	rtFlags |= CVrProjectionUpr::Instance()->GetRTFlags();
	...
	{
		static CDrxNameTSCRC techTiledShading("TiledDeferredShading");
	...
	m_passCullingShading.BeginConstantUpdate();
	{
		...
		static CDrxNameR projParamsName("ProjParams");
		...
		static CDrxNameR screenSizeName("ScreenSize");
		...
		static CDrxNameR worldViewPosName("WorldViewPos");
		...
		static CDrxNameR frustumTLName("FrustumTL");
		...
		static CDrxNameR frustumTRName("FrustumTR");
		...
		static CDrxNameR frustumBLName("FrustumBL");
		...
		static CDrxNameR sunDirName("SunDir");
		...
		static CDrxNameR sunColorName("SunColor");
		Vec3 sunColor;
		...
		static CDrxNameR ssdoParamsName("SSDOParams");
