...
void SD3DPostEffectsUtils::CopyTextureToScreen(CTexture*& pSrc, const RECT* pSrcRegion, i32k filterMode)
{
	ASSERT_LEGACY_PIPELINE
/*
	static CDrxNameTSCRC pRestoreTechName("TextureToTexture");
...
void SD3DPostEffectsUtils::Downsample(CTexture* pSrc, CTexture* pDst, i32 nSrcW, i32 nSrcH, i32 nDstW, i32 nDstH, EFilterType eFilter /*= FilterType_Box*/, bool bSetTarget /*= true*/)
{
	ASSERT_LEGACY_PIPELINE
}
...
void CPostEffectsMgr::End(CRenderView* pRenderView)
{
	...
	i32k kFloatMaxContinuousInt = 0x1000000;  // 2^24
