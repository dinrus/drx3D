...
COpticsElement::COpticsElement(tukk name, float size, const float brightness, const ColorF& color)
...
void COpticsElement::Load(IXmlNode* pNode)
{
	...
	if (pCommonNode)
	{
		...
		i32 nAlpha((i32)(m_Color.a * 255.0f));
...
void COpticsElement::GetMemoryUsage(IDrxSizer* pSizer) const
{
