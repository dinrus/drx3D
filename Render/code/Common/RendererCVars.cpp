...
//////////////////////////////////////////////////////////////////////////
i32 CRendererCVars::CV_r_GraphicsPipeline;
i32 CRendererCVars::CV_r_GraphicsPipelineMobile;
i32 CRendererCVars::CV_r_GraphicsPipelinePassScheduler;
i32 CRendererCVars::CV_r_PostProcess_CB;
i32 CRendererCVars::CV_r_PostProcess;
...
i32 CRendererCVars::CV_r_vsync;
#if defined(SUPPORT_DEVICE_INFO_USER_DISPLAY_OVERRIDES)
float CRendererCVars::CV_r_overrideRefreshRate = 0;
i32 CRendererCVars::CV_r_overrideScanlineOrder = 0;
#endif
#if DRX_PLATFORM_WINDOWS
i32 CRendererCVars::CV_r_FullscreenPreemption = 1;
#endif
...
i32 CRendererCVars::CV_r_HDRDithering;
...
i32 CRendererCVars::CV_r_logVBuffers;
AllocateConstIntCVar(CRendererCVars, CV_r_logVidMem);
AllocateConstIntCVar(CRendererCVars, CV_r_useESRAM);
i32 CRendererCVars::CV_r_DeferredShadingSortLights;

i32 CRendererCVars::CV_r_BreakOnError;
i32 CRendererCVars::CV_r_durango_async_dips;
i32 CRendererCVars::CV_r_durango_async_dips_sync;
i32 CRendererCVars::CV_r_D3D12SubmissionThread;
i32 CRendererCVars::CV_r_D3D12WaitableSwapChain;
i32 CRendererCVars::CV_r_D3D12BatchResourceBarriers;
i32 CRendererCVars::CV_r_D3D12EarlyResourceBarriers;
i32 CRendererCVars::CV_r_D3D12AsynchronousCompute;
i32 CRendererCVars::CV_r_D3D12HardwareComputeQueue;
i32 CRendererCVars::CV_r_D3D12HardwareCopyQueue;
i32 CRendererCVars::CV_r_VkSubmissionThread;
i32 CRendererCVars::CV_r_VkBatchResourceBarriers;
i32 CRendererCVars::CV_r_VkHardwareComputeQueue;
i32 CRendererCVars::CV_r_VkHardwareCopyQueue;
i32 CRendererCVars::CV_r_ReprojectOnlyStaticObjects;
i32 CRendererCVars::CV_r_ReadZBufferDirectlyFromVMEM;
i32 CRendererCVars::CV_r_FlushToGPU;

i32 CRendererCVars::CV_r_EnableDebugLayer;
i32 CRendererCVars::CV_r_NoDraw;
i32 CRendererCVars::CV_r_UpdateInstances;
...
i32 CRendererCVars::CV_r_multigpu;
...
i32 CRendererCVars::CV_r_texturesstreamingSkipMips;
i32 CRendererCVars::CV_r_texturesstreamingMinUsableMips;
i32 CRendererCVars::CV_r_texturesstreamingJobUpdate;
#if defined(TEXSTRM_DEFERRED_UPLOAD)
i32 CRendererCVars::CV_r_texturesstreamingDeferred;
#endif
#if defined(SUPPORTS_INPLACE_TEXTURE_STREAMING)
i32 CRendererCVars::CV_r_texturesstreamingInPlace;
#endif
...
i32 CRendererCVars::CV_r_TexturesStreamPoolSize;
i32 CRendererCVars::CV_r_TexturesStreamPoolSecondarySize;
i32 CRendererCVars::CV_r_texturesstreampooldefragmentation;
i32 CRendererCVars::CV_r_texturesstreampooldefragmentationmaxmoves;
i32 CRendererCVars::CV_r_texturesstreampooldefragmentationmaxamount;
i32 CRendererCVars::CV_r_rendertargetpoolsize;
float CRendererCVars::CV_r_TexturesStreamingMaxRequestedMB;
i32 CRendererCVars::CV_r_TexturesStreamingMaxRequestedJobs;
float CRendererCVars::CV_r_TexturesStreamingMipBias;
i32 CRendererCVars::CV_r_TexturesStreamingMipClampDVD;
i32 CRendererCVars::CV_r_TexturesStreamingDisableNoStreamDuringLoad;
float CRendererCVars::CV_r_TextureLodDistanceRatio;

i32 CRendererCVars::CV_r_buffer_banksize;
i32 CRendererCVars::CV_r_constantbuffer_banksize;
i32 CRendererCVars::CV_r_constantbuffer_watermark;
i32 CRendererCVars::CV_r_buffer_sli_workaround;
i32 CRendererCVars::CV_r_transient_pool_size;
...
i32 CRendererCVars::CV_r_buffer_pool_max_allocs;
i32 CRendererCVars::CV_r_buffer_pool_defrag_static;
i32 CRendererCVars::CV_r_buffer_pool_defrag_dynamic;
i32 CRendererCVars::CV_r_buffer_pool_defrag_max_moves;

i32 CRendererCVars::CV_r_dyntexmaxsize;
i32 CRendererCVars::CV_r_dyntexatlascloudsmaxsize;
i32 CRendererCVars::CV_r_dyntexatlasspritesmaxsize;
i32 CRendererCVars::CV_r_dyntexatlasvoxterrainsize;
i32 CRendererCVars::CV_r_dyntexatlasdyntexsrcsize;
...
i32 CRendererCVars::CV_r_texatlassize;
i32 CRendererCVars::CV_r_texminanisotropy;
i32 CRendererCVars::CV_r_texmaxanisotropy;
...
i32 CRendererCVars::CV_r_DeferredShadingTiled;
i32 CRendererCVars::CV_r_DeferredShadingTiledDebug;
i32 CRendererCVars::CV_r_DeferredShadingTiledHairQuality;
i32 CRendererCVars::CV_r_DeferredShadingSSS;
i32 CRendererCVars::CV_r_DeferredShadingFilterGBuffer;

i32 CRendererCVars::CV_r_UsePersistentRTForModelHUD;
...
i32 CRendererCVars::CV_r_DeferredShadingAmbient;
...
i32 CRendererCVars::CV_r_HDRSwapChain;
AllocateConstIntCVar(CRendererCVars, CV_r_HDRDebug);
i32 CRendererCVars::CV_r_HDRBloom;
i32 CRendererCVars::CV_r_HDRBloomQuality;
i32 CRendererCVars::CV_r_HDRVignetting;
...
i32 CRendererCVars::CV_r_HDREyeAdaptationMode;
...
i32 CRendererCVars::CV_r_SilhouettePOM;
#endif
#ifdef WATER_TESSELLATION_RENDERER
i32 CRendererCVars::CV_r_WaterTessellationHW;
#endif
i32 CRendererCVars::CV_r_tessellationdebug;
float CRendererCVars::CV_r_tessellationtrianglesize;
float CRendererCVars::CV_r_displacementfactor;

i32 CRendererCVars::CV_r_batchtype;
i32 CRendererCVars::CV_r_geominstancingthreshold;
...
i32 CRendererCVars::CV_r_ShadowsPCFiltering;
float CRendererCVars::CV_r_shadow_jittering;
i32 CRendererCVars::CV_r_ShadowPoolMaxTimeslicedUpdatesPerFrame;
i32 CRendererCVars::CV_r_ShadowCastingLightsMaxCount;
...
i32 CRendererCVars::CV_r_ShadowsCache;
i32 CRendererCVars::CV_r_ShadowsCacheFormat;
i32 CRendererCVars::CV_r_ShadowsScreenSpace;
float CRendererCVars::CV_r_ShadowsScreenSpaceLength;
i32 CRendererCVars::CV_r_ShadowsNearestMapResolution;
i32 CRendererCVars::CV_r_HeightMapAO;
...
i32 CRendererCVars::CV_r_shadersremotecompiler;
i32 CRendererCVars::CV_r_shadersasynccompiling;
i32 CRendererCVars::CV_r_shadersasyncactivation;
i32 CRendererCVars::CV_r_shadersasyncmaxthreads;
i32 CRendererCVars::CV_r_shaderscachedeterministic;
i32 CRendererCVars::CV_r_ShadersCachePrecacheAll;
...
i32 CRendererCVars::CV_r_shaderssubmitrequestline;
i32 CRendererCVars::CV_r_shaderslogcachemisses;
i32 CRendererCVars::CV_r_shadersImport;
i32 CRendererCVars::CV_r_shadersExport;

AllocateConstIntCVar(CRendererCVars, CV_r_meshprecache);
i32 CRendererCVars::CV_r_meshpoolsize;
i32 CRendererCVars::CV_r_meshinstancepoolsize;

AllocateConstIntCVar(CRendererCVars, CV_r_ZPassDepthSorting);
float CRendererCVars::CV_r_ZPrepassMaxDist;
i32 CRendererCVars::CV_r_usezpass;

AllocateConstIntCVar(CRendererCVars, CV_r_TransparentPasses);
i32 CRendererCVars::CV_r_TranspDepthFixup;
...
i32 CRendererCVars::CV_r_ParticlesSoftIsec;
i32 CRendererCVars::CV_r_ParticlesRefraction;
i32 CRendererCVars::CV_r_ParticlesHalfRes;
...
i32 CRendererCVars::CV_r_AntialiasingMode_CB;
i32 CRendererCVars::CV_r_AntialiasingMode;
i32 CRendererCVars::CV_r_AntialiasingModeSCull;
i32 CRendererCVars::CV_r_AntialiasingTAAPattern;
...
i32 CRendererCVars::CV_r_MotionVectors;
i32 CRendererCVars::CV_r_MotionBlur;
i32 CRendererCVars::CV_r_MotionBlurQuality;
i32 CRendererCVars::CV_r_MotionBlurGBufferVelocity;
float CRendererCVars::CV_r_MotionBlurThreshold;
i32 CRendererCVars::CV_r_UseMergedPosts;
i32 CRendererCVars::CV_r_MaxFrameLatency;
...
i32 CRendererCVars::CV_r_cloakFadeByDist;
...
i32 CRendererCVars::CV_r_cloakRefractionFadeByDist;
...
i32 CRendererCVars::CV_r_cloakRenderInThermalVision;
...
i32 CRendererCVars::CV_r_rain;
i32 CRendererCVars::CV_r_rain_ignore_nearest;
...
i32 CRendererCVars::CV_r_SSReflections;
i32 CRendererCVars::CV_r_SSReflHalfRes;
i32 CRendererCVars::CV_r_SSReflSamples;
float CRendererCVars::CV_r_SSReflDistance;
i32 CRendererCVars::CV_r_ssdo;
i32 CRendererCVars::CV_r_ssdoHalfRes;
i32 CRendererCVars::CV_r_ssdoColorBleeding;
...
i32 CRendererCVars::CV_r_dof;
i32 CRendererCVars::CV_r_DofMode;
i32 CRendererCVars::CV_r_DofBokehQuality;
...
i32 CRendererCVars::CV_r_rc_autoinvoke;

i32 CRendererCVars::CV_r_Refraction;
i32 CRendererCVars::CV_r_sunshafts;
...
i32 CRendererCVars::CV_r_PostProcessReset;
i32 CRendererCVars::CV_r_PostProcessFilters;
...
i32 CRendererCVars::CV_r_PostProcessHUD3DCache;
...
i32 CRendererCVars::CV_r_colorRangeCompression;

i32 CRendererCVars::CV_r_colorgrading;
i32 CRendererCVars::CV_r_colorgrading_selectivecolor;
...
i32 CRendererCVars::CV_r_colorgrading_charts;
i32 CRendererCVars::CV_r_ColorgradingChartsCache;

AllocateConstIntCVar(CRendererCVars, CV_r_showdyntextures);
i32 CRendererCVars::CV_r_ShowDynTexturesMaxCount;
...
i32 CRendererCVars::CV_r_ShaderCompilerPort;
i32 CRendererCVars::CV_r_ShaderCompilerDontCache;
i32 CRendererCVars::CV_r_flares = FLARES_DEFAULT_VAL;
i32 CRendererCVars::CV_r_flareHqShafts;
float CRendererCVars::CV_r_FlaresChromaShift;
i32 CRendererCVars::CV_r_FlaresIrisShaftMaxPolyNum;
i32 CRendererCVars::CV_r_FlaresEnableColorGrading;
float CRendererCVars::CV_r_FlaresTessellationRatio;

i32 CRendererCVars::CV_r_envcmresolution;
i32 CRendererCVars::CV_r_envtexresolution;
...
i32 CRendererCVars::CV_r_waterreflections;
...
i32 CRendererCVars::CV_r_watercaustics;
float CRendererCVars::CV_r_watercausticsdistance;
i32 CRendererCVars::CV_r_watercausticsdeferred;
i32 CRendererCVars::CV_r_watervolumecaustics;
i32 CRendererCVars::CV_r_watervolumecausticsdensity;
i32 CRendererCVars::CV_r_watervolumecausticsresolution;
float CRendererCVars::CV_r_watervolumecausticssnapfactor;
float CRendererCVars::CV_r_watervolumecausticsmaxdistance;
i32 CRendererCVars::CV_r_water_godrays;
float CRendererCVars::CV_r_water_godrays_distortion;
i32 CRendererCVars::CV_r_WaterUpdateThread;
i32 CRendererCVars::CV_r_texNoAnisoAlphaTest;
i32 CRendererCVars::CV_r_reflections;
i32 CRendererCVars::CV_r_reflections_quality;
...
i32 CRendererCVars::CV_r_scissor;

AllocateConstIntCVar(CRendererCVars, CV_r_wireframe);
i32 CRendererCVars::CV_r_GetScreenShot;
...
i32 CRendererCVars::CV_r_VegetationSpritesTexRes;
AllocateConstIntCVar(CRendererCVars, CV_r_VegetationSpritesGenAlways);

i32 CRendererCVars::CV_r_ShowVideoMemoryStats;

ICVar* CRendererCVars::CV_r_ShowTexture = NULL;
ICVar* CRendererCVars::CV_r_TexturesStreamingDebugfilter = NULL;
i32 CRendererCVars::CV_r_TexturesStreamingDebugMinSize;
i32 CRendererCVars::CV_r_TexturesStreamingDebugMinMip;
...
i32 CRendererCVars::CV_r_ParticlesTessellation;
i32 CRendererCVars::CV_r_ParticlesTessellationTriSize;
...
i32 CRendererCVars::CV_r_ConditionalRendering;
i32 CRendererCVars::CV_r_enableAltTab;
i32 CRendererCVars::CV_r_StereoFlipEyes;
i32 CRendererCVars::CV_r_StereoEnableMgpu;
...
i32 CRendererCVars::CV_r_ConsoleBackbufferWidth;
i32 CRendererCVars::CV_r_ConsoleBackbufferHeight;

i32 CRendererCVars::CV_r_CustomResMaxSize;
i32 CRendererCVars::CV_r_CustomResWidth;
i32 CRendererCVars::CV_r_CustomResHeight;
i32 CRendererCVars::CV_r_CustomResPreview;
i32 CRendererCVars::CV_r_Supersampling;
i32 CRendererCVars::CV_r_SupersamplingFilter;

float CRendererCVars::CV_r_FogDepthTest;
#if defined(VOLUMETRIC_FOG_SHADOWS)
i32 CRendererCVars::CV_r_FogShadows;
i32 CRendererCVars::CV_r_FogShadowsMode;
#endif
i32 CRendererCVars::CV_r_FogShadowsWater;

i32 CRendererCVars::CV_r_RainDropsEffect;
...
i32 CRendererCVars::CV_r_DynTexSourceSharedRTWidth;
i32 CRendererCVars::CV_r_DynTexSourceSharedRTHeight;
i32 CRendererCVars::CV_r_DynTexSourceUseSharedRT;

#if defined(ENABLE_RENDER_AUX_GEOM)
i32 CRendererCVars::CV_r_enableauxgeom;
#endif

i32 CRendererCVars::CV_r_ParticleVerticePoolSize;
i32 CRendererCVars::CV_r_ParticleMaxVerticePoolSize;
i32 CRendererCVars::CV_r_GeomCacheInstanceThreshold;
i32 CRendererCVars::CV_r_VisAreaClipLightsPerPixel;

i32 CRendererCVars::CV_r_VolumetricFogTexScale;
i32 CRendererCVars::CV_r_VolumetricFogTexDepth;
float CRendererCVars::CV_r_VolumetricFogReprojectionBlendFactor;
i32 CRendererCVars::CV_r_VolumetricFogSample;
i32 CRendererCVars::CV_r_VolumetricFogShadow;
i32 CRendererCVars::CV_r_VolumetricFogDownscaledSunShadow;
i32 CRendererCVars::CV_r_VolumetricFogDownscaledSunShadowRatio;
i32 CRendererCVars::CV_r_VolumetricFogReprojectionMode;
float CRendererCVars::CV_r_VolumetricFogMinimumLightBulbSize;
i32 CRendererCVars::CV_r_VolumetricFogSunLightCorrection;

i32 CRendererCVars::CV_r_GpuParticles;
i32 CRendererCVars::CV_r_GpuParticlesConstantRadiusBoundingBoxes;
i32 CRendererCVars::CV_r_GpuPhysicsFluidDynamicsDebug;

i32 CRendererCVars::CV_r_VolumetricClouds;
i32 CRendererCVars::CV_r_VolumetricCloudsRaymarchStepNum;
i32 CRendererCVars::CV_r_VolumetricCloudsPipeline;
i32 CRendererCVars::CV_r_VolumetricCloudsStereoReprojection;
i32 CRendererCVars::CV_r_VolumetricCloudsTemporalReprojection;
i32 CRendererCVars::CV_r_VolumetricCloudsShadowResolution;

Vec2 CRendererCVars::s_overscanBorders(0, 0);

i32 CRendererCVars::CV_d3d11_CBUpdateStats;
...
i32 CRendererCVars::CV_d3d11_debugBreakOnce;
#endif

#if defined(DRX_PLATFORM_WINDOWS)
i32 CRendererCVars::CV_d3d11_preventDriverThreading;
#endif
...
static void OnChange_CV_D3D12HardwareComputeQueue(ICVar* /*pCVar*/)
{
	...
	reinterpret_cast<CDrxDX12Device*>(gcpRendD3D->GetDevice().GetRealDevice())->FlushAndWaitForGPU();
	reinterpret_cast<CDrxDX12DeviceContext*>(gcpRendD3D->GetDeviceContext().GetRealDeviceContext())->RecreateCommandListPool(CMDQUEUE_COMPUTE);
}
...
static void OnChange_CV_D3D12HardwareCopyQueue(ICVar* /*pCVar*/)
{
	...
	reinterpret_cast<CDrxDX12Device*>(gcpRendD3D->GetDevice().GetRealDevice())->FlushAndWaitForGPU();
	reinterpret_cast<CDrxDX12DeviceContext*>(gcpRendD3D->GetDeviceContext().GetRealDeviceContext())->RecreateCommandListPool(CMDQUEUE_COPY);
}
#endif
...
static void OnChange_CV_r_ShaderTarget(ICVar* pCVar)
{
	...
	STxt r_driverStr = gEnv->pConsole->GetCVar("r_driver")->GetString();
	STxt shaderTargetStr(pCVar->GetString());
	auto toUpperLamda = [](u8 c) -> u8 { return std::toupper(c); };
...
#if DRX_PLATFORM_ANDROID || DRX_PLATFORM_LINUX || DRX_PLATFORM_APPLE
	...
	else if (shaderTargetStr == STR_ORBIS_SHADER_TARGET)
	{
		...
		if(r_driverStr != STR_DX11_RENDERER)
			DrxFatalError("r_driver MUST match shader target flag.");
	}
	...
	{
		DrxFatalError("Using %s as a shader target string is not allowed. Available valid options are %s/%s/%s/%s/%s/%s", 
			shaderTargetStr, 
...
static void OnChange_CV_r_AntialiasingMode(ICVar* pCVar)
{
	...
	i32 nVal = gRenDev->CV_r_AntialiasingMode;
...
static void OnChange_CV_r_ShadersAllowCompiliation(ICVar* pCVar)
{
	...
	DrxWarning(VALIDATOR_MODULE_RENDERER, VALIDATOR_ERROR, "Changing r_ShadersAllowCompilation at runtime can cause problems. Please set it in your system.cfg or user.cfg instead.");
}

static void OnChange_CV_r_MaxFrameLatency(ICVar* pCVar)
{
	i32 clampedLatency = clamp_tpl(pCVar->GetIVal(), 1, MAX_FRAME_LATENCY);
	pCVar->Set(clampedLatency);
}

static void OnChange_CV_r_FlaresTessellationRatio(ICVar* pCVar)
{
	gEnv->pOpticsUpr->Invalidate();
}
...
void CRendererCVars::OnChange_GeomInstancingThreshold(ICVar* pVar)
{
	...
	{
		i32 nGPU = gRenDev->GetFeatures() & RFT_HW_MASK;
...
{
	i32 argCount = pParams->GetArgCount();
...
void CRendererCVars::InitCVars()
{
	...
	for (i32 i = 0; i < eAT_AAMODES_COUNT; ++i)
	{
		string mode;
		mode.Format("%d: %s\n", i, s_pszAAModes[i]);
	...
	i32k defaultbuffer_bank_size = 4;
	i32k default_transient_bank_size = 4;
	i32k default_cb_bank_size = 4;
	i32k defaultt_cb_watermark = 64;
	i32k defaultbuffer_pool_max_allocs = 0xfff0;
	i32k defaultbuffer_pool_defrag = 0;
	...
	i32 nDefaultDefragState = 0;
	i32 nDefaultTexPoolSize = 1024;
...
CCVarUpdateRecorder::SUpdateRecord::SUpdateRecord(ICVar* pCVar)
{
	...
	switch (type)
	{
		...
		case CVAR_STRING: drx_strcpy(stringValue, pCVar->GetString()); break;
...
const CCVarUpdateRecorder::SUpdateRecord* CCVarUpdateRecorder::GetCVar(tukk cvarName) const
{
	for (auto& cvar : m_updatedCVars[gRenDev->GetRenderThreadID()])
	{
		if (drx_strcmp(cvar.name, cvarName) == 0)
			return &cvar;
	}
