...
i32 SPostEffectsUtils::m_iFrameCounter = 0;
CShader* SPostEffectsUtils::m_pCurrShader;
i32 SPostEffectsUtils::m_nColorMatrixFrameID;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////
void SPostEffectsUtils::GetFullScreenTri(SVF_P3F_C4B_T2F pResult[3], i32 nTexWidth, i32 nTexHeight, float z, const RECT* pSrcRegion)
{
	z = 1.0f - z;
...
void SPostEffectsUtils::GetFullScreenQuad(SVF_P3F_C4B_T2F pResult[4], i32 nTexWidth, i32 nTexHeight, float z, const RECT* pSrcRegion)
{
	z = 1.0f - z;
...
void SPostEffectsUtils::DrawFullScreenTri(i32 nTexWidth, i32 nTexHeight, float z, const RECT* pSrcRegion)
{
	//OLD PIPELINE
	ASSERT_LEGACY_PIPELINE

	//DrxStackAllocWithSizeVector(SVF_P3F_C4B_T2F, 4, screenQuad, CDeviceBufferUpr::AlignBufferSizeForStreaming);
...
void SPostEffectsUtils::DrawScreenQuad(i32 nTexWidth, i32 nTexHeight, float x0, float y0, float x1, float y1)
{
	//OLD PIPELINE
	ASSERT_LEGACY_PIPELINE

	const float z = 1.0f;
	DrxStackAllocWithSizeVector(SVF_P3F_C4B_T2F, 4, pScreenQuad, CDeviceBufferUpr::AlignBufferSizeForStreaming);
...
void SPostEffectsUtils::DrawQuad(i32 nTexWidth, i32 nTexHeight,
...
void SPostEffectsUtils::GetFullScreenTriWPOS(SVF_P3F_T2F_T3F pResult[3], i32 nTexWidth, i32 nTexHeight, float z, const RECT* pSrcRegion)
{
...
void SPostEffectsUtils::GetFullScreenQuadWPOS(SVF_P3F_T2F_T3F pResult[4], i32 nTexWidth, i32 nTexHeight, float z, const RECT* pSrcRegion)
{
	UpdateFrustumCorners();
...
void SPostEffectsUtils::DrawFullScreenTriWPOS(i32 nTexWidth, i32 nTexHeight, float z, const RECT* pSrcRegion)
{
	//OLD PIPELINE
	ASSERT_LEGACY_PIPELINE

	//DrxStackAllocWithSizeVector(SVF_P3F_T2F_T3F, 4, screenQuad, CDeviceBufferUpr::AlignBufferSizeForStreaming);
...
void SPostEffectsUtils::SetTexture(CTexture* pTex, i32 nStage, i32 nFilter, ESamplerAddressMode eMode, bool bSRGBLookup, DWORD dwBorderColor)
{
	ASSERT_LEGACY_PIPELINE;
}
...
bool SPostEffectsUtils::GetOrCreateRenderTarget(tukk szTexName, CTexture*& pTex, i32 nWidth, i32 nHeight, const ColorF& cClear, bool bUseAlpha, bool bMipMaps, ETEX_Format eTF, i32 nCustomID, i32 nFlags)
{
	...
	u32 flags = nFlags & ~(FT_USAGE_DEPTHSTENCIL);
...
bool SPostEffectsUtils::GetOrCreateDepthStencil(tukk szTexName, CTexture*& pTex, i32 nWidth, i32 nHeight, const ColorF& cClear, bool bUseAlpha, bool bMipMaps, ETEX_Format eTF, i32 nCustomID, i32 nFlags)
{
	MEMSTAT_CONTEXT_FMT(EMemStatContextTypes::MSC_Texture, 0, "PostEffects CreateRenderTarget: %s", szTexName);
	...
	u32 flags = nFlags & ~(FT_USAGE_RENDERTARGET);
...
bool SPostEffectsUtils::ShBeginPass(CShader* pShader, const CDrxNameTSCRC& TechName, u32 nFlags)
{
	ASSERT_LEGACY_PIPELINE
	return false;
}
...
void SPostEffectsUtils::ShSetParamVS(const CDrxNameR& pParamName, const Vec4& pParam)
{
	ASSERT_LEGACY_PIPELINE
}
...
void SPostEffectsUtils::ShSetParamPS(const CDrxNameR& pParamName, const Vec4& pParam)
{
	ASSERT_LEGACY_PIPELINE
}
