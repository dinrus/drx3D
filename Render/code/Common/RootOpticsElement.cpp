...
{
	DRX_PROFILE_REGION(PROFILE_RENDERER, "RootOpticsElement::RT_RenderPreview");

	DRX_ASSERT(pParam  && pParam->IsValid());
...
bool RootOpticsElement::ProcessAll(CPrimitiveRenderPass& targetPass, std::vector<CPrimitiveRenderPass*>& prePasses, const SFlareLight& light, const SRenderViewInfo* pViewInfo, i32 viewInfoCount, bool bForceRender, bool bUpdateOcclusion)
{
