...
DrxCriticalSection CRenderElement::s_accessLock;

i32 CRenderElement::s_nCounter;
...
#endif
	u32 nFrame = (u32)(gRenDev->GetMainFrameID()) - 3;
...
i32                CRenderElement::mfGetMatId()       { return -1; }
void               CRenderElement::mfReset()          {}

tukk        CRenderElement::mfTypeString()
{
	switch (m_Type)
	{
	case eDATA_Sky:
...
uk CRenderElement::mfGetPointer(ESrcPointer ePT, i32* Stride, EParamType Type, ESrcPointer Dst, i32 Flags) { return NULL; }
