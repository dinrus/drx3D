...
i32 CCapsuleGeom::CalcPhysicalProperties(phys_geometry *pgeom)
{ 
	pgeom->pGeom = this;
...
i32 CCapsuleGeom::PointInsideStatus(const Vec3 &pt)
{
...
i32 CCapsuleGeom::PrepareForIntersectionTest(geometry_under_test *pGTest, CGeometry *pCollider,geometry_under_test *pGTestColl, bool bKeepPrevContacts)
{
...
i32 CCapsuleGeom::GetUnprojectionCandidates(i32 iop,const contact *pcontact, primitive *&pprim,i32 *&piFeature, geometry_under_test *pGTest)
{
	...
	i32 iFeature = pcontact->iFeature[iop];
	float r2,hh;
...
i32 CCapsuleGeom::FindClosestPoint(geom_world_data *pgwd, i32 &iPrim,i32 &iFeature, const Vec3 &ptdst0,const Vec3 &ptdst1,
...
i32 CCapsuleGeom::UnprojectSphere(Vec3 center,float r,float rsep, contact *pcontact)
{
...
i32 CCapsuleGeom::DrawToOcclusionCubemap(const geom_world_data *pgwd, i32 iStartPrim,i32 nPrims, i32 iPass, SOcclusionCubeMap* cubeMap)
{
	CBoxGeom geombox;
