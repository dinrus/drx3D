...
i32 CCylinderGeom::CalcPhysicalProperties(phys_geometry *pgeom)
{ 
	pgeom->pGeom = this;
...
i32 CCylinderGeom::PointInsideStatus(const Vec3 &pt)
{
	Vec3 ptr; float h;
...
i32 CCylinderGeom::PrepareForIntersectionTest(geometry_under_test *pGTest, CGeometry *pCollider,geometry_under_test *pGTestColl, bool bKeepPrevContacts)
{
...
i32 CCylinderGeom::PreparePrimitive(geom_world_data *pgwd, primitive *&pprim, i32 iCaller)
{
...
i32 CCylinderGeom::GetPrimitiveList(i32 iStart,i32 nPrims, i32 typeCollider,primitive *pCollider,i32 bColliderLocal,
...
i32 CCylinderGeom::GetUnprojectionCandidates(i32 iop,const contact *pcontact, primitive *&pprim,i32 *&piFeature, geometry_under_test *pGTest)
{
	...
	i32 iFeature = pcontact->iFeature[iop],iCap;
	float r2,hh;
...
i32 CCylinderGeom::PreparePolygon(coord_plane *psurface, i32 iPrim,i32 iFeature, geometry_under_test *pGTest, Vec2 *&ptbuf,
...
i32 CCylinderGeom::PreparePolyline(coord_plane *psurface, i32 iPrim,i32 iFeature, geometry_under_test *pGTest, Vec2 *&ptbuf,
																	 i32 *&pVtxIdBuf,i32 *&pEdgeIdBuf)
{
	Vec3 axis,center,pt;
...
i32 CCylinderGeom::FindClosestPoint(geom_world_data *pgwd, i32 &iPrim,i32 &iFeature, const Vec3 &ptdst0,const Vec3 &ptdst1,
...
i32 CCylinderGeom::UnprojectSphere(Vec3 center,float r,float rsep, contact *pcontact)
{
	...
	umode.dir.Set(0,0,0);
	i32 res = cylinder_sphere_lin_unprojection(&umode,&m_cyl,-1,&sph,-1,pcontact,0);
...
i32 crop_polyarc2d_with_line(const Vec2 *pt,i32k *itype,i32 npt, float r, Vec2 *ptout,i32 *itypeout, 
...
void CCylinderGeom::CalculateMediumResistance(const plane *pplane, const geom_world_data *pgwd, Vec3 &dPres,Vec3 &dLres)
{
	...
	i32 i,icap,npt,sgx,itypebuf0[16],itypebuf1[16],*itype=itypebuf0,*itype1=itypebuf1,*itypet;
...
i32 CCylinderGeom::DrawToOcclusionCubemap(const geom_world_data *pgwd, i32 iStartPrim,i32 nPrims, i32 iPass, SOcclusionCubeMap* cubeMap)
{
	CBoxGeom geombox;
...
void CCylinderGeom::DrawWireframe(IPhysRenderer *pRenderer, geom_world_data *gwd, i32 iLevel, i32 idxColor)
{
	/*if (iLevel==0) {
		i32 i; float step,ang;
...
void CCylinderGeom::GetMemoryStatistics(IDrxSizer *pSizer)
{
