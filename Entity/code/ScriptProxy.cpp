...
DRXREGISTER_CLASS(CEntityComponentLuaScript);
...
void CEntityComponentLuaScript::ProcessEvent(const SEntityEvent& event)
{
	...
	case ENTITY_EVENT_TIMER:
		...
		m_pScript->CallStateFunction(CurrentState(), m_pThis.get(), ScriptState_OnTimer, (i32)event.nParam[0], (i32)event.nParam[1]);
		break;
			...
			if (m_enableSoundAreaEvents)
			{
				...
				if (pIEntity != nullptr)
				{
					...
					if (pTrgEntityThis != nullptr)
					{
						...
						{
							m_pScript->CallStateFunction(CurrentState(), m_pThis.get(), ScriptState_OnEnterArea, pTrgEntityThis, static_cast<i32>(event.nParam[1]), event.fParam[0], pTriggerEntityScript);
						}
						else
						{
							m_pScript->CallStateFunction(CurrentState(), m_pThis.get(), ScriptState_OnEnterArea, pTrgEntityThis, static_cast<i32>(event.nParam[1]), event.fParam[0]);
						}
					}
					...
					if ((pIEntity->GetFlags() & (ENTITY_FLAG_LOCAL_PLAYER | ENTITY_FLAG_CAMERA_SOURCE)) > 0)
					{
						if (pTriggerEntityScript != nullptr)
						{
							m_pScript->CallStateFunction(CurrentState(), m_pThis.get(), ScriptState_OnLocalClientEnterArea, pTrgEntityThis, static_cast<i32>(event.nParam[1]), event.fParam[0], pTriggerEntityScript);
						}
						else
						{
							m_pScript->CallStateFunction(CurrentState(), m_pThis.get(), ScriptState_OnLocalClientEnterArea, pTrgEntityThis, static_cast<i32>(event.nParam[1]), event.fParam[0]);
						}
					}
	...
	case ENTITY_EVENT_MOVEINSIDEAREA:
		{
			if (m_enableSoundAreaEvents)
			{
				...
				if (pIEntity != nullptr)
				{
					...
					if (pTrgEntityThis != nullptr)
					{
						m_pScript->CallStateFunction(CurrentState(), m_pThis.get(), ScriptState_OnProceedFadeArea, pTrgEntityThis, static_cast<i32>(event.nParam[1]), event.fParam[0]);
					}

					// allow local player/camera source entities to trigger callback even without that entity having a scripttable
					if ((pIEntity->GetFlags() & (ENTITY_FLAG_LOCAL_PLAYER | ENTITY_FLAG_CAMERA_SOURCE)) > 0)
					{
						m_pScript->CallStateFunction(CurrentState(), m_pThis.get(), ScriptState_OnLocalClientProceedFadeArea, pTrgEntityThis, static_cast<i32>(event.nParam[1]), event.fParam[0]);
					}
			...
			if (m_enableSoundAreaEvents)
			{
				...
				if (pIEntity != nullptr)
				{
					...
					if (pTrgEntityThis != nullptr)
					{
						if (pTriggerEntityScript != nullptr)
						{
							m_pScript->CallStateFunction(CurrentState(), m_pThis.get(), ScriptState_OnLeaveArea, pTrgEntityThis, static_cast<i32>(event.nParam[1]), event.fParam[0], pTriggerEntityScript);
						}
						else
						{
							m_pScript->CallStateFunction(CurrentState(), m_pThis.get(), ScriptState_OnLeaveArea, pTrgEntityThis, static_cast<i32>(event.nParam[1]), event.fParam[0]);
						}
					}
					...
					if ((pIEntity->GetFlags() & (ENTITY_FLAG_LOCAL_PLAYER | ENTITY_FLAG_CAMERA_SOURCE)) > 0)
					{
						if (pTriggerEntityScript != nullptr)
						{
							m_pScript->CallStateFunction(CurrentState(), m_pThis.get(), ScriptState_OnLocalClientLeaveArea, pTrgEntityThis, static_cast<i32>(event.nParam[1]), event.fParam[0], pTriggerEntityScript);
						}
						else
						{
							m_pScript->CallStateFunction(CurrentState(), m_pThis.get(), ScriptState_OnLocalClientLeaveArea, pTrgEntityThis, static_cast<i32>(event.nParam[1]), event.fParam[0]);
						}
					}

					if ((pIEntity->GetFlagsExtended() & (ENTITY_FLAG_EXTENDED_AUDIO_LISTENER)) > 0)
					{
						m_pScript->CallStateFunction(CurrentState(), m_pThis.get(), ScriptState_OnAudioListenerLeaveArea, pTrgEntityThis, static_cast<i32>(event.nParam[1]), event.fParam[0], event.fParam[1]);
					}
				}
			}
	...
	case ENTITY_EVENT_ENTERNEARAREA:
		{
			if (m_enableSoundAreaEvents)
			{
				...
				if (pIEntity != nullptr)
				{
					...
					if (pTrgEntityThis != nullptr)
					{
						m_pScript->CallStateFunction(CurrentState(), m_pThis.get(), ScriptState_OnEnterNearArea, pTrgEntityThis, static_cast<i32>(event.nParam[1]), event.fParam[0]);
					}

					// allow local player/camera source entities to trigger callback even without that entity having a scripttable
					if ((pIEntity->GetFlags() & (ENTITY_FLAG_LOCAL_PLAYER | ENTITY_FLAG_CAMERA_SOURCE)) > 0)
					{
						m_pScript->CallStateFunction(CurrentState(), m_pThis.get(), ScriptState_OnLocalClientEnterNearArea, pTrgEntityThis, static_cast<i32>(event.nParam[1]), event.fParam[0]);
					}

					if ((pIEntity->GetFlagsExtended() & (ENTITY_FLAG_EXTENDED_AUDIO_LISTENER)) > 0)
					{
						m_pScript->CallStateFunction(CurrentState(), m_pThis.get(), ScriptState_OnAudioListenerEnterNearArea, pTrgEntityThis, static_cast<i32>(event.nParam[1]), event.fParam[0]);
					}
				}
			}
	...
	case ENTITY_EVENT_LEAVENEARAREA:
		{
			if (m_enableSoundAreaEvents)
			{
				...
				if (pIEntity != nullptr)
				{
					...
					if (pTrgEntityThis != nullptr)
					{
						m_pScript->CallStateFunction(CurrentState(), m_pThis.get(), ScriptState_OnLeaveNearArea, pTrgEntityThis, static_cast<i32>(event.nParam[1]), event.fParam[0]);
					}

					// allow local player/camera source entities to trigger callback even without that entity having a scripttable
					if ((pIEntity->GetFlags() & (ENTITY_FLAG_LOCAL_PLAYER | ENTITY_FLAG_CAMERA_SOURCE)) > 0)
					{
						m_pScript->CallStateFunction(CurrentState(), m_pThis.get(), ScriptState_OnLocalClientLeaveNearArea, pTrgEntityThis, static_cast<i32>(event.nParam[1]), event.fParam[0]);
					}

					if ((pIEntity->GetFlagsExtended() & (ENTITY_FLAG_EXTENDED_AUDIO_LISTENER)) > 0)
					{
						m_pScript->CallStateFunction(CurrentState(), m_pThis.get(), ScriptState_OnAudioListenerLeaveNearArea, pTrgEntityThis, static_cast<i32>(event.nParam[1]), event.fParam[0], event.fParam[1]);
					}
				}
			}
	...
	case ENTITY_EVENT_MOVENEARAREA:
		{
			if (m_enableSoundAreaEvents)
			{
				...
				if (pIEntity != nullptr)
				{
					...
					if (pTrgEntityThis != nullptr)
					{
						m_pScript->CallStateFunction(CurrentState(), m_pThis.get(), ScriptState_OnMoveNearArea, pTrgEntityThis, static_cast<i32>(event.nParam[1]), event.fParam[0], event.fParam[1]);
					}

					// allow local player/camera source entities to trigger callback even without that entity having a scripttable
					if ((pIEntity->GetFlags() & (ENTITY_FLAG_LOCAL_PLAYER | ENTITY_FLAG_CAMERA_SOURCE)) > 0)
					{
						m_pScript->CallStateFunction(CurrentState(), m_pThis.get(), ScriptState_OnLocalClientMoveNearArea, pTrgEntityThis, static_cast<i32>(event.nParam[1]), event.fParam[0], event.fParam[1]);
					}

					if ((pIEntity->GetFlagsExtended() & (ENTITY_FLAG_EXTENDED_AUDIO_LISTENER)) > 0)
					{
						m_pScript->CallStateFunction(CurrentState(), m_pThis.get(), ScriptState_OnAudioListenerMoveNearArea, pTrgEntityThis, static_cast<i32>(event.nParam[1]), event.fParam[0]);
					}
				}
			}
	...
	case ENTITY_EVENT_PHYS_BREAK:
		{
			...
			if (pBreakEvent)
			{
				...
				i32 nBreakPartId = pBreakEvent->partid[0];
				i32 nBreakOtherEntityPartId = pBreakEvent->partid[1];
	...
	case ENTITY_EVENT_COLLISION:
		{
			...
			i32k thisEntityIndex = static_cast<i32>(event.nParam[1]);
			i32k otherEntityIndex = (thisEntityIndex + 1) % 2;
...
//////////////////////////////////////////////////////////////////////////
bool CEntityComponentLuaScript::GotoState(tukk sStateName)
{
	i32 nStateId = m_pScript->GetStateId(sStateName);
	if (nStateId >= 0)
	{
		GotoState(nStateId);
	}
...
//////////////////////////////////////////////////////////////////////////
bool CEntityComponentLuaScript::GotoState(i32 stateId)
{
...
//////////////////////////////////////////////////////////////////////////
bool CEntityComponentLuaScript::IsInState(tukk sStateName)
{
	i32 nStateId = m_pScript->GetStateId(sStateName);
	if (nStateId >= 0)
	{
...
//////////////////////////////////////////////////////////////////////////
bool CEntityComponentLuaScript::IsInState(i32 nState)
{
	return nState == m_currentStateId;
}

//////////////////////////////////////////////////////////////////////////
tukk CEntityComponentLuaScript::GetState()
{
	return m_pScript->GetStateName(m_currentStateId);
}

//////////////////////////////////////////////////////////////////////////
i32 CEntityComponentLuaScript::GetStateId()
{
	...
	if (ser.GetSerializationTarget() != eST_Network)
	{
		...
		if (NeedGameSerialize())
		{
			if (ser.BeginOptionalGroup("ScriptProxy", true))
			{
				...
				i32 currStateId = m_currentStateId;
...
//////////////////////////////////////////////////////////////////////////
void CEntityComponentLuaScript::SerializeTable(TSerialize ser, tukk name)
{
	CHECK_SCRIPT_STACK;
...
void CEntityComponentLuaScript::SetEventTargets(XmlNodeRef& eventTargetsNode)
{
	...
	for (i32 i = 0; i < eventTargetsNode->getChildCount(); i++)
	{
...
//////////////////////////////////////////////////////////////////////////
void CEntityComponentLuaScript::CallEvent(tukk sEvent)
{
	m_pScript->CallEvent(m_pThis.get(), sEvent, (bool)true);
}

//////////////////////////////////////////////////////////////////////////
void CEntityComponentLuaScript::CallEvent(tukk sEvent, float fValue)
{
	m_pScript->CallEvent(m_pThis.get(), sEvent, fValue);
}

//////////////////////////////////////////////////////////////////////////
void CEntityComponentLuaScript::CallEvent(tukk sEvent, bool bValue)
{
	m_pScript->CallEvent(m_pThis.get(), sEvent, bValue);
}

//////////////////////////////////////////////////////////////////////////
void CEntityComponentLuaScript::CallEvent(tukk sEvent, tukk sValue)
{
	m_pScript->CallEvent(m_pThis.get(), sEvent, sValue);
}

//////////////////////////////////////////////////////////////////////////
void CEntityComponentLuaScript::CallEvent(tukk sEvent, EntityId nEntityId)
{
...
//////////////////////////////////////////////////////////////////////////
void CEntityComponentLuaScript::CallEvent(tukk sEvent, const Vec3& vValue)
{
...
//////////////////////////////////////////////////////////////////////////
void CEntityComponentLuaScript::OnCollision(CEntity* pTarget, i32 matId, const Vec3& pt, const Vec3& n, const Vec3& vel, const Vec3& targetVel, i32 partId, float mass)
{
	if (CVar::pLogCollisions->GetIVal() != 0)
	{
		...
		if (pTarget)
			...
			s2 = "<Unknown>";
		DrxLogAlways("OnCollision %s (Target: %s)", s1.c_str(), s2.c_str());
	}
		...
		m_hitTable.Create(gEnv->pScriptSystem);
	{
		...
		if (pTarget)
		{
			...
			{
				chain.SetValue("target_type", (i32)pTarget->GetPhysics()->GetType());
			}
			else
			{
...
//////////////////////////////////////////////////////////////////////////
void CEntityComponentLuaScript::SendScriptEvent(i32 Event, IScriptTable* pParamters, bool* pRet)
{
...
//////////////////////////////////////////////////////////////////////////
void CEntityComponentLuaScript::SendScriptEvent(i32 Event, tukk str, bool* pRet)
{
	SScriptState* pState = CurrentState();
	for (i32 i = 0; i < NUM_STATES; i++)
	{
...
//////////////////////////////////////////////////////////////////////////
void CEntityComponentLuaScript::SendScriptEvent(i32 Event, i32 nParam, bool* pRet)
{
	SScriptState* pState = CurrentState();
	for (i32 i = 0; i < NUM_STATES; i++)
	{
...
void CEntityComponentLuaScript::GetMemoryUsage(IDrxSizer* pSizer) const
{
	pSizer->AddObject(this, sizeof(*this));
}

void CEntityComponentLuaScript::SetPhysParams(i32 type, IScriptTable* params)
{
