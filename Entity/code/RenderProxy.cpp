...
inline void CheckIfBBoxValid(const AABB& box, CEntity* pEntity)
{
	...
	if (!_finite(v))
	{
		DrxWarning(VALIDATOR_MODULE_ENTITYSYSTEM, VALIDATOR_WARNING, "BBox contain invalid floating values for Entity: %s", pEntity->GetEntityTextDescription().c_str());
	}
#endif
}
...
//////////////////////////////////////////////////////////////////////////
i32 CEntityRender::AnimEventCallback(ICharacterInstance* pCharacter, uk userdata)
{
...
//////////////////////////////////////////////////////////////////////////
CEntitySlot* CEntityRender::AllocSlot(i32 nIndex)
{
	if (nIndex >= (i32)m_slots.size())
	{
...
//////////////////////////////////////////////////////////////////////////
void CEntityRender::FreeSlot(i32 nIndex)
{
	//	assert(nIndex>=0 && nIndex < (i32)m_slots.size());
	if ((nIndex >= 0 && nIndex < (i32)m_slots.size()) && (m_slots[nIndex] != NULL))
	{
		...
		if (nIndex == m_slots.size() - 1)
		{
			...
			for (i32 i = nIndex; i >= 0 && m_slots[i] == NULL; i--)
				m_slots.pop_back();
		}
		delete pSlot;
...
//////////////////////////////////////////////////////////////////////////
CEntitySlot* CEntityRender::GetOrMakeSlot(i32& nSlot)
{
	if (nSlot < 0)
	{
		// find free slot
...
//////////////////////////////////////////////////////////////////////////
CEntitySlot* CEntityRender::GetParentSlot(i32 nIndex) const
{
...
//////////////////////////////////////////////////////////////////////////
bool CEntityRender::SetParentSlot(i32 nParentIndex, i32 nChildIndex)
{
	// Not implemented
...
//////////////////////////////////////////////////////////////////////////
void CEntityRender::SetSlotLocalTM(i32 nIndex, const Matrix34& localTM, EntityTransformationFlagsMask transformReasons)
{
...
//////////////////////////////////////////////////////////////////////////
void CEntityRender::SetSlotCameraSpacePos(i32 nIndex, const Vec3& cameraSpacePos)
{
	if (IsSlotValid(nIndex))
	{
...
//////////////////////////////////////////////////////////////////////////
void CEntityRender::GetSlotCameraSpacePos(i32 nIndex, Vec3& cameraSpacePos) const
{
	if (IsSlotValid(nIndex))
	{
		CEntitySlot* pSlot = Slot(nIndex);
...
//////////////////////////////////////////////////////////////////////////
Matrix34 CEntityRender::GetSlotWorldTM(i32 nIndex) const
{
	IStatObj* pCompObj;
...
//////////////////////////////////////////////////////////////////////////
Matrix34 CEntityRender::GetSlotLocalTM(i32 nIndex, bool bRelativeToParent) const
{
	IStatObj* pCompObj;
...
void CEntityRender::ProcessEvent(const SEntityEvent& event)
{
	...
	case ENTITY_EVENT_XFORM:
		OnEntityXForm((i32)event.nParam[0]);
		break;
...
//////////////////////////////////////////////////////////////////////////
void CEntityRender::OnEntityXForm(i32 nWhyFlags)
{
...
//////////////////////////////////////////////////////////////////////////
IRenderNode* CEntityRender::GetRenderNode(i32 nSlot) const
{
	if (nSlot >= 0)
	{
...
//////////////////////////////////////////////////////////////////////////
bool CEntityRender::GetSlotInfo(i32 nIndex, SEntitySlotInfo& slotInfo) const
{
	if (!IsSlotValid(nIndex))
		return false;
...
//////////////////////////////////////////////////////////////////////////
void CEntityRender::SetSlotFlags(i32 nSlot, u32 nFlags)
{
	if (nSlot < 0)
	{
		// All slots.
...
//////////////////////////////////////////////////////////////////////////
u32 CEntityRender::GetSlotFlags(i32 nSlot) const
{
	if (IsSlotValid(nSlot))
	{
...
//////////////////////////////////////////////////////////////////////////
void CEntityRender::SetSlotMaterial(i32 nSlot, IMaterial* pMaterial)
{
	if (IsSlotValid(nSlot))
	{
...
//////////////////////////////////////////////////////////////////////////
IMaterial* CEntityRender::GetSlotMaterial(i32 nSlot) const
{
	if (IsSlotValid(nSlot))
	{
...
//////////////////////////////////////////////////////////////////////////
i32 CEntityRender::SetSlotGeometry(i32 nSlot, IStatObj* pStatObj)
{
	IStatObj* pCompObj = 0;
...
//////////////////////////////////////////////////////////////////////////
i32 CEntityRender::LoadGeometry(i32 nSlot, tukk szFilename, tukk szGeomName, i32 nLoadFlags)
{
...
//////////////////////////////////////////////////////////////////////////
i32 CEntityRender::SetSlotCharacter(i32 nSlot, ICharacterInstance* pCharacter)
{
	CEntitySlot* pSlot = GetOrMakeSlot(nSlot);
...
//////////////////////////////////////////////////////////////////////////
i32 CEntityRender::LoadCharacter(i32 nSlot, tukk sFilename, i32 nLoadFlags)
{
	...
	ICharacterInstance* pCharacter = gEnv->pCharacterUpr->CreateInstance(sFilename);

	return SetSlotCharacter(nSlot, pCharacter);
}

//////////////////////////////////////////////////////////////////////////
i32 CEntityRender::SetParticleEmitter(i32 nSlot, IParticleEmitter* pEmitter, bool bSerialize)
{
	assert(pEmitter);
...
i32 CEntityRender::LoadParticleEmitter(i32 nSlot, IParticleEffect* pEffect, SpawnParams const* pParams, bool bPrime, bool bSerialize)
{
	assert(pEffect);
...
//////////////////////////////////////////////////////////////////////////
i32 CEntityRender::LoadLight(i32 nSlot, SRenderLight* pLight, u16 layerId)
{
	assert(pLight);
	CEntitySlot* pSlot = GetOrMakeSlot(nSlot);
...
//////////////////////////////////////////////////////////////////////////
i32 CEntityRender::LoadCloudBlocker(i32 nSlot, const SCloudBlockerProperties& properties)
{
	CEntitySlot* pSlot = GetOrMakeSlot(nSlot);
	...
	DRX_ASSERT(pRenderNode && pRenderNode->GetRenderNodeType() == eERType_CloudBlocker);
...
//////////////////////////////////////////////////////////////////////////
i32 CEntityRender::LoadFogVolume(i32 nSlot, const SFogVolumeProperties& properties)
{
	CEntitySlot* pSlot = GetOrMakeSlot(nSlot);
...
//////////////////////////////////////////////////////////////////////////
i32 CEntityRender::FadeGlobalDensity(i32 nSlot, float fadeTime, float newGlobalDensity)
{
	CEntitySlot* pSlot = GetOrMakeSlot(nSlot);
	IRenderNode* pRenderNode(pSlot->GetRenderNode());
...
//////////////////////////////////////////////////////////////////////////
i32 CEntityRender::LoadGeomCache(i32 nSlot, tukk sFilename)
{
	CEntitySlot* pSlot = GetOrMakeSlot(nSlot);
...
//////////////////////////////////////////////////////////////////////////
ICharacterInstance* CEntityRender::GetCharacter(i32 nSlot)
{
...
//////////////////////////////////////////////////////////////////////////
IStatObj* CEntityRender::GetStatObj(i32 nSlot)
{
	IStatObj* pCompObj;
	if (!(nSlot & ENTITY_SLOT_ACTUAL) && (pCompObj = GetCompoundObj()))
		return (u32)pCompObj->GetSubObjectCount() > (u32)nSlot ?
...
//////////////////////////////////////////////////////////////////////////
IParticleEmitter* CEntityRender::GetParticleEmitter(i32 nSlot)
{
	if (!IsSlotValid(nSlot))
		return NULL;
...
//////////////////////////////////////////////////////////////////////////
i32 CEntityRender::SetSlotRenderNode(i32 nSlot, IRenderNode* pRenderNode)
{
	CEntitySlot* pSlot = GetOrMakeSlot(nSlot);
...
//////////////////////////////////////////////////////////////////////////
IMaterial* CEntityRender::GetRenderMaterial(i32 nSlot) const
{
					...
					for (u32 i = 0; i < m_slots.size(); ++i)
					{
						...
						if (pEmitter && pEmitter->IsAlive())
						{
							if (m_slots[i]->NeedSerialize())
							{
								...
								++nSerSlots;
								ser.Value("slot", i);
								gEnv->pParticleUpr->SerializeEmitter(ser, pEmitter);
								ser.EndGroup();
							}
						}
					}
			...
			else
			{
				...
				if (ser.BeginOptionalGroup("Particles", true))
				{
					...
					for (i32 i = 0; i < nSerSlots; ++i)
					{
						...
						if (nSlot >= 0)
						{
							if (IParticleEmitter* pEmitter = gEnv->pParticleUpr->SerializeEmitter(ser, GetParticleEmitter(i)))
							{
...
#if DEBUG_PARTICLES
	for (i32 i = 0; i < m_slots.size(); ++i)
	{
		IParticleEmitter* pEmitter = GetParticleEmitter(i);
		if (pEmitter && pEmitter->IsAlive())
			DrxWarning(VALIDATOR_MODULE_ENTITYSYSTEM, VALIDATOR_COMMENT,
...
//////////////////////////////////////////////////////////////////////////
i32 CEntityRender::GetSlotCount() const
{
	return m_slots.size();
}
...
//////////////////////////////////////////////////////////////////////////
void CEntityRender::SetSubObjHideMask(i32 nSlot, hidemask nSubObjHideMask)
{
	if (IsSlotValid(nSlot))
	{
...
//////////////////////////////////////////////////////////////////////////
hidemask CEntityRender::GetSubObjHideMask(i32 nSlot) const
{
	if (IsSlotValid(nSlot))
	{
		CEntitySlot* pSlot = Slot(nSlot);
...
{
	const ptrdiff_t offsetFromEntity = Drx::Memory::GetMemberOffset(&CEntity::m_render);
