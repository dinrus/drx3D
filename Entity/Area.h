...
DRX_CREATE_ENUM_FLAG_OPERATORS(EAreaState);
} //endns AreaUpr
} //endns Drx
...
public:
	...
	virtual i32 GetGroup() const override    { return m_areaGroupId; }
	virtual i32 GetPriority() const override { return m_priority; }
	virtual i32 GetID() const override       { return m_areaId; }
	...
	void     Release();
	void     SetID(i32k id)              { m_areaId = id; }
	void     SetEntityID(const EntityId id)   { m_entityId = id; }
	EntityId GetEntityID() const              { return m_entityId; }
	void     SetGroup(i32k id)           { m_areaGroupId = id; }
	void     SetPriority(i32k nPriority) { m_priority = nPriority; }
	...
	void AddConvexHullToSolid(const Vec3* verticesOfConvexHull, bool bObstruction, i32 numberOfVertices);
	...
	Drx::AreaUpr::EAreaState GetState() const                                      { return m_state; }
	void                         AddState(Drx::AreaUpr::EAreaState const state)    { m_state |= state; }
	void                         RemoveState(Drx::AreaUpr::EAreaState const state) { m_state &= ~state; }
...
private:
	...
	Drx::AreaUpr::EAreaState m_state = Drx::AreaUpr::EAreaState::None;
};
