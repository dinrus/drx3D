...
public:
	...
	void                  SetAsLight(const SRenderLight& lightData, u16 layerId = 0);
	...
	void SetParent(i32 parent) { m_parent = parent; };
	//! Get parent slot index
	i32  GetParent() const     { return m_parent; }
...
private:
	...
	u8 m_bNeedSerialize        : 1; //! This slot needs to be serialized on save/load.
	u8 m_bCameraSpacePos       : 1; //! Slot render in camera space (m_cameraSpacePos member variable must be set)
	u8 m_bRegisteredRenderNode : 1; //! RenderNode was registered to the 3D engine.
	u8 m_bPostInit             : 1; //! Post Init was already called.
...
// Custom new/delete.
//////////////////////////////////////////////////////////////////////////
inline uk CEntitySlot::operator new(size_t nSize)
{
	uk ptr = g_Alloc_EntitySlot->Allocate();
	if (ptr)
...
//////////////////////////////////////////////////////////////////////////
inline void CEntitySlot::operator delete(uk ptr)
{
	if (ptr)
