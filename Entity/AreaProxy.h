...
{
	DRX_ENTITY_COMPONENT_CLASS_GUID(CEntityComponentArea, IEntityAreaComponent, "CEntityComponentArea", "feb82854-291c-4aba-9652-ddd7f403f24a"_drx_guid);
...
public:
	...
	//////////////////////////////////////////////////////////////////////////
	virtual void            SetFlags(i32 nAreaProxyFlags) override { m_nFlags = nAreaProxyFlags; }
	virtual i32             GetFlags() override                    { return m_nFlags; }
	...
	virtual void            AddConvexHullToSolid(const Vec3* verticesOfConvexHull, bool bObstruction, i32 numberOfVertices) override;
	virtual void            EndSettingSolid() override;

	virtual i32             GetPointsCount() override                         { return m_localPoints.size(); }
	...
	virtual void            SetGravityVolume(const Vec3* pPoints, i32 nNumPoints, float fRadius, float fGravity, bool bDontDisableInvisible, float fFalloff, float fDamping) override;

	virtual void            SetID(i32k id) override              { m_pArea->SetID(id); }
	virtual i32             GetID() const override                    { return m_pArea->GetID(); }
	virtual void            SetGroup(i32k id) override           { m_pArea->SetGroup(id); }
	virtual i32             GetGroup() const override                 { return m_pArea->GetGroup(); }
	virtual void            SetPriority(i32k nPriority) override { m_pArea->SetPriority(nPriority); }
	virtual i32             GetPriority() const override              { return m_pArea->GetPriority(); }
...
private:
	...
	void ReadPolygonsForAreaSolid(CDrxFile& file, i32 numberOfPolygons, bool bObstruction);
