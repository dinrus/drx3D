#ifndef DRX3D_SOFT_MULTIBODY_DYNAMICS_WORLD_H
#define DRX3D_SOFT_MULTIBODY_DYNAMICS_WORLD_H
...
class SoftMultiBodyDynamicsWorld : public MultiBodyDynamicsWorld
{
...
public:
	SoftMultiBodyDynamicsWorld(Dispatcher* dispatcher, BroadphaseInterface* pairCache, MultiBodyConstraintSolver* constraintSolver, CollisionConfiguration* collisionConfiguration, SoftBodySolver* softBodySolver = 0);

	virtual ~SoftMultiBodyDynamicsWorld();
	...
	{
		return DRX3D_SOFT_MULTIBODY_DYNAMICS_WORLD;
	}
...
#endif  //DRX3D_SOFT_MULTIBODY_DYNAMICS_WORLD_H
