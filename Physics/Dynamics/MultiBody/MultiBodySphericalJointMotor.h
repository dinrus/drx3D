#ifndef DRX3D_MULTIBODY_SPHERICAL_JOINT_MOTOR_H
#define DRX3D_MULTIBODY_SPHERICAL_JOINT_MOTOR_H

#include <drx3D/Physics/Dynamics/MultiBody/MultiBodyConstraint.h>
struct SolverInfo;

class MultiBodySphericalJointMotor : public MultiBodyConstraint
{
protected:
...
public:
	MultiBodySphericalJointMotor(MultiBody* body, i32 link, Scalar maxMotorImpulse);
	
	virtual ~MultiBodySphericalJointMotor();
...
#endif  //DRX3D_MULTIBODY_SPHERICAL_JOINT_MOTOR_H
