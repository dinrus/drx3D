...
{
/// minimal "tree" (chain)
SimpleTreeCreator::SimpleTreeCreator(i32 dim) : m_num_bodies(dim)
{
	m_mass = 1.0;
...
i32 SimpleTreeCreator::getNumBodies(i32* num_bodies) const
{
	*num_bodies = m_num_bodies;
	return 0;
}

i32 SimpleTreeCreator::getBody(i32k body_index, i32* parent_index, JointType* joint_type,
