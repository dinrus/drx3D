...
#include "../CoilCreator.h"

namespace drx3d_inverse
{
CoilCreator::CoilCreator(i32 n) : m_num_bodies(n), m_parent(n)
{
	...
	const idScalar alpha_DH = 5.0 * DRX3D_ID_PI / m_num_bodies;
	...
	m_body_I_body(1, 1) = (3e-4 + 4.0 / DRX3D_ID_POW(m_num_bodies, 2)) / (12.0 * m_num_bodies);
...
i32 CoilCreator::getNumBodies(i32* num_bodies) const
{
	*num_bodies = m_num_bodies;
	return 0;
}

i32 CoilCreator::getBody(i32 body_index, i32* parent_index, JointType* joint_type,
