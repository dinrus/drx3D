#ifndef D3_REDUCE_CONTACTS_H
#define D3_REDUCE_CONTACTS_H

inline i32 b3ReduceContacts(const b3Float4* p, i32 nPoints, const b3Float4& nearNormal, b3Int4* contactIdx)
{
	if (nPoints == 0)
		return 0;
