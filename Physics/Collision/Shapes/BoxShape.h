#ifndef DRX3D_OBB_BOX_MINKOWSKI_H
#define DRX3D_OBB_BOX_MINKOWSKI_H
...
///The BoxShape is a box primitive around the origin, its sides axis aligned with length specified by half extents, in local shape coordinates. When used as part of a CollisionObject2 or RigidBody it will be an oriented box in world space.
ATTRIBUTE_ALIGNED16(class)
BoxShape : public PolyhedralConvexShape
{
...
public:
	...
	BoxShape(const Vec3& boxHalfExtents);
...
#endif  //DRX3D_OBB_BOX_MINKOWSKI_H
