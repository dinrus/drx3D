...
public:
	...
	inline i32 operator()(const T& a, const Z& b)
	{
...
{
public:
	inline i32 operator()(const GIM_RSORT_TOKEN& a, const GIM_RSORT_TOKEN& b)
	{
...
void gim_down_heap(T* pArr, GUINT k, GUINT n, COMP_CLASS CompareFunc)
{
	...
	while (k <= n / 2)
	{
		...
		if ((child < (i32)n) && CompareFunc(pArr[child - 1], pArr[child]) < 0)
		{
			child++;
		}
		/* pick larger child */
