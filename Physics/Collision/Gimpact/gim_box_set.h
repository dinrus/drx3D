...
#include <drx3D/Physics/Collision/Gimpact/gim_pair.h>
...
public:
	...
	SIMD_FORCE_INLINE bool boxQueryTrans(const GIM_AABB& box,
										 const Transform2& transform, gim_array<GUINT>& collided_results) const
	{
...
public:
	void find_collision(BOX_SET_CLASS0* boxset1, const Transform2& trans1,
						BOX_SET_CLASS1* boxset2, const Transform2& trans2,
