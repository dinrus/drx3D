...
IToolWindowDragHandler::SplitSizes QToolWindowDragHandlerNinePatch::getSplitSizes(i32 originalSize) const
{
...
QRect tabSeparatorRect(QRect tabRect, i32 splitterWidth)
{
...
{
	i32 splitterWidth = area->getWidget()->style()->pixelMetric(QStyle::PM_SplitterWidth, 0, area->getWidget());
