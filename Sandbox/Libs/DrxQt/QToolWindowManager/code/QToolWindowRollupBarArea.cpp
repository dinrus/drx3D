	...
	m_areaDraggable(true)
{
	...
	connect(this, SIGNAL(RollupCloseRequested(i32)), this, SLOT(closeRollup(i32)));
...
void QToolWindowRollupBarArea::addToolWindow(QWidget* toolWindow, i32 index /*= -1*/)
{
	addToolWindows(QList<QWidget*>() << toolWindow, index);
}

void QToolWindowRollupBarArea::addToolWindows(const QList<QWidget*>& toolWindows, i32 index /*= -1*/)
{
...
void QToolWindowRollupBarArea::restoreState(const QVariantMap &data, i32 stateFormat)
{
...
i32 QToolWindowRollupBarArea::indexOf(QWidget* w) const
{
...
QRect QToolWindowRollupBarArea::combineSubWidgetRect(i32 index) const 
{
...
i32 QToolWindowRollupBarArea::subWidgetAt(const QPoint& pos) const 
{	
...
void QToolWindowRollupBarArea::closeRollup(i32 index)
{
