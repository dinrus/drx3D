...
public:
	...
	QToolWindowAreaReference(i32 t) : type((eType)t) { }
...
struct QTOOLWINDOWMANAGER_EXPORT QToolWindowAreaTarget
{
	...
	QToolWindowAreaTarget(QToolWindowAreaReference::eType reference, i32 index = -1, QRect geometry = QRect()) : area(nullptr), reference(reference), index(index), geometry(geometry) {};
	QToolWindowAreaTarget(IToolWindowArea* area, QToolWindowAreaReference::eType reference, i32 index = -1, QRect geometry = QRect()) : area(area), reference(reference), index(index), geometry(geometry) {};
};
...
public:
	...
	void addToolWindow(QWidget* toolWindow, IToolWindowArea* area = nullptr, QToolWindowAreaReference::eType reference = QToolWindowAreaReference::Combine, i32 index = -1, QRect geometry = QRect());
	...
	void addToolWindows(const QList<QWidget*>& toolWindows, IToolWindowArea* area, QToolWindowAreaReference::eType reference = QToolWindowAreaReference::Combine, i32 index = -1, QRect geometry = QRect());
	
	void moveToolWindow(QWidget* toolWindow, const QToolWindowAreaTarget& target, const QTWMToolType toolType = ttStandard);
	void moveToolWindow(QWidget* toolWindow, IToolWindowArea* area, QToolWindowAreaReference::eType reference = QToolWindowAreaReference::Combine, i32 index = -1, QRect geometry = QRect());
	...
	void moveToolWindows(const QList<QWidget*>& toolWindows, IToolWindowArea* area, QToolWindowAreaReference::eType reference = QToolWindowAreaReference::Combine, i32 index = -1, QRect geometry = QRect());
	...
	IToolWindowWrapper* restoreWrapperState(const QVariantMap& data, i32 stateFormat, IToolWindowWrapper* wrapper = nullptr);
	QVariantMap saveSplitterState(QSplitter* splitter);
	QSplitter* restoreSplitterState(const QVariantMap& data, i32 stateFormat);
	...
	void resizeSplitter(QWidget* widget, QList<i32> sizes);
