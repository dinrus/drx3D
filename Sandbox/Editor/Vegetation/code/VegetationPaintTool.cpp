...
class CVegetationPaintTool_ClassDesc : public IClassDesc
{
	...
	virtual tukk ClassName() { return "EditTool.VegetationPaint"; };
...
void CVegetationPaintTool::OnLButtonDown(CViewport* pView, i32 flags, const CPoint& point)
{
...
//////////////////////////////////////////////////////////////////////////
void CVegetationPaintTool::OnMouseMove(CViewport* pView, i32 flags, const CPoint& point)
{
	if (flags & MK_LBUTTON)
	{
		if (flags & MK_ALT)
...
//////////////////////////////////////////////////////////////////////////
bool CVegetationPaintTool::MouseCallback(CViewport* pView, EMouseEvent event, CPoint& point, i32 flags)
{
...
//////////////////////////////////////////////////////////////////////////
bool CVegetationPaintTool::OnKeyDown(CViewport* pView, u32 key, u32 repCnt, u32 flags)
{
...
//////////////////////////////////////////////////////////////////////////
bool CVegetationPaintTool::OnKeyUp(CViewport* pView, u32 key, u32 repCnt, u32 flags)
{
	bool processed = false;
	if (key == Qt::Key_Shift)
	{
