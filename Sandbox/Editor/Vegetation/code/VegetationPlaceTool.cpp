...
class CVegetationPlaceTool_ClassDesc : public IClassDesc
{
	...
	virtual tukk ClassName() { return "EditTool.VegetationPlace"; };
...
i32 CVegetationPlaceTool::ObjectMouseCallback(CViewport* pView, EMouseEvent eventId, const CPoint& point, u32 flags)
{
