...
void CRuler::Update()
{
	...
	if (pActiveView)
	{
		...
		{
			DRX_ASSERT(!m_startPoint.IsEmpty());
...
//////////////////////////////////////////////////////////////////////////
bool CRuler::MouseCallback(CViewport* pView, EMouseEvent event, CPoint& point, i32 flags)
{
...
//////////////////////////////////////////////////////////////////////////
void CRuler::OnMouseMove(CViewport* pView, CPoint& point, i32 flags)
{
	DrxGUID hitGUID = DrxGUID::Null();
...
//////////////////////////////////////////////////////////////////////////
void CRuler::OnLButtonUp(CViewport* pView, CPoint& point, i32 flags)
{
	if (m_startPoint.IsEmpty())
	{
...
//////////////////////////////////////////////////////////////////////////
void CRuler::OnMButtonUp(CViewport* pView, CPoint& point, i32 flags)
{
	if (m_startPoint.IsEmpty())
	{
		UpdateRulerPoint(pView, point, m_startPoint, false);
...
//////////////////////////////////////////////////////////////////////////
void CRuler::OnRButtonUp(CViewport* pView, CPoint& point, i32 flags)
{
	/*m_startPoint.Reset();
	   m_endPoint.Reset();*/
}
