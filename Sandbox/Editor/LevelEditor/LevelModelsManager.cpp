...
static CItemModelAttribute* FullLevel_GetColumnAttribute(i32 column)
{
	switch (column)
	{
...
static QVariant FullLevel_GetHeaderData(i32 section, Qt::Orientation orientation, i32 role)
{
	...
	if (role == Qt::DecorationRole)
	{
		...
		if (section == eFullLevelColumns_Frozen)
			return DrxIcon("icons:General/editable.ico");
	}
...
} //endns CLevelModelsManager_Private
