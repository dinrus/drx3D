...
// This is a stub class that is meant to encapsulate all editor logic for the level editor that is currently in DrxEdit.
// Ultimately the level editor will be just another window and all its logic should be encapsulated, while DrxEdit should retain global functionnality
...
public:
	...
	virtual tukk GetEditorName() const override { return "Level Editor"; }
	...
	bool ConvertEditorXmlToLevelAssetType(const string& levelFolder, tukk const szName) const;
...
private:
	...
	void SaveDrxassetFile(const string& levelPath);
