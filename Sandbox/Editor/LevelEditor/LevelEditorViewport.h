...
public:
	...
	bool		DragEvent(EDragEvent eventId, QEvent* event, i32 flags) override;
	...
	bool		MouseCallback(EMouseEvent event, CPoint& point, i32 flags) override;
private:
	...
	bool AssetDragCreate(EDragEvent eventId, QEvent* event, i32 flags);
