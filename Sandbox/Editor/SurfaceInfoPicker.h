...
public:
	...
	void SetPickOptionFlag(i32 nFlag) { m_PickOption = nFlag; }
...
public:
	...
	bool           PickByAABB(const CPoint& point, i32 nFlag = ePOG_All, IDisplayViewport* pView = NULL, CExcludedObjects* pExcludedObjects = NULL, std::vector<CBaseObjectPtr>* pOutObjects = NULL);
...
private:
	...
	void FindNearestInfoFromSolids(i32 nFlag,
	                               const Vec3& vWorldRaySrc,
	                               const Vec3& vWorldRayDir,
	                               IMaterial** ppOutLastMaterial,
	                               SRayHitInfo& outHitInfo) const;
