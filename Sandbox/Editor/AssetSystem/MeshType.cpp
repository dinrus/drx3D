...
DrxIcon CMeshType::GetIconInternal() const
{
	return DrxIcon("icons:common/assets_mesh.ico");
}
...
bool CMeshType::MoveAsset(CAsset* pAsset, tukk szNewPath, bool bMoveSourcefile) const
{
...
void CMeshType::GenerateThumbnail(const CAsset* pAsset) const
{
	...
	tukk meshFileName = pAsset->GetFile(0);
