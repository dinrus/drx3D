...
static tukk const s_szRootTag = "rootTag";

struct SXmlType
{
	tukk const m_szXmlTag;
	tukk const m_szXmlType;
...
static const SXmlType* GetXmlTypeFromXmlTag(tukk szTag)
{
...
} //endns Private_LegacyAssetTypes
