...
#include <DrxParticleSystem/ParticleParams.h>
...
#include <DrxParticleSystem/ParticleParams_TypeInfo.h>
...
private:
	...
	//////////////////////////////////////////////////////////////////////////
	CVariableArray* AddGroup(tukk sName)
	{
...
BOOL CParticleDialog::OnInitDialog()
{
	...
	i32 HSplitter = AfxGetApp()->GetProfileInt("Dialogs\\Particles", "HSplitter", 200);
	i32 VSplitter = AfxGetApp()->GetProfileInt("Dialogs\\Particles", "VSplitter", 200);
...
//////////////////////////////////////////////////////////////////////////
void CParticleDialog::OnSize(UINT nType, i32 cx, i32 cy)
{
...
HTREEITEM CParticleDialog::InsertItemToTree(CBaseLibraryItem* pItem, HTREEITEM hParent)
{
	...
	for (i32 i = 0; i < pParticles->GetChildCount(); i++)
	{
...
bool CParticleDialog::AddItem(bool bFromParent)
{
	...
	{
		Warning("Item with name %s already exists", (tukk)fullName);
		return false;
	}
...
void CParticleDialog::UpdateItemState(CParticleItem* pItem, bool bRecursive)
{
	...
	if (hItem)
	{
		...
		static i32 nIconStates[4] = { 6, 7, 4, 5 };
		i32 nIconState = nIconStates[pItem->GetEnabledState() & 3];
...
//////////////////////////////////////////////////////////////////////////
dll_string ParticleResourceSelector(const SResourceSelectorContext& x, tukk szPreviousValue)
{
	if (x.useLegacyPicker)
	{
		std::vector<CString> items;
		tukk openLibraryText = "[ Open Particle Database (might crash with empty DB!) ]";
...
dll_string ParticleAssetSelector(const SResourceSelectorContext& context, tukk szPreviousValue)
{
	return SStaticAssetSelectorEntry::SelectFromAsset(context, { "Particles" }, szPreviousValue);
}

dll_string ParticleSelector(const SResourceSelectorContext& context, tukk szPreviousValue)
{
...
dll_string ValidateParticlePath(const SResourceSelectorContext& context, tukk szNewValue, tukk szPreviousValue)
{
...
void EditParticle(const SResourceSelectorContext& context, tukk szAssetPath)
{
