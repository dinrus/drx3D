...
u32k OCCMAP_DOWNSCALE_FACTOR = 1;   // occlusionmap resolution factor to the diffuse texture, can be 1, 2, or 4
...
public:
	...
	bool GenerateSurfaceTexture(i32 flags, CImageEx& surfaceTexture);
