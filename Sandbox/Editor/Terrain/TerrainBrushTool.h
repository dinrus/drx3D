...
public:
	...
	virtual void SetUserData(tukk key, uk userData) { m_pBrush = (CTerrainBrush*)userData; }
...
protected:
	...
	virtual void   PaintTerrain(CHeightmap* pHeightmap, i32 tx, i32 ty, i32 tsize, float fInsideRadius, float brushSpeed) {}
...
public:
	...
	virtual void   PaintTerrain(CHeightmap* pHeightmap, i32 tx, i32 ty, i32 tsize, float fInsideRadius, float brushSpeed) override;
...
public:
	...
	virtual bool   OnKeyUp(CViewport* view, u32 key, u32 nRepCnt, u32 nFlags) override;
