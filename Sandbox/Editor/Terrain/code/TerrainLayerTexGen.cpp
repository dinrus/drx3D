...
//////////////////////////////////////////////////////////////////////////
CTerrainLayerTexGen::CTerrainLayerTexGen(i32k resolution)
{
	m_bLog = true;
	m_waterLayer = NULL;
...
//////////////////////////////////////////////////////////////////////////
void CTerrainLayerTexGen::Init(i32k resolution)
{
	i32 i;
...
////////////////////////////////////////////////////////////////////////
bool CTerrainLayerTexGen::GenerateSectorTexture(CPoint sector, const CRect& rect, i32 flags, CImageEx& surfaceTexture)
{
	// set flags.
	...
	i32 sectorFlags = texsectorInfo.m_Flags;
	...
	else
	{
		...
		for (i = 0; i < (i32)numLayers; i++)
		{
			...
			u32* pTex = surfaceTexture.GetData();

			u32 layerWidth = pLayer->GetTextureWidth();
			u32 layerHeight = pLayer->GetTextureHeight();
			...
			if (bFirstLayer)
			{
				...
				for (i32 y = layerRc.top; y < layerRc.bottom; y++)
				{
					u32 layerY = y & (layerHeight - 1);
					for (i32 x = layerRc.left; x < layerRc.right; x++)
					{
						u32 layerX = x & (layerWidth - 1);
...
//////////////////////////////////////////////////////////////////////////
void CTerrainLayerTexGen::Log(tukk format, ...)
{
	if (!m_bLog)
		return;
...
//////////////////////////////////////////////////////////////////////////
i32 CTerrainLayerTexGen::GetSectorFlags(CPoint sector)
{
...
//////////////////////////////////////////////////////////////////////////
void CTerrainLayerTexGen::SetSectorFlags(CPoint sector, i32 flags)
{
	assert(sector.x >= 0 && sector.x < m_numSectors && sector.y >= 0 && sector.y < m_numSectors);
...
//////////////////////////////////////////////////////////////////////////
i32 CTerrainLayerTexGen::GetLayerCount() const
{
	return m_layers.size();
}

//////////////////////////////////////////////////////////////////////////
CLayer* CTerrainLayerTexGen::GetLayer(i32 index) const
{
