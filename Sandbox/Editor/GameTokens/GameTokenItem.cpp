...
#include <DrxGame/IGameTokens.h>

class CFlowDataReadVisitorEditor
{
public:
	CFlowDataReadVisitorEditor(tukk data) : m_data(data), m_ok(false) {}
...
//////////////////////////////////////////////////////////////////////////
inline bool SetFlowDataFromString(TFlowInputData& value, tukk str)
{
...
void CGameTokenItem::Serialize(SerializeContext& ctx)
{
	...
	if (ctx.bLoading)
	{
		tukk sTypeName = node->getAttr("Type");
		tukk sDefaultValue = node->getAttr("Value");
	...
	else
	{
		...
		// Saving.
		tukk sTypeName = FlowTypeToName((EFlowDataTypes)m_value.GetType());
		if (*sTypeName != 0)
...
{
	return (tukk)ConvertFlowDataToString(m_value);
}

//////////////////////////////////////////////////////////////////////////
void CGameTokenItem::SetValueString(tukk sValue)
{
...
//////////////////////////////////////////////////////////////////////////
bool CGameTokenItem::SetTypeName(tukk typeName)
{
	...
	{
	case eFDT_Int:
		m_value = TFlowInputData((i32)0, true);
		break;
	case eFDT_Float:
