...
void CDragNDropListBox::DrawLine(i32 idx, bool isActiveLine)
{
...
void CDragNDropListBox::UpdateSelection(i32 hoverIdx)
{
...
void CDragNDropListBox::OnDrop(i32 curIdx, i32 newIdx)
{
	if (m_dropCb)
	{
...
void CDragNDropListBox::OnLButtonDown(UINT nFlags, CPoint point)
{
	...
	BOOL bOutside;
	i32 idx = ItemFromPoint(point, bOutside);
