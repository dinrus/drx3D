...
protected:
	...
	afx_msg i32             OnCreateControl(LPCREATECONTROLSTRUCT lpCreateControl);
	...
	void ProcessMenu(i32 nMenuOption, TDTreeItems& rchSelectedItems);

	bool CreateBreakpointContextMenu(CMenu& roMenu, HTREEITEM hItem);
	void ProcessBreakpointMenu(i32 nMenuOption, HTREEITEM hItem);
...
private:
	...
	u32                            m_componentsViewMask; //! which node categories (EFLN_DEBUG, EFLN_ADVANCED..) should be displayed.
