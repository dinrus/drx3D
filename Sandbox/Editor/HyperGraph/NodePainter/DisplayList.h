...
public:
	...
	CDisplayElem* SetHitEvent(i32 event) { m_event = event; return this; }
	i32           GetHitEvent() const    { return m_event; }
...
public:
	...
	CDisplayRectangle* SetHitEvent(i32 event)                      { CDisplayElem::SetHitEvent(event); return this; }
...
public:
	...
	CDisplayGradientRectangle* SetHitEvent(i32 event)                        { CDisplayElem::SetHitEvent(event); return this; }
...
public:
	...
	virtual CDisplayEllipse* SetHitEvent(i32 event)                      { CDisplayElem::SetHitEvent(event); return this; }
...
public:
	...
	CDisplayTracepoint* SetHitEvent(i32 event)                      { CDisplayElem::SetHitEvent(event); return this; }
...
public:
	...
	CDisplayPortArrow* SetHitEvent(i32 event)                      { CDisplayElem::SetHitEvent(event); return this; }
...
public:
	...
	CDisplayMinimizeArrow* SetHitEvent(i32 event)                      { CDisplayElem::SetHitEvent(event); return this; }
...
public:
	...
	CDisplayString* SetHitEvent(i32 event)                          { CDisplayElem::SetHitEvent(event); return this; }
...
public:
	...
	CDisplayLine* SetHitEvent(i32 event)                                                { CDisplayElem::SetHitEvent(event); return this; }
...
public:
	...
	void SetAttachRect(i32 id, Gdiplus::RectF attach)
	{
		m_attachRects[id] = attach;
	}
	bool GetAttachRect(i32 id, Gdiplus::RectF* pAttach) const
	{
		std::map<i32, Gdiplus::RectF>::const_iterator iter = m_attachRects.find(id);
...
private:
	...
	std::map<i32, Gdiplus::RectF> m_attachRects;
