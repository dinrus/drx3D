...
public:
	...
	virtual void UpdateNodePrototypeWithoutReload(tukk nodeClassName) override;

	virtual CHyperNode*  CreateNode(CHyperGraph* pGraph, tukk sNodeClass, HyperNodeID nodeId, const Gdiplus::PointF& pos, CBaseObject* pObj = nullptr, bool bAllowMissing = false) override;
	...
	CHyperFlowGraph* CreateGraphForEntity(CEntityObject* pEntity, tukk sGroupName = "");
	...
	CHyperFlowGraph* FindGraphByName(tukk flowGraphName);
...
private:
	...
	IVariable* MakeInVar(const SInputPortConfig* pConfig, u32 portId, CFlowNode* pFlowNode);
	IVariable* MakeSimpleVarFromFlowType(i32 type);
