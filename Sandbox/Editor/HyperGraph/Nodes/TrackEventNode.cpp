...
void CTrackEventNode::Serialize(XmlNodeRef& node, bool bLoading, CObjectArchive* ar)
{
	...
	if (bLoading)
	{
		...
		{
			string eventName;
			for (i32 i = 0; i < outputs->getChildCount(); i++)
			{
	...
	else
	{
		...
		if (NULL != m_pSequence)
		{
			...
			i32k iCount = m_pSequence->GetTrackEventsCount();
...
CString CTrackEventNode::GetTitle() const
{
	...
	if (!m_inputs.empty())
	{
		...
		IAnimSequence* pSeq = GetIEditorImpl()->GetMovieSystem()->FindSequenceById((u32)id);
		if (pSeq)
			value = pSeq->GetName();
		else
...
////////////////////////////////////////////////////////////////////////////
tukk CTrackEventNode::GetClassName() const
{
	return TRACKEVENTNODE_CLASS;
}

////////////////////////////////////////////////////////////////////////////
tukk CTrackEventNode::GetDescription() const
{
...
void CTrackEventNode::PopulateOutput(bool bLoading)
{
	...
	CString sequence;
	m_inputs[kSequenceId].pVar->Get(id);
	m_pSequence = GetIEditorImpl()->GetMovieSystem()->FindSequenceById((u32)id);
	if (m_pSequence == NULL)
	{
...
////////////////////////////////////////////////////////////////////////////
void CTrackEventNode::AddOutputEvent(tukk event)
{
	CString desc;
...
////////////////////////////////////////////////////////////////////////////
void CTrackEventNode::RemoveOutputEvent(tukk event)
{
	// Find it
...
////////////////////////////////////////////////////////////////////////////
void CTrackEventNode::RenameOutputEvent(tukk event, tukk newName)
{
...
////////////////////////////////////////////////////////////////////////////
void CTrackEventNode::MoveUpOutputEvent(tukk event)
{
...
////////////////////////////////////////////////////////////////////////////
void CTrackEventNode::MoveDownOutputEvent(tukk event)
{
	for (size_t i = 0; i < m_outputs.size(); ++i)
	{
		if (strcmp(m_outputs[i].GetName(), event) == 0)
...
////////////////////////////////////////////////////////////////////////////
void CTrackEventNode::OnTrackEvent(IAnimSequence* pSequence, i32 reason, tukk event, uk pUserData)
{
	switch (reason)
	{
	...
	case ITrackEventListener::eTrackEventReason_Renamed:
		{
			tukk newName = reinterpret_cast<tukk >(pUserData);
