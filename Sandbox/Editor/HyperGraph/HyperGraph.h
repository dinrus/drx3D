...
public:
	...
	i32                 cornerModified;
	i32                 debugCount;                 // counts all debug events including initialization
	i32                 debugCountInitialization;   // counts only initialization phase events
	bool                isInInitializationPhase;

	//////////////////////////////////////////////////////////////////////////
	u16 nPortIn;  // Index of input port.
	u16 nPortOut; // Index of output port.
	//////////////////////////////////////////////////////////////////////////
...
public:
	...
	virtual IHyperNode*            CreateNode(tukk sNodeClass, Gdiplus::PointF& pos = Gdiplus::PointF(0.0f, 0.0f));
	...
	virtual bool                   Save(tukk filename);
	virtual bool                   Load(tukk filename);
	virtual bool                   Migrate(XmlNodeRef& node);
	virtual bool                   Import(tukk filename);
	virtual tukk            GetName() const            { return m_name; };
	virtual void                   SetName(tukk sName) { m_name = sName; if (m_name.IsEmpty()) m_filename.Empty(); };
	...
	i32            GetMissingNodesCount() const;
	i32            GetMissingPortsCount() const;
