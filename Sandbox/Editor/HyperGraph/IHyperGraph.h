...
struct IHyperGraph : public _i_reference_target_t
{
	...
	virtual IHyperNode*            CreateNode(tukk sNodeClass, Gdiplus::PointF& pos = Gdiplus::PointF(0.0f, 0.0f)) = 0;
	...
	virtual bool                   Save(tukk filename) = 0;
	virtual bool                   Load(tukk filename) = 0;
