...
public:
	...
	tukk GetName()      { return pVar->GetName(); }
	tukk GetHumanName() { return pVar->GetHumanName(); }
};
...
public:
	...
	virtual tukk  GetName() const override { return m_name; };
	virtual void         SetName(tukk sName) override;
	//////////////////////////////////////////////////////////////////////////

	virtual tukk            GetClassName() const   { return m_classname; };
	virtual tukk            GetDescription() const { return "No description available."; }
	virtual tukk            GetInfoAsString() const;
	...
	virtual void                   DebugPortActivation(TFlowPortId port, tukk value, bool bIsInitializationStep) {}
	...
	void SetFlag(u32 nFlag, bool bSet) { if (bSet) m_nFlags |= nFlag; else m_nFlags &= ~nFlag; }
	bool CheckFlag(u32 nFlag) const    { return ((m_nFlags & nFlag) == nFlag); }
	...
	virtual CHyperNodePort* FindPort(i32 idx, bool bInput);

	CHyperNodePort*         CreateMissingPort(tukk portname, bool bInput, bool bAttribute = false);
	i32                     GetMissingPortCount() const { return m_iMissingPort; }
	...
	virtual i32                   GetDrawPriority()                                         { return m_drawPriority; }
	...
	void         SelectInputPort(i32 nPort, bool bSelected);
	void         SelectOutputPort(i32 nPort, bool bSelected);
	...
	virtual i32  GetCustomSelectionMode() { return -1; }

	//////////////////////////////////////////////////////////////////////////
	// Context Menu processing.
	//////////////////////////////////////////////////////////////////////////
	virtual void PopulateContextMenu(CMenu& menu, i32 baseCommandId);
	virtual void OnContextMenuCommand(i32 nCmd);
	...
	bool               GetAttachRect(i32 i, Gdiplus::RectF* pRect)
	{
	...
	virtual i32 GetObjectAt(Gdiplus::Graphics* pGr, Gdiplus::PointF point)
	{
		...
		i32 obj = m_dispList.GetObjectAt(point - GetPos());
	...
	i32         GetDebugCount() const { return m_debugCount; }
