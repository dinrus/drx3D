...
{
public:
	CHyperFlowGraph(CHyperGraphManager* pManager, tukk sGroupName = "", CEntityObject* pEntity = nullptr);
	...
	virtual bool OnFlowNodeActivation(IFlowGraphPtr pFlowGraph, TFlowNodeId srcNode, TFlowPortId srcPort, TFlowNodeId toNode, TFlowPortId toPort, tukk value);
	// ~SFlowNodeActivationListener
