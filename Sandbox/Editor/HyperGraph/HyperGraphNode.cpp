...
static const WCHAR* CvtStr(CString& str)
{
	...
	i32 nLen = MultiByteToWideChar(CP_ACP, 0, str.GetBuffer(), -1, NULL, NULL);
	assert(nLen < MAX_BUF);
...
protected:
	virtual tukk GetDescription() { return "HyperNodeUndo"; };
...
//////////////////////////////////////////////////////////////////////////
void CHyperNode::SetName(tukk sName)
{
	m_name = sName;
	if (m_pGraph)
...
tukk CHyperNode::GetInfoAsString() const
{
	string sNodeInfo;
...
CString CHyperNode::VarToValue(IVariable* var)
{
	...
	else if (var->GetDataType() == IVariable::DT_SEQUENCE_ID)
	{
		...
		IAnimSequence* pSeq = GetIEditorImpl()->GetMovieSystem()->FindSequenceById((u32)atoi(value));
		if (pSeq)
			return pSeq->GetName();
	}
...
//////////////////////////////////////////////////////////////////////////
CHyperNodePort* CHyperNode::FindPort(tukk portname, bool bInput)
{
	if (bInput)
	{
	...
	{
		for (i32 i = 0; i < m_outputs.size(); i++)
		{
...
CHyperNodePort* CHyperNode::FindPort(i32 idx, bool bInput)
{
	if (bInput)
	{
...
//////////////////////////////////////////////////////////////////////////
CHyperNodePort* CHyperNode::CreateMissingPort(tukk portname, bool bInput, bool bAttribute)
{
			...
			if (portsNode)
			{
				for (i32 i = 0; i < m_inputs.size(); i++)
				{
					...
					if (ar && pVar->GetDataType() == IVariable::DT_SEQUENCE_ID)
					{
						...
						i32 seqId = 0;
						pVar->Get(seqId);
						pVar->Set((i32)ar->RemapSequenceId((u32)seqId));
					}
				...
				/*
				        for (i32 i = 0; i < portsNode->getChildCount(); i++)
				        {
...
//////////////////////////////////////////////////////////////////////////
void CHyperNode::PopulateContextMenu(CMenu& menu, i32 baseCommandId)
{
}

//////////////////////////////////////////////////////////////////////////
void CHyperNode::OnContextMenuCommand(i32 nCmd)
{
}
...
//////////////////////////////////////////////////////////////////////////
void CHyperNode::SelectInputPort(i32 nPort, bool bSelected)
{
...
//////////////////////////////////////////////////////////////////////////
void CHyperNode::SelectOutputPort(i32 nPort, bool bSelected)
{
