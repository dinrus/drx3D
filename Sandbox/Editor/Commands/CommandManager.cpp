...
bool CEditorCommandManager::UnregisterCommand(tukk cmdFullName)
{
...
const CCommandModuleDescription* CEditorCommandManager::GetCommandModuleDescription(tukk moduleName)
{
...
CCommand* CEditorCommandManager::GetCommand(tukk cmdFullName) const
{
...
bool CEditorCommandManager::IsRegistered(tukk module, tukk name) const
{
	string fullName = GetFullCommandName(module, name);
...
bool CEditorCommandManager::IsRegistered(tukk cmdLine_) const
{
...
QCommandAction* CEditorCommandManager::GetCommandAction(string command, tukk text) const
{
	...
	DrxLog("Command not found: %s", command.c_str());
...
void CEditorCommandManager::RegisterAction(QCommandAction* action, const string& command)
{
	...
	else
	{
		...
		DrxWarning(VALIDATOR_MODULE_EDITOR, VALIDATOR_WARNING, "Command \'%s\' is not registered.", command.c_str());
	}
}

void CEditorCommandManager::ResetShortcut(tukk commandFullName)
{
...
void CEditorCommandManager::SetUiDescription(tukk module, tukk name, const CUiCommand::UiInfo& info) const
{
...
QAction* CEditorCommandManager::GetAction(tukk cmdFullName, tukk text) const
{
