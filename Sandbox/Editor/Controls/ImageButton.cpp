...
void CImageButton::SetImage(CImageList& imageList, u32 imageIndex, eImageAlignment alignment)
{
...
void CImageButton::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct)
{
	...
	DRX_ASSERT(lpDrawItemStruct->CtlType == ODT_BUTTON);
