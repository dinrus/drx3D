...
public:
	...
	tukk         ClassName()                         { return "ParticleEntity"; };
	tukk         Category()                          { return "Particle Entity"; };
	CRuntimeClass*      GetRuntimeClass()                   { return RUNTIME_CLASS(CParticleEffectObject); };
	tukk         GetFileSpec()                       { return "*ParticleEffects"; };
	virtual tukk GetDataFilesFilterString() override { return "*.pfx"; }
