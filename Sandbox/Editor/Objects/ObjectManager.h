...
public:
	...
	virtual void LinkSelectionTo(CBaseObject* pLinkTo, tukk szTargetName = "") override;
	//! Link single object to target
	virtual void Link(CBaseObject* pObject, CBaseObject* pLinkTo, tukk szTargetName = "") override;
	//! Link multiple objects to target
	virtual void Link(const std::vector<CBaseObject*> objects, CBaseObject* pLinkTo, tukk szTargetName = "") override;
	...
	//////////////////////////////////////////////////////////////////////////
	//! Find object by ID.
	CBaseObject* FindObject(const DrxGUID& guid) const;
	//////////////////////////////////////////////////////////////////////////
	//! Find object by name.
	// When runtime class is specified, returns valid object only if it belongs to specified runtime class.
	CBaseObject* FindObject(tukk objectName, CRuntimeClass* pRuntimeClass = 0) const;
	//////////////////////////////////////////////////////////////////////////
	...
	i32  MoveObjects(const AABB& box, const Vec3& offset, i32 nRot = 0, bool bIsCopy = false);
	...
	void FindObjectsInRect(CViewport* view, const CRect& rect, std::vector<DrxGUID>& guids);
	...
	u32 ForceID() const     { return m_forceID; }
	void   ForceID(u32 FID) { m_forceID = FID; }
	...
	void Serialize(XmlNodeRef& rootNode, bool bLoading, i32 flags = SERIALIZE_ALL);
	...
	void ChangeObjectId(const DrxGUID& oldId, const DrxGUID& newId);
	...
	void RegisterTypeConverter(CRuntimeClass* pSource, tukk szTargetName, std::function<void(CBaseObject* pObject)> conversionFunc) override;

	void IterateTypeConverters(CRuntimeClass* pSource, std::function<void(tukk szTargetName, std::function<void(CBaseObject* pObject)> conversionFunc)> callback) override;
	...
	//////////////////////////////////////////////////////////////////////////
	void StartObjectsLoading(i32 numObjects);
	...
	virtual void                 FindAndRenameProperty2(tukk property2Name, const string& oldValue, const string& newValue);
	virtual void                 FindAndRenameProperty2If(tukk property2Name, const string& oldValue, const string& newValue, tukk otherProperty2Name, const string& otherValue);
	...
	void         SetSelectionMask(i32 mask) const override;
	...
	CDrxSignal<void(i32)> signalSelectionMaskChanged;
...
private:
	...
	void LinkToGeomCacheNode(const std::vector<CBaseObject*> objects, CGeomCacheEntity* pLinkTo, tukk target);
	...
	void HitTestObjectAgainstRect(CBaseObject* pObj, CViewport* view, HitContext hc, std::vector<DrxGUID>& guids);
...
private:
	typedef std::unordered_map<DrxGUID, CBaseObjectPtr> Objects;
	Objects           m_objects;
	...
	// Numbering for names.
	//////////////////////////////////////////////////////////////////////////
	typedef std::map<string, std::set<u16>, stl::less_stricmp<string>> NameNumbersMap;
