...
#include <DrxAISystem/INavigationSystem.h>
...
#include <DrxGame/IGameVolumes.h>
...
public:
	...
	virtual i32  InsertPoint(i32 index, const Vec3& point, bool const bModifying);
	//! Split shape on two shapes based on index. if snap is on, split precisely on the point, else use point to split the shape
	void         SplitAtPoint(i32 index, bool bSnap, Vec3 point);
	//! Remove point from shape at given index.
	virtual void RemovePoint(i32 index);
	//! Set edge index for merge.
	void         SetMergeIndex(i32 index);
	//! Merge shape to this.
...
protected:
	...
	virtual i32  GetMaxPoints() const   { return 100000; };
	virtual i32  GetMinPoints() const   { return 3; };
...
public:
	...
	virtual void       RemovePoint(i32 index) override;
	virtual i32        InsertPoint(i32 index, const Vec3& point, bool const bModifying) override;
	virtual void       SetPoint(i32 index, const Vec3& pos) override;
...
protected:
	...
	virtual i32  GetMinPoints() const override { return 2; }

private:

	bool IsSegmentValid(const Vec3& p0, const Vec3& p1, float rad);
	void DrawSphere(DisplayContext& dc, const Vec3& p0, float rad, i32 n);
	void DrawCylinder(DisplayContext& dc, const Vec3& p0, const Vec3& p1, float rad, i32 n);

	CVariable<bool>    m_bRoad;
	CVariableEnum<i32> m_navType;
...
private:
	...
	CVariable<string>  m_anchorType;
	CVariableEnum<i32> m_lightLevel;
};
...
protected:
	...
	virtual i32 GetMaxPoints() const { return 1; }
	virtual i32 GetMinPoints() const { return 1; }
#endif
};
...
protected:
	...
	virtual i32       GetMaxPoints() const;
	virtual i32       GetMinPoints() const;
	...
	template<typename T>
	bool GetParameterValue(T& outValue, tukk functionName) const;
...
private:
	...
	CVariableEnum<i32> m_shapeClasses;
...
protected:
	...
	void         RegisterNavigationArea(INavigationSystem& navigationSystem, tukk szAreaName);
	void         ReregisterNavigationAreaAfterReload();

	void         RegisterNavigationListener(INavigationSystem& navigationSystem, tukk szAreaName);
...
public:
	ObjectType     GetObjectType()     { return OBJTYPE_SHAPE; };
	tukk    ClassName()         { return "AIHorizontalOcclusionPlane"; };
	tukk    Category()          { return "AI"; };
...
public:
	ObjectType     GetObjectType()     { return OBJTYPE_SHAPE; };
	tukk    ClassName()         { return "AIPerceptionModifier"; };
	tukk    Category()          { return "AI"; };
...
public:
	ObjectType     GetObjectType()     { return OBJTYPE_SHAPE; }
	tukk    ClassName()         { return "GameVolume"; }
	tukk    Category()          { return "Area"; }
...
public:
	ObjectType     GetObjectType()     { return OBJTYPE_SHAPE; }
	tukk    ClassName()         { return "Ledge"; }
	tukk    Category()          { return "GameCustom"; }
...
public:
	ObjectType     GetObjectType()     { return OBJTYPE_SHAPE; }
	tukk    ClassName()         { return "LedgeStatic"; }
	tukk    Category()          { return "GameCustom"; }
...
public:
	ObjectType     GetObjectType()     { return OBJTYPE_SHAPE; }
	tukk    ClassName()         { return "NavigationArea"; }
	tukk    Category()          { return "AI"; }
...
public:
	ObjectType     GetObjectType()     { return OBJTYPE_SHAPE; };
	tukk    ClassName()         { return "Entity::AITerritory"; };
