...
public:
	...
	//////////////////////////////////////////////////////////////////////////
	// Flags.
	i32           GetFlags() const           { return m_nFlags; }

	i32           GetMethodCount() const     { return m_methods.size(); }
	const string& GetMethod(i32 index) const { return m_methods[index]; }
	...
	//////////////////////////////////////////////////////////////////////////
	i32           GetEmptyLinkCount();
	const string& GetEmptyLink(i32 i);
...
private:
	void CopyPropertiesToScriptInternal(IEntity* pEntity, CVarBlock* pVarBlock, bool bCallUpdate, tukk tableKey);
	void CopyPropertiesFromScriptInternal(IEntity* pEntity, CVarBlock* pVarBlock, tukk tableKey);

	bool ParseScript();
	i32  FindLineNum(const string& line);
...
public:
	...
	std::shared_ptr<CEntityScript> Find(tukk szName) const;
	std::shared_ptr<CEntityScript> Insert(IEntityClass* pClass, tukk szAlias = "");
	...
	CDrxSignal<void(CEntityScript*)> m_scriptAdded;
	CDrxSignal<void(CEntityScript*)> m_scriptChanged;
	CDrxSignal<void(CEntityScript*)> m_scriptRemoved;
