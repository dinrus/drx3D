...
void CWaterShapeObject::SetMaterial(IEditorMaterial* mtl)
{
	...
	if (m_pWVRN != nullptr)
	{
		if (mtl != nullptr)
		{
			...
			{
				DrxWarning(VALIDATOR_MODULE_3DENGINE, VALIDATOR_ERROR, "Incorrect shader set for water / water fog volume \"%s\"!", GetName());
			}
...
void CWaterShapeObject::UpdateGameArea()
{
	...
	if (m_pWVRN)
	{
		...
		if (GetPointCount() > 3)
		{
			...
			u32 renderFlags = m_pWVRN->GetRndFlags();
...
//////////////////////////////////////////////////////////////////////////
void CWaterShapeObject::SetMinSpec(u32 nSpec, bool bSetChildren)
{
...
//////////////////////////////////////////////////////////////////////////
void CWaterShapeObject::SetMaterialLayersMask(u32 nLayersMask)
{
