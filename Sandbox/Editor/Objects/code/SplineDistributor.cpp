...
//////////////////////////////////////////////////////////////////////////
void CSplineDistributor::SetObjectCount(i32 num)
{
	i32 oldNum = m_renderNodes.size();
	if (oldNum < num)
	{
...
void CSplineDistributor::OnUpdate()
{
	if (!m_bGameObjectCreated)
		return;
	SetObjectCount(i32(GetSplineLength() / mv_step) + 1);
...
//////////////////////////////////////////////////////////////////////////
void CSplineDistributor::InvalidateTM(i32 nWhyFlags)
{
...
void CSplineDistributor::UpdateEngineNode(bool bOnlyTransform)
{
	...
	i32 numObjects = m_renderNodes.size();
...
//////////////////////////////////////////////////////////////////////////
void CSplineDistributor::SetLayerId(u16 nLayerId)
{
...
public:
	...
	tukk    ClassName()         { return "SplineDistributor"; }
