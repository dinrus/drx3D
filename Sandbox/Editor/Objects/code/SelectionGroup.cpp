...
//////////////////////////////////////////////////////////////////////////
i32 CSelectionGroup::GetCount() const
{
	return m_objects.size();
}

//////////////////////////////////////////////////////////////////////////
CBaseObject* CSelectionGroup::GetObject(i32 index) const
{
...
//////////////////////////////////////////////////////////////////////////
CBaseObject* CSelectionGroup::GetObjectByGuid(DrxGUID guid) const
{
...
//////////////////////////////////////////////////////////////////////////
CBaseObject* CSelectionGroup::GetObjectByGuidInPrefab(DrxGUID guid) const
{
	...
	for (size_t i = 0, count(m_objects.size()); i < count; ++i)
	{
		...
		if (m_objects[i]->IsKindOf(RUNTIME_CLASS(CGroup)))
		{
			...
			while (!groups.empty())
			{
				...
				for (i32 j = 0, childCount = pGroup->GetChildCount(); j < childCount; ++j)
				{
...
//////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////
void CSelectionGroup::Move(const Vec3& offset, i32 moveFlags, i32 referenceCoordSys, const CPoint& point, bool bFromInitPos) const
{
	...
	{
		for (i32 i = 0; i < GetFilteredCount(); ++i)
	...
	for (i32 i = 0; i < GetFilteredCount(); i++)
	{
		...
		if (bFromInitPos)
		{
			...
			{
				DRX_ASSERT_MESSAGE(0, "Initial position expected from transform but not provided. Use SaveFilteredPositions before moving");
...
//////////////////////////////////////////////////////////////////////////
void CSelectionGroup::MoveTo(const Vec3& pos, EMoveSelectionFlag moveFlag, i32 referenceCoordSys, const CPoint& point) const
{
	FilterParents();
...
//////////////////////////////////////////////////////////////////////////
void CSelectionGroup::Rotate(const Quat& qRot, i32 referenceCoordSys) const
{
...
//////////////////////////////////////////////////////////////////////////
void CSelectionGroup::Rotate(const Ang3& angles, i32 referenceCoordSys) const
{
...
//////////////////////////////////////////////////////////////////////////
void CSelectionGroup::Rotate(const Matrix34& rotateTM, i32 referenceCoordSys) const
{
...
//////////////////////////////////////////////////////////////////////////
void CSelectionGroup::Scale(const Vec3& scaleArg, i32 referenceCoordSys) const
{
	Vec3 scl = scaleArg;
	...
	for (i32 i = 0; i < GetFilteredCount(); i++)
	{
		i32 objCoordSystem = referenceCoordSys;
...
void CSelectionGroup::SetScale(const Vec3& scale, i32 referenceCoordSys) const
{
	Vec3 relScale = scale;
...
//////////////////////////////////////////////////////////////////////////
void CSelectionGroup::Transform(const Vec3& offset, EMoveSelectionFlag moveFlag, const Ang3& angles, const Vec3& scale, i32 referenceCoordSys) const
{
	if (offset != Vec3(0))
...
void CSelectionGroup::ResetTransformation() const
{
	...
	for (i32 i = 0, n = GetFilteredCount(); i < n; ++i)
	{
...
static void RecursiveFlattenHierarchy(CBaseObject* pObj, CSelectionGroup& newGroup, bool flattenGroups)
{
	...
	else if (flattenGroups)
	{
		...
		for (i32 i = 0, count = groupMembers.size(); i < count; ++i)
		{
...
public:
	...
	virtual void OnPick(CBaseObject* picked)
	{
		...
		if (picked->GetType() == OBJTYPE_GROUP)
		{
			...
			for (i32 i = 0; i < selGroup->GetFilteredCount(); i++)
...
private:
	bool ChildIsValid(CBaseObject* pParent, CBaseObject* pChild, i32 nDir = 3)
	{
		if (pParent == pChild)
			return false;
		...
		if (nDir & 2)
		{
			for (i32 i = 0; i < pChild->GetChildCount(); i++)
			{
