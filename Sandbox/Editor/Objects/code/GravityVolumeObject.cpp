...
//////////////////////////////////////////////////////////////////////////
void CEditGravityVolumeTool::SetUserData(tukk key, uk userData)
{
...
bool CEditGravityVolumeTool::OnKeyDown(CViewport* view, u32 nChar, u32 nRepCnt, u32 nFlags)
{
	...
	else if (nChar == Qt::Key_Delete)
	{
		if (m_GravityVolume)
		{
			i32 sel = m_GravityVolume->GetSelectedPoint();
...
void CEditGravityVolumeTool::OnManipulatorBeginDrag(IDisplayViewport* view, ITransformManipulator*, const Vec2i&, i32 flags)
{
...
void CEditGravityVolumeTool::OnManipulatorDrag(IDisplayViewport* view, ITransformManipulator*, const Vec2i&, const Vec3& offset, i32)
{
	if (GetIEditorImpl()->GetEditMode() == eEditModeMove)
	{
...
//////////////////////////////////////////////////////////////////////////
bool CEditGravityVolumeTool::MouseCallback(CViewport* view, EMouseEvent event, CPoint& point, i32 flags)
{
	if (!m_GravityVolume)
		return false;
	...
	if (event == eMouseLDown || event == eMouseMove || event == eMouseLDblClick || event == eMouseLUp)
	{
		...
		if ((flags & MK_CONTROL) && !m_modifying)
		{
			...
			if (p1 >= 0 && p2 >= 0 && dist < fGravityVolumeCloseDistance + view->GetSelectionTolerance())
			{
				...
				if (event == eMouseLDown)
				{
					...
					i32 index = m_GravityVolume->InsertPoint(p2, intPnt);
		...
		i32 index = m_GravityVolume->GetNearestPoint(raySrc, rayDir, dist);
...
//////////////////////////////////////////////////////////////////////////
void CGravityVolumeObject::InvalidateTM(i32 nWhyFlags)
{
...
//////////////////////////////////////////////////////////////////////////
i32 CGravityVolumeObject::MouseCreateCallback(IDisplayViewport* view, EMouseEvent event, CPoint& point, i32 flags)
{
...
//////////////////////////////////////////////////////////////////////////
Vec3 CGravityVolumeObject::GetBezierPos(CGravityVolumePointVector& points, i32 index, float t)
{
...
//////////////////////////////////////////////////////////////////////////
Vec3 CGravityVolumeObject::GetSplinePos(CGravityVolumePointVector& points, i32 index, float t)
{
	i32 indprev = index - 1;
	i32 indnext = index + 1;
	if (indprev < 0)
...
//////////////////////////////////////////////////////////////////////////
Vec3 CGravityVolumeObject::GetBezierNormal(i32 index, float t)
{
	float kof = 0.0f;
	i32 i = index;
...
//////////////////////////////////////////////////////////////////////////
float CGravityVolumeObject::GetBezierSegmentLength(i32 index, float t)
{
	const Matrix34& wtm = GetWorldTM();
	i32 kn = i32(t * 20) + 1;
	float fRet = 0.0f;
...
void CGravityVolumeObject::DrawBezierSpline(DisplayContext& dc, CGravityVolumePointVector& points, COLORREF col, bool isDrawJoints, bool isDrawGravityVolume)
{
	...
	for (i32 i = 0; i < points.size(); i++)
	{
		...
		if (i < points.size())
		{
			i32 kn = i32((GetBezierSegmentLength(i) + 0.5f) / mv_step);
			if (kn == 0)
				kn = 1;
			for (i32 k = 0; k < kn; k++)
			{
...
//////////////////////////////////////////////////////////////////////////
i32 CGravityVolumeObject::InsertPoint(i32 index, const Vec3& point)
{
	if (GetPointCount() >= GetMaxPoints())
...
//////////////////////////////////////////////////////////////////////////
void CGravityVolumeObject::RemovePoint(i32 index)
{
...
//////////////////////////////////////////////////////////////////////////
void CGravityVolumeObject::SelectPoint(i32 index)
{
...
//////////////////////////////////////////////////////////////////////////
void CGravityVolumeObject::BezierAnglesCorrection(CGravityVolumePointVector& points, i32 index)
{
	i32 maxindex = points.size() - 1;
...
//////////////////////////////////////////////////////////////////////////
void CGravityVolumeObject::SplinePointsCorrection(CGravityVolumePointVector& points, i32 index)
{
	i32 maxindex = points.size() - 1;
	if (index < 0 || index > maxindex)
		return;
...
//////////////////////////////////////////////////////////////////////////
void CGravityVolumeObject::BezierCorrection(i32 index)
{
...
//////////////////////////////////////////////////////////////////////////
void CGravityVolumeObject::SplineCorrection(i32 index)
{
	/*
...
//////////////////////////////////////////////////////////////////////////
void CGravityVolumeObject::SetPoint(i32 index, const Vec3& pos)
{
	Vec3 p = pos;
	if (m_bForce2D)
	{
...
//////////////////////////////////////////////////////////////////////////
i32 CGravityVolumeObject::GetNearestPoint(const Vec3& raySrc, const Vec3& rayDir, float& distance)
{
	i32 index = -1;
	float minDist = FLT_MAX;
...
//////////////////////////////////////////////////////////////////////////
void CGravityVolumeObject::GetNearestEdge(const Vec3& pos, i32& p1, i32& p2, float& distance, Vec3& intersectPoint)
{
	p1 = -1;
	p2 = -1;
	float minDist = FLT_MAX;
...
//////////////////////////////////////////////////////////////////////////
void CGravityVolumeObject::GetNearestEdge(const Vec3& raySrc, const Vec3& rayDir, i32& p1, i32& p2, float& distance, Vec3& intersectPoint)
{
	p1 = -1;
	p2 = -1;
	float minDist = FLT_MAX;
