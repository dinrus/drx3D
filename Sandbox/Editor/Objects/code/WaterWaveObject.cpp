...
void CWaterWaveObject::UpdateSectors()
{
	...
	for (i32 i = 0; i < m_sectors.size(); i++)
	{
		CRoadSector& pSector = m_sectors[i];
		if (IsValidSector(pSector))
		{
			// copy vertex data
			for (i32 v(0); v < pSector.points.size(); ++v)
			{
...
//////////////////////////////////////////////////////////////////////////
void CWaterWaveObject::SetPoint(i32 index, const Vec3& pos)
{
...
//////////////////////////////////////////////////////////////////////////
i32 CWaterWaveObject::MouseCreateCallback(IDisplayViewport* view, EMouseEvent event, CPoint& point, i32 flags)
{
...
public:
	...
	tukk    ClassName()         { return "Water wave"; };
