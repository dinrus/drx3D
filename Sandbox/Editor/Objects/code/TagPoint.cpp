...
//////////////////////////////////////////////////////////////////////////
i32 CTagPoint::MouseCreateCallback(IDisplayViewport* view, EMouseEvent event, CPoint& point, i32 flags)
{
...
i32 CNavigationSeedPoint::MouseCreateCallback(IDisplayViewport* view, EMouseEvent event, CPoint& point, i32 flags)
{
	i32k retValue = __super::MouseCreateCallback(view, event, point, flags);
