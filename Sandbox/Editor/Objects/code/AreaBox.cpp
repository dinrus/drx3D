...
//////////////////////////////////////////////////////////////////////////
void CAreaObjectBase::OnObjectEvent(CBaseObject* const pBaseObject, i32 const event)
{
...
void CAreaObjectBase::Serialize(CObjectArchive& ar)
{
	...
	if (ar.bLoading)
	{
		...
		if (entities)
		{
			i32 const numChildren = entities->getChildCount();
...
void CAreaBox::Display(CObjectRenderHelper& objRenderHelper)
{
	...
	else
	{
		...
		// Draw each side
		u32 const nSideCount = ((mv_height > 0.0f) ? 6 : 4);
		for (u32 i = 0; i < nSideCount; ++i)
		{
			if (mv_height == 0.0f)
			{
				if (IsSelected())
...
//////////////////////////////////////////////////////////////////////////
void CAreaBox::InvalidateTM(i32 nWhyFlags)
{
...
void CAreaBox::Serialize(CObjectArchive& ar)
{
	...
	if (ar.bLoading)
	{
		...
		u32 const nVarCount = soundVarBlock->GetNumVariables();
		for (u32 i = 0; i < nVarCount; ++i)
		{
...
//////////////////////////////////////////////////////////////////////////
void CAreaBox::SetAreaId(i32 nAreaId)
{
	m_areaId = nAreaId;
