...
public:
	...
	virtual bool   OnKeyUp(CViewport* view, u32 nChar, u32 nRepCnt, u32 nFlags);
	virtual void   SetUserData(tukk userKey, uk userData);
...
//////////////////////////////////////////////////////////////////////////
bool CDecalObjectTool::OnKeyDown(CViewport* view, u32 nChar, u32 nRepCnt, u32 nFlags)
{
	return false;
}

//////////////////////////////////////////////////////////////////////////
bool CDecalObjectTool::OnKeyUp(CViewport* view, u32 nChar, u32 nRepCnt, u32 nFlags)
{
	return false;
}

//////////////////////////////////////////////////////////////////////////
bool CDecalObjectTool::MouseCallback(CViewport* view, EMouseEvent event, CPoint& point, i32 flags)
{
	if (m_pDecalObj)
...
//////////////////////////////////////////////////////////////////////////
void CDecalObjectTool::SetUserData(tukk userKey, uk userData)
{
...
//////////////////////////////////////////////////////////////////////////
i32 CDecalObject::GetProjectionType() const
{
...
//////////////////////////////////////////////////////////////////////////
void CDecalObject::SetMinSpec(u32 nSpec, bool bSetChildren)
{
...
//////////////////////////////////////////////////////////////////////////
void CDecalObject::SetMaterialLayersMask(u32 nLayersMask)
{
...
//////////////////////////////////////////////////////////////////////////
void CDecalObject::InvalidateTM(i32 nWhyFlags)
{
...
//////////////////////////////////////////////////////////////////////////
void CDecalObject::MouseCallbackImpl(CViewport* view, EMouseEvent event, CPoint& point, i32 flags, bool callerIsMouseCreateCallback)
{
...
//////////////////////////////////////////////////////////////////////////
i32 CDecalObject::MouseCreateCallback(IDisplayViewport* view, EMouseEvent event, CPoint& point, i32 flags)
{
