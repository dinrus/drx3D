...
{
public:
	static CObjectLayer* Create(tukk szName, EObjectLayerType type);
	...
	DrxGUID GetParentGUID() const { return m_parentGUID; }
	...
	i32          GetSpecs() const         { return m_specs; }
	...
	void         SetSpecs(i32 specs)                     { m_specs = specs; }
	...
	void          SetAsRootLayer();
	i32           GetChildCount() const         { return m_childLayers.size(); }
	CObjectLayer* GetChild(i32 index) const;
	...
	void   SetLayerID(u16 nLayerId) { m_nLayerId = nLayerId; }
	u16 GetLayerID() const          { return m_nLayerId; }
...
protected:
	...
	CObjectLayer(tukk szName, EObjectLayerType type);
