...
{
public:
	CSimpleTreeBrowser(i32 Height = 0, i32 iddImageList = 0, CWnd* pParent = NULL);   // standard constructor
	...
	void SetAutoResize(bool bEnabled, i32 minHeight = 0, i32 maxHeight = 0);
	...
	typedef Functor1<i32>                                       TContextMenuCommandCallback;
