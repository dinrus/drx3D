...
protected:
	virtual tukk GetDescription() { return "Add Objects To Prefab"; };
...
private:
	...
	{
		DrxGUID              m_object;
		DrxGUID              m_objectParent;
		std::vector<DrxGUID> m_objectsChilds;
	};
...
public:
	...
	i32 GetPrefabInstanceCount(CPrefabItem* pPrefabItem);
