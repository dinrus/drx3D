...
public:
	...
	void ObjectUpdateCallback(CBaseObject* pObj, i32 evt);
...
public:
	...
	void           OnManipulatorBeginDrag(IDisplayViewport* view, ITransformManipulator* pManipulator, const Vec2i& point, i32 flags);
	void           OnManipulatorDrag(IDisplayViewport* view, ITransformManipulator* pManipulator, const Vec2i& p0, const Vec3& value, i32 flags);
...
protected:
	bool OnLButtonDown(CViewport* view, i32 nFlags, CPoint point);
	bool OnLButtonDblClk(CViewport* view, i32 nFlags, CPoint point);
	bool OnLButtonUp(CViewport* view, i32 nFlags, CPoint point);
	bool OnRButtonDown(CViewport* view, i32 nFlags, CPoint point);
	bool OnRButtonUp(CViewport* view, i32 nFlags, CPoint point);
	bool OnMButtonDown(CViewport* view, i32 nFlags, CPoint point);
	bool OnMouseMove(CViewport* view, i32 nFlags, CPoint point);
...
private:
	...
	typedef std::vector<DrxGUID> TGuidContainer;
