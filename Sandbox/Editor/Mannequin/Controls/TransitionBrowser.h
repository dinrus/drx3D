...
struct TTransitionID
{
	...
	bool operator==(const TTransitionID& rhs) const
	{
		...
		DRX_ASSERT((uid != rhs.uid) || (fromID == rhs.fromID && toID == rhs.toID &&
...
public:
	...
	//void PrintRows(tukk szWhen); // Was useful for debugging
...
private:
	...
	void                      SetScopeContextDataIdx(i32 scopeContextDataIdx);
