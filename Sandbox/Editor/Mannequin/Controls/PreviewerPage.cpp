...
static i32k CHAR_BUFFER_SIZE = 512;
};
...
BOOL CPreviewerPage::OnInitDialog()
{
	...
	i32 nTimelineUnits = regMgr.GetProfileInt(strSection, "TimelineUnits", m_wndTrackPanel.GetTickDisplayMode());
...
//////////////////////////////////////////////////////////////////////////
float CPreviewerPage::PopulateClipTracks(CSequencerNode* node, i32k scopeID)
{
	struct SSelectedKey
	{
			...
			if (scopeMask & BIT64(scopeID))
			{
				...
				if (trackContext.context && trackContext.context->database)
				{
					...
					if (blend1.pFragmentBlend)
					{
						...
						i32k id = fragTrack->CreateKey(transitionTime);
						CFragmentKey fragKey;
...
//////////////////////////////////////////////////////////////////////////
void CPreviewerPage::LoadSequence(tukk szFilename)
{
	ResetForcedBlend();
...
void CPreviewerPage::LoadSequence(i32k scopeContextIdx, const FragmentID fromID, const FragmentID toID, const SFragTagState fromFragTag, const SFragTagState toFragTag, const SFragmentBlendUid blendUid)
{
...
//////////////////////////////////////////////////////////////////////////
void CPreviewerPage::SaveSequence(tukk szFilename)
{
	OnUpdateTV();
