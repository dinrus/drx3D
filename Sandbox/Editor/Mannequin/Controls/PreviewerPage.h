...
public:
	...
	void                             NewSequence();
	void                             LoadSequence(tukk szFilename = NULL);
	void                             SaveSequence(tukk szFilename = NULL);

	void                             LoadSequence(i32k scopeContextIdx, const FragmentID fromID, const FragmentID toID, const SFragTagState fromFragTag, const SFragTagState toFragTag, const SFragmentBlendUid blendUid);
...
protected:
	...
	float        PopulateClipTracks(CSequencerNode* node, i32k scopeID);
