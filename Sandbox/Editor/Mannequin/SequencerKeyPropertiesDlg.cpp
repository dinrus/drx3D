	...
	: m_pLastTrackSelected(NULL)
{
	...
	if (!overrideConstruct)
	{
		...
		/*std::vector<IClassDesc*> classes;
		   ...
		   for (i32 i = 0; i < (i32)classes.size(); i++)
		   {
...
//////////////////////////////////////////////////////////////////////////
void CSequencerKeyPropertiesDlg::OnSize(UINT nType, i32 cx, i32 cy)
{
...
void CSequencerKeyPropertiesDlg::AddVars(CSequencerKeyUIControls* pUI)
{
	...
	for (i32 i = 0, num = pVB->GetNumVariables(); i < num; i++)
	{
...
void CSequencerKeyPropertiesDlg::SetVarValue(tukk varName, tukk varValue)
{
...
void CSequencerTrackPropsDlg::OnDeltaposPrevnext(NMHDR* pNMHDR, LRESULT* pResult)
{
	...
	i32 nkey = m_key + pNMUpDown->iDelta;
	if (nkey < 0)
...
void CSequencerTrackPropsDlg::SetCurrKey(i32 nkey)
{
	if (m_key >= 0 && m_key < m_track->GetNumKeys())
	{
