...
static void SaveTagDefinitionAndImports(IMannequinEditorManager* const pMannequinEditorManager, CMannequinFileChangeWriter* const pWriter, const CTagDefinition* const pTagdefinition)
{
	...
	for (i32 i = 0; i < includedTagDefs.size(); ++i)
	{
...
void CMannequinFileChangeWriter::RefreshModifiedFiles()
{
	...
	else
	{
		...
		if (mannequinContexts.m_controllerDef)
		{
			...
			// Databases
			u32k numScopeContexts = mannequinContexts.m_contextData.size();
			for (u32 itScopeContexts = 0; itScopeContexts != numScopeContexts; ++itScopeContexts)
			{
...
//////////////////////////////////////////////////////////////////////////
void CMannequinFileChangeWriter::WriteNewFile(tukk filename)
{
...
//////////////////////////////////////////////////////////////////////////
bool CMannequinFileChangeWriter::SaveFile(tukk filename, XmlNodeRef xmlNode, CString& path)
{
	assert(filename);
	assert(xmlNode);
...
//////////////////////////////////////////////////////////////////////////
void CMannequinFileChangeWriter::SaveFile(tukk filename, XmlNodeRef xmlNode, EFileEntryType fileEntryType)
{
	CString path;
