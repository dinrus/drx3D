...
public:
	...
	void          ClearLocators();
	void          AddLocator(u32 refID, tukk name, const QuatT& transform, IEntity* pEntity = NULL, i16 refJointId = -1, IAttachment* pAttachment = NULL, u32 paramCRC = 0, string helperName = "");
...
private:
	...
	u32               m_key_W, m_keyrcr_W;
	u32               m_key_S, m_keyrcr_S;
	u32               m_key_A, m_keyrcr_A;
	u32               m_key_D, m_keyrcr_D;

	u32               m_key_SPACE, m_keyrcr_SPACE;
	u32               m_ControllMode;
