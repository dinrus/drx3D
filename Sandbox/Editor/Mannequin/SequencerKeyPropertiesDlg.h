...
protected:
	...
	void AddVariable(CVariableBase& varArray, IVariable& var, tukk varName, u8 dataType = IVariable::DT_SIMPLE)
	{
		if (varName)
			var.SetName(varName);
...
public:
	...
	void SetVarValue(tukk varName, tukk varValue);
