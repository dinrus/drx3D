...
public:
	...
	static i32 _cdecl       RowCompareFunc(const CXTPReportRow** pRow1, const CXTPReportRow** pRow2);
...
public:
	...
	virtual CMaterialBrowserRecord* InsertItemToTree(IDataBaseItem* pItem, i32 nSubMtlSlot = -1, CMaterialBrowserRecord* pParentRecord = 0);
...
protected:
	...
	void       SetSubMaterial(CMaterialBrowserRecord* pRecord, i32 nSlot, CMaterial* pSubMaterial, bool bSelectSubMtl);
	...
	u32     MaterialNameToCrc32(tukk str);
