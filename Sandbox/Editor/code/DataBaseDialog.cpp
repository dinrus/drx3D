...
class CDataBaseViewPaneClass : public IViewPaneClass
{
	...
	virtual tukk    ClassName()       override { return DATABASE_VIEW_NAME; };
	...
	virtual tukk    GetPaneTitle()    override { return _T(DATABASE_VIEW_NAME); };
...
{
	for (i32 i = 0; i < m_windows.size(); i++)
	{
		delete m_windows[i];
	}
}
...
//////////////////////////////////////////////////////////////////////////
void CDataBaseDialog::OnSize(UINT nType, i32 cx, i32 cy)
{
	////////////////////////////////////////////////////////////////////////
	// Resize
	////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////
void CDataBaseDialog::Select(i32 num)
{
	if (num == m_selectedCtrl)
		return;
	i32 prevSelected = m_selectedCtrl;
...
//////////////////////////////////////////////////////////////////////////
CDataBaseDialogPage* CDataBaseDialog::GetPage(i32 num)
{
...
//////////////////////////////////////////////////////////////////////////
void CDataBaseDialog::AddTab(tukk szTitle, CDataBaseDialogPage* wnd)
{
...
BOOL CDataBaseDialog::OnCmdMsg(UINT nID, i32 nCode, uk pExtra, AFX_CMDHANDLERINFO* pHandlerInfo)
{
