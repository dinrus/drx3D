...
//////////////////////////////////////////////////////////////////////////
void C2DViewport::UpdateContent(i32 flags)
{
...
void C2DViewport::DrawGrid(DisplayContext& dc, bool bNoXNumbers)
{
	...
	i32 width = m_rcClient.Width();
	i32 height = m_rcClient.Height();
	...
	i32 firstGridLineX = origin[0] / gridSize - 1;
	i32 firstGridLineY = origin[1] / gridSize - 1;

	i32 numGridLinesX = (m_rcClient.Width() / fScale) / gridSize + 1;
	i32 numGridLinesY = (m_rcClient.Height() / fScale) / gridSize + 1;
...
//////////////////////////////////////////////////////////////////////////
void C2DViewport::MakeSnappingGridPlane(i32 axis)
{
...
//////////////////////////////////////////////////////////////////////////
bool C2DViewport::MouseCallback(EMouseEvent event, CPoint& point, i32 flags)
{
