...
public:
	...
	virtual bool OnPickFilter(CBaseObject* pLinkTo)
	{
		...
		for (i32 i = 0; i < pSelectionGroup->GetFilteredCount(); i++)
		{
...
//////////////////////////////////////////////////////////////////////////
bool CLinkTool::MouseCallback(CViewport* view, EMouseEvent event, CPoint& point, i32 flags)
{
...
//////////////////////////////////////////////////////////////////////////
bool CLinkTool::OnKeyDown(CViewport* view, u32 nChar, u32 nRepCnt, u32 nFlags)
{
		...
		if (pEntity)
		{
			...
			if (pGeomCacheRenderNode)
			{
				if (QtUtil::IsModifierKeyDown(Qt::ShiftModifier))
				{
					...
					{
						tukk pNodeName = pGeomCacheRenderNode->GetNodeName(i);
