...
IClassDesc* CClassFactory::FindClass(tukk pClassName) const
{
	...
	tukk pSubClassName = strstr(pClassName, "::");
...
void CClassFactory::GetClassesByCategory(tukk pCategory, std::vector<IClassDesc*>& rOutClasses)
{
	rOutClasses.clear();
