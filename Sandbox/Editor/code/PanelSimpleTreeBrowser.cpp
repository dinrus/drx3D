...
//////////////////////////////////////////////////////////////////////////
CSimpleTreeBrowser::CSimpleTreeBrowser(i32 Height /*= 0*/, i32 iddImageList /*= 0*/, CWnd* pParent /*= NULL*/)
...
//////////////////////////////////////////////////////////////////////////
void CSimpleTreeBrowser::SetAutoResize(bool bEnabled, i32 minHeight /*= 0*/, i32 maxHeight /*= 0*/)
{
...
void CSimpleTreeBrowser::AddItemsToTree(const TSimpleTreeBrowserItems& items, CTreeItemRecord* pParent)
{
	for (size_t i = 0, iCount = items.size(); i < iCount; i++)
	{
		...
		pRec->SetUserData((uk ) &item);
		pRec->SetIcon(item.Icon);
		pRec->SetUserString(string().Format("%s_%i", (LPCTSTR)item.DisplayName, (i32)(intptr_t)item.UserData).c_str());
...
void CSimpleTreeBrowser::AutoResize()
{
	...
	{
		i32 newHeigth = m_CurrItems.size() * 28 + 50;
