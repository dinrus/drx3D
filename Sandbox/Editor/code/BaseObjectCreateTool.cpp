...
bool CBaseObjectCreateTool::MouseCallback(CViewport* pView, EMouseEvent eventId, CPoint& point, i32 flags)
{
	switch (eventId)
	{
...
bool CBaseObjectCreateTool::OnDragEvent(CViewport* pView, EDragEvent eventId, QEvent* pEvent, u32 flags)
{
	switch (eventId)
	{
	case eDragEnter:
...
bool CBaseObjectCreateTool::OnKeyDown(CViewport* pView, u32 key, u32, u32)
{
