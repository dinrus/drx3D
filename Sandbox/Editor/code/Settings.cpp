...
i32k EditorSettingsVersion = 1; // bump this up on every substantial settings change
...
inline QVariant GetQtSettingsValue(tukk sSection, tukk sKey, const QVariant& deflt)
{
	QVariant var;
...
//////////////////////////////////////////////////////////////////////////
void SEditorSettings::LoadValue(tukk sSection, tukk sKey, i32& value)
{
	value = GetQtSettingsValue(sSection, sKey, QVariant(value)).toInt();
}

//////////////////////////////////////////////////////////////////////////
void SEditorSettings::LoadValue(tukk sSection, tukk sKey, u32& value)
{
	value = GetQtSettingsValue(sSection, sKey, QVariant(value)).toUInt();
}

//////////////////////////////////////////////////////////////////////////
void SEditorSettings::LoadValue(tukk sSection, tukk sKey, u64& value)
{
	value = GetQtSettingsValue(sSection, sKey, QVariant((u32)value)).toUInt();
}

//////////////////////////////////////////////////////////////////////////
void SEditorSettings::LoadValue(tukk sSection, tukk sKey, float& value)
{
	value = GetQtSettingsValue(sSection, sKey, QVariant(value)).toFloat();
}

//////////////////////////////////////////////////////////////////////////
void SEditorSettings::LoadValue(tukk sSection, tukk sKey, bool& value)
{
	value = GetQtSettingsValue(sSection, sKey, QVariant(value)).toBool();
}

//////////////////////////////////////////////////////////////////////////
void SEditorSettings::LoadValue(tukk sSection, tukk sKey, string& value)
{
...
void SEditorSettings::LoadFrom(const QString& filename)
{
	...
	DrxLog("Loading editor preferences from: %s", filename.toLatin1().data());

	i32 settingsVersion = EditorSettingsVersion;
	...
	gViewportSelectionPreferences.colorPrefabBBox = ColorB(u32(prefabHighlight), gViewportSelectionPreferences.geomAlpha);
	gViewportSelectionPreferences.colorGroupBBox = ColorB(u32(groupHighlight), gViewportSelectionPreferences.geomAlpha);
	gViewportSelectionPreferences.colorEntityBBox = ColorB(u32(entityHighlight), gViewportSelectionPreferences.geomAlpha);
	gViewportSelectionPreferences.geometryHighlightColor = ColorB(u32(geometryHighlightColor), gViewportSelectionPreferences.geomAlpha);
	gViewportSelectionPreferences.solidBrushGeometryColor = ColorB(u32(solidBrushGeometryColor), gViewportSelectionPreferences.geomAlpha);
