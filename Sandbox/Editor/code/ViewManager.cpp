...
public:
	...
	virtual QVariantMap GetState() const
	{
		if (m_pViewport->IsRenderViewport())
		{
			...
			QVariantMap state;
			state.insert("resolutionMode", static_cast<i32>(viewport->GetResolutionMode()));
			i32 width, height;
...
CViewport* CViewManager::GetViewport(EViewportType type) const
{
	...
	// type attached
	////////////////////////////////////////////////////////////////////////
	for (i32 i = 0; i < m_viewports.size(); i++)
	{
...
//////////////////////////////////////////////////////////////////////////
void CViewManager::UpdateViews(i32 flags)
{
...
//////////////////////////////////////////////////////////////////////////
void CViewManager::SetAxisConstrain(i32 axis)
{
...
{
	descriptions.clear();
	for (i32 i = 0; i < m_viewportDesc.size(); i++)
	{
...
//////////////////////////////////////////////////////////////////////////
i32 CViewManager::GetNumberOfGameViewports()
{
...
//////////////////////////////////////////////////////////////////////////
bool CViewManager::TryResize(CViewport* viewport, i32 width, i32 height, bool bMaximize)
{
	return false;
}
