...
public:
	...
	inline void InitMP()
	{
		...
		if (m_CoreCount > 1)
		{
			...
			{
				DrxFatalError("Error spawning \"SHLighting_TriRaster\" thread.");
			}
		}
#endif
	}
...
private:
	...
	static u32  scMPDataCount[2];
	static u32  scActiveSet;         //current active index to push into
	...
	u32   m_CoreCount;         //number of system cores, 1 will not toggle mp
};
