...
BOOL CResourceCompilerDialog::OnInitDialog()
{
	...
	{
		DrxFatalError("Error spawning \"ResourceCompilerDialog\" thread.");
	}
...
void CResourceCompilerDialog::OnRCMessage(MessageSeverity severity, tukk pText)
{
...
void CResourceCompilerDialog::AppendToOutput(CString text, bool bUseDefaultColor, COLORREF color)
{
	...
	i32k length = m_outputCtrl.GetWindowTextLength();
	...
	i32k visibleLines = GetNumVisibleLines();
...
i32 CResourceCompilerDialog::GetNumVisibleLines()
{
	CRect rect;
