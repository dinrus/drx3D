...
public:
	...
	void setupUi(QMainWindow* MainWindow)
	{
		...
		actionNew->setIcon(DrxIcon("icons:General/File_New.ico"));
		actionNew->setObjectName(QStringLiteral("actionNew"));
		actionOpen = new QCommandAction(nullptr, nullptr, MainWindow);
		actionOpen->setObjectName(QStringLiteral("actionOpen"));
		DrxIcon icon;
		icon.addFile(QStringLiteral("icons:General/Folder_Open.ico"), QSize(), DrxIcon::Normal, DrxIcon::Off);
		actionOpen->setIcon(icon);
		actionSave_As = new QCommandAction(nullptr, nullptr, MainWindow);
		actionSave_As->setObjectName(QStringLiteral("actionSave_As"));
		actionSave_As->setIcon(DrxIcon("icons:General/Save_as.ico"));
		actionToggle_Content_Browser = new QCommandAction("Quick Asset Browser", "asset.toggle_browser", MainWindow);
		actionToggle_Content_Browser->setIcon(DrxIcon("icons:Tools/tools_asset-browser.ico"));
		...
		actionExport_to_Engine->setIcon(DrxIcon("icons:General/Export.ico"));
		...
		actionExport_Selected_Objects->setIcon(DrxIcon("icons:Tools/Export_Selected_Objects.ico"));
		...
		actionExit->setIcon(DrxIcon("icons:General/Exit.ico"));
		actionUndo = new QCommandAction(nullptr, nullptr, MainWindow);
		actionUndo->setObjectName(QStringLiteral("actionUndo"));
		DrxIcon icon1;
		icon1.addFile(QStringLiteral("icons:General/History_Undo.ico"), QSize(), DrxIcon::Normal, DrxIcon::Off);
		actionUndo->setIcon(icon1);
		actionRedo = new QCommandAction(nullptr, nullptr, MainWindow);
		actionRedo->setObjectName(QStringLiteral("actionRedo"));
		DrxIcon icon2;
		icon2.addFile(QStringLiteral("icons:General/History_Redo.ico"), QSize(), DrxIcon::Normal, DrxIcon::Off);
		actionRedo->setIcon(icon2);
		actionDelete = new QCommandAction(nullptr, nullptr, MainWindow);
		actionDelete->setObjectName(QStringLiteral("actionDelete"));
		actionDelete->setIcon(DrxIcon("icons:General/Close.ico"));
		actionDelete->setIcon(DrxIcon("icons:General/Delete_Asset.ico"));
		...
		actionDuplicate->setIcon(DrxIcon("icons:General/Duplicate_asset.ico"));
		actionCopy = new QCommandAction(nullptr, nullptr, MainWindow);
		actionCopy->setIcon(DrxIcon("icons:General/Copy_Asset.ico"));
		actionCopy->setObjectName(QStringLiteral("actionCopy"));
		actionCut = new QCommandAction(nullptr, nullptr, MainWindow);
		actionCut->setIcon(DrxIcon("icons:General/Cut_Asset.ico"));
		actionCut->setObjectName(QStringLiteral("actionCut"));
		actionPaste = new QCommandAction(nullptr, nullptr, MainWindow);
		actionPaste->setIcon(DrxIcon("icons:General/Paste_Asset.ico"));
		...
		DrxIcon icon3;
		icon3.addFile(QStringLiteral("icons:General/editable_false.ico"), QSize(), DrxIcon::Normal, DrxIcon::Off);
		...
		DrxIcon icon4;
		icon4.addFile(QStringLiteral("icons:General/editable_true.ico"), QSize(), DrxIcon::Normal, DrxIcon::Off);
		...
		DrxIcon icon7;
		icon7.addFile(QStringLiteral("icons:General/Search.ico"), QSize(), DrxIcon::Normal, DrxIcon::Off);
		...
		DrxIcon iconFindPrevious;
		iconFindPrevious.addFile(QStringLiteral("icons:General/Arrow_Left.ico"), QSize(), DrxIcon::Normal, DrxIcon::Off);
		actionFindPrevious->setIcon(iconFindPrevious);
		DrxIcon iconFindNext;
		iconFindNext.addFile(QStringLiteral("icons:General/Arrow_Right.ico"), QSize(), DrxIcon::Normal, DrxIcon::Off);
		...
		i32 editMode = GetIEditorImpl()->GetEditMode();
		actionSelect_Mode->setChecked(editMode == eEditModeSelect);
		DrxIcon icon8;
		icon8.addFile(QStringLiteral("icons:Navigation/Basics_Select.ico"), QSize(), DrxIcon::Normal, DrxIcon::Off);
		...
		DrxIcon icon9;
		icon9.addFile(QStringLiteral("icons:Navigation/Basics_Move.ico"), QSize(), DrxIcon::Normal, DrxIcon::Off);
		actionMove->setIcon(icon9);
		actionRotate = new QCommandAction(nullptr, nullptr, MainWindow);
		actionRotate->setObjectName(QStringLiteral("actionRotate"));
		actionRotate->setCheckable(true);
		DrxIcon icon10;
		icon10.addFile(QStringLiteral("icons:Navigation/Basics_Rotate.ico"), QSize(), DrxIcon::Normal, DrxIcon::Off);
		...
		DrxIcon icon11;
		icon11.addFile(QStringLiteral("icons:Navigation/Basics_Scale.ico"), QSize(), DrxIcon::Normal, DrxIcon::Off);
		...
		DrxIcon icon13;
		icon13.addFile(QStringLiteral("icons:Navigation/Tools_Link.ico"), QSize(), DrxIcon::Normal, DrxIcon::Off);
		...
		DrxIcon icon14;
		icon14.addFile(QStringLiteral("icons:Navigation/Tools_Link_Unlink.ico"), QSize(), DrxIcon::Normal, DrxIcon::Off);
		...
		DrxIcon icon15;
		icon15.addFile(QStringLiteral("icons:Navigation/Align_To_Grid.ico"), QSize(), DrxIcon::Normal, DrxIcon::Off);
		...
		DrxIcon icon16;
		icon16.addFile(QStringLiteral("icons:Viewport/viewport-snap-pivot.ico"), QSize(), DrxIcon::Normal, DrxIcon::Off);
		...
		DrxIcon icon17;
		icon17.addFile(QStringLiteral("icons:General/Go_To_Selection.ico"), QSize(), DrxIcon::Normal, DrxIcon::Off);
		...
		actionMaterial_Assign_Current->setIcon(DrxIcon("icons:MaterialEditor/Material_Editor_Assign_To_Object.ico"));
		...
		actionMaterial_Reset_to_Default->setIcon(DrxIcon("icons:MaterialEditor/Material_Editor_Reset_Material.ico"));
		...
		actionMaterial_Get_from_Selected->setIcon(DrxIcon("icons:MaterialEditor/Material_Editor_Pick_From_Object.ico"));
		...
		actionPick_Material->setIcon(DrxIcon("icons:General/Picker.ico"));
		...
		DrxIcon icon18;
		icon18.addFile(QStringLiteral("icons:General/Get_Physics.ico"), QSize(), DrxIcon::Normal, DrxIcon::Off);
		...
		DrxIcon icon19;
		icon19.addFile(QStringLiteral("icons:General/Reset_Physics.ico"), QSize(), DrxIcon::Normal, DrxIcon::Off);
		...
		DrxIcon icon20;
		icon20.addFile(QStringLiteral("icons:General/Simulate_Physics.ico"), QSize(), DrxIcon::Normal, DrxIcon::Off);
		...
		actionPhysics_Generate_Joints->setIcon(DrxIcon("icons:General/Physics_Generate_Joints.ico"));
		...
		actionWireframe->setIcon(DrxIcon("icons:Viewport/Modes/display_wireframe.ico"));
		actionRuler = new QCommandAction(nullptr, nullptr, MainWindow);
		actionRuler->setObjectName(QStringLiteral("actionRuler"));
		actionRuler->setIcon(DrxIcon("icons:Tools/tools-ruler.ico"));
		...
		QCommandAction* pSnapSettings = new QCommandAction(name.append("..."), (tukk)cmd.toLocal8Bit(), menuAlign_Snap);
		pSnapSettings->setIcon(DrxIcon("icons:Viewport/viewport-snap-options.ico"));
		...
		actionGoto_Position->setIcon(DrxIcon("icons:Tools/Go_To_Position.ico"));
		...
		actionSwitch_to_Game->setIcon(DrxIcon("icons:Game/Game_Play.ico"));
		...
		actionEnable_Physics_AI->setIcon(DrxIcon("icons:common/general_physics_play.ico"));
		...
		DrxIcon icon22;
		icon22.addFile(QStringLiteral("icons:General/File_Save.ico"), QSize(), DrxIcon::Normal, DrxIcon::Off);
		...
		DrxIcon icon23;
		icon23.addFile(QStringLiteral("icons:MaterialEditor/Material_Save.ico"), QSize(), DrxIcon::Normal, DrxIcon::Off);
		...
		DrxIcon icon24;
		icon24.addFile(QStringLiteral("icons:MaterialEditor/Material_Load.ico"), QSize(), DrxIcon::Normal, DrxIcon::Off);
		...
		DrxIcon icon25;
		icon25.addFile(QStringLiteral("icons:Navigation/Axis_X.ico"), QSize(), DrxIcon::Normal, DrxIcon::Off);
		...
		DrxIcon icon26;
		icon26.addFile(QStringLiteral("icons:Navigation/Axis_Y.ico"), QSize(), DrxIcon::Normal, DrxIcon::Off);
		...
		DrxIcon icon27;
		icon27.addFile(QStringLiteral("icons:Navigation/Axis_Z.ico"), QSize(), DrxIcon::Normal, DrxIcon::Off);
		...
		DrxIcon icon28;
		icon28.addFile(QStringLiteral("icons:Navigation/Axis_XY.ico"), QSize(), DrxIcon::Normal, DrxIcon::Off);
		...
		actionCoordinates_View->setIcon(DrxIcon("icons:Navigation/Coordinates_View.ico"));
		...
		actionCoordinates_Local->setIcon(DrxIcon("icons:Navigation/Coordinates_Local.ico"));
		...
		actionCoordinates_Parent->setIcon(DrxIcon("icons:Navigation/Coordinates_Parent.ico"));
		...
		actionCoordinates_World->setIcon(DrxIcon("icons:Navigation/Coordinates_World.ico"));
		...
		actionMute_Audio->setIcon(DrxIcon("icons:Audio/Mute_Audio.ico"));
		...
		actionStop_All_Sounds->setIcon(DrxIcon("icons:Audio/Stop_All_Sounds.ico"));
		...
		actionRefresh_Audio->setIcon(DrxIcon("icons:Audio/Refresh_Audio.ico"));
...

		{
			...
			i32k sec = builder.GetNextEmptySection();
	...
	, m_bUserEventPriorityMode(false)
{
	...
	toolConfig[SANDBOX_WRAPPER_MINIMIZE_ICON] = DrxIcon("icons:Window/Window_Minimize.ico");
	toolConfig[SANDBOX_WRAPPER_MAXIMIZE_ICON] = DrxIcon("icons:Window/Window_Maximize.ico");
	toolConfig[SANDBOX_WRAPPER_RESTORE_ICON] = DrxIcon("icons:Window/Window_Restore.ico");
	toolConfig[SANDBOX_WRAPPER_CLOSE_ICON] = DrxIcon("icons:Window/Window_Close.ico");
	toolConfig[QTWM_TAB_CLOSE_ICON] = DrxIcon("icons:Window/Window_Close.ico");
	toolConfig[QTWM_SINGLE_TAB_FRAME_CLOSE_ICON] = DrxIcon("icons:Window/Window_Close.ico");
...
void CEditorMainFrame::CreateToolsMenu()
{
	...
	std::map<string, i32> numClassesInCategory;
	...
	for (i = 0; i < classes.size(); i++)
	{
		...
		i32 numClasses = numClassesInCategory[pViewClass->Category()];
		string name = pViewClass->ClassName();
		string category = pViewClass->Category();

		string cmd;
		cmd.Format("general.open_pane '%s'", (tukk)pViewClass->ClassName());
		...
		{
			pAction->setIcon(DrxIcon(iconName));
		}
	...
	for (i32 i = 0; i < subMenuActions.size(); ++i)
	{
...
void CEditorMainFrame::BindAIMenu()
{
	...
	if (!pUpdateModeMenu)
	{
		DrxWarning(VALIDATOR_MODULE_EDITOR, VALIDATOR_WARNING, "Ai Navigation Update Menu not found");
		return;
	}
...
void CEditorMainFrame::InitMenus()
{
	...
	else
	{
		...
		QString cmd = QString("general.open_pane '%1'").arg(name);
		QCommandAction* pKeyboardShortcuts = new QCommandAction(name.append("..."), (tukk)cmd.toLocal8Bit(), editMenu);
		pKeyboardShortcuts->setIcon(DrxIcon("icons:Tools/Keyboard_Shortcuts.ico"));
		editMenu->addAction(pKeyboardShortcuts);

		name = "Preferences";
		cmd = QString("general.open_pane '%1'").arg(name);
		editMenu->addAction(new QCommandAction(name.append("..."), (tukk)cmd.toLocal8Bit(), editMenu));
		...
		name = "Undo History";
		cmd = QString("general.open_pane '%1'").arg(name);
		QAction* pUndoHistory = new QCommandAction(name, (tukk)cmd.toLocal8Bit(), editMenu);
		pUndoHistory->setIcon(DrxIcon("icons:General/History_Undo_List.ico"));
	...
	else
	{
		...
		QString cmd = QString("general.open_pane '%1'").arg(name);
		QAction* pAction = new QCommandAction(name, static_cast<tukk >(cmd.toLocal8Bit()), pHelpMenu);
		pAction->setIcon(DrxIcon("icons:ObjectTypes/Console_Commands.ico"));
		pHelpMenu->addAction(pAction);

		name = "Console Variables";
		cmd = QString("general.open_pane '%1'").arg(name);
		pAction = new QCommandAction(name, static_cast<tukk >(cmd.toLocal8Bit()), pHelpMenu);
		pAction->setIcon(DrxIcon("icons:ObjectTypes/Console_Variables.ico"));
		pHelpMenu->addAction(pAction);
...
bool CEditorMainFrame::BeforeClose()
{
	...
	CDrxEditDoc* pDoc = GetIEditorImpl()->GetDocument();
...
bool CEditorMainFrame::event(QEvent* event)
{
	...
	else if ((i32k)event->type() == SandboxEvent::MissedShortcut)
	{
		...
		{
			DrxLog("Ambiguous shortcut overload : %s", missed_event->GetSequence().toString(QKeySequence::NativeText).toLatin1().constData());
		}
...
//////////////////////////////////////////////////////////////////////////
void CEditorMainFrame::OnAxisConstrainChanged(i32 axis)
{
...
bool CEditorMainFrame::OnNativeEvent(uk message, long* result)
{
#ifdef WIN32
...
void CEditorMainFrame::OnIdleCallback()
{
	...
	if (!m_bUserEventPriorityMode ||
	    ...
	    bOverViewport)
	{
		res = CDrxEditApp::GetInstance()->IdleProcessing(false);
...
void CEditorMainFrame::OnBackgroundUpdateTimer()
{
	...
	if (period > 0)
	{
		...
		{
			CDrxEditApp::GetInstance()->IdleProcessing(true);
		}
