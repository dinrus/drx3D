...
public:
	...
	tukk Text() { return m_text.c_str(); }
	CPopupMenuItem& AddSeparator();

	//! Adds a parent menu which should host a submenu as child items
	CPopupMenuItem& Add(tukk text);

	//! Please do not use other methods, std::function and std::bind make this the only Add method necessary
	CPopupMenuItem& Add(tukk text, const std::function<void()>& function);
	
	CPopupMenuItem& Add(tukk text, tukk icon,const std::function<void()>& function);
	...
	CPopupMenuItem& AddCommand(tukk text, string commandToExecute);

	//! Deprecated method
	/*CPopupMenuItem& Add(tukk text, const Functor0& functor);*/

	//! Deprecated method
	template<class Arg1>
	CPopupMenuItem& Add(tukk text, const Functor1<Arg1>& functor, const Arg1& arg1);

	//! Deprecated method
	template<class Arg1, class Arg2>
	CPopupMenuItem& Add(tukk text, const Functor2<Arg1, Arg2>& functor, const Arg1& arg1, const Arg2& arg2);

	//! Deprecated method
	template<class Arg1, class Arg2, class Arg3>
	CPopupMenuItem& Add(tukk text, const Functor3<Arg1, Arg2, Arg3>& functor, const Arg1& arg1, const Arg2& arg2, const Arg3& arg3);

	CPopupMenuItem* Find(tukk text);
...
template<class Arg1>
CPopupMenuItem& CPopupMenuItem::Add(tukk text, const Functor1<Arg1>& functor, const Arg1& arg1)
{
	return Add(text, std::bind(functor, arg1));
}

template<class Arg1, class Arg2>
CPopupMenuItem& CPopupMenuItem::Add(tukk text, const Functor2<Arg1, Arg2>& functor, const Arg1& arg1, const Arg2& arg2)
{
	return Add(text, std::bind(functor, arg1, arg2));
}

template<class Arg1, class Arg2, class Arg3>
CPopupMenuItem& CPopupMenuItem::Add(tukk text, const Functor3<Arg1, Arg2, Arg3>& functor, const Arg1& arg1, const Arg2& arg2, const Arg3& arg3)
{
