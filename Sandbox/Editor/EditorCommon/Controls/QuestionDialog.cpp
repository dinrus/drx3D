...
void CQuestionDialog::SetupUI(EInfoMessageType type, const QString& title, const QString& text, QDialogButtonBox::StandardButtons buttons, QDialogButtonBox::StandardButton defaultButton)
{
	...
	case EInfoMessageType::CriticalType:
		m_iconLabel->setPixmap(DrxIcon("icons:Dialogs/dialog-error.ico").pixmap(iconSize, iconSize, QIcon::Normal, QIcon::On));
		break;
	case EInfoMessageType::QuestionType:
		m_iconLabel->setPixmap(DrxIcon("icons:Dialogs/dialog-question.ico").pixmap(iconSize, iconSize, QIcon::Normal, QIcon::On));
		break;
	case EInfoMessageType::WarningType:
		m_iconLabel->setPixmap(DrxIcon("icons:Dialogs/dialog-warning.ico").pixmap(iconSize, iconSize, QIcon::Normal, QIcon::On));
		break;
	}
