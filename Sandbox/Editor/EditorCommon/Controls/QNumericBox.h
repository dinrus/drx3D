...
public:
	...
	void   setPrecision(i32 precision); //set to 0 for an integer spin box
...
private:
	...
	QIcon m_icon;
	i32   m_spinClickTimerId;
	i32   m_spinClickTimerInterval;
	i32   m_spinClickThresholdTimerId;
	i32   m_spinClickThresholdTimerInterval;
	i32   m_effectiveSpinRepeatRate;
	i32   m_acceleration;
	bool  m_accelerated;
};
