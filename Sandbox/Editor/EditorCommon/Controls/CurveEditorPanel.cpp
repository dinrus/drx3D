	...
	: CDockableWidget(pParent)
{
	...
	DRX_ASSERT(pParent); //must have a valid parent in order to connect to its broadcast manager
...
void CCurveEditorPanel::SetTitle(tukk szTitle)
{
...
{
	DRX_ASSERT(event.type() == BroadcastEvent::EditCurve);
