...
public:
	...
	virtual bool MouseCallback(CViewport* view, EMouseEvent event, CPoint& point, i32 flags) = 0;
	...
	virtual bool OnKeyDown(CViewport* view, u32 nChar, u32 nRepCnt, u32 nFlags) { return false; }
	...
	virtual bool OnDragEvent(CViewport* view, EDragEvent eventId, QEvent* event, u32 flags) { return false; }
	...
	//TODO : these two helper methods were added for DrxDesigner support, remove if possible
	...
	CDrxSignal<void(CEditTool*)> signalPropertiesChanged;
