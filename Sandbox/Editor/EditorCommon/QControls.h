...
Q_SIGNALS:
	...
	void OnSliderRelease(i32 value);
	// called on slider press
	void OnSliderPress(i32 value);
	void OnSliderChanged(i32 value);
...
protected:
	...
	i32k     m_delta;       // constant update time
	i32           m_elapsedTime; // In ms. Needed because QTimer doesn't track elapsed time
	bool          m_bLoading;
};
