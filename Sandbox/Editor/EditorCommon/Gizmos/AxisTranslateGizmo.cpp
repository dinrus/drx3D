...
void CAxisTranslateGizmo::SetName(tukk sName)
{
	m_name = sName;
}

tukk CAxisTranslateGizmo::GetName()
{
	return m_name.c_str();
}
...
bool CAxisTranslateGizmo::MouseCallback(IDisplayViewport* view, EMouseEvent event, CPoint& point, i32 nFlags)
{
