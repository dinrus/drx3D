...
public:
	...
	virtual bool     MouseCallback(IDisplayViewport* view, EMouseEvent event, CPoint& point, i32 nFlags);
	virtual void     SetCustomTransform(bool on, const Matrix34& m);

	bool NeedsSnappingGrid() const override;

	void BeginMoveDrag(IDisplayViewport* view, CGizmo* gizmo, const Vec3& initialPosition, const CPoint& point, i32 nFlags);
	void MoveDragging(IDisplayViewport* view, CGizmo* gizmo, const Vec3& offset, const CPoint& point, i32 nFlags);

	void BeginRotateDrag(IDisplayViewport* view, CGizmo* gizmo, const CPoint& point, i32 nFlags);
	void RotateDragging(IDisplayViewport* view, CGizmo* gizmo, const AngleAxis& rotationAxis, const CPoint& point, i32 nFlags);

	void BeginScaleDrag(IDisplayViewport* view, CGizmo* gizmo, const CPoint& point, i32 nFlags);
	void ScaleDragging(IDisplayViewport* view, CGizmo* gizmo, float scale, const CPoint& point, i32 nFlags);

	void EndDrag(IDisplayViewport* view, CGizmo* gizmo, const CPoint& point, i32 nFlags);
