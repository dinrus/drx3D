...
void CTransformManipulator::UpdateGizmos()
{
	...
	i32 nEditMode = GetIEditor()->GetEditMode();
...
//////////////////////////////////////////////////////////////////////////
bool CTransformManipulator::MouseCallback(IDisplayViewport* view, EMouseEvent event, CPoint& point, i32 nFlags)
{
...
void CTransformManipulator::BeginMoveDrag(IDisplayViewport* view, CGizmo* gizmo, const Vec3& initialPosition, const CPoint& point, i32 nFlags)
{
...
void CTransformManipulator::MoveDragging(IDisplayViewport* view, CGizmo* gizmo, const Vec3& offset, const CPoint& point, i32 nFlags)
{
	Vec2i ipoint(point.x, point.y);
	signalDragging(view, this, ipoint, offset, nFlags);
}

void CTransformManipulator::BeginRotateDrag(IDisplayViewport* view, CGizmo* gizmo, const CPoint& point, i32 nFlags)
{
	GetIEditor()->GetIUndoManager()->Begin();
	m_bDragging = true;
	m_cMouseDownPos = point;
...
void CTransformManipulator::RotateDragging(IDisplayViewport* view, CGizmo* gizmo, const AngleAxis& rotationAxis, const CPoint& point, i32 nFlags)
{
...
void CTransformManipulator::BeginScaleDrag(IDisplayViewport* view, CGizmo* gizmo, const CPoint& point, i32 nFlags)
{
	GetIEditor()->GetIUndoManager()->Begin();
	m_bDragging = true;
	m_cMouseDownPos = point;
...
void CTransformManipulator::ScaleDragging(IDisplayViewport* view, CGizmo* gizmo, float scale, const CPoint& point, i32 nFlags)
{
...
void CTransformManipulator::EndDrag(IDisplayViewport* view, CGizmo* gizmo, const CPoint& point, i32 nFlags)
{
	if (m_bDragging)
	{
		m_bDragging = false;
