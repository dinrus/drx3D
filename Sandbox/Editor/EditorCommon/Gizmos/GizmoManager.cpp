...
//////////////////////////////////////////////////////////////////////////
i32 CGizmoManager::GetGizmoCount() const
{
	return (i32)m_gizmos.size();
}

//////////////////////////////////////////////////////////////////////////
CGizmo* CGizmoManager::GetGizmoByIndex(i32 nIndex) const
{
	i32 nCount = 0;
...
bool CGizmoManager::HandleMouseInput(IDisplayViewport* view, EMouseEvent event, CPoint& point, i32 flags)
{
