...
void CTreeViewDialog::Initialize(QAbstractItemModel* pModel, i32 filterColumn, const std::vector<i32>& visibleColumns)
{
	...
	i32k count = pProxy->columnCount(QModelIndex());
	for (i32 i = 1; i < count; ++i)
	{
		m_pTreeView->SetColumnVisible(i, false);
	}
	for (i32 i : visibleColumns)
	{
