...
public slots:
	void StartFileMonitor(i32 handle, const SFileFilter& filter, const FileMonitorPtr&);
	void StopFileMonitor(i32 handle);

	void StartSubTreeMonitor(i32 handle, const SFileFilter& filter, const SubTreeMonitorPtr&);
