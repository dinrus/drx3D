...
public:
	...
	static constexpr i32 s_IconOverrideRole = Qt::UserRole + 2202;
	static constexpr i32 s_DrawRectOverrideRole = s_IconOverrideRole + 1;

	QAdvancedItemDelegate(QAbstractItemView* view);

	void SetColumnBehavior(i32 i, BehaviorFlags behavior);
	bool TestColumnBehavior(i32 i, BehaviorFlags behavior);
...
private:
	...
	QMap<i32, BehaviorFlags> m_columnBehavior;
	QAbstractItemView*       m_view;
	bool                     m_dragChecking;
	i32                      m_dragCheckButtons;
	i32                      m_dragColumn;
