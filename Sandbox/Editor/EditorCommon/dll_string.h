...
public:
	...
	static const u64 kGranularity = 32;
	...
	i32 compare(const dll_string_tpl<T>& rhs) const
	{
...
private:
	...
	static i32 strcompare(const T* s1, const T* s2, size_type len)
	{
		for (/**/; len != 0; --len)
		{
			const T c1 = *s1;
