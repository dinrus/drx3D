...
#define REGISTER_POLLED_KEY(moduleName, keyName, description, shortcut)                                                               \
  ...
  REGISTER_ONLY_PYTHON_COMMAND(Private_DrxCommand::SetPolledKey ## moduleName ## keyName, moduleName, keyName, description);          \
  REGISTER_EDITOR_COMMAND_SHORTCUT(moduleName, keyName, shortcut);

#define GET_POLLED_KEY(moduleName, keyName) Private_DrxCommand::g_bPolledKey ## moduleName ## keyName
