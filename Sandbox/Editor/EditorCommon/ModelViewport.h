...
{
public:
	CModelViewport(tukk settingsPath = R"(Settings/CharacterEditorUserOptions)");
	virtual ~CModelViewport() override;

	static bool           IsPreviewableFileType(tukk szPath);
	...
	virtual void  PlayAnimation(tukk szName);
...
protected:
	...
	void         SetConsoleVar(tukk var, i32 value);
...
protected:
	...
	virtual bool OnKeyDown(u32 nChar, u32 nRepCnt, u32 nFlags) override;
