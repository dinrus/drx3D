...
public:
	...
	void setAutoExpandDepth(i32 depth) { m_autoExpandDepth = depth; }

	//! Legacy method
	void setExpandLevels(i32 depth) { setAutoExpandDepth(depth); }
...
private:
	...
	void SetSplitterPosition(i32 pos);
	...
	i32 GetAutoExpandDepth() const { return m_autoExpandDepth; }
