...
struct IDrawContext
{
	...
	virtual void drawControlButton(const Rect& rect, tukk text, i32 buttonFlags, property_tree::Font font, const Color* colorOverride = 0) = 0;
	virtual void drawButton(const Rect& rect, tukk text, i32 buttonFlags, property_tree::Font font, const Color* colorOverride = 0) = 0;
	...
	virtual void drawComboBox(const Rect& rect, tukk text, bool disabled) = 0;
	virtual void drawEntry(const Rect& rect, tukk text, bool pathEllipsis, bool grayBackground, i32 trailingOffset) = 0;
	...
	virtual void drawButtonWithIcon(const Icon&, const Rect& rect, tukk text, i32 buttonFlags, property_tree::Font font) = 0;
	virtual void drawLabel(tukk text, Font font, const Rect& rect, bool selected, bool disabled) = 0;
	virtual void drawNumberEntry(tukk text, const Rect& rect, i32 fieldFlags, double minValue, double maxValue) = 0;
	virtual void drawPlus(const Rect& rect, bool expanded, bool selected, bool grayed) = 0;
	virtual void drawGroupBox(const Rect& rect, i32 headerHeight) = 0;
	virtual void drawSplitter(const Rect& rect) = 0;
	virtual void drawSelection(const Rect& rect, bool inlinedRow) = 0;
	virtual void drawValueText(bool highlighted, tukk text) = 0;
