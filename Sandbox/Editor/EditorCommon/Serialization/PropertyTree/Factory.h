...
public:
    ...
    _Product* createByIndex(i32 index, Constructor ctor = Constructor()) const{
...
#define DECLARE_SEGMENT(fileName) i32 dataSegment##fileName; 

#define FORCE_SEGMENT(fileName) \
	extern i32 dataSegment##fileName; \
	i32* dataSegmentPtr##fileName = &dataSegment##fileName;
