...
bool PropertyRowBool::assignToPrimitive(uk object, size_t size) const
{
...
bool PropertyRowBool::assignToByPointer(uk instance, const yasli::TypeID& type) const
{
...
i32 PropertyRowBool::widgetSizeMin(const PropertyTree* tree) const
{
