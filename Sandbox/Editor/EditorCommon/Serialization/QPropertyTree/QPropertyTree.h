...
#include <drx3D/CoreX/Serialization/yasli/Object.h>
...
public:
	...
	void show();
	void move(i32 deltaX, i32 deltaY);
	void hide();
...
public:
	...
	void _drawRowValue(QPainter& p, tukk text, const QFont* font, const QRect& rect, const QColor& color, bool pathEllipsis, bool center) const;
	i32 _updateHeightsTime() const{ return updateHeightsTime_; }
	i32 _paintTime() const{ return paintTime_; }
...
protected:
	...
	bool canBePasted(tukk destinationType) override;
	...
	void startFilter(tukk filter) override;
	...
	void drawFilteredString(QPainter& p, tukk text, RowFilter::Type type, const QFont* font, const QRect& rect, const QColor& color, bool pathEllipsis, bool center) const;
...
protected:
	...
	i32 aggregatedMouseEventCount_;
	QScopedPointer<QMouseEvent> lastMouseMoveEvent_;

	i32 updateHeightsTime_;
	i32 paintTime_;
	bool sizeToContent_;
	QSize contentSize_;
