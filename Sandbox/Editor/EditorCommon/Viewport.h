...
public:
	 ...
	 */
	void SetViewportId(i32 id) { m_nCurViewportID = id; };

	/** Get ID of this viewport
	 */
	i32 GetViewportId() { return m_nCurViewportID; };
	...
	virtual void  GetDimensions(i32* pWidth, i32* pHeight) const;
	...
	virtual void            SetResolution(i32 x, i32 y)               {}
	virtual void            GetResolution(i32& x, i32& y);
	...
	virtual void          UpdateContent(i32 flags);
	...
	virtual Vec3 WorldToView3D(const Vec3& wp, i32 nFlags = 0) const;
	...
	virtual Vec3 MapViewToCP(CPoint point, i32 axis, bool aSnapToTerrain = false, float aTerrainOffset = 0.f);
	...
	virtual Vec3 GetCPVector(const Vec3& p1, const Vec3& p2, i32 axis);
	...
	i32           GetAxisConstrain() const { return GetIEditor()->GetAxisConstrains(); };
	...
	virtual bool HitTestLine(const Vec3& lineP1, const Vec3& lineP2, const CPoint& hitpoint, i32 pixelRadius, float* pToCameraDistance = 0) const;
	...
	//////////////////////////////////////////////////////////////////////////
	virtual void            MakeSnappingGridPlane(i32 axis);
	...
	virtual bool MouseCallback(EMouseEvent event, CPoint& point, i32 flags);
	// Process key events in viewport
	virtual bool OnKeyDown(u32 nChar, u32 nRepCnt, u32 nFlags);
	virtual bool OnKeyUp(u32 nChar, u32 nRepCnt, u32 nFlags);

	virtual bool DragEvent(EDragEvent eventId, QEvent* event, i32 flags);
	...
	virtual tukk GetCameraMenuName() const
	{
		return m_name.c_str();
	};
	...
	virtual void OnFilterDrxInputEvent(DrxInputEvent* evt) {};
...
protected:
	...
	i32                m_nLastUpdateFrame;
	i32                m_nLastMouseMoveFrame;
