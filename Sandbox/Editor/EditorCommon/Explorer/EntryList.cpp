...
EntryBase* EntryListBase::GetBaseByName(tukk name) const
{
...
EntryBase* EntryListBase::GetBaseByPath(tukk path) const
{
...
EntryId EntryListBase::RemoveByPath(tukk path)
{
	EntryId id = 0;
