...
public:
	...
	i32             widgetSizeMin(const PropertyTree* tree) const override { return 36; }
...
public:
	...
	i32  widgetSizeMin(const PropertyTree* tree) const override { return 40; }
	...
	void redraw(property_tree::IDrawContext& context)
	{
		...
		i32 buttonFlags = BUTTON_CENTER_TEXT;
		if (pressed)
			buttonFlags |= BUTTON_PRESSED;
		if (selected())
			buttonFlags |= BUTTON_FOCUSED;
