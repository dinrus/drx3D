...
{
	static i32k s_maxRecentFiles = 10;
...
void CEditor::AddToMenu(CAbstractMenu* pMenu, tukk command)
{
...
QAction* CEditor::GetAction(tukk command)
{
...
void CEditor::AddToMenu(const MenuItems* items, i32 count)
{
...
void CEditor::AddToMenu(tukk menuName, tukk command)
{
...
CAbstractMenu* CEditor::GetMenu(tukk menuName)
{
...
void CEditor::AddRecentFile(const QString& filePath)
{
	...
	i32 index = recent.indexOf(filePath);
	if (index > -1)
	{
