...
public: 
	...
	PopulateInspectorEvent(const TCallback& factory, tukk szTitle = "")
		: BroadcastEvent(BroadcastEvent::PopulateInspector)
		, m_factory(factory)
		, m_szTitle(szTitle) {}

	tukk GetTitle() const { return m_szTitle.c_str(); }
...
class EDITOR_COMMON_API DrxInputEvent : public SandboxEvent
{
public:
	DrxInputEvent(SInputEvent* pInput);
