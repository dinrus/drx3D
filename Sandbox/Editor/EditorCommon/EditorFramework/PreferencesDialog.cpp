...
QPreferencePage::QPreferencePage(std::vector<SPreferencePage*> preferences, tukk path, QWidget* pParent/* = nullptr*/)
	: QWidget(pParent)
	, m_path(path)
{
...
void QPreferencesDialog::OnPreferencePageSelected(tukk path)
{
