...
void CEventLoopHandler::AddNativeHandler(uintptr_t id, std::function <bool(uk , long*)> callback)
{
...
bool CEventLoopHandler::nativeEventFilter(const QByteArray &eventType, uk message, long *result)
{
