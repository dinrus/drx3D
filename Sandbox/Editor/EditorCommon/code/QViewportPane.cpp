...
{
//////////////////////////////////////////////////////////////////////////
inline u32 GetMouseFlags(Qt::MouseButtons buttons, Qt::KeyboardModifiers modifiers)
{
	u32 nFlags = 0;
...
//////////////////////////////////////////////////////////////////////////
inline u32 GetWheelFlags(QWheelEvent* event)
{
	u32 nFlags = 0;
...
//////////////////////////////////////////////////////////////////////////
inline u32 GetKeyFlags(QKeyEvent* event)
{
	u32 nFlags = 0;
	if (event->modifiers() & Qt::Modifier::CTRL)
		nFlags |= MK_CONTROL;
...
void QViewportWidget::keyPressEvent(QKeyEvent* event)
{
	...
	{
		i32 nChar = event->key();
		i32 nRepCnt = event->isAutoRepeat() ? 1 : 0;
...
void QViewportWidget::customEvent(QEvent* evt)
{
	...
	if (evt->type() == SandboxEvent::DrxInput)
	{
		DrxInputEvent* e = static_cast<DrxInputEvent*>(evt);
		m_viewport->OnFilterDrxInputEvent(e);
	}
}
...
i32 QAspectLayout::count() const
{
	return (m_child != nullptr) ? 1 : 0;
}

QLayoutItem* QAspectLayout::itemAt(i32 i) const
{
	return (i == 0) ? m_child : nullptr;
}

QLayoutItem* QAspectLayout::takeAt(i32 i)
{
	if (i == 0)
	{
			...
			case CViewport::EResolutionMode::Stretch:
				{
					...
					if (ownAspect > viewportAspect)
					{
						startY = 0;
						endY = height;
						i32 screenWidth = viewportAspect * height;
					...
					else
					{
						startX = 0;
						endX = width;
						i32 screenHeight = width / viewportAspect;
