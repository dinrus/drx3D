...
uk CRenderViewport::m_currentContextWnd = 0;
...
//////////////////////////////////////////////////////////////////////////
void CRenderViewport::OnFilterDrxInputEvent(DrxInputEvent* evt)
{
...
//////////////////////////////////////////////////////////////////////////
static i32 OnPaintFilter(u32 code, struct _EXCEPTION_POINTERS* ep)
{
...
//////////////////////////////////////////////////////////////////////////
void CRenderViewport::UpdateContent(i32 flags)
{
...
CBaseObject* CRenderViewport::GetCameraObject() const
{
	...
	{
		DrxGUID delegateGUID = m_pCameraDelegate->GetActiveCameraObjectGUID();
		pCameraObject = GetIEditor()->GetObjectManager()->FindObject(delegateGUID);
	}
	else if (m_cameraObjectId != DrxGUID::Null())
	{
...
void CRenderViewport::RenderCursorString()
{
	...
	IRenderAuxText::Draw2dLabel(point.x + 12, point.y + 4, 1.2f, col, false, "%s", (tukk)m_cursorStr);
}
...
void CRenderViewport::Accelerate(i32k acceleration)
{
	SetCameraMoveSpeedIncrements(m_moveSpeedIncrements + acceleration, true);
}

void CRenderViewport::SetCameraMoveSpeedIncrements(i32 sp, bool bnotify)
{
	...
	i32 maxsteps = log(9999) / log(1.1) + 0.5;
...
//////////////////////////////////////////////////////////////////////////
tukk CRenderViewport::GetCameraMenuName() const
{
...
void CRenderViewport::ProcessKeys()
{
	...
	const bool pressedF = DrxGetAsyncKeyState('F');
	if (bCtrl && DrxGetAsyncKeyState('G'))
	{
...
Vec3 CRenderViewport::WorldToView3D(const Vec3& wp, i32 nFlags) const
{
	Vec3 out(0, 0, 0);
...
void CRenderViewport::SetResolution(i32 x, i32 y)
{
...
void CRenderViewport::GetResolution(i32& x, i32& y)
{
...
{
	if (m_cameraObjectId != DrxGUID::Null() || GetCameraObject() || m_pCameraDelegate)
		return false;
...
void CRenderViewport::OnResizeInternal(i32 width, i32 height)
{
...
void CRenderViewport::OnResize()
{
	...
	i32 width = rcClient.Width();
	i32 height = rcClient.Height();
...
//////////////////////////////////////////////////////////////////////////
bool CRenderViewport::MouseCallback(EMouseEvent event, CPoint& point, i32 flags)
{
