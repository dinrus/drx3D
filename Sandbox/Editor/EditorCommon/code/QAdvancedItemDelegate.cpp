...
void QAdvancedItemDelegate::SetColumnBehavior(i32 i, BehaviorFlags behavior)
{
	m_columnBehavior[i] = behavior;
}

bool QAdvancedItemDelegate::TestColumnBehavior(i32 i, BehaviorFlags behavior)
{
...
Qt::CheckState QAdvancedItemDelegate::Check(QAbstractItemModel* model, const QModelIndex& index)
{
	...
	static QVector<i32> roles(1, Qt::CheckStateRole);
