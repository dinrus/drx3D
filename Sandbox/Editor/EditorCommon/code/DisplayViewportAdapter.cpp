...
bool CDisplayViewportAdapter::HitTestLine(const Vec3& lineP1, const Vec3& lineP2, const CPoint& hitpoint, i32 pixelRadius, float* pToCameraDistance) const
{
...
void CDisplayViewportAdapter::GetDimensions(i32* width, i32* height) const
{
	if (width)
