...
//////////////////////////////////////////////////////////////////////////
void CViewport::GetDimensions(i32* pWidth, i32* pHeight) const
{
	if (pWidth)
...
void CViewport::GetResolution(i32& x, i32& y)
{
	CRect rectViewport;
...
//////////////////////////////////////////////////////////////////////////
void CViewport::UpdateContent(i32 flags)
{
...
void CViewport::Update()
{
	...
	bSpaceClick = DrxGetAsyncKeyState(VK_SPACE);
...
//////////////////////////////////////////////////////////////////////////
Vec3 CViewport::WorldToView3D(const Vec3& wp, i32 nFlags) const
{
...
//////////////////////////////////////////////////////////////////////////
void CViewport::MakeSnappingGridPlane(i32 axis)
{
	CPoint cursor;
	GetCursorPos(&cursor);
...
//////////////////////////////////////////////////////////////////////////
Vec3 CViewport::MapViewToCP(CPoint point, i32 axis, bool aSnapToTerrain, float aTerrainOffset)
{
...
//////////////////////////////////////////////////////////////////////////
Vec3 CViewport::GetCPVector(const Vec3& p1, const Vec3& p2, i32 axis)
{
	Vec3 v = p2 - p1;
...
//////////////////////////////////////////////////////////////////////////
void CViewport::SetAxisConstrain(i32 axis)
{
	m_activeAxis = axis;
};
...
//////////////////////////////////////////////////////////////////////////
bool CViewport::HitTestLine(const Vec3& lineP1, const Vec3& lineP2, const CPoint& hitpoint, i32 pixelRadius, float* pToCameraDistance) const
{
...
//////////////////////////////////////////////////////////////////////////
bool CViewport::MouseCallback(EMouseEvent event, CPoint& point, i32 flags)
{
	...
	// Concrete example: DrxPhysics called from Trackview causing an assert, and moving the cursor over the viewport
	// would cause the editor to freeze as it calls DrxPhysics again for a raycast while it didn't release the lock.
...
bool CViewport::DragEvent(EDragEvent eventId, QEvent* event, i32 flags)
{
	if (GetIEditor()->IsInGameMode())
	{
		return true;
...
//////////////////////////////////////////////////////////////////////////
bool CViewport::OnKeyDown(u32 nChar, u32 nRepCnt, u32 nFlags)
{
	if (GetIEditor()->IsInGameMode())
	{
...
//////////////////////////////////////////////////////////////////////////
bool CViewport::OnKeyUp(u32 nChar, u32 nRepCnt, u32 nFlags)
{
	if (GetIEditor()->IsInGameMode())
	{
		// Ignore key downs while in game.
