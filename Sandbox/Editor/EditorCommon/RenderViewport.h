...
public:
	...
	virtual void            SetResolution(i32 x, i32 y) override;
	virtual void            GetResolution(i32& x, i32& y) override;
	...
	CDrxSignal<void()> signalResolutionChanged;
	...
	virtual void        SetCameraMoveSpeedIncrements(i32 sp, bool bnotify = false);
	virtual void		OnCameraSpeedChanged() {}

	virtual tukk GetCameraMenuName() const override;
	...
	virtual void  OnFilterDrxInputEvent(DrxInputEvent* evt) override;
...
protected:
	...
	void             Accelerate(i32k acceleration);
	...
	void         OnMenuCommandChangeAspectRatio(u32 commandId);
	...
	void         ResizeView(i32 width, i32 height);
...
protected:
	...
	mutable DrxGUID        m_cameraObjectId;
	...
	mutable i32               m_numSkipEnts;

	bool                      m_isOnPaint;
	static CRenderViewport*   m_pPrimaryViewport;

	static uk              m_currentContextWnd;
...
protected:
	...
	virtual void OnResizeInternal(i32 width, i32 height);
	...
	i32  m_pendingResizeWidth;
	i32  m_pendingResizeHeight;
