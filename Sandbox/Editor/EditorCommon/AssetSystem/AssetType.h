...
public:
	...
	virtual tukk GetUiTypeName() const = 0;
	...
	virtual tukk GetFileExtension() const = 0;
	...
	bool Create(tukk szFilepath, ukk pTypeSpecificParameter = nullptr) const;
	...
	virtual CAssetEditor* Edit(CAsset* asset) const { DRX_ASSERT(0); /*not implemented*/ return nullptr; }
	...
	virtual bool RenameAsset(CAsset* pAsset, tukk szNewName) const;
	...
	virtual bool MoveAsset(CAsset* pAsset, tukk szDestinationFolder, bool bMoveSourcefile) const;
	...
	virtual bool CopyAsset(CAsset* pAsset, tukk szNewPath) const;
	...
	virtual void GenerateThumbnail(const CAsset* pAsset) const { DRX_ASSERT(0); }
	//! @name Importing
	//! @{
	...
	//! @see CBaseObject
	virtual tukk GetObjectClassName() const { return nullptr; }
	...
	virtual DrxIcon GetIconInternal() const;
...
private:
	...
	//! \sa CAssetType::Create
	virtual bool OnCreate(CEditableAsset& editAsset, ukk pTypeSpecificParameter) const { DRX_ASSERT(0); /*not implemented*/ return false; }
...
#define DECLARE_ASSET_TYPE_DESC(type)                           \
  virtual tukk ClassName() override { return # type; } \
  virtual uk CreateObject() override { return nullptr; }
