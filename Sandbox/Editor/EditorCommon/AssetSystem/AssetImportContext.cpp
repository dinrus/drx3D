...
} //endns Private_AssetImportContext
...
string CAssetImportContext::GetOutputFilePath(tukk szExt) const
{
...
uk CAssetImportContext::GetSharedPointer(const string& key) const
{
