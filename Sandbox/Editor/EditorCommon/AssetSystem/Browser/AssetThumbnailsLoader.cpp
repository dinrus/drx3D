...
} //endns Private_AssetThumbnailsLoader
...
{
	DRX_ASSERT(pGenerateThumbnais);
	DRX_ASSERT(pGenerateThumbnais->GetType() == CVAR_INT);
	DRX_ASSERT(strcmp(pGenerateThumbnais->GetName(), "ed_generateThumbnails") == 0);
