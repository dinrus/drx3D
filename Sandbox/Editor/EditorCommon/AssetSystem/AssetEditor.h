...
public:
	...
	static CAssetEditor* OpenAssetForEdit(tukk editorClassName, CAsset* asset);

	//! Must declare which asset type can be handled by this editor
	CAssetEditor(tukk assetType, QWidget* pParent = nullptr);
	...
	CDrxSignal<void(CAsset*)> signalAssetClosed;
...
protected:
	...
	virtual void OnAssetChanged(CAsset& asset, i32 changeFlags);
...
private:
	...
	void InitNewMenu();
	i32 GetNewableAssetCount() const;
