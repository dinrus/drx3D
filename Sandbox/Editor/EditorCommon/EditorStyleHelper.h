...
public:
	...
	// QTreeView
	STYLE_PROP(i32, treeViewItemMarginTop, treeViewItemMarginTop);
	...
	STYLE_PROP(i32, toolTipMarginTop, setToolTipMarginTop);
	STYLE_PROP(i32, toolTipMarginLeft, setToolTipMarginLeft);
	STYLE_PROP(i32, toolTipMarginRight, setToolTipMarginRight);
	STYLE_PROP(i32, toolTipMarginBottom, setToolTipMarginBottom);
