...
public:
	...
	virtual void      SetUiDescription(tukk module, tukk name, const CUiCommand::UiInfo& info) const = 0;
	virtual bool      UnregisterCommand(tukk cmdFullName) = 0;
	virtual bool      IsRegistered(tukk module, tukk name) const = 0;
	virtual bool      IsRegistered(tukk cmdLine) const = 0;
	virtual CCommand* GetCommand(tukk cmdFullName) const = 0;
	...
	virtual QAction*  GetAction(tukk cmdFullName, tukk text = nullptr) const = 0;
...
{
bool RegisterCommand(ICommandManager* pCmdMgr, tukk szModule, tukk szName, const CCommandDescription& description, const Functor0& functor);
template<typename RT>
bool RegisterCommand(ICommandManager* pCmdMgr, tukk szModule, tukk szName, const CCommandDescription& description, const Functor0wRet<RT>& functor);
template<LIST(1, typename P)>
bool RegisterCommand(ICommandManager* pCmdMgr, tukk szModule, tukk szName, const CCommandDescription& description, const Functor1<LIST(1, P)>& functor);
template<LIST(1, typename P), typename RT>
bool RegisterCommand(ICommandManager* pCmdMgr, tukk szModule, tukk szName, const CCommandDescription& description, const Functor1wRet<LIST(1, P), RT>& functor);
template<LIST(2, typename P)>
bool RegisterCommand(ICommandManager* pCmdMgr, tukk szModule, tukk szName, const CCommandDescription& description, const Functor2<LIST(2, P)>& functor);
template<LIST(2, typename P), typename RT>
bool RegisterCommand(ICommandManager* pCmdMgr, tukk szModule, tukk szName, const CCommandDescription& description, const Functor2wRet<LIST(2, P), RT>& functor);
template<LIST(3, typename P)>
bool RegisterCommand(ICommandManager* pCmdMgr, tukk szModule, tukk szName, const CCommandDescription& description, const Functor3<LIST(3, P)>& functor);
template<LIST(3, typename P), typename RT>
bool RegisterCommand(ICommandManager* pCmdMgr, tukk szModule, tukk szName, const CCommandDescription& description, const Functor3wRet<LIST(3, P), RT>& functor);
template<LIST(4, typename P)>
bool RegisterCommand(ICommandManager* pCmdMgr, tukk szModule, tukk szName, const CCommandDescription& description, const Functor4<LIST(4, P)>& functor);
template<LIST(4, typename P), typename RT>
bool RegisterCommand(ICommandManager* pCmdMgr, tukk szModule, tukk szName, const CCommandDescription& description, const Functor4wRet<LIST(4, P), RT>& functor);
template<LIST(5, typename P)>
bool RegisterCommand(ICommandManager* pCmdMgr, tukk szModule, tukk szName, const CCommandDescription& description, const Functor5<LIST(5, P)>& functor);

namespace Private
{
template<typename FunctorType, typename CommandType>
bool        RegisterCommand(ICommandManager* pCmdMgr, tukk szModule, tukk szName, const CCommandDescription& description, const FunctorType& functor);

inline void DefaultDelete(uk p)
{
	delete p;
}
}
...
template<typename FunctorType, typename CommandType>
bool CommandManagerHelper::Private::RegisterCommand(ICommandManager* pCmdMgr, tukk szModule, tukk szName, const CCommandDescription& description, const FunctorType& functor)
{
	DRX_ASSERT(functor);
	if (!functor)
	{
...
inline bool CommandManagerHelper::RegisterCommand(ICommandManager* pCmdMgr, tukk szModule, tukk szName, const CCommandDescription& description, const Functor0& functor)
{
	return Private::RegisterCommand<Functor0, CCommand0>(pCmdMgr, szModule, szName, description, functor);
}

template<typename RT>
bool CommandManagerHelper::RegisterCommand(ICommandManager* pCmdMgr, tukk szModule, tukk szName, const CCommandDescription& description, const Functor0wRet<RT>& functor)
{
	return Private::RegisterCommand<Functor0wRet<RT>, CCommand0wRet<RT>>(pCmdMgr, szModule, szName, description, functor);
}

template<LIST(1, typename P)>
bool CommandManagerHelper::RegisterCommand(ICommandManager* pCmdMgr, tukk szModule, tukk szName, const CCommandDescription& description, const Functor1<LIST(1, P)>& functor)
{
	return Private::RegisterCommand<Functor1<LIST(1, P)>, CCommand1<LIST(1, P)>>(pCmdMgr, szModule, szName, description, functor);
}

template<LIST(1, typename P), typename RT>
bool CommandManagerHelper::RegisterCommand(ICommandManager* pCmdMgr, tukk szModule, tukk szName, const CCommandDescription& description, const Functor1wRet<LIST(1, P), RT>& functor)
{
...
template<LIST(2, typename P)>
bool CommandManagerHelper::RegisterCommand(ICommandManager* pCmdMgr, tukk szModule, tukk szName, const CCommandDescription& description, const Functor2<LIST(2, P)>& functor)
{
	return Private::RegisterCommand<Functor2<LIST(2, P)>, CCommand2<LIST(2, P)>>(pCmdMgr, szModule, szName, description, functor);
}

template<LIST(2, typename P), typename RT>
bool CommandManagerHelper::RegisterCommand(ICommandManager* pCmdMgr, tukk szModule, tukk szName, const CCommandDescription& description, const Functor2wRet<LIST(2, P), RT>& functor)
{
...
template<LIST(3, typename P)>
bool CommandManagerHelper::RegisterCommand(ICommandManager* pCmdMgr, tukk szModule, tukk szName, const CCommandDescription& description, const Functor3<LIST(3, P)>& functor)
{
	return Private::RegisterCommand<Functor3<LIST(3, P)>, CCommand3<LIST(3, P)>>(pCmdMgr, szModule, szName, description, functor);
}

template<LIST(3, typename P), typename RT>
bool CommandManagerHelper::RegisterCommand(ICommandManager* pCmdMgr, tukk szModule, tukk szName, const CCommandDescription& description, const Functor3wRet<LIST(3, P), RT>& functor)
{
...
template<LIST(4, typename P)>
bool CommandManagerHelper::RegisterCommand(ICommandManager* pCmdMgr, tukk szModule, tukk szName, const CCommandDescription& description, const Functor4<LIST(4, P)>& functor)
{
	return Private::RegisterCommand<Functor4<LIST(4, P)>, CCommand4<LIST(4, P)>>(pCmdMgr, szModule, szName, description, functor);
}

template<LIST(4, typename P), typename RT>
bool CommandManagerHelper::RegisterCommand(ICommandManager* pCmdMgr, tukk szModule, tukk szName, const CCommandDescription& description, const Functor4wRet<LIST(4, P), RT>& functor)
{
...
template<LIST(5, typename P)>
bool CommandManagerHelper::RegisterCommand(ICommandManager* pCmdMgr, tukk szModule, tukk szName, const CCommandDescription& description, const Functor5<LIST(5, P)>& functor)
{
...
#define REGISTER_EDITOR_UI_COMMAND_DESC(moduleName, functionName, buttonText, shortcut, icon)                                     \
  namespace Private_DrxUiCommandDesc                                                                                              \
  {                                                                                                                               \
