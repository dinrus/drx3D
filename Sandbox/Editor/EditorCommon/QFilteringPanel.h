...
public:
	...
	QFilteringPanel(tukk uniqueName, QAttributeFilterProxyModel* pModel, QWidget* pParent = nullptr);
	...
	CDrxSignal<void()> signalOnFiltered;
...
private:
	...
	void             SaveFilter(tukk filterName);
	void             LoadFilter(const QString& filter);
	void             DeleteFilter(tukk filterName);
	void             RenameFilter(tukk filterName, tukk filterNewName);
