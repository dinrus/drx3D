...
//////////////////////////////////////////////////////////////////////////
void CObjectArchive::SetResolveCallback(CBaseObject* fromObject, const DrxGUID& objectId, ResolveObjRefFunctor1& func)
{
	if (objectId == DrxGUID::Null())
	{
		func(0);
		return;
	}

	DrxGUID guid(objectId);
	if (m_nFlags & eObjectLoader_ReconstructPrefabs)
	{
		for (i32 i = 0, iLoadedObjectsSize(m_loadedObjects.size()); i < iLoadedObjectsSize; ++i)
		{
			DrxGUID guidInPrefab;
...
//////////////////////////////////////////////////////////////////////////
void CObjectArchive::SetResolveCallback(CBaseObject* fromObject, const DrxGUID& objectId, ResolveObjRefFunctor2& func, u32 userData)
{
	if (objectId == DrxGUID::Null())
	{
		func(0, userData);
...
//////////////////////////////////////////////////////////////////////////
DrxGUID CObjectArchive::ResolveID(const DrxGUID& id)
{
...
{
	i32 numObjects = rootObjectsNode->getChildCount();
...
void CObjectArchive::SerializeObjects(bool processEvents)
{
	...
	//////////////////////////////////////////////////////////////////////////
	i32 numObj = m_loadedObjects.size();
	for (i32 i = 0; i < numObj; i++)
	{
...
void CObjectArchive::ResolveObjectsGuids()
{
	for (Callbacks::iterator it = m_resolveCallbacks.begin(); it != m_resolveCallbacks.end(); it++)
	{
		...
		DrxGUID objectId = ResolveID(it->first);
		...
		if (!pObject)
		{
			...
			DrxWarning(VALIDATOR_MODULE_EDITOR, VALIDATOR_ERROR, "Unresolved ObjectID: %s, Referenced from Object %s", 
				objectId.ToString(), (tukk)from);
...
//////////////////////////////////////////////////////////////////////////
void CObjectArchive::RemapID(DrxGUID oldId, DrxGUID newId)
{
...
//////////////////////////////////////////////////////////////////////////
void CObjectArchive::AddSequenceIdMapping(u32 oldId, u32 newId)
{
	assert(oldId != newId);
...
//////////////////////////////////////////////////////////////////////////
u32 CObjectArchive::RemapSequenceId(u32 id) const
{
	std::map<u32, u32>::const_iterator itr = m_sequenceIdRemap.find(id);
...
//////////////////////////////////////////////////////////////////////////
bool CObjectArchive::IsAmongPendingIds(u32 id) const
{
