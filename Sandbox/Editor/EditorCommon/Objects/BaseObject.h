...
{
	DrxGUID              m_modifiedObjectGuidInPrefab; //! The object that was modified identified by guid in the prefab
	DrxGUID              m_modifiedObjectGlobalId;     //! The object id globally unique and used in ObjectManager
	...
	SObjectChangedContext(EObjectChangedOpType optype) : m_modifiedObjectGuidInPrefab(DrxGUID::Null()), m_modifiedObjectGlobalId(DrxGUID::Null()), m_operation(optype) { m_localTM.SetIdentity(); }
	SObjectChangedContext() : m_modifiedObjectGuidInPrefab(DrxGUID::Null()), m_modifiedObjectGlobalId(DrxGUID::Null()), m_operation(eOCOT_Empty) { m_localTM.SetIdentity(); }
};
...
public:
	...
	void Render(const Matrix34& tm, i32 objType = eStatObject_Anchor)
	{
...
public:
	...
	//	tukk GetTypeName() const { return m_classDesc->ClassName(); };
	...
	static bool   FilterByLayer(CBaseObject const& obj, uk pLayer);
	...
	void ClearFlags(i32 flags) { m_flags &= ~flags; };
	bool CheckFlags(i32 flags) const { return (m_flags & flags) != 0; };
	...
	i32  GetTextureIcon() const { return m_nTextureIcon; }
	void SetTextureIcon(i32 nTexIcon) { m_nTextureIcon = nTexIcon; }
	...
	const DrxGUID& GetId() const { return m_guid; };

	//////////////////////////////////////////////////////////////////////////
	// Prefabs support
	//////////////////////////////////////////////////////////////////////////
	//! To identify an object WHITHIN a prefab uniquely use this GUID
	const DrxGUID& GetIdInPrefab() const { return m_guidInPrefab; }
	void           SetIdInPrefab(const DrxGUID& guid) { m_guidInPrefab = guid; }
	...
	//! Change name of object.
	inline void  SetName(tukk name) { SetName(string(name)); } // for CString conversion
	//! Set object name and make sure it is unique.
	void         SetUniqName(const string& name);
	//! Set object name and make sure it is unique.
	inline void  SetUniqName(tukk name) { SetUniqName(string(name)); } // for CString conversion

	//////////////////////////////////////////////////////////////////////////
	// Geometry.
	//////////////////////////////////////////////////////////////////////////
	//! Set object position.
	bool SetPos(const Vec3& pos, i32 flags = 0);

	//! Set object rotation angles.
	bool SetRotation(const Quat& rotate, i32 flags = 0);

	//! Set object scale.
	bool SetScale(const Vec3& scale, i32 flags = 0);
	...
	virtual void SetWorldPos(const Vec3& pos, i32 flags = 0);
	...
	virtual void SetWorldTM(const Matrix34& tm, i32 flags = 0);

	//! Set object xform.
	virtual void SetLocalTM(const Matrix34& tm, i32 flags = 0);

	// Set object xform.
	virtual void SetLocalTM(const Vec3& pos, const Quat& rotate, const Vec3& scale, i32 flags = 0);
	...
	void StoreUndo(tukk undoDescription, bool minimal = false, i32 flags = 0);
	...
	//////////////////////////////////////////////////////////////////////////
	virtual void SetMaterialLayersMask(u32 nLayersMask) { m_nMaterialLayersMask = nLayersMask; }
	u32       GetMaterialLayersMask() const             { return m_nMaterialLayersMask; };

	//////////////////////////////////////////////////////////////////////////
	// Object minimal usage spec (All/Low/Medium/High)
	//////////////////////////////////////////////////////////////////////////
	u32       GetMinSpec() const { return m_nMinSpec; }
	...
	virtual bool StartSubObjSelection(i32 elemType)                                                                 { return false; };
...
protected:
	 ...
	 */
	//virtual void SetId( u32 objectId ) { m_id = objectId; };
	...
	void         DrawTextOn2DBox(DisplayContext& dc, const Vec3& pos, tukk text, float textScale, const ColorF& TextColor, const ColorF& TextBackColor);
	...
	CBaseObject* FindObject(DrxGUID id) const;
	...
	i32         GetTextureIconFlags()   { return m_nIconFlags; };
...
private:
	...
	// auto resolving
	void OnMtlResolved(u32 id, bool success, tukk orgName, tukk newName);
	...
	void         SetMaterialByName(tukk mtlName);

	virtual void OnLink(CBaseObject* pParent) {}
	virtual void OnUnLink()                   {}

	void         SetId(DrxGUID guid)          { m_guid = guid; }
...
private:
	...
	// Flags and bit masks.
	//////////////////////////////////////////////////////////////////////////
	mutable u32 m_bMatrixInWorldSpace    : 1;
	mutable u32 m_bMatrixValid           : 1;
	mutable u32 m_bWorldBoxValid         : 1;
	u32         m_bUseMaterialLayersMask : 1;
	bool           m_bSuppressUpdatePrefab  : 1;
	u32         m_nMaterialLayersMask    : 8;
	u32         m_nMinSpec               : 8;
...
public:
	...
	CBaseObject* GetObject(i32 nIndex) const { return m_objects[nIndex]; }
	void         AddObject(CBaseObject* pObject) { m_objects.push_back(pObject); }
	void         ClearObjects() { m_objects.clear(); }
	void         Reserve(i32 nCount) { m_objects.reserve(nCount); }
private:
