...
void SViewportDebugPreferences::SetDebugFlags(i32 flags)
{
	debugFlags = flags;
...
void SViewportDebugPreferences::SetObjectHideMask(i32 hideMask)
{
...
{
	colorPrefabBBox = ColorB(u32(RGB(214, 172, 5)), geomAlpha);
	colorGroupBBox = ColorB(u32(RGB(0, 255, 0)), geomAlpha);
	colorEntityBBox = ColorB(u32(RGB(112, 117, 102)), geomAlpha);
	geometryHighlightColor = ColorB(u32(RGB(220, 220, 220)), geomAlpha);
	geometrySelectionColor = ColorB(u32(RGB(255, 146, 21)), geomAlpha);
	solidBrushGeometryColor = ColorB(u32(RGB(192, 0, 192)), geomAlpha);
}
