	...
	: QWidget(pParent)
{
	...
	pClearAll->setIcon(DrxIcon("icons:General/Element_Clear.ico"));
	...
	pShowCompleteHistory->setIcon(DrxIcon("icons:Dialogs/show_log.ico"));
	...
	pCopyHistory->setIcon(DrxIcon("icons:General/Copy.ico"));
	...
	m_pShowInfo->setIcon(DrxIcon("icons:Dialogs/dialog-question.ico"));
	...
	m_pShowWarnings->setIcon(DrxIcon("icons:Dialogs/dialog-warning.ico"));
	...
	m_pShowErrors->setIcon(DrxIcon("icons:Dialogs/dialog-error.ico"));
	...
	m_pFilterModel->setSortRole(static_cast<i32>(CNotificationModel::Roles::SortRole));
	...
	i32 columnCount = m_pNotificationModel->columnCount();
...
void CNotificationHistory::OnContextMenu(const QPoint& pos) const
{
	...
	QAction* action = menu->addAction(DrxIcon("icons:General/Copy.ico"), tr("Copy"));
