...
public:
	...
	//Note that DrxENGINE may intentionally override default shortcuts from Qt and use its own semantics for standard keys. This is not meant to be a 1 to 1 mapping
	...
	static StandardKey StringToStandardKey(tukk str);
