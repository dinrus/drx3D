...
public:
	...
	CItemModelAttribute(tukk szName, EAttributeType type, Visibility visibility = Visibility::Visible, bool filterable = true, QVariant defaultFilterValue = QVariant())
		: m_name(szName)
		, m_type(type)
...
{
public:
	CItemModelAttributeEnum(tukk szName, QStringList enumEntries, Visibility visibility = CItemModelAttribute::Visible, bool filterable = true, QVariant defaultFilterValue = QVariant());
	CItemModelAttributeEnum(tukk szName, tuk* enumEntries, i32 enumEntryCount, Visibility visibility = CItemModelAttribute::Visible, bool filterable = true, QVariant defaultFilterValue = QVariant());

	//! commaSeparatedString needs to be in the form "value1,value2,value3"
	CItemModelAttributeEnum(tukk szName, tuk commaSeparatedString, Visibility visibility = CItemModelAttribute::Visible, bool filterable = true, QVariant defaultFilterValue = QVariant());
...
{
public:
	CItemModelAttributeEnumFunc(tukk szName, std::function<QStringList()> populateFunc, Visibility visibility = CItemModelAttribute::Visible, bool filterable = true, QVariant defaultFilterValue = QVariant());
...
{
public:
	CItemModelAttributeEnumT(tukk szName, Visibility visibility = CItemModelAttribute::Visible, bool filterable = true, QVariant defaultFilterValue = QVariant())
...
constexpr i32 s_getAttributeRole = Qt::UserRole + 1984;
...
constexpr i32 s_attributeMenuPathRole = Qt::UserRole + 1985;
}
