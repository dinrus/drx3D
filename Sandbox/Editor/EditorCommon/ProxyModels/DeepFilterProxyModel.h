...
protected:
	...
	virtual bool filterAcceptsRow(i32 sourceRow, const QModelIndex& sourceParent) const final;
...
protected:
	...
	virtual bool rowMatchesFilter(i32 sourceRow, const QModelIndex& sourceParent) const;
