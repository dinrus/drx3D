...
} //endns CAbstractMultiProxyModelHelper_Private
...
CAbstractMultiProxyModelHelper::Connections CAbstractMultiProxyModelHelper::ConnectSourceModel(const SourceModel* pSourceModel, QObject* pParent)
{
	...
	connections << QObject::connect(pSourceModel, &QAbstractItemModel::dataChanged, pParent, [this](const QModelIndex& topLeft, const QModelIndex& bottomRight, const QVector<i32>& roles)
	{
	...
	connections << QObject::connect(pSourceModel, &QAbstractItemModel::rowsAboutToBeInserted, pParent, [this, pSourceModel](const QModelIndex& sourceParent, i32 first, i32 last)
	{
	...
	connections << QObject::connect(pSourceModel, &QAbstractItemModel::rowsInserted, pParent, [this, pSourceModel](const QModelIndex& sourceParent, i32 first, i32 last)
	{
		if (IsSourceIndexMapped(pSourceModel, sourceParent))
		{
	...
	connections << QObject::connect(pSourceModel, &QAbstractItemModel::rowsAboutToBeRemoved, pParent, [this, pSourceModel](const QModelIndex& sourceParent, i32 first, i32 last)
	{
		if (IsSourceIndexMapped(pSourceModel, sourceParent))
		{
	...
	connections << QObject::connect(pSourceModel, &QAbstractItemModel::rowsRemoved, pParent, [this, pSourceModel](const QModelIndex& sourceParent, i32 first, i32 last)
	{
		if (IsSourceIndexMapped(pSourceModel, sourceParent))
		{
	...
	connections << QObject::connect(pSourceModel, &QAbstractItemModel::rowsAboutToBeMoved, pParent, [this, pSourceModel, getMoveSituation](const QModelIndex& sourceParent, i32 sourceStart, i32 sourceEnd, const QModelIndex& destinationParent, i32 destinationRow)
	{
	...
	connections << QObject::connect(pSourceModel, &QAbstractItemModel::rowsMoved, pParent, [this, pSourceModel, getMoveSituation](const QModelIndex& sourceParent, i32 sourceStart, i32 sourceEnd, const QModelIndex& destinationParent, i32 destinationRow)
	{
		switch (m_storedMovedSituation)
		{
		case eMoveSourceValid:
	...
	{
		DRX_ASSERT("TODO"); // setup your columns before connecting the models!
	});
