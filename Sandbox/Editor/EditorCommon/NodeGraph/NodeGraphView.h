...
public:
	...
	void                       SetZoom(i32 percentZoom);
	i32                      GetZoom() const { return m_currentScalePercent; }
...
protected:
	...
	void                                  SetAction(u32 action, bool abortCurrent = true);
	u32                                GetAction() const { return m_action; }
...
public:
	void RegisterConnectionEventListener(DrxGraphEditor::IConnectionEventsListener* pListener);
	void RemoveConnectionEventListener(DrxGraphEditor::IConnectionEventsListener* pListener);

	void SendBeginCreateConnection(QWidget* pSender, DrxGraphEditor::SBeginCreateConnectionEventArgs& args);
	void SendEndCreateConnection(QWidget* pSender, DrxGraphEditor::SEndCreateConnectionEventArgs& args);

private:
	std::set<DrxGraphEditor::IConnectionEventsListener*> m_connectionEventListeners;
	// ~TODO
