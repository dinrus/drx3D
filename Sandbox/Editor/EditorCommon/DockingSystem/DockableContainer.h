...
public:
	...
	QWidget* SpawnWidget(QString name, IToolWindowArea* area = nullptr, QToolWindowAreaReference reference = QToolWindowAreaReference::Combine, i32 index = -1, QRect geometry = QRect());
	...
	void SetSplitterSizes(QWidget* widget, QList<i32> sizes);
...
private:
	...
	QWidget* SpawnWidget(QString name, QString forceObjectName, IToolWindowArea* area = nullptr, QToolWindowAreaReference reference = QToolWindowAreaReference::Combine, i32 index = -1, QRect geometry = QRect());
