...
QWidget* CDockableContainer::SpawnWidget(QString name, IToolWindowArea* area /*= nullptr*/, QToolWindowAreaReference reference /*= QToolWindowAreaTarget::Combine*/, i32 index /*= -1*/, QRect geometry /*= QRect()*/)
{
	return SpawnWidget(name, "", area, reference, index, geometry);
}

QWidget* CDockableContainer::SpawnWidget(QString name, QString objectName, IToolWindowArea* area /*= nullptr*/, QToolWindowAreaReference reference /*= QToolWindowManager::AreaReference::Combine*/, i32 index /*= -1*/, QRect geometry /*= QRect()*/)
{
...
void CDockableContainer::SetSplitterSizes(QWidget* widget, QList<i32> sizes)
{
...
void CDockableContainer::BuildWindowMenu()
{
	...
	i32 sec = m_pMenu->GetNextEmptySection();
