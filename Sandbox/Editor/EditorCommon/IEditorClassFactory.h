...
struct IClassDesc
{
	...
	virtual uk CreateObject() { return nullptr; }
	...
	//! create panel.
	virtual tukk    Category() { return nullptr; }
...
public:
	...
	virtual IClassDesc* FindClass(tukk pClassName) const = 0;
	...
	virtual void        GetClassesByCategory(tukk pCategory, std::vector<IClassDesc*>& rOutClasses) = 0;
};
