...
CObjectCreateTreeWidget::CObjectCreateTreeWidget(CObjectClassDesc* pClassDesc, tukk szRegExp, QWidget* pParent)
	...
	, m_pClassDesc(pClassDesc)
{
	...
	m_pShowPreviewButton->setIcon(DrxIcon("icons:General/Visibility_False.ico"));
	...
	{
		UpdatePreviewWidget();
		m_pShowPreviewButton->setIcon(m_pShowPreviewButton->isChecked() ? DrxIcon("icons:General/Visibility_True.ico") : DrxIcon("icons:General/Visibility_False.ico"));
