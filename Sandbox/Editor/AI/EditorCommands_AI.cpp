...
{
	void PySetNavigationUpdate(i32 updateType)
	{
	...
	void PyRegenerateMNMType(tukk type)
	{
...
void PySetDebugAgentType(i32k typeIdx)
{
...
void PyRegenerateAgentTypeLayer(i32k typeIdx)
{
	CAIManager* manager = GetIEditorImpl()->GetAI();
...
REGISTER_PYTHON_COMMAND_WITH_EXAMPLE(Private_EditorCommands::PySetNavigationUpdate, ai, set_navigation_update_type,
	...
	"ai.set_navigation_update_type(i32 updateType)");
