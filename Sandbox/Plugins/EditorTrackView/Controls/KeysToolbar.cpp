	...
	: CTrackViewCoreComponent(pTrackViewCore, false)
{
	...
	pNoSnapping->setIcon(DrxIcon("icons:Trackview/No_Snapping.ico"));
	...
	pKeySnapping->setIcon(DrxIcon("icons:Trackview/Key_Snapping.ico"));
	...
	pTimeSnapping->setIcon(DrxIcon("icons:Trackview/Time_Snapping.ico"));
	...
	addAction(DrxIcon("icons:Trackview/Go_To_Prev_Key.ico"), "Go to previous Key", this, SLOT(OnGoToPreviousKey()));
	addAction(DrxIcon("icons:Trackview/Go_To_Next_Key.ico"), "Go to next Key", this, SLOT(OnGoToNextKey()));
	...
	pSlideAction->setIcon(DrxIcon("icons:Trackview/trackview_keys-slide.ico"));
	...
	pScaleAction->setIcon(DrxIcon("icons:Trackview/trackview_keys-scale.ico"));
	...
	addSeparator();
	addAction(DrxIcon("icons:Trackview/Sync_Selected_Tracks_To_Base_Pos.ico"), "Sync selected Tracks to Base Position", this, SLOT(OnSyncSelectedTracksToBase()));
	addAction(DrxIcon("icons:Trackview/Sync_Selected_Tracks_From_Base_Pos.ico"), "Sync selected Tracks from Base Position", this, SLOT(OnSyncSelectedTracksFromBase()));
}
