...
protected:
	virtual tukk GetDescription() override { return "Undo Sequence Settings"; };
...
protected:
	...
	virtual tukk GetDescription() override { return "Undo Sequence Key Selection"; };
...
protected:
	virtual tukk GetDescription() override { return "Undo Track Modify"; };
...
protected:
	virtual tukk GetDescription() override { return "Undo Add Sequence"; };
...
protected:
	virtual tukk GetDescription() override { return "Undo Remove Sequence"; };
...
protected:
	virtual tukk GetDescription() override { return "Undo Add TrackView Node"; };
...
protected:
	virtual tukk GetDescription() override { return "Undo Remove TrackView Node"; };
...
public:
	...
	virtual tukk GetDescription() override { return "Undo Detach Anim Entity"; };
...
protected:
	virtual tukk GetDescription() override { return "Undo Add TrackView Track"; };
...
protected:
	virtual tukk GetDescription() override { return "Undo Remove TrackView Track"; };
...
protected:
	virtual tukk GetDescription() override { return "Undo Reparent TrackView Node"; };
...
protected:
	virtual tukk GetDescription() override { return "Undo Rename TrackView Node"; };
...
protected:
	virtual tukk GetDescription() override { return "Undo Disable TrackView Node"; };
