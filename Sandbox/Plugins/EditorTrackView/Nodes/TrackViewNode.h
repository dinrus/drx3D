...
public:
	...
	CTrackViewKeyConstHandle(const CTrackViewTrack* pTrack, u32 keyIndex)
...
public:
	...
	u32                GetIndex() const { return m_keyIndex; }
...
public:
	...
	virtual u32        GetKeyCount() const = 0;
	virtual CTrackViewKeyHandle GetKey(u32 index) = 0;
...
public:
	...
	virtual u32        GetKeyCount() const override          { return m_keys.size(); }
	virtual CTrackViewKeyHandle GetKey(u32 index) override   { return m_keys[index]; }
...
public:
	...
	virtual bool        SetName(tukk pName) { return false; };
	...
	// Children
	u32    GetChildCount() const              { return m_childNodes.size(); }
	CTrackViewNode* GetChild(u32 index) const { return m_childNodes[index].get(); }
