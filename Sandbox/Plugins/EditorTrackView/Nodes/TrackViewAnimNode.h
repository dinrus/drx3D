...
{
public:
	u32              GetCount() const                        { return m_animNodes.size(); }
	CTrackViewAnimNode*       GetNode(u32k index)       { return m_animNodes[index]; }
	const CTrackViewAnimNode* GetNode(u32k index) const { return m_animNodes[index]; }
...
// will not destroy the DrxMovie track
//
////////////////////////////////////////////////////////////////////////////
...
public:
	...
	// Name setter/getter
	virtual tukk GetName() const override { return m_pAnimNode->GetName(); }
	...
	CTrackViewAnimNodeBundle GetAnimNodesByName(tukk pName);
	...
	CTrackViewTrack* GetTrackForParameter(const CAnimParamType& paramType, u32 index = 0) const;
	...
	CAnimParamType                  GetParamType(u32 index) const;
	tuk                           GetParamName(const CAnimParamType& paramType) const;
	...
	virtual DrxGUID GetGUID() const override { return m_pAnimNode->GetGUID(); }
