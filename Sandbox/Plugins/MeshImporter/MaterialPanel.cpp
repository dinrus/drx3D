...
void CMaterialPanel::GenerateMaterial(uk pUserData)
{
	m_pMaterialGenerator->GenerateMaterial(pUserData);
}

void CMaterialPanel::GenerateMaterial(const QString& mtlFilePath, uk pUserData)
{
	m_pMaterialGenerator->GenerateMaterial(QtUtil::ToString(mtlFilePath), pUserData);
}

void CMaterialPanel::GenerateTemporaryMaterial(uk pUserData)
{
	m_pMaterialGenerator->GenerateTemporaryMaterial(pUserData);
}

void CMaterialPanel::OnMaterialCreated(CMaterial* pMtl, uk pUserData)
{
	if (!pMtl)
	{
		return;
