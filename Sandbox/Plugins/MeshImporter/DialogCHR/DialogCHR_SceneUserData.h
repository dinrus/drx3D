...
public:
	...
	{
		DRX_ASSERT(!pMeshNode || pMeshNode->numMeshes);
	...
	CDrxSignal<void()> sigJointProxyChanged;
	CDrxSignal<void()> sigJointLimitsChanged;
...
struct SBlockSignals
{
	...
	CDrxSignal<void()> m_oldJointProxyChanged;
	CDrxSignal<void()> m_oldJointDataChanged;
};
