...
uk CRcInOrderCaller::GetUserData() const
{
	return m_pUserData;
}

void CRcInOrderCaller::CallRc(const QString& filePath, uk pUserData, ITaskHost* pTaskHost, const QString& options, const QString& message)
{
