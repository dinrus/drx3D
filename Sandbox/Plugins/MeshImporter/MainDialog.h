...
public:
	...
	bool                CreateMetaData(FbxMetaData::SMetaData& metaData, const QString& sourceFilename, i32 flags = 0);
...
private:
	...
	virtual i32     GetOpenFileFormatFlags() override;
	...
	std::vector<i32>             m_nodeVisibilityMap;
