...
struct ITaskHost
{
	...
	// Called by tasks.
	virtual void SetProgress(CAsyncTaskBase* pTask, const QString& what, i32 progress) = 0;
...
protected:
	...
	virtual void OnTaskProgress(CAsyncTaskBase* pTask, const QString& what, i32 progress) = 0;
...
public:
	...
	virtual void SetProgress(CAsyncTaskBase* pTask, const QString& what, i32 progress) override;
...
public:
	...
	void        UpdateProgress(const QString& what, i32 progress);
...
public:
	...
	virtual void    OnTaskProgress(CAsyncTaskBase* pTask, const QString& message, i32 progress) override;
