...
static tukk s_settingsPropertyName = "displayOptions";

} //endns Private_DisplayOptions
...
void CDisplayOptionsWidget::SetUserOptions(const Serialization::SStruct& options, tukk szName, tukk szLabel)
{
