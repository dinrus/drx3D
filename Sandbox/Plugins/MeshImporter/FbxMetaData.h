...
#pragma once
#if !defined(DRX_PLATFORM) || (!defined(NOT_USE_DRX_STRING) && !defined(DRX_STRING))
...
{
// This must have been set by DrxString.h (via platform.h).
// We can't set any other type than this, as YASLI depends on using that exact type.
// TODO: Investigate if we can switch this to STxt and supply our own YASLI string wrappers (and drop the CE dependency entirely)
...
{
	for (i32 i = 0; i < eUnitSetting_COUNT; ++i)
	{
