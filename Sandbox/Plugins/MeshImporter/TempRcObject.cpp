...
void CTempRcObject::RcCaller_OnAssign(CRcInOrderCaller* pCaller, const QString& filePath, uk pUserData)
{
	using namespace Private_TempRcObject;
	std::unique_ptr<SRcPayload> pPayload((SRcPayload*)pUserData);

	DRX_ASSERT(m_pSceneManager);
