...
public:
	...
	virtual i32 GetOpenFileFormatFlags() override { return eFileFormat_I_CAF; }
...
private:
	...
	void RcCaller_ChrAssign(CRcInOrderCaller* pCaller, const QString& filePath, uk pUserData);
	void RcCaller_SkinAssign(CRcInOrderCaller* pCaller, const QString& filePath, uk pUserData);
	void AssignMaterial(CMaterial* pMat, uk pUserData);

	void SetupUI();

	bool IsCurrentScene(i32 sceneId) const;
