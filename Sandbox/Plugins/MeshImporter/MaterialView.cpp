	...
	: QAdvancedTreeView(QAdvancedTreeView::None, pParent), m_pModel(pModel)
{
	...
	{
		for (i32 i = 0; i < FbxTool::EMaterialPhysicalizeSetting_COUNT; ++i)
		{
			tukk const szName = FbxTool::MaterialPhysicalizeSettingToString(FbxTool::EMaterialPhysicalizeSetting(i));
