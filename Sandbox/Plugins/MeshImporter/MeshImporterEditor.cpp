...
public:
	...
	virtual tukk GetEditorName() const override { return m_title.c_str(); }
private:
	string m_title;
};
...
string PyGenerateCharacter(tukk filePath)
{
	string str(filePath);
...
void CEditorAdapter::Host_AddMenu(tukk menu)
{
	GetRootMenu()->CreateMenu(menu);
}

void CEditorAdapter::Host_AddToMenu(tukk menu, tukk command)
{
...
{
	DRX_ASSERT_MESSAGE(false, "Not implemented");
	return false;
}
