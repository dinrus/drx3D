...
struct IDialogHost
{
	...
	virtual void Host_AddMenu(tukk menu) = 0;
	virtual void Host_AddToMenu(tukk menu, tukk command) = 0;
};
...
protected:
	...
	QString ShowOpenFilePrompt(i32 fileFormatFlags);
public:
	...
	virtual tukk GetDialogName() const = 0;

	virtual i32              GetOpenFileFormatFlags() { return 0; }

	// IEditorNotifyListener implementation.
	virtual void           OnEditorNotifyEvent(EEditorNotifyEvent evt) override;

	virtual i32 GetToolButtons() const { return 0; }  // See EToolButtonFlags.
...
protected:
	...
	QString                ShowSaveAsFilePrompt(i32 fileFormat);
