...
public:
	PythonViewPaneWidget(PyObject* pWidgetType, tukk name) : IPane()
		, name(name)
	{
	...
	virtual tukk GetPaneTitle() const override { return name.c_str(); }
...
public:
	PythonViewPaneClass(PyObject* pWidgetType, tukk name, tukk category, bool needsMenuItem, tukk menuPath, bool unique)
		: IViewPaneClass()
	...
	virtual tukk    ClassName() override       { return name.c_str(); }
	virtual tukk    Category()  override       { return category.c_str(); }
	virtual bool           NeedsMenuItem()            { return needsMenuItem; }
	virtual tukk    GetMenuPath()              { return menuPath.c_str(); }
	virtual CRuntimeClass* GetRuntimeClass() override { return 0; }
	virtual tukk    GetPaneTitle() override    { return name.c_str(); }
