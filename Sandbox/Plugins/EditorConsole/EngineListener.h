...
protected:
	...
	static i32 StringCompare(tukk left, tukk right);

	//access the state lock
	DrxCriticalSection* GetLock() { return &m_lock; }
...
public:
	...
	void GetFilteredCVars(tukk contains, const std::function<void (ICVar*)>& function) const;
