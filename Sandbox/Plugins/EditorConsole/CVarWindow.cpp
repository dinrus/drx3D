...
{
	//load icons
	m_icons[SCVarItem::eType_Int] = QPixmap(QStringLiteral(":/i32.png"));
...
QVariant CCVarWindow::CCVarModel::data(const QModelIndex& index, i32 role) const
{
...
bool CCVarWindow::CCVarModel::setData(const QModelIndex& index, const QVariant& value, i32 role)
{
