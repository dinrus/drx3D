...
QVariant CNodesDictionaryCategory::GetColumnValue(i32 columnIndex) const
{
	switch (columnIndex)
	{
	case CNodesDictionary::eColumn_Name:
...
const CAbstractDictionaryEntry* CNodesDictionaryCategory::GetChildEntry(i32 index) const
{
