...
tukk CEffectAssetWidget::GetName() const
{
	DRX_ASSERT(m_pEffectAsset);
...
bool CEffectAssetWidget::MakeNewComponent(tukk szTemplateName)
{
	DRX_ASSERT(m_pEffectAsset);
...
{
	DRX_ASSERT(m_pEffectAssetModel);
