	...
	: m_pMatEd(pMatEd)
{
	...
	toolbar->addAction(DrxIcon("icons:material_editor/sphere.ico"), tr("Sphere Preview"), [this]() { SetPreviewModel("%EDITOR%/Objects/MtlSphere.cgf"); });
	toolbar->addAction(DrxIcon("icons:material_editor/cube.ico"), tr("Cube Preview"), [this]() { SetPreviewModel("%EDITOR%/Objects/MtlBox.cgf"); });
	toolbar->addAction(DrxIcon("icons:material_editor/plane.ico"), tr("Plane Preview"), [this]() { SetPreviewModel("%EDITOR%/Objects/MtlPlane.cgf"); });
	toolbar->addAction(DrxIcon("icons:material_editor/teapot.ico"), tr("Teapot Preview"), [this]() { SetPreviewModel("%EDITOR%/Objects/MtlTeapot.cgf"); });
	toolbar->addAction(DrxIcon("icons:General/Search.ico"), tr("Set Custom Preview Model..."), this, &CMaterialPreviewWidget::OnPickPreviewModel);
...
void CMaterialPreviewWidget::SetPreviewModel(tukk model)
{
