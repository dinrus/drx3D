...
#include <DrxSystem/IDrxPluginManager.h>
...
void CCSharpOutputWindow::GetLineRange(const string& text, i32 index, i32& lineStart, i32& lineEnd)
{
	lineStart = lineEnd = 0;
...
bool CCSharpOutputWindow::TryParseStackTraceLine(const string& line, string& path, i32& lineNumber)
{
	lineNumber = -1;
	path = "";
