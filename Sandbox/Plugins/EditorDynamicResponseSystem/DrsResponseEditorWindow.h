...
public:
	...
	bool Load(tukk szFilename);
	bool Save(tukk szFilename);
...
protected:
	...
	{
		signalNameWithCounter(tukk szSignalName) : signalName(szSignalName), counter(1) {}
		string signalName;
		i32    counter;
	};

	void FillWithSignals(DynArray<tukk >& elements);
