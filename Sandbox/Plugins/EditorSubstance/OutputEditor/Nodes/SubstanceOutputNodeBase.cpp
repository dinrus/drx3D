...
namespace EditorSubstance
{
	namespace OutputEditor
	{
		...
		CSubstanceOutputNodeBase::CSubstanceOutputNodeBase(const SSubstanceOutput& output, DrxGraphEditor::CNodeGraphViewModel& viewModel)
		...
		const DrxGraphEditor::PinItemArray& CSubstanceOutputNodeBase::GetPinItems() const
		{
			return m_pins;
		}
		...
		DrxGraphEditor::CNodeWidget* CSubstanceOutputNodeBase::CreateWidget(DrxGraphEditor::CNodeGraphView& view)
		{
