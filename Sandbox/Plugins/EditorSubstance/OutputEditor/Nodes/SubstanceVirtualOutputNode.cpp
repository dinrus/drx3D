...
#include "DrxSerialization/StringList.h"
...
namespace EditorSubstance
{
	namespace OutputEditor
	{
		...
		CVirtualOutputNode::CVirtualOutputNode(const SSubstanceOutput& output, DrxGraphEditor::CNodeGraphViewModel& viewModel)
		...
		void CVirtualOutputNode::HandleIndividualConnection(i32 pinIndex)
		{
			...
			i32 srcPinIndex = connectionInfo.node->GetPinItemIndex(*connectionInfo.pin);
		...
		ConnectionInfo CVirtualOutputNode::GetPinConnectionInfo(i32 index)
		{
