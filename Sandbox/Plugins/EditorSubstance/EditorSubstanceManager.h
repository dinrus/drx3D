...
enum DRX_SUBSTANCE_API EPixelFormat
{
	ePixelFormat_BC1,
	ePixelFormat_BC1a,
	ePixelFormat_BC3,
...
enum DRX_SUBSTANCE_API EColorSpace
{
	eColorSpaceSRGB,
	eColorSpaceLinear,
};

enum DRX_SUBSTANCE_API ETextureFlags
{
	TF_SRGB = 1,
	TF_DECAL = 2,
	TF_NORMALMAP = 4,
...
private:
	...
	std::unordered_map<u32, SInputImageRefCount> m_loadedImages;
};
