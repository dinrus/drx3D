...
struct AnimationSetFilter
{
	...
	bool Matches(tukk cafPath) const;
...
inline bool Serialize(IArchive& ar, SkeletonParametersInclude& ref, tukk name, tukk label)
{
...
struct SkeletonParameters
{
	...
	bool       LoadFromXMLFile(tukk filename, bool* dataLost = 0);
