...
public:
	...
	virtual tukk                       GetPaneTitle() const override        { return "Character Tool"; };
...
private:
	...
	void                SaveLayoutToFile(tukk filename);
	void                LoadLayoutFromFile(tukk filename);
	void                ResetLayout();
	void                Initialize();
	...
	i32                                        m_displayParametersSplitterWidths[2];
