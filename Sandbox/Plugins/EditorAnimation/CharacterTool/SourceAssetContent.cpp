...
struct CreateAssetManifestTask : IBackgroundTask
{
	...
	CreateAssetManifestTask(ExplorerFileList* sourceAssetList, tukk assetFilename, u32 entryId)
	...
	tukk ErrorMessage() const override { return ""; }
...
bool RCAssetLoader::Load(EntryBase* entryBase, tukk filename)
{
