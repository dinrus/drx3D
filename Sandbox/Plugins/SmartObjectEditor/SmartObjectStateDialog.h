...
private:
	...
	HTREEITEM AddItemInTreeCtrl(tukk name, const CString& location);
...
protected:
	...
	//	afx_msg void OnDrawItem( i32 id, LPDRAWITEMSTRUCT lpDrawItemStruct );
	//	afx_msg i32 OnCompareItem( i32 id, LPCOMPAREITEMSTRUCT lpCompareItemStruct );
