...
bool CLibraryAssetType::OnCreate(CEditableAsset& editAsset, ukk /*pTypeSpecificParameter*/) const
{
...
bool CLibraryAssetType::RenameAsset(CAsset* pAsset, tukk szNewName) const
{
	if (pAsset)
	{
...
DrxIcon CLibraryAssetType::GetIconInternal() const
{
	return DrxIcon("icons:schematyc/assettype_library.ico");
}
