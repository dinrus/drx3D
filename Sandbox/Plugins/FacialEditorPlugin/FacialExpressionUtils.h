...
public:
	...
	ControlledItemIterator  operator++(i32)                                 { ControlledItemIterator copy = *this; ++*this; return copy; }
...
i32                                                AddOrphansToGarbageFacialExpressionFolder(IFacialEffectorsLibrary* pLibrary);
i32                                                DeleteOrphans(IFacialEffectorsLibrary* pLibrary);
