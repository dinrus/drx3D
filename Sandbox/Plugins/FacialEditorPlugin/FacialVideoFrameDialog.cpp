...
void CFacialVideoFrameDialog::OnSize(UINT nType, i32 cx, i32 cy)
{
...
void CFacialVideoFrameDialog::OnPaint()
{
...

	{
		...
		dc.StretchBlt(
		  (client.left + client.right - i32(adjustedViewportWidth)) / 2,
		  (client.top + client.bottom - i32(adjustedViewportHeight)) / 2,
...
void CFacialVideoFrameDialog::SetResolution(i32 width, i32 height, i32 bpp)
{
...
uk CFacialVideoFrameDialog::GetBits()
{
	return m_image->GetBits();
}

i32 CFacialVideoFrameDialog::GetPitch()
{
