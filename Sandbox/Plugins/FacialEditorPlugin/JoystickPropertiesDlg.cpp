...
CJoystickPropertiesDlg::CJoystickPropertiesDlg(CWnd* pParent /*=NULL*/)
	: CDialog(IDD_FACEED_JOYSTICK_PROPERTIES, pParent)
{
...
void CJoystickPropertiesDlg::SetChannelName(i32 axis, const string& channelName)
{
	m_names[axis] = channelName;
}

void CJoystickPropertiesDlg::SetChannelFlipped(i32 axis, bool flipped)
{
	m_flippeds[axis] = flipped;
}

bool CJoystickPropertiesDlg::GetChannelFlipped(i32 axis) const
{
	return m_flippeds[axis];
}

void CJoystickPropertiesDlg::SetVideoScale(i32 axis, float offset)
{
	m_scales[axis] = offset;
}

float CJoystickPropertiesDlg::GetVideoScale(i32 axis) const
{
	return m_scales[axis];
}

void CJoystickPropertiesDlg::SetVideoOffset(i32 axis, float offset)
{
	m_offsets[axis] = offset;
}

float CJoystickPropertiesDlg::GetVideoOffset(i32 axis) const
{
	return m_offsets[axis];
}

void CJoystickPropertiesDlg::SetChannelEnabled(i32 axis, bool enabled)
{
