...
void CScrollableWindow::SetClientSize(u32 nWidth, u32 nHeight)
{
...
{
	i32 nCurPos = GetScrollPos(SB_HORZ);
	i32 nPrevPos = nCurPos;
	CRect oClientRect;
...
{
	i32 nCurPos = GetScrollPos(SB_VERT);
	i32 nPrevPos = nCurPos;
	CRect oClientRect;
...
void CScrollableWindow::OnSize(UINT nType, i32 cx, i32 cy)
{
	UpdateScrollBars();
