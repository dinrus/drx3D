...
public:
	...
	virtual void AcceptUndo(tukk name) = 0;
...
public:
	...
	virtual void AcceptUndo(tukk name);
...
private:
	...
	void                            RenderString(CDC& dc, tukk szString, const Vec2& position, i32 maxWidth, COLORREF colour);
