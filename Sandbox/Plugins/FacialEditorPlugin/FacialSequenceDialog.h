...
public:
	...
	void                            SetContext(CFacialEdContext* pContext);
	void                            LipSync(i32 waveformIndex);
	void                            RemoveSoundEntry(i32 waveformIndex);
	void                            ClearAllSoundEntries();
	IFacialAnimChannel*             GetLipSyncGroup();
	IFacialAnimChannel*             GetBakedLipSyncGroup();
	bool                            DoPhonemeExtraction(CString wavFile, CString strText, struct IFacialAnimSequence* pSeq, i32 soundEntryIndex);
	...
	virtual i32                  GetSplineCount() const;
	virtual i32                  GetKeyCountAtTime(float time, float threshold) const;
...
protected:
	...
	i32          OnCreateControl(LPCREATECONTROLSTRUCT lpCreateControl);

	//////////////////////////////////////////////////////////////////////////
	void SelectChannel(IFacialAnimChannel* pChannel, bool bExclusive);
	void SelectChannels(i32 numChannels, IFacialAnimChannel** ppChannels, bool bExclusive = true);
