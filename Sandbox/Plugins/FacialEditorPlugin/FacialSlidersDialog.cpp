...
//////////////////////////////////////////////////////////////////////////
CFacialSlidersDialog::CFacialSlidersDialog() : CDialog(IDD_DATABASE, NULL)
{
	m_pContext = 0;
	m_hAccelerators = 0;
}
...
//////////////////////////////////////////////////////////////////////////
void CFacialSlidersDialog::OnSize(UINT nType, i32 cx, i32 cy)
{
...
void CFacialSlidersDialog::RecalcLayout()
{
	if (m_tabCtrl.m_hWnd)
	{
		...
		i32 numItems = m_slidersCtrl[sel].GetItemCount();
		CRect rcSliderItem;
		...
		i32 tabHeaderHeight = irc.Height() + 2;
