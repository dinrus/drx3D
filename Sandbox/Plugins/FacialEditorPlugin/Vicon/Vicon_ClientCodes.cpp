...
//@}
	#endif
// DrxNet specific errors and messages
...
//////////////////////////////////////////////////////////////////////////
tukk CViconClient::GetErrorDescription(u32 nError)
{
	u32 nRes = MAKE_NRESULT(NET_FAIL, NET_FACILITY_SOCKET, nError);
	i32 n = 0;
...
//////////////////////////////////////////////////////////////////////////
void CViconClient::PrintErrorDescription(u32 nError)
{
	/*
	   u32 numJoints=sizeof(DefSkel)/sizeof(SDefaultJoint);

	   tukk szRes=GetErrorDescription(nError);
	   if (szRes)
