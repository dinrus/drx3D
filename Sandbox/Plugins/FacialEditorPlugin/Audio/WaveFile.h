...
public:
	...
	// Initialization
	VOID    Initialize(FOURCC fccChunkId, const RiffChunkMemory* pParentChunk, tukk pFileData, u32 nFileSize);
	HRESULT Open();
	BOOL    IsValid() const { return !!(m_dwFlags & RIFFCHUNK_FLAGS_VALID); }
...
{
	tukk     m_pFileData;          // Ptr to File data
	u32          m_nFileSize;          // Size of Sound file
...
public:
	...
	// Initialization
	HRESULT Init(tukk pFileData, u32 nFileSize);
