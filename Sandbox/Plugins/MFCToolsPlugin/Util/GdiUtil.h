...
public:
	...
	bool BlitTo(HDC hDestDC, i32 aDestX = 0, i32 aDestY = 0, i32 aDestWidth = -1, i32 aDestHeight = -1, i32 aSrcX = 0, i32 aSrcY = 0, i32 aRop = SRCCOPY);
	//! blit/copy the image from the canvas to other destination window
	bool BlitTo(HWND hDestWnd, i32 aDestX = 0, i32 aDestY = 0, i32 aDestWidth = -1, i32 aDestHeight = -1, i32 aSrcX = 0, i32 aSrcY = 0, i32 aRop = SRCCOPY);
	...
	bool GradientFillRect(CRect& rRect, COLORREF aStartColor, COLORREF aEndColor, i32 aFillType = GRADIENT_FILL_RECT_H);
	...
	bool BitBltWithAlpha(CDC& rBmpDC, i32 aDestX, i32 aDestY, i32 aDestWidth = -1, i32 aDestHeight = -1, i32 aSrcX = 0, i32 aSrcY = 0, i32 aSrcWidth = -1, i32 aSrcHeight = -1, BLENDFUNCTION* pBlendFunc = NULL);
	...
	void BreakTextByChars(tukk pText, string& rOutStr, const CRect& rRect);
	...
	void DrawBox(i32 aLeft, i32 aTop, i32 aWidth, i32 aHeight, COLORREF aFillColor1, COLORREF aFillColor2 = kDrawBoxSameColorAsFill,
...
public:
	...
	bool Load(tukk pFilename, bool bVerticalFlip = false);
	//! save a bitmap to a file
	bool Save(tukk pFileName);
	...
	bool     Create(uk pData, UINT aWidth, UINT aHeight, bool bVerticalFlip = false, bool bPremultiplyAlpha = false);
...
private:
	i32  GetEncoderClsid(tukk format, CLSID* pClsid) const;
	bool GetCLSIDObjFromFileExt(tukk fileName, CLSID* pClsid) const;
