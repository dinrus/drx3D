...
//////////////////////////////////////////////////////////////////////////
BOOL CMFCUtils::LoadTrueColorImageList(CImageList& imageList, UINT nIDResource, i32 nIconWidth, COLORREF colMaskColor)
{
	CBitmap bitmap;
	BITMAP bmBitmap;
	...
	i32 nCount = cSize.cx / nIconWidth;
	if (!imageList)
	{
...
//////////////////////////////////////////////////////////////////////////
void CMFCUtils::TransparentBlt(HDC hdcDest, i32 nXDest, i32 nYDest, i32 nWidth, i32 nHeight, HBITMAP hBitmap, i32 nXSrc, i32 nYSrc,
...
//////////////////////////////////////////////////////////////////////////
void CMFCUtils::LoadShortcuts(CXTPCommandBars* pCommandBars, UINT nMenuIDResource, tukk pSectionNameForLoading)
{
...
//////////////////////////////////////////////////////////////////////////
void CMFCUtils::ShowShortcutsCustomizeDlg(CXTPCommandBars* pCommandBars, UINT nMenuIDResource, tukk pSectionNameForSaving)
{
	if (pCommandBars != NULL)
	{
		...
		for (i32 i = 0; i < dlg.GetPageCount(); ++i)
			dlg.RemovePage(i);
...
//////////////////////////////////////////////////////////////////////////
void CMFCUtils::ImportShortcuts(CXTPShortcutManager* pShortcutMgr, tukk pSectionNameForSaving)
{
	CSystemFileDialog::RunParams params;
	params.extensionFilters = CExtensionFilter::Parse("HOT Files (*.hot)|*.hot||");
...
IVariable* CMFCUtils::GetChildVar(const IVariable* array, tukk name, bool recursive /*= false*/)
{
...
bool CMFCUtils::ExecuteConsoleApp(const string& CommandLine, string& OutputText, bool bNoTimeOut /*= false*/, bool bShowWindow /*= false*/)
{
	...
	DrxLog("Executing console application '%s'", (tukk)CommandLine);
	...
	char cmdLine[1024];
	drx_strcpy(cmdLine, CommandLine);
