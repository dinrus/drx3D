...
{
	i32k nMin = GetRangeMin();
	i32k nMax = GetRangeMax() + 1;
	CRect rc;
	GetChannelRect(rc);
	double dPos;
	...
	i32 nNewPos = (i32)(nMin + (nMax - nMin) * dPos + dCorrectionFactor);
...
//////////////////////////////////////////////////////////////////////////
void CSliderCtrlEx::PostMessageToParent(i32k nTBCode)
{
	if (m_noNotify)
		return;
	...
	if (pWnd)
	{
		i32 nMsg = (GetStyle() & TBS_VERT) ? WM_VSCROLL : WM_HSCROLL;
...
//////////////////////////////////////////////////////////////////////////
i32 CSliderCtrlCustomDraw::ValueToPos(i32 x)
{
	CRect trc;
	GetThumbRect(trc);
...
//////////////////////////////////////////////////////////////////////////
void CSliderCtrlCustomDraw::DrawTick(CDC* pDC, i32 x, bool bMajor)
{
	i32 s = (bMajor) ? 10 : 6;
...
void CSliderCtrlCustomDraw::DrawTicks(CDC* pDC)
{
	...
	if (GetStyle() & TBS_AUTOTICKS)
	{
		...
		if (m_tickFreq < 1)
			m_tickFreq = 1;
		for (i32 i = r0; i < r1; i += m_tickFreq)
		{
			if (bBottom)
			{
				i32 x = ValueToPos(i);
...
//////////////////////////////////////////////////////////////////////////
void CSliderCtrlCustomDraw::SetSelection(i32 nMin, i32 nMax)
{
