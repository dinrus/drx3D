...
//  Copyright (C), DinrusPro 3D, 1999-2013
////////////////////////////////////////////////////////////////////////////
...
public:
	...
	void       LoadFile(tukk modelFile, bool changeCamera = true);
	void       LoadParticleEffect(IParticleEffect* pEffect);
	Vec3       GetSize() const       { return m_size; };
	tukk GetLoadedFile() const { return m_loadedFile.GetString(); }
	...
	typedef void (* CameraChangeCallback)(uk m_userData, CPreviewModelCtrl* m_currentCamera);
	void SetCameraChangeCallback(CameraChangeCallback callback, uk userData) { m_cameraChangeCallback = callback, m_pCameraChangeUserData = userData; }
...
protected:
	...
	afx_msg virtual i32  OnCreate(LPCREATESTRUCT lpCreateStruct);
	...
	afx_msg virtual void OnSize(UINT nType, i32 cx, i32 cy);
