...
//////////////////////////////////////////////////////////////////////////
void CSplineCtrl::OnSize(UINT nType, i32 cx, i32 cy)
{
...
//////////////////////////////////////////////////////////////////////////
CPoint CSplineCtrl::KeyToPoint(i32 nKey)
{
	if (nKey >= 0)
	{
...
//////////////////////////////////////////////////////////////////////////
float CSplineCtrl::XOfsToTime(i32 x)
{
...
//////////////////////////////////////////////////////////////////////////
CPoint CSplineCtrl::XOfsToPoint(i32 x)
{
...
void CSplineCtrl::DrawGrid(CDC* pDC)
{
	...
	i32 cx = m_rcSpline.Width();
	i32 cy = m_rcSpline.Height();
...
/////////////////////////////////////////////////////////////////////////////
void CSplineCtrl::SetActiveKey(i32 nIndex)
{
	ClearSelection();
...
void CSplineCtrl::TrackKey(CPoint point)
{
	...
	if (nKey >= 0)
	{
		...
		{
			i32 first = 0;
			i32 last = m_pSpline->GetKeyCount() - 1;
			if (nKey == first)
...
//////////////////////////////////////////////////////////////////////////
void CSplineCtrl::RemoveKey(i32 nKey)
{
	if (!m_pSpline)
		return;
	if (nKey)
...
//////////////////////////////////////////////////////////////////////////
i32 CSplineCtrl::InsertKey(CPoint point)
{
...
void CSplineCtrl::ToggleKeySlope(i32 nIndex, i32 nDir)
{
	if (nIndex >= 0)
	{
		i32 flags = m_pSpline->GetKeyFlags(nIndex);
		if (nDir <= 0)
			// Toggle left side.
...
//////////////////////////////////////////////////////////////////////////
void CSplineCtrl::SendNotifyEvent(i32 nEvent)
{
	NMHDR nmh;
	nmh.hwndFrom = m_hWnd;
	nmh.idFrom = ::GetDlgCtrlID(m_hWnd);
