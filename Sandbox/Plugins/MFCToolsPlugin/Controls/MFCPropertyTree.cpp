...
i32 CMFCPropertyTree::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void CMFCPropertyTree::OnSize(UINT nType, i32 cx, i32 cy)
{
...
void CMFCPropertyTree::SetExpandLevels(i32 expandLevels)
{
