...
//////////////////////////////////////////////////////////////////////////
void CColorGradientCtrl::OnSize(UINT nType, i32 cx, i32 cy)
{
...
//////////////////////////////////////////////////////////////////////////
CPoint CColorGradientCtrl::KeyToPoint(i32 nKey)
{
	if (nKey >= 0)
	{
...
//////////////////////////////////////////////////////////////////////////
float CColorGradientCtrl::XOfsToTime(i32 x)
{
...
//////////////////////////////////////////////////////////////////////////
CPoint CColorGradientCtrl::XOfsToPoint(i32 x)
{
	return TimeToPoint(XOfsToTime(x));
}

//////////////////////////////////////////////////////////////////////////
COLORREF CColorGradientCtrl::XOfsToColor(i32 x)
{
...
{
	i32 cx = m_rcGradient.Width();
	i32 cy = m_rcGradient.Height();
	...
	for (i32 x = rcClip.left; x < rcClip.right; x++)
	{
...
void CColorGradientCtrl::DrawKeys(CDC* pDC)
{
	...
	for (i32 i = 0; i < m_pSpline->GetKeyCount(); i++)
	{
...
void CColorGradientCtrl::UpdateTooltip()
{
	if (m_nHitKeyIndex >= 0)
	{
		...
		i32 cont_s = (m_pSpline->GetKeyFlags(m_nHitKeyIndex) >> SPLINE_KEY_TANGENT_IN_SHIFT) & SPLINE_KEY_TANGENT_LINEAR ? 1 : 2;
		i32 cont_d = (m_pSpline->GetKeyFlags(m_nHitKeyIndex) >> SPLINE_KEY_TANGENT_OUT_SHIFT) & SPLINE_KEY_TANGENT_LINEAR ? 1 : 2;
...
void CColorGradientCtrl::OnLButtonDown(UINT nFlags, CPoint point)
{
	...
	/*
	   ...
	   i32 flags = m_pSpline->GetKeyFlags(m_nHitKeyIndex);
	   if (m_nHitKeyDist < 0)
	    // Toggle left side.
...
/////////////////////////////////////////////////////////////////////////////
void CColorGradientCtrl::SetActiveKey(i32 nIndex)
{
	ClearSelection();
...
//////////////////////////////////////////////////////////////////////////
void CColorGradientCtrl::EditKey(i32 nKey)
{
	if (!m_pSpline)
		return;
...
//////////////////////////////////////////////////////////////////////////
void CColorGradientCtrl::RemoveKey(i32 nKey)
{
	if (!m_pSpline)
		return;
	if (m_bLockFirstLastKey)
...
//////////////////////////////////////////////////////////////////////////
i32 CColorGradientCtrl::InsertKey(CPoint point)
{
...
void CColorGradientCtrl::ClearSelection()
{
	...
	if (m_pSpline)
		m_bSelectedKeys.resize(m_pSpline->GetKeyCount());
	for (i32 i = 0; i < (i32)m_bSelectedKeys.size(); i++)
...
//////////////////////////////////////////////////////////////////////////
void CColorGradientCtrl::SendNotifyEvent(i32 nEvent)
{
	NMHDR nmh;
	nmh.hwndFrom = m_hWnd;
	nmh.idFrom = ::GetDlgCtrlID(m_hWnd);
