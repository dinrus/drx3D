...
void CVehicleSeat::UpdateVarFromObject()
{
	...
	if (!pEnt)
	{
		DrxWarning(VALIDATOR_MODULE_EDITOR, VALIDATOR_WARNING, "[CVehicleSeat::UpdateVariable] pEnt is null, returning");
		return;
	}
...
//////////////////////////////////////////////////////////////////////////
void CVehicleSeat::AddWeapon(i32 weaponType, CVehicleWeapon* pWeap, IVariable* pVar /*=0*/)
{
	...
	if (!pWeaponVar)
	{
		tukk category = (weaponType == WEAPON_PRIMARY) ? "Primary" : "Secondary";
...
//////////////////////////////////////////////////////////////////////////
void CVehicleSeat::OnObjectEvent(CBaseObject* node, i32 event)
{
