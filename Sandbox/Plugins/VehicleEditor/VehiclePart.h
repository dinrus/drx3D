...
public:
	...
	tukk GetElementName() { return "Part"; }
	i32         GetIconIndex();
...
protected:
	...
	void DrawRotationLimits(DisplayContext& dc, IVariable* pSpeed, IVariable* pLimits, IVariable* pHelper, i32 axis);
...
public:
	...
	tukk    ClassName()       { return "VehiclePart"; };
