...
public:
	...
	virtual tukk GetElementName()             { return ""; }
	...
	virtual i32         GetIconIndex()               { return 0; }
...
private:
	void OnObjectEventCallback(CBaseObject* pObject, i32 eventId);
