...
public:
	...
	void          OnObjectEvent(CBaseObject* object, i32 event);
...
protected:
	...
	i32             FillParts(IVariablePtr pData);
	...
	CVehicleWeapon* CreateWeapon(i32 weaponType, CVehicleSeat* pSeat, IVariable* pVar = 0);
