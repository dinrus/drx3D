...
public:
	...
	tukk        GetElementName() { return "Helper"; }
	virtual i32        GetIconIndex()   { return (IsFromGeometry() ? VEED_ASSET_HELPER_ICON : VEED_HELPER_ICON); }
...
public:
	...
	tukk    ClassName()       { return "VehicleHelper"; };
