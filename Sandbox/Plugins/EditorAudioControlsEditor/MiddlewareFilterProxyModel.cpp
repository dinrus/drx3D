...
//////////////////////////////////////////////////////////////////////////
bool CMiddlewareFilterProxyModel::rowMatchesFilter(i32 sourceRow, QModelIndex const& sourceParent) const
{
...
bool CMiddlewareFilterProxyModel::lessThan(QModelIndex const& left, QModelIndex const& right) const
{
	...
	{
		i32 const sortPriorityRole = static_cast<i32>(ModelUtils::ERoles::SortPriority);
