	...
	, m_pTreeView(new CTreeView(this, QAdvancedTreeView::BehaviorFlags(QAdvancedTreeView::Behavior::PreserveSelectionAfterReset | QAdvancedTreeView::Behavior::UseItemModelAttribute)))
{
	...
	pBrowseButton->setIcon(DrxIcon("icons:General/Folder.ico"));
	...
	m_pAttributeFilterProxyModel->setFilterKeyColumn(static_cast<i32>(CFileImporterModel::EColumns::Source));
	...
	m_pTreeView->sortByColumn(static_cast<i32>(CFileImporterModel::EColumns::Source), Qt::AscendingOrder);
	...
	m_pTreeView->header()->resizeSection(static_cast<i32>(CFileImporterModel::EColumns::Source), 300);
	m_pTreeView->header()->setSectionResizeMode(static_cast<i32>(CFileImporterModel::EColumns::Target), QHeaderView::Stretch);
	m_pTreeView->header()->setSectionResizeMode(static_cast<i32>(CFileImporterModel::EColumns::Import), QHeaderView::ResizeToContents);
...
{
	auto const& selection = m_pTreeView->selectionModel()->selectedRows(static_cast<i32>(CFileImporterModel::EColumns::Import));
