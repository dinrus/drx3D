...
{
	DRX_ASSERT_MESSAGE(ids.empty(), "Passed container must be empty.");
...
//////////////////////////////////////////////////////////////////////////
i32 CConnectionsModel::rowCount(QModelIndex const& parent) const
{
	i32 rowCount = 0;
...
//////////////////////////////////////////////////////////////////////////
i32 CConnectionsModel::columnCount(QModelIndex const& parent) const
{
	return static_cast<i32>(EColumns::Count);
}

//////////////////////////////////////////////////////////////////////////
QVariant CConnectionsModel::data(QModelIndex const& index, i32 role) const
{
	QVariant variant;
				...
				if (pIItem != nullptr)
				{
					...
					else
					{
						...
						case static_cast<i32>(EColumns::Name):
							...
							break;
						case static_cast<i32>(EColumns::Path):
							{
								switch (role)
								{
								case Qt::DisplayRole:
...
//////////////////////////////////////////////////////////////////////////
bool CConnectionsModel::setData(QModelIndex const& index, QVariant const& value, i32 role)
{
	return false;
}

//////////////////////////////////////////////////////////////////////////
QVariant CConnectionsModel::headerData(i32 section, Qt::Orientation orientation, i32 role) const
{
	QVariant variant;
...
//////////////////////////////////////////////////////////////////////////
QModelIndex CConnectionsModel::index(i32 row, i32 column, QModelIndex const& parent /*= QModelIndex()*/) const
{
...
//////////////////////////////////////////////////////////////////////////
bool CConnectionsModel::canDropMimeData(QMimeData const* pData, Qt::DropAction action, i32 row, i32 column, QModelIndex const& parent) const
{
...
//////////////////////////////////////////////////////////////////////////
bool CConnectionsModel::dropMimeData(QMimeData const* pData, Qt::DropAction action, i32 row, i32 column, QModelIndex const& parent)
{
