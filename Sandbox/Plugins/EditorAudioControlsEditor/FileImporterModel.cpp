...
//////////////////////////////////////////////////////////////////////////
i32 CFileImporterModel::rowCount(QModelIndex const& parent) const
{
	return static_cast<i32>(m_fileImportInfos.size());
}

//////////////////////////////////////////////////////////////////////////
i32 CFileImporterModel::columnCount(QModelIndex const& parent) const
{
	return static_cast<i32>(EColumns::Count);
}

//////////////////////////////////////////////////////////////////////////
QVariant CFileImporterModel::data(QModelIndex const& index, i32 role) const
{
	QVariant variant;

	if (index.isValid() && (index.row() < static_cast<i32>(m_fileImportInfos.size())))
	{
		...
		else
		{
			switch (index.column())
			{
			case static_cast<i32>(EColumns::Source):
				{
					switch (role)
					{
					case Qt::DisplayRole:
				...
				break;
			case static_cast<i32>(EColumns::Target):
				{
					switch (role)
					{
					case Qt::DisplayRole:
				...
				break;
			case static_cast<i32>(EColumns::Import):
				{
					switch (role)
					{
					case Qt::DisplayRole:
...
//////////////////////////////////////////////////////////////////////////
bool CFileImporterModel::setData(QModelIndex const& index, QVariant const& value, i32 role)
{
	bool wasDataChanged = false;

	if (index.isValid() && (index.row() < static_cast<i32>(m_fileImportInfos.size())))
	{
		if ((index.column() == static_cast<i32>(EColumns::Import)) && (role == Qt::CheckStateRole))
		{
...
//////////////////////////////////////////////////////////////////////////
QVariant CFileImporterModel::headerData(i32 section, Qt::Orientation orientation, i32 role) const
{
	QVariant variant;
...
Qt::ItemFlags CFileImporterModel::flags(QModelIndex const& index) const
{
	...
	if (index.isValid())
	{
		if (index.column() == static_cast<i32>(EColumns::Import) &&
...
//////////////////////////////////////////////////////////////////////////
QModelIndex CFileImporterModel::index(i32 row, i32 column, QModelIndex const& parent /*= QModelIndex()*/) const
{
	QModelIndex modelIndex = QModelIndex();

	if ((row >= 0) && (row < static_cast<i32>(m_fileImportInfos.size())))
	{
...
//////////////////////////////////////////////////////////////////////////
bool CFileImporterModel::canDropMimeData(QMimeData const* pData, Qt::DropAction action, i32 row, i32 column, QModelIndex const& parent) const
{
	return false;
}

//////////////////////////////////////////////////////////////////////////
bool CFileImporterModel::dropMimeData(QMimeData const* pData, Qt::DropAction action, i32 row, i32 column, QModelIndex const& parent)
{
	return false;
}
