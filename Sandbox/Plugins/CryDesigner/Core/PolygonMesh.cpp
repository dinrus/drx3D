...
void PolygonMesh::SetPolygon(PolygonPtr pPolygon, bool bForce, const Matrix34& worldTM, i32 dwRndFlags, i32 nViewDistRatio, i32 nMinSpec, u8 materialLayerMask)
{
...
void PolygonMesh::SetPolygons(const std::vector<PolygonPtr>& polygonList, bool bForce, const Matrix34& worldTM, i32 dwRndFlags, i32 nViewDistRatio, i32 nMinSpec, u8 materialLayerMask)
{
...
void PolygonMesh::UpdateStatObjAndRenderNode(const FlexibleMesh& mesh, const Matrix34& worldTM, i32 dwRndFlags, i32 nViewDistRatio, i32 nMinSpec, u8 materialLayerMask)
{
	CreateRenderNode();
