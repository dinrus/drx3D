...
public:
	...
	void       Reset(Model* pModel, i32 nFlag, ShelfID nValidShelfID = eShelf_Any);
	void       Reset(const std::vector<PolygonPtr>& polygons, i32 nFlag, ShelfID nValidShelfID = eShelf_Any);
...
private:
	void AddVertex(const BrushVec3& vertex, i32 nVertexIndex, PolygonPtr pPolygon);
