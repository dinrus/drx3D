...
/*
   ...
   REGISTER_ONLY_PYTHON_COMMAND_WITH_EXAMPLE( Designer::Script::PyDesignerSetSelection,
                       ...
                       "designer.set_selection( i32 nID )" );
