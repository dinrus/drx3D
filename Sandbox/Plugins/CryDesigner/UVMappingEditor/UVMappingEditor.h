...
public:
	...
	void              ApplyPostProcess(i32 updateType = ePostProcess_Mesh | ePostProcess_SmoothingGroup);
	...
	virtual tukk                       GetPaneTitle() const override        { return "UV Mapping"; };
...
private:
	...
	void RegisterMenuButtons(EUVMappingToolGroup what, QGridLayout* where, i32 columnNumber);
