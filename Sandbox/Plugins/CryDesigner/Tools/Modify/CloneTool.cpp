...
tukk CloneTool::ToolClass() const
{
...
void CloneTool::UpdateCloneList()
{
	...
	for (i32 i = 0; i < m_CloneParameter.m_NumberOfClones; ++i)
	{
...
void CloneTool::UpdateClonePositionsAlongCircle()
{
	...
	i32 nCloneCountInPanel = m_CloneParameter.m_NumberOfClones;
	...
	for (i32 i = 0; i < nCloneCountInPanel; ++i)
	{
		if (i == 0)
...
void CloneTool::FreezeClones()
{
	...
	i32 iCloneCount(localClones.size());
