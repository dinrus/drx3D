...
void PivotTool::Display(DisplayContext& dc)
{
	...
	for (i32 i = 0, iCount(m_CandidateVertices.size()); i < iCount; ++i)
	{
...
bool PivotTool::OnKeyDown(CViewport* view, u32 nChar, u32 nRepCnt, u32 nFlags)
{
...
void PivotTool::OnManipulatorDrag(IDisplayViewport* pView, ITransformManipulator* pManipulator, CPoint& p0, BrushVec3 value, i32 flags)
{
...
void PivotTool::OnManipulatorBegin(IDisplayViewport* pView, ITransformManipulator* pManipulator, CPoint& point, i32 flags)
{
