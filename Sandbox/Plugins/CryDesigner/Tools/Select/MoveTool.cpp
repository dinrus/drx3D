...
void MoveTool::OnManipulatorDrag(IDisplayViewport* pView, ITransformManipulator* pManipulator, CPoint& p0, BrushVec3 value, i32 flags)
{
	if (!m_bManipulatingGizmo)
		return;
...
void MoveTool::OnManipulatorBegin(IDisplayViewport* pView, ITransformManipulator* pManipulator, CPoint& point, i32 flags)
{
	ElementSet* pSelected = DesignerSession::GetInstance()->GetSelectedElements();
