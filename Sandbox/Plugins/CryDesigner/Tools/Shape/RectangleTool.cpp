...
{
	//! A spot in DrxDesigner means a point with some extra information such as the polygon below the point, the spot status and position etc.
...
bool RectangleTool::OnKeyDown(CViewport* view, u32 nChar, u32 nRepCnt, u32 nFlags)
{
...
//! Registers the rectangle tool to DrxDesigner
