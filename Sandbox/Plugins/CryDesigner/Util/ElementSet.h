...
struct Element
{
	...
	{
		m_pPolygon = pPolygon;
		i32 iVertexSize(pPolygon->GetVertexCount());
...
public:
	...
	const Element& Get(i32 nIndex) const  { return m_Elements[nIndex]; }
	Element&       operator[](i32 nIndex) { return m_Elements[nIndex]; }

	void           Set(i32 nIndex, const Element& element)
	{
	...
	bool                    PickFromModel(CBaseObject* pObject, Model* pModel, CViewport* viewport, CPoint point, i32 nFlag, bool bOnlyIncludeCube, BrushVec3* pOutPickedPos);
