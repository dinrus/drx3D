...
public:
	...
	virtual i32  GetSubMatID() const = 0;
	virtual void SetSubMatID(i32 nID) = 0;
...
{
public:
	ToolGroupRegister(EToolGroup group, EDesignerTool tool, tukk name, tukk classname)
	{
...
typedef DesignerFactory<tukk , IBasePanel, BaseTool*, LessStrCmpPR> UIFactory;
typedef DesignerFactory<EDesignerTool, IBasePanel, BaseTool*>             UIPanelFactory;
typedef DesignerFactory<EDesignerTool, BaseTool, i32>                     ToolFactory;
}
