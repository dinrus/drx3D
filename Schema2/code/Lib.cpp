...
SERIALIZATION_ENUM_BEGIN_NESTED2(sxema2, CLibClassProperties, EInternalOverridePolicy, "sxema Library Class Property Override Policy")
	SERIALIZATION_ENUM(sxema2::CLibClassProperties::EInternalOverridePolicy::UseDefault, "UseDefault", "Default")
	SERIALIZATION_ENUM(sxema2::CLibClassProperties::EInternalOverridePolicy::OverrideDefault, "OverrideDefault", "Override")
...
namespace sxema2
{
	...
	//////////////////////////////////////////////////////////////////////////
	CLibAbstractInterfaceFunction::CLibAbstractInterfaceFunction(const SGUID& guid, tukk szName)
		: m_guid(guid)
		, m_name(szName)
	{}
	...
	//////////////////////////////////////////////////////////////////////////
	tukk CLibAbstractInterfaceFunction::GetName() const
	{
		return m_name.c_str();
	}
	...
	//////////////////////////////////////////////////////////////////////////
	CLibAbstractInterface::CLibAbstractInterface(const SGUID& guid, tukk szName)
		: m_guid(guid)
		, m_name(szName)
	{}
	...
	//////////////////////////////////////////////////////////////////////////
	tukk CLibAbstractInterface::GetName() const
	{
		return m_name.c_str();
	}

	//////////////////////////////////////////////////////////////////////////
	CLibStateMachine::CLibStateMachine(const SGUID& guid, tukk szName, ELibStateMachineLifetime lifetime)
		: m_guid(guid)
		, m_name(szName)
		, m_lifetime(lifetime)
	...
	//////////////////////////////////////////////////////////////////////////
	tukk CLibStateMachine::GetName() const
	{
		return m_name.c_str();
	}
	...
	//////////////////////////////////////////////////////////////////////////
	CLibState::CLibState(const SGUID& guid, tukk szName)
		: m_guid(guid)
		, m_name(szName)
	...
	//////////////////////////////////////////////////////////////////////////
	CLibVariable::CLibVariable(const SGUID& guid, tukk szName, EOverridePolicy overridePolicy, const IAny& value, size_t variantPos, size_t variantCount, ELibVariableFlags flags)
		: m_guid(guid)
		, m_name(szName)
	...
	//////////////////////////////////////////////////////////////////////////
	tukk CLibVariable::GetName() const
	{
		return m_name.c_str();
	}
	...
	//////////////////////////////////////////////////////////////////////////
	CLibContainer::CLibContainer(const SGUID& guid, tukk name, const SGUID& typeGUID)
		: m_guid(guid)
		, m_name(name)
		, m_typeGUID(typeGUID)
	{}
	...
	//////////////////////////////////////////////////////////////////////////
	tukk CLibContainer::GetName() const
	{
		return m_name.c_str();
	}
	...
	//////////////////////////////////////////////////////////////////////////
	CLibTimer::CLibTimer(const SGUID& guid, tukk szName, const STimerParams& params)
		: m_guid(guid)
		, m_name(szName)
		, m_params(params)
	{}
	...
	//////////////////////////////////////////////////////////////////////////
	CLibAbstractInterfaceImplementation::CLibAbstractInterfaceImplementation(const SGUID& guid, tukk name, const SGUID& interfaceGUID)
		: m_guid(guid)
		, m_name(name)
	...
	//////////////////////////////////////////////////////////////////////////
	tukk CLibAbstractInterfaceImplementation::GetName() const
	{
		return m_name.c_str();
	}
	...
	//////////////////////////////////////////////////////////////////////////
	CLibComponentInstance::CLibComponentInstance(const SGUID& guid, tukk szName, const SGUID& componentGUID, const IPropertiesConstPtr& pProperties, u32 propertyFunctionIdx, u32 parentIdx)
		: m_guid(guid)
		, m_name(szName)
	...
	//////////////////////////////////////////////////////////////////////////
	tukk CLibComponentInstance::GetName() const
	{
		return m_name.c_str();
	}
	...
	//////////////////////////////////////////////////////////////////////////
	u32 CLibComponentInstance::GetPropertyFunctionIdx() const
	{
		return m_propertyFunctionIdx;
	}

	//////////////////////////////////////////////////////////////////////////
	u32 CLibComponentInstance::GetParentIdx() const
	{
		return m_parentIdx;
	}

	//////////////////////////////////////////////////////////////////////////
	CLibActionInstance::CLibActionInstance(const SGUID& guid, tukk name, const SGUID& actionGUID, size_t iComponentInstance, const IPropertiesPtr& pProperties)
		: m_guid(guid)
		, m_name(name)
	...
	//////////////////////////////////////////////////////////////////////////
	tukk CLibActionInstance::GetName() const
	{
		return m_name.c_str();
	}
	...
	//////////////////////////////////////////////////////////////////////////
	void CLibFunction::SetName(tukk name)
	{
		m_name = name;
	}

	//////////////////////////////////////////////////////////////////////////
	tukk CLibFunction::GetName() const
	{
		return m_name.c_str();
	}

	//////////////////////////////////////////////////////////////////////////
	void CLibFunction::SetScope(tukk scope)
	{
		m_scope = scope;
	}

	//////////////////////////////////////////////////////////////////////////
	tukk CLibFunction::GetScope() const
	{
		return m_scope.c_str();
	}

	//////////////////////////////////////////////////////////////////////////
	void CLibFunction::SetFileName(tukk fileName)
	{
		m_fileName = fileName;
	}

	//////////////////////////////////////////////////////////////////////////
	tukk CLibFunction::GetFileName() const
	{
		return m_fileName.c_str();
	}

	//////////////////////////////////////////////////////////////////////////
	void CLibFunction::SetAuthor(tukk author)
	{
		m_author = author;
	}

	//////////////////////////////////////////////////////////////////////////
	tukk CLibFunction::GetAuthor() const
	{
		return m_author.c_str();
	}

	//////////////////////////////////////////////////////////////////////////
	void CLibFunction::SetDescription(tukk szDescription)
	{
		m_textDesc = szDescription;
	}

	//////////////////////////////////////////////////////////////////////////
	tukk CLibFunction::GetDescription() const
	{
		return m_textDesc.c_str();
	}

	//////////////////////////////////////////////////////////////////////////
	void CLibFunction::AddInput(tukk name, tukk textDesc, const IAny& value)
	{
	...
	//////////////////////////////////////////////////////////////////////////
	tukk CLibFunction::GetInputName(size_t iInput) const
	{
		return iInput < m_inputs.size() ? m_inputs[iInput].name.c_str() : "";
	}

	//////////////////////////////////////////////////////////////////////////
	tukk CLibFunction::GetInputTextDesc(size_t iInput) const
	{
	...
	//////////////////////////////////////////////////////////////////////////
	void CLibFunction::AddOutput(tukk name, tukk textDesc, const IAny& value)
	{
	...
	//////////////////////////////////////////////////////////////////////////
	tukk CLibFunction::GetOutputName(size_t iOutput) const
	{
		return iOutput < m_outputs.size() ? m_outputs[iOutput].name.c_str() : "";
	}

	//////////////////////////////////////////////////////////////////////////
	tukk CLibFunction::GetOutputTextDesc(size_t iOutput) const
	{
	...
	size_t CLibFunction::AddOp(const SVMOp& op)
	{
		if(op.size > (m_capacity - m_size))
		{
			...
			m_pBegin		= static_cast<u8*>(realloc(m_pBegin, m_capacity));
		}
	...
	//////////////////////////////////////////////////////////////////////////
	CLibFunction::SParam::SParam(tukk _name, tukk _textDesc)
		: name(_name)
		, textDesc(_textDesc)
	{}
	...
	//////////////////////////////////////////////////////////////////////////
	CLibClassProperties::SProperty::SProperty(tukk _szLabel, const IAnyPtr& _pValue, EInternalOverridePolicy _overridePolicy)
			: label(_szLabel)
			, pValue(_pValue)
	...
	//////////////////////////////////////////////////////////////////////////
	CLibClass::CLibClass(const ILib& lib, const SGUID& guid, tukk szName, const SGUID& foundationGUID, const IPropertiesConstPtr& pFoundationProperties)
		: m_lib(lib)
		, m_guid(guid)
		, m_name(szName)
	...
	//////////////////////////////////////////////////////////////////////////
	const CRuntimeFunction* CLibClass::GetFunction_New(u32 functionIdx) const
	{
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CLibClass::AddStateMachine(const SGUID& guid, tukk name, ELibStateMachineLifetime lifetime)
	{
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CLibClass::AddState(const SGUID& guid, tukk name)
	{
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CLibClass::AddVariable(const SGUID& guid, tukk szName, EOverridePolicy overridePolicy, const IAny& value, size_t variantPos, size_t variantCount, ELibVariableFlags flags)
	{
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CLibClass::AddContainer(const SGUID& guid, tukk szName, const SGUID& typeGUID)
	{
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CLibClass::AddTimer(const SGUID& guid, tukk szName, const STimerParams& params)
	{
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CLibClass::AddPersistentTimer(const SGUID& guid, tukk szName, const STimerParams& params)
	{
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CLibClass::AddAbstractInterfaceImplementation(const SGUID& guid, tukk szName, const SGUID& interfaceGUID)
	{
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CLibClass::AddComponentInstance(const SGUID& guid, tukk szName, const SGUID& componentGUID, const IPropertiesPtr& pProperties, u32 propertyFunctionIdx, u32 parentIdx)
	{
		...
		for (size_t iComponentInstance = 0; iComponentInstance < componentInstanceCount; ++iComponentInstance)
		{
			...
			if ((pComponentFactory->GetFlags() & EComponentFlags::Singleton) != 0)
			{
				...
				else
				{
					...
					SXEMA2_COMPILER_ERROR("Singleton component %s '%s' instance %s is repeated several time. First instance %s",
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CLibClass::AddActionInstance(const SGUID& guid, tukk name, const SGUID& actionGUID, size_t iComponentInstance, const IPropertiesPtr& pProperties)
	{
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CLibClass::AddPersistentActionInstance(const SGUID& guid, tukk name, const SGUID& actionGUID, size_t iComponentInstance, const IPropertiesPtr& pProperties)
	{
	...
	//////////////////////////////////////////////////////////////////////////
	u32 CLibClass::AddFunction_New(const SGUID& guid)
	{
		u32k        functionIdx = m_functions_New.size();
	...
	//////////////////////////////////////////////////////////////////////////
	CRuntimeFunction* CLibClass::GetFunction_New(u32 functionIdx)
	{
		return functionIdx < m_functions_New.size() ? m_functions_New[functionIdx].get() : nullptr;
	}
	...
	void CLibClass::PreviewFunction(const CLibFunction& function, StringStreamOutCallback stringStreamOutCallback) const
	{
		...
		if(function.GetSize() > 0)
		{
			...
			for(size_t functionPos = 0, size = function.GetSize(); functionPos < size; )
			{
				...
				{
					size_t	pos = static_cast<size_t>(reinterpret_cast<u8k*>(pOp) - reinterpret_cast<u8k*>(function.GetOp(0)));
	...
	//////////////////////////////////////////////////////////////////////////
	CSignalPtr CLib::AddSignal(const SGUID& guid, const SGUID& senderGUID, tukk name)
	{
	...
	//////////////////////////////////////////////////////////////////////////
	CLibAbstractInterfacePtr CLib::AddAbstractInterface(const SGUID& guid, tukk name)
	{
	...
	//////////////////////////////////////////////////////////////////////////
	CLibAbstractInterfaceFunctionPtr CLib::AddAbstractInterfaceFunction(const SGUID& guid, tukk name)
	{
	...
	//////////////////////////////////////////////////////////////////////////
	CLibClassPtr CLib::AddClass(const SGUID& guid, tukk name, const SGUID& foundationGUID, const IPropertiesConstPtr& pFoundationProperties)
	{
		if(!GetClass(guid))
		{
