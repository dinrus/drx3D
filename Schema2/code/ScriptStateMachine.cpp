...
SERIALIZATION_ENUM_BEGIN_NESTED(sxema2, EScriptStateMachineLifetime, "sxema Script State Machine Lifetime")
	SERIALIZATION_ENUM(sxema2::EScriptStateMachineLifetime::Persistent, "persistent", "Persistent")
	SERIALIZATION_ENUM(sxema2::EScriptStateMachineLifetime::Task, "task", "Task")
...
namespace sxema2
{
	...
	//////////////////////////////////////////////////////////////////////////
	CScriptStateMachine::CScriptStateMachine(IScriptFile& file, const SGUID& guid, const SGUID& scopeGUID, tukk szName, EScriptStateMachineLifetime lifetime, const SGUID& contextGUID, const SGUID& partnerGUID)
		: CScriptElementBase(EScriptElementType::StateMachine, file)
		, m_guid(guid)
	...
	//////////////////////////////////////////////////////////////////////////
	bool CScriptStateMachine::SetName(tukk szName)
	{
		m_name = szName;
		return true;
	}
	...
	//////////////////////////////////////////////////////////////////////////
	tukk CScriptStateMachine::GetName() const
	{
		return m_name.c_str();
	}
	...
	void CScriptStateMachine::RefreshTransitionGraph()
	{
		if(gEnv->IsEditor())
		{
			...
			if(!m_transitionGraphGUID || !file.GetGraph(m_transitionGraphGUID))
			{
				...
				SXEMA2_SYSTEM_ASSERT(pTransitionGraph);
				if(pTransitionGraph)
				{
