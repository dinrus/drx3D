...
#include <drx3D/Schema2/EnvTypeDesc.h>
#include <drx3D/Schema2/SerializationEnums.inl>
...
namespace sxema2
{
	namespace
	{
		...
		static tukk OLD_SCRIPT_SUB_FOLDER = "docs";
		static tukk OLD_SCRIPT_EXTENSION  = "xml";
		static tukk g_szScriptsFolder     = "scripts";
		static tukk g_szScriptExtension   = "ssf";
		static tukk g_szSettingsFolder    = "settings";
		static tukk g_szSettingsExtension = "xml";
	...
	CFramework::~CFramework()
	{
		sxema2::CVars::Unregister();

		// TODO: Currently set to null in CSystem::UnloadSchematyc() funcion. Remove it there as soon as we have fixed internal sxema shutdown order.
		//gEnv->pSchematyc2 = nullptr;
		// ~TODO
	}

	//////////////////////////////////////////////////////////////////////////
	bool CFramework::Initialize(SSysGlobEnv& env, const SSysInitParams& initParams)
	{
		env.pSchematyc2 = this;

		sxema2::CVars::Register();
		...
		m_log.Init();
		{
			...
			SXEMA2_SYSTEM_ASSERT(m_pLogFileOutput);
		...
		SXEMA2_SYSTEM_COMMENT("Initializing sxema framework");
		// Refresh environment.
		RefreshEnv();
		// Run unit tests.
	...
	//////////////////////////////////////////////////////////////////////////
	tukk CFramework::GetFileFormat() const
	{
	...
	//////////////////////////////////////////////////////////////////////////
	tukk CFramework::GetOldScriptsFolder() const
	{
	...
	//////////////////////////////////////////////////////////////////////////
	tukk CFramework::GetOldScriptExtension() const
	{
		return OLD_SCRIPT_EXTENSION;
	}

	//////////////////////////////////////////////////////////////////////////
	tukk CFramework::GetScriptsFolder() const
	{
	...
	//////////////////////////////////////////////////////////////////////////
	bool CFramework::IsExperimentalFeatureEnabled(tukk szFeatureName) const
	{
		return DrxStringUtils::stristr(CVars::GetStringSafe(CVars::sc_ExperimentalFeatures), szFeatureName) != nullptr;
	}
	...
	void CFramework::RefreshEnv()
	{
		...
		m_envRegistry.RegisterTypeDesc(MakeEnvTypeDescShared(INT32_TYPE_GUID, "Int32", "Signed 32bit integer", i32(), EEnvTypeFlags::Switchable));
		m_envRegistry.RegisterTypeDesc(MakeEnvTypeDescShared(UINT32_TYPE_GUID, "UInt32", "Unsigned 32bit integer", u32(), EEnvTypeFlags::Switchable));
	...
	void CFramework::RefreshLogFileConfiguration()
	{
		if (m_pLogFileOutput)
		{
			i32 sc_LogToFile = CVars::sc_LogToFile->GetIVal();
	...
	DRXREGISTER_SINGLETON_CLASS(CFramework)
}
