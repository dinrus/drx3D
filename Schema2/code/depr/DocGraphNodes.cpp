...
#include <drx3D/Schema2/DocGraphNodes.h>
...
namespace sxema2
{
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CDocGraphBeginNode::AddOptionalOutput(tukk szName, EScriptGraphPortFlags flags, const CAggregateTypeId& typeId)
	{
		return INVALID_INDEX;
	}
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CDocGraphBeginConstructorNode::AddOptionalOutput(tukk szName, EScriptGraphPortFlags flags, const CAggregateTypeId& typeId)
	{
		return INVALID_INDEX;
	}
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CDocGraphBeginDestructorNode::AddOptionalOutput(tukk szName, EScriptGraphPortFlags flags, const CAggregateTypeId& typeId)
	{
		return INVALID_INDEX;
	}
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CDocGraphBeginSignalReceiverNode::AddOptionalOutput(tukk szName, EScriptGraphPortFlags flags, const CAggregateTypeId& typeId)
	{
		return INVALID_INDEX;
	}
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CDocGraphMakeEnumerationNode::AddOptionalOutput(tukk szName, EScriptGraphPortFlags flags, const CAggregateTypeId& typeId)
	{
		return INVALID_INDEX;
	}
	...
	void CDocGraphMakeEnumerationNode::Serialize(Serialization::IArchive& archive)
	{
		...
		if(archive.isEdit())
		{
			...
			else if(archive.isOutput())
			{
				...
				Serialization::StringListValue typeName(typeNames, itTypeId != typeIds.end() ? static_cast<i32>(itTypeId - typeIds.begin()) : 0);
				archive(typeName, "typeName", "Type");
			}
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CDocGraphForLoopNode::AddOptionalOutput(tukk szName, EScriptGraphPortFlags flags, const CAggregateTypeId& typeId)
	{
		return INVALID_INDEX;
	}
	...
	void CDocGraphForLoopNode::Refresh(const SScriptRefreshParams& params)
	{
		...
		CDocGraphNodeBase::AddInput("Begin", EScriptGraphPortFlags::None, GetAggregateTypeId<i32>());
		CDocGraphNodeBase::AddInput("End", EScriptGraphPortFlags::None, GetAggregateTypeId<i32>());
	...
	void CDocGraphForLoopNode::CompileInputs(IDocGraphNodeCompiler& compiler) const
	{
		...
		compiler.BindOutputToStack(*this, compiler.GetStackSize() - 1, EOutput::Index, MakeAny(i32()));
	}
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CDocGraphProcessSignalNode::AddOptionalOutput(tukk szName, EScriptGraphPortFlags flags, const CAggregateTypeId& typeId)
	{
		return INVALID_INDEX;
	}
	...
	void CDocGraphProcessSignalNode::Serialize(Serialization::IArchive& archive)
	{
		...
		{
			tukk szName = CDocGraphNodeBase::GetInputName(inputIdx);
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CDocGraphBroadcastSignalNode::AddOptionalOutput(tukk szName, EScriptGraphPortFlags flags, const CAggregateTypeId& typeId)
	{
		return INVALID_INDEX;
	}
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CDocGraphGetObjectNode::AddOptionalOutput(tukk szName, EScriptGraphPortFlags flags, const CAggregateTypeId& typeId)
	{
		return INVALID_INDEX;
	}
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CDocGraphContainerClearNode::AddOptionalOutput(tukk szName, EScriptGraphPortFlags flags, const CAggregateTypeId& typeId)
	{
		return INVALID_INDEX;
	}
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CDocGraphContainerSizeNode::AddOptionalOutput(tukk szName, EScriptGraphPortFlags flags, const CAggregateTypeId& typeId)
	{
		return INVALID_INDEX;
	}
	...
	void CDocGraphContainerSizeNode::Refresh(const SScriptRefreshParams& params)
	{
		...
		CDocGraphNodeBase::Refresh(params);
		CDocGraphNodeBase::AddOutput("Size", EScriptGraphPortFlags::MultiLink | EScriptGraphPortFlags::Pull, GetAggregateTypeId<i32>());
		...
		if(pContainer)
		{
			...
			if(pTypeDesc)
			{
				...
				if(pValue)
				{
					...
					compiler.BindOutputToStack(*this, compiler.GetStackSize() - 1, EOutput::Size, MakeAny(i32()));
				}
			}
		}
	}
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CDocGraphContainerGetNode::AddOptionalOutput(tukk szName, EScriptGraphPortFlags flags, const CAggregateTypeId& typeId)
	{
		return INVALID_INDEX;
	}
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CDocGraphStartTimerNode::AddOptionalOutput(tukk szName, EScriptGraphPortFlags flags, const CAggregateTypeId& typeId)
	{
		return INVALID_INDEX;
	}
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CDocGraphStopTimerNode::AddOptionalOutput(tukk szName, EScriptGraphPortFlags flags, const CAggregateTypeId& typeId)
	{
		return INVALID_INDEX;
	}
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CDocGraphResetTimerNode::AddOptionalOutput(tukk szName, EScriptGraphPortFlags flags, const CAggregateTypeId& typeId)
	{
		return INVALID_INDEX;
	}
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CDocGraphBeginStateNode::AddOptionalOutput(tukk szName, EScriptGraphPortFlags flags, const CAggregateTypeId& typeId)
	{
		return INVALID_INDEX;
	}
	...
	{
		preCompiler.AddFunctionOutput("Result", nullptr, MakeAny(i32(ELibTransitionResult::Continue)));
		preCompiler.AddFunctionOutput("State", nullptr, MakeAny(i32(0)));
	}
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CDocGraphEndStateNode::AddOptionalOutput(tukk szName, EScriptGraphPortFlags flags, const CAggregateTypeId& typeId)
	{
		return INVALID_INDEX;
	}
	...
	{
		compiler.Set(0, MakeAny(i32(bSuccess ? ELibTransitionResult::EndSuccess : ELibTransitionResult::EndFailure)));
		compiler.Set(1, MakeAny(i32(~0)));
		compiler.Return();
	}
	...
	//////////////////////////////////////////////////////////////////////////
	tukk CDocGraphCommentNode::GetComment() const
	{
		return m_str.c_str();
	}
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CDocGraphCommentNode::AddOptionalOutput(tukk szName, EScriptGraphPortFlags flags, const CAggregateTypeId& typeId)
	{
		return INVALID_INDEX;
	}
