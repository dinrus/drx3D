...
namespace sxema2
{
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CDocGraphStateNode::AddOptionalOutput(tukk szName, EScriptGraphPortFlags flags, const CAggregateTypeId& typeId)
	{
	...
	void CDocGraphStateNode::SelectState(IDocGraphNodeCompiler& compiler) const
	{
		...
		{
			compiler.Set(0, MakeAny(i32(ELibTransitionResult::ChangeState)));
			compiler.Set(1, MakeAny(i32(libStateIdx)));
			compiler.Return();
		}
	}
}
