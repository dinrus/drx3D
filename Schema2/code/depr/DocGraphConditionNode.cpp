...
#include <drx3D/Schema2/Deprecated/DocGraphNodes/DocGraphConditionNode.h>
...
SERIALIZATION_ENUM_BEGIN_NESTED2(sxema2, CDocGraphConditionNode, EConditionType, "sxema Condition Type")
	SERIALIZATION_ENUM(sxema2::CDocGraphConditionNode::EConditionType::EnvGlobal, "EnvGlobal", "Environment Global")
	SERIALIZATION_ENUM(sxema2::CDocGraphConditionNode::EConditionType::EnvComponent, "EnvComponent", "Environment Component")
	SERIALIZATION_ENUM(sxema2::CDocGraphConditionNode::EConditionType::EnvAction, "EnvAction", "Environment Action")
	SERIALIZATION_ENUM(sxema2::CDocGraphConditionNode::EConditionType::Script, "Script", "Script")
...
namespace sxema2
{
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CDocGraphConditionNode::AddOptionalOutput(tukk szName, EScriptGraphPortFlags flags, const CAggregateTypeId& typeId)
	{
		return INVALID_INDEX;
	}
				...
				if(pFunction)
				{
					if(DocGraphConditionNodeUtils::FunctionIsCondition(*pFunction))
					{
						...
						for(size_t functionInputIdx = 0; functionInputIdx < functionInputCount; ++ functionInputIdx)
						{
							...
							SXEMA2_SYSTEM_ASSERT(pFunctionInputValue);
		...
		case EConditionType::Script:
			{
				...
				if(pGraph)
				{
					...
					for(size_t graphInputIdx = 0; graphInputIdx < graphInputCount; ++ graphInputIdx)
					{
						...
						SXEMA2_SYSTEM_ASSERT(pGraphInputValue);
						if(pGraphInputValue)
						{
