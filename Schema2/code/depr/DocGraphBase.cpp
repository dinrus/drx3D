...
#include <drx3D/Schema2/DocGraphBase.h>
...
{
	inline bool Serialize(Serialization::IArchive& archive, pair<sxema2::SGUID, sxema2::SDocGraphNode>& value, tukk szName, tukk szLabel)
	{
		archive(sxema2::DocGraphBaseUtils::SNodeMapValueSerializer(value), szName, szLabel);
		return true;
	}
...
namespace sxema2
{
	...
	//////////////////////////////////////////////////////////////////////////
	CScriptGraphLink::CScriptGraphLink(const SGUID& srcNodeGUID, tukk szSrcOutputName, const SGUID& dstNodeGUID, tukk szDstInputName)
	...
	//////////////////////////////////////////////////////////////////////////
	CDocGraphBase::CDocGraphBase(IScriptFile& file, const SGUID& guid, const SGUID& scopeGUID, tukk szName, EScriptGraphType type, const SGUID& contextGUID)
	...
	//////////////////////////////////////////////////////////////////////////
	bool CDocGraphBase::SetName(tukk szName)
	{
		m_name = szName;
		return true;
	}
	...
	//////////////////////////////////////////////////////////////////////////
	tukk CDocGraphBase::GetName() const
	{
		return m_name.c_str();
	}
	...
	//////////////////////////////////////////////////////////////////////////
	tukk CDocGraphBase::GetInputName(size_t inputIdx) const
	{
	...
	//////////////////////////////////////////////////////////////////////////
	tukk CDocGraphBase::GetOutputName(size_t outputIdx) const
	{
	...
	//////////////////////////////////////////////////////////////////////////
	tukk CDocGraphBase::GetAvailableNodeName(size_t availableNodeIdx) const
	{
	...
	//////////////////////////////////////////////////////////////////////////
	bool CDocGraphBase::CanAddLink(const SGUID& srcNodeGUID, tukk szScOutputName, const SGUID& dstNodeGUID, tukk szDstInputName) const
	{
	...
	//////////////////////////////////////////////////////////////////////////
	IScriptGraphLink* CDocGraphBase::AddLink(const SGUID& srcNodeGUID, tukk szSrcOutputName, const SGUID& dstNodeGUID, tukk szDstInputName)
	{
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CDocGraphBase::FindLink(const SGUID& srcGUID, tukk szSrcOutputName, const SGUID& dstNodeGUID, tukk szDstInputName) const
	{
	...
	//////////////////////////////////////////////////////////////////////////
	void CDocGraphBase::AddAvailableNode(tukk szName, EScriptGraphNodeType type, const SGUID& contextGUID, const SGUID& refGUID)
	{
	...
	//////////////////////////////////////////////////////////////////////////
	CDocGraphBase::SAvailableNode::SAvailableNode(tukk _szName, EScriptGraphNodeType _type, const SGUID& _contextGUID, const SGUID& _refGUID)
		: name(_szName)
		, type(_type)
		, contextGUID(_contextGUID)
		, refGUID(_refGUID)
