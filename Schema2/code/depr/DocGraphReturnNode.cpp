...
namespace sxema2
{
	...
	//////////////////////////////////////////////////////////////////////////
	size_t CDocGraphReturnNode::AddOptionalOutput(tukk szName, EScriptGraphPortFlags flags, const CAggregateTypeId& typeId)
	{
		return INVALID_INDEX;
	}
	...
	void CDocGraphReturnNode::Serialize(Serialization::IArchive& archive)
	{
		...
		for(size_t graphOutputIdx = 0; graphOutputIdx < graphOutputCount; ++ graphOutputIdx)
		{
			...
			if(pOutputValue)
			{
				tukk szName = graph.GetOutputName(graphOutputIdx);
