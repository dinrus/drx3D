...
#include <drx3D/Schema2/Deprecated/DocGraphNodes/DocGraphAbstractInterfaceFunctionNode.h>
#include <drx3D/Schema2/Deprecated/DocGraphNodes/DocGraphBranchNode.h>
...
#include <drx3D/Schema2/Deprecated/DocGraphNodes/DocGraphContainerRemoveByValueNode.h>
#include <drx3D/Schema2/Deprecated/DocGraphNodes/DocGraphContainerSetNode.h>
...
#include <drx3D/Schema2/Deprecated/DocGraphNodes/DocGraphGetNode.h>
#include <drx3D/Schema2/Deprecated/DocGraphNodes/DocGraphNodes.h>
#include <drx3D/Schema2/Deprecated/DocGraphNodes/DocGraphReturnNode.h>
#include <drx3D/Schema2/Deprecated/DocGraphNodes/DocGraphStateNode.h>
...
#include <drx3D/Schema2/Deprecated/DocGraphNodes/DocGraphSetNode.h>
#include <drx3D/Schema2/Deprecated/DocGraphNodes/DocGraphSwitchNode.h>
...
namespace sxema2
{
	...
	//////////////////////////////////////////////////////////////////////////
	CDocLogicGraph::CDocLogicGraph(IScriptFile& file, const SGUID& guid, const SGUID& scopeGUID, tukk szName, EScriptGraphType type, const SGUID& contextGUID)
				...
				case EScriptGraphType::Condition:
					{
						...
						for(CScriptVariableDeclaration& output : GetOutputs())
						{
							...
							if(pOutputValue)
							{
								tukk szOutputName = output.GetName();
