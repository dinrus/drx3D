...
namespace TemplateUtils
{
	...
	private:
		...
		typedef RETURN (DELEGATE_FASTCALL *StubPtr)(uk pObject PARAM_SEPARATOR PROTOTYPE_PARAMS);
		...
		template <RETURN (*FUNCTION_PTR)(PROTOTYPE_PARAMS)> static RETURN DELEGATE_FASTCALL GlobalFunctionStub(uk PARAM_SEPARATOR INPUT_PARAMS)
		{
			return (FUNCTION_PTR)(OUTPUT_PARAMS);
		}

		template <class OBJECT, RETURN (OBJECT::*MEMBER_FUNCTION_PTR)(PROTOTYPE_PARAMS)> static RETURN DELEGATE_FASTCALL MemberFunctionStub(uk pObject PARAM_SEPARATOR INPUT_PARAMS)
		{
			return ((static_cast<OBJECT*>(pObject))->*MEMBER_FUNCTION_PTR)(OUTPUT_PARAMS);
		}

		template <class OBJECT, RETURN (OBJECT::*CONST_MEMBER_FUNCTION_PTR)(PROTOTYPE_PARAMS) const> static RETURN DELEGATE_FASTCALL ConstMemberFunctionStub(uk pObject PARAM_SEPARATOR INPUT_PARAMS)
		{
			return ((const_cast<OBJECT*>(static_cast<const OBJECT*>(pObject)))->*CONST_MEMBER_FUNCTION_PTR)(OUTPUT_PARAMS);
		}

		template <typename CLOSURE> static RETURN DELEGATE_FASTCALL LambdaFunctionStub(uk pClosure PARAM_SEPARATOR INPUT_PARAMS)
		{
