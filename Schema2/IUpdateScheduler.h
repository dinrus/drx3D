...
namespace sxema2
{
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	inline UpdatePriority CreateUpdatePriority(u32 stage, u32 distribution)
	{
	...
	public:
		...
		CUpdateScope(const IEntity* pEntity, const sxema2::IObject* pSchematycObject);

		~CUpdateScope();

		bool IsBound() const;
		const IEntity* GetEntity() const;
		const sxema2::IObject* GetSchematycObj() const;
		bool IsOnlyLocalGrid() const;
		void SetExtraScopeInfo(const IEntity* pEntity, const sxema2::IObject* pSchematycObj, bool bOnlyLocalGrid);

	private:

		bool                            m_bIsBound;
		const IEntity*                  m_pEntity;
		const sxema2::IObject* m_pSchematycObject;
	...
	struct IUpdateScheduler
	{
		typedef std::function<bool(const sxema2::IObject& object)> UseRelevanceGridPredicate;
		typedef std::function<bool(const sxema2::IObject& object)> IsDynamicObjectPredicate;
	...
	inline CUpdateScope::CUpdateScope(const IEntity* pEntity, const sxema2::IObject* pSchematycObject)
		: m_bIsBound(false)
		, m_pEntity(pEntity)
	...
	inline const sxema2::IObject* CUpdateScope::GetSchematycObj() const
	{
	...
	inline void CUpdateScope::SetExtraScopeInfo(const IEntity* pEntity, const sxema2::IObject* pSchematycObj, bool bOnlyLocalGrid)
	{
		m_pEntity = pEntity;
