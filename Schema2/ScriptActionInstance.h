...
namespace sxema2
{
	...
	public:
		...
		CScriptActionInstance(IScriptFile& file, const SGUID& guid = SGUID(), const SGUID& scopeGUID = SGUID(), tukk szName = nullptr, const SGUID& actionGUID = SGUID(), const SGUID& componentInstanceGUID = SGUID());
