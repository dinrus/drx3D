...
namespace sxema2
{
	...
	struct IScriptEnumeration : public IScriptElement
	{
		...
		virtual size_t FindConstant(tukk szConstant) const = 0;
		virtual tukk GetConstant(size_t constantIdx) const = 0;
	};
	...
	struct IScriptStructure : public IScriptElement
	{
		...
		virtual tukk GetFieldName(size_t fieldIdx) const = 0;
	...
	struct IScriptFile
	{
		...
		virtual IScriptInclude* AddInclude(const SGUID& scopeGUID, tukk szFileName, const SGUID& refGUID) = 0;
		...
		virtual IScriptGroup* AddGroup(const SGUID& scopeGUID, tukk szName) = 0;
		...
		virtual IScriptEnumeration* AddEnumeration(const SGUID& scopeGUID, tukk szName) = 0;
		...
		virtual IScriptStructure* AddStructure(const SGUID& scopeGUID, tukk szName) = 0;
		...
		virtual IScriptSignal* AddSignal(const SGUID& scopeGUID, tukk szName) = 0;
		...
		virtual IScriptAbstractInterface* AddAbstractInterface(const SGUID& scopeGUID, tukk szName) = 0;
		...
		virtual IScriptAbstractInterfaceFunction* AddAbstractInterfaceFunction(const SGUID& scopeGUID, tukk szName) = 0;
		...
		virtual IScriptAbstractInterfaceTask* AddAbstractInterfaceTask(const SGUID& scopeGUID, tukk szName) = 0;
		...
		virtual IScriptClass* AddClass(const SGUID& scopeGUID, tukk szName, const SGUID& foundationGUID) = 0;
		...
		virtual IScriptStateMachine* AddStateMachine(const SGUID& scopeGUID, tukk szName, EScriptStateMachineLifetime lifetime, const SGUID& contextGUID, const SGUID& partnerGUID) = 0;
		...
		virtual IScriptState* AddState(const SGUID& scopeGUID, tukk szName, const SGUID& partnerGUID) = 0;
		...
		virtual IScriptVariable* AddVariable(const SGUID& scopeGUID, tukk szName, const CAggregateTypeId& typeId) = 0;
		...
		virtual IScriptProperty* AddProperty(const SGUID& scopeGUID, tukk szName, const SGUID& refGUID, const CAggregateTypeId& typeId) = 0;
		...
		virtual IScriptContainer* AddContainer(const SGUID& scopeGUID, tukk szName, const SGUID& typeGUID) = 0;
		...
		virtual IScriptTimer* AddTimer(const SGUID& scopeGUID, tukk szName) = 0;
		...
		virtual IScriptComponentInstance* AddComponentInstance(const SGUID& scopeGUID, tukk szName, const SGUID& componentGUID, EScriptComponentInstanceFlags flags) = 0;
		...
		virtual IScriptActionInstance* AddActionInstance(const SGUID& scopeGUID, tukk szName, const SGUID& actionGUID, const SGUID& componentInstanceGUID) = 0;
		...
		virtual bool IsElementNameUnique(const SGUID& scopeGUID, tukk szName) const = 0; // #SchematycTODO : Move to separate utils class!
