...
#include <drx3D/Schema2/TemplateUtils_RingBuffer.h>
...
#include <drx3D/Schema2/INetworkObject.h>
...
#define SXEMA2_PREVIEW_ENTITY_NAME "Preview"
...
namespace sxema2
{
	...
	struct IObject
	{
		...
		virtual IAnyConstPtr GetProperty(u32 propertyIdx) const = 0;
