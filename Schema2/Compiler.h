...
#define SXEMA2_COMPILER_PREVIEW_OUTPUT 0	// Disabled because this system is WIP. Once complete it Will provide more verbose compiler preview output than existing implementation.
...
namespace sxema2
{
	...
	public:
		...
		virtual void SetFunctionName(tukk name) override;
		virtual void AddFunctionInput(tukk name, tukk textDesc, const IAny& value) override;
		virtual void AddFunctionOutput(tukk name, tukk textDesc, const IAny& value) override;
		// ~IDocGraphSequencePreCompiler
