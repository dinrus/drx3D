...
namespace TemplateUtils
{
	...
	public:
		...
		inline CTypeWrapper operator ++ (i32)
		{
	...
	template <typename BASE_TYPE, typename TRAITS> inline bool Serialize(Serialization::IArchive& archive, CTypeWrapper<BASE_TYPE, TRAITS>& value, tukk szName, tukk szLabel)
	{
		if(archive.isInput())
		{
			BASE_TYPE	temp;
