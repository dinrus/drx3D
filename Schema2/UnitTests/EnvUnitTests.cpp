...
#include <drx3D/Schema2/EnvFunctionDescriptor.h>
...
namespace sxema2
{
	namespace EnvFunctionDescriptorUnitTests
	{
		...
		EUnitTestResultFlags TestEnvFunctionDescriptor(const CEnvFunctionDescriptorPtr& pEnvFunctionDescriptor, EEnvFunctionFlags flags, u32 paramCount)
		{
	...
	SXEMA2_REGISTER_UNIT_TEST(&EnvFunctionDescriptorUnitTests::Run, "EnvFunctionDescriptor")
}
