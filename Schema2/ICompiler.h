...
#include <drx3D/Schema2/IAny.h> // #SchematycTODO : Can we forward declare?
...
namespace sxema2
{
	...
	struct IDocGraphSequencePreCompiler
	{
		...
		virtual void SetFunctionName(tukk szName) = 0;
		virtual void AddFunctionInput(tukk szName, tukk szDescription, const IAny& value) = 0;
		virtual void AddFunctionOutput(tukk szName, tukk szDescription, const IAny& value) = 0;
	};
