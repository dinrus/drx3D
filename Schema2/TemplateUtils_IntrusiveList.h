...
namespace TemplateUtils
{
	...
	private:
		...
		public:
			...
			{
				return reinterpret_cast<pointer>((u8*)(this) - TemplateUtils::GetMemberOffset<value_type, intrusive_list_node>(MEMBER));
			}

			inline const_pointer value() const
			{
				return reinterpret_cast<const_pointer>((u8k*)(this) - TemplateUtils::GetMemberOffset<value_type, intrusive_list_node>(MEMBER));
			}
	...
	public:
		...
		public:
			...
			inline const_iterator operator ++ (i32)
			{
		...
		public:
			...
			inline reverse_iterator operator ++ (i32)
			{
				member_node* prev_node = m_node;
				m_node = m_node->prev();
#if TEMPLATE_UTILS_INTRUSIVE_LIST_DEBUG
		...
		public:
			...
			inline const_reverse_iterator operator ++ (i32)
			{
				const member_node* prev_node = m_node;
				m_node = m_node->prev();
#if TEMPLATE_UTILS_INTRUSIVE_LIST_DEBUG
