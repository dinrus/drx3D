...
#define SXEMA2_MAKE_COMPONENT_MEMBER_FUNCTION_SHARED(function, guid, componentGUID) sxema2::SMakeComponentMemberFunctionShared<TYPE_OF(&function)>()(&function, guid, componentGUID, TemplateUtils::GetFunctionName<TYPE_OF(&function), &function>(), __FILE__, "Code")
...
namespace sxema2
{
	...
	namespace ComponentMemberFunctionUtils
	{
		...
		public:
			...
			inline CBase(const SGUID& guid, const SGUID& componentGUID, tukk szDeclaration, tukk szFileName, tukk szProjectDir)
				: m_guid(guid)
	...
	public:
		...
		inline CComponentMemberFunction(FunctionPtr pFunction, const SGUID& guid, const SGUID& componentGUID, tukk szDeclaration, tukk szFileName, tukk szProjectDir)
	...
	template <typename COMPONENT> struct SMakeComponentMemberFunctionShared<void (COMPONENT::*)()>
	{
		...
		inline IComponentMemberFunctionPtr operator () (FunctionPtr pFunction, const SGUID& guid, const SGUID& componentGUID, tukk szDeclaration, tukk szFileName, tukk szProjectDir) const
		{
