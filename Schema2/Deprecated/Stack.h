...
namespace sxema2
{
	...
	public:
		...
		inline void Reserve(size_t capacity)
		{
			...
			if(capacity > m_capacity)
			{
				...
				CVariant* pData = static_cast<CVariant*>(DrxModuleMalloc(sizeof(CVariant) * capacity));
	...
	protected:
		...
		typedef void (*FreeFunctionPtr)(uk );

		inline CStack(uk const pData, const FreeFunctionPtr pFreeFunction, const size_t capacity)
	...
	private:
		...
		u8 m_data[sizeof(CVariant) * CAPACITY];
	};
