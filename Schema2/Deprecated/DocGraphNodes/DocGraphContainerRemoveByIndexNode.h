...
namespace sxema2
{
	class CDocGraphContainerRemoveByIndexNode : public CDocGraphNodeBase
	{
	public:

		CDocGraphContainerRemoveByIndexNode(IScriptFile& file, IDocGraph& graph, const SGUID& guid = SGUID(), const SGUID& contextGUID = SGUID(), const SGUID& refGUID = SGUID(), Vec2 pos = Vec2(ZERO));
