...
namespace sxema2
{
	class CDocGraphContainerAddNode : public CDocGraphNodeBase
	{
	public:

		CDocGraphContainerAddNode(IScriptFile& file, IDocGraph& graph, const SGUID& guid = SGUID(), const SGUID& contextGUID = SGUID(), const SGUID& refGUID = SGUID(), Vec2 pos = Vec2(ZERO));
