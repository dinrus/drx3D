...
#include <drx3D/Schema2/GUID.h> // #SchematycTODO : Remove this include?
...
namespace sxema2
{
	...
	{
		inline SVMCallGlobalFunctionOp(u32k _iGlobalFunction)
