...
namespace sxema2
{
	...
	public:
		...
		virtual IFoundationPtr CreateFoundation(const SGUID& guid, tukk name) override;
		...
		virtual bool RegisterSettings(tukk name, const IEnvSettingsPtr& pSettings) override;
		virtual IEnvSettingsPtr GetSettings(tukk name) const override;
