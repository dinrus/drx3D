...
i32 CScriptTimerMgr::AddTimer(ScriptTimer& timer)
{
...
void CScriptTimerMgr::RemoveTimer(i32 nTimerID)
{
...
{
	DRX_PROFILE_FUNCTION(PROFILE_SCRIPT);
...
//////////////////////////////////////////////////////////////////////////
void CScriptTimerMgr::GetMemoryUsage(IDrxSizer* pSizer) const
{
...
void CScriptTimerMgr::Serialize(TSerialize& ser)
{
	...
	if (ser.IsReading())
	{
		...
		for (i32 i = 0; i < nTimers; i++)
		{
			...
			string func;
			ser.Value("func", func);
			drx_strcpy(timer.sFuncName, func);
