...
// -------------------------------------------------------------------------
//  Имя файла:   ScriptBind_Physics.cpp
//  Version:     v1.00
...
//////////////////////////////////////////////////////////////////////////
i32 CScriptBind_Physics::SimulateExplosion(IFunctionHandler* pH, SmartScriptTable explisionTable)
{
	{
...
//////////////////////////////////////////////////////////////////////////
i32 CScriptBind_Physics::RegisterExplosionShape(IFunctionHandler* pH, tukk sGeometryFile, float fSize, i32 nIdMaterial, float fProbability,
                                                tukk sSplintersFile, float fSplintersOffset, tukk sSplintersCloudEffect)
{
	//////////////////////////////////////////////////////////////////////////
	// Remove all this.
	//////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////
i32 CScriptBind_Physics::RegisterExplosionCrack(IFunctionHandler* pH, tukk sGeometryFile, i32 nIdMaterial)
{
	IStatObj* pObj = gEnv->p3DEngine->LoadStatObj(sGeometryFile, "#ForceBreakable", NULL, false);
	if (!pObj || pObj->IsDefaultObject())
	{
	...
	//@TODO: restore it.
	m_pPhysicalWorld->GetGeomUpr()->RegisterCrack(pObj->GetPhysGeom()->pGeom, vtx, 0);
	return pH->EndFunction();
}

//////////////////////////////////////////////////////////////////////////
i32 CScriptBind_Physics::RayWorldIntersection(IFunctionHandler* pH)
{
	...
	i32 nHits = m_pSystem->GetIPhysicalWorld()->RayWorldIntersection(src, dir, iEntTypes,
...
//////////////////////////////////////////////////////////////////////////
i32 CScriptBind_Physics::RayTraceCheck(IFunctionHandler* pH, Vec3 src, Vec3 dst, ScriptHandle skipEntityId1, ScriptHandle skipEntityId2)
{
...
i32 CScriptBind_Physics::SamplePhysEnvironment(IFunctionHandler* pH)
{
	i32 nEnts, i, nHits = 0, objtypes = ent_static | ent_rigid | ent_sleeping_rigid | ent_sort_by_mass | ent_allocate_list | ent_addref_results;
	...
	pSphere = pWorld->GetGeomUpr()->CreatePrimitive(primitives::sphere::type, &sph);

	nEnts = pWorld->GetEntitiesInBox(sph.center - Vec3(sph.r), sph.center + Vec3(sph.r), pEnts, objtypes, DRX_ARRAY_COUNT(ents));
