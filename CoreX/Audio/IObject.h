...
struct IObject
{
	...
	/**
	 * Stops all instances of the passed trigger ID or all instances of all active triggers if DrxAudio::InvalidControlId (default) is passed on this audio object.
