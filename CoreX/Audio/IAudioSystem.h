...
/**
 * @enum DrxAudio::ESystemEvents
 * @brief A strongly typed enum class representing different audio system events that can be listened to.
 * @var DrxAudio::ESystemEvents::None
 * @var DrxAudio::ESystemEvents::ImplSet
 * @var DrxAudio::ESystemEvents::TriggerExecuted
 * @var DrxAudio::ESystemEvents::TriggerFinished
 * @var DrxAudio::ESystemEvents::FilePlay
 * @var DrxAudio::ESystemEvents::FileStarted
 * @var DrxAudio::ESystemEvents::FileStopped
 * @var DrxAudio::ESystemEvents::All
 */
...
DRX_CREATE_ENUM_FLAG_OPERATORS(ESystemEvents);

/**
 * @enum DrxAudio::EDataScope
 ...
 * @var DrxAudio::EDataScope::None
 * @var DrxAudio::EDataScope::Global
 * @var DrxAudio::EDataScope::LevelSpecific
 * @var DrxAudio::EDataScope::All
 */
...
/**
 * @enum DrxAudio::EOcclusionType
 * @brief A strongly typed enum class representing different audio occlusion types that can be set on audio objects.
 * @var DrxAudio::EOcclusionType::None
 * @var DrxAudio::EOcclusionType::Ignore
 * @var DrxAudio::EOcclusionType::Adaptive
 * @var DrxAudio::EOcclusionType::Low
 * @var DrxAudio::EOcclusionType::Medium
 * @var DrxAudio::EOcclusionType::High
 * @var DrxAudio::EOcclusionType::Count
 */
...
DRX_CREATE_ENUM_FLAG_OPERATORS(EOcclusionType);

/**
 * @enum DrxAudio::ELogType
 * @brief A strongly typed enum class representing different audio specific log types.
 * @var DrxAudio::ELogType::None
 * @var DrxAudio::ELogType::Comment
 * @var DrxAudio::ELogType::Warning
 * @var DrxAudio::ELogType::Error
 * @var DrxAudio::ELogType::Always
 */
...
struct ISystemModule : public Drx::IDefaultModule
{
	DRXINTERFACE_DECLARE_GUID(ISystemModule, "6c7ba422-375b-4325-ae00-918679610d2e"_drx_guid);
};

struct IImplModule : public Drx::IDefaultModule
{
	DRXINTERFACE_DECLARE_GUID(IImplModule, "5c4adbec-a343-49ce-b799-2a856cdd553b"_drx_guid);
};
...
struct IAudioSystem
{
	...
	/**
	 * Stops all instances of the passed trigger ID or all instances of all active triggers if DrxAudio::InvalidControlId (default) is passed.
	 ...
	 * @param eventMask - a combination of DrxAudio::ESystemEvents one is interested in. If set to ESystemEvents::All, all events generated by the given object will be received.
	 * @return void
	 * @see RemoveRequestListener
	 */
	virtual void AddRequestListener(void (* func)(SRequestInfo const* const), uk const pObjectToListenTo, ESystemEvents const eventMask) = 0;
	 ...
	 */
	virtual void RemoveRequestListener(void (* func)(SRequestInfo const* const), uk const pObjectToListenTo) = 0;
	 ...
	 * @return Pointer to a freshly constructed DrxAudio::IListener instance.
	 * @see ReleaseListener
	 */
	 ...
	 * @param userData - optional struct used to pass additional data to the internal request.
	 * @return Pointer to a freshly constructed DrxAudio::IObject instance.
	 * @see ReleaseObject
	 */
	 ...
	 * Note: Don't use this method directly, instead use Drx::Audio::Log()!
...
AUTO_TYPE_INFO(DrxAudio::EOcclusionType);