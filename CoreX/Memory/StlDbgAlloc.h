...
#ifndef _DRX_DBG_ALLOCATOR_HDR_
#define _DRX_DBG_ALLOCATOR_HDR_
...
namespace drx
{
#if defined(_DEBUG) && defined(_INC_CRTDBG) && DRX_PLATFORM_WINDOWS
...
public:
	...
	dbg_allocator(tukk szParentObject = "drx_dbg_alloc", i32 nParentIndex = 0) :
	...
	pointer allocate(size_type _Count, ukk )
	{
	...
	tukk m_szParentObject;      //!< The file name.
	i32         m_nParentIndex;        //!< The file line number.
};
...
/*
   ...
   //! Construct default allocator (do nothing).
   dbg_allocator<T>(tukk szParentObject, i32 nParentIndex = 0):
...
public:
	...
	//! Construct default allocator (do nothing).
	dbg_struct_allocator(tukk szParentObject, i32 nParentIndex = 0) :
...
public:
	//! Construct default allocator (do nothing).
	dbg_allocator(tukk szSource = "DrxDbgAlloc", i32 nSource = 0)
	{
	}
...
public:
	...
	map(tukk szParentObject = "STL map", i32 nParentIndex = 0) :
...
public:
	...
	set(tukk szParentObject = "STL set", i32 nParentIndex = 0) :
...
public:
	...
	vector(tukk szParentObject = "STL vector", i32 nParentIndex = 0) :
...
public:
	...
	string(tukk szThat, const _Allocator allocator = _Allocator("STL string", 0)) :
		_Base(szThat, 0, _Base::npos, allocator)
	{
	}
	string(tukk szBegin, tukk szEnd, const _Allocator allocator = _Allocator("STL string", 0)) :
...
public:
	...
	map(tukk szParentObject, i32 nParentIndex = 0)
	{
	}
};
//#endif
...
public:
	...
	set(tukk szParentObject, i32 nParentIndex = 0)
	{
	}
};
//#endif
...
public:
	...
	vector(tukk szParentObject, i32 nParentIndex = 0)
	{
	}
};
//#endif
...
public:
	...
	string(tukk szThat, const _Allocator allocator) :
		_Base(szThat)
	{
	}
	string(tukk szBegin, tukk szEnd) :
		_Base(szBegin, szEnd)
	{
	}
	string(tukk szBegin, tukk szEnd, const _Allocator allocator) :
		_Base(szBegin, szEnd)
	{
	}
