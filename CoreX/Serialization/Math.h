...
template<typename T>
bool Serialize(Serialization::IArchive& ar, struct Vec2_tpl<T>& v, tukk name, tukk label);

template<typename T>
bool Serialize(Serialization::IArchive& ar, struct Vec3_tpl<T>& v, tukk name, tukk label);

template<typename T>
bool Serialize(Serialization::IArchive& ar, struct Vec4_tpl<T>& v, tukk name, tukk label);

template<typename T>
bool Serialize(Serialization::IArchive& ar, struct Quat_tpl<T>& q, tukk name, tukk label);

template<typename T>
bool Serialize(Serialization::IArchive& ar, struct QuatT_tpl<T>& qt, tukk name, tukk label);

template<typename T>
bool Serialize(Serialization::IArchive& ar, struct Ang3_tpl<T>& a, tukk name, tukk label);

template<class T>
bool Serialize(Serialization::IArchive& ar, struct Matrix34_tpl<T>& value, tukk name, tukk label);

bool Serialize(Serialization::IArchive& ar, struct AABB& aabb, tukk name, tukk label);
