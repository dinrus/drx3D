...
template<class T>
ResourceSelector<T> MakeResourceSelector(T& s, tukk selectorType)
{
...
inline ResourceSelectorWithId         AnimationPathWithId(string& s, i32 id) { return ResourceSelectorWithId(s, "AnimationOrBSpace", id); }
