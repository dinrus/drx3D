...
template<typename T>
bool Serialize(Serialization::IArchive& ar, Vec2_tpl<T>& value, tukk name, tukk label)
{
...
template<typename T>
bool Serialize(Serialization::IArchive& ar, Vec3_tpl<T>& value, tukk name, tukk label)
{
	if (!ar.isEdit() && !ar.caps(Serialization::IArchive::XML_VERSION_1))
	{
...
template<typename T>
inline bool Serialize(Serialization::IArchive& ar, struct Vec4_tpl<T>& value, tukk name, tukk label)
{
	if (!ar.isEdit() && !ar.caps(Serialization::IArchive::XML_VERSION_1))
	{
...
template<typename T>
inline bool Serialize(Serialization::IArchive& ar, Vec4H<T>& value, tukk name, tukk label)
{
	if (!ar.isEdit() && !ar.caps(Serialization::IArchive::XML_VERSION_1))
	{
...
template<typename T>
bool Serialize(Serialization::IArchive& ar, Quat_tpl<T>& value, tukk name, tukk label)
{
	if (ar.isEdit())
	{
		typedef T (& Array)[3];
...
template<typename T>
bool Serialize(Serialization::IArchive& ar, struct QuatT_tpl<T>& value, tukk name, tukk label)
{
...
inline bool Serialize(Serialization::IArchive& ar, struct AABB& value, tukk name, tukk label)
{
	return Serialize(ar, static_cast<SerializableAABB&>(value), name, label);
}

template<typename T>
bool Serialize(Serialization::IArchive& ar, Matrix33_tpl<T>& value, tukk name, tukk label)
{
	typedef T(&Array)[9];
	return ar((Array)value, name, label);
}
...
template<typename T>
bool Serialize(Serialization::IArchive& ar, Matrix34_tpl<T>& value, tukk name, tukk label)
{
	typedef T (& Array)[12];
	return ar((Array)value, name, label);
}
...
#ifdef DRX_TYPE_SIMD4
template<typename T>
bool Serialize(Serialization::IArchive& ar, Matrix34H<T>& value, tukk name, tukk label)
{
	typedef T (& Array)[12];
	return ar((Array)value, name, label);
}
...
template<typename T>
bool Serialize(Serialization::IArchive& ar, Matrix44_tpl<T>& value, tukk name, tukk label)
{
	typedef T(&Array)[16];
	return ar((Array)value, name, label);
}
...
#ifdef DRX_TYPE_SIMD4
template<typename T>
bool Serialize(Serialization::IArchive& ar, Matrix44H<T>& value, tukk name, tukk label)
{
	typedef T(&Array)[16];
	return ar((Array)value, name, label);
}
...
inline bool Serialize(Serialization::IArchive& ar, SUniformScale& c, tukk name, tukk label)
{
	if (!ar.isEdit())
	{
		typedef float(*Array)[3];
...
template<class T>
bool SerializeRadiansAsDeg(Serialization::IArchive& ar, T& radians, tukk name, tukk label)
{
	if (ar.isEdit()) 
	{
...
template<class T>
bool Serialize(Serialization::IArchive& ar, Serialization::SRadiansAsDeg<T>& value, tukk name, tukk label)
{
	return SerializeRadiansAsDeg(ar, *value.radians, name, label);
}

template<class T>
bool Serialize(Serialization::IArchive& ar, Serialization::SRadiansWithRangeAsDeg<T>& value, tukk name, tukk label)
{
...
template<class T>
bool Serialize(Serialization::IArchive& ar, Serialization::SRadianAng3AsDeg<T>& value, tukk name, tukk label)
{
	if (ar.isEdit())
	{
...
template<class T>
bool SerializeRadiusAsDiameter(Serialization::IArchive& ar, T* radius, tukk name, tukk label)
{
	if (ar.isEdit())
	{
...
template<class T>
bool Serialize(Serialization::IArchive& ar, Serialization::SRadiusAsDiameter<T>& value, tukk name, tukk label)
{
	return SerializeRadiusAsDiameter(ar, value.radius, name, label);
}

template<class T>
bool Serialize(Serialization::IArchive& ar, Serialization::SRadiusWithRangeAsDiameter<T>& value, tukk name, tukk label)
{
...
template<typename T>
bool Serialize(Serialization::IArchive& ar, Ang3_tpl<T>& value, tukk name, tukk label)
{
	typedef T (& Array)[3];
	return ar((Array)value, name, label);
}
...
template<class T>
bool Serialize(Serialization::IArchive& ar, Serialization::QuatAsAng3<T>& value, tukk name, tukk label)
{
	if (ar.isEdit())
	{
...
template<class T>
bool Serialize(Serialization::IArchive& ar, Serialization::QuatTAsVec3Ang3<T>& value, tukk name, tukk label)
{
	if (ar.isEdit())
	{
