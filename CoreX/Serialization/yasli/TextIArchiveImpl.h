...
YASLI_INLINE double parseFloat(tukk str);
...
public:
    ...
    Token operator()(tukk text) const;
private:
    inline bool isSpace(char c) const;
    inline bool isWordPart(u8 c) const;
    inline bool isComment(char c) const;
    inline bool isQuoteOpen(i32& quoteIndex, char c) const;
    inline bool isQuoteClose(i32 quoteIndex, char c) const;
...
inline bool Tokenizer::isWordPart(u8 c) const
{
		return charTypes[c] != 0;
}

Token Tokenizer::operator()(tukk ptr) const
{
	while(isSpace(*ptr))
		++ptr;
	Token cur(ptr, ptr);
...
bool TextIArchive::open(tukk buffer, size_t length, bool free)
{
	if(!length)
		return false;
...
bool TextIArchive::load(tukk filename)
{
...
i32 TextIArchive::line(tukk position) const
{
    ...
    if(token_ != token){
      ...
      while (lineEnd && *lineEnd != '\0' && *lineEnd != '\r' && *lineEnd != '\n')
        ...
        msg << "Error parsing file, expected '=' at line " << line(token_.start) << ":\n"
         << STxt(token_.start, lineEnd).c_str();
...
bool TextIArchive::findName(tukk name)
{
...
bool TextIArchive::operator()(const Serializer& ser, tukk name, tukk label)
{
    if(findName(name)){
        if(openBracket()){
            stack_.push_back(Level());
...
bool TextIArchive::operator()(ContainerInterface& ser, tukk name, tukk label)
{
    if(findName(name)){
...
bool TextIArchive::operator()(i32& value, tukk name, tukk label)
{
    if(findName(name)){
        readToken();
        checkValueToken();
...
bool TextIArchive::operator()(u32& value, tukk name, tukk label)
{
    if(findName(name)){
        readToken();
        checkValueToken();
...
bool TextIArchive::operator()(i16& value, tukk name, tukk label)
{
    if(findName(name)){
        readToken();
        checkValueToken();
...
bool TextIArchive::operator()(u16& value, tukk name, tukk label)
{
    if(findName(name)){
        readToken();
        checkValueToken();
...
bool TextIArchive::operator()(i64& value, tukk name, tukk label)
{
    if(findName(name)){
        readToken();
        checkValueToken();
...
bool TextIArchive::operator()(u64& value, tukk name, tukk label)
{
    if(findName(name)){
        readToken();
        checkValueToken();
...
bool TextIArchive::operator()(float& value, tukk name, tukk label)
{
    if(findName(name)){
        readToken();
        checkValueToken();
...
bool TextIArchive::operator()(double& value, tukk name, tukk label)
{
    if(findName(name)){
        readToken();
        checkValueToken();
...
bool TextIArchive::operator()(StringInterface& value, tukk name, tukk label)
{
    if(findName(name)){
        readToken();
        if(checkStringValueToken()){
			...
			tuk pTmpBuf = bIsStackString ? (tuk)alloca(nMaxBytesRequired) : (tuk)malloc(nMaxBytesRequired);
...
inline void utf8ToUtf16(std::wstring* out, tukk in)
{
  out->clear();
...
bool TextIArchive::operator()(WStringInterface& value, tukk name, tukk label)
{
	if(findName(name)){
		readToken();
		if(checkStringValueToken()){
...
bool TextIArchive::operator()(bool& value, tukk name, tukk label)
{
    if(findName(name)){
        readToken();
        checkValueToken();
...
bool TextIArchive::operator()(i8& value, tukk name, tukk label)
{
    if(findName(name)){
        readToken();
        checkValueToken();
...
bool TextIArchive::operator()(u8& value, tukk name, tukk label)
{
    if(findName(name)){
        readToken();
        checkValueToken();
...
bool TextIArchive::operator()(char& value, tukk name, tukk label)
{
    if(findName(name)){
        readToken();
        checkValueToken();
