...
static void escapeString(MemoryWriter& dest, tukk begin, tukk end)
{
    while(begin != end){
        tukk str = escapeTable[(u8)(*begin)];
        dest.write(str);
        ++begin;
    }
}
...
static i32k TAB_WIDTH = 2;

JSONOArchive::JSONOArchive(i32 textWidth, tukk header)
: Archive(OUTPUT | TEXT)
, header_(header)
...
bool JSONOArchive::save(tukk fileName)
{
...
void JSONOArchive::placeName(tukk name)
{
...
bool JSONOArchive::operator()(bool& value, tukk name, tukk label)
{
    placeIndent();
    placeName(name);
...
bool JSONOArchive::operator()(StringInterface& value, tukk name, tukk label)
{
    placeIndent();
    placeName(name);
    (*buffer_) << "\""; 
...
inline tuk writeUtf16ToUtf8(tuk s, u32 ch)
{
  u8k byteMark = 0x80;
  u8k byteMask = 0xBF;
...
bool JSONOArchive::operator()(WStringInterface& value, tukk name, tukk label)
{
	placeIndent();
	placeName(name);
	(*buffer_) << "\""; 
...
bool JSONOArchive::operator()(float& value, tukk name, tukk label)
{
    placeIndentCompact();
    placeName(name);
...
bool JSONOArchive::operator()(double& value, tukk name, tukk label)
{
    placeIndentCompact();
    placeName(name);
...
bool JSONOArchive::operator()(i32& value, tukk name, tukk label)
{
    placeIndentCompact();
    placeName(name);
    (*buffer_) << value;
...
bool JSONOArchive::operator()(u32& value, tukk name, tukk label)
{
    placeIndentCompact();
    placeName(name);
    (*buffer_) << value;
...
bool JSONOArchive::operator()(i16& value, tukk name, tukk label)
{
    placeIndentCompact();
    placeName(name);
    (*buffer_) << value;
...
bool JSONOArchive::operator()(u16& value, tukk name, tukk label)
{
    placeIndentCompact();
    placeName(name);
    (*buffer_) << value;
...
bool JSONOArchive::operator()(i64& value, tukk name, tukk label)
{
    placeIndentCompact();
    placeName(name);
    (*buffer_) << value;
...
bool JSONOArchive::operator()(u64& value, tukk name, tukk label)
{
    placeIndentCompact();
    placeName(name);
    (*buffer_) << value;
...
bool JSONOArchive::operator()(u8& value, tukk name, tukk label)
{
    placeIndentCompact();
    placeName(name);
    (*buffer_) << value;
...
bool JSONOArchive::operator()(i8& value, tukk name, tukk label)
{
    placeIndentCompact();
    placeName(name);
    (*buffer_) << value;
...
bool JSONOArchive::operator()(char& value, tukk name, tukk label)
{
    placeIndentCompact();
    placeName(name);
    (*buffer_) << value;
...
bool JSONOArchive::operator()(const Serializer& ser, tukk name, tukk label)
{
    placeIndent();
    placeName(name);
    std::size_t position = buffer_->position();
    openBracket();
    stack_.push_back(Level(false, position, i32(strlen(name) + 2 * (name[0] & 1) + (stack_.size() - 1) * TAB_WIDTH + 2)));
...
bool JSONOArchive::operator()(KeyValueInterface& keyValue, tukk name, tukk label)
{
    placeIndent();
...
bool JSONOArchive::operator()(PointerInterface& ser, tukk name, tukk label)
{
	placeIndent();
	placeName(name);
	openBracket();
	tukk registeredTypeName = ser.registeredTypeName();
...
bool JSONOArchive::operator()(ContainerInterface& ser, tukk name, tukk label)
{
	placeIndent();
	placeName(name);
	std::size_t position = buffer_->position();
	openContainerBracket();
	stack_.push_back(Level(true, position, i32(strlen(name) + 2 * (name[0] & 1) + stack_.size() - 1 * TAB_WIDTH + 2)));
...
static tuk joinLines(tuk start, tuk end)
{
...
bool JSONOArchive::joinLinesIfPossible()
{
    ...
    i32 indentCount = stack_.back().indentCount;
    //YASLI_ASSERT(startPosition >= indentCount);
    if(buffer_->position() - startPosition - indentCount < std::size_t(textWidth_)){
        tuk buffer = buffer_->buffer();
        tuk start = buffer + startPosition;
        tuk end = buffer + buffer_->position();
