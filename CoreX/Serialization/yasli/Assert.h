...
bool assertionDialog(tukk function, tukk fileName, i32 line, tukk expr, tukk str, ...);
inline bool assertionDialog(tukk function, tukk fileName, i32 line, tukk expr) { return assertionDialog(function, fileName, line, expr, ""); }
}
#ifdef _MSC_VER
