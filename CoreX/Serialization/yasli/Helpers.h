...
template<i32 Size, class S8, class S16, class S32, class S64>
...
template<> struct IsSigned<i32> { enum { value = true }; };
template<> struct IsSigned<i64> { enum { value = true }; };
template<> struct IsSigned<z64> { enum { value = true }; };
