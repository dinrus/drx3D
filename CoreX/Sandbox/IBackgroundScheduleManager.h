...
struct IBackgroundScheduleItem
{
	...
	virtual u32k GetNumWorkItems() const = 0;

	// Get n-th work item from the schedule item
	virtual IBackgroundScheduleItemWork* GetWorkItem(u32k index) const = 0;
...
struct IBackgroundSchedule
{
	...
	virtual u32k GetNumItems() const = 0;

	// Get single schedule item
	virtual IBackgroundScheduleItem* GetItem(u32k index) const = 0;
...
struct IBackgroundScheduleManager
{
	...
	virtual IBackgroundSchedule* CreateSchedule(tukk szName) = 0;

	// Create empty schedule item
	virtual IBackgroundScheduleItem* CreateScheduleItem(tukk szName) = 0;
	...
	virtual u32k GetNumSchedules() const = 0;

	// Get n-th schedule
	virtual IBackgroundSchedule* GetSchedule(u32k index) const = 0;
