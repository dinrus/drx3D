...
struct EmptyEnumInfo
{
	...
	static i32 step() { return 1; }
};

///////////////////////////////////////////////////////////////////////////////
// Create a unique DynamicEnum type from a unique Info type. Examples:
//   using ESomething = DynamicEnum<struct SDummySomething, u8>;  // no per-enum info
//   struct SThingInfo {...}; // define enum info
//   using EThing = DynamicEnum<SThingInfo>;
template<typename Tag, typename V = i32, typename I = EmptyEnumInfo>
class DynamicEnum
{
public:
