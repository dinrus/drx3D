...
enum class EStereoSubmission : i32
{
...
enum class EStereoDeviceState : i32
{
...
// helper functions
//inline tukk  GetLayerList_UICONFIG() { COMPILE_TIME_ASSERT(eLayerList_SceneLayer_0 == 0 && eLayerList_Total == eLayerList_QuadLayer_1 + 1); return "enum_int:SCENE3D_0,QUAD_0, QUAD_1"; }
inline tukk  GetLayerType_UICONFIG()             { static_assert(eLayer_Scene3D == 0 && eLayer_NumLayerTypes == 3, "Unexpected enum value!"); return "enum_int:SCENE3D=0,QUAD=1,QUAD_LOCKED=2"; }
inline tukk  GetQuadLayer_UICONFIG()             { static_assert(eQuadLayers_0 == 0, "Unexpected enum value!"); return "enum_int:QUAD_0=0, QUAD_1=1"; }
inline tukk  GetQuadLayerType_UICONFIG()         { static_assert(eLayer_Quad == 1, "Unexpected enum value!"); return "enum_int:QuadFree=1"; }
...
struct IStereoRenderer
{
	...
	virtual Vec2_tpl<i32>      GetOverlayResolution() const = 0;
...
struct IHmdRenderer
{
	...
	virtual bool Initialize(i32 initialWidth, i32 initialeight) = 0;
	virtual void Shutdown() = 0;

	virtual void ReleaseBuffers() = 0;
	virtual void OnResolutionChanged(i32 newWidth, i32 newHeight) = 0;
