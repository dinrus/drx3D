...
// Common
#define GLASSCFG_MIN_DRX3D_SPEED      400.0f     /* Anything above this speed will be considered a bullet (Generally 450 to 1100)*/
#define GLASSCFG_MIN_DRX3D_HOLE_SCALE 1.1f       /* Minimum size for physical hole created by bullets */
