...
public:
	...
	virtual i32           mfGet_width() const = 0;
	virtual i32           mfGet_height() const = 0;
	virtual i32           mfGet_depth() const = 0;
	virtual i32           mfGet_NumSides() const = 0;

	virtual EImFileError  mfGet_error() const = 0;

	virtual byte*         mfGet_image(i32k nSide) = 0;
	virtual bool          mfIs_image(i32k nSide) const = 0;

	virtual ETEX_Format   mfGetFormat() const = 0;
	virtual ETEX_TileMode mfGetTileMode() const = 0;
	virtual i32           mfGet_numMips() const = 0;
	virtual i32           mfGet_numPersistantMips() const = 0;
	virtual i32           mfGet_Flags() const = 0;
	virtual const ColorF& mfGet_minColor() const = 0;
	virtual const ColorF& mfGet_maxColor() const = 0;
	virtual i32           mfGet_ImageSize() const = 0;
