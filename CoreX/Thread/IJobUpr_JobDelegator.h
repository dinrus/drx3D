...
// -------------------------------------------------------------------------
//  Имя файла:   IJobUpr_JobDelegator.h
//  Version:     v1.00
...
#define DECLARE_JOB(name, type, function)                                                       \
  ...
  namespace JobUpr { namespace Detail { JobUpr::TJobHandle gJobHandle ## type = NULL; } \
  }                                                                                             \
...
template<typename T>
struct DRX_ALIGN(16) SParams0
{
	typename SClassArg<T>::TClassTypePtr _pthis;
};

template<>
struct DRX_ALIGN(16) SParams0<SNullType>
{
};

template<typename T, typename T0>
struct DRX_ALIGN(16) SParams1
{
	typename SClassArg<T>::TClassTypePtr _pthis;
	T0 t0;
...
struct DRX_ALIGN(16) SParams1<SNullType, T0>
{
	T0 t0;
	SParams1(T0 t0_) : t0(t0_)
	{
...
struct DRX_ALIGN(16) SParams2<SNullType, T0, T1>
{
	T0 t0;
	T1 t1;
	SParams2(T0 t0_, T1 t1_) : t0(t0_), t1(t1_)
...
struct DRX_ALIGN(16) SParams3<SNullType, T0, T1, T2>
{
	T0 t0;
	T1 t1;
	T2 t2;
...
struct DRX_ALIGN(16) SParams4<SNullType, T0, T1, T2, T3>
{
	T0 t0;
	T1 t1;
	T2 t2;
...
struct DRX_ALIGN(16) SParams5<SNullType, T0, T1, T2, T3, T4>
{
	T0 t0;
	T1 t1;
	T2 t2;
...
struct DRX_ALIGN(16) SParams6<SNullType, T0, T1, T2, T3, T4, T5>
{
	T0 t0;
	T1 t1;
	T2 t2;
...
struct DRX_ALIGN(16) SParams7<SNullType, T0, T1, T2, T3, T4, T5, T6>
{
	T0 t0;
	T1 t1;
	T2 t2;
...
struct DRX_ALIGN(16) SParams8<SNullType, T0, T1, T2, T3, T4, T5, T6, T7>
{
	T0 t0;
	T1 t1;
	T2 t2;
...
struct DRX_ALIGN(16) SParams9<SNullType, T0, T1, T2, T3, T4, T5, T6, T7, T8>
{
	T0 t0;
	T1 t1;
	T2 t2;
...
struct DRX_ALIGN(16) SParams10<SNullType, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>
{
	T0 t0;
	T1 t1;
	T2 t2;
...
struct DRX_ALIGN(16) SParams11<SNullType, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
{
	T0 t0;
	T1 t1;
	T2 t2;
...
#define DECLARE_JOB_INVOKER_CLASS(name, type, function)                                                                                                                  \
  ...
  private:                                                                                                                                                               \
    ...
    /*****************/                                                                                                                                                  \
    /* class members */                                                                                                                                                  \
    u8 m_ParameterStorage[JobUpr::SInfoBlock::scAvailParamSize]; /* Storage for job parameter */                                                          \
    u32 paramSize;                                                     /* size of set parameters */                                                             \
    JobUpr::SJobState* m_pJobState;                                         /* address of per packet job address */                                                  \
    CCommonDMABase commonDMABase;                                                                                                                                        \
  };  /* struct packet */                                                                                                                                                \
                                                                                                                                                                         \
                                                                                                                                                                         \
  class DRX_ALIGN(128) SGenericJob ## type: public CJobBase                                                                                                              \
  {                                                                                                                                                                      \
  public:                                                                                                                                                                \
    typedef JobUpr::Detail::packet ## type packet;                                                                                                                   \
                                                                                                                                                                         \
    /*******************************************/                                                                                                                        \
    /* Common non job dependent interface part */                                                                                                                        \
    const JobUpr::TJobHandle GetProgramHandle()  const ;                                                                                                     \
    u32 GetJobID();                                                                                                                                                   \
    tukk GetJobName() const;                                                                                                                                \
                                                                                                                       \
    void SetParamDataSize(u32k cParamSize);                                                                                                                \
    void SetPriorityLevel(u32 nPriorityLevel);                                                                                                                  \
    void ForceUpdateOfProfilingDataIndex();                                                                                                                              \
    void SetBlocking();                                                                                                                                                  \
    u32 GetParamDataSize();                                                                                                                                     \
    void SetJobParamData(uk paramMem);                                                                                                                                \
    ...
    uk operator new(size_t nSize)        { return DrxModuleMemalign(nSize, 128); }                                                                                    \
    void  operator delete(uk pPtr)       { DrxModuleMemalignFree(pPtr); }                                                                                             \
                                                                                                                                                                         \
    uk operator new(size_t, uk where) { return where; }                                                                                                            \
                                                                                                                                                                         \
  private:                                                                                                                                                               \
    /**********************************************************************/                                                                                             \
    /* Functions to initialize the parameters - member function overloads */                                                                                             \
    ...
    /***************************************************************************/                                                                                        \
    /* class members */                                                                                                                                                  \
    DRX_ALIGN(128) u8 m_ParameterStorage[JobUpr::SInfoBlock::scAvailParamSize]; /* memory to store serialized parameters */                               \
    JobUpr::Invoker m_Invoker;                                                             /* Invoker function to de-serialize the parameters*/                      \
                                                                                                                                                                         \
  };                                                                                                                                                                     \
                                                                                                                                                                         \
                                                                                                                                                                         \
  ...
  inline const JobUpr::TJobHandle SGenericJob ## type::GetProgramHandle() const                                                                              \
  {                                                                                                                                                                      \
    if (gJobHandle ## type == NULL)                                                                                                                                      \
    {                                                                                                                                                                    \
      /*Safe, since GetJobHandle itself is thread safe and should always return the same result for a job */                                                             \
      gJobHandle ## type = gEnv->GetJobUpr()->GetJobHandle(name, sizeof(name) - 1, GenerateInvoker(&function));                                                      \
    }                                                                                                                                                                    \
    return gJobHandle ## type;                                                                                                                                           \
  }                                                                                                                                                                      \
                                                                                                                                                                         \
  inline u32 SGenericJob ## type::GetJobID()                                                                                                                          \
  {                                                                                                                                                                      \
    return GetProgramHandle()->jobId;                                                                                                                                    \
  }                                                                                                                                                                      \
                                                                                                                                                                         \
  inline tukk SGenericJob ## type::GetJobName() const                                                                                                             \
  {                                                                                                                                                                      \
    return GetProgramHandle()->cpString;                                                                                                                                 \
  }                                                                                                                                                                      \
   /*                                                                                                                                                                      \
  inline tukk SGenericJob ## type::GetJobName() const volatile                                                                                                   \
  {                                                                                                                                                                      \
    return GetProgramHandle()->cpString;                                                                                                                                 \
  }                                                                                                                                                                      \
    */                                                                                                                                                                     \
  inline void SGenericJob ## type::SetParamDataSize(u32k cParamSize)                                                                                       \
  {                                                                                                                                                                      \
  ...
  {                                                                                                                                                                      \
    this->m_JobDelegator.ForceUpdateOfProfilingDataIndex();                                                                                                              \
                                                                                                                                                                         ...
                                                                                                                                                                         \
  inline void SGenericJob ## type::SetPriorityLevel(u32 nPriorityLevel)                                                                                         \
  {                                                                                                                                                                      \
  ...
  {                                                                                                                                                                      \
    this->m_JobDelegator.SetBlocking();                                                                                                                                  \
                                                                                                                                                                         ...
                                                                                                                                                                         \
  inline u32 SGenericJob ## type::GetParamDataSize()                                                                                                            \
  {                                                                                                                                                                      \
    return this->m_JobDelegator.GetParamDataSize();                                                                                                                      \
  }                                                                                                                                                                      \
                                                                                                                                                                         \
  inline void SGenericJob ## type::SetJobParamData(uk paramMem)                                                                                                       \
  {                                                                                                                                                                      \
  ...
  {                                                                                                                                                                      \
    this->m_JobDelegator.SetJobParamData((uk )m_ParameterStorage);                                                                                                     \
  ...
  {                                                                                                                                                                      \
    typedef SParams0<uk> SParameterType;                                                                                                                              \
  ...
  {                                                                                                                                                                      \
    typedef SParams1<uk , T0> SParameterType;                                                                                                                          \
    STATIC_CHECK(sizeof(SParameterType) <= SInfoBlock::scAvailParamSize, JOB_PARAMETER_NEED_MORE_THAN_80_BYTES);                                                         \
    STATIC_CHECK(sizeof(m_ParameterStorage) == SInfoBlock::scAvailParamSize, JOB_PARAMETER_STORAGE_DIFFERES_BETWEEN_SGENERICJOB_AND_JOBMANAGER_QUEUE);                   \
  ...
  {                                                                                                                                                                      \
    typedef SParams2<uk , T0, T1> SParameterType;                                                                                                                      \
    STATIC_CHECK(sizeof(SParameterType) <= SInfoBlock::scAvailParamSize, JOB_PARAMETER_NEED_MORE_THAN_80_BYTES);                                                         \
    STATIC_CHECK(sizeof(m_ParameterStorage) == SInfoBlock::scAvailParamSize, JOB_PARAMETER_STORAGE_DIFFERES_BETWEEN_SGENERICJOB_AND_JOBMANAGER_QUEUE);                   \
  ...
  {                                                                                                                                                                      \
    typedef SParams3<uk , T0, T1, T2> SParameterType;                                                                                                                  \
    STATIC_CHECK(sizeof(SParameterType) <= SInfoBlock::scAvailParamSize, JOB_PARAMETER_NEED_MORE_THAN_80_BYTES);                                                         \
    STATIC_CHECK(sizeof(m_ParameterStorage) == SInfoBlock::scAvailParamSize, JOB_PARAMETER_STORAGE_DIFFERES_BETWEEN_SGENERICJOB_AND_JOBMANAGER_QUEUE);                   \
  ...
  {                                                                                                                                                                      \
    typedef SParams4<uk , T0, T1, T2, T3> SParameterType;                                                                                                              \
    STATIC_CHECK(sizeof(SParameterType) <= SInfoBlock::scAvailParamSize, JOB_PARAMETER_NEED_MORE_THAN_80_BYTES);                                                         \
    STATIC_CHECK(sizeof(m_ParameterStorage) == SInfoBlock::scAvailParamSize, JOB_PARAMETER_STORAGE_DIFFERES_BETWEEN_SGENERICJOB_AND_JOBMANAGER_QUEUE);                   \
  ...
  {                                                                                                                                                                      \
    typedef SParams5<uk , T0, T1, T2, T3, T4> SParameterType;                                                                                                          \
    STATIC_CHECK(sizeof(SParameterType) <= SInfoBlock::scAvailParamSize, JOB_PARAMETER_NEED_MORE_THAN_80_BYTES);                                                         \
    STATIC_CHECK(sizeof(m_ParameterStorage) == SInfoBlock::scAvailParamSize, JOB_PARAMETER_STORAGE_DIFFERES_BETWEEN_SGENERICJOB_AND_JOBMANAGER_QUEUE);                   \
  ...
  {                                                                                                                                                                      \
    typedef SParams6<uk , T0, T1, T2, T3, T4, T5> SParameterType;                                                                                                      \
    STATIC_CHECK(sizeof(SParameterType) <= SInfoBlock::scAvailParamSize, JOB_PARAMETER_NEED_MORE_THAN_80_BYTES);                                                         \
    STATIC_CHECK(sizeof(m_ParameterStorage) == SInfoBlock::scAvailParamSize, JOB_PARAMETER_STORAGE_DIFFERES_BETWEEN_SGENERICJOB_AND_JOBMANAGER_QUEUE);                   \
  ...
  {                                                                                                                                                                      \
    typedef SParams7<uk , T0, T1, T2, T3, T4, T5, T6> SParameterType;                                                                                                  \
    STATIC_CHECK(sizeof(SParameterType) <= SInfoBlock::scAvailParamSize, JOB_PARAMETER_NEED_MORE_THAN_80_BYTES);                                                         \
    STATIC_CHECK(sizeof(m_ParameterStorage) == SInfoBlock::scAvailParamSize, JOB_PARAMETER_STORAGE_DIFFERES_BETWEEN_SGENERICJOB_AND_JOBMANAGER_QUEUE);                   \
  ...
  {                                                                                                                                                                      \
    typedef SParams8<uk , T0, T1, T2, T3, T4, T5, T6, T7> SParameterType;                                                                                              \
    STATIC_CHECK(sizeof(SParameterType) <= SInfoBlock::scAvailParamSize, JOB_PARAMETER_NEED_MORE_THAN_80_BYTES);                                                         \
    STATIC_CHECK(sizeof(m_ParameterStorage) == SInfoBlock::scAvailParamSize, JOB_PARAMETER_STORAGE_DIFFERES_BETWEEN_SGENERICJOB_AND_JOBMANAGER_QUEUE);                   \
  ...
  {                                                                                                                                                                      \
    typedef SParams9<uk , T0, T1, T2, T3, T4, T5, T6, T7, T8> SParameterType;                                                                                          \
    STATIC_CHECK(sizeof(SParameterType) <= SInfoBlock::scAvailParamSize, JOB_PARAMETER_NEED_MORE_THAN_80_BYTES);                                                         \
    STATIC_CHECK(sizeof(m_ParameterStorage) == SInfoBlock::scAvailParamSize, JOB_PARAMETER_STORAGE_DIFFERES_BETWEEN_SGENERICJOB_AND_JOBMANAGER_QUEUE);                   \
  ...
  {                                                                                                                                                                      \
    typedef SParams10<uk , T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> SParameterType;                                                                                     \
    STATIC_CHECK(sizeof(SParameterType) <= SInfoBlock::scAvailParamSize, JOB_PARAMETER_NEED_MORE_THAN_80_BYTES);                                                         \
    STATIC_CHECK(sizeof(m_ParameterStorage) == SInfoBlock::scAvailParamSize, JOB_PARAMETER_STORAGE_DIFFERES_BETWEEN_SGENERICJOB_AND_JOBMANAGER_QUEUE);                   \
  ...
  {                                                                                                                                                                      \
    typedef SParams11<uk , T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> SParameterType;                                                                                \
    STATIC_CHECK(sizeof(SParameterType) <= SInfoBlock::scAvailParamSize, JOB_PARAMETER_NEED_MORE_THAN_80_BYTES);                                                         \
    STATIC_CHECK(sizeof(m_ParameterStorage) == SInfoBlock::scAvailParamSize, JOB_PARAMETER_STORAGE_DIFFERES_BETWEEN_SGENERICJOB_AND_JOBMANAGER_QUEUE);                   \
  ...
  {                                                                                                                                                                      \
    commonDMABase.SetJobParamData((uk )m_ParameterStorage);                                                                                                            \
    m_pJobState = 0;                                                                                                                                                     \
  }                                                                                                                                                                      \
                                                                                                                                                                         \
  inline void packet ## type::SetParamDataSize(u32 cParamSize)                                                                                                  \
  {                                                                                                                                                                      \
    paramSize = ((cParamSize + 0xF) & ~0xF);                                                                                                                             \
  }                                                                                                                                                                      \
                                                                                                                                                                         \
  inline u32k packet ## type::GetPacketSize() const                                                                                                        \
  {                                                                                                                                                                      \
    return paramSize;                                                                                                                                                    \
  }                                                                                                                                                                      \
                                                                                                                                                                         \
  ...
  {                                                                                                                                                                      \
    return (SVEC4_UINT*)m_ParameterStorage;                                                                                                                              \
                                                                                                                                                                         ...
                                                                                                                                                                         \
  inline JobUpr::SJobState* packet ## type::GetJobStateAddress() const                                                                                               \
  {                                                                                                                                                                      \
    return m_pJobState;                                                                                                                                                  \
  }                                                                                                                                                                      \
                                                                                                                                                                         \
  inline void packet ## type::RegisterJobState(JobUpr::SJobState * pJobState)                                                                                        \
  {                                                                                                                                                                      \
  ...
  {                                                                                                                                                                      \
    ...
    *alias_cast<C**>(m_ParameterStorage) = pClassInstance;                                                                                                               \
                                                                                                                                                                         ...
                                                                                                                                                                         \
  inline u16 packet ## type::GetProfilerIndex() const                                                                                                                 \
  {                                                                                                                                                                      \
  ...
  typedef JobUpr::Detail::SGenericJob ## type type;
