...
//
////////////////////////////////////////////////////////////////////////////
#ifndef _DRX_COMMON_LINUX_SPECIFIC_HDR_
#define _DRX_COMMON_LINUX_SPECIFIC_HDR_
...
public:
	...
	#if (DRX_PLATFORM_LINUX && DRX_PLATFORM_64BIT) && !defined(__clang__)
...
private:
	...
	//! For compatibility reason to encapsulate a uk as an i32.
...
typedef CHandle<i32, (i32) - 1l> HANDLE;
...
inline i32   _CrtCheckMemory() { return 1; };

inline tuk _fullpath(tuk absPath, tukk relPath, size_t maxLength)
{
	char path[PATH_MAX];
...
typedef uk HDC;
typedef uk PROC;
typedef uk PIXELFORMATDESCRIPTOR;

// General overloads of bitwise operators for enum types.
// This makes the type of expressions like "eFoo_Flag1 | eFoo_Flag2" to be of type EFoo, instead of i32.
