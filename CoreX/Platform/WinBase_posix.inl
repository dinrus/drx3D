...
#include <signal.h>
	...
	#include <CoreFoundation/CoreFoundation.h> // for DrxMessageBox
...
namespace DrxFileSystem
{
ILINE void FS_OPEN(const char* szFileName, int iFlags, int& iFileDesc, DRXMODE_T uMode, FS_ERRNO_TYPE& rErr)
{
...
ILINE int FS_MKDIR(const char* dirname, DRXMODE_T mode)
{
