...
//  Описание: Apple specific declarations common amongst its products
// -------------------------------------------------------------------------
//  История:
//
////////////////////////////////////////////////////////////////////////////
...
//! For compatibility reason we needed to create a class that actually contains an i32 rather than a uk and make sure it does not get mistreated.
...
private:
	...
	typedef void ReferenceType;     //!< For compatibility reasons, to encapsulate a uk as an i32.

	// Forbid these functions, which would actually not work on an i32.
