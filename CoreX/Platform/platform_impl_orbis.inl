...
{
	drx_strcpy(szEngineRootPath, engineRootPathSize, ".");
}

void DrxGetExecutableFolder(unsigned int nBufferLength, char* lpBuffer)
{
	DrxFindEngineRootFolder(nBufferLength, lpBuffer);
}
