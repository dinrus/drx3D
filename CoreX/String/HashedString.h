...
public:
	...
	explicit CHashedString(u32k hash);
	CHashedString(tukk szText); //!< Remark: If the string starts with '0x' then we assume it is already a string representation of a hash, we wont rehash this string, but instead just convert it into a hash.
...
//////////////////////////////////////////////////////////////////////////
inline CHashedString::CHashedString(u32k hash)
{
	m_hash = hash;
#if defined(HASHEDSTRING_STORES_SOURCE_STRING)
...
//////////////////////////////////////////////////////////////////////////
inline CHashedString::CHashedString(tukk szText)
{
...
//////////////////////////////////////////////////////////////////////////
inline CHashedString& CHashedString::operator=(tukk szText)
{
	m_hash = CreateHash(szText);
#if defined(HASHEDSTRING_STORES_SOURCE_STRING)
	if (m_hash != INVALID_HASH)
...
{
	char buffer[16];
	drx_sprintf(buffer, "0x%08x", m_hash);
	return buffer;
}

//////////////////////////////////////////////////////////////////////////
inline bool CHashedString::operator==(tukk szText) const
{
...
inline bool CHashedString::operator==(const CHashedString& other) const
{
	...
	{
		DRX_ASSERT_MESSAGE(m_textCopy.compareNoCase(other.m_textCopy) == 0 || m_textCopy == other.GetHashAsString() || GetHashAsString() == other.m_textCopy, "HashCollision occured! The same hash was used for two different strings");
		return true;
	}
	else
	{
...
//////////////////////////////////////////////////////////////////////////
inline u32 CHashedString::CreateHash(tukk szStringToHash) const
{
...
//////////////////////////////////////////////////////////////////////////
inline bool Serialize(Serialization::IArchive& ar, CHashedString& str, tukk name, tukk label)
{
#if defined(HASHEDSTRING_STORES_SOURCE_STRING)
