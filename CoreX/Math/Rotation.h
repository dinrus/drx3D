...
public:
	...
	static inline void ReflectType(sxema::CTypeDesc<CRotation>& desc)
	{
		desc.SetGUID("991960c1-3b34-45cc-ac3c-f3f0e55ed7ef"_drx_guid);
...
inline bool Serialize(Serialization::IArchive& archive, CRotation& value, tukk szName, tukk szLabel)
{
