...
{
	a = (float)((360.0 / 65536) * ((i32)(a * (65536 / 360.0)) & 65535));
	return a;
}
inline float AngleModRad(float a)
{
	a = (float)((gf_PI2 / 65536) * ((i32)(a * (65536 / gf_PI2)) & 65535));
	return a;
}
...
// Fix replace viewport by i16 array.
// Fix for d3d viewport.
inline f32 mathVec3Project(Vec3* pvWin, const Vec3* pvObj, i32k pViewport[4], const Matrix44A* pProjection, const Matrix44A* pView, const Matrix44A* pWorld)
{
	Vec4 in, out;
...
inline Vec3* mathVec3UnProject(Vec3* pvObj, const Vec3* pvWin, i32k pViewport[4], const Matrix44A* pProjection, const Matrix44A* pView, const Matrix44A* pWorld)
{
	Matrix44A m, mA;
	Vec4 in, out;
...
inline Vec3* mathVec3ProjectArray(Vec3* pOut, u32 OutStride, const Vec3* pV, u32 VStride, i32k pViewport[4], const Matrix44A* pProjection, const Matrix44A* pView, const Matrix44A* pWorld, u32 n)
{
	Matrix44A m;
	Vec4 in, out;
...
inline Vec3* mathVec3UnprojectArray(Vec3* pOut, u32 OutStride, const Vec3* pV, u32 VStride, i32k pViewport[4], const Matrix44* pProjection, const Matrix44* pView, const Matrix44* pWorld, u32 n)
{
	Vec4 in, out;
	Matrix44 m, mA;
