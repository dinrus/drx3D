...
public:
    ...
    //template < typename _Tp1 > struct rebind { typedef std::allocator<_Tp1> other; };

	typedef typename A::template < none_const_value_type >::other none_const_allocator_type;
