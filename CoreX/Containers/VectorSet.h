...
// -------------------------------------------------------------------------
//  Имя файла:   VectorSet.h
//  Version:     v1.00
//  Created:     25/9/2006 by MichaelS.
//  Компиляторы:       drux (DinrusPro's Universal Compiler),   Visual Studio.NET 2005
//  Описание: std::set replacement implemented using sorted vector.
// -------------------------------------------------------------------------
//  История:
//
////////////////////////////////////////////////////////////////////////////
...
public:
	...
	reference                                 operator[](i32 index);       //!< See documentation above.
	const_reference                           operator[](i32 index) const; //!< See documentation above.
...
template<typename K, typename T, typename A>
typename VectorSet<K, T, A>::reference VectorSet<K, T, A >::operator[](i32 index)
{
	return m_entries[index];
}

template<typename K, typename T, typename A>
typename VectorSet<K, T, A>::const_reference VectorSet<K, T, A >::operator[](i32 index) const
{
	return m_entries[index];
}
