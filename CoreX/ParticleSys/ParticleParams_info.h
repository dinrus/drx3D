...
ENUM_INFO_BEGIN(DrxAudio::EOcclusionType)
	ENUM_ELEM_INFO(DrxAudio::, EOcclusionType::Ignore)
	ENUM_ELEM_INFO(DrxAudio::, EOcclusionType::Adaptive)
	ENUM_ELEM_INFO(DrxAudio::, EOcclusionType::Low)
	ENUM_ELEM_INFO(DrxAudio::, EOcclusionType::Medium)
	ENUM_ELEM_INFO(DrxAudio::, EOcclusionType::High)
ENUM_INFO_END(DrxAudio::EOcclusionType)
