// Разработка 2018-2023 DinrusPro / Dinrus Group. РНЦП Динрус.
	...
	#error не определена DRX_PLATFORM, возможно, отсутствует #include "stdafx.h".
#endif
...
//#pragma warning(disable: 4244)
	...
	#define REG_COMPANY_NAME       L"DinrusPro\\"
	#define REG_SETTING            L"Settings\\"
	#define REG_DINRUSPRO_SETTING_KEY REG_SOFTWARE REG_COMPANY_NAME REG_SETTING

// pseudo-variable that represents the DOS header of the module
EXTERN_C IMAGE_DOS_HEADER __ImageBase;

	#define INFOTEXT L"Пожалуйста, укажите директорию установки DrxENGINE (RootPath):"

using namespace SettingsUprHelpers;

static bool g_bWindowQuit;
static CEngineSettingsUpr* g_pThis = 0;
...
LRESULT static CALLBACK WndProcSettingsUpr(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	assert(g_pThis);
...
//////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////
CEngineSettingsUpr::CEngineSettingsUpr(const wchar_t* moduleName, const wchar_t* iniFileName)
	: m_hWndParent(0)
{
	m_sModuleName.clear();
...
//////////////////////////////////////////////////////////////////////////
void CEngineSettingsUpr::RestoreDefaults()
{
	// Engine
...
//////////////////////////////////////////////////////////////////////////
bool CEngineSettingsUpr::GetModuleSpecificStringEntryUtf16(const char* key, SettingsUprHelpers::CWCharBuffer wbuffer)
{
	...
	{
		CFixedString<wchar_t, 256> s = L"Software\\DinrusPro\\Settings\\";
...
//////////////////////////////////////////////////////////////////////////
bool CEngineSettingsUpr::GetModuleSpecificStringEntryUtf8(const char* key, SettingsUprHelpers::CCharBuffer buffer)
{
	...
	if (!GetModuleSpecificStringEntryUtf16(key, SettingsUprHelpers::CWCharBuffer(wBuffer, sizeof(wBuffer))))
	{
		buffer[0] = 0;
		return false;
	}

	SettingsUprHelpers::ConvertUtf16ToUtf8(wBuffer, buffer);

	return true;
}

//////////////////////////////////////////////////////////////////////////
bool CEngineSettingsUpr::GetModuleSpecificIntEntry(const char* key, int& value)
{
	value = 0;
...
//////////////////////////////////////////////////////////////////////////
bool CEngineSettingsUpr::GetModuleSpecificBoolEntry(const char* key, bool& value)
{
	value = false;
...
//////////////////////////////////////////////////////////////////////////
bool CEngineSettingsUpr::SetModuleSpecificStringEntryUtf16(const char* key, const wchar_t* str)
{
	SetKey(key, str);
	if (!m_bGetDataFromRegistry)
	{
...
//////////////////////////////////////////////////////////////////////////
bool CEngineSettingsUpr::SetModuleSpecificStringEntryUtf8(const char* key, const char* str)
{
	wchar_t wbuffer[512];
	SettingsUprHelpers::ConvertUtf8ToUtf16(str, SettingsUprHelpers::CWCharBuffer(wbuffer, sizeof(wbuffer)));

	return SetModuleSpecificStringEntryUtf16(key, wbuffer);
}

//////////////////////////////////////////////////////////////////////////
bool CEngineSettingsUpr::SetModuleSpecificIntEntry(const char* key, const int& value)
{
	SetKey(key, value);
	if (!m_bGetDataFromRegistry)
	{
...
//////////////////////////////////////////////////////////////////////////
bool CEngineSettingsUpr::SetModuleSpecificBoolEntry(const char* key, const bool& value)
{
	SetKey(key, value);
	if (!m_bGetDataFromRegistry)
	{
...
//////////////////////////////////////////////////////////////////////////
void CEngineSettingsUpr::SetRootPath(const wchar_t* szRootPath)
{
...
//////////////////////////////////////////////////////////////////////////
bool CEngineSettingsUpr::HasKey(const char* key)
{
	return m_keyValueArray.find(key) != 0;
}

//////////////////////////////////////////////////////////////////////////
void CEngineSettingsUpr::SetKey(const char* key, const wchar_t* value)
{
	m_keyValueArray.set(key, value);
}

//////////////////////////////////////////////////////////////////////////
void CEngineSettingsUpr::SetKey(const char* key, bool value)
{
	m_keyValueArray.set(key, (value ? "true" : "false"));
}

//////////////////////////////////////////////////////////////////////////
void CEngineSettingsUpr::SetKey(const char* key, int value)
{
	char buf[40];
...
//////////////////////////////////////////////////////////////////////////
void CEngineSettingsUpr::GetRootPathUtf16(SettingsUprHelpers::CWCharBuffer wbuffer)
{
	LoadEngineSettingsFromRegistry();
...
//////////////////////////////////////////////////////////////////////////
void CEngineSettingsUpr::GetRootPathAscii(SettingsUprHelpers::CCharBuffer buffer)
{
	wchar_t wbuffer[MAX_PATH];
	GetRootPathUtf16(SettingsUprHelpers::CWCharBuffer(wbuffer, sizeof(wbuffer)));
	SettingsUprHelpers::GetAsciiFilename(wbuffer, buffer);
}

//////////////////////////////////////////////////////////////////////////
bool CEngineSettingsUpr::GetInstalledBuildRootPathUtf16(const int index, SettingsUprHelpers::CWCharBuffer name, SettingsUprHelpers::CWCharBuffer path)
{
	RegKey key(L"Software\\DinrusPro\\Settings\\DrxExport\\ProjectBuilds", false);
	if (key.pKey)
	{
		DWORD type;
...
//////////////////////////////////////////////////////////////////////////
void CEngineSettingsUpr::CallSettingsDialog(void* pParent)
{
	HWND hParent = (HWND)pParent;

	wchar_t pathBuffer[1024];
	GetRootPathUtf16(SettingsUprHelpers::CWCharBuffer(pathBuffer, sizeof(pathBuffer)));
	if (!pathBuffer[0])
	{
	...
	if (FindWindowA(NULL, "DrxENGINE Settings"))
		return;
	...
	if (res < (HINSTANCE)33)
	{
		MessageBoxA(hParent, "Could not execute DrxENGINE settings dialog.\nPlease run Tools\\SettingsMgr.exe.", "Error", MB_OK | MB_ICONERROR);
		CallRootPathDialog(hParent);
		return;
	}

	Sleep(1000); // Sleep because DrxSleep is not available in this scope!
}

//////////////////////////////////////////////////////////////////////////
void CEngineSettingsUpr::CallRootPathDialog(void* pParent)
{
	HWND hParent = (HWND)pParent;
	...
	const wchar_t* szWindowClass = L"DRXENGINEROOTPATHUI";

	// Register the window class
	WNDCLASSW wndClass = {
		0,    WndProcSettingsUpr, 0,                   DLGWINDOWEXTRA,          GetModuleHandleW(0),
	...
	// Create the window
	HWND hDialogWnd = CreateWindowExW(WS_EX_TOOLWINDOW | WS_EX_CONTROLPARENT, szWindowClass, L"DrxENGINE RootPath", WS_BORDER | WS_CAPTION | WS_SYSMENU | WS_VISIBLE,
	...
	wchar_t buffer[512];
	GetValueByRef("ENG_RootPath", SettingsUprHelpers::CWCharBuffer(buffer, sizeof(buffer)));
...
//////////////////////////////////////////////////////////////////////////
void CEngineSettingsUpr::SetParentDialog(unsigned long window)
{
	m_hWndParent = window;
}

//////////////////////////////////////////////////////////////////////////
bool CEngineSettingsUpr::StoreData(bool bForceFileOutput)
{
	...
	for (size_t i = 0; i < m_keyValueArray.size(); ++i)
	{
		...
		{
			SettingsUprHelpers::ConvertUtf16ToUtf8(kv.value.c_str(), SettingsUprHelpers::CCharBuffer(buffer, sizeof(buffer)));
...
//////////////////////////////////////////////////////////////////////////
bool CEngineSettingsUpr::LoadValuesFromConfigFile(const wchar_t* szFileName)
{
	...
	while (end < size)
	{
		...
		if (equalsOfs < line.length())
		{
			...
			SettingsUprHelpers::ConvertUtf8ToUtf16(line.c_str() + equalsOfs + 1, SettingsUprHelpers::CWCharBuffer(wBuffer, sizeof(wBuffer)));
...
//////////////////////////////////////////////////////////////////////////
bool CEngineSettingsUpr::SetRegValue(void* key, const char* valueName, const wchar_t* value)
{
	SettingsUprHelpers::CFixedString<wchar_t, 256> name;
...
//////////////////////////////////////////////////////////////////////////
bool CEngineSettingsUpr::SetRegValue(void* key, const char* valueName, bool value)
{
	SettingsUprHelpers::CFixedString<wchar_t, 256> name;
	name.appendAscii(valueName);
...
//////////////////////////////////////////////////////////////////////////
bool CEngineSettingsUpr::SetRegValue(void* key, const char* valueName, int value)
{
	SettingsUprHelpers::CFixedString<wchar_t, 256> name;
	name.appendAscii(valueName);
...
//////////////////////////////////////////////////////////////////////////
bool CEngineSettingsUpr::GetRegValue(void* key, const char* valueName, SettingsUprHelpers::CWCharBuffer wbuffer)
{
	if (wbuffer.getSizeInElements() <= 0)
	{
		return false;
...
//////////////////////////////////////////////////////////////////////////
bool CEngineSettingsUpr::GetRegValue(void* key, const char* valueName, bool& value)
{
	SettingsUprHelpers::CFixedString<wchar_t, 256> name;
	name.appendAscii(valueName);
	...
	{
		wchar_t buffer[100];
		res = GetRegValue(key, valueName, SettingsUprHelpers::CWCharBuffer(buffer, sizeof(buffer)));
		if (res)
		{
...
//////////////////////////////////////////////////////////////////////////
bool CEngineSettingsUpr::GetRegValue(void* key, const char* valueName, int& value)
{
	SettingsUprHelpers::CFixedString<wchar_t, 256> name;
	name.appendAscii(valueName);
...
//////////////////////////////////////////////////////////////////////////
bool CEngineSettingsUpr::StoreEngineSettingsToRegistry()
{
	if (!m_bGetDataFromRegistry)
		return true;
	...
	RegKey key1(L"Software\\DinrusPro", true);
	if (!key1.pKey)
	{
		RegKey key0(L"Software", true);
		HKEY hKey1;
		RegCreateKeyA((HKEY)key0.pKey, "DinrusPro", &hKey1);
		if (!hKey1)
			return false;
	}

	RegKey key2(L"Software\\DinrusPro\\Settings", true);
	if (!key2.pKey)
	{
		RegKey key1(L"Software\\DinrusPro", true);
		HKEY hKey2;
	...
	RegKey key(L"Software\\DinrusPro\\Settings", true);
	if (!key.pKey)
	{
		bRet = false;
	}
	else
	{
		...
		if (GetValueByRef("ENG_RootPath", SettingsUprHelpers::CWCharBuffer(buffer, sizeof(buffer))))
		{
		...
		if (GetValueByRef("RC_ShowWindow", SettingsUprHelpers::CWCharBuffer(buffer, sizeof(buffer))))
		{
			const bool b = wcscmp(buffer, L"true") == 0;
			SetRegValue(key.pKey, "RC_ShowWindow", b);
		}

		if (GetValueByRef("RC_HideCustom", SettingsUprHelpers::CWCharBuffer(buffer, sizeof(buffer))))
		{
			const bool b = wcscmp(buffer, L"true") == 0;
			SetRegValue(key.pKey, "RC_HideCustom", b);
		}

		if (GetValueByRef("RC_Parameters", SettingsUprHelpers::CWCharBuffer(buffer, sizeof(buffer))))
		{
...
//////////////////////////////////////////////////////////////////////////
bool CEngineSettingsUpr::StoreLicenseSettingsToRegistry()
{
	if (!m_bGetDataFromRegistry)
		return true;
	...
	RegKey key2(REG_DINRUSPRO_SETTING_KEY, true);
	if (!key2.pKey)
	{
		RegKey key1(REG_SOFTWARE REG_COMPANY_NAME, true);
		HKEY hKey2;
	...
	RegKey key(REG_DINRUSPRO_SETTING_KEY, true);
	if (!key.pKey)
	{
		bRet = false;
	}
...
//////////////////////////////////////////////////////////////////////////
void CEngineSettingsUpr::LoadEngineSettingsFromRegistry()
{
	if (!m_bGetDataFromRegistry)
		return;
	...
	RegKey key(L"Software\\DinrusPro\\Settings", false);
	if (key.pKey)
	{
		// Engine Specific
		if (GetRegValue(key.pKey, "ENG_RootPath", SettingsUprHelpers::CWCharBuffer(buffer, sizeof(buffer))))
			SetKey("ENG_RootPath", buffer);

		// Engine Specific
		if (GetRegValue(key.pKey, "ENG_BinPath", SettingsUprHelpers::CWCharBuffer(buffer, sizeof(buffer))))
		...
		if (GetRegValue(key.pKey, "RC_Parameters", SettingsUprHelpers::CWCharBuffer(buffer, sizeof(buffer))))
			SetKey("RC_Parameters", buffer);
	}
}

//////////////////////////////////////////////////////////////////////////
long CEngineSettingsUpr::HandleProc(void* pWnd, long uMsg, long wParam, long lParam)
{
	HWND hWnd = (HWND)pWnd;
...
//////////////////////////////////////////////////////////////////////////
bool CEngineSettingsUpr::GetValueByRef(const char* key, SettingsUprHelpers::CWCharBuffer wbuffer) const
{
	if (wbuffer.getSizeInElements() <= 0)
	{
		return false;
...
//////////////////////////////////////////////////////////////////////////
bool CEngineSettingsUpr::GetValueByRef(const char* key, bool& value) const
{
	wchar_t buffer[100];
	if (!GetValueByRef(key, SettingsUprHelpers::CWCharBuffer(buffer, sizeof(buffer))))
	{
		return false;
	}
	value = (wcscmp(buffer, L"true") == 0);
...
//////////////////////////////////////////////////////////////////////////
bool CEngineSettingsUpr::GetValueByRef(const char* key, int& value) const
{
	wchar_t buffer[100];
	if (!GetValueByRef(key, SettingsUprHelpers::CWCharBuffer(buffer, sizeof(buffer))))
	{
