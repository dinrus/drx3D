...
void Joystick::Update() {
	...
	int32_t axeCount = 0;
	auto axesPtr = glfwGetJoystickAxes(static_cast<i32>(port), &axeCount);
	...
	auto buttonsPtr = glfwGetJoystickButtons(static_cast<i32>(port), &buttonCount);
	...
	int32_t hatCount = 0;
	auto hatsPtr = glfwGetJoystickHats(static_cast<i32>(port), &hatCount);
