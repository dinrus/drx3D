...
#define NET_FACILITY_DRXNETWORK 0x02000000

#define NET_NOIMPL              MAKE_NRESULT(NET_FAIL, NET_FACILITY_DRXNETWORK, 0x01)
#define NET_SOCKET_NOT_CREATED  MAKE_NRESULT(NET_FAIL, NET_FACILITY_DRXNETWORK, 0x02)
