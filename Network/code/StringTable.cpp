...
static u32k LOG2_NUM_STRING_IDS = 16;
static u32k NUM_STRING_IDS = 1 << LOG2_NUM_STRING_IDS;
...
public:
	...
	typedef std::unordered_map<string, u32, stl::hash_strcmp<string>, stl::hash_strcmp<string>> StrToIdMap;
...
{
	u32 id = in.ReadBits(LOG2_NUM_STRING_IDS);
