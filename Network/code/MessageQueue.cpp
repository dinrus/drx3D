...
public:
	...
	std::map<u32, SAccountingGroupPolicy> m_policy;
};
...
{
	for (i32 i = 0; i < m_nAccountingGroups; i++)
	{
...
void CMessageQueue::WriteMessages(IMessageOutput* pOut, const SSchedulingParams& params)
{
	...
	u32 stopAfterBytes = params.targetBytes - 8;
...
void CMessageQueue::DrawLabel(float x, float y, float* clr, tukk msg, ...)
{
	...
	if (t)
		t->PutText((i32)(x / 4 - 2), (i32)(y / 10 - 1), buffer);
