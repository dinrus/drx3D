...
void CServerProfiler::Tick()
{
	...
	IMemoryUpr::SProcessMemInfo memcnt;
	GetISystem()->GetIMemoryUpr()->GetProcessMemInfo(memcnt);
...
void CServerProfiler::TimerCallback(NetTimerId, uk , CTimeValue)
{
	m_pThis->Tick();
