...
{
	SSetNicknameParams(){}
	SSetNicknameParams(tukk nick) : m_nick(nick){}
	string m_nick;
	void   SerializeWith(TSerialize ser)
	{
...
public:
	...
	virtual tukk ValidateMessage(const SNetMessageDef*, bool bNetworkMsg);
...
private:
	...
	virtual tukk DebugString()       { return "SERVER"; }
	...
	typedef Vec3_tpl<i32> BreakSegmentID;
