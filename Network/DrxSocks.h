...
#define LOCAL_FALLBACK_DOMAIN ".intern.drxtek.de" // On connection error try to fallback to this domain
...
#define INCLUDED_FROM_DRX_SOCKS_H

#if DRX_PLATFORM_WINAPI
	#include <drx3D/Network/DrxSocks_win32.h>
#elif DRX_PLATFORM_ORBIS
	#include <drx3D/Network/DrxSocks_sce.h>
#elif DRX_PLATFORM_POSIX
	#include <drx3D/Network/DrxSocks_posix.h>
#endif

#undef INCLUDED_FROM_DRX_SOCKS_H
