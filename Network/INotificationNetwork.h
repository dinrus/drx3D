...
struct INotificationNetworkListener
{
	...
	virtual void OnNotificationNetworkReceive(ukk pBuffer, size_t length) = 0;
	// </interfuscator:shuffle>
};
...
struct INotificationNetworkClient
{
	...
	virtual bool ListenerBind(tukk channelName, INotificationNetworkListener* pListener) = 0;
	...
	virtual bool Send(tukk channelName, ukk pBuffer, size_t length) = 0;
	...
	virtual bool Connect(tukk address, u16 port) = 0;
...
struct INotificationNetwork
{
	...
	virtual INotificationNetworkClient* Connect(tukk address, u16 port) = 0;
	...
	virtual size_t GetConnectionCount(tukk channelName = NULL) = 0;
	...
	virtual u32 Send(tukk channel, ukk pBuffer, size_t length) = 0;
	// </interfuscator:shuffle>
};
