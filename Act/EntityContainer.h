...
// Описание: A container to gather entities and applying actions to all of them at once
...
private:
	...
	CEntityContainer(EntityId containerId, const TEntityContainerListeners* pListeners, tukk szContainerName = nullptr);
...
private:
	...
	struct CVars
	{
		...
		static i32  ms_es_debugContainers;
	};

	tukk GetName() const { return m_szName; }
