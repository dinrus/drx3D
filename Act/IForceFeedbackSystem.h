...
struct IFFSPopulateCallBack
{
	...
	virtual void AddFFSEffectName(tukk const pName) = 0;
};
...
struct IForceFeedbackSystem
{
	...
	virtual ForceFeedbackFxId GetEffectIdByName(tukk effectName) const = 0;
	...
	//			leftEnvelope - Envelope value (u16) from 0 to 2000 for left trigger motor
	//			rightEnvelope - Envelope value (u16) from 0 to 2000 for left trigger motor
	...
	// Return Value:
	//			Number of effects
	virtual i32 GetEffectNamesCount() const = 0;
