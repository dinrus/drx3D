...
struct ICustomAction
{
	...
	virtual tukk GetCustomActionGraphName() const = 0;
	...
	virtual void               RegisterListener(ICustomActionListener* pEventListener, tukk name) = 0;
...
{
	// <interfuscator:shuffle>
	virtual ~ICustomActionUpr(){}

	//! Execute start section of action.
	virtual bool StartAction(IEntity* pObject, tukk szCustomActionGraphName, ICustomActionListener* pListener = NULL) = 0;

	//! Execute succeed section of action.
	virtual bool SucceedAction(IEntity* pObject, tukk szCustomActionGraphName, ICustomActionListener* pListener = NULL) = 0;
	...
	virtual void LoadLibraryActions(tukk sPath) = 0;
	...
	//! \return An action by name if exists in library, NULL if not found.
	virtual ICustomAction* GetCustomActionFromLibrary(tukk szCustomActionGraphName) = 0;
