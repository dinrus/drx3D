...
{
public:
	void Begin(tukk name, bool clear);
	...
	void Add2DText(tukk text, float size, ColorF clr, float timeout);
	void Add2DLine(float x1, float y1, float x2, float y2, ColorF clr, float timeout);
	void AddText(float x, float y, float size, ColorF clr, float timeout, tukk fmt, ...);
	void AddText3D(const Vec3& pos, float size, ColorF clr, float timeout, tukk fmt, ...);
	...
	void AddEntityTag(const SEntityTagParams& params, tukk tagContext = "");
	void ClearEntityTags(EntityId entityId);
	void ClearStaticTag(EntityId entityId, tukk staticId);
	void ClearTagContext(tukk tagContext);
	void ClearTagContext(tukk tagContext, EntityId entityId);
