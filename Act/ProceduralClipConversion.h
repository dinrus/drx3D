...
struct SProcClipConversionEntry
{
	...
	void       CreateAttribute(XmlNodeRef pNewNode, const ParamConversionStringList& newAttributeName, tukk const newAttributeValue) const;
	void       ConvertAttribute(const XmlNodeRef& pOldNode, XmlNodeRef pNewNode, tukk const oldAttributeName, const ParamConversionStringList& newAttributeName) const;
