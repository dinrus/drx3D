...
public:
	...
	tukk          GetSeatName() const     { return m_name.c_str(); }
	...
	virtual i32                       GetViewCount() const           { return m_views.size(); };
	...
	void     OnAction(const TVehicleActionId actionId, i32 activationMode, float value);
	...
	float                   ProcessPassengerDamage(float actorHealth, float damage, i32 hitTypeId, bool explosion);
	...
	virtual void            OnCameraShake(float& angleAmount, float& shiftAmount, const Vec3& pos, tukk source) const;
	...
	i32                              GetSeatActionId(IVehicleSeatAction* pAction) const;
	const IVehicleSeatAction*        GetSeatActionById(i32 id) const;
	...
	virtual i32                      GetCurrentTransition() const                { return m_transitionType; }
	...
	i32                              GetSeatGroupIndex() const                   { return m_seatGroupIndex; }
...
protected:
	...
	static CDrxAction*              m_pGameFramework;
	...
	i32   m_seatGroupIndex;

	u8 m_transitionType;
	u8 m_prevTransitionType;
	u8 m_queuedTransition;
