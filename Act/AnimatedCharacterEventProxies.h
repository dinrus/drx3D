...
{
	DRX_ENTITY_COMPONENT_INTERFACE_AND_CLASS_GUID(CAnimatedCharacterComponent_PrepareAnimatedCharacterForUpdate,
		"CAnimatedCharacterComponent_PrepareAnimatedCharacterForUpdate", "3f9d1b59-ebab-4f73-abb9-b04c675a32b9"_drx_guid)
public:
...
{
	DRX_ENTITY_COMPONENT_INTERFACE_AND_CLASS_GUID(CAnimatedCharacterComponent_StartAnimProc,
		"CAnimatedCharacterComponent_StartAnimProc", "aa2d677d-23a0-48d5-aa47-116b97dd6216"_drx_guid)
...
{
	DRX_ENTITY_COMPONENT_INTERFACE_AND_CLASS_GUID(CAnimatedCharacterComponent_GenerateMoveRequest,
		"CAnimatedCharacterComponent_GenerateMoveRequest", "0cc3ee7e-1ace-4bcd-9aea-e391b81b8e78"_drx_guid)
