...
public:
	...
	CNodeLiveWriter(CWriter& Writer, NodeLiveID ID, StringID IDTag, u32 safecheckID);
	...
	CNodeLiveWriterRef AddChildNode(tukk pChildName);
	void               Done();
	template<class T>
	void               AddAttr(tukk pAttrName, const T& data);
	void               AddAttr(tukk pAttrName, u8k* data, u32 len, bool needInmediateCopy = false);
	tukk        GetTag() const;

	// TODO: they do linear strcmp searchs, check if they could be avoided or if they need optimization
	bool        HaveAttr(tukk pAttrName);
	tukk ReadAttrStr(tukk pAttrName);
...
private:
	...
	NodeLiveID GetID() const   { return m_ID; }
	void       Reuse(StringID IDTag, u32 safecheckID);
	void       CompactPendingChildren();
	void       Compact();
	u32     GetSafeCheckID() const { return m_safecheckID; }
	...
	u32                           m_safecheckID; // to prevent wrong use.
	...
	static i32k INITIAL_SIZE_CHILDREN_VECTOR;
	static i32k INITIAL_SIZE_ATTRS_VECTOR;
	...
	struct TStats
	{
		...
		u32 m_maxNumChildren;
		u32 m_maxNumAttrs;
		u32 m_totalNodesCreated;
		u32 m_totalAttrs;
		u32 m_totalChildren;
		u32 m_totalSizeNodeData;            // not including attrs
		u32 m_totalSizeAttrData;
	};
...
//////////////////////////////////////////////////////////////////////////
template<class T>
inline void CNodeLiveWriter::AddAttr(tukk pAttrName, const T& data)
{
