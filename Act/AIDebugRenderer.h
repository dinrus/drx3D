...
public:
	...
	virtual i32   GetWidth()  { return m_pRenderer->GetOverlayWidth(); }
	virtual i32   GetHeight() { return m_pRenderer->GetOverlayHeight(); }
	...
	virtual ITexture* LoadTexture(tukk sNameOfTexture, u32 nFlags);
	...
	virtual u32 PopState();
	virtual u32 PushState();
