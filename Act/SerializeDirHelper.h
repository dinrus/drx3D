...
static inline void SerializeDirHelper(TSerialize ser, Vec3& dir, i32 policyYaw, i32 policyElev)
{
...
static inline void SerializeDirHelper(CBitArray& array, Vec3& dir, i32 nYawBits, i32 nElevBits)
{
	// Serialise look direction as yaw and elev. Gives better compression
	float yaw, elev;
...
static inline void SerializeDirVector(CBitArray& array, Vec3& dir, float maxLength, i32 nScaleBits, i32 nYawBits, i32 nElevBits)
{
	float length;
	if (array.IsReading())
	{
