...
// -------------------------------------------------------------------------
//  Имя файла:   FlashUIElementNodes.h
//  Version:     v1.00
...
private:
	...
	inline i32  GetInputPort(EInputs input)
	{
		if (input <= eI_TemplateInstanceName)
			return (i32) input;
		return m_isTemplate ? (i32) input : (i32) input - 1;
	}
	bool m_isTemplate;
};
////////////////////////////////////////////////////////////////////////////
...
private:
	void GotoAndPlay(IUIElement* pElement, i32 frameId, tukk frameName);
	void GotoAndStop(IUIElement* pElement, i32 frameId, tukk frameName);
...
private:
	...
	i32                            m_iCurrInstanceId;

	typedef CUIStack<std::pair<SUIArguments, i32>> TEventStack;
...
private:
	...
	inline bool IsTemplate() const { return m_isTemplate; }
	inline i32  GetDynStartPort()  { return m_isTemplate ? (i32) eI_DynamicPorts : (i32) eI_DynamicPorts - 1; }
...
private:
	...
	typedef CUIStack<std::pair<EOutputs, i32>> TEventStack;
	TEventStack m_events;
