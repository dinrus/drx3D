...
//////////////////////////////////////////////////////////////////////////
CBinarySerializedObject::CBinarySerializedObject(tukk szSection)
...
//////////////////////////////////////////////////////////////////////////
void CBinarySerializedObject::GetMemoryUsage(IDrxSizer* pSizer) const
{
	pSizer->Add(*this);
...
//////////////////////////////////////////////////////////////////////////
void CBinarySerializeHelper::GetMemoryUsage(IDrxSizer* pSizer) const
{
	pSizer->Add(*this);
}

//////////////////////////////////////////////////////////////////////////
_smart_ptr<ISerializedObject> CBinarySerializeHelper::CreateSerializedObject(tukk szSection)
{
	assert(szSection && szSection[0]);
...
//////////////////////////////////////////////////////////////////////////
bool CBinarySerializeHelper::Write(ISerializedObject* pObject, TSerializeFunc serializeFunc, uk pArgument /*= NULL*/)
{
	assert(pObject);
...
//////////////////////////////////////////////////////////////////////////
bool CBinarySerializeHelper::Read(ISerializedObject* pObject, TSerializeFunc serializeFunc, uk pArgument /*= NULL*/)
{
	assert(pObject);
