...
void CDrxAction::DefineProtocolRMI(IProtocolBuilder* pBuilder)
{
...
void CDrxAction::DoInvokeRMI(_smart_ptr<IRMIMessageBody> pBody, unsigned where,
	i32 channel, const bool isGameObjectRmi)
{
	if (!isGameObjectRmi)
	{
