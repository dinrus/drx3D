...
tukk CVehicleViewActionThirdPerson::m_name = "ActionThirdPerson";
...
void CVehicleViewActionThirdPerson::OnStartUsing(EntityId passengerId)
{
	...
	DrxLog("Entity position=%.2f %.2f %.2f, initial camera position=%.2f %.2f %.2f, offset=%.2f %.2f %.2f", worldPos.x, worldPos.y, worldPos.z, m_worldViewPos.x, m_worldViewPos.y, m_worldViewPos.z, m_cameraOffset.x, m_cameraOffset.y, m_cameraOffset.z);
...
//------------------------------------------------------------------------
void CVehicleViewActionThirdPerson::OnAction(const TVehicleActionId actionId, i32 activationMode, float value)
{
