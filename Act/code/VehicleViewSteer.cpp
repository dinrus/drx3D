...
tukk CVehicleViewSteer::m_name = "SteerThirdPerson";
...
static void getFlag(CVehicleParams& params, tukk key, i32& flags, i32 flag)
{
	i32 tmp = flags & flag;
...
//------------------------------------------------------------------------
void CVehicleViewSteer::OnAction(const TVehicleActionId actionId, i32 activationMode, float value)
{
...
void CVehicleViewSteer::Update(float dt)
{
	...
	{
		DRX_ASSERT_MESSAGE(0, "camera will fail because lookat position is invalid");
	}
...
void CVehicleViewSteer::UpdateView(SViewParams& viewParams, EntityId playerId)
{
	...
	{
		DRX_ASSERT_MESSAGE(0, "camera position invalid");
	}
	...
	{
		DRX_ASSERT_MESSAGE(0, "camera rotation invalid");
	}
