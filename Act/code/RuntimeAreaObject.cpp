...
bool CRuntimeAreaObject::ReloadExtension(IGameObject* pGameObject, const SEntitySpawnParams& params)
{
	...
	DRX_ASSERT_MESSAGE(false, "CRuntimeAreaObject::ReloadExtension not implemented");

	return false;
}

///////////////////////////////////////////////////////////////////////////
bool CRuntimeAreaObject::NetSerialize(TSerialize ser, EEntityAspects aspect, u8 profile, i32 flags)
{
	DRX_ASSERT_MESSAGE(false, "CRuntimeAreaObject::NetSerialize not implemented");
...
///////////////////////////////////////////////////////////////////////////
void CRuntimeAreaObject::GetMemoryUsage(IDrxSizer* pSizer) const
{
...
void CRuntimeAreaObject::UpdateParameterValues(IEntity* const pEntity, TAudioParameterMap& paramMap)
{
	...
	if (pAudioProxy != NULL)
	{
		...
		gEnv->p3DEngine->GetIMergedMeshesUpr()->QueryDensity(pEntity->GetPos(), aSurfaceTypes, aDensities);

		for (i32 i = 0; i < MMRM_MAX_SURFACE_TYPES && (aSurfaceTypes[i] != NULL); ++i)
		{
