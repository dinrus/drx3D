...
bool CContactRaycastPinger::Update(Vec3& position, Vec3& normal)
{
	...
	i32 nSkip = m_pinger.GetSkipEntities(pSkipEntities, 10);

	static i32k totalHits = 6;
	...
	i32 hitCount = gEnv->pPhysicalWorld->RayWorldIntersection(rp);
...
ILINE bool InitializePoseAlignerBipedHuman(PoseAligner::CPose& pose, IEntity& entity, ICharacterInstance& character)
{
	...
	i32 jointIndexRoot = rIDefaultSkeleton.GetJointIDByName("Bip01 Pelvis");
	if (jointIndexRoot < 0)
		return false;
	i32 jointIndexFrontLeft = rIDefaultSkeleton.GetJointIDByName("Bip01 planeTargetLeft");
	if (jointIndexFrontLeft < 0)
		return false;
	i32 jointIndexFrontRight = rIDefaultSkeleton.GetJointIDByName("Bip01 planeTargetRight");
	if (jointIndexFrontRight < 0)
		return false;

	i32 jointIndexLeftBlend = rIDefaultSkeleton.GetJointIDByName("Bip01 planeWeightLeft");
	i32 jointIndexRightBlend = rIDefaultSkeleton.GetJointIDByName("Bip01 planeWeightRight");
...
ILINE bool InitializePoseAlignerBipedAlien(PoseAligner::CPose& pose, IEntity& entity, ICharacterInstance& character)
{
	IDefaultSkeleton& rIDefaultSkeleton = character.GetIDefaultSkeleton();
	// Stalker, Grunt
	i32 jointIndexRoot = rIDefaultSkeleton.GetJointIDByName("Pelvis");
	if (jointIndexRoot < 0)
		return false;
	i32 jointIndexFrontLeft = rIDefaultSkeleton.GetJointIDByName("L Heel");
	if (jointIndexFrontLeft < 0)
		return false;
	i32 jointIndexFrontRight = rIDefaultSkeleton.GetJointIDByName("R Heel");
	if (jointIndexFrontRight < 0)
		return false;
...
#define CREATEPINGERCONTACTREPORTER                                                                          \
  ...
  {                                                                                                          \
	...
	if (jointIndexRoot < 0)
		return false;
	i32 jointIndexFrontLeft = rIDefaultSkeleton.GetJointIDByName("planeAlignerLeft");
	if (jointIndexFrontLeft < 0)
		return false;
	i32 jointIndexFrontLeftBlend = rIDefaultSkeleton.GetJointIDByName("planeLockWeightLeft");
	if (jointIndexFrontLeftBlend < 0)
		return false;
	i32 jointIndexFrontRight = rIDefaultSkeleton.GetJointIDByName("planeAlignerRight");
	if (jointIndexFrontRight < 0)
		return false;
	i32 jointIndexFrontRightBlend = rIDefaultSkeleton.GetJointIDByName("planeLockWeightRight");
	if (jointIndexFrontRightBlend < 0)
		return false;
	i32 jointIndexFrontCenter = rIDefaultSkeleton.GetJointIDByName("planeAlignerCenter");
	if (jointIndexFrontCenter < 0)
		return false;
	i32 jointIndexFrontCenterBlend = rIDefaultSkeleton.GetJointIDByName("planeLockWeightCenter");
...
{
	IDefaultSkeleton& rIDefaultSkeleton = character.GetIDefaultSkeleton();
	i32 jointIndexRoot = rIDefaultSkeleton.GetJointIDByName("hips_joint");
	if (jointIndexRoot < 0)
		return false;
	i32 jointIndexBackLeft = rIDefaultSkeleton.GetJointIDByName("l_bwd_leg_end_joint");
	if (jointIndexBackLeft < 0)
		return false;
	i32 jointIndexBackLeftBlend = rIDefaultSkeleton.GetJointIDByName("planeLockWeightBackLeft");
	if (jointIndexBackLeftBlend < 0)
		return false;
	i32 jointIndexBackRight = rIDefaultSkeleton.GetJointIDByName("r_bwd_leg_end_joint");
	if (jointIndexBackRight < 0)
		return false;
	i32 jointIndexBackRightBlend = rIDefaultSkeleton.GetJointIDByName("planeLockWeightBackRight");
	if (jointIndexBackRightBlend < 0)
		return false;
	i32 jointIndexFrontLeft = rIDefaultSkeleton.GetJointIDByName("l_fwd_leg_end_joint");
	if (jointIndexFrontLeft < 0)
		return false;
	i32 jointIndexFrontLeftBlend = rIDefaultSkeleton.GetJointIDByName("planeLockWeightFrontLeft");
	if (jointIndexFrontLeftBlend < 0)
		return false;
	i32 jointIndexFrontRight = rIDefaultSkeleton.GetJointIDByName("r_fwd_leg_end_joint");
	if (jointIndexFrontRight < 0)
		return false;
	i32 jointIndexFrontRightBlend = rIDefaultSkeleton.GetJointIDByName("planeLockWeightFrontRight");
	if (jointIndexFrontRightBlend < 0)
		return false;
...
{
	IDefaultSkeleton& rIDefaultSkeleton = character.GetIDefaultSkeleton();
	i32 jointIndexRoot = rIDefaultSkeleton.GetJointIDByName("Def_COG_jnt");
	if (jointIndexRoot < 0)
		return false;
	i32 jointIndexBackLeft = rIDefaultSkeleton.GetJointIDByName("Def_L_ToeEnd_jnt");
	if (jointIndexBackLeft < 0)
		return false;
	i32 jointIndexBackRight = rIDefaultSkeleton.GetJointIDByName("Def_R_ToeEnd_jnt");
	if (jointIndexBackRight < 0)
		return false;
	i32 jointIndexFrontLeft = rIDefaultSkeleton.GetJointIDByName("Def_L_WristEnd_jnt");
	if (jointIndexFrontLeft < 0)
		return false;
	i32 jointIndexFrontRight = rIDefaultSkeleton.GetJointIDByName("Def_R_WristEnd_jnt");
	if (jointIndexFrontRight < 0)
		return false;
...
DRXREGISTER_CLASS(CPoseAlignerC3)
