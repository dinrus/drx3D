...
namespace
{
void AISendSignal(IEntity* const pEntity, tukk const signalName)
{
	DRX_ASSERT(pEntity);
...
public:
	...
	virtual void OnEntityEvent(IEntity* pEntity, const SEntityEvent& event)
	{
		...
		tukk eventName = reinterpret_cast<tukk >(event.nParam[0]);
		u32k eventNameCrc = CCrc32::Compute(eventName);

		static u32k s_arrivedAtPathEndCrc = CCrc32::Compute("ArrivedAtPathEnd");
		static u32k s_arrivedCloseToPathEndCrc = CCrc32::Compute("ArrivedCloseToPathEnd");
		static u32k s_pathFollowingStoppedCrc = CCrc32::Compute("PathFollowingStopped");
...
public:
	...
	virtual void OnEntityEvent(IEntity* pEntity, const SEntityEvent& event)
	{
		...
		static u32k s_forceAttentionTargetFinishedCrc = CCrc32::Compute("ForceAttentionTargetFinished");
