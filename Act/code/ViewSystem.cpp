...
void CViewSystem::RemoveView(u32 viewId)
{
	RemoveViewById(viewId);
}

void CViewSystem::RemoveViewById(u32 viewId)
{
...
//------------------------------------------------------------------------
void CViewSystem::SetActiveView(u32 viewId)
{
	IView* const __restrict pPrevView = GetView(m_activeViewId);
...
//------------------------------------------------------------------------
IView* CViewSystem::GetView(u32 viewId) const
{
...
bool CViewSystem::IsClientActorViewActive() const
{
	...
	return pActiveView->GetLinkedId() == CDrxAction::GetDrxAction()->GetClientActorId();
}

//------------------------------------------------------------------------
u32 CViewSystem::GetViewId(IView* pView) const
{
	for (auto const& view : m_views)
	{
...
//------------------------------------------------------------------------
u32 CViewSystem::GetActiveViewId() const
{
...
//------------------------------------------------------------------------
void CViewSystem::BeginCutScene(IAnimSequence* pSeq, u64 dwFlags, bool bResetFX)
{
	m_cutsceneCount++;
	...
	/* TODO: how do we block keys
	   ...
	   m_pGame->m_pIActionMapUpr->SetActionMap("player_dead");
...
//------------------------------------------------------------------------
void CViewSystem::EndCutScene(IAnimSequence* pSeq, u64 dwFlags)
{
	...
	/* TODO: resolve input difficulties
	   m_pGame->m_pIActionMapUpr->SetActionMap("default");
	   GetISystem()->GetIInput()->GetIKeyboard()->ClearKeyState();
	 */
	...
	/* TODO: weird game related stuff
	   ...
	   {
	    CPlayer *pPlayer;
	    if (m_pGame->GetMyPlayer()->GetContainer()->QueryContainerInterface(CIT_IPLAYER,(uk *)&pPlayer))
	    {
...
void CViewSystem::SendGlobalEvent(tukk pszEvent)
{
...
void CViewSystem::ClearCutsceneViews()
{
	...
	i32k count = m_cutsceneViewIdVector.size();
...
//////////////////////////////////////////////////////////////////////////
void CViewSystem::GetMemoryUsage(IDrxSizer* s) const
{
