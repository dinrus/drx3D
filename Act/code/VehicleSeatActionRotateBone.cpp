...
{
	DrxCreateClassInstanceForInterface(drxiidof<IAnimationOperatorQueue>(), m_poseModifier);
}
...
bool CVehicleSeatActionRotateBone::Init(IVehicle* pVehicle, IVehicleSeat* pSeat, const CVehicleParams& table)
{
	...
	if (pIDefaultSkeleton)
	{
		...
		{
			tukk boneName = table.getAttr("MoveBone");
...
void CVehicleSeatActionRotateBone::OnAction(const TVehicleActionId actionId, i32 activationMode, float value)
{
...
void CVehicleSeatActionRotateBone::GetMemoryUsage(IDrxSizer* s) const
{
...
///*static*/ tSoundID CVehicleSeatActionRotateBone::PlaySound( IEntityAudioComponent& rIEntityAudioComponent, tukk  soundName )
//{
...
//}
//
///*static*/ void CVehicleSeatActionRotateBone::SetSoundParam(IEntityAudioComponent& rIEntityAudioComponent, tSoundID soundID, tukk param, float value)
//{
