...
/*************************************************************************
   ...
   $Id$
   $DateTime$
   Описание: Implements a flow node to handle vehicle passengers
...
#include <drx3D/Act/FlowVehiclePassenger.h>
...
void CFlowVehiclePassenger::GetConfiguration(SFlowNodeConfig& nodeConfig)
{
	...
	static const SInputPortConfig pInConfig[] =
	{
		...
		InputPortConfig<i32>("SeatId",          _HELP("Seat ID of the preferred seat where place the new passenger")),
		{ 0 }
	};
