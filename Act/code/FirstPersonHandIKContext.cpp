...
#include <drx3D/Act/FirstPersonHandIKContext.h>
...
void CFirstPersonHandIKContext::Update(float timePassed)
{
	...
	i16 blendParentId = m_pCharacterInstance->GetIDefaultSkeleton().GetJointParentIDByID(m_params.m_rightBlendIkIdx);
...
DRXREGISTER_CLASS(CFirstPersonHandIKContext);
