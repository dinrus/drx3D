	...
	, m_type(type)
{
	...
	{
		DRX_ASSERT_MESSAGE(gEnv->pFlowSystem, "FlowSystem not initialized, crash will follow!");
	...
	{
		DRX_ASSERT_MESSAGE(gEnv->pScriptSystem, "ScriptSystem not initialized, crash will follow!");
...
{
	DRX_ASSERT_MESSAGE(m_type == eUIAT_FlowGraph, "Try to serialize Flowgraph of Lua UI Action");
...
//------------------------------------------------------------------------------------
bool CFlashUIAction::Serialize(tukk scriptFile, bool bIsLoading)
{
	DRX_ASSERT_MESSAGE(m_type == eUIAT_LuaScript, "Try to serialize Script of FG UI Action");
...
//-------------------------------------------------------------------
void CFlashUIAction::GetMemoryUsage(IDrxSizer* s) const
{
...
//------------------------------------------------------------------------------------
void CUIActionUpr::StartAction(IUIAction* pAction, const SUIArguments& args)
{
...
//------------------------------------------------------------------------------------
void CUIActionUpr::EndAction(IUIAction* pAction, const SUIArguments& args)
{
	if (!m_bAcceptRequests) return;
...
//------------------------------------------------------------------------------------
void CUIActionUpr::EnableAction(IUIAction* pAction, bool bEnable)
{
	if (!m_bAcceptRequests) return;
...
//------------------------------------------------------------------------------------
void CUIActionUpr::AddListener(IUIActionListener* pListener, tukk name)
{
...
//------------------------------------------------------------------------------------
void CUIActionUpr::RemoveListener(IUIActionListener* pListener)
{
...
//-------------------------------------------------------------------
void CUIActionUpr::GetMemoryUsage(IDrxSizer* s) const
{
	SIZER_SUBCOMPONENT_NAME(s, "UIActionUpr");
	s->AddObject(this, sizeof(*this));
...
//------------------------------------------------------------------------------------
void CUIActionUpr::StartActionInt(IUIAction* pAction, const SUIArguments& args)
{
	DRX_PROFILE_FUNCTION(PROFILE_ACTION);
...
//------------------------------------------------------------------------------------
void CUIActionUpr::EndActionInt(IUIAction* pAction, const SUIArguments& args)
{
	DRX_PROFILE_FUNCTION(PROFILE_ACTION);
...
//------------------------------------------------------------------------------------
void CUIActionUpr::EnableActionInt(IUIAction* pAction, bool bEnable)
{
