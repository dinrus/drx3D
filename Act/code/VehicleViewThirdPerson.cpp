...
tukk CVehicleViewThirdPerson::m_name = "ThirdPerson";
...
CVehicleViewThirdPerson::CVehicleViewThirdPerson()
	...
	, m_height(0.0f)
	, m_distance(0.0f)
	, m_boundSwitchAngle(0.0f)
	, m_rot(0.0f)
	, m_interpolationSpeed(5.0f) // default speed
	, m_zoom(1.0f)
	, m_zoomMult(0.0f)
	, m_actionZoom(0.0f)
...
//------------------------------------------------------------------------
void CVehicleViewThirdPerson::OnAction(const TVehicleActionId actionId, i32 activationMode, float value)
{
