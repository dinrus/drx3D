...
#include <drx3D/Act/EntityContainer.h>


i32 CEntityContainer::CVars::ms_es_debugContainers = 0;


CEntityContainer::CEntityContainer(EntityId containerId, const TEntityContainerListeners* pListeners, tukk szContainerName /* = nullptr */)
...
// ------------------------------------------------------------------------
/* static */ void CEntityContainer::Log(tukk szMessage)
{
	DrxLog(szMessage);
}
