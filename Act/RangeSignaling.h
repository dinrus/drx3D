...
public:
	...
	/*$1- Utils --------------------------------------------------------------*/
	bool AddRangeSignal(EntityId IdEntity, float fRadius, float fBoundary, tukk sSignal, IAISignalExtraData* pData = NULL);
	bool AddTargetRangeSignal(EntityId IdEntity, EntityId IdTarget, float fRadius, float fBoundary, tukk sSignal, IAISignalExtraData* pData = NULL);
	bool AddAngleSignal(EntityId IdEntity, float fAngle, float fBoundary, tukk sSignal, IAISignalExtraData* pData = NULL);
