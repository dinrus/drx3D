...
#include <drx3D/Act/InterpolationHelpers.h>
...
public:
	...
	void         SetAimGoal(Vec3 aimPos, i32 priority = 0);
	...
	virtual bool GetRotationLimits(i32 axis, float& min, float& max);
