...
public:
	...
	size_t               Register(tukk scriptName, tukk serializeName);
	size_t               Count() const;
	size_t               GetID(tukk scriptName) const;
...
public:
	...
	const SGameScopeDesc* GetScopeDesc(tukk scriptName) const;

	CStatsTracker*        PushGameScope(size_t scopeID, u32 timestamp, CGameStatistics* gameStatistics);
