...
// -------------------------------------------------------------------------
//  Имя файла:   FlashUIDisplayNodes.h
//  Version:     v1.00
...
private:
	...
	void   SetToInstance(IUIElement* pInstance, uint64 flags, float alpha, i32 layer);
...
private:
	void GetLayer(IUIElement* pInstance, i32& layer) { layer = pInstance->GetLayer(); }
	void SetLayer(IUIElement* pInstance, i32 layer)  { pInstance->SetLayer(layer); }
