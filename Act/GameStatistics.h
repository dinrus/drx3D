...
public:
	...
	virtual size_t                   RegisterGameEvent(tukk scriptName, tukk serializeName);
	virtual size_t                   GetEventCount() const;
	virtual size_t                   GetEventID(tukk scriptName) const;
	virtual size_t                   GetEventIDBySerializeName(tukk serializeName) const;
	...
	virtual size_t                   RegisterGameState(tukk scriptName, tukk serializeName);
	virtual size_t                   GetStateCount() const;
	virtual size_t                   GetStateID(tukk scriptName) const;
	...
	virtual size_t                   GetScopeID(tukk scriptName) const;
	...
	virtual size_t                   GetElementID(tukk scriptName) const;
	...
	virtual XmlNodeRef               CreateStatXMLNode(tukk tag = "root");
...
private:
	...
	tukk          GetSerializeName(const SNodeLocator& locator) const;
	void                 NotifyVisitNode(const SNodeLocator& locator, tukk serializeName, IStatsContainer& container, EStatNodeState state);
	void                 NotifyLeaveNode(const SNodeLocator& locator, tukk serializeName, IStatsContainer& container, EStatNodeState state);
