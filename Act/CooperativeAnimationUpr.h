...
/*************************************************************************
   ...
   $Id$
   $DateTime$
   Описание: Central manager for synchronized animations on multiple actors
...
class CCooperativeAnimationUpr : public ICooperativeAnimationUpr
{
public:
	CCooperativeAnimationUpr() {}
	virtual ~CCooperativeAnimationUpr();
