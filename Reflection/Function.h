...
private:
	u8 m_pointer[sizeof(uint64) * 2];
};

// TODO: Code from old sxema reflection that needs to be integrated in new sxema.
struct CFunctionExecutionContext
{
public:
	CFunctionExecutionContext(uk pObject)
		: m_pObject(pObject)
	{}
...
public:
	...
	{
		DRX_ASSERT_MESSAGE(m_proxyFunc && m_functionPtr.IsValid(), "Pointer or proxy not set.");
