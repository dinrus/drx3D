...
sth_stash* initFont(GLPrimitiveRenderer* primRenderer)
{
	...
	i32 numPaths = sizeof(fontPaths) / sizeof(tuk);
...
#endif
void keyCallback(i32 key, i32 value)
{
...
i32 main()
{
	...
	i32 majorGlVersion, minorGlVersion;

	if (!(sscanf((tukk)glGetString(GL_VERSION), "%d.%d", &majorGlVersion, &minorGlVersion) == 2))
	{
