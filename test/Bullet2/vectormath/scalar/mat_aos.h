...
inline Matrix3 &Matrix3::setCol(i32 col, const Vector3 &vec)
{
	*(&mCol0 + col) = vec;
	return *this;
}

inline Matrix3 &Matrix3::setRow(i32 row, const Vector3 &vec)
{
...
inline Matrix3 &Matrix3::setElem(i32 col, i32 row, float val)
{
	Vector3 tmpV3_0;
...
inline float Matrix3::getElem(i32 col, i32 row) const
{
...
inline const Vector3 Matrix3::getCol(i32 col) const
{
	return *(&mCol0 + col);
}

inline const Vector3 Matrix3::getRow(i32 row) const
{
	return Vector3(mCol0.getElem(row), mCol1.getElem(row), mCol2.getElem(row));
}

inline Vector3 &Matrix3::operator[](i32 col)
{
	return *(&mCol0 + col);
}

inline const Vector3 Matrix3::operator[](i32 col) const
{
	return *(&mCol0 + col);
}
...
inline void print(const Matrix3 &mat, tukk name)
{
	printf("%s:\n", name);
	print(mat);
}
...
inline Matrix4 &Matrix4::setCol(i32 col, const Vector4 &vec)
{
	*(&mCol0 + col) = vec;
	return *this;
}

inline Matrix4 &Matrix4::setRow(i32 row, const Vector4 &vec)
{
	mCol0.setElem(row, vec.getElem(0));
	mCol1.setElem(row, vec.getElem(1));
	mCol2.setElem(row, vec.getElem(2));
...
inline Matrix4 &Matrix4::setElem(i32 col, i32 row, float val)
{
	Vector4 tmpV3_0;
	tmpV3_0 = this->getCol(col);
	tmpV3_0.setElem(row, val);
...
inline float Matrix4::getElem(i32 col, i32 row) const
{
	return this->getCol(col).getElem(row);
}
...
inline const Vector4 Matrix4::getCol(i32 col) const
{
	return *(&mCol0 + col);
}

inline const Vector4 Matrix4::getRow(i32 row) const
{
	return Vector4(mCol0.getElem(row), mCol1.getElem(row), mCol2.getElem(row), mCol3.getElem(row));
}

inline Vector4 &Matrix4::operator[](i32 col)
{
	return *(&mCol0 + col);
}

inline const Vector4 Matrix4::operator[](i32 col) const
{
	return *(&mCol0 + col);
}
...
inline void print(const Matrix4 &mat, tukk name)
{
	printf("%s:\n", name);
	print(mat);
}
...
inline Transform3 &Transform3::setCol(i32 col, const Vector3 &vec)
{
	*(&mCol0 + col) = vec;
	return *this;
}

inline Transform3 &Transform3::setRow(i32 row, const Vector4 &vec)
{
	mCol0.setElem(row, vec.getElem(0));
	mCol1.setElem(row, vec.getElem(1));
	mCol2.setElem(row, vec.getElem(2));
...
inline Transform3 &Transform3::setElem(i32 col, i32 row, float val)
{
	Vector3 tmpV3_0;
	tmpV3_0 = this->getCol(col);
	tmpV3_0.setElem(row, val);
...
inline float Transform3::getElem(i32 col, i32 row) const
{
	return this->getCol(col).getElem(row);
}
...
inline const Vector3 Transform3::getCol(i32 col) const
{
	return *(&mCol0 + col);
}

inline const Vector4 Transform3::getRow(i32 row) const
{
	return Vector4(mCol0.getElem(row), mCol1.getElem(row), mCol2.getElem(row), mCol3.getElem(row));
}

inline Vector3 &Transform3::operator[](i32 col)
{
	return *(&mCol0 + col);
}

inline const Vector3 Transform3::operator[](i32 col) const
{
	return *(&mCol0 + col);
}
...
inline void print(const Transform3 &tfrm, tukk name)
{
	printf("%s:\n", name);
	print(tfrm);
}
...
inline Quat::Quat(const Matrix3 &tfrm)
{
	...
	i32 negTrace, ZgtX, ZgtY, YgtX;
	i32 largestXorY, largestYorZ, largestZorX;
