...
inline void loadHalfFloats(Vector3 &vec, const unsigned short *hfptr)
{
	...
	for (i32 i = 0; i < 3; i++)
	{
		...
		u32 sign = fp16 >> 15;
		u32 exponent = (fp16 >> 10) & ((1 << 5) - 1);
		u32 mantissa = fp16 & ((1 << 10) - 1);
...
inline void storeHalfFloats(const Vector3 &vec, unsigned short *hfptr)
{
	...
	for (i32 i = 0; i < 3; i++)
	{
		...
		u32 sign = d.u32 >> 31;
		u32 exponent = (d.u32 >> 23) & ((1 << 8) - 1);
		u32 mantissa = d.u32 & ((1 << 23) - 1);
		;
...
inline Vector3 &Vector3::setElem(i32 idx, float value)
{
	*(&mX + idx) = value;
	return *this;
}

inline float Vector3::getElem(i32 idx) const
{
	return *(&mX + idx);
}

inline float &Vector3::operator[](i32 idx)
{
	return *(&mX + idx);
}

inline float Vector3::operator[](i32 idx) const
{
	return *(&mX + idx);
}
...
inline Vector4 &Vector4::setElem(i32 idx, float value)
{
	*(&mX + idx) = value;
	return *this;
}

inline float Vector4::getElem(i32 idx) const
{
	return *(&mX + idx);
}

inline float &Vector4::operator[](i32 idx)
{
	return *(&mX + idx);
}

inline float Vector4::operator[](i32 idx) const
{
	return *(&mX + idx);
}
...
inline Point3 &Point3::setElem(i32 idx, float value)
{
	*(&mX + idx) = value;
	return *this;
}

inline float Point3::getElem(i32 idx) const
{
	return *(&mX + idx);
}

inline float &Point3::operator[](i32 idx)
{
	return *(&mX + idx);
}

inline float Point3::operator[](i32 idx) const
{
	return *(&mX + idx);
}
