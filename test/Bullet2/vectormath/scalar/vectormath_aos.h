...
public:
	...
	//
	inline Vector3 &setElem(i32 idx, float value);

	// Get an x, y, or z element of a 3-D vector by index
	//
	inline float getElem(i32 idx) const;

	// Subscripting operator to set or get an element
	//
	inline float &operator[](i32 idx);

	// Subscripting operator to get an element
	//
	inline float operator[](i32 idx) const;
...
// Function is only defined when _VECTORMATH_DEBUG is defined.
//
inline void print(const Vector3 &vec, tukk name);
...
public:
	...
	//
	inline Vector4 &setElem(i32 idx, float value);
...
// Function is only defined when _VECTORMATH_DEBUG is defined.
//
inline void print(const Vector4 &vec, tukk name);
...
public:
	...
	//
	inline Point3 &setElem(i32 idx, float value);
...
// Function is only defined when _VECTORMATH_DEBUG is defined.
//
inline void print(const Point3 &pnt, tukk name);
...
public:
	...
	//
	inline Quat &setElem(i32 idx, float value);
...
// Function is only defined when _VECTORMATH_DEBUG is defined.
//
inline void print(const Quat &quat, tukk name);
...
public:
	...
	//
	inline Matrix4 &setCol(i32 col, const Vector4 &vec);

	// Set the row of a 4x4 matrix referred to by the specified index
	//
	inline Matrix4 &setRow(i32 row, const Vector4 &vec);

	// Get the column of a 4x4 matrix referred to by the specified index
	//
	inline const Vector4 getCol(i32 col) const;

	// Get the row of a 4x4 matrix referred to by the specified index
	//
	inline const Vector4 getRow(i32 row) const;

	// Subscripting operator to set or get a column
	//
	inline Vector4 &operator[](i32 col);

	// Subscripting operator to get a column
	//
	inline const Vector4 operator[](i32 col) const;

	// Set the element of a 4x4 matrix referred to by column and row indices
	//
	inline Matrix4 &setElem(i32 col, i32 row, float val);
...
public:
	...
	//
	inline Transform3 &setCol(i32 col, const Vector3 &vec);

	// Set the row of a 3x4 transformation matrix referred to by the specified index
	//
	inline Transform3 &setRow(i32 row, const Vector4 &vec);
	...
	//
	inline Transform3 &setElem(i32 col, i32 row, float val);
