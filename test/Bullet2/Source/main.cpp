...
//i32 gReportNanoseconds = 0;    // in Utils.c

i32 gReportAverageTimes = 0;
i32 gExitOnError = 0;
char *gFullPath = NULL;
tukk gAppName = NULL;
i32 gArgc;
...
static i32 ParseArgs(i32 argc, tukk argv[]);
...
i32 main(i32 argc, tukk argv[])
{
	...
	i32 numPassedTests = 0;
	i32 numFailedTests = 0;
	...
	{  // test everything
		...
		for (i = 0; NULL != gTestList[i].test_func; i++)
		{
			...
			i32 local_error = gTestList[i].test_func();
