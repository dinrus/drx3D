...
typedef u8 uchar16 __attribute__((__vector_size__(16)));
typedef short short8 __attribute__((__vector_size__(16)));
typedef unsigned short ushort8 __attribute__((__vector_size__(16)));
typedef i32 int4 __attribute__((__vector_size__(16)));
// typedef u32 uint4      __attribute__ ((__vector_size__(16)));
#ifdef __LP64__
typedef long long2 __attribute__((__vector_size__(16)));
typedef u64 ulong2 __attribute__((__vector_size__(16)));
#else
typedef long long long2 __attribute__((__vector_size__(16)));
typedef zu64 ulong2 __attribute__((__vector_size__(16)));
#endif
#include <emmintrin.h>
#endif
