...
static inline btQuaternion& qtnorm_ref(btQuaternion& q1)
{
	...
	q1.setVal(q1.x() * dot, q1.y() * dot, q1.z() * dot, q1.w() * dot);
...
i32 Test_qtnorm(void)
{
	...
	for (i = 0; i < LOOPCOUNT; i++)
	{
		...
		correct_res.setVal(vNaN, vNaN, vNaN, vNaN);
		test_res.setVal(vNaN, vNaN, vNaN, vNaN);
