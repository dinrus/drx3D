...
{
	i32 i, dofCount, posVarCount, ret, numJoints;
	i32 sensorJointIndexLeft = -1;
	i32 sensorJointIndexRight = -1;
	tukk urdfFileName = "r2d2.urdf";
	tukk sdfFileName = "kuka_iiwa/model.sdf";
	...
	if (b3CanSubmitCommand(sm))
	{
...

		{
			b3SharedMemoryStatusHandle statusHandle;
			i32 statusType;
			i32 bodyIndicesOut[10];  //MAX_SDF_BODIES = 10
			i32 numJoints, numBodies;
			i32 bodyUniqueId;
