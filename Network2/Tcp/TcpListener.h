 ...
 * new instance of drx3d::TcpSocket that is properly initialized and can be used to
 ...
 * a listener socket will always return the new connections as drx3d::TcpSocket instances.
 *
 ...
 */
class DRX3D_EXPORT TcpListener : public Socket {
public:
	/**
	 * Default constructor.
	 */
