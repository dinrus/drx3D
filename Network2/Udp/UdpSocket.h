 ...
 * whereas the high-level interface uses packets (see drx3d::Packet),
 ...
 */
class DRX3D_EXPORT UdpSocket : public Socket {
public:
	/**
	 * Default constructor.
	 */
	 ...
	 * @return Status code.
	 */
	Status Send(ukk data, std::size_t size, const IpAddress &remoteAddress, uint16_t remotePort);
	 ...
	 * @return Status code.
	 */
	Status Receive(uk data, std::size_t size, std::size_t &received, IpAddress &remoteAddress, uint16_t &remotePort);
