...
#define STORE32L(x, y)                                                                     \
  do { (y)[3] = (u8)(((x)>>24)&255); (y)[2] = (u8)(((x)>>16)&255);   \
       (y)[1] = (u8)(((x)>>8)&255); (y)[0] = (u8)((x)&255); } while(0)
...
#define STORE64L(x, y)                                                                     \
  do { (y)[7] = (u8)(((x)>>56)&255); (y)[6] = (u8)(((x)>>48)&255);   \
       (y)[5] = (u8)(((x)>>40)&255); (y)[4] = (u8)(((x)>>32)&255);   \
       (y)[3] = (u8)(((x)>>24)&255); (y)[2] = (u8)(((x)>>16)&255);   \
       (y)[1] = (u8)(((x)>>8)&255); (y)[0] = (u8)((x)&255); } while(0)
...
#define STORE32H(x, y)                                                                     \
  do { (y)[0] = (u8)(((x)>>24)&255); (y)[1] = (u8)(((x)>>16)&255);   \
       (y)[2] = (u8)(((x)>>8)&255); (y)[3] = (u8)((x)&255); } while(0)
...
#define STORE64H(x, y)                                                                     \
do { (y)[0] = (u8)(((x)>>56)&255); (y)[1] = (u8)(((x)>>48)&255);     \
     (y)[2] = (u8)(((x)>>40)&255); (y)[3] = (u8)(((x)>>32)&255);     \
     (y)[4] = (u8)(((x)>>24)&255); (y)[5] = (u8)(((x)>>16)&255);     \
     (y)[6] = (u8)(((x)>>8)&255); (y)[7] = (u8)((x)&255); } while(0)
...
static inline ulong32 ROL(ulong32 word, i32 i)
{
   asm ("roll %%cl,%0"
      :"=r" (word)
      :"0" (word),"c" (i));
...
static inline ulong32 ROR(ulong32 word, i32 i)
{
   asm ("rorl %%cl,%0"
      :"=r" (word)
      :"0" (word),"c" (i));
...
static inline ulong32 ROLc(ulong32 word, i32k i)
{
   asm ("rotlwi %0,%0,%2"
      :"=r" (word)
      :"0" (word),"I" (i));
...
static inline ulong32 RORc(ulong32 word, i32k i)
{
   asm ("rotrwi %0,%0,%2"
      :"=r" (word)
      :"0" (word),"I" (i));
...
static inline ulong64 ROL64(ulong64 word, i32 i)
{
   asm("rolq %%cl,%0"
      :"=r" (word)
      :"0" (word),"c" (i));
...
static inline ulong64 ROR64(ulong64 word, i32 i)
{
   asm("rorq %%cl,%0"
      :"=r" (word)
      :"0" (word),"c" (i));
