                      ...
                      rsa_key *key)
{
   ...
   if ((err = mp_init_multi(&tmp, &tmpa, &tmpb,
                                               ...
                                               &rnd, &rndi,
                                                           ...
                                                           NULL)) != CRYPT_OK)
        { return err; }
   if ((err = mp_read_unsigned_bin(tmp, (u8*)in, (i32)inlen)) != CRYPT_OK)
        { goto error; }
   ...
   if (which == PK_PRIVATE) {
      ...
      if (has_crt_parameters) {
         ...
         if ((err = mp_read_unsigned_bin(tmpb, (u8*)in, (i32)inlen)) != CRYPT_OK)        { goto error; }
