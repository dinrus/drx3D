...
i32 sha3_224_test(void)
{
   ...
   return CRYPT_NOP;
#else
   u8 buf[200], hash[224 / 8];
   i32 i;
   hash_state c;
   u8k c1 = 0xa3;

   u8k sha3_224_empty[224 / 8] = {
   ...
   u8k sha3_224_0xa3_200_times[224 / 8] = {
...
i32 sha3_256_test(void)
{
   ...
   return CRYPT_NOP;
#else
   u8 buf[200], hash[256 / 8];
   i32 i;
   hash_state c;
   u8k c1 = 0xa3;

   u8k sha3_256_empty[256 / 8] = {
      0xa7, 0xff, 0xc6, 0xf8, 0xbf, 0x1e, 0xd7, 0x66,
      0x51, 0xc1, 0x47, 0x56, 0xa0, 0x61, 0xd6, 0x62,
      0xf5, 0x80, 0xff, 0x4d, 0xe4, 0x3b, 0x49, 0xfa,
      0x82, 0xd8, 0x0a, 0x4b, 0x80, 0xf8, 0x43, 0x4a
   };
   u8k sha3_256_0xa3_200_times[256 / 8] = {
...
i32 sha3_384_test(void)
{
   ...
   return CRYPT_NOP;
#else
   u8 buf[200], hash[384 / 8];
   i32 i;
   hash_state c;
   u8k c1 = 0xa3;

   u8k sha3_384_0xa3_200_times[384 / 8] = {
...
i32 sha3_512_test(void)
{
   ...
   return CRYPT_NOP;
#else
   u8 buf[200], hash[512 / 8];
   i32 i;
   hash_state c;
   u8k c1 = 0xa3;

   u8k sha3_512_0xa3_200_times[512 / 8] = {
...
i32 sha3_shake_test(void)
{
   ...
   u8k shake256_0xa3_200_times[32] = {
   ...
   u8k shake128_0xa3_200_times[32] = {
