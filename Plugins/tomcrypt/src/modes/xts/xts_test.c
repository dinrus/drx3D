...
#ifndef LTC_NO_TEST
static i32 _xts_test_accel_xts_encrypt(u8k *pt, u8 *ct, u64 blocks,
                                       u8 *tweak, symmetric_key *skey1, symmetric_key *skey2)
{
   i32 ret;
   symmetric_xts xts;
   i32 (*orig)(u8k *, u8 *,
               u64 , u8 *, symmetric_key *,
               symmetric_key *);
...
static i32 _xts_test_accel_xts_decrypt(u8k *ct, u8 *pt, u64 blocks,
                                       u8 *tweak, symmetric_key *skey1, symmetric_key *skey2)
{
   i32 ret;
   symmetric_xts xts;
