...
static i32 _base64_decode_internal(u8k *in,  u64 inlen,
                                 u8 *out, u64 *outlen,
                           u8k *map, i32 is_strict)
{
   u64 t, x, y, z;
   u8 c;
   i32           g;
   ...
   if (y != 0) {
      ...
      if (y >= 2) out[z++] = (u8) ((t >> 16) & 255);
      if (y == 3) out[z++] = (u8) ((t >> 8) & 255);
   }
   *outlen = z;
   return CRYPT_OK;
}
...
*/
i32 base64_decode(u8k *in,  u64 inlen,
                        u8 *out, u64 *outlen)
{
...
/**
   ...
   @return CRYPT_OK if successful
*/
i32 base64_strict_decode(u8k *in,  u64 inlen,
                        u8 *out, u64 *outlen)
{
...
/**
   ...
   @return CRYPT_OK if successful
*/
i32 base64url_decode(u8k *in,  u64 inlen,
                           u8 *out, u64 *outlen)
{
...
/**
   ...
   @return CRYPT_OK if successful
*/
i32 base64url_strict_decode(u8k *in,  u64 inlen,
                           u8 *out, u64 *outlen)
{
