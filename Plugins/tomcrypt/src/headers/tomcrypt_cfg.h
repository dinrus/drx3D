...
LTC_EXPORT uk  LTC_CALL XMALLOC(size_t n);
LTC_EXPORT uk  LTC_CALL XREALLOC(uk p, size_t n);
LTC_EXPORT uk  LTC_CALL XCALLOC(size_t n, size_t s);
LTC_EXPORT void LTC_CALL XFREE(uk p);

LTC_EXPORT void LTC_CALL XQSORT(uk base, size_t nmemb, size_t size, i32(*compar)(ukk , ukk ));
...
LTC_EXPORT uk  LTC_CALL XMEMCPY(uk dest, ukk src, size_t n);
LTC_EXPORT i32   LTC_CALL XMEMCMP(ukk s1, ukk s2, size_t n);
LTC_EXPORT uk  LTC_CALL XMEMSET(uk s, i32 c, size_t n);

LTC_EXPORT i32   LTC_CALL XSTRCMP(tukk s1, tukk s2);
...
#ifdef _MSC_VER
   #define CONST64(n) n ## u64
   typedef unsigned __int64 ulong64;
#else
   #define CONST64(n) n ## ULL
   typedef zu64 ulong64;
#endif
...
typedef zu64 ltc_mp_digit;
#else
typedef u64 ltc_mp_digit;
#endif
...
#ifdef LTC_FAST
   #define LTC_FAST_TYPE_PTR_CAST(x) ((LTC_FAST_TYPE*)(uk )(x))
