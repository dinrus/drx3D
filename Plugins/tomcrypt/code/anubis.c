...
static i32 _anubis_setup(u8k *key, i32 keylen, i32 num_rounds, symmetric_key *skey)
#else
...
i32  anubis_setup(u8k *key, i32 keylen, i32 num_rounds, symmetric_key *skey)
{
  ...
  burn_stack(sizeof(i32) * 5 + sizeof(ulong32) * (MAX_N + MAX_N + 5));
  return err;
}
#endif


static void anubis_crypt(u8k *plaintext, u8 *ciphertext,
                         ulong32 roundKey[18 + 1][4], i32 R) {
   i32 i, pos, r;
   ulong32 state[4];
   ulong32 inter[4];
