...
static void _round(u8 *b, i32 i, symmetric_key *skey)
{
   ROUND(b, i);
}

static void _iround(u8 *b, i32 i, symmetric_key *skey)
{
   iROUND(b, i);
}

static void _lt(u8 *b, u8 *b2)
{
   LT(b, b2);
}

static void _ilt(u8 *b, u8 *b2)
{
   iLT(b, b2);
}
