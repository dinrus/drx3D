...
#define B(x,i) ((u8)(((x) >> (8*i)) & 0xFF))

static ulong32 BYTE2WORD(u8 *b)
{
   ulong32 t;
   LOAD32L(t, b);
   return t;
...
static void XORWORD(ulong32 w, u8k *in, u8 *out)
{
   ulong32 t;
   LOAD32L(t, in);
   t ^= w;
...
*/
i32 sober128_stream_setup(sober128_state *c, u8k *key, u64 keylen)
{
   ulong32 i, k;
 ...
 */
i32 sober128_stream_setiv(sober128_state *c, u8k *iv, u64 ivlen)
{
   ulong32 i, k;
...
/**
   ...
   @return CRYPT_OK if successful
*/
i32 sober128_stream_crypt(sober128_state *c, u8k *in, u64 inlen, u8 *out)
{
   ulong32 t;
...
i32 sober128_stream_keystream(sober128_state *c, u8 *out, u64 outlen)
{
...
/**
  ...
  @return CRYPT_OK on success
*/
i32 sober128_stream_done(sober128_state *c)
{
   LTC_ARGCHK(c != NULL);
