...
static i32 _sha512_compress(hash_state * md, u8 *buf)
#else
static i32  sha512_compress(hash_state * md, u8 *buf)
#endif
{
...
static i32 sha512_compress(hash_state * md, u8 *buf)
{
    ...
    burn_stack(sizeof(ulong64) * 90 + sizeof(i32));
    return err;
}
#endif
...
/**
   ...
   @return CRYPT_OK if successful
*/
i32 sha512_done(hash_state * md, u8 *out)
{
    i32 i;
    ...
    /* append the '1' bit */
    md->sha512.buf[md->sha512.curlen++] = (u8)0x80;
    ...
    if (md->sha512.curlen > 112) {
        while (md->sha512.curlen < 128) {
            md->sha512.buf[md->sha512.curlen++] = (u8)0;
        }
...
i32  sha512_test(void)
{
  ...
  for (i = 0; i < (i32)(sizeof(tests) / sizeof(tests[0])); i++) {
      sha512_init(&md);
      sha512_process(&md, (u8*)tests[i].msg, (u64)strlen(tests[i].msg));
      sha512_done(&md, tmp);
