...
i32 khazad_setup(u8k *key, i32 keylen, i32 num_rounds, symmetric_key *skey)
{
   ...
   for (r = 1; r < R; r++) {
      ...
      skey->khazad.roundKeyDec[r] =
         T0[(i32)S[(i32)(K1 >> 56)       ] & 0xff] ^
         T1[(i32)S[(i32)(K1 >> 48) & 0xff] & 0xff] ^
         T2[(i32)S[(i32)(K1 >> 40) & 0xff] & 0xff] ^
         T3[(i32)S[(i32)(K1 >> 32) & 0xff] & 0xff] ^
         T4[(i32)S[(i32)(K1 >> 24) & 0xff] & 0xff] ^
         T5[(i32)S[(i32)(K1 >> 16) & 0xff] & 0xff] ^
         T6[(i32)S[(i32)(K1 >>  8) & 0xff] & 0xff] ^
         T7[(i32)S[(i32)(K1      ) & 0xff] & 0xff];
   }
...
static void khazad_crypt(u8k *plaintext, u8 *ciphertext,
    ...
    */
    for (r = 1; r < R; r++) {
      state =
         T0[(i32)(state >> 56)       ] ^
         T1[(i32)(state >> 48) & 0xff] ^
         T2[(i32)(state >> 40) & 0xff] ^
         T3[(i32)(state >> 32) & 0xff] ^
         T4[(i32)(state >> 24) & 0xff] ^
         T5[(i32)(state >> 16) & 0xff] ^
         T6[(i32)(state >>  8) & 0xff] ^
         T7[(i32)(state      ) & 0xff] ^
         roundKey[r];
    }
    ...
    */
   state =
      (T0[(i32)(state >> 56)       ] & CONST64(0xff00000000000000)) ^
      (T1[(i32)(state >> 48) & 0xff] & CONST64(0x00ff000000000000)) ^
      (T2[(i32)(state >> 40) & 0xff] & CONST64(0x0000ff0000000000)) ^
      (T3[(i32)(state >> 32) & 0xff] & CONST64(0x000000ff00000000)) ^
      (T4[(i32)(state >> 24) & 0xff] & CONST64(0x00000000ff000000)) ^
      (T5[(i32)(state >> 16) & 0xff] & CONST64(0x0000000000ff0000)) ^
      (T6[(i32)(state >>  8) & 0xff] & CONST64(0x000000000000ff00)) ^
      (T7[(i32)(state      ) & 0xff] & CONST64(0x00000000000000ff)) ^
      roundKey[R];
