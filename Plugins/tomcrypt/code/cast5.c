...
#ifdef _MSC_VER
   #define GB(x, i) ((u8)((x[(15-i)>>2])>>(unsigned)(8*((15-i)&3))))
#else
...
static i32 _cast5_setup(u8k *key, i32 keylen, i32 num_rounds, symmetric_key *skey)
#else
...
i32 cast5_setup(u8k *key, i32 keylen, i32 num_rounds, symmetric_key *skey)
{
   ...
   burn_stack(sizeof(ulong32)*8 + 16 + sizeof(i32)*2);
   return z;
}
#endif
...
*/
#ifdef LTC_CLEAN_STACK
static i32 _cast5_ecb_encrypt(u8k *pt, u8 *ct, symmetric_key *skey)
#else
...
i32 cast5_ecb_encrypt(u8k *pt, u8 *ct, symmetric_key *skey)
{
   i32 err =_cast5_ecb_encrypt(pt,ct,skey);
...
*/
#ifdef LTC_CLEAN_STACK
static i32 _cast5_ecb_decrypt(u8k *ct, u8 *pt, symmetric_key *skey)
#else
...
i32 cast5_ecb_decrypt(u8k *ct, u8 *pt, symmetric_key *skey)
{
   i32 err = _cast5_ecb_decrypt(ct,pt,skey);
   burn_stack(sizeof(ulong32)*3);
   return err;
}
#endif
