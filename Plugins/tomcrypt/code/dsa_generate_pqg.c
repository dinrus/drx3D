...
*/
static i32 _dsa_make_params(prng_state *prng, i32 wprng, i32 group_size, i32 modulus_size, uk p, uk q, uk g)
{
  u64 L, N, n, outbytes, seedbytes, counter, j, i;
  i32 err, res, mr_tests_q, mr_tests_p, found_p, found_q, hash;
  u8 *wbuf, *sbuf, digest[MAXBLOCKSIZE];
  uk t2L1, *t2N1, *t2q, *t2seedlen, *U, *W, *X, *c, *h, *e, *seedinc;
