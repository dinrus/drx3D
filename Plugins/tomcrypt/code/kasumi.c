...
static ulong32 FO( ulong32 in, i32 round_no, symmetric_key *key)
{
   u16 left, right;
...
static ulong32 FL( ulong32 in, i32 round_no, symmetric_key *key )
{
    u16 l, r, a, b;
...
{
    static u16k C[8] = { 0x0123,0x4567,0x89AB,0xCDEF, 0xFEDC,0xBA98,0x7654,0x3210 };
    u16 ukey[8], Kprime[8];
    i32 n;
