...
mp_err s_mp_exptmod_fast(const mp_int *G, const mp_int *X, const mp_int *P, mp_int *Y, i32 redmode)
{
   mp_int  M[TAB_SIZE], res;
   mp_digit buf, mp;
   i32     bitbuf, bitcpy, bitcnt, mode, digidx, x, y, winsize;
   mp_err   err;
