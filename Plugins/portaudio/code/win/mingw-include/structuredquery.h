...
typedef i32 STRUCTURED_QUERY_RESOLVE_OPTION;
...
EXTERN_C const IID IID_IQuerySolution;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE GetErrors( 
            /* [in] */ __RPC__in REFIID riid,
            /* [iid_is][retval][out] */ __RPC__deref_out_opt uk *ppParseErrors) = 0;
    ...
    typedef struct IQuerySolutionVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *GetErrors )( 
            IQuerySolution * This,
            /* [in] */ __RPC__in REFIID riid,
            /* [iid_is][retval][out] */ __RPC__deref_out_opt uk *ppParseErrors);
...
EXTERN_C const IID IID_ICondition;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE GetSubConditions( 
            /* [in] */ __RPC__in REFIID riid,
            /* [iid_is][retval][out] */ __RPC__deref_out_opt uk *ppv) = 0;
    ...
    typedef struct IConditionVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *GetSubConditions )( 
            ICondition * This,
            /* [in] */ __RPC__in REFIID riid,
            /* [iid_is][retval][out] */ __RPC__deref_out_opt uk *ppv);
...
EXTERN_C const IID IID_IEntity;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE Relationships( 
            /* [in] */ __RPC__in REFIID riid,
            /* [iid_is][retval][out] */ __RPC__deref_out_opt uk *pRelationships) = 0;
        ...
        virtual HRESULT STDMETHODCALLTYPE MetaData( 
            /* [in] */ __RPC__in REFIID riid,
            /* [iid_is][retval][out] */ __RPC__deref_out_opt uk *pMetaData) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE NamedEntities( 
            /* [in] */ __RPC__in REFIID riid,
            /* [iid_is][retval][out] */ __RPC__deref_out_opt uk *pNamedEntities) = 0;
    ...
    typedef struct IEntityVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *Relationships )( 
            IEntity * This,
            /* [in] */ __RPC__in REFIID riid,
            /* [iid_is][retval][out] */ __RPC__deref_out_opt uk *pRelationships);
        ...
        HRESULT ( STDMETHODCALLTYPE *MetaData )( 
            IEntity * This,
            /* [in] */ __RPC__in REFIID riid,
            /* [iid_is][retval][out] */ __RPC__deref_out_opt uk *pMetaData);
        
        HRESULT ( STDMETHODCALLTYPE *NamedEntities )( 
            IEntity * This,
            /* [in] */ __RPC__in REFIID riid,
            /* [iid_is][retval][out] */ __RPC__deref_out_opt uk *pNamedEntities);
...
EXTERN_C const IID IID_ISchemaProvider;
    ...
    public:
        virtual HRESULT STDMETHODCALLTYPE Entities( 
            /* [in] */ __RPC__in REFIID riid,
            /* [iid_is][retval][out] */ __RPC__deref_out_opt uk *pEntities) = 0;
    ...
    typedef struct ISchemaProviderVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *Entities )( 
            ISchemaProvider * This,
            /* [in] */ __RPC__in REFIID riid,
            /* [iid_is][retval][out] */ __RPC__deref_out_opt uk *pEntities);
...
EXTERN_C const IID IID_IQueryParserManager;
    ...
    public:
        virtual HRESULT STDMETHODCALLTYPE CreateLoadedParser( 
            ...
            /* [in] */ __RPC__in REFIID riid,
            /* [iid_is][retval][out] */ __RPC__deref_out_opt uk *ppQueryParser) = 0;
    ...
    typedef struct IQueryParserManagerVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *CreateLoadedParser )( 
            ...
            /* [in] */ LANGID langidForKeywords,
            /* [in] */ __RPC__in REFIID riid,
            /* [iid_is][retval][out] */ __RPC__deref_out_opt uk *ppQueryParser);
...
u64             __RPC_USER  BSTR_UserSize(     u64 *, u64            , BSTR * ); 
u8 * __RPC_USER  BSTR_UserMarshal(  u64 *, u8 *, BSTR * ); 
u8 * __RPC_USER  BSTR_UserUnmarshal(u64 *, u8 *, BSTR * ); 
void                      __RPC_USER  BSTR_UserFree(     u64 *, BSTR * ); 

u64             __RPC_USER  LPSAFEARRAY_UserSize(     u64 *, u64            , LPSAFEARRAY * ); 
u8 * __RPC_USER  LPSAFEARRAY_UserMarshal(  u64 *, u8 *, LPSAFEARRAY * ); 
u8 * __RPC_USER  LPSAFEARRAY_UserUnmarshal(u64 *, u8 *, LPSAFEARRAY * ); 
void                      __RPC_USER  LPSAFEARRAY_UserFree(     u64 *, LPSAFEARRAY * ); 
