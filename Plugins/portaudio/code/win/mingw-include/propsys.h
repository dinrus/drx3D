...
typedef i32 GETPROPERTYSTOREFLAGS;
...
EXTERN_C const IID IID_IPropertyChangeArray;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE GetAt( 
            /* [in] */ UINT iIndex,
            /* [in] */ __RPC__in REFIID riid,
            /* [iid_is][out] */ __RPC__deref_out_opt uk *ppv) = 0;
    ...
    typedef struct IPropertyChangeArrayVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *GetAt )( 
            ...
            /* [in] */ UINT iIndex,
            /* [in] */ __RPC__in REFIID riid,
            /* [iid_is][out] */ __RPC__deref_out_opt uk *ppv);
...
typedef i32 PROPDESC_TYPE_FLAGS;
...
typedef i32 PROPDESC_VIEW_FLAGS;
...
typedef i32 PROPDESC_FORMAT_FLAGS;
...
typedef i32 PROPDESC_SEARCHINFO_FLAGS;
...
typedef i32 PERSIST_SPROPSTORE_FLAGS;
...
u64             __RPC_USER  BSTR_UserSize64(     u64 *, u64            , BSTR * ); 
u8 * __RPC_USER  BSTR_UserMarshal64(  u64 *, u8 *, BSTR * ); 
u8 * __RPC_USER  BSTR_UserUnmarshal64(u64 *, u8 *, BSTR * ); 
void                      __RPC_USER  BSTR_UserFree64(     u64 *, BSTR * ); 

u64             __RPC_USER  LPSAFEARRAY_UserSize64(     u64 *, u64            , LPSAFEARRAY * ); 
u8 * __RPC_USER  LPSAFEARRAY_UserMarshal64(  u64 *, u8 *, LPSAFEARRAY * ); 
u8 * __RPC_USER  LPSAFEARRAY_UserUnmarshal64(u64 *, u8 *, LPSAFEARRAY * ); 
void                      __RPC_USER  LPSAFEARRAY_UserFree64(     u64 *, LPSAFEARRAY * ); 
