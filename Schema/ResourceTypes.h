...
template<Serialization::ResourceFilePath(* SERIALIZER) (string&)> struct SResourceNameSerializer
{
	...
	inline SResourceNameSerializer(tukk _szValue)
		: value(_szValue)
	{}
...
template<Serialization::ResourceFilePath(* SERIALIZER) (string&)> inline bool Serialize(Serialization::IArchive& archive, SResourceNameSerializer<SERIALIZER>& value, tukk szName, tukk szLabel)
{
...
template<Serialization::ResourceSelector<string>(* SELECTOR)(string&)> struct SResourceNameSelector
{
	...
	inline SResourceNameSelector(tukk _szValue)
		: value(_szValue)
	{}
...
template<Serialization::ResourceSelector<string>(* SELECTOR)(string&)> inline bool Serialize(Serialization::IArchive& archive, SResourceNameSelector<SELECTOR>& value, tukk szName, tukk szLabel)
{
...
{
	desc.SetGUID("2c8887a2-0878-42cc-8cee-a0595baa0820"_drx_guid);
...
{
	desc.SetGUID("A35E2F8F-F546-4B43-A158-1A896D2AF9A5"_drx_guid);
...
{
	desc.SetGUID("{BE0FF234-DCA3-4379-A0F4-AE8FA54AA550}"_drx_guid);
...
{
	desc.SetGUID("bd6f2953-1127-4cdd-bfe7-79f98c97058c"_drx_guid);
...
{
	desc.SetGUID("243e1764-0bca-4af4-8a24-bf8a2fc8f9c8"_drx_guid);
...
{
	desc.SetGUID("cb3189c1-92de-4851-b26a-22894ec039b0"_drx_guid);
...
{
	desc.SetGUID("{51398F30-C0DD-41F6-9391-8F70755442C0}"_drx_guid);
...
{
	desc.SetGUID("{7BAA3267-E7BB-4B02-A223-2CB03F6BF35A}"_drx_guid);
...
{
	desc.SetGUID("a6f326e7-d3d3-428a-92c9-97185f003bec"_drx_guid);
...
{
	desc.SetGUID("C312E1D3-D31F-4509-A92F-644965E2BD6F"_drx_guid);
...
{
	desc.SetGUID("A1AD3BA1-FCD0-4CE0-99FB-A77736E897FE"_drx_guid);
...
{
	desc.SetGUID("730c191c-531f-48ae-bba9-5c1d8216b701"_drx_guid);
...
{
	desc.SetGUID("43ae9bb4-9831-449d-b082-3e37b71ec872"_drx_guid);
...
{
	desc.SetGUID("1877be04-a1db-490c-b6a2-47f99cac7fc2"_drx_guid);
...
{
	desc.SetGUID("A4A3C724-3A78-4F10-9184-3ECEB03C55BA"_drx_guid);
...
{
	desc.SetGUID("839adde8-cc62-4636-9f26-16dd4236855f"_drx_guid);
...
{
	desc.SetGUID("c366ed5c-5242-453f-bb2d-7247f7be2655"_drx_guid);
	desc.SetLabel("EntityClassName");
	desc.SetDescription("Entity class name");
}

// WORKAROUND: Can't register the same ResourceSelector (EntityClassName) for both sxema versions.
// Remove this in favor of EntityClassName when we finally have just one sxema.
...
{
	desc.SetGUID("BAD6BD36-AC7D-428B-8A27-34EB064E2C29"_drx_guid);
...
{
	desc.SetGUID("{F21E3B5D-8C0D-423E-81BF-DE72B7DC72A8}"_drx_guid);
...
{
	desc.SetGUID("{22B719FF-8B61-43CC-A997-B5292866CD0C}"_drx_guid);
...
{
	desc.SetGUID("40dce92c-9532-4c02-8752-4afac04331ef"_drx_guid);
...
{
	desc.SetGUID("{E67FEB06-ECF5-4CED-A03B-D5DA9536AB63}"_drx_guid);
...
{
	desc.SetGUID("{F9D3217F-2394-4059-BF1E-92CC73EA202E}"_drx_guid);
...
{
	desc.SetGUID("{14776399-DF80-43AF-A9C0-0544DB464A95}"_drx_guid);
...
{
	desc.SetGUID("B5329286-CC95-4A0D-8996-9FC19B445ACB"_drx_guid);
