...
public:
	...
	CScriptView(const DrxGUID& scopeGUID);

	// IScriptView

	virtual const DrxGUID&                    GetScopeGUID() const override;
	...
	virtual const IScriptStateMachine*      GetScriptStateMachine(const DrxGUID& guid) const override;
	virtual const IScriptComponentInstance* GetScriptComponentInstance(const DrxGUID& guid) const override;
	virtual const IScriptActionInstance*    GetScriptActionInstance(const DrxGUID& guid) const override;
	virtual const IScriptElement*           GetScriptElement(const DrxGUID& guid) const override;
