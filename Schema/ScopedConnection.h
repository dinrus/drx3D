...
////////////////////////////////////////////////////////////////////////////////////////////////////
template<typename TYPE, typename KEY = void, class KEY_COMPARE = typename SDefaultCompare<KEY>::Type> class CScopedConnectionUpr
{
public:
...
public:
	...
	inline CScopedConnectionUpr(const KeyCompare& keyCompare = KeyCompare())
...
// Scoped connection manager.
////////////////////////////////////////////////////////////////////////////////////////////////////
template<typename TYPE> class CScopedConnectionUpr<TYPE>
{
public:
...
public:
	...
	template<typename DELEGATE> inline void Process(const DELEGATE& delegate)
	{
		...
		if (!m_bLocked)
		{
			...
			u32k slotCount = m_slots.size();
			if (slotCount)
			{
				u32 slotIdx = 0;
				u32 endSlotIdx = slotCount;
				...
				u32k emptySlotCount = slotCount - endSlotIdx;
				if (emptySlotCount)
				{
