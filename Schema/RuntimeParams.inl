...
inline void CRuntimeParams::ReserveScratchpad(u32 capacity)
{
...
inline bool FromInputClass(const CClassDesc& typeDesc, CRuntimeParams& params, const void* pInput)
{
	...
	{
		if (!params.AddInput(CUniqueId::FromUInt32(memberDesc.GetId()), CAnyConstRef(memberDesc.GetTypeDesc(), reinterpret_cast<u8k*>(pInput) + memberDesc.GetOffset())))
		{
			return false;
		}
	}
