...
template<typename TYPE, u32(* FUNCTION_PTR)(const TYPE&)> struct SArraySize<u32 (*)(const TYPE&), FUNCTION_PTR>
{
	static inline u32 Size(const void* pArray)
	{
...
template<typename TYPE, u32(TYPE::* FUNCTION_PTR)() const> struct SArraySize<u32 (TYPE::*)() const, FUNCTION_PTR>
{
	static inline u32 Size(const void* pArray)
	{
...
template<typename TYPE, typename ELEMENT_TYPE, ELEMENT_TYPE& (* FUNCTION_PTR)(TYPE&, u32)> struct SArrayAt<ELEMENT_TYPE& (*)(TYPE&, u32), FUNCTION_PTR>
{
	static inline void* At(void* pArray, u32 pos)
	{
...
template<typename TYPE, typename ELEMENT_TYPE, ELEMENT_TYPE& (TYPE::* FUNCTION_PTR)(u32)> struct SArrayAt<ELEMENT_TYPE& (TYPE::*)(u32), FUNCTION_PTR>
{
	static inline void* At(void* pArray, u32 pos)
	{
...
template<typename TYPE, typename ELEMENT_TYPE, const ELEMENT_TYPE& (* FUNCTION_PTR)(const TYPE&, u32)> struct SArrayAtConst<const ELEMENT_TYPE& (*)(const TYPE&, u32), FUNCTION_PTR>
{
	static inline const void* AtConst(const void* pArray, u32 pos)
	{
...
template<typename TYPE, typename ELEMENT_TYPE, const ELEMENT_TYPE& (TYPE::* FUNCTION_PTR)(u32) const> struct SArrayAtConst<const ELEMENT_TYPE& (TYPE::*)(u32) const, FUNCTION_PTR>
{
	static inline const void* AtConst(const void* pArray, u32 pos)
	{
