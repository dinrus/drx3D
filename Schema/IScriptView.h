...
struct IScriptView
{
	...
	virtual const DrxGUID&                  GetScopeGUID() const = 0; // #SchematycTODO : Scope using element instead of GUID?
	...
	virtual const IScriptStateMachine*      GetScriptStateMachine(const DrxGUID& guid) const = 0;      // #SchematycTODO : Can't we just access the script registry directly?
	virtual const IScriptComponentInstance* GetScriptComponentInstance(const DrxGUID& guid) const = 0; // #SchematycTODO : Can't we just access the script registry directly?
	virtual const IScriptActionInstance*    GetScriptActionInstance(const DrxGUID& guid) const = 0;    // #SchematycTODO : Can't we just access the script registry directly?
	virtual const IScriptElement*           GetScriptElement(const DrxGUID& guid) const = 0;           // #SchematycTODO : Can't we just access the script registry directly?
