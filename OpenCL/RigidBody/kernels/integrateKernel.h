...
static tukk integrateKernelCL =
	...
	"}\n"
	"__kernel void \n"
	"  integrateTransformsKernel( __global b3RigidBodyData_t* bodies,i32k numNodes, float timeStep, float angularDamping, float4 gravityAcceleration)\n"
	"{\n"
