...
static tukk solverSetup2CL =
	...
	"void SetDeterminismSortDataChildShapeB(__global struct b3Contact4Data* contactsIn, __global int2* sortDataOut, i32 nContacts)\n"
	"{\n"
	"	i32 gIdx = GET_GLOBAL_IDX;\n"
	"	if( gIdx < nContacts )\n"
	"	{\n"
	...
	"}\n"
	"__kernel __attribute__((reqd_work_group_size(WG_SIZE,1,1)))\n"
	"void SetDeterminismSortDataChildShapeA(__global struct b3Contact4Data* contactsIn, __global int2* sortDataInOut, i32 nContacts)\n"
	"{\n"
	"	i32 gIdx = GET_GLOBAL_IDX;\n"
	"	if( gIdx < nContacts )\n"
	"	{\n"
	...
	"}\n"
	"__kernel __attribute__((reqd_work_group_size(WG_SIZE,1,1)))\n"
	"void SetDeterminismSortDataBodyA(__global struct b3Contact4Data* contactsIn, __global int2* sortDataInOut, i32 nContacts)\n"
	"{\n"
	"	i32 gIdx = GET_GLOBAL_IDX;\n"
	"	if( gIdx < nContacts )\n"
	"	{\n"
	...
	"__kernel\n"
	"__attribute__((reqd_work_group_size(WG_SIZE,1,1)))\n"
	"void SetDeterminismSortDataBodyB(__global struct b3Contact4Data* contactsIn, __global int2* sortDataInOut, i32 nContacts)\n"
	"{\n"
	"	i32 gIdx = GET_GLOBAL_IDX;\n"
	"	if( gIdx < nContacts )\n"
	"	{\n"
	...
	"i32 nContacts,float scale,int4 nSplit,i32 staticIdx)\n"
	"{\n"
	"	i32 gIdx = GET_GLOBAL_IDX;\n"
	"	\n"
	"	if( gIdx < nContacts )\n"
