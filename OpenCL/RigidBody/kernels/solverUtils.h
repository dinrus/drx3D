...
static tukk solverUtilsCL =
   ...
   // "typedef u8 u8;\n"
    ...
    "   u32 m_paddings;\n"
    "} Constraint4;\n"
    "__kernel void CountBodiesKernel(__global struct b3Contact4Data* manifoldPtr, __global u32* bodyCount, __global int2* contactConstraintOffsets, i32 numContactManifolds, i32 fixedBodyIndex)\n"
    "{\n"
    "   i32 i = GET_GLOBAL_IDX;\n"
    "   \n"
    "   if( i < numContactManifolds)\n"
    "   {\n"
    "       i32 pa = manifoldPtr[i].m_bodyAPtrAndSignBit;\n"
    "       bool isFixedA = (pa <0) || (pa == fixedBodyIndex);\n"
    "       i32 bodyIndexA = abs(pa);\n"
    "       if (!isFixedA)\n"
    "       {\n"
    ...
    "   }\n"
    "}\n"
    "__kernel void ClearVelocitiesKernel(__global float4* linearVelocities,__global float4* angularVelocities, i32 numSplitBodies)\n"
    "{\n"
    "   i32 i = GET_GLOBAL_IDX;\n"
    "   \n"
    "   if( i < numSplitBodies)\n"
    ...
    "   }\n"
    "}\n"
    "__kernel void AverageVelocitiesKernel(__global Body* gBodies,__global i32* offsetSplitBodies,__global u32k* bodyCount,\n"
    "__global float4* deltaLinearVelocities, __global float4* deltaAngularVelocities, i32 numBodies)\n"
    "{\n"
    "   i32 i = GET_GLOBAL_IDX;\n"
    "   if (i<numBodies)\n"
    "   {\n"
    ...
    "__global int2* contactConstraintOffsets,__global u32* offsetSplitBodies,\n"
    "__global float4* deltaLinearVelocities, __global float4* deltaAngularVelocities)\n"
    "{\n"
    "   //float frictionCoeff = ldsCs[0].m_linear.w;\n"
    "   i32 aIdx = ldsCs[0].m_bodyA;\n"
    "   i32 bIdx = ldsCs[0].m_bodyB;\n"
    ...
    "   i32 constraintOffsetA = contactConstraintOffsets[0].x;\n"
    ...
    "   i32 constraintOffsetB = contactConstraintOffsets[0].y;\n"
    ...
    "__global int2* contactConstraintOffsets,__global u32* offsetSplitBodies,__global float4* deltaLinearVelocities, __global float4* deltaAngularVelocities,\n"
    "float deltaTime, float positionDrift, float positionConstraintCoeff, i32 fixedBodyIndex, i32 numManifolds\n"
    ")\n"
    "{\n"
    "   i32 i = GET_GLOBAL_IDX;\n"
    "   if (i<numManifolds)\n"
    ...
    "   }\n"
    "}\n"
    "__kernel void UpdateBodyVelocitiesKernel(__global Body* gBodies,__global i32* offsetSplitBodies,__global u32k* bodyCount,\n"
    "                                   __global float4* deltaLinearVelocities, __global float4* deltaAngularVelocities, i32 numBodies)\n"
    "{\n"
    "   i32 i = GET_GLOBAL_IDX;\n"
    "   if (i<numBodies)\n"
