...
static tukk updateAabbsKernelCL =
	...
	"__kernel void initializeGpuAabbsFull(  i32k numNodes, __global b3RigidBodyData_t* gBodies,__global b3Collidable_t* collidables, __global b3Aabb_t* plocalShapeAABB, __global b3Aabb_t* pAABB)\n"
	"{\n"
	...
	"	}\n"
	"}\n"
	"__kernel void clearOverlappingPairsKernel(  __global int4* pairs, i32 numPairs)\n"
	"{\n"
	"	i32 pairId = get_global_id(0);\n"
	"	if( pairId< numPairs )\n"
	"	{\n"
