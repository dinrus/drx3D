...
//	batching on the GPU
__kernel void CreateBatchesBruteForce( __global struct b3Contact4Data* gConstraints, 	__global u32k* gN, __global u32k* gStart, int m_staticIdx )
{
...
//	batching on the GPU
__kernel void CreateBatchesNew( __global struct b3Contact4Data* gConstraints, __global u32k* gN, __global u32k* gStart, __global int* batchSizes, int staticIdx )
{
	int wgIdx = GET_GROUP_IDX;
	int lIdx = GET_LOCAL_IDX;
