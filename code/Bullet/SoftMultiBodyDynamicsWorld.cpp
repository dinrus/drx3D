...
SoftMultiBodyDynamicsWorld::SoftMultiBodyDynamicsWorld(
	Dispatcher* dispatcher,
	BroadphaseInterface* pairCache,
	MultiBodyConstraintSolver* constraintSolver,
	CollisionConfiguration* collisionConfiguration,
	SoftBodySolver* softBodySolver) : MultiBodyDynamicsWorld(dispatcher, pairCache, constraintSolver, collisionConfiguration),
...
void SoftMultiBodyDynamicsWorld::predictUnconstraintMotion(Scalar timeStep)
{
...
void SoftMultiBodyDynamicsWorld::internalSingleStepSimulation(Scalar timeStep)
{
...
void SoftMultiBodyDynamicsWorld::solveSoftBodiesConstraints(Scalar timeStep)
{
...
void SoftMultiBodyDynamicsWorld::addSoftBody(SoftBody* body, i32 collisionFilterGroup, i32 collisionFilterMask)
{
...
void SoftMultiBodyDynamicsWorld::removeSoftBody(SoftBody* body)
{
...
void SoftMultiBodyDynamicsWorld::removeCollisionObject(CollisionObject2* collisionObject)
{
...
void SoftMultiBodyDynamicsWorld::debugDrawWorld()
{
...
struct SoftSingleRayCallback : public BroadphaseRayCallback
{
	...
	const SoftMultiBodyDynamicsWorld* m_world;
	CollisionWorld::RayResultCallback& m_resultCallback;

	SoftSingleRayCallback(const Vec3& rayFromWorld, const Vec3& rayToWorld, const SoftMultiBodyDynamicsWorld* world, CollisionWorld::RayResultCallback& resultCallback)
...
void SoftMultiBodyDynamicsWorld::rayTest(const Vec3& rayFromWorld, const Vec3& rayToWorld, RayResultCallback& resultCallback) const
{
...
void SoftMultiBodyDynamicsWorld::rayTestSingle(const Transform2& rayFromTrans, const Transform2& rayToTrans,
...
void SoftMultiBodyDynamicsWorld::serializeSoftBodies(Serializer* serializer)
{
	i32 i;
...
void SoftMultiBodyDynamicsWorld::serialize(Serializer* serializer)
{
