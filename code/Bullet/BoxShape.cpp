...
BoxShape::BoxShape(const Vec3& boxHalfExtents)
...
void BoxShape::getAabb(const Transform2& t, Vec3& aabbMin, Vec3& aabbMax) const
{
	Transform2Aabb(getHalfExtentsWithoutMargin(), getMargin(), t, aabbMin, aabbMax);
}

void BoxShape::calculateLocalInertia(Scalar mass, Vec3& inertia) const
{
