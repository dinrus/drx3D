#include <drx3D/Physics/Collision/Gimpact/GImpactQuantizedBvh.h>
#include <drx3D/Maths/Linear/Quickprof.h>

#ifdef TRI_COLLISION_PROFILING
Clock g_q_tree_clock;

float g_q_accum_tree_collision_time = 0;
i32 g_q_count_traversing = 0;

void drx3d_begin_gim02_q_tree_time()
{
	g_q_tree_clock.reset();
}

void drx3d_end_gim02_q_tree_time()
{
...
float GImpactQuantizedBvh::getAverageTreeCollisionTime()
{
...
void QuantizedBvhTree::calc_quantization(
	GIM_BVH_DATA_ARRAY& primitive_boxes, Scalar boundMargin)
{
	//calc globa box
	AABB global_bound;
...
i32 QuantizedBvhTree::_sort_and_calc_splitting_index(
...
void QuantizedBvhTree::_build_sub_tree(GIM_BVH_DATA_ARRAY& primitive_boxes, i32 startIndex, i32 endIndex)
{
...
void QuantizedBvhTree::build_tree(
...
void GImpactQuantizedBvh::refit()
{
...
bool GImpactQuantizedBvh::boxQuery(const AABB& box, AlignedObjectArray<i32>& collided_results) const
{
	i32 curIndex = 0;
...
//! returns the indices of the primitives in the m_primitive_manager
bool GImpactQuantizedBvh::rayQuery(
...
SIMD_FORCE_INLINE bool _quantized_node_collision(
	const GImpactQuantizedBvh* boxset0, const GImpactQuantizedBvh* boxset1,
...
void GImpactQuantizedBvh::find_collision(const GImpactQuantizedBvh* boxset0, const Transform2& trans0,
										   const GImpactQuantizedBvh* boxset1, const Transform2& trans1,
										   PairSet& collision_pairs)
{
