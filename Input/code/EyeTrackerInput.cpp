...
#define LOG(msg) DrxLogAlways((STxt("[EYEX] ") + msg + "\n").c_str())

static CEyeTrackerInput* g_pEyeTrackerInstance = NULL;
static const TX_STRING InteractorId = "DRXENGINE";
...
void CEyeTrackerInput::SetEyeProjection(i32 iX, i32 iY)
{
...
void OnGazeDataEvent(TX_HANDLE hGazeDataBehavior)
{
	...
	{
		g_pEyeTrackerInstance->SetEyeProjection((i32)eventParams.X, (i32)eventParams.Y);
	}
	else 
	{
