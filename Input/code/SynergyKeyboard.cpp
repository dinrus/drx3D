...
void CSynergyKeyboard::ProcessKey(u32 key, bool bPressed, bool bRepeat, u32 modificators)
{
...
u32 CSynergyKeyboard::GetInputCharUnicode(const SInputEvent& event)
{
...
u32 CSynergyKeyboard::PackModificators(u32 modificators)
{
	u32 ret = 0;
...
void CSynergyKeyboard::TypeASCIIString(tukk pString)
{
	struct KeyPair
	{
		i32         key;
	...
	while (pString[0])
	{
		for (i32 i = 0; i < DRX_ARRAY_COUNT(pairs); i++)
		{
