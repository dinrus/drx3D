...
//	#if defined(USE_DXINPUT)
//LINK_SYSTEM_LIBRARY("libxinput9_1_0.a");
...
//i32 g_numControllers = 0;

//////////////////////////////////////////////////////////////////////////
// This is a thread task responsible for periodically checking gamepad
// connection status.
//////////////////////////////////////////////////////////////////////////
class CInputConnectionThreadTask : public IThread
{
	IInput*       m_pInput;
	 bool m_bQuit;
...
CXInputDevice::CXInputDevice(IInput& input, i32 deviceNo) : CInputDevice(input, deviceNames[deviceNo]),
...
CXInputDevice::~CXInputDevice()
{
	...
	{
		g_pInputConnectionThreadTask->SignalStopWork();
		gEnv->pThreadUpr->JoinThread(g_pInputConnectionThreadTask, eJM_Join);
...
void CXInputDevice::PostInit()
{
	...
	if (g_pInputConnectionThreadTask == NULL)
	{
		...
		if (!gEnv->pThreadUpr->SpawnThread(g_pInputConnectionThreadTask, "InputWorker"))
		{
			DrxFatalError("Error spawning \"InputWorker\" thread.");
		}
	}
}
