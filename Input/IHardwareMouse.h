...
struct IHardwareMouseEventListener
{
	...
	virtual void OnHardwareMouseEvent(i32 iX, i32 iY, EHARDWAREMOUSEEVENT eHardwareMouseEvent, i32 wheelDelta = 0) = 0;
	// </interfuscator:shuffle>
};
...
struct IHardwareMouse
{
	...
	virtual void Event(i32 iX, i32 iY, EHARDWAREMOUSEEVENT eHardwareMouseEvent, i32 wheelDelta = 0) = 0;
	...
	virtual bool SetCursor(i32 idc_cursor_id) = 0;
	virtual bool SetCursor(tukk path) = 0;
