...
public:
	 ...
	 */
	Buffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, ukk data = nullptr);
	virtual ~Buffer();

	void MapMemory(uk *data) const;
