...
namespace drx3d {
const std::vector<tukk > LogicalDevice::DeviceExtensions = {VK_KHR_SWAPCHAIN_EXTENSION_NAME}; // VK_KHR_PUSH_DESCRIPTOR_EXTENSION_NAME
...
void LogicalDevice::CreateQueueIndices() {
	...
	if (!graphicsFamily)
		throw drx::Exc("Failed to find queue family supporting VK_QUEUE_GRAPHICS_BIT");
}
