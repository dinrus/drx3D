...
public:
	...
	virtual void        AddRequestListener(void (* func)(SRequestInfo const* const), uk const pObjectToListenTo, ESystemEvents const eventMask) override;
	virtual void        RemoveRequestListener(void (* func)(SRequestInfo const* const), uk const pObjectToListenTo) override;
...
private:
	...
	std::atomic<u32>        m_externalThreadFrameId;
	u32                     m_lastExternalThreadFrameId;
	...
	DrxEvent                   m_mainEvent;
	DrxEvent                   m_audioThreadWakeupEvent;
