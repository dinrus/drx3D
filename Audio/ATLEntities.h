...
#include <drx3D/Audio/ATLUtils.h>
...
DRX_CREATE_ENUM_FLAG_OPERATORS(EObjectFlags);
...
DRX_CREATE_ENUM_FLAG_OPERATORS(EFileFlags);
...
public:
	...
	DrxFixedStringT<MaxControlNameLength> m_name;
...
class CATLListener final : public DrxAudio::IListener
{
public:
...
public:
	...
	uk                 m_pOwner = nullptr;
	uk                 m_pUserData = nullptr;
	uk                 m_pUserDataOwner = nullptr;
...
public:
	...
	DrxFixedStringT<MaxFilePathLength> m_path;
	size_t                             m_size;
	size_t                             m_useCount;
