...
public:
	...
	virtual AKRESULT Read(AkFileDesc& rFileDesc, AkIoHeuristics const& rHeuristics, uk pBuffer, AkIOTransferInfo& rTransferInfo) override;
	virtual AKRESULT Write(AkFileDesc& in_fileDesc, AkIoHeuristics const& in_heuristics, uk in_pData, AkIOTransferInfo& io_transferInfo) override;
	// ~IAkIOHookBlocking overrides.
