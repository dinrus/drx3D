...
{
	pPanningRule->Set(drxmath::clamp(pPanningRule->GetIVal(), 0, 1));
...
void CCVars::RegisterVariables()
{
	...
	m_streamUprMemoryPoolSize = 128;           // 128 KiB
	...
	m_enableEventUprThread = 1;
	m_enableSoundBankUprThread = 1;
	...
	REGISTER_CVAR2("s_WwiseStreamUprMemoryPoolSize", &m_streamUprMemoryPoolSize, m_streamUprMemoryPoolSize, VF_REQUIRE_APP_RESTART,
	               "Specifies the size (in KiB) of the Wwise stream manager memory pool.\n"
	               "Usage: s_WwiseStreamUprMemoryPoolSize [0/...]\n"
	...
	REGISTER_CVAR2("s_WwiseEnableEventUprThread", &m_enableEventUprThread, m_enableEventUprThread, VF_REQUIRE_APP_RESTART,
	               "Specifies whether Wwise should initialize using its EventUpr thread or not.\n"
	               "Usage: s_WwiseEnableEventUprThread [0/1]\n"
	               "Default: 1 (on)\n");

	REGISTER_CVAR2("s_WwiseEnableSoundBankUprThread", &m_enableSoundBankUprThread, m_enableSoundBankUprThread, VF_REQUIRE_APP_RESTART,
	               "Specifies whether Wwise should initialize using its SoundBankUpr thread or not.\n"
	               "Usage: s_WwiseEnableSoundBankUprThread [0/1]\n"
	               "Default: 1 (on)\n");
...
void CCVars::UnregisterVariables()
{
	...
	if (pConsole != nullptr)
	{
		...
		pConsole->UnregisterVariable("s_WwiseStreamUprMemoryPoolSize");
		...
		pConsole->UnregisterVariable("s_WwiseEnableEventUprThread");
		pConsole->UnregisterVariable("s_WwiseEnableSoundBankUprThread");
