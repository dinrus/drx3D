...
{
//////////////////////////////////////////////////////////////////////////
FMOD_RESULT F_CALLBACK FileCallback(FMOD_CHANNELCONTROL* pChannelControl, FMOD_CHANNELCONTROL_TYPE controlType, FMOD_CHANNELCONTROL_CALLBACK_TYPE callbackType, uk pData1, uk pData2)
{
	if (controlType == FMOD_CHANNELCONTROL_CHANNEL && callbackType == FMOD_CHANNELCONTROL_CALLBACK_END)
	{
		...
		FMOD_RESULT const fmodResult = pChannel->getUserData(reinterpret_cast<uk *>(&pStandaloneFile));
		ASSERT_FMOD_OK;
...
//////////////////////////////////////////////////////////////////////////
FMOD_RESULT F_CALLBACK ProgrammerSoundFileCallback(FMOD_STUDIO_EVENT_CALLBACK_TYPE type, FMOD_STUDIO_EVENTINSTANCE* pEvent, uk pInOutParameters)
{
	if (pEvent != nullptr)
	{
		...
		FMOD_RESULT fmodResult = pEventInstance->getUserData(reinterpret_cast<uk *>(&pFile));
		ASSERT_FMOD_OK;
...
bool CStandaloneFile::IsReady()
{
	...
	if (m_pLowLevelSound)
	{
		...
		{
			Drx::Audio::Log(ELogType::Error, "Failed to load audio file %s", m_fileName.c_str());
		}
	}
