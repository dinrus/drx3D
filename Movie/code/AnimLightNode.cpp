...
namespace AnimLightNode
{
	...
	void AddSupportedParam(tukk szName, i32 paramId, EAnimValue valueType)
	{
...
CAnimLightNode::CAnimLightNode(i32k id)
	: CAnimEntityNode(id),
	m_fRadius(10.0f),
...
u32 CAnimLightNode::GetParamCount() const
{
	return AnimLightNode::s_nodeParameters.size();
}

CAnimParamType CAnimLightNode::GetParamType(u32 nIndex) const
{
...
{
	for (u32 i = 0; i < AnimLightNode::s_nodeParameters.size(); ++i)
	{
