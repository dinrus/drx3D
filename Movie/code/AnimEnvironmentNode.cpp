...
CAnimEnvironmentNode::CAnimEnvironmentNode(i32k id) : CAnimNode(id), m_oldSunLongitude(0.0f), m_oldSunLatitude(0.0f)
{
...
u32 CAnimEnvironmentNode::GetParamCount() const
{
	return AnimEnvironmentNode::s_environmentNodeParams.size();
}

CAnimParamType CAnimEnvironmentNode::GetParamType(u32 nIndex) const
{
