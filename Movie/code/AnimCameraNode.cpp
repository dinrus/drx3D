...
CAnimCameraNode::CAnimCameraNode(i32k id)
	: CAnimEntityNode(id)
	, m_fFOV(60.0f)
	, m_fDOF(ZERO)
...
u32 CAnimCameraNode::GetParamCount() const
{
	return s_nodeParams.size();
}

CAnimParamType CAnimCameraNode::GetParamType(u32 nIndex) const
{
...
Ang3 CAnimCameraNode::ShakeParam::ApplyCameraShake(CPNoise3& noiseGen, SAnimTime time, Ang3 angles, CAnimSplineTrack* pFreqTrack, EntityId camEntityId, i32 shakeIndex, const uint shakeSeed)
{
	Ang3 rotation;
	Ang3 rotationNoise;
