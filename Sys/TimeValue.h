...
public:
	...
	{
		DrxInterlockedAdd(&m_lValue, val);
	}
	...
	ILINE CTimeValue& operator/=(i32 inRhs)               { m_lValue /= inRhs; return *this; }
	...
	void GetMemoryStatistics(class IDrxSizer* pSizer) const { /*nothing*/ }
