...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// A wrapper around Scaleform's GRenderer interface to delegate all rendering to DinrusX's IRenderer interface
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
	GRendererCommandBuffer(GMemoryHeap* pHeap)
		...
		, m_curReadPos(0)
		, m_curWritePos(0)
		, m_rawData(GMemorySTLAlloc<u8>(pHeap))
...
private:
	...
	void Write(ukk pData, const size_t size)
	{
		assert(IsAligned(m_curWritePos));
...
private:
	...
	std::vector<u8, GMemorySTLAlloc<u8>> m_rawData;
...
public:
	...
	virtual void SetVertexData(ukk pVertices, i32 numVertices, VertexFormat vf, CacheProvider* pCache = 0) override;
	virtual void SetIndexData(ukk pIndices, i32 numIndices, IndexFormat idxf, CacheProvider* pCache = 0) override;
	...
	virtual void DrawBitmaps(BitmapDesc* pBitmapList, i32 listSize, i32 startIndex, i32 count, const GTexture* pTi, const GMatrix2D& m, CacheProvider* pCache = 0) override;
...
public:
	...
	// IFlashPlayer
	virtual void SetClearFlags(u32 clearFlags, ColorF clearColor) override;
...
public:
	...
	static CCachedDataStore* CreateOrReuse(GRenderer* pRenderer, GRenderer::CacheProvider* pCache, GRenderer::CachedDataType type, IScaleformPlayback* pOwner, ukk pVertices, i32 numVertices, GRenderer::VertexFormat vf);
	static CCachedDataStore* CreateOrReuse(GRenderer* pRenderer, GRenderer::CacheProvider* pCache, GRenderer::CachedDataType type, IScaleformPlayback* pOwner, ukk pIndices, i32 numIndices, GRenderer::IndexFormat idxf);
	static CCachedDataStore* CreateOrReuse(GRenderer* pRenderer, GRenderer::CacheProvider* pCache, GRenderer::CachedDataType type, IScaleformPlayback* pOwner, const GRenderer::BitmapDesc* pBitmapList, i32 numBitmaps);
...
private:
	CCachedDataStore(GRenderer::CachedDataType type, IScaleformPlayback* pOwner, const IScaleformPlayback::DeviceData* pData)
		...
		, m_type(type)
	{
		DrxInterlockedIncrement(&ms_numInst);
	}

	virtual ~CCachedDataStore()
	{
		DrxInterlockedDecrement(&ms_numInst);
		if (m_pData)
		{
