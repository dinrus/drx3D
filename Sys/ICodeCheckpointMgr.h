...
struct ICodeCheckpointMgr
{
	...
	virtual tukk GetCheckPointName(size_t checkpointIdx) const = 0;
...
public:
	...
	u32      HitCount() const { return m_hitCount; }
	tukk Name() const     { return m_name; }

private:
	u32      m_hitCount;   //!< How many times this has been hit (u32 gives 49 days @ 1000 hits/second).
	tukk m_name;       //!< Name for the checkpoint. Should be descriptive and unique but not function name.
};
