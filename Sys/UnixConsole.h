...
public:
	...
	void Init();
	void Update(float srvRate, i32 numPlayers, INetNub::SStatistics& netNubStats);
...
private:
	...
	static i32k SYSLOG_DEFAULT_PERIOD = 3000; // default timeout (sec)
};
	                   ...
	                   public ITextModeConsole
{
	...
	static i32k DEFAULT_COLOR = -1;

	typedef DrxMutex ConsoleLock;
	ConsoleLock                           m_Lock;
	static DrxCriticalSectionNonRecursive m_cleanupLock;
	...
	DrxConditionVariable m_PromptCond;
	...
	i32    m_CursorPosition;
	i32    m_ScrollPosition;
	...
	void SetColor(i32 color = DEFAULT_COLOR);
	void SetColorRaw(i32 color);
	...
	//
	// Note:
	// - The Put(tukk) method will interpret '\n' as a line separator an
	...
	static char GetLastCharacter(const string& line, i32* color);
	...
	void     DrawLog();
	void     DrawFullscreen();
	void     DrawStatus(i32 maxLines = -1);
...
public:
	...
	// already.
	void Init(tukk headerString = NULL);
	...
	virtual void SetHeader(tukk headerString)
	{
		Lock();
	...
	DLL_EXPORT char Prompt(tukk promptString, tukk responseChars);
	...
	DLL_EXPORT void PrintF(tukk format, ...) PRINTF_PARAMS(2, 3);
...
public:
	...
	// IOutputPrintSink
	///////////////////////////////////////////////////////////////////////////////////////
	virtual void Print(tukk inszText);
	...
	// ITextModeConsole
	///////////////////////////////////////////////////////////////////////////////////////
	virtual Vec2_tpl<i32> BeginDraw() { return Vec2_tpl<i32>(0, 0); };
	virtual void          PutText(i32 x, i32 y, tukk msg);
	virtual void          EndDraw()   {};
