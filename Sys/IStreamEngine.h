...
struct IStreamEngineListener
{
	...
	virtual void OnStreamEnqueue(ukk pReq, tukk filename, EStreamTaskType source, const StreamReadParams& readParams) = 0;
	virtual void OnStreamComputedSortKey(ukk pReq, uint64 key) = 0;
	virtual void OnStreamBeginIO(ukk pReq, u32 compressSize, u32 readSize, EStreamSourceMediaType mediaType) = 0;
	virtual void OnStreamEndIO(ukk pReq) = 0;
	virtual void OnStreamBeginInflate(ukk pReq) = 0;
	virtual void OnStreamEndInflate(ukk pReq) = 0;
	virtual void OnStreamBeginDecrypt(ukk pReq) = 0;
	virtual void OnStreamEndDecrypt(ukk pReq) = 0;
	virtual void OnStreamBeginAsyncCallback(ukk pReq) = 0;
	virtual void OnStreamEndAsyncCallback(ukk pReq) = 0;
	virtual void OnStreamDone(ukk pReq) = 0;
	virtual void OnStreamPreempted(ukk pReq) = 0;
	virtual void OnStreamResumed(ukk pReq) = 0;
	// </interfuscator:shuffle>
};
...
public:
	...
	virtual IReadStreamPtr StartRead(const EStreamTaskType tSource, tukk szFile, IStreamCallback* pCallback = NULL, const StreamReadParams* pParams = NULL) = 0;
	...
	virtual void PauseStreaming(bool bPause, u32 nPauseTypesBitmask) = 0;

	//! Get pause bit mask.
	virtual u32 GetPauseMask() const = 0;
	...
	virtual void Update(u32 nUpdateTypesBitmask) = 0;
	...
	virtual tukk GetStreamTaskTypeName(EStreamTaskType type) = 0;
...
public:
	...
	virtual u32 GetBytesRead(bool bWait = false) = 0;
	...
	virtual void Wait(i32 nMaxWaitMillis = -1) = 0;
	...
	virtual tukk GetErrorName() const = 0;
...
//! DrxPak supports asynchronous reading through this interface.
...
public:
	...
	virtual uk StreamOnNeedStorage(IReadStream* pStream, unsigned nSize, bool& bAbortOnFailToAlloc) { return NULL; }
