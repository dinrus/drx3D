...
struct ITimer
{
	...
	virtual float GetProfileFrameBlending(float* pfBlendTime = 0, i32* piBlendMode = 0) = 0;
	...
	//! Convert from ticks (DrxGetTicks()) to seconds.
