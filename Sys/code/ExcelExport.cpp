...
//////////////////////////////////////////////////////////////////////////
XmlNodeRef CExcelExportBase::NewWorksheet(tukk name)
{
...
//////////////////////////////////////////////////////////////////////////
void CExcelExportBase::AddCell_SumOfRows(i32 nRows)
{
...
//////////////////////////////////////////////////////////////////////////
void CExcelExportBase::AddCell(i32 number)
{
	XmlNodeRef cell = m_CurrRow->newChild("Cell");
...
//////////////////////////////////////////////////////////////////////////
void CExcelExportBase::AddCell(u32 number)
{
	XmlNodeRef cell = m_CurrRow->newChild("Cell");
	cell->setAttr("ss:StyleID", "s22"); // Centered
	XmlNodeRef data = cell->newChild("Data");
...
//////////////////////////////////////////////////////////////////////////
void CExcelExportBase::AddCell(tukk str, i32 nFlags)
{
	XmlNodeRef cell = m_CurrRow->newChild("Cell");
	XmlNodeRef data = cell->newChild("Data");
...
//////////////////////////////////////////////////////////////////////////
void CExcelExportBase::AddCellAtIndex(i32 nIndex, tukk str, i32 nFlags)
{
	XmlNodeRef cell = m_CurrRow->newChild("Cell");
...
//////////////////////////////////////////////////////////////////////////
void CExcelExportBase::SetCellFlags(XmlNodeRef cell, i32 flags)
{
	if (flags & CELL_BOLD)
	{
...
//////////////////////////////////////////////////////////////////////////
bool CExcelExportBase::SaveToFile(tukk filename)
{
	string xml = GetXmlHeader();

	string sDir = PathUtil::GetParentDirectory(filename);
	gEnv->pDrxPak->MakeDir(sDir.c_str());
