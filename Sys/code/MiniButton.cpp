...
//////////////////////////////////////////////////////////////////////////
bool CMiniButton::SetControlCVar(tukk sCVarName, float fOffValue, float fOnValue)
{
	m_pCVar = GetISystem()->GetIConsole()->GetCVar(sCVarName);

	if (!m_pCVar)
	{
		DrxLogAlways("failed to find CVar: %s\n", sCVarName);
	}
...
//////////////////////////////////////////////////////////////////////////
bool CMiniButton::SetClickCallback(ClickCallback callback, uk pCallbackData)
{
