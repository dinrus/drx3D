...
static_assert(sizeof(u32) == sizeof(UInt32), "Bad UInt32 size used");
...
static_assert(u32(IScaleformPlayback::VertexFormat::Vertex_None) == u32(GRenderer::VertexFormat::Vertex_None), "Bad VertexFormat index for Vertex_None");
static_assert(u32(IScaleformPlayback::VertexFormat::Vertex_XY16i) == u32(GRenderer::VertexFormat::Vertex_XY16i), "Bad VertexFormat index for Vertex_XY16i");
static_assert(u32(IScaleformPlayback::VertexFormat::Vertex_XY32f) == u32(GRenderer::VertexFormat::Vertex_XY32f), "Bad VertexFormat index for Vertex_XY32f");
static_assert(u32(IScaleformPlayback::VertexFormat::Vertex_XY16iC32) == u32(GRenderer::VertexFormat::Vertex_XY16iC32), "Bad VertexFormat index for Vertex_XY16iC32");
static_assert(u32(IScaleformPlayback::VertexFormat::Vertex_XY16iCF32) == u32(GRenderer::VertexFormat::Vertex_XY16iCF32), "Bad VertexFormat index for Vertex_XY16iCF32");
...
//////////////////////////////////////////////////////////////////////////
 ...
 i32 CCachedDataStore::ms_numInst = 0;
...
CCachedDataStore* CCachedDataStore::CreateOrReuse(GRenderer* pRenderer, GRenderer::CacheProvider* pCache, GRenderer::CachedDataType type, IScaleformPlayback* pOwner, ukk pVertices, i32 numVertices, GRenderer::VertexFormat _vf)
{
...
CCachedDataStore* CCachedDataStore::CreateOrReuse(GRenderer* pRenderer, GRenderer::CacheProvider* pCache, GRenderer::CachedDataType type, IScaleformPlayback* pOwner, ukk pIndices, i32 numIndices, GRenderer::IndexFormat _idxf)
{
...
CCachedDataStore* CCachedDataStore::CreateOrReuse(GRenderer* pRenderer, GRenderer::CacheProvider* pCache, GRenderer::CachedDataType type, IScaleformPlayback* pOwner, const GRenderer::BitmapDesc* _pBitmapList, i32 numBitmaps)
{
...
GTexture* CScaleformRecording::PushTempRenderTarget(const GRectF& _frameRect, UInt targetW, UInt targetH, bool wantStencil)
{
	...
	i32 TempIRT = GetPlayback()->PushTempRenderTarget(frameRect, targetW, targetH, true, wantStencil);
...
void CScaleformRecording::SetVertexData(ukk pVertices, i32 numVertices, VertexFormat _vf, CacheProvider* pCache)
{
	if (!pVertices) return;
...
void CScaleformRecording::SetIndexData(ukk pIndices, i32 numIndices, IndexFormat _idxf, CacheProvider* pCache)
{
	if (!pIndices) return;
...
void CScaleformRecording::DrawIndexedTriList(i32 baseVertexIndex, i32 minVertexIndex, i32 numVertices, i32 startIndex, i32 triangleCount)
{
...
void CScaleformRecording::DrawLineStrip(i32 baseVertexIndex, i32 lineCount)
{
...
void CScaleformRecording::DrawBitmaps(BitmapDesc* pBitmapList, i32 listSize, i32 startIndex, i32 count, const GTexture* _pTi, const GMatrix2D& _m, CacheProvider* pCache)
{
...
void CScaleformRecording::GetRenderStats(Stats* pStats, bool resetStats)
{
	...
	assert(rsIdx < DRX_ARRAY_COUNT(m_renderStats));
...
void CScaleformRecording::SetClearFlags(u32 clearFlags, ColorF clearColor)
{
...
void CScaleformRecording::SetThreadIDs(u32 mainThreadID, u32 renderThreadID)
{
