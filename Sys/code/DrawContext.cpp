...
// -------------------------------------------------------------------------
//  Имя файла:   DrawContext.cpp
//  Created:     26/08/2009 by Timur.
//  Описание: Implementation of the DrawContext class
// -------------------------------------------------------------------------
//  История:
//
////////////////////////////////////////////////////////////////////////////
...
void CDrawContext::DrawFrame(const Rect& rc, ColorB lineColor, ColorB solidColor, float thickness)
{
	...
	u32 curFlags = m_pAuxRender->GetRenderFlags().m_renderFlags;
...
//////////////////////////////////////////////////////////////////////////
void CDrawContext::DrawString(float x, float y, float font_size, ETextAlign align, tukk format, ...)
{
	...
	i32 flags = eDrawText_Monospace | eDrawText_2D | eDrawText_FixedSize | eDrawText_IgnoreOverscan;
