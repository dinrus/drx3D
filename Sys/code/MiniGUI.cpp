...
// -------------------------------------------------------------------------
//  Имя файла:   MiniGUI.cpp
//  Created:     26/08/2009 by Timur.
//  Описание: Implementation of the MiniGUI class
// -------------------------------------------------------------------------
//  История:
//
////////////////////////////////////////////////////////////////////////////
...
DRXREGISTER_SINGLETON_CLASS(minigui::CMiniGUI)
...
//////////////////////////////////////////////////////////////////////////
IMiniCtrl* CMiniGUI::CreateCtrl(IMiniCtrl* pParentCtrl, i32 nCtrlID, EMiniCtrlType type, i32 nCtrlFlags, const Rect& rc, tukk title)
{
	CMiniCtrl* pCtrl = 0;
	// Test code.
	switch (type)
...
//////////////////////////////////////////////////////////////////////////
void CMiniGUI::OnHardwareMouseEvent(i32 iX, i32 iY, EHARDWAREMOUSEEVENT eHardwareMouseEvent, i32 wheelDelta /*= 0*/)
{
			...
			case DPAD_LEFT:
				{
					...
					if (pNewMenu == NULL)
					{
						i32 i = 0, nRootMenus = m_rootMenus.size();
...
bool CMiniGUI::OnInputEvent(const SInputEvent& rInputEvent)
{
	...
	else
	{
		...
		if (pCtrl)
		{
			...
			//DrxLogAlways("InputEvent %s %d", rInputEvent.keyName, rInputEvent.deviceId);
		}
	}
...
void CMiniCtrl::RemoveSubCtrl(IMiniCtrl* pCtrl)
{
	...
	if (pParent == this)
	{
		...
		for (i32 i = 0, num = (i32)m_subCtrls.size(); i < num; i++)
		{
...
{
	i32 nSubCtrls = m_subCtrls.size();

	if (nSubCtrls)
	{
		for (i32 i = 0; i < nSubCtrls; i++)
		{
...
//////////////////////////////////////////////////////////////////////////
i32 CMiniCtrl::GetSubCtrlCount() const
{
	return (i32)m_subCtrls.size();
}

//////////////////////////////////////////////////////////////////////////
IMiniCtrl* CMiniCtrl::GetSubCtrl(i32 nIndex) const
{
	assert(nIndex >= 0 && nIndex < (i32)m_subCtrls.size());
