...
public:
	// Shared variables:
	static i32 hmd_info;
	static i32 hmd_social_screen;
	static i32 hmd_social_screen_aspect_mode;
	static i32 hmd_post_inject_camera;
	static i32 hmd_tracking_origin;
	static float hmd_resolution_scale;
	static ICVar* pSelectedHmdNameVar;

	static void OnHmdRecenter(IConsoleCmdArgs* pArgs) 
	{ 
		gEnv->pSystem->GetHmdUpr()->RecenterPose();
	}
