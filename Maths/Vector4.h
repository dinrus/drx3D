...
public:
	 ...
	 */
	template<typename K>
	constexpr auto d3Min(const Vector4<K> &other);
	 ...
	 */
	template<typename K>
	constexpr auto d3Max(const Vector4<K> &other);
	...
	DRX3D_EXPORT static const Vector4 Zero;
	DRX3D_EXPORT static const Vector4 One;
	DRX3D_EXPORT static const Vector4 Infinity;
