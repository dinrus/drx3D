...
public:
  CVotingSystem();
  ~CVotingSystem();
  bool  StartVoting(EntityId id, const CTimeValue& start, EVotingState st, EntityId eid, tukk subj);
  void  EndVoting();
  bool  GetCooldownTime(EntityId id, CTimeValue& v);
  
  bool  IsInProgress()const;
  i32   GetNumVotesFor()const;
  i32   GetNumVotesAgainst()const;
  ...
  //clients can vote
  void  Vote(EntityId id, i32 team, bool yes);
