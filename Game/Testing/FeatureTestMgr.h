...
public:
	...
	void OnTestResults(tukk testName, tukk testDesc, tukk failureMsg, float duration, tukk owners = NULL);
...
protected:
	...
	size_t FindTest(tukk name) const;
