...
{
public:
	CGameTypeInfo(tukk name, const CGameTypeInfo* pParent)
		:	m_pParent(pParent)
		,	m_name(name) {}
...
#define DRX_IMPLEMENT_GTI(Type, BaseType)																									\
