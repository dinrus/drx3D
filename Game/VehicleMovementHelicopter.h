...
#include <drx3D/Game/Vehicle/VehiclePhysicsHelicopter.h>
...
public:
    ...
    ILINE u16 GetFlags() { return m_netSyncFlags; }
    ILINE void SetFlags(u16 f) { m_netSyncFlags = f; }
...
#endif // #if !defined(__VEHICLEMOVEMENTHELICOPTERDRXSIS2_H__)
