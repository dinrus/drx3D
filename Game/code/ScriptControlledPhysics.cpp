...
-------------------------------------------------------------------------
История:
- 26:7:2007   17:01 : Created by M�rcio Martins
...
bool CScriptControlledPhysics::ReloadExtension( IGameObject * pGameObject, const SEntitySpawnParams &params )
{
	...
	DRX_ASSERT_MESSAGE(false, "CScriptControlledPhysics::ReloadExtension not implemented");
...
{
	DRX_ASSERT_MESSAGE(false, "CScriptControlledPhysics::GetEntityPoolSignature not implemented");
...
//------------------------------------------------------------------------
i32 CScriptControlledPhysics::Reset(IFunctionHandler *pH)
{
	m_moving = false;
	m_moveTarget.zero();
	m_lastVelocity.zero();
...
//------------------------------------------------------------------------
i32 CScriptControlledPhysics::GetSpeed(IFunctionHandler *pH)
{
	return pH->EndFunction(m_speed);
}

//------------------------------------------------------------------------
i32 CScriptControlledPhysics::GetAcceleration(IFunctionHandler *pH)
{
	return pH->EndFunction(m_acceleration);
}

//------------------------------------------------------------------------
i32 CScriptControlledPhysics::GetAngularSpeed(IFunctionHandler *pH)
{
	return pH->EndFunction(m_rotationSpeed);
}

//------------------------------------------------------------------------
i32 CScriptControlledPhysics::GetAngularAcceleration(IFunctionHandler *pH)
{
	return pH->EndFunction(m_rotationAcceleration);
}

//------------------------------------------------------------------------
i32 CScriptControlledPhysics::MoveTo(IFunctionHandler *pH, Vec3 point, float initialSpeed, float speed, float acceleration, float stopTime)
{
	m_moveTarget=point;
	m_lastVelocity.zero();
	m_moving=true;
...
//------------------------------------------------------------------------
i32 CScriptControlledPhysics::RotateTo(IFunctionHandler *pH, Vec3 dir, float roll, float initialSpeed, float speed, float acceleration, float stopTime)
{
...
//------------------------------------------------------------------------
i32 CScriptControlledPhysics::RotateToAngles(IFunctionHandler *pH, Vec3 angles, float initialSpeed, float speed, float acceleration, float stopTime)
{
...
//------------------------------------------------------------------------
i32 CScriptControlledPhysics::HasArrived(IFunctionHandler *pH)
{
	return pH->EndFunction(!m_moving);
}

//------------------------------------------------------------------------
void CScriptControlledPhysics::GetMemoryUsage(IDrxSizer *pSizer) const
{	
