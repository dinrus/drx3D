...
namespace
{
	...
	void CallEntityScriptMethod(EntityId entityId, tukk methodName, CPlayer* pPlayerArgument, i32 slotArgument)
	{
...
void CPlayerEntityInteraction::ItemPickUpMechanic(CPlayer* pPlayer, const ActionId& actionId, i32 activationMode)
{
