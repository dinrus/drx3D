...
//------------------------------------------------------------------------
void CVehicleMountedWeapon::Update( SEntityUpdateContext& ctx, i32 update)
{
...
//------------------------------------------------------------------------
void CVehicleMountedWeapon::SetAmmoCount(IEntityClass* pAmmoType, i32 count)
{ 
 	IActor* pOwner = GetOwnerActor();
...
//------------------------------------------------------------------------
void CVehicleMountedWeapon::SetInventoryAmmoCount(IEntityClass* pAmmoType, i32 count)
{
 	IActor* pOwner = GetOwnerActor();
	IVehicle *pVehicle = gEnv->pGame->GetIGameFramework()->GetIVehicleSystem()->GetVehicle(m_vehicleId);
...
{
	IActionMapUpr* pMapUpr = gEnv->pGame->GetIGameFramework()->GetIActionMapUpr();
	assert(pMapUpr);
	pMapUpr->EnableActionMap("vehicle_general", false);
