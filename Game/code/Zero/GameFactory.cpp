...
void CGameFactory::CreateScriptTables(SEntityScriptProperties& out, u32 flags)
{
...
template<class T>
void CGameFactory::RegisterGameObject(const string& name, const string& script, u32 flags)
{
...
template<class T>
void CGameFactory::RegisterNoScriptGameObject(const string& name, const string& editorPath, u32 flags)
{
