...
void CInputExtension::PostInit(IGameObject* pGameObject)
{
	...
	IActionMapUpr* pActionMapUpr = gEnv->pGame->GetIGameFramework()->GetIActionMapUpr();
	if (pActionMapUpr)
	{
		pActionMapUpr->InitActionMaps("libs/config/defaultprofile.xml");
		pActionMapUpr->SetDefaultActionEntity(GetEntityId());
		pActionMapUpr->EnableActionMap("player", true);
		pActionMapUpr->Enable(true);
	}
...
void CInputExtension::OnAction(const ActionId& action, i32 activationMode, float value)
{
	m_playerActionHandler.Dispatch(this, GetEntityId(), action, activationMode, value);
}

bool CInputExtension::OnActionControllerMoveX(EntityId entityId, const ActionId& actionId, i32 activationMode, float value)
{
	m_vDeltaMovement.x = value;
	return false;
}

bool CInputExtension::OnActionControllerMoveY(EntityId entityId, const ActionId& actionId, i32 activationMode, float value)
{
	m_vDeltaMovement.y = value;
	return false;
}

bool CInputExtension::OnActionControllerRotateYaw(EntityId entityId, const ActionId& actionId, i32 activationMode, float value)
{
...
bool CInputExtension::OnActionControllerRotatePitch(EntityId entityId, const ActionId& actionId, i32 activationMode, float value)
{
...
bool CInputExtension::OnActionMoveForward(EntityId entityId, const ActionId& actionId, i32 activationMode, float value)
{
...
bool CInputExtension::OnActionMoveBackward(EntityId entityId, const ActionId& actionId, i32 activationMode, float value)
{
	if (activationMode == eAAM_OnPress)
		m_vDeltaMovement.y = -value;
	else if (activationMode == eAAM_OnRelease && m_vDeltaMovement.y < 0.0f)
...
bool CInputExtension::OnActionMoveLeft(EntityId entityId, const ActionId& actionId, i32 activationMode, float value)
{
	if (activationMode == eAAM_OnPress)
		m_vDeltaMovement.x = -value;
...
bool CInputExtension::OnActionMoveRight(EntityId entityId, const ActionId& actionId, i32 activationMode, float value)
{
	if (activationMode == eAAM_OnPress)
		m_vDeltaMovement.x = value;
	else if (activationMode == eAAM_OnRelease && m_vDeltaMovement.x > 0.0f)
...
bool CInputExtension::OnActionMouseRotateYaw(EntityId entityId, const ActionId& actionId, i32 activationMode, float value)
{
...
bool CInputExtension::OnActionMouseRotatePitch(EntityId entityId, const ActionId& actionId, i32 activationMode, float value)
{
	if (m_bUseControllerRotation)
	{
		m_rotation = GetEntity()->GetWorldAngles();
...
bool CInputExtension::OnActionMoveUp(EntityId entityId, const ActionId& actionId, i32 activationMode, float value)
{
	if (activationMode == eAAM_OnPress)
...
bool CInputExtension::OnActionMoveDown(EntityId entityId, const ActionId& actionId, i32 activationMode, float value)
{
	if (activationMode == eAAM_OnPress)
		m_vDeltaMovement.z = -value;
	else if (activationMode == eAAM_OnRelease && m_vDeltaMovement.z < 0.0f)
...
bool CInputExtension::OnActionBoost(EntityId entityId, const ActionId& actionId, i32 activationMode, float value)
{
