...
//-----------------------------------------------------
void CWeapon::OnAction(EntityId actorId, const ActionId& actionId, i32 activationMode, float value)
{
...
//------------------------------------------------------
void CWeapon::SetInputFlag(u8 actionFlag) 
{ 
	DRX_ASSERT(GetOwnerActor() && ( GetOwnerActor()->IsClient() || !GetOwnerActor()->IsPlayer() ) );
...
//------------------------------------------------------
void CWeapon::ForcePendingActions(u8 blockedActions)
{
	...
	if(IsInputFlagSet(eWeaponAction_Fire) && !(blockedActions&eWeaponAction_Fire))
	{
		...
		OnAction(GetOwnerId(),CDrxName("attack1"),eAAM_OnHold,0.0f);
	}
	...
	if(IsInputFlagSet(eWeaponAction_Zoom) && !(blockedActions&eWeaponAction_Zoom))
	{
		if(!IsZoomed() && !IsZoomingInOrOut())
			OnActionZoom(GetOwnerId(), CDrxName("zoom"), eAAM_OnPress, 0.0f);
...
//--------------------------------------------------------------------
bool CWeapon::OnActionSprint(EntityId actorId, const ActionId& actionId, i32 activationMode, float value)
{
...
bool CWeapon::OnActionAttackPrimary(EntityId actorId, const ActionId& actionId, i32 activationMode, float value)
{
...
bool CWeapon::OnActionAttackSecondary(EntityId actorId, const ActionId& actionId, i32 activationMode, float value)
{
	CActor *pOwner = GetOwnerActor();
...
//---------------------------------------------------------
bool CWeapon::OnActionReload(EntityId actorId, const ActionId& actionId, i32 activationMode, float value)
{
...
//---------------------------------------------------------------------------------
bool CWeapon::OnActionFiremode(EntityId actorId, const ActionId& actionId, i32 activationMode, float value)
{
	CActor* pOwner = GetOwnerActor();
...
//---------------------------------------------------------------------
bool CWeapon::OnActionSpecial(EntityId actorId, const ActionId& actionId, i32 activationMode, float value)
{
...
//-------------------------------------------------------------------------
bool CWeapon::OnActionModify(EntityId actorId, const ActionId& actionId, i32 activationMode, float value)
{
	if (IsZoomed() || IsZoomingInOrOut())
		return false;
...
//---------------------------------------------------------
bool CWeapon::OnActionZoomToggle(EntityId actorId, const ActionId& actionId, i32 activationMode, float value)
{
	if(m_zm && m_zm->IsZoomed() && m_zm->GetZoomState() != eZS_ZoomingOut)
	{
		i32 numSteps = m_zm->GetMaxZoomSteps();
...
//---------------------------------------------------------
bool CWeapon::OnActionZoomIn(EntityId actorId, const ActionId& actionId, i32 activationMode, float value)
{
...
//----------------------------------------------------------
bool CWeapon::OnActionZoomOut(EntityId actorId, const ActionId& actionId, i32 activationMode, float value)
{
	if(m_zm && m_zm->IsZoomed())
	{
		i32 numSteps = m_zm->GetMaxZoomSteps();
...
bool CWeapon::OnActionZoom(EntityId actorId, const ActionId& actionId, i32 activationMode, float value)
{
	if (IsModifying())
	{
		return false;
...
//------------------------------------------------------------------------------
bool CWeapon::OnActionZoomXI(EntityId actorId, const ActionId& actionId, i32 activationMode, float value)
{
	if (!AreAnyItemFlagsSet(eIF_Modifying))
	{
...
//------------------------------------------------------------------------------
bool CWeapon::OnActionStabilize(EntityId actorId, const ActionId& actionId, i32 activationMode, float value)
{
...
//------------------------------------------------------------------------------
bool CWeapon::OnActionToggleFlashLight(EntityId actorId, const ActionId& actionId, i32 activationMode, float value)
{
	if (activationMode != eAAM_OnPress)
		return false;
