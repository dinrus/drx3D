...
public:
	...
	EStatus Update(float timePassed) override
	{
		...
		{
			static u32 leanParamCRC = CCrc32::ComputeLowercase("SlideFactor");
	...
	void OnSequenceFinished(i32 layer, u32 scopeID) override
	{
...
{
	const EntityId closeCombatTargetId = g_pGame->GetAutoAimUpr().GetCloseCombatSnapTarget();
