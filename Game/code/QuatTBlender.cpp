...
void QuatTBlender::Init( const QuatT& blendLocationStart, const QuatT& blendLocationEnd, const float totalBlendPeriod )
{
	...
	// Validity
	DRX_ASSERT_MESSAGE( m_totalBlendPeriod >= 0.0f, "QuatTBlender::Init(...) < error param totalBlendPeriod is invalid");
}
...
{
	DRX_ASSERT_MESSAGE( m_totalBlendPeriod >= 0.0f, "QuatTBlender::UpdateBlendOverTime(...) < error param totalBlendPeriod is invalid");
