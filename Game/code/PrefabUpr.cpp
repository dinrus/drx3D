...
#include <drx3D/Game/RuntimePrefab.h>
...
{	
	...
	tukk szFilename = objNode->getAttr("Prefab");
	if (szFilename)
	...
	tukk szMat=objNode->getAttr( "Material");
	if (szMat && szMat[0])
...
{			
	...
	i32 projectionType( SDecalProperties::ePlanar );
...
{		
	...
	tukk szFullName = objNode->getAttr("PrefabName");
	if (szFullName)
...
bool CPrefab::ExtractDesignerLoadParams(XmlNodeRef &objNode, tBrushParams &loadParams)
{
	...
	if (meshNode)
	{
		...
		{
			i32 nLength = strlen(encodedStr);
			if(nLength > 0)
			{
				u32 nDestBufferLen = Base64::decodedsize_base64(nLength);
...
{				
	drx_strcpy(m_szName, itemNode->getAttr("Name"));
	...
	{		
		...
		for (i32 i = 0; i < numObjects; i++)
		{
			...
			tukk szType = objNode->getAttr("Type");
...
//////////////////////////////////////////////////////////////////////////
void CPrefabUpr::Clear(bool bDeleteLibs)
{	
	if (bDeleteLibs)
	{
...
//////////////////////////////////////////////////////////////////////////
CPrefab	*CPrefabUpr::GetPrefab(const string &sLibrary,const string &sName)
{
...
//////////////////////////////////////////////////////////////////////////
bool CPrefabUpr::LoadPrefabLibrary(const string &sFilename)
{ 
	...
	tukk szName=xmlLibRoot->getAttr("Name");
	...
	for (i32 i = 0; i < xmlLibRoot->getChildCount(); i++)
	{
...
//////////////////////////////////////////////////////////////////////////
void CPrefabUpr::SetPrefabGroup(const string &sGroupName)
{	
	m_sCurrentGroup=sGroupName;
}

//////////////////////////////////////////////////////////////////////////
CPrefab *CPrefabUpr::GetRandomPrefab(CPrefabLib *pLib,const lstPrefabIt &it,u32 nSeed)
{
	return NULL;
}

//////////////////////////////////////////////////////////////////////////
void	CPrefabUpr::StripLibraryName(const string &sLibraryName,const string &sFullName,string &sResult,bool bApplyGroup)
{
...
//////////////////////////////////////////////////////////////////////////
CPrefab	*CPrefabUpr::FindPrefabInGroup(CPrefabLib *pLib,const string &sLibraryName,const string &sFullName,lstPrefabIt &i)
{
	string sResult;
...
//////////////////////////////////////////////////////////////////////////
CPrefab *CPrefabUpr::FindPrefab(CPrefabLib *pLib,const string &sFullName,lstPrefabIt &i,bool bLoadIfNotFound)
{	
...
//////////////////////////////////////////////////////////////////////////
void CPrefabUpr::SpawnPrefab(const string &sLibraryFilename,const string &sFullName,EntityId id,u32 nSeed,u32 nMaxSpawn)
{
	// check if the library exists
	...
	if (nMaxSpawn>0)
	{
		std::map<CPrefab*,i32>::iterator pOccCount=m_lstOccurrences.find(pPrefab);
...
//////////////////////////////////////////////////////////////////////////
void CPrefabUpr::MovePrefab(EntityId id)
{
	lstRuntimePrefabIt i=m_lstRuntimePrefabs.find(id);
	if (i!=m_lstRuntimePrefabs.end())
	{
...
//////////////////////////////////////////////////////////////////////////
void CPrefabUpr::DeletePrefab(EntityId id)
{
	lstRuntimePrefabIt i=m_lstRuntimePrefabs.find(id);
	if (i!=m_lstRuntimePrefabs.end())
	{
		...
		std::map<CPrefab*,i32>::iterator pOccCount=m_lstOccurrences.find(pRuntimePrefab->GetSourcePrefab());
		if (pOccCount!=m_lstOccurrences.end())
		{
...
//////////////////////////////////////////////////////////////////////////
void CPrefabUpr::HidePrefab(EntityId id,bool bHide)
{
	lstRuntimePrefabIt i=m_lstRuntimePrefabs.find(id);
	if (i!=m_lstRuntimePrefabs.end())
	{
...
//////////////////////////////////////////////////////////////////////////
void CPrefabUpr::CallOnSpawn(IEntity *pEntity,i32 nSeed)
{
