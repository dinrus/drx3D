...
CAnimActionBlendFromRagdoll::CAnimActionBlendFromRagdoll( i32 priority, CActor& actor, const FragmentID& fragID, const TagState fragTags )
...
{
//::DrxCreateClassInstance<IAnimationPoseMatching>("AnimationPoseModifier_PoseMatching", m_pPoseMatching);
}
...
void CAnimActionBlendFromRagdoll::GenerateAnimIDs()
{
	...
	i32 numOptions = m_rootScope->GetDatabase().FindBestMatchingTag(fragQuery, &fragTagStateMatch, &tagSetIdx);
...
CAnimActionBlendFromRagdollSleep::CAnimActionBlendFromRagdollSleep( i32 priority, CActor& actor, const HitInfo& hitInfo, const TagState& sleepTagState, const TagState& fragTags )
