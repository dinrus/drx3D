...
//////////////////////////////////////////////////////////////////////////
CAnimActionAIStance::CAnimActionAIStance( i32 priority, CPlayer* pPlayer, const EStance targetStance )
...
bool CAnimActionAIStance::FragmentExistsInDatabase( const SAnimationContext& context, const IAnimationDatabase& database ) const
{
	...
	u32k optionCount = database.FindBestMatchingTag( fragQuery );
