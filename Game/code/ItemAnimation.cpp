...
/*************************************************************************
-------------------------------------------------------------------------
Описание: Helper functionality for item animation control
...
CActionItemIdle::CActionItemIdle(i32 priority, FragmentID fragmentID, FragmentID idleBreakFragmentID, const TagState fragTags, CPlayer& playerRef)
...
void CActionItemIdle::OnSequenceFinished(i32 layer, u32 scopeID)
{
...
CItemSelectAction::CItemSelectAction(i32 priority, FragmentID fragmentID, const TagState &fragTags, CItem& _item)
