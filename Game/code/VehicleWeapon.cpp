...
//------------------------------------------------------------------------
void CVehicleWeapon::Update( SEntityUpdateContext& ctx, i32 update)
{
...
//------------------------------------------------------------------------
void CVehicleWeapon::SetAmmoCount(IEntityClass* pAmmoType, i32 count)
{ 
...
//------------------------------------------------------------------------
void CVehicleWeapon::SetInventoryAmmoCount(IEntityClass* pAmmoType, i32 count)
{
  IActor* pOwner = GetOwnerActor();
...
{
	DRX_ASSERT(GetOwnerId() == g_pGame->GetIGameFramework()->GetClientActorId());
...
//---------------------------------------------------------------------
void CVehicleWeapon::GetCacheName(const IEntityClass* pClass, const bool bIsThirdPerson, DrxFixedStringT<32> &outCacheName)
{
