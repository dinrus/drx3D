...
tukk  CGodMode::m_godModeCVarName = "g_godMode";
tukk  CGodMode::m_demiGodRevivesAtCheckpointCVarName = "g_demiGodRevivesAtCheckpoint";
...
tukk CGodMode::GetCurrentStateString() const
{
	tukk res = "None";
