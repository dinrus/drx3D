...
//////////////////////////////////////////////////////////////////////////
CAnimActionAIChangeCoverBodyDirection::CAnimActionAIChangeCoverBodyDirection( i32 priority, CPlayer* pPlayer, const ECoverBodyDirection targetCoverBodyDirection )
...
, m_isTargetCoverBodyDirectionSet( false )
{
	...
	DRX_ASSERT( m_targetCoverBodyDirection != eCoverBodyDirection_Unspecified );
}
...
//////////////////////////////////////////////////////////////////////////
CAnimActionAICoverAction::CAnimActionAICoverAction( i32 priority, CPlayer* pPlayer, tukk actionName )
...
{
	static u32k s_coverActionCrc = CCrc32::ComputeLowercase( "CoverAction" );
	static u32k s_coverActionInCrc = CCrc32::ComputeLowercase( "CoverActionIn" );
	static u32k s_coverActionOutCrc = CCrc32::ComputeLowercase( "CoverActionOut" );
...
void CAnimActionAICoverAction::Enter()
{
...

	{
		...
		tukk const actionName = m_action.c_str();
...
//////////////////////////////////////////////////////////////////////////
void CAnimActionAICoverAction::OnSequenceFinished( i32 layer, u32 scopeID )
{
...
//////////////////////////////////////////////////////////////////////////
bool CAnimActionAICoverAction::IsTargetActionName( tukk actionName ) const
{
	u32k actionNameCrc = CCrc32::ComputeLowercase( actionName );
