...
public:
	...
	void SetHorizontalAimJointName( tukk horizontalAimJointName );
	void SetWeaponJointName( tukk weaponJointName );
	void SetAimPosesOriginJointName( tukk aimPosesOriginJointName );

	void SetHorizontalAimJointId( i16k horizontalAimJointId );
	void SetWeaponJointId( i16k weaponJointId );
	void SetAimPosesOriginJointId( i16k aimPosesOriginJointId );
	...
	i32 GetVerticalAimLayer() const;

protected:
	bool InitialiseCharacter( i32k characterSlot );
...
private:
	...
	u32 m_horizontalAimLayer;
	u32 m_verticalAimLayer;
	...
	i16 m_horizontalAimJointId;
	i16 m_weaponJointId;
	i16 m_aimPosesOriginJointId;
