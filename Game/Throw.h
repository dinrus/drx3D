...
-------------------------------------------------------------------------
История:
- 261:10:2005   15:45 : Created by M�rcio Martins
...
public:
	...
	ILINE u32k GetTrajectoryLength() const { return m_trajectoryLength; }
...
protected:
	...
	void RenderTrajectory(const Vec3* trajectory, u32 sampleCount, const float time);
