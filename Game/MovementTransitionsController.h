...
public:
	...
	bool RequestTransition(tukk szFragmentID, const STransition*const pTransition, const STransitionFuture& future); // returns false when the fragmentID was invalid (or any other reason why we couldn't start the IAction)
...
private:
	static i32k MAX_SAMPLES = 100;
	static i32k MAX_PREDICTIONS_PER_FRAME = 6;
...
private:
	...
	static bool EnoughTimePassedSinceLastPrediction(i32k currentFrameID)
	{
	...
	static void RememberLastPredictionFrameID(i32k currentFrameID)
	{
		...
		{
			DRX_ASSERT(currentFrameID > m_lastPredictionFrameID);
...
private:
	static i32 m_lastPredictionFrameID;
	static i32 m_numPredictionsThisFrame;
