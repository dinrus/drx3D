...
public:
	...
	static size_t Compress(CRecordingBuffer *srcBuffer, u8* outBuffer, u32 maxOutputSize, SRecording_VictimPosition* startVictimPosition, SRecording_VictimPosition* endVictimPosition, EntityId killHitVictimID);
	...
	static size_t Decompress(u8 *compressedInput, size_t compressedSize, uk outputBuffer, size_t maxOutputSize, size_t streamAlignment=1);
	...
	//  outBuffer:           Output buffer for compressed data
	//  maxOutputSize:       Size of output buffer
	static size_t CompressRaw(u8 *inBuffer, u32 inBufferSize, u8* outBuffer, u32 maxOutputSize);
...
private:
	...
	static SRecording_Packet* SortPackets(SRecording_Packet *dstBuffer, CRecordingBuffer *srcBuffer, u8 *pSrcAuxBuffer, u32 srcAuxBufferSize, SRecording_VictimPosition* startVictimPosition, SRecording_VictimPosition* endVictimPosition, EntityId killHitVictimID);
