...
#include <drx3D/Game/EntityEffectsCloak.h>
...
//////////////////////////////////////////////////////////////////////////
void EntityEffects::Cloak::CloakEntity( IEntity* pEntity, bool bEnable, bool bFade, float blendSpeedScale, bool bCloakFadeByDistance, u8 cloakPaletteColorChannel, bool bIgnoreCloakRefractionColor)
{
	if (pEntity)
	{
		...
		if (pRenderProxy)
		{
			...
			u8 currentMask = pRenderProxy->GetMaterialLayersMask();
			u8 newMask = currentMask;
...
void EntityEffects::Cloak::CloakEntity( EntityId entityId, bool bEnable, bool bFade, float blendSpeedScale, bool bCloakFadeByDistance, u8 cloakPaletteColorChannel, bool bIgnoreCloakRefractionColor)
{
...
//////////////////////////////////////////////////////////////////////////
u8 EntityEffects::Cloak::GetCloakColorChannel(EntityId ownerEntityId)
{
	u8 cloakColorChannel = 0;
