...
#include <drx3D/Game/IUIDraw.h> // For alignment flags.
#include <drx3D/CoreX/Renderer/IRenderAuxGeom.h> // RenderStates

//-----------------------------------------------------------------------------------------------------

typedef u8 UIDRAWFLAGS;
...
public:
	...
	C2DRenderUtils(ScreenLayoutUpr* pLayoutUpr);
	~C2DRenderUtils();
	...
	void DrawImageStereo( i32 iTextureID,
	                float fX, float fY,
	                float fSizeX, float fSizeY,
	                float fAngleInDegrees,
	                const ColorF& cfColor,
...
#                endif
	...
	//--------------------------------------------------------------------------
	// Images
	void InternalDrawImage( i32 iTextureID,
	                        float fX, float fY,
	                        float fSizeX, float fSizeY,
	                        float fAngleInDegrees,
	                        const ColorF& cfColor,
	...
	void InternalDrawImageStereo( i32 iTextureID,
	                        float fX, float fY,
	                        float fSizeX, float fSizeY,
	                        float fAngleInDegrees,
	                        const ColorF& cfColor,
