...
bool CSnow::ReloadExtension( IGameObject * pGameObject, const SEntitySpawnParams &params )
{
	...
	DRX_ASSERT_MESSAGE(false, "CSnow::ReloadExtension not implemented");
...
{
	DRX_ASSERT_MESSAGE(false, "CSnow::GetEntityPoolSignature not implemented");
...
//------------------------------------------------------------------------
void CSnow::Update(SEntityUpdateContext &ctx, i32 updateSlot)
{
