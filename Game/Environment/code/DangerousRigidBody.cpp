...
#include <drx3D/Game/DangerousRigidBody.h>
#include <drx3D/Game/GameRules.h>

i32 CDangerousRigidBody::sDangerousRigidBodyHitTypeId	= -1;
...
void CDangerousRigidBody::InitClient( i32 channelId )
{
...
bool CDangerousRigidBody::NetSerialize( TSerialize ser, EEntityAspects aspect, u8 profile, i32 flags )
{
...
void CDangerousRigidBody::GetMemoryUsage( IDrxSizer *pSizer ) const
{
	pSizer->Add(*this);
}
...
bool CDangerousRigidBody::ReloadExtension( IGameObject * pGameObject, const SEntitySpawnParams &params )
{
	...
	DRX_ASSERT_MESSAGE(false, "CDangerousRigidBody::ReloadExtension not implemented");
...
{
	DRX_ASSERT_MESSAGE(false, "CDangerousRigidBody::GetEntityPoolSignature not implemented");
