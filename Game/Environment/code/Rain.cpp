...
bool CRain::ReloadExtension( IGameObject * pGameObject, const SEntitySpawnParams &params )
{
	...
	DRX_ASSERT_MESSAGE(false, "CRain::ReloadExtension not implemented");
...
{
	DRX_ASSERT_MESSAGE(false, "CRain::GetEntityPoolSignature not implemented");
...
//------------------------------------------------------------------------
void CRain::Update(SEntityUpdateContext &ctx, i32 updateSlot)
{
