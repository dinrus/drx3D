...
public:
	...
	void GetPlayerData( IEntity* pEntity, float& px, float &py, i32& rot ) const
	{
		if (pEntity)
		{
			...
			rot = (i32) ( pEntity->GetWorldAngles().z * 180.0f/gf_PI - 90.0f );
		}
	}
...
public:
	...
	virtual void GetConfiguration( SFlowNodeConfig& config )
	{
		...
		static const SOutputPortConfig outputs[] = {
			...
			OutputPortConfig<i32>		( "Width",		_HELP( "Minimap width" ) ),
			OutputPortConfig<i32>		( "Height",		_HELP( "Minimap height" ) ),
...
public:
	...
	virtual void GetConfiguration( SFlowNodeConfig& config )
	{
		...
		static const SOutputPortConfig outputs[] = {
			...
			OutputPortConfig<i32>	  ("Rotation",	_HELP( "Minimap rotation" ) ),
			{0}
		};
