...
public:
	...
	virtual void GetConfiguration( SFlowNodeConfig &config )
	{
		static const SInputPortConfig in_config[] = {
			...
			InputPortConfig<i32>( "Achievement",0, _HELP("The achievement to trigger"), _HELP("Achievement"), 
		...
		case eFE_Activate:
			{
				...
				{
					i32 achievementId = -1;
					i32 input = GetPortInt(pActInfo, EIP_Achievement);
...
private:
	...
	bool AccountLevelForStats( tukk levelName ) const
	{
	...
	virtual void ProcessEvent(EFlowEvent event, SActivationInfo *pActInfo)
	{
		...
		switch (event)
		{
			...
			{	
				...
				{
					i32 val = pStats->GetStat( EIPS_TutorialAlreadyPlayed );
