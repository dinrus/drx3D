...
#include <drx3D/Game/FlowFadeNode.h>
...
tukk CHUDFader::GetDebugName() const
{
	if (m_pTexture)
...
i32 CHUDFader::FadeIn( const ColorF& targetColor, float fDuration, bool bUseCurrentColor/*=true*/, bool bUpdateAlways/*=false*/ )
{
...
i32 CHUDFader::FadeOut( const ColorF& targetColor, float fDuration, tukk textureName/*=""*/, bool bUseCurrentColor/*=true*/, bool bUpdateAlways/*=false*/, float fTargetAlpha/*=1.f*/, float fSourceAlpha /*=-1.f*/)
{
...
ITexture* CHUDFader::LoadTexture( tukk textureName )
{
	if (gEnv->pRenderer)
...
void CHUDFader::SetTexture( tukk textureName )
{
...
CHUDFader* CMasterFader::GetHUDFader( i32 group )
{
...
class CFlowFadeNode : public CFlowBaseNode<eNCT_Instanced>
{
	...
	{
		i32 group = GetPortInt(pActInfo, EIP_FadeGroup);
...
public:
	...
	virtual void GetConfiguration(SFlowNodeConfig& config)
	{
		static const SInputPortConfig inputs[] = {
			InputPortConfig<i32> ("FadeGroup", 0, _HELP("Fade Group [0-3]"), 0, _UICONFIG("enum_int:0=0,1=1,2=2,3=3")),
