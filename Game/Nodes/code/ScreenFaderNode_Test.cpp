...
DRX_TEST_FIXTURE(ScreenFaderNode_TestFixture, Actor2BaseTestFixture, Actor2TestSuite)
{
public:
...
DRX_TEST_WITH_FIXTURE(Test_ScreenFaderNode_OnFadeOutPortActive_FadesOutScreen, ScreenFaderNode_TestFixture)
{
...
DRX_TEST_WITH_FIXTURE(Test_ScreenFaderNode_OnFadeInPortActive_FadesInScreen, ScreenFaderNode_TestFixture)
{
...
DRX_TEST_WITH_FIXTURE(Test_ScreenFaderNode_DoesNotTriggerFadeInOrOut_IfNotLocalPlayer, ScreenFaderNode_TestFixture)
{
