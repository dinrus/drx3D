...
public:
	...
	void Update(float elapsed)
	{
		...
		static i32k iObjTypes = ent_rigid | ent_sleeping_rigid | ent_living;// | ent_allocate_list;
		i32 numEntities = gEnv->pPhysicalWorld->GetEntitiesInBox(ptmin, ptmax, pEntityList, iObjTypes);
		AABB bounds;
