...
public:
	...
	void   AddInput(IEntityClass::EventValueType type, tukk name, FlowNodeInputFunction callback);
	void   AddOutputs(const std::vector<SOutputPortConfig>& outputs);
	i32    AddOutput(IEntityClass::EventValueType type, tukk name, tukk description = nullptr);
	void   Close();
