...
public:
	...
	CItemAction( i32 priority, FragmentID fragmentID, const TagState &fragTags, i32k flags = 0 )
...
public:
	...
	CItemSelectAction( i32 priority, FragmentID fragmentID, const TagState &fragTags, CItem& _item);
...
public:
	...
	CActionItemIdle(i32 priority, FragmentID fragmentID, FragmentID idleBreakFragmentID, const TagState fragTags, CPlayer& playerRef);
