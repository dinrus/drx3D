...
// -------------------------------------------------------------------------
//  Имя файла:   VehicleMovementMPVTOL.h
//  Version:     v1.00
//  Created:     02/09/2011
//  Компиляторы:       drux (DinrusPro's Universal Compiler),   mingw-w64-clang-x86_64
//  Описание: Handles movement of the multiplayer version of the VTOL vehicle
// -------------------------------------------------------------------------
//  История:
//
////////////////////////////////////////////////////////////////////////////
...
public:
  ...
  virtual void PostPhysicalize();
	...
	ILINE u8 GetPathComplete ( ) const { return m_pathing.pathComplete; }
...
private:
	...
	i32		m_baseStutters; //Stutter at least this many times in a row
	i32		m_maxExtraStutters; //Randomly stutter up to this many extra times
	i32		m_exhaustStuttersRemaining;
