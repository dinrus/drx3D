...
$Id$
$DateTime$
Описание:  BlendedEffect interface for ScreenEffects and some implementations
...
#include <DrxMemory/PoolAllocator.h>
...
{
	typedef stl::PoolAllocator<sizeof(T) + sizeof(uk ), stl::PoolAllocatorSynchronizationSinglethreaded> Alloc;
