...
#include <drx3D/Game/IMovementController.h> // for the exactpositioning structures
...
private:
	static TExactPositioningQueryID GenerateQueryID() { ++s_lastQueryID; DRX_ASSERT(s_lastQueryID); return s_lastQueryID; }
