...
// FX Asserts
#if DEBUG_GAME_FX_SYSTEM
	#define FX_ASSERT_MESSAGE(condition,message)		DRX_ASSERT_MESSAGE(condition,message); \
																									if(!(condition)) \
																									{\
																										DrxLogAlways("\n*************************************************************************************"); \
																										DrxLogAlways("FX ASSERT"); \
																										DrxLogAlways("Condition: %s",#condition); \
																										DrxLogAlways("Message: %s",message); \
																										DrxLogAlways("File: %s",__FILE__); \
																										DrxLogAlways("Line: %d",__LINE__); \
																										DrxLogAlways("*************************************************************************************\n"); \
																									}
#else	
...
#define GAME_FX_INPUT_ResetParticleUpr			eKI_Delete
#define GAME_FX_INPUT_PauseParticleUpr			eKI_End
...
typedef void (*DebugOnInputEventCallback)(i32);
