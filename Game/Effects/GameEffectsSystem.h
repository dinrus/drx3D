...
public:
	...
	{
		SRegisterEffectDebugData(DebugOnInputEventCallback inputEventCallback,DebugDisplayCallback debugDisplayCallback, tukk effectName)
		{
	...
	IGameEffect*			GetDebugEffect(tukk pEffectName) const;
#endif
...
private:
	...
	void										OnActivateDebugView(i32 debugView);
	void										OnDeActivateDebugView(i32 debugView);
	...
	static i32												s_currentDebugEffectId;

	i32																m_debugView;
#endif

	static CGameEffectsSystem*	s_singletonInstance;
	static i32									s_postEffectCVarNameOffset;
