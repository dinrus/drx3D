...
#include <drx3D/Game/Effects/GameEffectsSystemDefines.h>
...
public:
	...
	virtual void	SetFlag(u32 flag,bool state) = 0;
	virtual bool	IsFlagSet(u32 flag) const = 0;
...
public:
	...
	void					SetFlag(u32 flag,bool state) override;
	bool					IsFlagSet(u32 flag) const override;
...
protected:
	...
	void					SpawnParticlesOnSkeleton(IEntity* pEntity, IParticleEmitter* pParticleEmitter, u32 numParticles,float maxHeightScale = 1.0f) const;
	void					SetMaterialOnEntity(IMaterial* pMaterial,EntityId entityId,PodArray<i32>*	pBodyAttachmentIndexArray);
	...
	void					InitAttachmentIndexArray(PodArray<i32> *attachmentIndexArray,PodArray<ItemString>* pAttachmentNameArray,EntityId entityId) const;
	static IMaterial*				LoadMaterial(tukk pMaterialName);
	static IParticleEffect* LoadParticleEffect(tukk pParticleEffectName);
...
private:
	...
	DrxFixedStringT<32>		m_debugName;
#endif
};//------------------------------------------------------------------------------------------------
