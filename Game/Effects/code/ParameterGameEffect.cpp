...
#include <drx3D/Game/ParameterGameEffect.h>

#include <drx3D/Game/ItemParams.h>
#include <drx3D/Game/RecordingSystem.h>

tukk PARAMETER_GAME_EFFECT_NAME = "ParameterGameEffect";
...
//--------------------------------------------------------------------------------------------------
tukk CParameterGameEffect::GetName() const
{
...
{
	DRX_ASSERT(usage >= 0 && usage < eSEU_NUMTYPES);
