...
$Id$
$DateTime$
Описание: Continuous health effect running for the local player
...
#include <drx3D/Game/PlayerHealthEffect.h>
...
namespace
{
	...
	tukk radialBlurMaskName = "Textures/weapons/damage_blurmask.dds";
