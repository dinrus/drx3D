...
public:
	...
	// Configuration:
	void                                   SetParticleEffectName(tukk particleFileName);
...
public:
	...
	DrxFixedStringT<128>                m_EffectName;

	// The material name of the lightning effect.
	DrxFixedStringT<128>                m_MaterialName;
...
public:
	...
	// Setup:	
	void                                   Setup(tukk playersHandEffectName, tukk targetEntityEffectName, const CPlayerMindGameBeamEffectLinkedEffectConfig* linkedEffectConfig, tukk leftBossConnectAttachmentName, tukk rightBossConnectAttachmentName);
...
private:
	...
	DrxFixedStringT<64>                    m_LeftConnectionAttachmentName;

	// The name of the left connection attachment on the target entity.
	DrxFixedStringT<64>                    m_RightConnectionAttachmentName;
