...
i32 CFlock::m_e_flocks = 1;
i32 CFlock::m_e_flocks_hunt = 1;
...
//////////////////////////////////////////////////////////////////////////
void CFlock::SetPercentEnabled( i32 percent )
{
	if (percent < 0)
		percent = 0;
	if (percent > 100)
...
void CFlock::Render(const SRendParams & EntDrawParams)
{
	...
	i32 frameId = gEnv->pRenderer->GetFrameID(false);
...
void CFlock::RegisterAIEventListener( bool bEnable )
{
	...
	if (bEnable)
	{
		...
		gEnv->pAISystem->RegisterAIEventListener(this,m_bc.flockPos,m_bc.maxVisibleDistance,(1<<AISTIM_EXPLOSION)|(1<<AISTIM_SOUND)|(1<<AISTIM_DRX3D_HIT));
	}
...
bool CFlock::CreateEntities()
{
	...
	bool bHasCgfFile = gEnv->pDrxPak->IsFileExist(m_modelCgf) && m_bc.animationMaxDistanceSq > 0;
...
void CFlock::GetMemoryUsage( IDrxSizer *pSizer ) const
{
...
/*
//////////////////////////////////////////////////////////////////////////
CFlockUpr::CFlockUpr( ISystem *system )
{
	// Create one flock.
	m_system = system;
	m_lastFlockId = 1;
