...
#include <drx3D/Phys/DeferredActionQueue.h>
...
public:
	...
	bool PlayAnimation( tukk animation,bool bLooped,float fBlendTime=0.3f );
	bool PlayAnimationId( i32 nIndex,bool bLooped,float fBlendTime=0.3f );
	void ExecuteTrigger(i32 nIndex);

	i32 GetGeometrySurfaceType();
