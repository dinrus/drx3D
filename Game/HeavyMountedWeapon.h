...
private:
	...
	bool OnActionRipOff(EntityId actorId, const ActionId& actionId, i32 activationMode, float value);
	bool OnActionFiremode(EntityId actorId, const ActionId& actionId, i32 activationMode, float value);
