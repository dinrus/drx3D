...
public:
	...
	u8	GetLocalPlayerFaction() const;
	u8	GetTargetFaction(IEntity& targetEntity) const;

private:

	static i32k kMaxAutoaimTargets = 64;
	...
	mutable u8		m_localPlayerFaction;
};
