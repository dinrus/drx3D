...
#include <drx3D/Game/RadioChatterModule.h>
...
void RadioChatterModule::SetSound(tukk name)
{
...
void RadioChatterModule::PlayChatterOnRandomNearbyAgent()
{
	...
	ChatterCandidates::size_type randomCandidateIndex = drx_random((size_t)0, candidates.size() - 1);
...
void RadioChatterModule::RefreshNextChatterTime()
{
	...
	const float silenceDuration = drx_random(
