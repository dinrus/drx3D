...
/*************************************************************************
 -------------------------------------------------------------------------
  $Id$
  $DateTime$
  Описание: Helper to allow AI to see objects which have just been thrown
...
//////////////////////////////////////////////////////////////////////////
bool CVisibleObjectsHelper::RegisterObject(EntityId objectId, i32 factionId, u32 visibleObjectRule, 
										   TObjectVisibleFunc pObjectVisibleFunc, uk pObjectVisibleFuncArg)
{
	bool bResult = false;
...
//////////////////////////////////////////////////////////////////////////
bool CVisibleObjectsHelper::RegisterObject(EntityId objectId, const ObservableParams &observableParams, u32 visibleObjectRule, 
										   TObjectVisibleFunc pObjectVisibleFunc, uk pObjectVisibleFuncArg)
{
	bool bResult = false;
...
//////////////////////////////////////////////////////////////////////////
bool CVisibleObjectsHelper::SetObjectVisibleRule(EntityId objectId, u32 visibleObjectRule)
{
	bool bResult = false;
...
//////////////////////////////////////////////////////////////////////////
bool CVisibleObjectsHelper::SetObjectVisibleFunc(EntityId objectId, TObjectVisibleFunc pObjectVisibleFunc, uk pObjectVisibleFuncArg)
{
	bool bResult = false;
...
void CVisibleObjectsHelper::Update()
{
	...
	IAIObjectUpr* pAIObjectUpr = !activeVisibleObjects.empty() ? gEnv->pAISystem->GetAIObjectUpr() : NULL;
	IAIObjectIter* pAIObjectIter = pAIObjectUpr ? pAIObjectUpr->GetFirstAIObject(OBJFILTER_TYPE, AIOBJECT_ACTOR) : NULL;
	if (pAIObjectIter)
	{
...
bool CVisibleObjectsHelper::CheckVisibilityRule(IEntity *pObject, SVisibleObject &visibleObject, float fCurrTime) const
{
	...
	bool bIsActive = true;
	u32k checkRule = (visibleObject.rule & eVOR_TYPE_MASK);
		...
		if (bVisible)
		{
			...
			if (pAIEntity != NULL && eVOR_FlagNotifyOnSeen == (visibleObject->rule & eVOR_FlagNotifyOnSeen))
			{
				...
				if (pObservableParams != NULL)
				{
					...
					if (pTargetEntity != NULL && pTargetTrackUpr != NULL)
					{
						...
						pTargetTrackUpr->HandleStimulusEventForAgent(aiOwnerId, aiTargetId, "SeeThrownObject", eventInfo);
