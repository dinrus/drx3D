...
public:
	...
	virtual tukk GetName() const { return "ArmorModule"; }
...
private:
	...
	typedef std::tr1::unordered_map<u32, SShaderParamEntry> TShaderParams;
...
private:
	...
	void LoadParamsXml_Mode(TShaderParams &outShaderParams, XmlNodeRef &pNode, tukk szDebugName);
	void LoadParamsXml_Modifiers(TShaderParams &outShaderParams, XmlNodeRef &pNode, tukk szDebugName);
	...
	static IAttachmentUpr* GetAttachmentUpr(EntityId entityID);
...
private:
	...
	typedef std::map<u16, float> TWeaponDamageMods;
