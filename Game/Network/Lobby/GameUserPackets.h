...
$Id$
$DateTime$
Описание: Game side definitions for lobby user packets
...
#include <drx3D/CoreX/Lobby/DrxLobbyPacket.h>

#pragma once

enum GameUserPacketDefinitions
{
	eGUPD_LobbyStartCountdownTimer = DRXLOBBY_USER_PACKET_START,
