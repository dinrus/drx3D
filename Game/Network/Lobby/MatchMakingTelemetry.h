...
//////////////////////////////////////////////////////////////////////////
// Events Include
#include <drx3D/Game/Network/Lobby/MatchMakingEvents.h>
...
public:
	...
	virtual void OnClientConnect(i32 channelId, bool isReset, EntityId playerId) { DrxLog("MMT: OnClientConnect"); }
...
public:
	...
	virtual EResult	ProduceTelemetry( char *pOutBuffer, i32 inMinRequired, i32 inBufferSize, i32 *pOutWritten );

private:

	typedef DrxFixedStringT<256> EventDataString;
