...
//Currently PC achievements are stubbed out in DrxNetwork
static i32k ACHIEVEMENT_STARTINDEX = 0;
...
public:
	...
	void GiveAchievement(i32 achievement);
...
protected:
	...
	ECategorisedHitType CategoriseHit(i32 hitType);
