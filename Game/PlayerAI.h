...
public:
	...
	void SetRequestedCoverAction( const ECoverBodyDirection coverBodyDirection, tukk const actionName );
	...
	void SetRequestedCoverActionName( tukk const actionName );
	const string& GetRequestedCoverActionName() const;

	void SetCoverActionName( tukk const actionName );
...
public:
	...
	void UpdateAimingState( ISkeletonPose* pSkeletonPose, const bool aimEnabled, const Vec3& aimTarget, u32k aimIkLayer, const float aimIkFadeoutTime );
