...
{
	SBonusMatchXp(EntityId _entityId, i32 _amount)
		: entityId(_entityId)
		, amount(_amount)
	{}
	EntityId entityId;
...
{
	SIntrestEntity( EntityId _entityId, i32 _type)
		: entityId(_entityId)
		, type(_type)
	{}
	EntityId entityId;
...
class CStatsRecordingMgr : public IGameStatisticsCallback, public IHitListener, public IGameFrameworkListener, public IEntityPoolListener, public IDataListener
{
	...
	protected:
		...
		i32																				m_checkpointCount;
		i32																				m_lifeCount;
		bool																			m_requestNewSessionId;
		IStatsTracker															*m_teamTrackers[MAX_TEAM_INDEX+1];
		DrxFixedArray<SBonusMatchXp, MAX_PLAYER_LIMIT> m_matchBonusXp;
	...
	public:
		...
		static i32																GetIntAttributeFromProfile(
																								IPlayerProfile *inProfile, 
																								tukk inAttributeName);
		...
		void																			AddTeam(
																								i32				inTeamId,
																								string		inTeamName);
		void																			OnTeamScore(i32 teamId, i32 score, EGameRulesScoreType pointsType);
		void																			OnMatchBonusXp(IActor* pActor, i32 amount);

		void																			InteractiveObjectEntry( EntityId entity, i32 type );
		void																			EnvironmentalWeaponEntry( EntityId entity, i32 type );
		...
		void																			LoadEventConfig(tukk configName);
