...
*************************************************************************/
#ifndef __ScreenLayoutUpr_H__
#define __ScreenLayoutUpr_H__

#include <drx3D/Game/IUIDraw.h> // For alignment flags.

typedef u8 ScreenLayoutStates;
