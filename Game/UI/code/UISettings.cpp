...
#include <drx3D/Game/UISettings.h>
...
void CUISettings::InitEventSystem()
{
	...
	for (u32 i = 0; i < ScreenResolution::GetNumScreenResolutions(); i++)
	{
		ScreenResolution::SScreenResolution res;
		ScreenResolution::GetScreenResolutionAtIndex(i, res);
		i32 width = res.iWidth;
		i32 height = res.iHeight;
...
{
	for (u32 i = 0; i < m_Resolutions.size(); ++i)
	{
...
// ui events
////////////////////////////////////////////////////////////////////////////
void CUISettings::OnSetGraphicSettings( i32 resIndex, i32 graphicsQuality, bool fullscreen )
{
...
void CUISettings::OnSetResolution( i32 resX, i32 resY, bool fullscreen )
{
#if DRX_PLATFORM_DESKTOP
	m_pRXVar->Set(resX);
	m_pRYVar->Set(resY);
...
//TODO: SAFE CURRENT SETTINGS?
	...
	if (gEnv->pGame && gEnv->pGame->GetIGameFramework() && gEnv->pGame->GetIGameFramework()->GetIPlayerProfileUpr())
	{
		IPlayerProfileUpr* pProfileUpr = gEnv->pGame->GetIGameFramework()->GetIPlayerProfileUpr();
		pProfileUpr->LogoutUser(pProfileUpr->GetCurrentUser());
	}
}
...
void CUISettings::SendResolutions()
{
	...
	for (u32 i = 0; i < m_Resolutions.size(); ++i)
	{
		...
		m_eventSender.SendEvent<eUIE_OnGetResolutionItems>(res, (i32)i);
