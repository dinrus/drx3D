...
// -------------------------------------------------------------------------
//  Имя файла:   UIEntityDynTexTag.cpp
//  Version:     v1.00
...
#include <drx3D/Game/UIEntityDynTexTag.h>
...
////////////////////////////////////////////////////////////////////////////
void CUIEntityDynTexTag::OnAddTaggedEntity( EntityId entityId, tukk uiElementName, tukk entityClass, tukk materialTemplate, const Vec3& offset, tukk idx)
{
	...
	if (pEntClass)
	{
		...
		{
			IMaterial* pMatTemplate = gEnv->p3DEngine->GetMaterialUpr()->LoadMaterial(materialTemplate, false);
			...
			if (pMatTemplate && pMatTemplate->GetShaderItem().m_pShaderResources->GetTexture(EEfResTextures(0)))
			{
				...
				IMaterial* pMat = gEnv->p3DEngine->GetMaterialUpr()->CloneMaterial(pMatTemplate);
