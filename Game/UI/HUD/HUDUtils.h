...
namespace CHUDUtils
{
	tukk  LocalizeString( tukk text, tukk arg1 = 0, tukk arg2 = 0, tukk arg3 = 0, tukk arg4 = 0);
	void LocalizeString( string &out, tukk text, tukk arg1, tukk arg2, tukk arg3, tukk arg4 );
	void LocalizeStringn( tuk dest, size_t bufferSizeInBytes, tukk text, tukk arg1 = 0, tukk arg2 = 0, tukk arg3 = 0, tukk arg4 = 0 );

	tukk LocalizeNumber(i32k number);
	void LocalizeNumber(string &out, i32k number);
	void LocalizeNumbern(tukk dest, size_t bufferSizeInBytes, i32k number);

	tukk LocalizeNumber(const float number, i32 decimals);
	void LocalizeNumber(string &out, const float number, i32 decimals);
	void LocalizeNumbern(tukk dest, size_t bufferSizeInBytes, const float number, i32 decimals);
	...
	IFlashPlayer* GetFlashPlayerFromCgfMaterial( IEntity* pCgfEntity, bool bGetTemporary = false/*, tukk materialName*/ );
	...
	{
		SCenterSortPoint(Vec2 screenPos, uk pData = NULL)
	...
	typedef DrxFixedArray<SCenterSortPoint, HUDUTILS_MAX_CENTER_SORT_HELPERS> TCenterSortArray;
