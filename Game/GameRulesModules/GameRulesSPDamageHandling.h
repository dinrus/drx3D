...
class CMercyTimeFilter
{
	...
	struct ClassFilter
	{
		...
		bool operator == (u16k& otherClassId) const
		{
...
public:
	...
	bool Filtered( u16k projectileClassId, const EntityId ownerId, const EntityId targetId ) const;
...
private:
	...
	DrxFixedArray<u32, MaxDifficultyLevels> m_difficultyTolerance;

	mutable u32 m_lastMercyTimeFilterCount;
};
