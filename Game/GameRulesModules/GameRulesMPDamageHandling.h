...
public:
	...
	virtual void ClProcessHit(Vec3 dir, EntityId shooterId, EntityId weaponId, float damage, u16 projectileClassId, u8 hitTypeId);
	// ~IGameRulesDamageHandlingModule
...
protected:
	...
	typedef std::map<EntityId, u32> TVehicleBodyDamageMap;
