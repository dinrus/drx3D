...
#include <drx3D/Game/IGameRulesAssistScoringModule.h>
...
protected:
	void SvDoScoringForDeath(const EntityId victimId, const EntityId shooterId, tukk weaponClassName, i32 damage, i32 material, i32 hit_type);
