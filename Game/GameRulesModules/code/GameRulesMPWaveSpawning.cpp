...
#include <drx3D/Game/GameRulesMPWaveSpawning.h>
...
void CGameRulesMPWaveSpawning::Update( float frameTime )
{
	...
	{
		//DrxWatch("Next Reinforcement Wave in: %.4f", m_fMarineWaveSpawnTimer);
...
bool CGameRulesMPWaveSpawning::WaveSpawningEnabled( i32 teamId ) const
{
	if(WaveSpawningEnabled())
	{
...
float CGameRulesMPWaveSpawning::GetTeamReviveTimeOverride( i32 teamId ) const
{
...
float CGameRulesMPWaveSpawning::GetTimeFromDeathTillAutoReviveForTeam( i32 teamId ) const
{
