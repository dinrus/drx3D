...
$Id$
$DateTime$
Описание: Implements wheel based vehicle movement
...
#include <drx3D/Game/VehicleSystem/VehicleNoiseGenerator.h>
...
struct SVehicleWheel
{
	...
	i16 axleIndex;						// 0 == back wheel, 1 == front wheel
...
struct SVehicleDebugInfo
{
	...
	IDebugHistoryUpr*  pDebugHistoryUpr;
...
public:
	...
	virtual i32 GetStatus(SVehicleMovementStatus* status);
...
protected:
	...
	void EnableLowLevelPhysics(i32 state, i32 bThreadSafe);
...
protected:
	...
	size_t               m_iWaterLevelUpdate;
	 ...
	 i32    m_wheelStatusLock;
	 i32    m_frictionStateLock;
	i32             m_numWheels;
	...
	i16 m_largeObjectInfoWheelIdx;
	i16 m_largeObjectFrictionType;
