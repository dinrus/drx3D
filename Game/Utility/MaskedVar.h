...
class CMaskedVarT
{
	...
	private:
		void Set(const TVarType v)
		{
			...
			m_dbgVal = v;
#endif
			const TMaskType  m = drx_random((TMaskType)1, TMaxMaskValue);
			UVal  w;
			w.asVarType = v;
...
typedef CMaskedVarT<float, u32, 0xffffffff>  TMaskedFloat;
typedef CMaskedVarT<i32, u32, 0xffffffff>  TMaskedInt;
typedef CMaskedVarT<u32, u32, 0xffffffff> TMaskedUInt;
