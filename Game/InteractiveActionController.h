...
public:
	...
	void OnEnter(CPlayer& player, EntityId interactiveObjectId, i32 interactionIndex = 0, float actionSpeed = 1.0f);
	void OnEnterByName(CPlayer& player, tukk interaction, float actionSpeed = 1.0f);
...
private:
	...
	void CalculateStartTargetLocation(CPlayer& player, i32 interactionIndex);
	void SafelyReleaseAction();

	DrxFixedStringT<32> m_interactionName;
