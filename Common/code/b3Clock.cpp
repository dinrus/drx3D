...
u64 b3Clock::getTimeMilliseconds()
{
#ifdef D3_USE_WINDOWS_TIMERS
...
zu64 b3Clock::getTimeMicroseconds()
{
#ifdef D3_USE_WINDOWS_TIMERS
...
void b3Clock::usleep(i32 microSeconds)
{
#ifdef _WIN32
	if (microSeconds == 0)
	{
